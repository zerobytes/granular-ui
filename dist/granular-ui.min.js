var Vr="granular-ui-styles",Kt=new URL("./fonts/Poppins-400.ttf",import.meta.url).href,Qt=new URL("./fonts/Poppins-500.ttf",import.meta.url).href,Jt=new URL("./fonts/Poppins-600.ttf",import.meta.url).href,ea=new URL("./fonts/Poppins-700.ttf",import.meta.url).href,ia=new URL("./fonts/Arimo-400.ttf",import.meta.url).href,ra=new URL("./fonts/Arimo-500.ttf",import.meta.url).href,ta=new URL("./fonts/Arimo-600.ttf",import.meta.url).href,aa=new URL("./fonts/Arimo-700.ttf",import.meta.url).href,oa=new URL("./fonts/Inter-400.woff2",import.meta.url).href,na=new URL("./fonts/Inter-500.woff2",import.meta.url).href,sa=new URL("./fonts/Inter-600.woff2",import.meta.url).href,ua=new URL("./fonts/Inter-700.woff2",import.meta.url).href,ga=`
@font-face {
  font-family: 'Poppins';
  font-style: normal;
  font-weight: 400;
...
`;function Lr(){if(typeof document>"u"||document.getElementById(Vr))return;let e=document.createElement("style");e.id=Vr,e.textContent=ga,document.head.appendChild(e)}var la=new Set(["--g-ui-bg","--g-ui-bg-subtle","--g-ui-bg-muted","--g-ui-bg-emphasized","--g-ui-bg-inverted","--g-ui-bg-panel","--g-ui-fg","--g-ui-fg-muted","--g-ui-fg-subtle","--g-ui-fg-inverted","--g-ui-border","--g-ui-border-subtle","--g-ui-border-emphasized","--g-ui-border-inverted","--g-ui-primary","--g-ui-primary-hover","--g-ui-primary-active","--g-ui-primary-subtle","--g-ui-primary-muted","--g-ui-primary-emphasized","--g-ui-success","--g-ui-success-hover","--g-ui-success-active","--g-ui-success-subtle","--g-ui-success-muted","--g-ui-danger","--g-ui-danger-hover","--g-ui-danger-active","--g-ui-danger-subtle","--g-ui-danger-muted","--g-ui-warning","--g-ui-warning-hover","--g-ui-warning-active","--g-ui-warning-subtle","--g-ui-warning-muted","--g-ui-info","--g-ui-info-hover","--g-ui-info-active","--g-ui-info-subtle","--g-ui-info-muted","--g-ui-shadow-xs","--g-ui-shadow-sm","--g-ui-shadow-md","--g-ui-shadow-lg","--g-ui-shadow-xl","--g-ui-shadow-2xl","--g-ui-radius","--g-ui-font","--g-ui-surface","--g-ui-text","--g-ui-muted","--g-ui-primary-strong","--g-ui-shadow"]);function ca(e={},i=document?.documentElement){if(i)for(let[r,t]of Object.entries(e)){let a=r.startsWith("--")?r:`--g-ui-${r}`;la.has(a)&&i.style.setProperty(a,String(t))}}function pa(e="dark",i=document?.documentElement){i&&(i.classList.remove("g-ui-theme-dark","g-ui-theme-light"),i.classList.add(e==="light"?"g-ui-theme-light":"g-ui-theme-dark"))}function da(e=document?.documentElement){return e.classList.contains("g-ui-theme-light")?"light":"dark"}import{Renderer as Ir,isSignal as $r,isState as Ar,isStatePath as Br,isComputed as Fr,resolve as $e,computed as ma,after as Hi,concat as fa}from"@granularjs/core";function Oi(e){return $r(e)||Ar(e)||Br(e)||Fr(e)}function o(...e){return fa(...e,{separator:" ",filterFalsy:!0})}function jr(e){if(!(e==null||e===""))return typeof e=="number"?`${e}px`:e}function u(e,i){let r={},t=[],a=n=>!!n&&typeof n=="object"&&!Array.isArray(n)&&!Ir.isRenderable(n)&&!Ir.isDomNode(n)&&!$r(n)&&!Ar(n)&&!Br(n)&&!Fr(n);for(let n of e)a(n)?Object.assign(r,n):t.push(n);if(i&&typeof i=="object")for(let n of Object.keys(i))r[n]===void 0&&(r[n]=i[n]);return{props:ma(r),rawProps:r,children:t}}function c(e){return $e(e)}function xe(e){return!!$e(e)}function N(e,i,r){let t=a=>{let n=$e(a),s=n==null||n===""?r:n;return s==null||s===""?"":`${e}${s}`};return Oi(i)?Hi(i).compute(a=>t(a)):t(i)}function G(e,i){return Oi(i)?Hi(i).compute(r=>$e(r)?e:""):$e(i)?e:""}function me(e,i,r){let t=a=>i[a]||null;return Oi(e)?Hi(e).compute(a=>t($e(a??r))):t($e(e??r))}import{Button as va,Span as Yi,when as qi,after as ha}from"@granularjs/core";function Gi(...e){let{props:i,children:r}=u(e,{variant:"filled",size:"md",justify:"center"}),{variant:t,color:a,size:n,fullWidth:s,loading:g,leftSection:p,rightSection:h,className:v,disabled:y,justify:f,...l}=i,k=ha(y,g).compute(([z,B])=>z||B);return va({...l,disabled:k,className:o("g-ui-button",N("g-ui-button-variant-",t,"filled"),N("g-ui-button-color-",a,"primary"),N("g-ui-justify-",f,"center"),N("g-ui-button-size-",n,"md"),G("g-ui-button-full",s),G("g-ui-button-loading",g),v)},qi(p,()=>Yi({className:"g-ui-button-section-left"},p)),qi(g,()=>Yi("Loading..."),()=>r),qi(h,()=>Yi({className:"g-ui-button-section-right"},h)))}import{Span as ba}from"@granularjs/core";function Wi(...e){let{props:i,children:r}=u(e,{size:"md"}),{size:t,weight:a,color:n,dimmed:s,align:g,ellipsis:p,decoration:h,className:v,style:y,...f}=i,l=me(a,{bold:"g-ui-text-weight-700",semibold:"g-ui-text-weight-600",medium:"g-ui-text-weight-500",700:"g-ui-text-weight-700",600:"g-ui-text-weight-600",500:"g-ui-text-weight-500",400:"g-ui-text-weight-400"}),k=me(n,{primary:"g-ui-text-primary",success:"g-ui-text-success",danger:"g-ui-text-danger",muted:"g-ui-text-dimmed"}),z=me(g,{center:"g-ui-text-align-center",right:"g-ui-text-align-right",left:"g-ui-text-align-left"}),B=me(h,{underline:"g-ui-text-decoration-underline","line-through":"g-ui-text-decoration-line-through",overline:"g-ui-text-decoration-overline",none:"g-ui-text-decoration-none"});return ba({...f,style:y,className:o("g-ui-text",N("g-ui-text-size-",t,"md"),G("g-ui-text-dimmed",s),G("g-ui-text-ellipsis",p),l,k,z,B,v)},r)}import{H1 as xa,H2 as Er,H3 as wa,H4 as ya,H5 as ka,H6 as za}from"@granularjs/core";var Na={1:xa,2:Er,3:wa,4:ya,5:ka,6:za};function Ca(...e){let{props:i,children:r}=u(e,{order:2}),{order:t,className:a,style:n,...s}=i,g=c(t)||2;return(Na[g]||Er)({...s,className:o("g-ui-title",N("g-ui-title-order-",t,2),a)},r)}import{Div as Sa}from"@granularjs/core";function Da(...e){let{props:i,children:r}=u(e,{size:"md"}),{size:t,fluid:a,className:n,style:s,...g}=i;return Sa({...g,style:s,className:o("g-ui-container",G("g-ui-container-fluid",a),N("g-ui-container-size-",t,"md"),n)},r)}import{Div as Pa}from"@granularjs/core";function Ma(...e){let{props:i,children:r}=u(e,{gap:"md"}),{gap:t,align:a,justify:n,className:s,style:g,...p}=i,h=me(n,{between:"g-ui-justify-between",center:"g-ui-justify-center",end:"g-ui-justify-end",start:"g-ui-justify-start"});return Pa({...p,style:g,className:o("g-ui-stack",N("g-ui-gap-",t,"md"),N("g-ui-align-",a),h,s)},r)}import{Div as Ta}from"@granularjs/core";function Va(...e){let{props:i,children:r}=u(e,{gap:"md",align:"center"}),{gap:t,align:a,justify:n,position:s,noWrap:g,className:p,style:h,...v}=i,y=me(s,{apart:"g-ui-justify-between",center:"g-ui-justify-center",right:"g-ui-justify-end",left:"g-ui-justify-start"});return Ta({...v,style:h,className:o("g-ui-group",N("g-ui-gap-",t,"md"),N("g-ui-align-",a,"center"),N("g-ui-justify-",n,"none"),y,G("g-ui-no-wrap",g),p)},r)}import{Div as vi,list as La,when as Zi,after as Rr}from"@granularjs/core";function Ia(...e){let{props:i,children:r}=u(e,{padding:"md",radius:"md",shadow:"none",border:"default"}),{title:t,content:a,actions:n,border:s,padding:g,radius:p,shadow:h,className:v,style:y,...f}=i;return vi({style:y},Zi(t,()=>vi({className:"g-ui-card-title"},t)),Zi(a,()=>vi({className:"g-ui-card-content"},a)),{className:o("g-ui-card",N("g-ui-card-border-",s,"md"),N("g-ui-card-padding-",g,"md"),N("g-ui-card-radius-",p,"md"),N("g-ui-card-shadow-",h,"md"),v),...f},r,Zi(n,()=>vi({className:"g-ui-card-actions"},La(n,l=>Gi({className:"g-ui-card-action",onClick:k=>l.get().onClick?.(k),leftSection:l.leftSection,rightSection:l.rightSection,size:Rr(l.size).compute(k=>k||"sm"),variant:Rr(l.variant).compute(k=>k||"outline"),...l.get().props||{}},l.label)))))}import{Span as $a}from"@granularjs/core";function Aa(...e){let{props:i,children:r}=u(e,{variant:"filled",size:"md"}),{variant:t,size:a,className:n,dot:s,style:g,...p}=i,h=me(t,{dot:"g-ui-badge-dot"});return $a({...p,className:o("g-ui-badge",N("g-ui-badge-variant-",t,"filled"),N("g-ui-badge-size-",a,"md"),G("g-ui-badge-dot",s),h,n)},r)}import{Div as Ke,Input as Ba,Textarea as Fa,Label as ja,Span as Ea,when as Qe,state as Ra,after as Ha,isState as Oa}from"@granularjs/core";function fe(...e){let{props:i,rawProps:r}=u(e,{size:"md"}),{label:t,description:a,error:n,size:s,leftSection:g,rightSection:p,className:h,inputClassName:v,multiline:y,value:f,...l}=i,{value:k,node:z,onChange:B,onInput:M,onFocus:S,onBlur:L,onKeyDown:I,onKeyUp:b,onClick:w}=r,m=Oa(k)&&!B&&!M,C=m?k:Ra(c(f)??"");Ha(f).change(ne=>{m||C.set(c(ne)??"")});let T=ne=>{let J=ne?.target?.value??"";J!==f.get()&&(C.set(J),B?.(ne),M?.(ne))},$=xe(y),U=$?Fa:Ba,oe=o(v,$&&"g-ui-textarea"),ee=U({...l,node:z,value:C,onInput:T,onChange:T,onFocus:S,onBlur:L,onKeyDown:I,onKeyUp:b,onClick:w,className:o("g-ui-input",oe)});return Ke({className:o("g-ui-text-input",h)},Qe(t,()=>ja({className:"g-ui-text-input-label"},t)),Qe(a,()=>Ea({className:"g-ui-text-input-description"},a)),Ke({className:o("g-ui-input-wrapper",G("g-ui-input-multiline",y),N("g-ui-input-size-",s,"md"),G("g-ui-input-error",n))},Qe(g,()=>Ke({className:"g-ui-input-section"},g)),ee,Qe(p,()=>Ke({className:"g-ui-input-section"},p))),Qe(n,()=>Ke({className:"g-ui-text-input-error-text"},n)))}function Ui(...e){let{props:i}=u(e,{size:"md"}),{size:r,leftSection:t,rightSection:a,className:n,...s}=i;return fe({...s,size:r,className:n,leftSection:t,rightSection:a,multiline:!0})}import{Div as Hr,Span as Or,after as Ae,state as Ya}from"@granularjs/core";function Xi(...e){let{props:i,rawProps:r}=u(e,{size:"md",step:1,allowDecimal:!0,allowNegative:!0,clampBehavior:"blur",hideControls:!1,decimalSeparator:".",thousandSeparator:"",format:null,prefix:"",suffix:""}),{value:t,min:a,max:n,step:s,size:g,allowDecimal:p,allowNegative:h,decimalSeparator:v,thousandSeparator:y,decimalScale:f,clampBehavior:l,hideControls:k,format:z,locale:B,currency:M,formatOptions:S,prefix:L,suffix:I,leftSection:b,rightSection:w,className:m,onChange:C,onInput:T,...$}=i,{onChange:U,onInput:oe,onBlur:ee,onFocus:ne,onKeyDown:J}=r,se=V=>{U?.(V.target?.value??""),oe?.(V.target?.value??"")},ge=se,re=Ya(""),P=V=>String(V??"").replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),O=()=>{if(!!!c(p))return 0;let D=c(f);if(D!=null&&D!==""&&Number.isFinite(Number(D)))return Math.max(0,Number(D));let H=c(z);return H==="currency"||H==="percent"?2:0},x=V=>{let D=c(v)??".",H=c(y)??"",Y=String(V??"");if(H&&(Y=Y.split(H).join("")),!Y||Y==="-"||Y===D||Y.endsWith(D))return null;let Q=Y.replace(D,"."),X=Number(Q);return Number.isFinite(X)?X:null},F=V=>{let D=c(y)??"";return D?V.replace(/\B(?=(\d{3})+(?!\d))/g,D):V},E=V=>{let D=c(v)??".",H=O(),Y=Number(V);if(!Number.isFinite(Y))return"";let Q=Y<0?"-":"",X=Math.abs(Y),[W,_=""]=String(X).split("."),ae=F(W);if(H>0){let he=_.slice(0,H).padEnd(H,"0");return`${Q}${ae}${D}${he}`}return`${Q}${ae}`},Z=(V,D)=>{try{let H=c(B),Y=c(M)??"USD",Q=c(S)??{},X=O(),W=D==="currency"?"currency":"decimal";return new Intl.NumberFormat(H,{style:W,currency:Y,...X>0?{minimumFractionDigits:X,maximumFractionDigits:X}:{maximumFractionDigits:0},...Q}).format(V)}catch{return E(V)}},K=V=>{let D=V,H=c(a),Y=c(n);return H!=null&&Number.isFinite(Number(H))&&(D=Math.max(D,Number(H))),Y!=null&&Number.isFinite(Number(Y))&&(D=Math.min(D,Number(Y))),!c(h)&&D<0&&(D=0),D},le=()=>{let V=c(I)??"",D=c(z);return!V&&D==="percent"?"%":V},ve=(V,D,H)=>{let Y=c(L)??"",Q=le(),X=String(V??"").replace(/\u00A0/g," "),W=String(Y??"").replace(/\u00A0/g," "),_=String(Q??"").replace(/\u00A0/g," "),ae=W&&X.startsWith(W),he=_&&X.endsWith(_);return`${D??""}${ae?"":Y}${V}${he?"":Q}`},Se=(V,D)=>{let H=O(),Y=c(v)??".",X=String(V??"").replace(/\D/g,"")||"0",W=H>0?X.padStart(H+1,"0"):X,ae=(H>0?W.slice(0,-H):W).replace(/^0+(?=\d)/,"")||"0",he=H>0?W.slice(-H):"",Ve=H>0?`${ae}${Y}${he}`:ae;return`${D??""}${Ve}`},Ie=V=>{let D=c(L)??"",H=le(),Y=String(V??""),Q=String(D??"").replace(/\u00A0/g," "),X=String(H??"").replace(/\u00A0/g," ");return Q&&Y.replace(/\u00A0/g," ").startsWith(Q)&&(Y=Y.slice(D.length)),X&&Y.replace(/\u00A0/g," ").endsWith(X)&&(Y=Y.slice(0,-H.length)),Y},mi=V=>{let D=!!c(h),H=Ie(V),Y=D&&H.includes("-")?"-":"",Q=H.replace(/\D/g,""),X=Se(Q,Y);if(c(l)==="strict"){let W=x(X);if(W!=null){let _=K(W);X=`${_<0?"-":""}${E(Math.abs(_))}`}}return X},Bi=V=>{if(V==null||V==="")return Se("","");if(typeof V=="number"&&Number.isFinite(V)){let _=c(l)==="strict"?K(V):V;return`${_<0?"-":""}${E(Math.abs(_))}`}let D=Ie(V),H=c(v)??".",Q=!!c(h)&&String(D).includes("-")?"-":"",X=String(D??"").replace(new RegExp(`[^0-9${P(H)}]`,"g"),""),W=x(`${Q}${X}`);if(W!=null){let _=c(l)==="strict"?K(W):W;return`${_<0?"-":""}${E(Math.abs(_))}`}return mi(V)},Ne,_e=V=>{let D=c(V);if(D===void 0)return;let H=Bi(D);H!==re.get()&&(Ne=H,re.set(H))};_e(t),Ae(t).change(V=>{_e(V)}),Ae(re).change(V=>{if(V===Ne){Ne=void 0;return}Ne=void 0;let D=x(V);if(D==null){se?.(V??"");return}se?.(D)});let Fi=Ae(w).compute(V=>V!=null&&V!==!1),ji=Ae(k,Fi).compute(([V,D])=>!c(V)&&!D),fi=Ae(p).compute(V=>c(V)?"decimal":"numeric"),Ei=Ae(z,L,I,p,h,v,y,f,l,a,n,B,M,S).compute(()=>({mode:"both",format:V=>{let D=mi(V),H=c(z),Q=!!c(h)&&D.startsWith("-")?"-":"",X=x(D),W=D.replace(Q,"");if(X!=null){let _=Math.abs(X);if(typeof H=="function")try{W=H(_)}catch{W=E(_)}else if(H==="currency")W=Z(_,"currency");else if(H==="decimal"){let ae=c(B),he=c(S);W=ae||he?Z(_,"decimal"):E(_)}else W=E(_)}return{value:D,raw:D,visual:ve(W,Q,H)}}})),d=V=>{let D=x(re.get()),H=Number(c(s)??1),Q=K((D??0)+H*V);re.set(E(Q))},j=V=>{if(!V||typeof V.setSelectionRange!="function")return;let D=()=>{try{let H=String(V.value??"").length;V.setSelectionRange(H,H)}catch{}};typeof requestAnimationFrame=="function"?requestAnimationFrame(D):D()},ue=V=>{ge?.(V);let D=V?.target;D&&j(D)},q=V=>{if(ee?.(V),c(l)!=="blur")return;let D=x(re.get());if(D==null)return;let H=K(D);re.set(E(H))},te=V=>{ne?.(V),j(V?.target)},de=V=>{J?.(V);let D=V?.target;if(!D)return;let H=c(L)??"",Y=le();Y&&typeof D.selectionEnd=="number"&&(D.selectionEnd=Math.min(D.selectionEnd,String(D.value??"").length-Y.length)),H&&typeof D.selectionStart=="number"&&(D.selectionStart=Math.max(D.selectionStart,H.length))},ie=Hr({className:"g-ui-number-field-controls"},Or({className:"g-ui-number-field-control",onClick:()=>d(1)},"+"),Or({className:"g-ui-number-field-control",onClick:()=>d(-1)},"\u2212")),Ce=Hr({className:"g-ui-number-field-controls-wrapper"},ie),De=Ae(ji,w).compute(([V,D])=>V?Ce:D);return fe({...$,size:g,className:o("g-ui-number-field",m),leftSection:b,rightSection:De,type:"text",inputMode:fi,inputClassName:o("g-ui-input-number"),value:re,format:Ei,onInput:ue,onBlur:q,onFocus:te,onKeyDown:de})}function qa(...e){return Xi(...e)}import{Div as wi,Button as Ga,portal as Wa,when as _i,after as Za}from"@granularjs/core";var hi='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/></svg>',bi='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M560-240 320-480l240-240 56 56-184 184 184 184-56 56Z"/></svg>',xi='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M379.33-244 154-469.33 201.67-517l177.66 177.67 378.34-378.34L805.33-670l-426 426Z"/></svg>',Yr='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M240-446.67v-66.66h480v66.66H240Z"/></svg>',Ye='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M312-265.33 265.33-312l168-168-168-167L312-693.67l168 168 167-168L693.67-647l-168 167 168 168L647-265.33l-167-168-168 168Z"/></svg>',qr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>',Gr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>',Wr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h357l-80 80H200v560h560v-278l80-80v358q0 33-23.5 56.5T760-120H200Zm280-360v-80h240v80H480Zm0 160v-80h320v80H480Zm0 160v-80h320v80H480ZM360-360v-80h80v80h-80Zm0 160v-80h80v80h-80Zm0 160v-80h80v80h-80Zm160-320h280l-36-37 37-37v74H520Zm-160 0h80v-80h-80v80ZM120-600v-160l160-160h160l-80 80H200v240h-80Zm80-240v-80 80Z"/></svg>',Zr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>',Ur='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80H200Zm0-80h560v-400H200v400Z"/></svg>',Xr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z"/></svg>';function Je(...e){let{props:i,rawProps:r,children:t}=u(e,{size:"md",centered:!0,overlay:"normal"}),{opened:a,title:n,size:s,centered:g,overlay:p,position:h,className:v,style:y}=i,{onClose:f}=r,l=Za(h,g).compute(([k,z])=>`g-ui-modal-position-${k??(z===!1?"top-center":"center")}`);return _i(a,()=>Wa(wi({className:o("g-ui-modal-overlay",N("g-ui-modal-overlay-",p,"normal"),l),onClick:k=>{k.target===k.currentTarget&&f?.()}},wi({className:o("g-ui-modal",N("g-ui-modal-size-",s,"md"),v)},wi({className:"g-ui-modal-header"},_i(n,()=>wi({className:"g-ui-modal-title"},n)),_i(f,()=>Ga({type:"button",className:"g-ui-button g-ui-button-variant-subtle g-ui-button-size-xs g-ui-modal-close",onClick:f,innerHTML:Ye}))),t))))}import{Div as yi,Span as Ki,after as _r,when as Kr}from"@granularjs/core";function ei(...e){let{props:i}=u(e,{variant:"spinner",size:"md"}),{variant:r,size:t,className:a}=i,n=_r(r).compute(g=>g==="dots"),s=_r(r).compute(g=>g==="bars");return Kr(n,()=>yi({className:o("g-ui-loading g-ui-dots",N("g-ui-loading-size-",t,"md"),a)}),()=>Kr(s,()=>yi({className:o("g-ui-loading g-ui-bars",N("g-ui-loading-size-",t,"md"),a)},Ki(""),Ki(""),Ki("")),()=>yi({className:o("g-ui-loading",N("g-ui-loading-size-",t,"md"),a)},yi({className:"g-ui-spinner"}))))}import{Div as Qi,Input as Ua,Label as Xa,Span as Qr,when as Ji,state as _a,after as Ka}from"@granularjs/core";function er(...e){let{props:i,rawProps:r}=u(e,{size:"md"}),{checked:t,label:a,description:n,size:s,indeterminate:g,className:p,style:h,inputProps:v,...y}=i,{onChange:f}=r,l=_a(xe(t));Ka(t).change(z=>{z!=null&&(l.set(!!z),f?.(z))});let k=Xa({className:"g-ui-checkbox-control"},Ua({type:"checkbox",indeterminate:g,checked:l,className:o("g-ui-checkbox-input",N("g-ui-checkbox-size-",s,"md"),v?.className),...y}),Ji(l,()=>Qi({className:"g-ui-checkbox-checked",innerHTML:xi}),()=>{if(!l.get()&&g.get())return Qi({className:"g-ui-checkbox-indeterminate",innerHTML:Yr})}),Ji(a,()=>Qr({className:"g-ui-checkbox-label"},a)));return Qi({className:o("g-ui-checkbox",N("g-ui-checkbox-size-",s,"md"),p)},k,Ji(n,()=>Qr({className:"g-ui-checkbox-description"},n)))}import{Input as io,Label as ro,Span as to,when as ao,after as rr,state as oo}from"@granularjs/core";import{Div as Qa,context as Ja,after as Jr}from"@granularjs/core";var ir=Ja({name:null,selected:null});function eo(...e){let{props:i,rawProps:r,children:t}=u(e),{className:a,name:n,selected:s,onChange:g,...p}=i,{onChange:h}=r,v=ir.scope({name:n?.get(),selected:s?.get()});return Jr(v.selected).change(y=>{h?.(y)}),Jr(s).change(y=>{y!==v.selected.get()&&(v.set().selected=y)}),v.serve(Qa({...p,className:o("g-ui-switch-group",a)},t))}function no(...e){let{props:i}=u(e,{size:"md"}),{label:r,size:t,className:a,style:n,inputProps:s,checked:g,value:p,...h}=i,v=oo(g),y=ir.state(),f=rr(y).compute(l=>({name:l.name,type:l.name?"radio":"checkbox"}));return rr(y.selected).change(l=>{v.set(l===p.get())}),rr(v).change(l=>{if(!l)return;let k=y.get().selected;y.set().selected=p.get()}),ro({className:o("g-ui-switch",N("g-ui-switch-size-",t,"md"),a)},io({type:f.type,name:f.name,value:p,checked:v,className:o("g-ui-switch-input",N("g-ui-switch-size-",t,"md"),s?.className),...h}),ao(r,()=>to({className:"g-ui-switch-label"},r)))}import{Div as Be,Span as et,when as tr,state as it,after as ki}from"@granularjs/core";import{Span as so}from"@granularjs/core";function we(...e){let{props:i,children:r}=u(e,{size:"md"});return so({...i,className:o("g-ui-icon",N("g-ui-icon-size-",i.size,"md"),N("g-ui-icon-color-",i.color),i.className)},...r)}function uo(...e){let{props:i,rawProps:r}=u(e,{data:[],size:"md"}),{data:t,value:a,size:n,leftSection:s,rightSection:g,placeholder:p,className:h,...v}=i,{onChange:y}=r,f=it(!1),l=it(c(a)??"");ki(a).change(M=>{let S=c(M);S!==void 0&&l.set(S??"")});let k=M=>{l.set(M),y?.(M),f.set(!1)},z=ki(l).compute(M=>M?"":"g-ui-select-placeholder"),B=ki(l).compute(M=>{let L=(c(t)??[]).find(I=>I.value===M);return M?L?.label??"":p??""});return Be({...v,className:o("g-ui-select-root",h)},Be({className:o("g-ui-input-wrapper",N("g-ui-input-size-",n,"md"))},tr(s,()=>Be({className:"g-ui-input-section"},s)),Be({className:o("g-ui-select",z),onClick:()=>f.set(!f.get())},et({className:"g-ui-select-value"},B)),tr(g,()=>Be({className:"g-ui-input-section"},g),()=>et({className:"g-ui-select-caret"},we({innerHTML:Xr})))),tr(f,()=>Be({className:"g-ui-select-dropdown"},(c(t)??[]).map(M=>Be({className:o("g-ui-select-item",ki(l).compute(S=>S===M.value?"g-ui-select-item-active":"")),onClick:()=>k(M.value)},M.label)))))}import{Button as go,Div as qe,state as Pe,after as ii,list as lo,when as co}from"@granularjs/core";function po(...e){let{props:i,rawProps:r}=u(e,{tabs:[],orientation:"horizontal",variant:"default",sticky:!0}),{value:t,tabs:a,orientation:n,variant:s,sticky:g,className:p,style:h}=i,{onChange:v}=r,y=Pe(c(t)??c(a)?.[0]?.value??""),f=Pe(),l=Pe(),k=Pe(0),z=Pe(0),B=Pe(0),M=Pe(0),S=Pe(!1),L=Pe(0),I=!1,b=null,w=!1,m=new Set;ii(t).change(x=>{let F=c(x);F!=null&&y.set(F)});let C=x=>{y.set(x),v?.(x)},T=x=>{let F=[],E=x?.parentElement;for(;E;){let Z=getComputedStyle(E),K=`${Z.overflow}${Z.overflowY}${Z.overflowX}`;/(auto|scroll)/.test(K)&&F.push(E),E=E.parentElement}return F},$=x=>T(x)[0]??null,U=x=>x?x.getBoundingClientRect().top:0,oe=x=>x?x.scrollTop:window.scrollY||window.pageYOffset||0,ee=(x,F)=>x>F?"down":x<F?"up":"none",ne=(x,F,E,Z)=>x==="down"&&F<E?!0:x==="up"&&F>=E?!1:Z,J=()=>{let x=f.get(),F=l.get();if(!x||!F)return;if(!xe(g)){S.set(!1),k.set(0);return}if(typeof window>"u")return;let E=x.getBoundingClientRect(),Z=F.getBoundingClientRect(),K=$(x),le=U(K),ve=oe(K),Se=ee(ve,L.get());L.set(ve);let Ie=ne(Se,E.top,le,S.get());k.set(Z.height),z.set(E.left),B.set(E.width),M.set(le),Ie!==S.get()&&S.set(Ie)},se=()=>{b==null&&(b=requestAnimationFrame(()=>{b=null,J()}))},ge=x=>{!x||m.has(x)||(m.add(x),x.addEventListener("scroll",se,{passive:!0}))},re=()=>{if(I)return;let x=f.get(),F=l.get();!x||!F||typeof window>"u"||(I=!0,J(),ge(window),window.addEventListener("resize",se),T(x).forEach(ge))};ii(l,f,g).change(re),!w&&typeof window<"u"&&(w=!0,setTimeout(()=>re(),0));let P=ii(S,z,B,M).compute(x=>{let[F,E,Z,K]=x;return F?{position:"fixed",top:`${K}px`,left:`${E}px`,width:`${Z}px`,background:"var(--g-ui-surface)",zIndex:100}:{position:"static",top:"auto",left:"auto",width:"auto",zIndex:"auto",background:"transparent"}}),O=ii(S,k).compute(x=>{let[F,E]=x;return{height:F?`${E}px`:"0px"}});return qe(qe({className:o("g-ui-tabs",me(n,{vertical:"g-ui-tabs-vertical"}),N("g-ui-tabs-variant-",s,"default"),i.className??p)},qe({node:f}),qe({style:O}),qe({node:l,className:"g-ui-tabs-list",style:P},lo(a,x=>go({className:ii(y,x.value).compute(([F,E])=>o("g-ui-tabs-tab",E===F&&"g-ui-tabs-tab-active")),onClick:()=>C(x.get().value)},x.label))),qe({className:"g-ui-tabs-panel"},co(y,()=>a.get()?.find(x=>x.value===y.get())?.content??null))))}import{Table as mo,Thead as fo,Tbody as vo,Tr as rt,Th as ho,Td as tt}from"@granularjs/core";function bo(...e){let{props:i}=u(e,{headers:[],rows:[]}),{headers:r,rows:t,striped:a,highlightOnHover:n,withBorder:s,withColumnBorders:g,className:p,style:h,...v}=i;return mo({...v,className:o("g-ui-table",G("g-ui-table-striped",a),G("g-ui-table-hover",n),G("g-ui-table-with-border",s),G("g-ui-table-column-borders",g),p)},r.length?fo(rt(r.map(y=>ho(y)))):null,vo(t.map(y=>rt(Array.isArray(y)?y.map(f=>tt(f)):Object.values(y).map(f=>tt(f))))))}import{Div as ar}from"@granularjs/core";import{state as xo,when as wo,after as yo}from"@granularjs/core";function ko(...e){let{props:i,children:r}=u(e,{opened:!1}),{opened:t,className:a,...n}=i,s=xo(xe(t));yo(t).change(v=>{s.set(xe(v))});let g=()=>{s.set(!s.get())},p=r[0],h=r[1];return ar({...n,className:o("g-ui-accordion",a)},ar({className:"g-ui-accordion-header",onClick:g},p),wo(s,()=>ar({className:"g-ui-accordion-content"},h)))}import{Span as at}from"@granularjs/core";function zo(...e){let{props:i,children:r}=u(e),{label:t,className:a,style:n}=i;return at({className:o("g-ui-tooltip",a)},r,at({className:"g-ui-tooltip-content"},t))}import{Div as ri,when as No,after as Co,state as ti,portal as So}from"@granularjs/core";var or=ti({currentOpenState:null});function Do(...e){let i=ti(),r=ti(),t=ti({}),{props:a,rawProps:n,children:s}=u(e,{position:"right"}),{opened:g,content:p,position:h,className:v,...y}=a,{onChange:f}=n,l=ti(c(g)??!1);Co(g).change(I=>{let b=c(I);b!=null&&(l.set(!!b),b&&k())});let k=()=>{or.get().currentOpenState!==l&&(or.get().currentOpenState?.set(!1),or.set().currentOpenState=l)};g.get()&&k();let z=I=>{let w=String(I??"right").toLowerCase().split("-").filter(Boolean);if(w.length===1){let T=w[0];return T==="top"||T==="bottom"?{placement:T,align:"center"}:T==="left"||T==="right"?{placement:"bottom",align:T}:T==="center"?{placement:"bottom",align:"center"}:{placement:"bottom",align:"right"}}let[m,C]=w;return m==="top"||m==="bottom"?{placement:m,align:C||"center"}:m==="left"||m==="right"?{placement:m,align:C||"center"}:{placement:"bottom",align:"right"}},B=()=>{let I=i.get(),b=r.get();if(!I||!b||typeof window>"u")return;let w=I.getBoundingClientRect(),m=b.getBoundingClientRect(),C=c(h)??"right",T=getComputedStyle(document.documentElement).getPropertyValue("--g-ui-space-20"),$=Number.parseFloat(T)||20,U=window.innerWidth||0,oe=window.innerHeight||0,ee=Math.max($,U-m.width-$),ne=Math.max($,oe-m.height-$),{placement:J,align:se}=z(C),ge=8,re=w.bottom+ge,P=w.left;J==="top"||J==="bottom"?(re=J==="top"?w.top-m.height-ge:w.bottom+ge,se==="center"?P=w.left+w.width/2-m.width/2:se==="right"?P=w.right-m.width:P=w.left):(J==="left"||J==="right")&&(P=J==="left"?w.left-m.width-ge:w.right+ge,se==="center"?re=w.top+w.height/2-m.height/2:se==="bottom"?re=w.bottom-m.height:re=w.top),P=Math.max($,Math.min(P,ee)),re=Math.max($,Math.min(re,ne)),t.set({top:`${re}px`,left:`${P}px`})},M=I=>{l.set(I),f?.(I),I&&(k(),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>B()):setTimeout(()=>B(),0))},S=()=>M(!l.get()),L=()=>M(!1);return ri({...y,node:i,className:o("g-ui-menu",v)},ri({onClick:S},s),No(l,()=>So(ri(ri({className:"g-ui-menu-overlay",onClick:L}),ri({className:"g-ui-menu-dropdown",node:r,style:t},p)))))}import{Div as ot,portal as Po,when as Mo}from"@granularjs/core";function To(...e){let{props:i,children:r}=u(e,{position:"right",size:"md",overlay:"normal",shadowed:!0}),{opened:t,onClose:a,position:n,size:s,overlay:g,shadowed:p,className:h,style:v}=i;return Mo(t,()=>Po(ot({className:o("g-ui-drawer-overlay",N("g-ui-drawer-overlay-",g,"normal")),onClick:a},ot({className:o("g-ui-drawer",me(p,{true:"g-ui-drawer-shadowed"},!0),N("g-ui-drawer-",n,"right"),N("g-ui-drawer-size-",s,"md"),h),onClick:y=>y.stopPropagation()},r))))}import{Button as Vo,Div as nr,Span as nt,when as zi,after as st}from"@granularjs/core";function sr(...e){let{props:i,rawProps:r,children:t}=u(e,{color:"blue",withCloseButton:!0}),{title:a,color:n,icon:s,loading:g,withCloseButton:p,withBorder:h,className:v,style:y}=i,{onClose:f}=r,l=st(s,g).compute(([z,B])=>!z&&!!B),k=st(s,g).compute(([z,B])=>!!z||!!B);return nr({className:o("g-ui-notification",[h,"g-ui-notification-bordered"],[n,z=>`g-ui-notification-${z}`],[k,"g-ui-notification-with-icon"],v)},zi(s,()=>nt({className:"g-ui-notification-icon"},s)),zi(l,()=>ei({size:"sm",className:"g-ui-notification-loader"})),nr({className:"g-ui-notification-body"},zi(a,()=>nr({className:"g-ui-notification-title"},a)),t),zi(p,()=>Vo({type:"button",className:"g-ui-notification-close",onClick:()=>f?.()},nt({innerHTML:Ye}))))}import{Div as Lo,when as Io}from"@granularjs/core";function $o(...e){let{props:i}=u(e,{labelPosition:"center"}),{label:r,labelPosition:t,vertical:a,className:n,...s}=i;return Lo({...s,className:o("g-ui-divider",G("label",r),N("g-ui-divider-label-",t,"center"),G("g-ui-divider-vertical",a),n)},Io(r,()=>Wi({className:"g-ui-divider-label-text",size:"sm"},r)))}import{Div as Ao}from"@granularjs/core";function Bo(...e){let{props:i,children:r}=u(e,{padding:"md",radius:"md",shadow:"none"}),{padding:t,radius:a,shadow:n,className:s,...g}=i;return Ao({...g,className:o("g-ui-paper",[t,p=>`g-ui-card-padding-${p}`],[a,p=>`g-ui-card-radius-${p}`],[n,p=>`g-ui-card-shadow-${p}`],s)},r)}import{Button as Fo,Div as ur,Span as jo,after as ut,when as gr}from"@granularjs/core";function Eo(...e){let{props:i,rawProps:r,children:t}=u(e,{color:"blue"}),{title:a,color:n,icon:s,withCloseButton:g,className:p,...h}=i,{onClose:v}=r,y=ut(a,g).compute(([l,k])=>l||k),f=ut(s).compute(l=>l!==void 0);return ur({...h,className:o("g-ui-alert",[n,l=>`g-ui-alert-${l}`],p)},ur({className:"g-ui-alert-header"},gr(s,()=>jo({className:"g-ui-alert-icon"},s)),gr(a,()=>ur({className:"g-ui-alert-title"},a)),gr(g,()=>Fo({type:"button",className:"g-ui-alert-close",onClick:()=>v?.()},"\xD7"))),t)}import{Div as Ro,Img as Ho,when as Oo}from"@granularjs/core";function Yo(...e){let{props:i,children:r}=u(e,{size:"md",alt:""}),{src:t,size:a,alt:n,className:s,...g}=i;return Ro({...g,className:o("g-ui-avatar",[a,p=>`g-ui-avatar-size-${p}`],s)},Oo(t,()=>Ho({className:"g-ui-avatar-img",src:t,alt:n}),()=>r))}import{Span as qo}from"@granularjs/core";function Go(...e){let{props:i,children:r}=u(e),{className:t,...a}=i;return qo({...a,className:o("g-ui-kbd",t)},r)}import{Code as Wo}from"@granularjs/core";function Zo(...e){let{props:i,children:r}=u(e),{className:t,...a}=i;return Wo({...a,className:o("g-ui-code",t)},r)}import{Blockquote as Uo}from"@granularjs/core";function Xo(...e){let{props:i,children:r}=u(e),{className:t,...a}=i;return Uo({...a,className:o("g-ui-blockquote",t)},r)}import{Div as _o}from"@granularjs/core";function Ko(...e){let{props:i,children:r}=u(e,{cols:3,gap:"md"}),{cols:t,gap:a,className:n,...s}=i;return _o({...s,className:o("g-ui-grid",[a,g=>`g-ui-gap-${g}`],[t,g=>`g-ui-grid-cols-${g}`],n)},r)}import{Ul as Qo,Ol as Jo,Li as lr,Div as Ni,Span as cr,after as pr,when as Fe,isSignal as en,isState as rn,isStatePath as tn,isComputed as an}from"@granularjs/core";function gt(...e){let{props:i,children:r}=u(e,{type:"none",size:"md"}),{type:t,size:a,withPadding:n,className:s,...g}=i,p=me(t,{ordered:"g-ui-list-ordered",unordered:"g-ui-list-unordered",none:"g-ui-list-none"}),h=pr(t).compute(z=>z==="ordered"),v=z=>z&&typeof z=="object"&&typeof z.tagName=="string"&&(z.tagName.toLowerCase()==="ul"||z.tagName.toLowerCase()==="ol"),y=z=>z&&typeof z=="object"&&typeof z.tagName=="string"&&z.tagName.toLowerCase()==="li",f=z=>{console.log("INFO ABOUT ITEM",z,typeof z,typeof z?.tagName,z?.tagName?.toLowerCase());let B=M=>M?.nodeType==="granular-list-node"?M:M==null||M===!1?null:Array.isArray(M)?M.map(S=>B(S)):y(M)?M:v(M)?lr({className:"g-ui-list-nested-item"},M):lr(cr({className:"g-ui-list-item-shell"},M));return en(z)||rn(z)||tn(z)||an(z)?pr(z).compute(M=>B(M)):B(z)},l=Fe(r,()=>r.map(z=>f(z))),k={...g,className:o("g-ui-list",N("g-ui-list-size-",a,"md"),G("g-ui-list-with-padding",n),p,s)};return Fe(h,()=>Jo(k,l),()=>Qo(k,l))}function on(...e){let{props:i,children:r}=u(e,{withBorder:!1}),{leftSection:t,rightSection:a,title:n,body:s,withBorder:g,className:p,...h}=i,v=pr(n,s).compute(([y,f])=>!!y||!!f);return lr({...h,className:o("g-ui-list-item",G("g-ui-list-item-border",g),p)},Ni({className:"g-ui-list-item-shell"},Fe(t,()=>cr({className:"g-ui-list-item-section g-ui-list-item-section-left"},t)),Fe(v,()=>Ni({className:"g-ui-list-item-content"},Fe(n,()=>Ni({className:"g-ui-list-item-title"},n)),Fe(s,()=>Ni({className:"g-ui-list-item-body"},s))),()=>r),Fe(a,()=>cr({className:"g-ui-list-item-section g-ui-list-item-section-right"},a))))}gt.Item=on;import{A as nn}from"@granularjs/core";function sn(...e){let{props:i,children:r}=u(e),{className:t,...a}=i;return nn({...a,className:o("g-ui-anchor",t)},r)}import{Img as un}from"@granularjs/core";function gn(...e){let{props:i}=u(e),{className:r,...t}=i;return un({...t,className:o("g-ui-image",r)})}import{Div as lt}from"@granularjs/core";function ln(...e){let{props:i}=u(e,{value:0,color:"primary",size:"md"}),{value:r,color:t,size:a,className:n,...s}=i;return lt({...s,className:o("g-ui-progress",N("g-ui-progress-size-",a,"md"),[r,g=>{let p=Math.max(0,Math.min(100,Number(g)||0));return`g-ui-progress-${Math.round(p/5)*5}`}],[t,g=>g?`g-ui-progress-${g}`:""],n)},lt({className:"g-ui-progress-bar"}))}import{Div as Le,after as je,state as cn,when as ct,list as pn}from"@granularjs/core";function dn(...e){let{props:i,rawProps:r}=u(e,{size:"md",min:0,max:100,step:1}),{onChange:t}=r,{value:a,marks:n,size:s,min:g,max:p,step:h,disabled:v,className:y,...f}=i,l=cn(c(a??g)),k=je(n).compute(b=>b&&b.length>0);je(a).change(b=>{b!=null&&l.set(c(b))});let z=()=>{let b=Number(c(g)),w=Number(c(p));return!Number.isFinite(b)||!Number.isFinite(w)?{minValue:0,maxValue:100}:{minValue:Math.min(b,w),maxValue:Math.max(b,w)}},B=()=>{let b=Number(c(h));return Number.isFinite(b)&&b>0?b:1},M=b=>{let{minValue:w,maxValue:m}=z(),C=B(),T=Math.max(w,Math.min(m,Number(b))),$=Math.round((T-w)/C)*C+w;$!==l.get()&&(l.set($),t?.($))},S=je(l).compute(b=>{let{minValue:w,maxValue:m}=z(),C=m-w;if(C<=0)return 0;let T=(Number(b??w)-w)/C*100;return Math.max(0,Math.min(100,T))}),L=(b,w)=>{let m=w?.();if(!m||m.width===0)return;let T=Math.min(Math.max(b.clientX-m.left,0),m.width)/m.width,{minValue:$,maxValue:U}=z();M($+T*(U-$))},I=b=>{if(xe(v))return;b.preventDefault?.();let w=b.currentTarget,m=()=>w.getBoundingClientRect();w.setPointerCapture?.(b.pointerId),L(b,m);let C=$=>L($,m),T=()=>{w.releasePointerCapture?.(b.pointerId),window.removeEventListener("pointermove",C),window.removeEventListener("pointerup",T)};window.addEventListener("pointermove",C),window.addEventListener("pointerup",T)};return Le({...f,className:o("g-ui-slider",N("g-ui-slider-size-",s,"md"),G("g-ui-slider-disabled",v),y)},Le({className:"g-ui-slider-track",onPointerDown:I},Le({className:"g-ui-slider-bar",style:je(S).compute(b=>({width:`${b}%`}))}),Le({className:"g-ui-slider-thumb",style:je(S).compute(b=>({left:`${b}%`}))})),ct(k,()=>Le({className:"g-ui-slider-marks-placeholder"})),ct(n,()=>Le({className:"g-ui-slider-marks"},pn(n,b=>dr({mark:b,getBounds:z})))))}var dr=({mark:e,getBounds:i})=>{let{minValue:r,maxValue:t}=i(),a=t-r,n=je(e).compute(h=>h.value??h),s=je(e).compute(h=>h.label??String(h.value)??n),g=Number(n),p=0;return a>0&&(p=(g-r)/a*100),Le({className:"g-ui-slider-mark",style:{left:`${Math.max(0,Math.min(100,p))}%`}},Le({className:"g-ui-slider-mark-label"},s))};import{Div as mn,after as fn}from"@granularjs/core";function vn(...e){let{props:i}=u(e,{height:"md",width:"full"}),{height:r,width:t,className:a,...n}=i,s=fn(r,t).compute(([g,p])=>{let h={};return isNaN(g)||(h.height=`${g}px`),isNaN(p)||(h.width=`${p}px`),h});return mn({...n,style:{width:s.width,height:s.height,...n.style||{}},className:o("g-ui-skeleton",[r,g=>`g-ui-skeleton-h-${g}`],[t,g=>`g-ui-skeleton-w-${g}`],a)})}import{Button as hn,after as pt,state as bn}from"@granularjs/core";function xn(...e){let{props:i,rawProps:r,children:t}=u(e,{size:"md",variant:"filled",color:"primary"}),{checked:a,size:n,variant:s,color:g,className:p,...h}=i,{onChange:v}=r,y=bn(!!a);pt(a).change(l=>{l!=null&&y.set(!!l)});let f=l=>{y.set(l),v?.(l)};return hn({...h,type:"button",className:o("g-ui-chip",N("g-ui-chip-size-",n,"md"),N("g-ui-chip-variant-",s,"filled"),N("g-ui-chip-color-",g,"primary"),pt(y).compute(l=>l?"g-ui-chip-active":""),p),onClick:()=>f(!y.get())},t)}import{Div as mr,after as dt,state as wn,list as yn}from"@granularjs/core";function kn(...e){let{props:i,rawProps:r}=u(e,{data:[],size:"sm"}),{value:t,data:a,size:n,scroll:s,className:g,...p}=i,{onChange:h}=r,v=wn(c(t));dt(t).change(f=>{let l=c(f);l!=null&&v.set(l)});let y=f=>{v.set(f),h?.(f)};return mr({...p,className:o(s&&"g-ui-segmented-scroll")},mr({className:o("g-ui-segmented",N("g-ui-segmented-size-",n,"sm"),g)},yn(a,(f=>mr({className:o("g-ui-segmented-item",dt(v).compute(l=>f.get().value===l?"g-ui-segmented-active":"")),onClick:()=>y(f.get().value)},f.label)))))}import{Button as fr,Div as zn,state as Nn,after as Ci}from"@granularjs/core";function Cn(...e){let{props:i,rawProps:r}=u(e,{total:1,size:"md"}),{page:t,total:a,size:n,className:s,...g}=i,{onChange:p}=r,h=Nn(c(t)??1);Ci(t).change(l=>{let k=c(l);k!=null&&h.set(k)});let v=l=>{let k=Number(c(a))||1,z=Math.max(1,Math.min(k,l));h.set(z),p?.(z)},y=[],f=Number(c(a))||1;for(let l=1;l<=f;l+=1)y.push(l);return zn({...g,className:o("g-ui-pagination",N("g-ui-pagination-size-",n,"md"),i.className??s)},fr({className:"g-ui-pagination-item",onClick:()=>v((h.get?.()??h)-1),disabled:Ci(h).compute(l=>l<=1)},"<"),y.map(l=>fr({className:Ci(h).compute(k=>o("g-ui-pagination-item",l===k&&"g-ui-pagination-item-active")),onClick:()=>v(l)},String(l))),fr({className:"g-ui-pagination-item",onClick:()=>v((h.get?.()??h)+1),disabled:Ci(h).compute(l=>l>=a)},">"))}import{Div as Sn,Input as Dn,Label as Pn,Span as mt,when as ft}from"@granularjs/core";function Mn(...e){let{props:i}=u(e,{size:"md"}),{label:r,description:t,size:a,className:n,inputProps:s,...g}=i,p=Pn({className:"g-ui-radio-control"},Dn({type:"radio",className:o("g-ui-radio-input",N("g-ui-radio-size-",a,"md"),s?.className),...g}),ft(r,()=>mt({className:"g-ui-radio-label"},r)));return Sn({className:o("g-ui-radio",N("g-ui-radio-size-",a,"md"),n)},p,ft(t,()=>mt({className:"g-ui-radio-description"},t)))}import{Div as Tn}from"@granularjs/core";function Vn(...e){let{props:i,children:r}=u(e),{className:t,...a}=i;return Tn({...a,className:o("g-ui-stack g-ui-gap-sm",t)},r)}import{Nav as Ln,Span as In}from"@granularjs/core";function $n(...e){let{props:i,children:r}=u(e,{separator:"/"}),{separator:t,className:a,...n}=i,s=[];Array.isArray(r)?s.push(...r):s.push(r);let g=s.filter(Boolean),p=[];return g.forEach((h,v)=>{p.push(h),v<g.length-1&&p.push(In({className:"g-ui-breadcrumbs-separator"},t))}),Ln({...n,className:o("g-ui-breadcrumbs",a)},p)}import{Div as An}from"@granularjs/core";function Bn(...e){let{props:i,children:r}=u(e),{className:t,...a}=i;return An({...a,className:o("g-ui-center",t)},r)}import{Div as Fn}from"@granularjs/core";function jn(...e){let{props:i}=u(e,{size:"md"}),{size:r,className:t,...a}=i;return Fn({...a,className:o("g-ui-space",[r,n=>`g-ui-space-${n}`],t)})}import{Div as En,when as Rn}from"@granularjs/core";function Hn(...e){let{props:i,children:r}=u(e),{opened:t,className:a,...n}=i;return Rn(t,()=>En({...n,className:o("g-ui-collapse",a)},r))}import{Button as On}from"@granularjs/core";function Ee(...e){let{props:i,children:r}=u(e,{size:"md",variant:"filled"}),{size:t,variant:a,color:n,className:s,...g}=i;return On({...g,type:"button",className:o("g-ui-action-icon",N("g-ui-action-icon-size-",t,"md"),N("g-ui-action-icon-color-",n,"primary"),N("g-ui-action-icon-",a,"filled"),s)},r)}import{Div as vr,when as Yn,after as qn,state as Gn}from"@granularjs/core";function hr(...e){let{props:i,rawProps:r,children:t}=u(e,{position:"left"}),{opened:a,position:n,content:s,className:g,...p}=i,{onChange:h}=r,v=Gn(c(a)??!1);qn(a).change(f=>{let l=c(f);l!=null&&v.set(!!l)});let y=f=>{v.set(f),h?.(f)};return vr({...p,className:o("g-ui-popover",i.className??g)},vr({onClick:()=>y(!v.get())},t),Yn(v,()=>vr({className:o("g-ui-popover-dropdown",n==="right"&&"g-ui-popover-right",n==="center"&&"g-ui-popover-center")},s)))}import{Div as vt}from"@granularjs/core";function Wn(...e){let{props:i,children:r}=u(e,{position:"left"}),{position:t,content:a,className:n,...s}=i;return vt({...s,className:o("g-ui-hover-card",n)},r,vt({className:o("g-ui-hover-card-dropdown",[t,g=>g==="right"?"g-ui-hover-card-right":""],[t,g=>g==="center"?"g-ui-hover-card-center":""])},a))}import{Div as Zn}from"@granularjs/core";function Un(...e){let{props:i,children:r}=u(e,{position:"bottom-right"}),{position:t,className:a,...n}=i;return Zn({...n,className:o("g-ui-affix",[t,s=>`g-ui-affix-${s}`],a)},r)}import{Fieldset as Xn,Legend as _n,when as Kn}from"@granularjs/core";function Qn(...e){let{props:i,children:r}=u(e),{legend:t,className:a,...n}=i;return Xn({...n,className:o("g-ui-fieldset",a)},Kn(t,()=>_n({className:"g-ui-legend"},t)),r)}import{Div as Jn}from"@granularjs/core";function es(...e){let{props:i,children:r}=u(e,{position:"sticky"}),{position:t,className:a,...n}=i;return Jn({...n,className:o("g-ui-appbar",N("g-ui-appbar-",t,"sticky"),a)},r)}import{Div as br,portal as is,after as Si,state as ht,when as bt}from"@granularjs/core";function rs(...e){let{props:i,children:r}=u(e,{position:"left",size:"md",blur:!0,fixed:!1,minWidth:"button"});return bt(i.fixed,()=>as(i,r),()=>ts(i,r))}var ts=(e,i)=>{let{open:r,onClose:t,position:a,size:n,blur:s,fixed:g,minWidth:p,className:h,...v}=e,y=ht(!1),f=ht(!1),l=220,k=M=>{if(M){y.set(!0),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>f.set(!0)):setTimeout(()=>f.set(!0),0);return}f.set(!1),setTimeout(()=>y.set(!1),l)};k(!!r.get()),Si(r).change(M=>k(!!M));let z=Si(f,s).compute(M=>{let[S,L]=M;return o("g-ui-sidebar-overlay",S&&"g-ui-sidebar-overlay-open",!L&&"g-ui-sidebar-overlay-noblur")}),B=Si(n,a,f,h).compute(M=>{let[S,L,I,b]=M,w=L==="right"?"g-ui-sidebar-drawer-right g-ui-sidebar-position-right":"g-ui-sidebar-drawer-left";return o("g-ui-sidebar","g-ui-sidebar-drawer",`g-ui-sidebar-size-${S}`,w,I&&"g-ui-sidebar-drawer-open",c(b))});return bt(y,()=>is(br({className:z,onClick:t},br({className:B,onClick:M=>M.stopPropagation()},i))))},as=(e,i)=>{let{open:r,position:t,size:a,minWidth:n,className:s,...g}=e,p=Si(a,t,r,n,s).compute(h=>{let[v,y,f,l,k]=h,z=l||"button",B=null;return z==="button"?B="g-ui-sidebar-min-button":z==="xs"?B="g-ui-sidebar-min-xs":z==="sm"?B="g-ui-sidebar-min-sm":z==="md"&&(B="g-ui-sidebar-min-md"),o("g-ui-sidebar g-ui-sidebar-fixed",`g-ui-sidebar-size-${v||"md"}`,B,f&&"g-ui-sidebar-fixed-open",k)});return br({...g,className:p},i)};import{Div as Ge,when as xt}from"@granularjs/core";function os(...e){let{props:i}=u(e,{items:[]}),{items:r,className:t,...a}=i;return Ge({...a,className:o("g-ui-timeline",t)},r.map(n=>Ge({className:"g-ui-timeline-item"},Ge({className:"g-ui-timeline-dot"}),Ge({className:"g-ui-timeline-content"},xt(n.title,()=>Ge({className:"g-ui-timeline-title"},n.title)),xt(n.description,()=>Ge({className:"g-ui-timeline-desc"},n.description)),n.content))))}import{Div as Di,list as ns}from"@granularjs/core";function ss(...e){let{props:i}=u(e,{active:0,items:[]}),{active:r,items:t,className:a,...n}=i;return Di({...n,className:o("g-ui-stepper",a)},ns(t,(s,g)=>Di({className:o("g-ui-stepper-item",[r,p=>(console.log("value",p,"idx",g),g.get()===p?"g-ui-stepper-active":"")])},Di({className:"g-ui-stepper-index"},String(g+1)),Di({className:"g-ui-stepper-label"},s.label))))}import{Span as wt,after as yt,state as us}from"@granularjs/core";function gs(...e){let{props:i,rawProps:r}=u(e,{value:0,max:5,size:"md"}),{value:t,max:a,size:n,className:s,...g}=i,{onChange:p}=r,h=us(c(t));yt(t).change(l=>{let k=c(l);k!=null&&h.set(k)});let v=l=>{h.set(l),p?.(l)},y=[],f=Number(c(a))||0;for(let l=1;l<=f;l+=1)y.push(l);return wt({...g,className:o("g-ui-rating",N("g-ui-rating-size-",n,"md"),i.className??s)},y.map(l=>wt({className:o("g-ui-rating-item",yt(h).compute(k=>l<=k?"g-ui-rating-item-active":"")),onClick:()=>v(l)},"\u2605")))}import{Span as ls}from"@granularjs/core";function cs(...e){let{props:i,children:r}=u(e),{className:t,...a}=i;return ls({...a,className:o("g-ui-tag",t)},r)}import{Button as kt,Div as We,state as zt,after as Pi}from"@granularjs/core";var ps=["S","M","T","W","T","F","S"];function ai(...e){let{props:i,rawProps:r}=u(e,{size:"md"}),{value:t,className:a,size:n,...s}=i,{onChange:g}=r,p=S=>{let L=c(S);if(L instanceof Date)return L;if(L==null)return null;let I=new Date(L);return Number.isNaN(I.getTime())?null:I},h=zt(p(t)??new Date),v=zt(new Date(h.get()));Pi(t).change(S=>{let L=p(S);L!=null&&(h.set(L),v.set(new Date(L)))});let y=(S,L,I)=>{let b=new Date(S,L+1,0).getDate();return new Date(S,L,Math.min(I,b))},f=S=>{let L=v.get(),I=y(L.getFullYear(),L.getMonth(),S);h.set(I),v.set(I),g?.(I)},l=S=>{let L=v.get(),I=y(L.getFullYear(),L.getMonth()+S,L.getDate());v.set(I)},k=S=>{let L=v.get(),I=y(L.getFullYear()+S,L.getMonth(),L.getDate());v.set(I)},z=Pi(v).compute(S=>S.toLocaleString("default",{month:"long"})),B=Pi(v).compute(S=>String(S.getFullYear())),M=Pi(v,h).compute(([S,L])=>{let I=S.getFullYear(),b=S.getMonth(),m=new Date(I,b,1).getDay(),C=new Date(I,b+1,0).getDate(),T=[];for(let $=0;$<m;$+=1)T.push({muted:!0,label:""});for(let $=1;$<=C;$+=1)T.push({label:$});return[...ps.map($=>We({className:"g-ui-calendar-cell g-ui-calendar-cell-muted"},$)),...T.map($=>We({className:o("g-ui-calendar-cell",$.muted&&"g-ui-calendar-cell-muted",$.label&&L.getFullYear()===I&&L.getMonth()===b&&$.label===L.getDate()&&"g-ui-calendar-cell-active"),onClick:()=>$.label&&f($.label)},$.label))]});return We({...s,className:o("g-ui-calendar",a,N("g-ui-calendar-size-",n,"md"))},We({className:"g-ui-calendar-header"},Ee({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>l(-1)},we({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:bi})),We({className:"g-ui-calendar-title-group"},kt({type:"button",className:"g-ui-calendar-title-button",onClick:()=>l(1)},z),kt({type:"button",className:"g-ui-calendar-title-button",onClick:()=>k(1)},B)),Ee({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>l(1)},we({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:hi}))),We({className:"g-ui-calendar-grid"},M))}import{Div as oi,Span as Ze,Input as ds,when as xr,after as ze,state as Mi}from"@granularjs/core";function ms(...e){let{props:i,rawProps:r}=u(e,{data:[],size:"md",searchable:!0}),{value:t,data:a,size:n,className:s,placeholder:g,searchable:p,...h}=i,{onChange:v,onSearchChange:y}=r,f=Mi(c(t)??[]),l=Mi(""),k=Mi(!1),z=Mi(null),B=m=>(c(m)??[]).map(T=>typeof T=="string"?{value:T,label:T}:T&&typeof T=="object"?T:{value:String(T),label:String(T)});ze(t).change(m=>{let C=c(m);C!=null&&f.set(C)});let M=null;ze(k).change(m=>{if(M&&(M(),M=null),!m)return;let C=T=>{let $=z.get();$&&($.contains(T.target)||k.set(!1))};document.addEventListener("mousedown",C),M=()=>document.removeEventListener("mousedown",C)}),ze(l).change(m=>{y?.(m)});let S=m=>{let C=f.get()??[],T=C.includes(m)?C.filter($=>$!==m):C.concat(m);f.set(T),v?.(T)},L=ze(a).compute(m=>B(m)),I=ze(L,l).compute(([m,C])=>{let T=String(c(C)??"").toLowerCase().trim();return T?m.filter($=>String($.label??"").toLowerCase().includes(T)):m}),b=ze(f,l).compute(([m,C])=>{let T=c(m)??[],$=String(c(C)??"");return!T.length&&!$}),w=ze(p).compute(m=>!!m);return oi({...h,node:z,className:o("g-ui-select-multi-root",s)},oi({className:o("g-ui-select-multi",N("g-ui-select-multi-size-",n,"md")),onClick:()=>k.set(!0)},ze(L,f).compute(([m,C])=>(c(C)??[]).map($=>{let oe=(m??[]).find(ee=>ee.value===$)?.label??$;return Ze({className:"g-ui-select-tag"},Ze({className:"g-ui-select-tag-label",onClick:ee=>{ee?.stopPropagation?.()}},oe),Ze({className:"g-ui-select-tag-remove",innerHTML:Ye,onClick:ee=>{ee?.stopPropagation?.(),S($)}}))})),xr(b,()=>Ze({className:"g-ui-select-multi-placeholder"},g??"Select...")),xr(w,()=>ds({className:"g-ui-select-multi-input",value:l,onInput:m=>l.set(m.target?.value??""),onFocus:()=>k.set(!0)}))),xr(k,()=>oi({className:"g-ui-select-dropdown"},ze(I).compute(m=>m.length?m.map(C=>oi({className:o("g-ui-select-item",C.disabled&&"g-ui-select-item-disabled",ze(f).compute(T=>(c(T)??[]).includes(C.value)?"g-ui-select-item-active":"")),onClick:()=>{C.disabled||S(C.value)}},Ze({className:"g-ui-select-item-check",innerHTML:ze(f).compute(T=>(c(T)??[]).includes(C.value)?xi:"")}),Ze({className:"g-ui-select-item-label"},C.label))):oi({className:"g-ui-select-item"},"Nothing found")))))}import{Div as ni,when as Nt}from"@granularjs/core";function fs(...e){let{props:i}=u(e,{items:[]}),{items:r,className:t,onClose:a,timeout:n,...s}=i;return ni({...s,className:o("g-ui-toast-stack",t)},r.map(g=>ni({className:o("g-ui-toast",[n,"g-ui-toast-auto"])},ni({className:"g-ui-toast-row"},Nt(g.title,()=>ni({className:"g-ui-toast-title"},g.title)),Nt(a,()=>ni({className:"g-ui-toast-close",onClick:()=>a(g)},"\xD7"))),g.message)))}function vs(...e){let{props:i}=u(e);return ai(i)}import{Div as hs,after as bs}from"@granularjs/core";function xs(...e){let{props:i,rawProps:r}=u(e,{items:[],position:"top-right"}),{items:t,position:a,className:n,...s}=i,{onRemove:g}=r,p=new Map,h=(y,f)=>y?.id??y?.key??f,v=bs(t).compute(y=>{let f=c(y)??[],l=new Set;f.forEach((k,z)=>{let B=h(k,z);if(l.add(B),k?.autoClose&&!p.has(B)){let M=setTimeout(()=>{p.delete(B),g?.(k)},k.autoClose);p.set(B,M)}});for(let[k,z]of p.entries())l.has(k)||(clearTimeout(z),p.delete(k));return f.map((k,z)=>sr({key:h(k,z),title:k.title,color:k.color,icon:k.icon,loading:k.loading,withCloseButton:k.withCloseButton,withBorder:k.withBorder,onClose:()=>{k.onClose?.(),g?.(k)}},k.message??k.body??k.content??k.text))});return hs({...s,className:o("g-ui-notifications",N("g-ui-notifications-position-",a,"top-right"),n)},v)}import{Div as Ue,after as si,state as ws,when as ys}from"@granularjs/core";function ks(...e){let{props:i,rawProps:r}=u(e,{min:0,max:100,step:1,size:"md"}),{value:t,marks:a,min:n,max:s,step:g,size:p,disabled:h,className:v,...y}=i,{onChange:f}=r,l=ws(c(t??[n,s])),k=()=>{let b=Number(c(n)),w=Number(c(s));return!Number.isFinite(b)||!Number.isFinite(w)?{minValue:0,maxValue:100}:{minValue:Math.min(b,w),maxValue:Math.max(b,w)}},z=()=>{let b=Number(c(g));return Number.isFinite(b)&&b>0?b:1},B=b=>{let{minValue:w,maxValue:m}=k(),C=z(),T=[w,m];Array.isArray(b)&&(T=b);let $=Math.max(w,Math.min(m,Number(T[0]))),U=Math.max(w,Math.min(m,Number(T[1]))),oe=Math.round(Math.min($,U)/C)*C,ee=Math.round(Math.max($,U)/C)*C;return[oe,ee]};si(t).change(b=>{b!=null&&l.set(B(b))});let M=b=>{let w=B(b);w?.[0]===l.get()?.[0]&&w?.[1]===l.get()?.[1]||(l.set(w),f?.(w))},S=si(l).compute(b=>{let{minValue:w,maxValue:m}=k(),C=m-w,[T,$]=B(b);if(C<=0)return{lowPct:0,highPct:0};let U=(T-w)/C*100,oe=($-w)/C*100;return{lowPct:Math.max(0,Math.min(100,U)),highPct:Math.max(0,Math.min(100,oe))}}),L=(b,w,m)=>{let C=w?.();if(!C||C.width===0)return;let $=Math.min(Math.max(b.clientX-C.left,0),C.width)/C.width,{minValue:U,maxValue:oe}=k(),ee=U+$*(oe-U),ne=l;typeof l.get=="function"&&(ne=l.get());let[J,se]=B(ne);M(m==="low"?[ee,se]:[J,ee])},I=(b,w,m)=>{if(xe(h))return;b.preventDefault?.();let C=m||b.currentTarget,T=()=>C.getBoundingClientRect(),$=T(),U=S;typeof S.get=="function"&&(U=S.get());let{lowPct:oe,highPct:ee}=U,ne=(b.clientX-$.left)/$.width*100,J=w;if(!J){let re=Math.abs(ne-oe)<=Math.abs(ne-ee);J="high",re&&(J="low")}C.setPointerCapture?.(b.pointerId),L(b,T,J);let se=re=>L(re,T,J),ge=()=>{C.releasePointerCapture?.(b.pointerId),window.removeEventListener("pointermove",se),window.removeEventListener("pointerup",ge)};window.addEventListener("pointermove",se),window.addEventListener("pointerup",ge)};return Ue({...y,className:o("g-ui-range-slider",N("g-ui-slider-size-",p,"md"),G("g-ui-slider-disabled",h),i.className??v)},Ue({className:"g-ui-slider-track",onPointerDown:b=>I(b)},Ue({className:"g-ui-slider-bar",style:si(S).compute(({lowPct:b,highPct:w})=>({left:`${b}%`,width:`${Math.max(0,w-b)}%`}))}),Ue({className:"g-ui-slider-thumb",style:si(S).compute(({lowPct:b})=>({left:`${b}%`})),onPointerDown:b=>{b.stopPropagation?.(),I(b,"low",b.currentTarget.parentElement)}}),Ue({className:"g-ui-slider-thumb",style:si(S).compute(({highPct:b})=>({left:`${b}%`})),onPointerDown:b=>{b.stopPropagation?.(),I(b,"high",b.currentTarget.parentElement)}})),ys(a,()=>Ue({className:"g-ui-slider-marks"},a.map(b=>dr({mark:b,getBounds:k})))))}import{state as wr,after as Ct}from"@granularjs/core";function Ti(...e){let{props:i,rawProps:r}=u(e,{size:"md",format:{pattern:"dddd-dd-dd"}}),{value:t,size:a,calendarSize:n,leftSection:s,rightSection:g,className:p,format:h,minDate:v,maxDate:y,...f}=i,{onChange:l}=r,k=w=>{let m=c(w);if(m instanceof Date)return m;if(m==null||m==="")return null;let C=new Date(m);return Number.isNaN(C.getTime())?null:C},z=(w,m)=>w&&m&&w.getFullYear()===m.getFullYear()&&w.getMonth()===m.getMonth()&&w.getDate()===m.getDate(),B=w=>{if(!w)return"";let m=String(w.getFullYear()).padStart(4,"0"),C=String(w.getMonth()+1).padStart(2,"0"),T=String(w.getDate()).padStart(2,"0");return`${m}-${C}-${T}`},M=w=>{let m=String(w??"").replace(/\D/g,"");if(m.length<8)return null;let C=Number(m.slice(0,4)),T=Number(m.slice(4,6)),$=Number(m.slice(6,8));if(!C||!T||!$)return null;let U=new Date(C,T-1,$);if(U.getFullYear()!==C||U.getMonth()!==T-1||U.getDate()!==$)return null;let oe=k(v);if(oe&&U<oe)return null;let ee=k(y);return ee&&U>ee?null:U},S=wr(k(t)),L=wr(B(S.get())),I=wr(!1);Ct(t).change(w=>{let m=k(w);if(!z(m,S.get())){if(m==null){S.set(null),L.set("");return}S.set(m),L.set(B(m))}}),Ct(L).change(w=>{let m=M(w);m&&(z(m,S.get())||(S.set(m),l?.(m)))});let b=w=>{w&&(z(w,S.get())||(S.set(w),L.set(B(w)),l?.(w),I.set(!1)))};return hr({opened:I,onChange:w=>I.set(!!w),content:ai({size:N("",n,"xs"),value:S,onChange:b}),className:"g-ui-date-input-popover"},fe({...f,size:a,className:o("g-ui-dateinput",p),leftSection:s,rightSection:g,type:"text",inputMode:"numeric",format:h,value:L,onChange:w=>L.set(w)}))}import{Div as yr,when as zs,after as Ns,state as Cs}from"@granularjs/core";function Ss(...e){let{props:i,rawProps:r,children:t}=u(e),{opened:a,content:n,className:s,...g}=i,{onChange:p}=r,h=Cs(c(a)??!1);Ns(a).change(y=>{let f=c(y);f!=null&&h.set(!!f)});let v=y=>{h.set(y),p?.(y)};return yr({...g,className:o("g-ui-popper",s)},yr({onClick:()=>v(!h.get())},t),zs(h,()=>yr({className:"g-ui-popper-dropdown"},n)))}import{Button as Ds,after as St,when as Ps,state as Ms}from"@granularjs/core";function Ts(...e){let{props:i,rawProps:r}=u(e,{size:"md"}),{size:t,className:a,rightSection:n,...s}=i,{onChange:g}=r,p=Ms(!1),h=St(p).compute(y=>y?"text":"password"),v=St(n).compute(y=>y??Ds({className:"g-ui-password-toggle",onClick:()=>p.set(!p.get())},Ps(p,()=>"Hide",()=>"Show")));return fe({...s,size:t,className:a,onChange:g,rightSection:v,type:h})}import{Div as Vs}from"@granularjs/core";function Ls(...e){let{props:i}=u(e,{size:"md"}),{size:r,className:t,...a}=i;return fe({...a,size:r,className:t,leftSection:Vs({className:"g-ui-search-input-left-section",innerHTML:qr}),type:"text",inputMode:"search"})}import{Button as Is,after as $s,when as Dt}from"@granularjs/core";import{state as As}from"@granularjs/core";function Bs(...e){let{props:i,children:r}=u(e,{value:"",timeout:1500}),{value:t,timeout:a,className:n,...s}=i,g=As(!1),p=$s(g).compute(v=>o("g-ui-copy-button",v&&"g-ui-copy-button-done",n));return Is({...s,className:p,onClick:async()=>{try{await navigator.clipboard.writeText(String(t)),g.set(!0),setTimeout(()=>g.set(!1),a)}catch{}},type:"button"},Dt(r?.length,()=>r,()=>Dt(g,()=>"Copied",()=>"Copy")))}import{Div as Pt,after as ui,resolve as Fs}from"@granularjs/core";function Mt(e){let i=Number(e);return Number.isNaN(i)?0:Math.max(0,Math.min(100,i))}function js(...e){let{props:i}=u(e,{size:"md",value:null,color:"primary"}),{size:r,value:t,color:a,className:n,...s}=i,g=ui(t).compute(f=>f!=null&&f!==""),p=ui(t).compute(f=>Mt(f)),h=ui(p,g).compute(([f,l])=>{if(!l)return{};let k=Number(f),z=Number.isNaN(k)?0:Math.max(0,Math.min(360,k*3.6));return{background:`conic-gradient(var(--g-ui-progress-ring-fill, var(--g-ui-primary)) 0deg ${z}deg, var(--g-ui-border-muted) ${z}deg 360deg)`}}),v=ui(g).compute(f=>f?"":"g-ui-progress-ring-indeterminate"),y=ui(g,t).compute(([f,l])=>f?Mt(l):void 0);return Pt({...s,className:o("g-ui-progress-ring",N("g-ui-progress-ring-",a,"primary"),[r,f=>`g-ui-progress-ring-size-${Fs(f)??"md"}`],v,n),style:h,role:"progressbar","aria-valuemin":0,"aria-valuemax":100,"aria-valuenow":y},Pt({className:"g-ui-progress-ring-hole"}))}import{Div as kr,Button as Es,when as Tt}from"@granularjs/core";function Rs(...e){let{props:i,children:r}=u(e),{title:t,onClose:a,className:n,...s}=i;return kr({...s,className:o("g-ui-toast",n)},kr({className:"g-ui-toast-row"},Tt(t,()=>kr({className:"g-ui-toast-title"},t)),Tt(a,()=>Es({className:"g-ui-toast-close",onClick:a},"\xD7"))),r)}import{Div as Vi,state as Nr,after as Re,list as Os,when as Ys}from"@granularjs/core";import{Div as Hs}from"@granularjs/core";function zr(...e){let{props:i,children:r}=u(e,{size:"md"}),{size:t,className:a,...n}=i;return Hs({...n,className:o("g-ui-scroll-area",[t,s=>`g-ui-scroll-area-${s}`],a)},r)}function Me(e,i){if(i==null||i==="")return e;let r=String(i).trim().split("."),t=e;for(let a of r)t=t?.[a];return t}function qs(e,i,r){let t=r(i);return String(t??"").toLowerCase().includes(String(e??"").toLowerCase())}function Cr(...e){let{props:i,rawProps:r}=u(e,{data:[],size:"md",valuePath:"value",labelPath:"label"}),{data:t,value:a,size:n,valuePath:s,labelPath:g,filter:p,placeholder:h,label:v,description:y,error:f,leftSection:l,rightSection:k,className:z,inputClassName:B,disabled:M,...S}=i,{onChange:L,renderItem:I}=r,b=Nr(!1),w=Nr(""),m=Nr(c(a));Re(a).change(x=>{let F=c(x);F!==m.get()&&m.set(F)});let C=Re(t).compute(x=>Array.isArray(x)?x:[]),T=Re(C,m,s).compute(([x,F,E])=>{if(F==null)return null;let Z=K=>E==null||E===""?K:Me(K,E);return x.find(K=>Z(K)===F)??null}),$=Re(T,b,w,g).compute(([x,F,E,Z])=>{let K=le=>Z==null||Z===""?String(le??""):String(Me(le,Z)??"");return F?E??"":x?K(x):""}),U=Re(C,w,p,g).compute(([x,F,E,Z])=>{let K=ve=>Z==null||Z===""?String(ve??""):String(Me(ve,Z)??""),le=c(E)??qs;return x.filter(ve=>le(F,ve,K))}),oe=x=>{let F=c(s),E=F==null||F===""?x:Me(x,F);m.set(E),w.set(""),b.set(!1),L?.(E)},ee=()=>{if(c(M))return;b.set(!0);let x=T.get(),F=c(g),E=Z=>F==null||F===""?String(Z??""):String(Me(Z,F)??"");w.set(x?E(x):"")},ne=()=>{b.set(!1);let x=T.get(),F=c(g),E=Z=>F==null||F===""?String(Z??""):String(Me(Z,F)??"");w.set(x?E(x):"")},{onChange:J,...se}=S,ge={...se,size:n,label:v,description:y,error:f,leftSection:l,rightSection:k,placeholder:c(h)??void 0,disabled:M,value:$,onInput:x=>w.set(x?.target?.value??""),onFocus:ee,onClick:ee,onBlur:()=>setTimeout(()=>ne(),150)},re=x=>{let F=c(s);return F==null||F===""?x:Me(x,F)},P=x=>Re(m,s).compute(([F,E])=>(K=>E==null||E===""?K:Me(K,E))(x)===F?"g-ui-autocomplete-item-active":""),O=x=>{if(I&&typeof I=="function"){let F=I(x);if(F!=null)return Vi({className:o("g-ui-autocomplete-item",P(x)),onClick:()=>oe(x),role:"option"},F)}return Vi({className:o("g-ui-autocomplete-item",P(x)),onClick:()=>oe(x),role:"option"},Re(g).compute(F=>F==null||F===""?String(x??""):String(Me(x,F)??"")))};return Vi({className:o("g-ui-autocomplete",z,G("g-ui-autocomplete-disabled",M))},fe({...ge,className:o("g-ui-autocomplete-input-wrapper",ge.className),inputClassName:o("g-ui-autocomplete-input",B)}),Ys(b,()=>Vi({className:"g-ui-autocomplete-dropdown",role:"listbox"},zr({className:"g-ui-autocomplete-list",style:{maxHeight:"240px"}},Os(U,x=>O(x))))))}function Gs(...e){return Cr(...e)}import{Div as Ws,Span as Zs,state as Vt,after as Us}from"@granularjs/core";function Lt(e){let i=c(e);if(i instanceof Date)return i;if(i==null||i==="")return null;let r=new Date(i);return Number.isNaN(r.getTime())?null:r}function It(e){let i=c(e);if(i==null)return[null,null];let r=Array.isArray(i)?i:[i];return[Lt(r[0]),Lt(r[1])]}function $t(e,i){return!e||!i?e===i:e.getFullYear()===i.getFullYear()&&e.getMonth()===i.getMonth()&&e.getDate()===i.getDate()}function Xs(...e){let{props:i,rawProps:r}=u(e,{size:"md"}),{value:t,size:a,minDate:n,maxDate:s,className:g,placeholderMin:p,placeholderMax:h,...v}=i,{onChange:y}=r,[f,l]=It(t),k=Vt(f),z=Vt(l);Us(t).change(L=>{let[I,b]=It(L);$t(I,k.get())&&$t(b,z.get())||(k.set(I),z.set(b))});let B=()=>{let L=k.get(),I=z.get();y?.([L??null,I??null])},M=L=>{let I=z.get();L&&I&&L>I&&z.set(L),k.set(L),B()},S=L=>{let I=k.get();L&&I&&L<I&&k.set(L),z.set(L),B()};return Ws({...v,className:o("g-ui-range-picker",i.className??g)},Ti({...v,size:a,value:k,onChange:M,maxDate:z,placeholder:c(p)??void 0}),Zs({className:"g-ui-range-picker-separator"},"\u2013"),Ti({...v,size:a,value:z,onChange:S,minDate:k,placeholder:c(h)??void 0}))}import{Div as _s}from"@granularjs/core";function Ks(...e){let{props:i,children:r}=u(e,{align:"center",direction:"row"}),{direction:t,wrap:a,align:n,justify:s,gap:g,className:p,...h}=i;return _s({...h,className:o("g-ui-flex",[t,v=>v==="column"?"g-ui-flex-column":"g-ui-flex-row"],[a,"g-ui-flex-wrap"],[n,v=>v&&`g-ui-align-${v}`],[s,v=>v&&`g-ui-justify-${v}`],[g,v=>v&&`g-ui-gap-${v}`],p)},r)}import{A as Qs,Div as gi,Span as At,when as li,after as Bt,state as Js}from"@granularjs/core";function eu(...e){let{props:i,rawProps:r,children:t}=u(e,{variant:"subtle",childrenOffset:24}),{label:a,description:n,leftSection:s,rightSection:g,active:p,disabled:h,variant:v,childrenOffset:y,opened:f,defaultOpened:l,className:k,padding:z,...B}=i,{onClick:M,onChange:S}=r,L=t.length>0,I=Js(c(f)??c(l)??!1);Bt(f).change(m=>{let C=c(m);C!=null&&I.set(!!C)});let b=Bt(y).compute(m=>({paddingLeft:jr(c(m??24))??"24px"})),w=m=>{if(c(h)){m?.preventDefault?.();return}if(L){let C=!I.get();I.set(C),S?.(C)}M?.(m)};return gi({className:o("g-ui-navlink-root",k)},Qs({...B,className:o("g-ui-navlink",N("g-ui-navlink-variant-",v,"subtle"),G("g-ui-navlink-active",p),G("g-ui-navlink-disabled",h),N("g-ui-navlink-padding-",z,"md")),onClick:w},li(s,()=>At({className:"g-ui-navlink-section g-ui-navlink-left"},s)),gi({className:"g-ui-navlink-body"},li(a,()=>gi({className:"g-ui-navlink-label"},a)),li(n,()=>gi({className:"g-ui-navlink-description"},n))),li(g,()=>At({className:"g-ui-navlink-section g-ui-navlink-right"},g))),L?li(I,()=>gi({className:"g-ui-navlink-children",style:b},t)):null)}import{Div as Ft,when as iu}from"@granularjs/core";function ru(...e){let{props:i,children:r}=u(e,{show:!0,position:"top-right",color:"danger",size:"md"}),{show:t,position:a,color:n,size:s,className:g,...p}=i;return Ft({...p,className:o("g-ui-indicator",N("g-ui-indicator-position-",a,"top-right"),N("g-ui-indicator-color-",n,"danger"),N("g-ui-indicator-size-",s,"md"),g)},r,iu(t,()=>Ft({className:"g-ui-indicator-badge"})))}import{Span as Li}from"@granularjs/core";function tu(...e){let{props:i}=u(e),{opened:r,className:t,...a}=i;return Li({...a,className:o("g-ui-burger",[r,"g-ui-burger-open"],t)},Li(""),Li(""),Li(""))}import{Div as au,when as ou}from"@granularjs/core";function nu(...e){let{props:i}=u(e),{visible:r,...t}=i;return ou(r,()=>au({...t,className:"g-ui-loading-overlay"},ei({})))}import{Div as su}from"@granularjs/core";function uu(...e){let{props:i,children:r}=u(e,{gap:"md"}),{className:t,gap:a,...n}=i;return su({...n,className:o("g-ui-grid-system",[a,s=>`g-ui-gap-${s}`],t)},r)}import{Div as gu}from"@granularjs/core";function lu(...e){let{props:i,children:r}=u(e,{span:12}),{span:t,className:a,...n}=i;return gu({...n,className:o([t,s=>`g-ui-col-span-${s}`],a)},r)}import{Div as jt,Input as cu,after as Te,state as Sr,when as Et,list as pu}from"@granularjs/core";function du(...e){let{props:i,rawProps:r}=u(e,{length:4,size:"md",type:"alphanumeric",mask:!1,placeholder:"\u25CB",disabled:!1,error:!1,oneTimeCode:!1}),{length:t,value:a,size:n,type:s,mask:g,placeholder:p,disabled:h,error:v,oneTimeCode:y,className:f}=i,{onChange:l,onComplete:k}=r,z=Sr(c(t)??4),B=()=>z.get();Te(t).change(P=>{let O=c(P)??4,x=z.get();if(O===x)return;z.set(O);let F=S.get(),E=M.get();S.set(Array.from({length:O},(Z,K)=>F[K]??"")),M.set(Array.from({length:O},(Z,K)=>E[K]??null))});let M=Sr(Array.from({length:B()},()=>null)),S=Sr(Array.from({length:B()},(P,O)=>{let x=c(a);return typeof x=="string"||Array.isArray(x)?x[O]??"":""}));Te(a).change(P=>{if(P==null)return;let O=B();typeof P=="string"?S.set(Array.from({length:O},(x,F)=>P[F]??"")):Array.isArray(P)&&S.set(Array.from({length:O},(x,F)=>P[F]??""))});let L=()=>S.get().join(""),I=P=>{S.set(P);let O=P.join("");l?.(O),P.every(x=>x!=="")&&P.length===B()&&k?.(O)},b=P=>{let O=B(),x=M.get();P>=0&&P<O&&x[P]&&(x[P].focus(),x[P].select())},w=()=>{let P=c(s);return P==="number"?/^[0-9]$/:P instanceof RegExp?P:/^[a-zA-Z0-9]$/},m=(P,O)=>{let x=O.target.value,F=w();if(x.length>1){C(P,x);return}if(x&&!F.test(x)){O.target.value=S.get()[P]??"";return}let E=S.get().slice();E[P]=x,I(E),x&&P<B()-1&&b(P+1)},C=(P,O)=>{let x=w(),F=O.split("").filter(le=>x.test(le)),E=S.get().slice(),Z=B();F.forEach((le,ve)=>{let Se=P+ve;Se<Z&&(E[Se]=le)}),I(E);let K=E.findIndex((le,ve)=>ve>=P&&le==="");K>=0?b(K):b(Math.min(P+F.length,Z-1))},T=(P,O)=>{if(O.key==="Backspace"){let x=S.get().slice();x[P]===""&&P>0?(O.preventDefault(),x[P-1]="",I(x),b(P-1)):x[P]!==""&&(x[P]="",I(x))}else O.key==="ArrowLeft"&&P>0?(O.preventDefault(),b(P-1)):O.key==="ArrowRight"&&P<B()-1&&(O.preventDefault(),b(P+1))},$=(P,O)=>{O.target.select()},U=()=>{let P=S.get(),O=P.findIndex(x=>x==="");O>=0?b(O):b(P.length-1)},oe=Te(g).compute(P=>c(P)?"password":"text"),ee=Te(s).compute(P=>c(P)==="number"?"numeric":"text"),ne=Te(y).compute(P=>c(P)?"one-time-code":"off"),J=Te(h).compute(P=>!!c(P)),se=Te(v).compute(P=>!!c(P)),ge=Te(z).compute(P=>Array.from({length:P},(O,x)=>x)),re=P=>cu({className:o("g-ui-pin-input-field",Et(se,()=>"g-ui-pin-input-error")),type:oe,inputMode:ee,autocomplete:ne,maxLength:2,placeholder:Et(J,()=>"",()=>p),disabled:J,value:Te(S,P).compute(([O,x])=>O[x]??""),node:M[P.get()],onInput:O=>m(P.get(),O),onChange:O=>m(P.get(),O),onKeyDown:O=>T(P.get(),O),onFocus:O=>$(P.get(),O)});return jt({className:o("g-ui-pin-input",N("g-ui-input-size-",n,"md"),f),onClick:U},jt({className:"g-ui-pin-input-wrapper"},pu(ge,re)))}import{Div as mu}from"@granularjs/core";function fu(...e){let{props:i,children:r}=u(e),{className:t,...a}=i;return mu({...a,className:o("g-ui-checkbox-group",t)},r)}import{Div as vu}from"@granularjs/core";function hu(...e){let{props:i,children:r}=u(e),{className:t,...a}=i;return vu({...a,className:o("g-ui-avatar-group",t)},r)}import{Div as bu}from"@granularjs/core";function xu(...e){let{props:i,children:r}=u(e),{className:t,...a}=i;return bu({...a,className:o("g-ui-badge-group",t)},r)}import{Div as Ii,Span as wu,after as ci,context as Rt}from"@granularjs/core";var yu=Rt([]),Ht=Rt({sort:null,onSort:null});function Dr(...e){let{props:i,rawProps:r,children:t}=u(e,{sizes:[],sort:null,stickyHeader:!1}),{className:a,sizes:n,sort:s,stickyHeader:g,...p}=i,{onSort:h}=r,v=yu.scope(n.get());ci(n).change(f=>v.set(f));let y=Ht.scope({sort:s.get(),onSort:h||null});return ci(s).change(f=>y.set().sort=f),v.serve(y.serve(Ii({className:o("g-ui-grid-table",G("g-ui-grid-table-sticky",g),a),style:{gridTemplateColumns:ci(v).compute(f=>Array.isArray(f)?f.join(" "):"")},...p},t)))}Dr.GridRow=(...e)=>{let{props:i,children:r}=u(e,{}),{className:t,header:a,...n}=i;return Ii({className:o("g-ui-grid-table-row",G("g-ui-grid-table-row-header",a),t),...n},...r)};Dr.GridCell=function(...e){let{props:i,rawProps:r,children:t}=u(e,{}),{className:a,sort:n,...s}=i,g=r.sort;if(g){let p=Ht.state(),h=ci(p.sort).compute(y=>y?.key===g?y.direction:null),v=()=>{let y=p.get().sort,f;y?.key===g?f=y.direction==="asc"?{key:g,direction:"desc"}:null:f={key:g,direction:"asc"},p.set().sort=f;let{onSort:l}=p.get();l&&l(f)};return Ii({className:o("g-ui-grid-table-cell","g-ui-grid-table-cell-sortable",a),onClick:v,...s},t,wu({className:"g-ui-grid-table-sort-icon"},ci(h).compute(y=>y==="asc"?" \u2191":y==="desc"?" \u2193":"")))}return Ii({className:o("g-ui-grid-table-cell",a),...s},t)};import{Button as ku,Div as zu,Span as Ot,when as Yt}from"@granularjs/core";function qt(...e){let{props:i,children:r}=u(e,{grow:!0}),{grow:t,className:a,...n}=i;return zu({...n,className:o("g-ui-bottombar",G("g-ui-bottombar-grow",t),a)},r)}qt.Action=function(...i){let{props:r,rawProps:t,children:a}=u(i,{variant:"subtle"}),{icon:n,label:s,active:g,disabled:p,variant:h,className:v,...y}=r,{onClick:f}=t;return ku({...y,className:o("g-ui-bottombar-action",N("g-ui-bottombar-action-variant-",h,"subtle"),G("g-ui-bottombar-action-active",g),G("g-ui-bottombar-action-disabled",p),v),onClick:f,disabled:p},Yt(n,()=>Ot({className:"g-ui-bottombar-action-icon"},n)),Yt(s,()=>Ot({className:"g-ui-bottombar-action-label"},s)),a)};import{Div as R,Button as He,state as ce,after as ye,when as pe,Input as $i,Label as pi,Span as Oe}from"@granularjs/core";var Nu=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],Cu=[{value:"day",label:"Day"},{value:"week",label:"Week"},{value:"month",label:"Month"}];function Ai(e){if(e instanceof Date)return e;if(e==null)return null;let i=new Date(e);return Number.isNaN(i.getTime())?null:i}function Zt(e){let i=Ai(e.start),r=Ai(e.end);return!i||!r?null:{...e,id:e.id??`${i.getTime()}-${e.title??"event"}`,title:e.title??"",start:i,end:r,allDay:!!e.allDay,description:e.description??"",location:e.location??"",attendees:Array.isArray(e.attendees)?e.attendees:[],color:e.color??null}}function Ut(e,i,r){let t=Ai(i).getTime(),a=Ai(r).getTime();return e.map(Zt).filter(Boolean).filter(n=>n.end.getTime()>t&&n.start.getTime()<a)}function Gt(e,i){let r=new Date(i);r.setHours(0,0,0,0);let t=r.getTime();r.setHours(23,59,59,999);let a=r.getTime();return Ut(e,t,a)}function Pr(e,i){let r=new Date(e),a=(r.getDay()-i+7)%7;return r.setDate(r.getDate()-a),r.setHours(0,0,0,0),r}function Xe(e,i="default"){return e.toLocaleTimeString(i,{hour:"numeric",minute:"2-digit",hour12:!0})}function di(e,i="default"){return e.toLocaleDateString(i,{weekday:"short",month:"short",day:"numeric"})}function Su(e,i="default"){return e.toLocaleDateString(i,{month:"long",year:"numeric"})}function Du(e,i="default"){let r=new Date(e);return r.setDate(r.getDate()+6),`${e.toLocaleDateString(i,{month:"short",day:"numeric"})} \u2013 ${r.toLocaleDateString(i,{month:"short",day:"numeric",year:"numeric"})}`}function Wt(e,i,r,t){let a=new Date(e).setHours(r,0,0,0),n=new Date(e).setHours(t,0,0,0),s=(t-r)*60,g=Math.max(e.getTime(),a),h=(Math.min(i.getTime(),n)-g)/6e4,v=(g-a)/6e4/s*100,y=h/s*100;return{top:v,height:y}}function Pu(...e){let{props:i,rawProps:r}=u(e,{defaultView:"month",firstDayOfWeek:0,locale:"default",hourSlotDuration:30,minTime:6,maxTime:22,eventCreationColorOptions:[]}),{events:t=[],defaultView:a,firstDayOfWeek:n,locale:s,hourSlotDuration:g,minTime:p,maxTime:h,eventCreationColorOptions:v,className:y,...f}=i,{onCreateEventRequest:l,onViewEventRequest:k,onUpdateEventRequest:z,onRemoveEventRequest:B,eventCreationEmailLookup:M,eventCreationLocationsCallback:S,eventCreationCalendarsCallback:L,onSlotClick:I,onDateRangeChange:b}=r,w=ce(c(a)??"month"),m=ce(new Date),C=ce(null),T=ce(null),$=ce({title:"",start:null,end:null,allDay:!1,description:"",location:"",attendees:[],color:null}),U=ye(t).compute(d=>Array.isArray(d)?d:[]),oe=m.get(),ee=Pr(oe,c(n)??0),ne=c(p)??6,J=c(h)??22,se=c(g)??30,ge=()=>{let d=new Date(m.get());w.get()==="month"?d.setMonth(d.getMonth()-1):w.get()==="week"?d.setDate(d.getDate()-7):d.setDate(d.getDate()-1),m.set(d),b?.({start:d,end:d,view:w.get()})},re=()=>{let d=new Date(m.get());w.get()==="month"?d.setMonth(d.getMonth()+1):w.get()==="week"?d.setDate(d.getDate()+7):d.setDate(d.getDate()+1),m.set(d),b?.({start:d,end:d,view:w.get()})},P=()=>{let d=new Date;m.set(d),b?.({start:d,end:d,view:w.get()})},O=(d,j,ue=!1)=>{let q=d?new Date(d):new Date(m.get()),te=j?new Date(j):new Date(q.getTime()+3600*1e3);ue&&(q.setHours(0,0,0,0),te.setHours(23,59,59,999)),$.set({title:"",start:q,end:te,allDay:ue,description:"",location:"",attendees:[],color:null}),C.set("create")},x=d=>{T.set(Zt(d)),C.set("view"),k?.(d)},F=()=>{let d=T.get();d&&($.set({title:d.title,start:new Date(d.start),end:new Date(d.end),allDay:d.allDay,description:d.description??"",location:d.location??"",attendees:[...d.attendees||[]],color:d.color??null}),C.set("edit"))},E=()=>{C.set(null),T.set(null)},Z=(d,j,ue)=>{if(I){I({date:d,hour:j,allDay:ue});return}let q=new Date(d);if(ue){q.setHours(0,0,0,0);let te=new Date(q);te.setHours(23,59,59,999),O(q,te,!0)}else{q.setHours(j,0,0,0);let te=new Date(q.getTime()+se*60*1e3);O(q,te,!1)}},K=()=>{let d=$.get();!d.start||!d.end||l?.({title:d.title,start:d.start,end:d.end,allDay:d.allDay,description:d.description,location:d.location,attendees:d.attendees,color:d.color},()=>{E()})},le=()=>{let d=T.get(),j=$.get();!d||!j.start||!j.end||z?.(d,{title:j.title,start:j.start,end:j.end,allDay:j.allDay,description:j.description,location:j.location,attendees:j.attendees,color:j.color},()=>E())},ve=()=>{let d=T.get();d&&B?.(d,()=>E())},Se=ye(w,m).compute(([d,j])=>d==="month"?Su(j,c(s)):d==="week"?Du(Pr(j,c(n)??0),c(s)):di(j,c(s))),Ie=R({className:"g-ui-event-calendar-header"},R({className:"g-ui-event-calendar-nav-group"},Ee({size:"sm",variant:"subtle",onClick:ge,className:"g-ui-event-calendar-nav"},we({size:"sm",innerHTML:bi})),Ee({size:"sm",variant:"subtle",onClick:re,className:"g-ui-event-calendar-nav"},we({size:"sm",innerHTML:hi})),He({type:"button",variant:"subtle",size:"sm",className:"g-ui-event-calendar-today",onClick:P},we({size:"sm",className:"g-ui-event-calendar-today-icon",innerHTML:Ur}),"Today")),R({className:"g-ui-event-calendar-title"},Se),R({className:"g-ui-event-calendar-actions"},Cu.map(d=>R({className:o("g-ui-event-calendar-view-option",ye(w).compute(j=>j===d.value?"g-ui-event-calendar-view-option-active":"")),onClick:()=>{w.set(d.value),b?.({start:m.get(),end:m.get(),view:d.value})}},d.label)),He({type:"button",variant:"filled",size:"sm",className:"g-ui-event-calendar-create-btn",onClick:()=>O(m.get(),null,!1)},we({size:"sm",innerHTML:Gr}),"Create"))),mi=ye(m,U,n).compute(([d,j,ue])=>{let q=d.getFullYear(),te=d.getMonth(),ie=(new Date(q,te,1).getDay()-(ue??0)+7)%7,Ce=new Date(q,te+1,0).getDate(),De=new Date(q,te,0).getDate(),V=[],D=1,H=1,Y=Math.ceil((ie+Ce)/7)*7,Q=[];for(let X=0;X<Y;X+=1){let W,_,ae;X<ie?(W=De-ie+X+1,ae=new Date(q,te-1,W),_=!1):D<=Ce?(W=D,ae=new Date(q,te,W),_=!0,D+=1):(W=H,ae=new Date(q,te+1,W),_=!1,H+=1);let he=Gt(j,ae),Ve=ae.getDate()===new Date().getDate()&&ae.getMonth()===new Date().getMonth()&&ae.getFullYear()===new Date().getFullYear();Q.push(R({key:ae.getTime(),className:o("g-ui-event-calendar-month-cell",!_&&"g-ui-event-calendar-month-cell-outside",Ve&&"g-ui-event-calendar-month-cell-today")},R({className:"g-ui-event-calendar-month-cell-header",onClick:()=>Z(ae,0,!0)},Oe({className:"g-ui-event-calendar-month-cell-day"},ae.getDate())),R({className:"g-ui-event-calendar-month-cell-events"},he.slice(0,3).map(ke=>R({key:ke.id,className:"g-ui-event-calendar-month-event",style:ke.color?{borderLeftColor:ke.color,backgroundColor:`${ke.color}20`}:{},onClick:Ri=>{Ri.stopPropagation(),x(ke)}},ke.title||"(No title)")),pe(he.length>3,()=>R({className:"g-ui-event-calendar-month-more",onClick:ke=>{ke.stopPropagation(),x(he[3])}},`+${he.length-3} more`)))))}return Q}),Bi=R({className:"g-ui-event-calendar-month"},R({className:"g-ui-event-calendar-weekdays"},Nu.map(d=>R({key:d,className:"g-ui-event-calendar-weekday"},d))),R({className:"g-ui-event-calendar-month-grid"},mi)),Ne=[];for(let d=ne;d<J;d+=1)for(let j=0;j<60;j+=se)Ne.push(d+j/60);let _e=ye(m,n).compute(([d,j])=>{let ue=Pr(d,j??0),q=[];for(let te=0;te<7;te+=1){let de=new Date(ue);de.setDate(de.getDate()+te),q.push(de)}return q}),Fi=R({className:"g-ui-event-calendar-week"},ye(_e).compute(d=>R({className:"g-ui-event-calendar-week-days"},R({className:"g-ui-event-calendar-week-time-col"},""),(d||[]).map(j=>R({key:j.getTime(),className:"g-ui-event-calendar-week-day-col"},R({className:"g-ui-event-calendar-week-day-header"},di(j,c(s))))))),R({className:"g-ui-event-calendar-week-body"},R({className:"g-ui-event-calendar-week-time-col"},Ne.map(d=>{let j=Math.floor(d),ue=(d-j)*60,q=`${j<=12?j:j-12}:${ue===0?"00":ue} ${j<12?"AM":"PM"}`;return R({key:d,className:"g-ui-event-calendar-week-slot-label"},q)})),ye(_e,U).compute(([d,j])=>{if(!d||!d.length)return null;let ue=d[0],q=new Date(d[6]);q.setHours(23,59,59,999);let te=Ut(j,ue,q);return R({className:"g-ui-event-calendar-week-grid-cols"},d.map(de=>R({key:de.getTime(),className:"g-ui-event-calendar-week-day-col g-ui-event-calendar-week-day-col-body"},Ne.map(ie=>R({key:ie,className:"g-ui-event-calendar-week-slot",onClick:()=>Z(de,ie,!1)})),te.filter(ie=>!ie.allDay&&ie.start.getDate()===de.getDate()&&ie.start.getMonth()===de.getMonth()&&ie.start.getFullYear()===de.getFullYear()).map(ie=>{let{top:Ce,height:De}=Wt(ie.start,ie.end,ne,J);return R({key:ie.id,className:"g-ui-event-calendar-week-event",style:{top:`${Ce}%`,height:`${De}%`,borderLeftColor:ie.color||"var(--g-ui-primary)"},onClick:V=>{V.stopPropagation(),x(ie)}},R({className:"g-ui-event-calendar-week-event-title"},ie.title||"(No title)"),pe(!ie.allDay,()=>Oe({className:"g-ui-event-calendar-week-event-time"},`${Xe(ie.start,c(s))} \u2013 ${Xe(ie.end,c(s))}`)))}))))}))),ji=R({className:"g-ui-event-calendar-day"},R({className:"g-ui-event-calendar-day-body"},R({className:"g-ui-event-calendar-day-time-col"},Ne.map(d=>{let j=Math.floor(d),ue=(d-j)*60,q=`${j<=12?j:j-12}:${ue===0?"00":ue} ${j<12?"AM":"PM"}`;return R({key:d,className:"g-ui-event-calendar-day-slot-label"},q)})),R({className:"g-ui-event-calendar-day-slots"},Ne.map(d=>R({key:d,className:"g-ui-event-calendar-day-slot",onClick:()=>Z(m.get(),d,!1)})),ye(U,m).compute(([d,j])=>j?Gt(d,j).filter(q=>!q.allDay).map(q=>{let{top:te,height:de}=Wt(q.start,q.end,ne,J);return R({key:q.id,className:"g-ui-event-calendar-day-event",style:{top:`${te}%`,height:`${de}%`,borderLeftColor:q.color||"var(--g-ui-primary)"},onClick:ie=>{ie.stopPropagation(),x(q)}},R({className:"g-ui-event-calendar-day-event-title"},q.title||"(No title)"),Oe({className:"g-ui-event-calendar-day-event-time"},`${Xe(q.start,c(s))} \u2013 ${Xe(q.end,c(s))}`))}):[])))),fi=d=>{let j=$.get(),ue=new Date,q=j.start||ue,te=j.end||new Date(ue.getTime()+3600*1e3),de=ce(j.title),ie=ce(q.toISOString().slice(0,10)),Ce=ce(!j.allDay&&q?q.toTimeString().slice(0,5):"09:00"),De=ce(te.toISOString().slice(0,10)),V=ce(!j.allDay&&te?te.toTimeString().slice(0,5):"10:00"),D=ce(j.allDay),H=ce(j.description),Y=ce(j.location),Q=ce(j.attendees||[]),X=ce(""),W=ce([]),_=ce([]),ae=ce(""),he=Array.isArray(v)?v:[],Ve=ce(j.color),ke=()=>{let A=new Date(ie.get()+"T"+(D.get()?"00:00:00":Ce.get()+":00")),be=new Date(De.get()+"T"+(D.get()?"23:59:59":V.get()+":00"));$.set({title:de.get(),start:A,end:be,allDay:D.get(),description:H.get(),location:Y.get(),attendees:Q.get(),color:Ve.get()})},Ri=A=>{if(X.set(A),!M||!A.trim()){W.set([]);return}Promise.resolve(M(A.trim())).then(be=>W.set(Array.isArray(be)?be:[])).catch(()=>W.set([]))},Xt=A=>{let be=Q.get();be.some(Tr=>(Tr.email||Tr.id)===(A.email||A.id))||(Q.set([...be,{id:A.id,email:A.email??A.label,label:A.label}]),X.set(""),W.set([]))},_t=A=>{let be=[...Q.get()];be.splice(A,1),Q.set(be)},Mr=()=>{S&&Promise.resolve(S(ae.get())).then(A=>_.set(Array.isArray(A)?A:[])).catch(()=>_.set([]))};return R({className:"g-ui-event-calendar-form"},R({className:"g-ui-event-calendar-form-row"},fe({label:"Title",placeholder:"Event title",value:de,onInput:A=>de.set(A?.target?.value??"")})),R({className:"g-ui-event-calendar-form-row g-ui-event-calendar-form-row-inline"},er({label:"All day",checked:D,onChange:A=>D.set(A)})),R({className:"g-ui-event-calendar-form-row g-ui-event-calendar-form-row-inline"},R({className:"g-ui-event-calendar-form-field"},pi({className:"g-ui-event-calendar-form-label"},"Start"),$i({type:"date",className:"g-ui-input g-ui-input-size-md",value:ie,onInput:A=>ie.set(A?.target?.value??"")}),pe(!D,()=>$i({type:"time",className:"g-ui-input g-ui-input-size-md",value:Ce,onInput:A=>Ce.set(A?.target?.value??"")}))),R({className:"g-ui-event-calendar-form-field"},pi({className:"g-ui-event-calendar-form-label"},"End"),$i({type:"date",className:"g-ui-input g-ui-input-size-md",value:De,onInput:A=>De.set(A?.target?.value??"")}),pe(!D,()=>$i({type:"time",className:"g-ui-input g-ui-input-size-md",value:V,onInput:A=>V.set(A?.target?.value??"")})))),pe(S,()=>R({className:"g-ui-event-calendar-form-row"},pi({className:"g-ui-event-calendar-form-label"},"Location"),fe({placeholder:"Search or type location",value:ae,onInput:A=>{ae.set(A?.target?.value??""),Mr()},onFocus:Mr}),pe(ye(_).compute(A=>A&&A.length>0),()=>R({className:"g-ui-event-calendar-form-suggestions"},_.get().map(A=>R({key:A.id??A.label,className:"g-ui-event-calendar-form-suggestion-item",onClick:()=>{Y.set(A.label??A.id),ae.set(""),_.set([])}},A.label??A.id)))),pe(ye(Y).compute(A=>!!A),()=>Oe({className:"g-ui-event-calendar-form-chip"},Y)))),pe(M,()=>R({className:"g-ui-event-calendar-form-row"},pi({className:"g-ui-event-calendar-form-label"},"Add guests"),fe({placeholder:"Type email to search",value:X,onInput:A=>Ri(A?.target?.value??"")}),R({className:"g-ui-event-calendar-form-chips"},Q.get().map((A,be)=>Oe({key:(A.email||A.id)+be,className:"g-ui-event-calendar-form-chip g-ui-event-calendar-form-chip-removable",onClick:()=>_t(be)},A.label||A.email||A.id," \xD7"))),pe(ye(W).compute(A=>A&&A.length>0),()=>R({className:"g-ui-event-calendar-form-suggestions"},W.get().map(A=>R({key:A.id??A.email,className:"g-ui-event-calendar-form-suggestion-item",onClick:()=>Xt(A)},A.label??A.email??A.id)))))),R({className:"g-ui-event-calendar-form-row"},Ui({label:"Description",placeholder:"Add description",value:H,onInput:A=>H.set(A?.target?.value??"")})),pe(he.length>0,()=>R({className:"g-ui-event-calendar-form-row"},pi({className:"g-ui-event-calendar-form-label"},"Color"),R({className:"g-ui-event-calendar-form-colors"},he.map(A=>R({key:A.value??A.id??A,className:o("g-ui-event-calendar-form-color-swatch",ye(Ve).compute(be=>be===(A.value??A.id??A)?"g-ui-event-calendar-form-color-swatch-active":"")),style:{backgroundColor:A.color??A.value??A},onClick:()=>Ve.set(A.value??A.id??A)}))))),R({className:"g-ui-event-calendar-form-actions"},He({variant:"subtle",onClick:E},"Cancel"),He({variant:"filled",onClick:()=>{ke(),d?le():K()}},d?"Save":"Create")))},Ei=()=>{let d=T.get();return d?R({className:"g-ui-event-calendar-view-modal"},R({className:"g-ui-event-calendar-view-modal-title"},d.title||"(No title)"),R({className:"g-ui-event-calendar-view-modal-meta"},d.allDay?Oe({className:"g-ui-event-calendar-view-modal-date"},di(d.start,c(s))+(d.start.getTime()!==d.end.getTime()?` \u2013 ${di(d.end,c(s))}`:"")):Oe({className:"g-ui-event-calendar-view-modal-date"},`${di(d.start,c(s))} \xB7 ${Xe(d.start,c(s))} \u2013 ${Xe(d.end,c(s))}`)),pe(d.location,()=>R({className:"g-ui-event-calendar-view-modal-field"},"Location: ",d.location)),pe(d.description,()=>R({className:"g-ui-event-calendar-view-modal-field"},d.description)),pe(d.attendees?.length,()=>R({className:"g-ui-event-calendar-view-modal-field"},"Guests: ",d.attendees.map(j=>j.label||j.email||j.id).join(", "))),R({className:"g-ui-event-calendar-view-modal-actions"},He({variant:"subtle",size:"sm",onClick:F},we({size:"sm",innerHTML:Wr})," Edit"),He({variant:"subtle",size:"sm",onClick:ve,className:"g-ui-event-calendar-view-modal-delete"},we({size:"sm",innerHTML:Zr})," Delete"),He({variant:"filled",size:"sm",onClick:E},"Close"))):null};return R({...f,className:o("g-ui-event-calendar",y)},Ie,pe(w,d=>d==="month",()=>Bi),pe(w,d=>d==="week",()=>Fi),pe(w,d=>d==="day",()=>ji),pe(C,d=>d==="create",()=>Je({opened:!0,title:"New event",size:"lg",onClose:E},fi(!1))),pe(C,d=>d==="view",()=>Je({opened:!0,title:"Event",size:"md",onClose:E},Ei())),pe(C,d=>d==="edit",()=>Je({opened:!0,title:"Edit event",size:"lg",onClose:E},fi(!0))))}import{state as Mu}from"@granularjs/core";function Tu(e=!1){let i=Mu(!!e);return[i,{open:()=>i.set(!0),close:()=>i.set(!1),toggle:()=>i.set(!i.get())}]}Lr();export{ko as Accordion,Ee as ActionIcon,Un as Affix,Eo as Alert,sn as Anchor,es as AppBar,Cr as Autocomplete,Yo as Avatar,hu as AvatarGroup,Aa as Badge,xu as BadgeGroup,Xo as Blockquote,qt as BottomBar,$n as Breadcrumbs,tu as Burger,Gi as Button,ai as Calendar,Ia as Card,Bn as Center,er as Checkbox,fu as CheckboxGroup,xn as Chip,Zo as Code,lu as Col,Hn as Collapse,Da as Container,Bs as CopyButton,Ti as DateInput,vs as DatePicker,$o as Divider,To as Drawer,Pu as EventCalendar,Qn as Fieldset,Ks as Flex,uu as Grid,Dr as GridTable,Va as Group,Wn as HoverCard,we as Icon,gn as Image,ru as Indicator,Go as Kbd,gt as List,ei as Loading,nu as LoadingOverlay,Do as Menu,Je as Modal,ms as MultiSelect,eu as NavLink,sr as Notification,xs as Notifications,Xi as NumberField,qa as NumberInput,Cn as Pagination,Bo as Paper,Ts as PasswordInput,du as PinInput,hr as Popover,Ss as Popper,ln as Progress,js as ProgressRing,Mn as Radio,Vn as RadioGroup,Xs as RangePicker,ks as RangeSlider,gs as Rating,zr as ScrollArea,Ls as SearchInput,kn as SegmentedControl,uo as Select,Gs as SelectSearch,rs as Sidebar,Ko as SimpleGrid,vn as Skeleton,dn as Slider,jn as Space,Ma as Stack,ss as Stepper,no as Switch,eo as SwitchGroup,bo as Table,po as Tabs,cs as Tag,Wi as Text,fe as TextInput,Ui as Textarea,os as Timeline,Ca as Title,Rs as Toast,fs as ToastStack,zo as Tooltip,G as classFlag,me as classMap,N as classVar,o as cx,da as getThemeMode,pa as setThemeMode,ca as setThemeVars,u as splitPropsChildren,Tu as useDisclosure};
