var ge="granular-ui-styles",nr=new URL("./fonts/Poppins-400.ttf",import.meta.url).href,gr=new URL("./fonts/Poppins-500.ttf",import.meta.url).href,ur=new URL("./fonts/Poppins-600.ttf",import.meta.url).href,lr=new URL("./fonts/Poppins-700.ttf",import.meta.url).href,cr=new URL("./fonts/Arimo-400.ttf",import.meta.url).href,pr=new URL("./fonts/Arimo-500.ttf",import.meta.url).href,dr=new URL("./fonts/Arimo-600.ttf",import.meta.url).href,mr=new URL("./fonts/Arimo-700.ttf",import.meta.url).href,fr=new URL("./fonts/Inter-400.woff2",import.meta.url).href,xr=new URL("./fonts/Inter-500.woff2",import.meta.url).href,hr=new URL("./fonts/Inter-600.woff2",import.meta.url).href,br=new URL("./fonts/Inter-700.woff2",import.meta.url).href,vr=`
@font-face {
  font-family: 'Poppins';
  font-style: normal;
  font-weight: 400;
...
`;function ue(){if(typeof document>"u"||document.getElementById(ge))return;let i=document.createElement("style");i.id=ge,i.textContent=vr,document.head.appendChild(i)}var wr=new Set(["--g-ui-bg","--g-ui-bg-subtle","--g-ui-bg-muted","--g-ui-bg-emphasized","--g-ui-bg-inverted","--g-ui-bg-panel","--g-ui-fg","--g-ui-fg-muted","--g-ui-fg-subtle","--g-ui-fg-inverted","--g-ui-border","--g-ui-border-subtle","--g-ui-border-emphasized","--g-ui-border-inverted","--g-ui-primary","--g-ui-primary-hover","--g-ui-primary-active","--g-ui-primary-subtle","--g-ui-primary-muted","--g-ui-primary-emphasized","--g-ui-success","--g-ui-success-hover","--g-ui-success-active","--g-ui-success-subtle","--g-ui-success-muted","--g-ui-danger","--g-ui-danger-hover","--g-ui-danger-active","--g-ui-danger-subtle","--g-ui-danger-muted","--g-ui-warning","--g-ui-warning-hover","--g-ui-warning-active","--g-ui-warning-subtle","--g-ui-warning-muted","--g-ui-info","--g-ui-info-hover","--g-ui-info-active","--g-ui-info-subtle","--g-ui-info-muted","--g-ui-shadow-xs","--g-ui-shadow-sm","--g-ui-shadow-md","--g-ui-shadow-lg","--g-ui-shadow-xl","--g-ui-shadow-2xl","--g-ui-radius","--g-ui-font","--g-ui-surface","--g-ui-text","--g-ui-muted","--g-ui-primary-strong","--g-ui-shadow"]);function yr(i={},e=document?.documentElement){if(e)for(let[t,r]of Object.entries(i)){let a=t.startsWith("--")?t:`--g-ui-${t}`;wr.has(a)&&e.style.setProperty(a,String(r))}}function zr(i="dark",e=document?.documentElement){e&&(e.classList.remove("g-ui-theme-dark","g-ui-theme-light"),e.classList.add(i==="light"?"g-ui-theme-light":"g-ui-theme-dark"))}import{Renderer as le,isSignal as ce,isState as pe,isStatePath as de,isComputed as me,resolve as H,computed as kr,after as Ni,concat as Nr}from"granular";function Ci(i){return ce(i)||pe(i)||de(i)||me(i)}function o(...i){return Nr(...i,{separator:" ",filterFalsy:!0})}function fe(i){if(!(i==null||i===""))return typeof i=="number"?`${i}px`:i}function n(i,e){let t={},r=[],a=s=>!!s&&typeof s=="object"&&!Array.isArray(s)&&!le.isRenderable(s)&&!le.isDomNode(s)&&!ce(s)&&!pe(s)&&!de(s)&&!me(s);for(let s of i)a(s)?Object.assign(t,s):r.push(s);if(e&&typeof e=="object")for(let s of Object.keys(e))t[s]===void 0&&(t[s]=e[s]);return{props:kr(t),rawProps:t,children:r}}function k(i){return H(i)}function $(i){return!!H(i)}function m(i,e,t){let r=a=>{let s=H(a),g=s==null||s===""?t:s;return g==null||g===""?"":`${i}${g}`};return Ci(e)?Ni(e).compute(a=>r(a)):r(e)}function L(i,e){return Ci(e)?Ni(e).compute(t=>H(t)?i:""):H(e)?i:""}function I(i,e,t){let r=a=>e[a]||null;return Ci(i)?Ni(i).compute(a=>r(H(a??t))):r(H(i??t))}import{Button as Cr,Span as Pi,when as Si}from"granular";function Di(...i){let{props:e,children:t}=n(i,{variant:"filled",size:"md"}),{variant:r,size:a,fullWidth:s,loading:g,leftSection:u,rightSection:c,className:f,disabled:l,...v}=e,p=$(g),d=$(l);return Cr({...v,disabled:d||p,className:o("g-ui-button",m("g-ui-button-variant-",r,"filled"),m("g-ui-button-size-",a,"md"),L("g-ui-button-full",s),L("g-ui-button-loading",g),f)},Si(u,()=>Pi({className:"g-ui-button-section-left"},u)),Si(p,()=>Pi("Loading..."),()=>t),Si(c,()=>Pi({className:"g-ui-button-section-right"},c)))}import{Span as Pr}from"granular";function Vi(...i){let{props:e,children:t}=n(i,{size:"md"}),{size:r,weight:a,color:s,dimmed:g,align:u,className:c,style:f,...l}=e,v=I(a,{bold:"g-ui-text-weight-700",semibold:"g-ui-text-weight-600",medium:"g-ui-text-weight-500",700:"g-ui-text-weight-700",600:"g-ui-text-weight-600",500:"g-ui-text-weight-500",400:"g-ui-text-weight-400"}),p=I(s,{primary:"g-ui-text-primary",success:"g-ui-text-success",danger:"g-ui-text-danger",muted:"g-ui-text-dimmed"}),d=I(u,{center:"g-ui-text-align-center",right:"g-ui-text-align-right",left:"g-ui-text-align-left"});return Pr({...l,className:o("g-ui-text",m("g-ui-text-size-",r,"md"),L("g-ui-text-dimmed",g),v,p,d,c)},t)}import{H1 as Sr,H2 as xe,H3 as Dr,H4 as Vr,H5 as Mr,H6 as Lr}from"granular";var Br={1:Sr,2:xe,3:Dr,4:Vr,5:Mr,6:Lr};function Ir(...i){let{props:e,children:t}=n(i,{order:2}),{order:r,className:a,style:s,...g}=e,u=k(r)||2;return(Br[u]||xe)({...g,className:o("g-ui-title",m("g-ui-title-order-",r,2),a)},t)}import{Div as Tr}from"granular";function jr(...i){let{props:e,children:t}=n(i,{size:"md"}),{size:r,fluid:a,className:s,style:g,...u}=e;return Tr({...u,className:o("g-ui-container",L("g-ui-container-fluid",a),m("g-ui-container-size-",r,"md"),s)},t)}import{Div as $r}from"granular";function Fr(...i){let{props:e,children:t}=n(i,{gap:"md"}),{gap:r,align:a,justify:s,className:g,style:u,...c}=e,f=I(s,{between:"g-ui-justify-between",center:"g-ui-justify-center",end:"g-ui-justify-end",start:"g-ui-justify-start"});return $r({...c,className:o("g-ui-stack",m("g-ui-gap-",r,"md"),m("g-ui-align-",a),f,g)},t)}import{Div as Ar}from"granular";function Rr(...i){let{props:e,children:t}=n(i,{gap:"md",align:"center"}),{gap:r,align:a,position:s,wrap:g,className:u,style:c,...f}=e,l=I(s,{apart:"g-ui-justify-between",center:"g-ui-justify-center",right:"g-ui-justify-end",left:"g-ui-justify-start"});return Ar({...f,className:o("g-ui-group",m("g-ui-gap-",r,"md"),m("g-ui-align-",a,"center"),l,L("g-ui-wrap",g),u)},t)}import{Div as si,list as Hr,when as Mi}from"granular";function Yr(...i){let{props:e,children:t}=n(i,{padding:"md",radius:"md",shadow:"none"}),{title:r,content:a,actions:s,padding:g,radius:u,shadow:c,className:f,style:l,...v}=e;return si(Mi(r,()=>si({className:"g-ui-card-title"},r)),Mi(a,()=>si({className:"g-ui-card-content"},a)),Mi(s,()=>si({className:"g-ui-card-actions"},Hr(s,p=>Di({className:"g-ui-card-action",onClick:p.onClick,leftSection:p.leftSection,rightSection:p.rightSection,size:p.size||"sm",variant:p.variant||"outline",...p.props},p.label)))),{className:o("g-ui-card",m("g-ui-card-padding-",g,"md"),m("g-ui-card-radius-",u,"md"),m("g-ui-card-shadow-",c,"md"),f),...v},t)}import{Span as Or}from"granular";function Er(...i){let{props:e,children:t}=n(i,{variant:"filled",size:"md"}),{variant:r,size:a,className:s,dot:g,style:u,...c}=e,f=I(r,{dot:"g-ui-badge-dot"});return Or({...c,className:o("g-ui-badge",m("g-ui-badge-variant-",r,"filled"),m("g-ui-badge-size-",a,"md"),L("g-ui-badge-dot",g),f,s)},t)}import{Div as he,Input as Gr,Label as Xr,Span as ni,when as Z}from"granular";function Ur(...i){let{props:e,rawProps:t}=n(i,{size:"md"}),{label:r,description:a,error:s,size:g,leftSection:u,rightSection:c,className:f,style:l,inputProps:v,...p}=e,{onChange:d}=t,x=Gr({...p,className:o("g-ui-input",v?.className),onInput:y=>{d?.(y?.target?.value,y),v?.onInput?.(y)}});return he({className:o("g-ui-text-input",f)},Z(r,()=>Xr({className:"g-ui-text-input-label"},r)),Z(a,()=>ni({className:"g-ui-text-input-description"},a)),he({className:o("g-ui-input-wrapper",m("g-ui-input-size-",g,"md"),L("g-ui-input-error",s))},Z(u,()=>ni({className:"g-ui-input-section"},u)),x,Z(c,()=>ni({className:"g-ui-input-section"},c))),Z(s,()=>ni({className:"g-ui-text-input-error-text"},s)))}import{Div as Li,Textarea as qr,when as be}from"granular";function Wr(...i){let{props:e}=n(i,{size:"md"}),{size:t,leftSection:r,rightSection:a,className:s,...g}=e;return Li({className:o("g-ui-input-wrapper","g-ui-input-multiline",m("g-ui-input-size-",t,"md"),s)},be(r,()=>Li({className:"g-ui-input-section"},r)),qr({...g,className:o("g-ui-input g-ui-textarea")}),be(a,()=>Li({className:"g-ui-input-section"},a)))}import{Div as Bi,Input as Zr,when as ve}from"granular";function Kr(...i){let{props:e}=n(i,{size:"md"}),{size:t,leftSection:r,rightSection:a,className:s,...g}=e;return Bi({className:o("g-ui-input-wrapper",m("g-ui-input-size-",t,"md"),s)},ve(r,()=>Bi({className:"g-ui-input-section"},r)),Zr({type:"text",inputMode:"decimal",...g,className:"g-ui-input"}),ve(a,()=>Bi({className:"g-ui-input-section"},a)))}import{Div as ui,Button as _r,portal as Jr,when as Ii,after as Qr}from"granular";var we='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/></svg>',ye='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M560-240 320-480l240-240 56 56-184 184 184 184-56 56Z"/></svg>',gi='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M379.33-244 154-469.33 201.67-517l177.66 177.67 378.34-378.34L805.33-670l-426 426Z"/></svg>',ze='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M240-446.67v-66.66h480v66.66H240Z"/></svg>',E='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M312-265.33 265.33-312l168-168-168-167L312-693.67l168 168 167-168L693.67-647l-168 167 168 168L647-265.33l-167-168-168 168Z"/></svg>';function it(...i){let{props:e,rawProps:t,children:r}=n(i,{size:"md",centered:!0,overlay:"normal"}),{opened:a,title:s,size:g,centered:u,overlay:c,position:f,className:l,style:v}=e,{onClose:p}=t,d=Qr(f,u).compute(([x,y])=>`g-ui-modal-position-${x??(y===!1?"top-center":"center")}`);return Ii(a,()=>Jr(ui({className:o("g-ui-modal-overlay",m("g-ui-modal-overlay-",c,"normal"),d),onClick:x=>{x.target===x.currentTarget&&p?.()}},ui({className:o("g-ui-modal",m("g-ui-modal-size-",g,"md"),l)},ui({className:"g-ui-modal-header"},Ii(s,()=>ui({className:"g-ui-modal-title"},s)),Ii(p,()=>_r({type:"button",className:"g-ui-button g-ui-button-variant-subtle g-ui-button-size-xs g-ui-modal-close",onClick:p,innerHTML:E}))),r))))}import{Div as li,Span as Ti,after as ke,when as Ne}from"granular";function K(...i){let{props:e}=n(i,{variant:"spinner",size:"md"}),{variant:t,size:r,className:a}=e,s=ke(t).compute(u=>u==="dots"),g=ke(t).compute(u=>u==="bars");return Ne(s,()=>li({className:o("g-ui-loading g-ui-dots",m("g-ui-loading-size-",r,"md"),a)}),()=>Ne(g,()=>li({className:o("g-ui-loading g-ui-bars",m("g-ui-loading-size-",r,"md"),a)},Ti(""),Ti(""),Ti("")),()=>li({className:o("g-ui-loading",m("g-ui-loading-size-",r,"md"),a)},li({className:"g-ui-spinner"}))))}import{Div as ji,Input as et,Label as rt,Span as Ce,when as $i,state as tt,after as at}from"granular";function ot(...i){let{props:e,rawProps:t}=n(i,{size:"md"}),{checked:r,label:a,description:s,size:g,indeterminate:u,className:c,style:f,inputProps:l,...v}=e,{onChange:p}=t,d=tt($(r));at(r).change(y=>{y!=null&&(d.set(!!y),p?.(y))});let x=rt({className:"g-ui-checkbox-control"},et({type:"checkbox",indeterminate:u,checked:d,className:o("g-ui-checkbox-input",m("g-ui-checkbox-size-",g,"md"),l?.className),...v}),$i(d,()=>ji({className:"g-ui-checkbox-checked",innerHTML:gi}),()=>{if(!d.get()&&u.get())return ji({className:"g-ui-checkbox-indeterminate",innerHTML:ze})}),$i(a,()=>Ce({className:"g-ui-checkbox-label"},a)));return ji({className:o("g-ui-checkbox",m("g-ui-checkbox-size-",g,"md"),c)},x,$i(s,()=>Ce({className:"g-ui-checkbox-description"},s)))}import{Input as st,Label as nt,Span as gt,when as ut}from"granular";function lt(...i){let{props:e}=n(i,{size:"md"}),{label:t,size:r,className:a,style:s,inputProps:g,...u}=e;return nt({className:o("g-ui-switch",m("g-ui-switch-size-",r,"md"),a)},st({type:"checkbox",className:o("g-ui-switch-input",m("g-ui-switch-size-",r,"md"),g?.className),...u}),ut(t,()=>gt({className:"g-ui-switch-label"},t)))}import{Div as Y,Span as Pe,when as Fi,state as Se,after as ci}from"granular";function ct(...i){let{props:e,rawProps:t}=n(i,{data:[],size:"md"}),{data:r,value:a,size:s,leftSection:g,rightSection:u,placeholder:c,className:f,...l}=e,{onChange:v}=t,p=Se(!1),d=Se(k(a)??"");ci(a).change(P=>{let D=k(P);D!==void 0&&d.set(D??"")});let x=P=>{d.set(P),v?.(P),p.set(!1)},y=ci(d).compute(P=>P?"":"g-ui-select-placeholder"),M=ci(d).compute(P=>{let N=(k(r)??[]).find(z=>z.value===P);return P?N?.label??"":c??""});return Y({...l,className:o("g-ui-select-root",f)},Y({className:o("g-ui-input-wrapper",m("g-ui-input-size-",s,"md"))},Fi(g,()=>Y({className:"g-ui-input-section"},g)),Y({className:o("g-ui-select",y),onClick:()=>p.set(!p.get())},Pe({className:"g-ui-select-value"},M)),Fi(u,()=>Y({className:"g-ui-input-section"},u),()=>Pe({className:"g-ui-select-caret"},"\u25BE"))),Fi(p,()=>Y({className:"g-ui-select-dropdown"},(k(r)??[]).map(P=>Y({className:o("g-ui-select-item",ci(d).compute(D=>D===P.value?"g-ui-select-item-active":"")),onClick:()=>x(P.value)},P.label)))))}import{Button as pt,Div as Ai,state as dt,after as De,list as mt,when as ft}from"granular";function xt(...i){let{props:e,rawProps:t}=n(i,{tabs:[],orientation:"horizontal",variant:"default"}),{value:r,tabs:a,orientation:s,variant:g,className:u,style:c}=e,{onChange:f}=t,l=dt(r?.get()??a.get()?.[0]?.value??"");De(r).change(p=>{l.set(p)});let v=p=>{l.set(p),f?.(p)};return Ai({className:o("g-ui-tabs",I(s,{vertical:"g-ui-tabs-vertical"}),m("g-ui-tabs-variant-",g,"default"),e.className??u)},Ai({className:"g-ui-tabs-list"},mt(a,p=>pt({className:De(l).compute(d=>o("g-ui-tabs-tab",p.value===d&&"g-ui-tabs-tab-active")),onClick:()=>v(p.value)},p.label))),Ai({className:"g-ui-tabs-panel"},ft(l,()=>(console.log("tabs",a.get()),a.get()?.find(p=>p.value===l.get())?.content??null))))}import{Table as ht,Thead as bt,Tbody as vt,Tr as Ve,Th as wt,Td as Me}from"granular";function yt(...i){let{props:e}=n(i,{headers:[],rows:[]}),{headers:t,rows:r,striped:a,highlightOnHover:s,withBorder:g,withColumnBorders:u,className:c,style:f,...l}=e;return ht({...l,className:o("g-ui-table",L("g-ui-table-striped",a),L("g-ui-table-hover",s),L("g-ui-table-with-border",g),L("g-ui-table-column-borders",u),c)},t.length?bt(Ve(t.map(v=>wt(v)))):null,vt(r.map(v=>Ve(Array.isArray(v)?v.map(p=>Me(p)):Object.values(v).map(p=>Me(p))))))}import{Div as Ri}from"granular";import{state as zt,when as kt,after as Nt}from"granular";function Ct(...i){let{props:e,children:t}=n(i,{opened:!1}),{opened:r,className:a,...s}=e,g=zt($(r));Nt(r).change(l=>{g.set($(l))});let u=()=>{g.set(!g.get())},c=t[0],f=t[1];return Ri({...s,className:o("g-ui-accordion",a)},Ri({className:"g-ui-accordion-header",onClick:u},c),kt(g,()=>Ri({className:"g-ui-accordion-content"},f)))}import{Span as Le}from"granular";function Pt(...i){let{props:e,children:t}=n(i),{label:r,className:a,style:s}=e;return Le({className:o("g-ui-tooltip",a)},t,Le({className:"g-ui-tooltip-content"},r))}import{Div as _,when as St,after as Dt,state as J,portal as Vt}from"granular";var Hi=J({currentOpenState:null});function Mt(...i){let e=J(),t=J(),r=J({}),{props:a,rawProps:s,children:g}=n(i,{position:"right"}),{opened:u,content:c,position:f,className:l,...v}=a,{onChange:p}=s,d=J(k(u)??!1);Dt(u).change(N=>{let z=k(N);z!=null&&(d.set(!!z),z&&x())});let x=()=>{Hi.get().currentOpenState!==d&&(Hi.get().currentOpenState?.set(!1),Hi.set().currentOpenState=d)};u.get()&&x();let y=()=>{let N=e.get(),z=t.get();if(!N||!z)return;let b=N.getBoundingClientRect(),S=z.getBoundingClientRect(),h=k(f)??"right",w=b.bottom+8,C=b.left;h==="center"&&(C=b.left+b.width/2-S.width/2),h==="right"&&(C=b.right-S.width),r.set({top:`${w}px`,left:`${C}px`})},M=N=>{d.set(N),p?.(N),N&&(x(),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>y()):setTimeout(()=>y(),0))},P=()=>M(!d.get()),D=()=>M(!1);return _({...v,node:e,className:o("g-ui-menu",l)},_({onClick:P},g),St(d,()=>Vt(_(_({className:"g-ui-menu-overlay",onClick:D}),_({className:"g-ui-menu-dropdown",node:t,style:r},c)))))}import{Div as Be,portal as Lt,when as Bt}from"granular";function It(...i){let{props:e,children:t}=n(i,{position:"right",size:"md",overlay:"normal",shadowed:!0}),{opened:r,onClose:a,position:s,size:g,overlay:u,shadowed:c,className:f,style:l}=e;return Bt(r,()=>Lt(Be({className:o("g-ui-drawer-overlay",m("g-ui-drawer-overlay-",u,"normal")),onClick:a},Be({className:o("g-ui-drawer",I(c,{true:"g-ui-drawer-shadowed"},!0),m("g-ui-drawer-",s,"right"),m("g-ui-drawer-size-",g,"md"),f),onClick:v=>v.stopPropagation()},t))))}import{Button as Tt,Div as Yi,Span as Ie,when as pi,after as Te}from"granular";function Oi(...i){let{props:e,rawProps:t,children:r}=n(i,{color:"blue",withCloseButton:!0}),{title:a,color:s,icon:g,loading:u,withCloseButton:c,withBorder:f,className:l,style:v}=e,{onClose:p}=t,d=Te(g,u).compute(([y,M])=>!y&&!!M),x=Te(g,u).compute(([y,M])=>!!y||!!M);return Yi({className:o("g-ui-notification",[f,"g-ui-notification-bordered"],[s,y=>`g-ui-notification-${y}`],[x,"g-ui-notification-with-icon"],l)},pi(g,()=>Ie({className:"g-ui-notification-icon"},g)),pi(d,()=>K({size:"sm",className:"g-ui-notification-loader"})),Yi({className:"g-ui-notification-body"},pi(a,()=>Yi({className:"g-ui-notification-title"},a)),r),pi(c,()=>Tt({type:"button",className:"g-ui-notification-close",onClick:()=>p?.()},Ie({innerHTML:E}))))}import{Div as jt,when as $t}from"granular";function Ft(...i){let{props:e}=n(i,{labelPosition:"center"}),{label:t,labelPosition:r,className:a,...s}=e;return jt({...s,className:o("g-ui-divider",L("label",t),m("g-ui-divider-label-",r,"center"),a)},$t(t,()=>Vi({className:"g-ui-divider-label-text",size:"sm"},t)))}import{Div as At}from"granular";function Rt(...i){let{props:e,children:t}=n(i,{padding:"md",radius:"md",shadow:"none"}),{padding:r,radius:a,shadow:s,className:g,...u}=e;return At({...u,className:o("g-ui-paper",[r,c=>`g-ui-card-padding-${c}`],[a,c=>`g-ui-card-radius-${c}`],[s,c=>`g-ui-card-shadow-${c}`],g)},t)}import{Button as Ht,Div as Ei,Span as Yt,after as je,when as Gi}from"granular";function Ot(...i){let{props:e,rawProps:t,children:r}=n(i,{color:"blue"}),{title:a,color:s,icon:g,withCloseButton:u,className:c,...f}=e,{onClose:l}=t,v=je(a,u).compute(([d,x])=>d||x),p=je(g).compute(d=>d!==void 0);return Ei({...f,className:o("g-ui-alert",[s,d=>`g-ui-alert-${d}`],c)},Ei({className:"g-ui-alert-header"},Gi(g,()=>Yt({className:"g-ui-alert-icon"},g)),Gi(a,()=>Ei({className:"g-ui-alert-title"},a)),Gi(u,()=>Ht({type:"button",className:"g-ui-alert-close",onClick:()=>l?.()},"\xD7"))),r)}import{Div as Et,Img as Gt,when as Xt}from"granular";function Ut(...i){let{props:e,children:t}=n(i,{size:"md",alt:""}),{src:r,size:a,alt:s,className:g,...u}=e;return Et({...u,className:o("g-ui-avatar",[a,c=>`g-ui-avatar-size-${c}`],g)},Xt(r,()=>Gt({className:"g-ui-avatar-img",src:r,alt:s}),()=>t))}import{Span as qt}from"granular";function Wt(...i){let{props:e,children:t}=n(i),{className:r,...a}=e;return qt({...a,className:o("g-ui-kbd",r)},t)}import{Code as Zt}from"granular";function Kt(...i){let{props:e,children:t}=n(i),{className:r,...a}=e;return Zt({...a,className:o("g-ui-code",r)},t)}import{Blockquote as _t}from"granular";function Jt(...i){let{props:e,children:t}=n(i),{className:r,...a}=e;return _t({...a,className:o("g-ui-blockquote",r)},t)}import{Div as Qt}from"granular";function ia(...i){let{props:e,children:t}=n(i,{cols:3,gap:"md"}),{cols:r,gap:a,className:s,...g}=e;return Qt({...g,className:o("g-ui-grid",[a,u=>`g-ui-gap-${u}`],[r,u=>`g-ui-grid-cols-${u}`],s)},t)}import{Ul as ea,Ol as ra,Li as Xi,Div as di,Span as Ui,after as qi,when as G,isSignal as ta,isState as aa,isStatePath as oa,isComputed as sa}from"granular";function $e(...i){let{props:e,children:t}=n(i,{type:"none",size:"md"}),{type:r,size:a,withPadding:s,className:g,...u}=e,c=I(r,{ordered:"g-ui-list-ordered",unordered:"g-ui-list-unordered",none:"g-ui-list-none"}),f=qi(r).compute(y=>y==="ordered"),l=y=>y&&typeof y=="object"&&typeof y.tagName=="string"&&(y.tagName.toLowerCase()==="ul"||y.tagName.toLowerCase()==="ol"),v=y=>y&&typeof y=="object"&&typeof y.tagName=="string"&&y.tagName.toLowerCase()==="li",p=y=>{let M=P=>P==null||P===!1?null:Array.isArray(P)?P.map(D=>M(D)):v(P)?P:l(P)?Xi({className:"g-ui-list-nested-item"},P):Xi(Ui({className:"g-ui-list-item-shell"},P));return ta(y)||aa(y)||oa(y)||sa(y)?qi(y).compute(P=>M(P)):M(y)},d=t.map(y=>p(y)),x={...u,className:o("g-ui-list",m("g-ui-list-size-",a,"md"),L("g-ui-list-with-padding",s),c,g)};return G(f,()=>ra(x,d),()=>ea(x,d))}function na(...i){let{props:e,children:t}=n(i,{withBorder:!1}),{leftSection:r,rightSection:a,title:s,body:g,withBorder:u,className:c,...f}=e,l=qi(s,g).compute(([v,p])=>!!v||!!p);return Xi({...f,className:o("g-ui-list-item",L("g-ui-list-item-border",u),c)},di({className:"g-ui-list-item-shell"},G(r,()=>Ui({className:"g-ui-list-item-section g-ui-list-item-section-left"},r)),G(l,()=>di({className:"g-ui-list-item-content"},G(s,()=>di({className:"g-ui-list-item-title"},s)),G(g,()=>di({className:"g-ui-list-item-body"},g))),()=>t),G(a,()=>Ui({className:"g-ui-list-item-section g-ui-list-item-section-right"},a))))}$e.Item=na;import{A as ga}from"granular";function ua(...i){let{props:e,children:t}=n(i),{className:r,...a}=e;return ga({...a,className:o("g-ui-anchor",r)},t)}import{Img as la}from"granular";function ca(...i){let{props:e}=n(i),{className:t,...r}=e;return la({...r,className:o("g-ui-image",t)})}import{Span as pa}from"granular";function mi(...i){let{props:e,children:t}=n(i,{size:"md"});return pa({...e,className:o("g-ui-icon",m("g-ui-icon-size-",e.size,"md"),m("g-ui-icon-color-",e.color),e.className)},...t)}import{Div as Fe}from"granular";function da(...i){let{props:e}=n(i,{value:0,color:"primary",size:"md"}),{value:t,color:r,size:a,className:s,...g}=e;return Fe({...g,className:o("g-ui-progress",m("g-ui-progress-size-",a,"md"),[t,u=>{let c=Math.max(0,Math.min(100,Number(u)||0));return`g-ui-progress-${Math.round(c/5)*5}`}],[r,u=>u?`g-ui-progress-${u}`:""],s)},Fe({className:"g-ui-progress-bar"}))}import{Div as O,after as fi,state as ma,when as fa}from"granular";function xa(...i){let{props:e,rawProps:t}=n(i,{size:"md",min:0,max:100,step:1}),{onChange:r}=t,{value:a,marks:s,size:g,min:u,max:c,step:f,disabled:l,className:v,...p}=e,d=ma(k(a??u));fi(a).change(z=>{z!=null&&d.set(k(z))});let x=()=>{let z=Number(k(u)),b=Number(k(c));return!Number.isFinite(z)||!Number.isFinite(b)?{minValue:0,maxValue:100}:{minValue:Math.min(z,b),maxValue:Math.max(z,b)}},y=()=>{let z=Number(k(f));return Number.isFinite(z)&&z>0?z:1},M=z=>{let{minValue:b,maxValue:S}=x(),h=y(),w=Math.max(b,Math.min(S,Number(z))),C=Math.round((w-b)/h)*h+b;C!==d.get()&&(d.set(C),r?.(C))},P=fi(d).compute(z=>{let{minValue:b,maxValue:S}=x(),h=S-b;if(h<=0)return 0;let w=(Number(z??b)-b)/h*100;return Math.max(0,Math.min(100,w))}),D=(z,b)=>{let S=b?.();if(!S||S.width===0)return;let w=Math.min(Math.max(z.clientX-S.left,0),S.width)/S.width,{minValue:C,maxValue:V}=x();M(C+w*(V-C))},N=z=>{if($(l))return;z.preventDefault?.();let b=z.currentTarget,S=()=>b.getBoundingClientRect();b.setPointerCapture?.(z.pointerId),D(z,S);let h=C=>D(C,S),w=()=>{b.releasePointerCapture?.(z.pointerId),window.removeEventListener("pointermove",h),window.removeEventListener("pointerup",w)};window.addEventListener("pointermove",h),window.addEventListener("pointerup",w)};return O({...p,className:o("g-ui-slider",m("g-ui-slider-size-",g,"md"),L("g-ui-slider-disabled",l),v)},O({className:"g-ui-slider-track",onPointerDown:N},O({className:"g-ui-slider-bar",style:fi(P).compute(z=>({width:`${z}%`}))}),O({className:"g-ui-slider-thumb",style:fi(P).compute(z=>({left:`${z}%`}))})),fa(s,()=>O({className:"g-ui-slider-marks"},s.map(z=>Wi({mark:z,getBounds:x})))))}var Wi=({mark:i,getBounds:e})=>{let{minValue:t,maxValue:r}=e(),a=r-t,s=i.value??i,g=i.label??String(i.value)??s,u=Number(s),c=0;return a>0&&(c=(u-t)/a*100),O({className:"g-ui-slider-mark",style:{left:`${Math.max(0,Math.min(100,c))}%`}},O({className:"g-ui-slider-mark-label"},g))};import{Div as ha}from"granular";function ba(...i){let{props:e}=n(i,{height:"md",width:"full"}),{height:t,width:r,className:a,...s}=e;return ha({...s,className:o("g-ui-skeleton",[t,g=>`g-ui-skeleton-h-${g}`],[r,g=>`g-ui-skeleton-w-${g}`],a)})}import{Button as va,after as Ae,state as wa}from"granular";function ya(...i){let{props:e,rawProps:t,children:r}=n(i,{size:"md",variant:"filled"}),{checked:a,size:s,variant:g,className:u,...c}=e,{onChange:f}=t,l=wa(!!a);Ae(a).change(p=>{p!=null&&l.set(!!p)});let v=p=>{l.set(p),f?.(p)};return va({...c,type:"button",className:o("g-ui-chip",m("g-ui-chip-size-",s,"md"),m("g-ui-chip-variant-",g,"filled"),Ae(l).compute(p=>p?"g-ui-chip-active":""),u),onClick:()=>v(!l.get())},r)}import{Div as Zi,after as Re,state as za}from"granular";function ka(...i){let{props:e,rawProps:t}=n(i,{data:[],size:"sm"}),{value:r,data:a,size:s,scroll:g,className:u,...c}=e,{onChange:f}=t,l=za(k(r));Re(r).change(p=>{let d=k(p);d!=null&&l.set(d)});let v=p=>{l.set(p),f?.(p)};return Zi({...c,className:o(g&&"g-ui-segmented-scroll")},Zi({className:o("g-ui-segmented",m("g-ui-segmented-size-",s,"sm"),e.className??u)},a.map(p=>Zi({className:o("g-ui-segmented-item",Re(l).compute(d=>p.value===d?"g-ui-segmented-active":"")),onClick:()=>v(p.value)},p.label))))}import{Button as Ki,Div as Na,state as Ca,after as xi}from"granular";function Pa(...i){let{props:e,rawProps:t}=n(i,{total:1,size:"md"}),{page:r,total:a,size:s,className:g,...u}=e,{onChange:c}=t,f=Ca(k(r??1));xi(r).change(d=>{let x=k(d);x!=null&&f.set(x)});let l=d=>{let x=Number(k(a))||1,y=Math.max(1,Math.min(x,d));f.set(y),c?.(y)},v=[],p=Number(k(a))||1;for(let d=1;d<=p;d+=1)v.push(d);return Na({...u,className:o("g-ui-pagination",m("g-ui-pagination-size-",s,"md"),e.className??g)},Ki({className:"g-ui-pagination-item",onClick:()=>l((f.get?.()??f)-1),disabled:xi(f).compute(d=>d<=1)},"<"),v.map(d=>Ki({className:xi(f).compute(x=>o("g-ui-pagination-item",d===x&&"g-ui-pagination-item-active")),onClick:()=>l(d)},String(d))),Ki({className:"g-ui-pagination-item",onClick:()=>l((f.get?.()??f)+1),disabled:xi(f).compute(d=>d>=a)},">"))}import{Div as Sa,Input as Da,Label as Va,Span as He,when as Ye}from"granular";function Ma(...i){let{props:e}=n(i,{size:"md"}),{label:t,description:r,size:a,className:s,inputProps:g,...u}=e,c=Va({className:"g-ui-radio-control"},Da({type:"radio",className:o("g-ui-radio-input",m("g-ui-radio-size-",a,"md"),g?.className),...u}),Ye(t,()=>He({className:"g-ui-radio-label"},t)));return Sa({className:o("g-ui-radio",m("g-ui-radio-size-",a,"md"),s)},c,Ye(r,()=>He({className:"g-ui-radio-description"},r)))}import{Div as La}from"granular";function Ba(...i){let{props:e,children:t}=n(i),{className:r,...a}=e;return La({...a,className:o("g-ui-stack g-ui-gap-sm",r)},t)}import{Nav as Ia,Span as Ta}from"granular";function ja(...i){let{props:e,children:t}=n(i,{separator:"/"}),{separator:r,className:a,...s}=e,g=[];Array.isArray(t)?g.push(...t):g.push(t);let u=g.filter(Boolean),c=[];return u.forEach((f,l)=>{c.push(f),l<u.length-1&&c.push(Ta({className:"g-ui-breadcrumbs-separator"},r))}),Ia({...s,className:o("g-ui-breadcrumbs",a)},c)}import{Div as $a}from"granular";function Fa(...i){let{props:e,children:t}=n(i),{className:r,...a}=e;return $a({...a,className:o("g-ui-center",r)},t)}import{Div as Aa}from"granular";function Ra(...i){let{props:e}=n(i,{size:"md"}),{size:t,className:r,...a}=e;return Aa({...a,className:o("g-ui-space",[t,s=>`g-ui-space-${s}`],r)})}import{Div as Ha,when as Ya}from"granular";function Oa(...i){let{props:e,children:t}=n(i),{opened:r,className:a,...s}=e;return Ya(r,()=>Ha({...s,className:o("g-ui-collapse",a)},t))}import{Button as Ea}from"granular";function hi(...i){let{props:e,children:t}=n(i,{size:"md",variant:"filled"}),{size:r,variant:a,className:s,...g}=e;return Ea({...g,type:"button",className:o("g-ui-action-icon",m("g-ui-action-icon-size-",r,"md"),m("g-ui-action-icon-",a,"filled"),s)},t)}import{Div as _i,when as Ga,after as Xa,state as Ua}from"granular";function Ji(...i){let{props:e,rawProps:t,children:r}=n(i,{position:"left"}),{opened:a,position:s,content:g,className:u,...c}=e,{onChange:f}=t,l=Ua(k(a)??!1);Xa(a).change(p=>{let d=k(p);d!=null&&l.set(!!d)});let v=p=>{l.set(p),f?.(p)};return _i({...c,className:o("g-ui-popover",e.className??u)},_i({onClick:()=>v(!l.get())},r),Ga(l,()=>_i({className:o("g-ui-popover-dropdown",s==="right"&&"g-ui-popover-right",s==="center"&&"g-ui-popover-center")},g)))}import{Div as Oe}from"granular";function qa(...i){let{props:e,children:t}=n(i,{position:"left"}),{position:r,content:a,className:s,...g}=e;return Oe({...g,className:o("g-ui-hover-card",s)},t,Oe({className:o("g-ui-hover-card-dropdown",[r,u=>u==="right"?"g-ui-hover-card-right":""],[r,u=>u==="center"?"g-ui-hover-card-center":""])},a))}import{Div as Wa}from"granular";function Za(...i){let{props:e,children:t}=n(i,{position:"bottom-right"}),{position:r,className:a,...s}=e;return Wa({...s,className:o("g-ui-affix",[r,g=>`g-ui-affix-${g}`],a)},t)}import{Fieldset as Ka,Legend as _a,when as Ja}from"granular";function Qa(...i){let{props:e,children:t}=n(i),{legend:r,className:a,...s}=e;return Ka({...s,className:o("g-ui-fieldset",a)},Ja(r,()=>_a({className:"g-ui-legend"},r)),t)}import{Div as io}from"granular";function eo(...i){let{props:e,children:t}=n(i,{position:"sticky"}),{position:r,className:a,...s}=e;return io({...s,className:o("g-ui-appbar",m("g-ui-appbar-",r,"sticky"),a)},t)}import{Div as Qi,portal as ro,after as bi,state as Ee,when as Ge}from"granular";function to(...i){let{props:e,children:t}=n(i,{position:"left",size:"md",blur:!0,fixed:!1,minWidth:"button"});return Ge(e.fixed,()=>oo(e,t),()=>ao(e,t))}var ao=(i,e)=>{let{open:t,onClose:r,position:a,size:s,blur:g,fixed:u,minWidth:c,className:f,...l}=i,v=Ee(!1),p=Ee(!1),d=220,x=P=>{if(P){v.set(!0),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>p.set(!0)):setTimeout(()=>p.set(!0),0);return}p.set(!1),setTimeout(()=>v.set(!1),d)};x(!!t.get()),bi(t).change(P=>x(!!P));let y=bi(p,g).compute(P=>{let[D,N]=P;return o("g-ui-sidebar-overlay",D&&"g-ui-sidebar-overlay-open",!N&&"g-ui-sidebar-overlay-noblur")}),M=bi(s,a,p,f).compute(P=>{let[D,N,z,b]=P,S=N==="right"?"g-ui-sidebar-drawer-right g-ui-sidebar-position-right":"g-ui-sidebar-drawer-left";return o("g-ui-sidebar","g-ui-sidebar-drawer",`g-ui-sidebar-size-${D}`,S,z&&"g-ui-sidebar-drawer-open",k(b))});return Ge(v,()=>ro(Qi({className:y,onClick:r},Qi({className:M,onClick:P=>P.stopPropagation()},e))))},oo=(i,e)=>{let{open:t,position:r,size:a,minWidth:s,className:g,...u}=i,c=bi(a,r,t,s,g).compute(f=>{let[l,v,p,d,x]=f,y=d||"button",M=null;return y==="button"?M="g-ui-sidebar-min-button":y==="xs"?M="g-ui-sidebar-min-xs":y==="sm"?M="g-ui-sidebar-min-sm":y==="md"&&(M="g-ui-sidebar-min-md"),o("g-ui-sidebar g-ui-sidebar-fixed",`g-ui-sidebar-size-${l||"md"}`,M,p&&"g-ui-sidebar-fixed-open",x)});return Qi({...u,className:c},e)};import{Div as X,when as Xe}from"granular";function so(...i){let{props:e}=n(i,{items:[]}),{items:t,className:r,...a}=e;return X({...a,className:o("g-ui-timeline",r)},t.map(s=>X({className:"g-ui-timeline-item"},X({className:"g-ui-timeline-dot"}),X({className:"g-ui-timeline-content"},Xe(s.title,()=>X({className:"g-ui-timeline-title"},s.title)),Xe(s.description,()=>X({className:"g-ui-timeline-desc"},s.description)),s.content))))}import{Div as vi}from"granular";function no(...i){let{props:e}=n(i,{active:0,items:[]}),{active:t,items:r,className:a,...s}=e;return vi({...s,className:o("g-ui-stepper",a)},r.map((g,u)=>vi({className:o("g-ui-stepper-item",[t,c=>u===c?"g-ui-stepper-active":""])},vi({className:"g-ui-stepper-index"},String(u+1)),vi({className:"g-ui-stepper-label"},g.label))))}import{Span as Ue,after as qe,state as go}from"granular";function uo(...i){let{props:e,rawProps:t}=n(i,{value:0,max:5,size:"md"}),{value:r,max:a,size:s,className:g,...u}=e,{onChange:c}=t,f=go(k(r));qe(r).change(d=>{let x=k(d);x!=null&&f.set(x)});let l=d=>{f.set(d),c?.(d)},v=[],p=Number(k(a))||0;for(let d=1;d<=p;d+=1)v.push(d);return Ue({...u,className:o("g-ui-rating",m("g-ui-rating-size-",s,"md"),e.className??g)},v.map(d=>Ue({className:o("g-ui-rating-item",qe(f).compute(x=>d<=x?"g-ui-rating-item-active":"")),onClick:()=>l(d)},"\u2605")))}import{Span as lo}from"granular";function co(...i){let{props:e,children:t}=n(i),{className:r,...a}=e;return lo({...a,className:o("g-ui-tag",r)},t)}import{Button as We,Div as U,state as Ze,after as wi}from"granular";var po=["S","M","T","W","T","F","S"];function Q(...i){let{props:e,rawProps:t}=n(i,{size:"md"}),{value:r,className:a,size:s,...g}=e,{onChange:u}=t,c=D=>{let N=k(D);if(N instanceof Date)return N;if(N==null)return null;let z=new Date(N);return Number.isNaN(z.getTime())?null:z},f=Ze(c(r)??new Date),l=Ze(new Date(f.get()));wi(r).change(D=>{let N=c(D);N!=null&&(f.set(N),l.set(new Date(N)))});let v=(D,N,z)=>{let b=new Date(D,N+1,0).getDate();return new Date(D,N,Math.min(z,b))},p=D=>{let N=l.get(),z=v(N.getFullYear(),N.getMonth(),D);f.set(z),l.set(z),u?.(z)},d=D=>{let N=l.get(),z=v(N.getFullYear(),N.getMonth()+D,N.getDate());l.set(z)},x=D=>{let N=l.get(),z=v(N.getFullYear()+D,N.getMonth(),N.getDate());l.set(z)},y=wi(l).compute(D=>D.toLocaleString("default",{month:"long"})),M=wi(l).compute(D=>String(D.getFullYear())),P=wi(l,f).compute(([D,N])=>{let z=D.getFullYear(),b=D.getMonth(),h=new Date(z,b,1).getDay(),w=new Date(z,b+1,0).getDate(),C=[];for(let V=0;V<h;V+=1)C.push({muted:!0,label:""});for(let V=1;V<=w;V+=1)C.push({label:V});return[...po.map(V=>U({className:"g-ui-calendar-cell g-ui-calendar-cell-muted"},V)),...C.map(V=>U({className:o("g-ui-calendar-cell",V.muted&&"g-ui-calendar-cell-muted",V.label&&N.getFullYear()===z&&N.getMonth()===b&&V.label===N.getDate()&&"g-ui-calendar-cell-active"),onClick:()=>V.label&&p(V.label)},V.label))]});return U({...g,className:o("g-ui-calendar",a,m("g-ui-calendar-size-",s,"md"))},U({className:"g-ui-calendar-header"},hi({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>d(-1)},mi({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:ye})),U({className:"g-ui-calendar-title-group"},We({type:"button",className:"g-ui-calendar-title-button",onClick:()=>d(1)},y),We({type:"button",className:"g-ui-calendar-title-button",onClick:()=>x(1)},M)),hi({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>d(1)},mi({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:we}))),U({className:"g-ui-calendar-grid"},P))}import{Div as ii,Span as q,Input as mo,when as ie,after as F,state as yi}from"granular";function fo(...i){let{props:e,rawProps:t}=n(i,{data:[],size:"md",searchable:!0}),{value:r,data:a,size:s,className:g,placeholder:u,searchable:c,...f}=e,{onChange:l,onSearchChange:v}=t,p=yi(k(r)??[]),d=yi(""),x=yi(!1),y=yi(null),M=h=>(k(h)??[]).map(C=>typeof C=="string"?{value:C,label:C}:C&&typeof C=="object"?C:{value:String(C),label:String(C)});F(r).change(h=>{let w=k(h);w!=null&&p.set(w)});let P=null;F(x).change(h=>{if(P&&(P(),P=null),!h)return;let w=C=>{let V=y.get();V&&(V.contains(C.target)||x.set(!1))};document.addEventListener("mousedown",w),P=()=>document.removeEventListener("mousedown",w)}),F(d).change(h=>{v?.(h)});let D=h=>{let w=p.get()??[],C=w.includes(h)?w.filter(V=>V!==h):w.concat(h);p.set(C),l?.(C)},N=F(a).compute(h=>M(h)),z=F(N,d).compute(([h,w])=>{let C=String(k(w)??"").toLowerCase().trim();return C?h.filter(V=>String(V.label??"").toLowerCase().includes(C)):h}),b=F(p,d).compute(([h,w])=>{let C=k(h)??[],V=String(k(w)??"");return!C.length&&!V}),S=F(c).compute(h=>!!h);return ii({...f,node:y,className:o("g-ui-select-multi-root",g)},ii({className:o("g-ui-select-multi",m("g-ui-select-multi-size-",s,"md")),onClick:()=>x.set(!0)},F(N,p).compute(([h,w])=>(k(w)??[]).map(V=>{let B=(h??[]).find(j=>j.value===V)?.label??V;return q({className:"g-ui-select-tag"},q({className:"g-ui-select-tag-label",onClick:j=>{j?.stopPropagation?.()}},B),q({className:"g-ui-select-tag-remove",innerHTML:E,onClick:j=>{j?.stopPropagation?.(),D(V)}}))})),ie(b,()=>q({className:"g-ui-select-multi-placeholder"},u??"Select...")),ie(S,()=>mo({className:"g-ui-select-multi-input",value:d,onInput:h=>d.set(h.target?.value??""),onFocus:()=>x.set(!0)}))),ie(x,()=>ii({className:"g-ui-select-dropdown"},F(z).compute(h=>h.length?h.map(w=>ii({className:o("g-ui-select-item",w.disabled&&"g-ui-select-item-disabled",F(p).compute(C=>(k(C)??[]).includes(w.value)?"g-ui-select-item-active":"")),onClick:()=>{w.disabled||D(w.value)}},q({className:"g-ui-select-item-check",innerHTML:F(p).compute(C=>(k(C)??[]).includes(w.value)?gi:"")}),q({className:"g-ui-select-item-label"},w.label))):ii({className:"g-ui-select-item"},"Nothing found")))))}import{Div as ei,when as Ke}from"granular";function xo(...i){let{props:e}=n(i,{items:[]}),{items:t,className:r,onClose:a,timeout:s,...g}=e;return ei({...g,className:o("g-ui-toast-stack",r)},t.map(u=>ei({className:o("g-ui-toast",[s,"g-ui-toast-auto"])},ei({className:"g-ui-toast-row"},Ke(u.title,()=>ei({className:"g-ui-toast-title"},u.title)),Ke(a,()=>ei({className:"g-ui-toast-close",onClick:()=>a(u)},"\xD7"))),u.message)))}function ho(...i){let{props:e}=n(i);return Q(e)}import{Div as bo,after as vo}from"granular";function wo(...i){let{props:e,rawProps:t}=n(i,{items:[],position:"top-right"}),{items:r,position:a,className:s,...g}=e,{onRemove:u}=t,c=new Map,f=(v,p)=>v?.id??v?.key??p,l=vo(r).compute(v=>{let p=k(v)??[],d=new Set;p.forEach((x,y)=>{let M=f(x,y);if(d.add(M),x?.autoClose&&!c.has(M)){let P=setTimeout(()=>{c.delete(M),u?.(x)},x.autoClose);c.set(M,P)}});for(let[x,y]of c.entries())d.has(x)||(clearTimeout(y),c.delete(x));return p.map((x,y)=>Oi({key:f(x,y),title:x.title,color:x.color,icon:x.icon,loading:x.loading,withCloseButton:x.withCloseButton,withBorder:x.withBorder,onClose:()=>{x.onClose?.(),u?.(x)}},x.message??x.body??x.content??x.text))});return bo({...g,className:o("g-ui-notifications",m("g-ui-notifications-position-",a,"top-right"),s)},l)}import{Div as W,after as ri,state as yo,when as zo}from"granular";function ko(...i){let{props:e,rawProps:t}=n(i,{min:0,max:100,step:1,size:"md"}),{value:r,marks:a,min:s,max:g,step:u,size:c,disabled:f,className:l,...v}=e,{onChange:p}=t,d=yo(k(r??[s,g])),x=()=>{let b=Number(k(s)),S=Number(k(g));return!Number.isFinite(b)||!Number.isFinite(S)?{minValue:0,maxValue:100}:{minValue:Math.min(b,S),maxValue:Math.max(b,S)}},y=()=>{let b=Number(k(u));return Number.isFinite(b)&&b>0?b:1},M=b=>{let{minValue:S,maxValue:h}=x(),w=y(),C=[S,h];Array.isArray(b)&&(C=b);let V=Math.max(S,Math.min(h,Number(C[0]))),T=Math.max(S,Math.min(h,Number(C[1]))),B=Math.round(Math.min(V,T)/w)*w,j=Math.round(Math.max(V,T)/w)*w;return[B,j]};ri(r).change(b=>{b!=null&&d.set(M(b))});let P=b=>{let S=M(b);S?.[0]===d.get()?.[0]&&S?.[1]===d.get()?.[1]||(d.set(S),p?.(S))},D=ri(d).compute(b=>{let{minValue:S,maxValue:h}=x(),w=h-S,[C,V]=M(b);if(w<=0)return{lowPct:0,highPct:0};let T=(C-S)/w*100,B=(V-S)/w*100;return{lowPct:Math.max(0,Math.min(100,T)),highPct:Math.max(0,Math.min(100,B))}}),N=(b,S,h)=>{let w=S?.();if(!w||w.width===0)return;let V=Math.min(Math.max(b.clientX-w.left,0),w.width)/w.width,{minValue:T,maxValue:B}=x(),j=T+V*(B-T),A=d;typeof d.get=="function"&&(A=d.get());let[R,oi]=M(A);P(h==="low"?[j,oi]:[R,j])},z=(b,S,h)=>{if($(f))return;b.preventDefault?.();let w=h||b.currentTarget,C=()=>w.getBoundingClientRect(),V=C(),T=D;typeof D.get=="function"&&(T=D.get());let{lowPct:B,highPct:j}=T,A=(b.clientX-V.left)/V.width*100,R=S;if(!R){let ki=Math.abs(A-B)<=Math.abs(A-j);R="high",ki&&(R="low")}w.setPointerCapture?.(b.pointerId),N(b,C,R);let oi=ki=>N(ki,C,R),ne=()=>{w.releasePointerCapture?.(b.pointerId),window.removeEventListener("pointermove",oi),window.removeEventListener("pointerup",ne)};window.addEventListener("pointermove",oi),window.addEventListener("pointerup",ne)};return W({...v,className:o("g-ui-range-slider",m("g-ui-slider-size-",c,"md"),L("g-ui-slider-disabled",f),e.className??l)},W({className:"g-ui-slider-track",onPointerDown:b=>z(b)},W({className:"g-ui-slider-bar",style:ri(D).compute(({lowPct:b,highPct:S})=>({left:`${b}%`,width:`${Math.max(0,S-b)}%`}))}),W({className:"g-ui-slider-thumb",style:ri(D).compute(({lowPct:b})=>({left:`${b}%`})),onPointerDown:b=>{b.stopPropagation?.(),z(b,"low",b.currentTarget.parentElement)}}),W({className:"g-ui-slider-thumb",style:ri(D).compute(({highPct:b})=>({left:`${b}%`})),onPointerDown:b=>{b.stopPropagation?.(),z(b,"high",b.currentTarget.parentElement)}})),zo(a,()=>W({className:"g-ui-slider-marks"},a.map(b=>Wi({mark:b,getBounds:x})))))}import{Div as No,Input as Co,Span as _e,when as Je,state as ee,after as Qe}from"granular";function Po(...i){let{props:e,rawProps:t}=n(i,{size:"md",format:{pattern:"dddd-dd-dd"}}),{value:r,size:a,calendarSize:s,leftSection:g,rightSection:u,className:c,inputProps:f,format:l,minDate:v,maxDate:p,...d}=e,{onChange:x}=t,y=h=>{let w=k(h);if(w instanceof Date)return w;if(w==null||w==="")return null;let C=new Date(w);return Number.isNaN(C.getTime())?null:C},M=(h,w)=>h&&w&&h.getFullYear()===w.getFullYear()&&h.getMonth()===w.getMonth()&&h.getDate()===w.getDate(),P=h=>{if(!h)return"";let w=String(h.getFullYear()).padStart(4,"0"),C=String(h.getMonth()+1).padStart(2,"0"),V=String(h.getDate()).padStart(2,"0");return`${w}-${C}-${V}`},D=h=>{let w=String(h??"").replace(/\D/g,"");if(w.length<8)return null;let C=Number(w.slice(0,4)),V=Number(w.slice(4,6)),T=Number(w.slice(6,8));if(!C||!V||!T)return null;let B=new Date(C,V-1,T);if(B.getFullYear()!==C||B.getMonth()!==V-1||B.getDate()!==T)return null;let j=y(v);if(j&&B<j)return null;let A=y(p);return A&&B>A?null:B},N=ee(y(r)),z=ee(P(N.get())),b=ee(!1);Qe(r).change(h=>{let w=y(h);if(w==null){N.set(null),z.set("");return}N.set(w),z.set(P(w))}),Qe(z).change(h=>{let w=D(h);w&&(M(w,N.get())||(N.set(w),x?.(w)))});let S=h=>{h&&(M(h,N.get())||(N.set(h),z.set(P(h)),x?.(h),b.set(!1)))};return Ji({opened:b,onChange:h=>b.set(!!h),content:Q({size:m("",s,"xs"),value:N,onChange:S}),className:"g-ui-date-input-popover"},No({className:o("g-ui-dateinput","g-ui-input-wrapper",m("g-ui-input-size-",a,"md"),c)},Je(g,()=>_e({className:"g-ui-input-section"},g)),Co({type:"text",inputMode:"numeric",format:l,value:z,...d,className:o("g-ui-input",f?.className),onInput:h=>{f?.onInput?.(h)}}),Je(u,()=>_e({className:"g-ui-input-section"},u))))}import{Input as So}from"granular";function Do(...i){let{props:e}=n(i),{className:t,...r}=e;return So({type:"text",inputMode:"decimal",...r,className:o("g-ui-input g-ui-input-number",t)})}import{Div as re,when as Vo,after as Mo,state as Lo}from"granular";function Bo(...i){let{props:e,rawProps:t,children:r}=n(i),{opened:a,content:s,className:g,...u}=e,{onChange:c}=t,f=Lo(k(a)??!1);Mo(a).change(v=>{let p=k(v);p!=null&&f.set(!!p)});let l=v=>{f.set(v),c?.(v)};return re({...u,className:o("g-ui-popper",g)},re({onClick:()=>l(!f.get())},r),Vo(f,()=>re({className:"g-ui-popper-dropdown"},s)))}import{Div as Io,Input as To,Button as jo,after as $o,when as Fo}from"granular";import{state as Ao}from"granular";function Ro(...i){let{props:e}=n(i,{size:"md"}),{size:t,className:r,...a}=e,s=Ao(!1),g=$o(s).compute(u=>u?"text":"password");return Io({className:o("g-ui-input-wrapper",m("g-ui-input-size-",t,"md"),r)},To({type:g,...a,className:"g-ui-input"}),jo({className:"g-ui-password-toggle",onClick:()=>s.set(!s.get())},Fo(s,()=>"Hide",()=>"Show")))}import{Div as ir,Input as Ho}from"granular";function Yo(...i){let{props:e}=n(i,{size:"md"}),{size:t,className:r,...a}=e;return ir({className:o("g-ui-input-wrapper",m("g-ui-input-size-",t,"md"),r)},ir({className:"g-ui-input-section"},"\u{1F50E}"),Ho({type:"text",inputMode:"search",...a,className:"g-ui-input"}))}import{Button as Oo,after as Eo,when as er}from"granular";import{state as Go}from"granular";function Xo(...i){let{props:e,children:t}=n(i,{value:"",timeout:1500}),{value:r,timeout:a,className:s,...g}=e,u=Go(!1),c=Eo(u).compute(l=>o("g-ui-copy-button",l&&"g-ui-copy-button-done",s));return Oo({...g,className:c,onClick:async()=>{try{await navigator.clipboard.writeText(String(r)),u.set(!0),setTimeout(()=>u.set(!1),a)}catch{}},type:"button"},er(t?.length,()=>t,()=>er(u,()=>"Copied",()=>"Copy")))}import{Div as Uo}from"granular";function qo(...i){let{props:e}=n(i,{size:"md"}),{size:t,className:r,...a}=e;return Uo({...a,className:o("g-ui-progress-ring",[t,s=>`g-ui-progress-ring-size-${s}`],r)})}import{Div as te,Button as Wo,when as rr}from"granular";function Zo(...i){let{props:e,children:t}=n(i),{title:r,onClose:a,className:s,...g}=e;return te({...g,className:o("g-ui-toast",s)},te({className:"g-ui-toast-row"},rr(r,()=>te({className:"g-ui-toast-title"},r)),rr(a,()=>Wo({className:"g-ui-toast-close",onClick:a},"\xD7"))),t)}import{Div as ae,Input as Ko}from"granular";import{state as _o}from"granular";function Jo(...i){let{props:e,rawProps:t}=n(i,{data:[]}),{data:r,className:a,...s}=e,{onChange:g}=t,u=_o(""),c=r.filter(f=>String(f.label||"").toLowerCase().includes(String(u.get()).toLowerCase()));return ae({...s,className:o("g-ui-select-search",a)},Ko({className:"g-ui-select-search-input",placeholder:"Search...",value:u}),ae({className:"g-ui-select-search-list"},c.map(f=>ae({className:"g-ui-select-search-item",onClick:()=>g?.(f.value)},f.label))))}import{Div as Qo}from"granular";function is(...i){let{props:e,children:t}=n(i),{className:r,...a}=e;return Qo({...a,className:o("g-ui-switch-group",r)},t)}import{Div as oe,Input as tr,state as es,after as se}from"granular";function rs(...i){let{props:e,rawProps:t}=n(i,{size:"md"}),{value:r,size:a,className:s,...g}=e,{onChange:u}=t,c=es(k(r)??["",""]);se(r).change(l=>{let v=k(l);v!=null&&c.set(v)});let f=l=>{c.set(l),u?.(l)};return oe({...g,className:o("g-ui-range-picker",e.className??s)},oe({className:o("g-ui-input-wrapper",m("g-ui-input-size-",a,"md"))},tr({type:"text",inputMode:"numeric",className:"g-ui-input",value:se(c).compute(l=>l?.[0]??""),onInput:l=>{let v=c.get()??["",""];f([l.target.value,v[1]])}})),oe({className:o("g-ui-input-wrapper",m("g-ui-input-size-",a,"md"))},tr({type:"text",inputMode:"numeric",className:"g-ui-input",value:se(c).compute(l=>l?.[1]??""),onInput:l=>{let v=c.get()??["",""];f([v[0],l.target.value])}})))}import{Div as ts}from"granular";function as(...i){let{props:e,children:t}=n(i,{direction:"row"}),{direction:r,wrap:a,align:s,justify:g,gap:u,className:c,...f}=e;return ts({...f,className:o("g-ui-flex",[r,l=>l==="column"?"g-ui-flex-column":"g-ui-flex-row"],[a,"g-ui-flex-wrap"],[s,l=>l&&`g-ui-align-${l}`],[g,l=>l&&`g-ui-justify-${l}`],[u,l=>l&&`g-ui-gap-${l}`],c)},t)}import{A as os,Div as ti,Span as ar,when as ai,after as or,state as ss}from"granular";function ns(...i){let{props:e,rawProps:t,children:r}=n(i,{variant:"subtle",childrenOffset:24}),{label:a,description:s,leftSection:g,rightSection:u,active:c,disabled:f,variant:l,childrenOffset:v,opened:p,defaultOpened:d,className:x,...y}=e,{onClick:M,onChange:P}=t,D=r.length>0,N=ss(k(p)??k(d)??!1);or(p).change(S=>{let h=k(S);h!=null&&N.set(!!h)});let z=or(v).compute(S=>({paddingLeft:fe(k(S??24))??"24px"})),b=S=>{if(k(f)){S?.preventDefault?.();return}if(D){let h=!N.get();N.set(h),P?.(h)}M?.(S)};return ti({className:o("g-ui-navlink-root",x)},os({...y,className:o("g-ui-navlink",m("g-ui-navlink-variant-",l,"subtle"),L("g-ui-navlink-active",c),L("g-ui-navlink-disabled",f)),onClick:b},ai(g,()=>ar({className:"g-ui-navlink-section g-ui-navlink-left"},g)),ti({className:"g-ui-navlink-body"},ai(a,()=>ti({className:"g-ui-navlink-label"},a)),ai(s,()=>ti({className:"g-ui-navlink-description"},s))),ai(u,()=>ar({className:"g-ui-navlink-section g-ui-navlink-right"},u))),D?ai(N,()=>ti({className:"g-ui-navlink-children",style:z},r)):null)}import{Div as sr,when as gs}from"granular";function us(...i){let{props:e,children:t}=n(i,{show:!0,position:"top-right",color:"danger",size:"md"}),{show:r,position:a,color:s,size:g,className:u,...c}=e;return sr({...c,className:o("g-ui-indicator",m("g-ui-indicator-position-",a,"top-right"),m("g-ui-indicator-color-",s,"danger"),m("g-ui-indicator-size-",g,"md"),u)},t,gs(r,()=>sr({className:"g-ui-indicator-badge"})))}import{Span as zi}from"granular";function ls(...i){let{props:e}=n(i),{opened:t,className:r,...a}=e;return zi({...a,className:o("g-ui-burger",[t,"g-ui-burger-open"],r)},zi(""),zi(""),zi(""))}import{Div as cs,when as ps}from"granular";function ds(...i){let{props:e}=n(i),{visible:t,...r}=e;return ps(t,()=>cs({...r,className:"g-ui-loading-overlay"},K({})))}import{Div as ms}from"granular";function fs(...i){let{props:e,children:t}=n(i,{gap:"md"}),{className:r,gap:a,...s}=e;return ms({...s,className:o("g-ui-grid-system",[a,g=>`g-ui-gap-${g}`],r)},t)}import{Div as xs}from"granular";function hs(...i){let{props:e,children:t}=n(i,{span:12}),{span:r,className:a,...s}=e;return xs({...s,className:o([r,g=>`g-ui-col-span-${g}`],a)},t)}import{Div as bs}from"granular";function vs(...i){let{props:e,children:t}=n(i,{size:"md"}),{size:r,className:a,...s}=e;return bs({...s,className:o("g-ui-scroll-area",[r,g=>`g-ui-scroll-area-${g}`],a)},t)}import{Div as ws,Input as ys,after as zs,state as ks}from"granular";function Ns(...i){let{props:e,rawProps:t}=n(i,{length:4}),{length:r,value:a,className:s,...g}=e,{onChange:u}=t,c=ks(Array.from({length:r},()=>""));zs(a).change(l=>{l!=null&&c.set(l)});let f=l=>{c.set(l),u?.(l)};return ws({...g,className:o("g-ui-pin-inputs",s)},Array.from({length:r}).map((l,v)=>ys({className:"g-ui-pin-input",type:"text",inputMode:"numeric",maxLength:1,value:c.get()?.[v]||"",onInput:p=>{let x=(c.get()??[]).slice();x[v]=p.target.value,f(x)}})))}import{Div as Cs}from"granular";function Ps(...i){let{props:e,children:t}=n(i),{className:r,...a}=e;return Cs({...a,className:o("g-ui-checkbox-group",r)},t)}import{Div as Ss}from"granular";function Ds(...i){let{props:e,children:t}=n(i),{className:r,...a}=e;return Ss({...a,className:o("g-ui-avatar-group",r)},t)}import{Div as Vs}from"granular";function Ms(...i){let{props:e,children:t}=n(i),{className:r,...a}=e;return Vs({...a,className:o("g-ui-badge-group",r)},t)}import{state as Ls}from"granular";function Bs(i=!1){let e=Ls(!!i);return[e,{open:()=>e.set(!0),close:()=>e.set(!1),toggle:()=>e.set(!e.get())}]}ue();export{Ct as Accordion,hi as ActionIcon,Za as Affix,Ot as Alert,ua as Anchor,eo as AppBar,Ut as Avatar,Ds as AvatarGroup,Er as Badge,Ms as BadgeGroup,Jt as Blockquote,ja as Breadcrumbs,ls as Burger,Di as Button,Q as Calendar,Yr as Card,Fa as Center,ot as Checkbox,Ps as CheckboxGroup,ya as Chip,Kt as Code,hs as Col,Oa as Collapse,jr as Container,Xo as CopyButton,Po as DateInput,ho as DatePicker,Ft as Divider,It as Drawer,Qa as Fieldset,as as Flex,fs as Grid,Rr as Group,qa as HoverCard,mi as Icon,ca as Image,us as Indicator,Wt as Kbd,$e as List,K as Loading,ds as LoadingOverlay,Mt as Menu,it as Modal,fo as MultiSelect,ns as NavLink,Oi as Notification,wo as Notifications,Do as NumberField,Kr as NumberInput,Pa as Pagination,Rt as Paper,Ro as PasswordInput,Ns as PinInput,Ji as Popover,Bo as Popper,da as Progress,qo as ProgressRing,Ma as Radio,Ba as RadioGroup,rs as RangePicker,ko as RangeSlider,uo as Rating,vs as ScrollArea,Yo as SearchInput,ka as SegmentedControl,ct as Select,Jo as SelectSearch,to as Sidebar,ia as SimpleGrid,ba as Skeleton,xa as Slider,Ra as Space,Fr as Stack,no as Stepper,lt as Switch,is as SwitchGroup,yt as Table,xt as Tabs,co as Tag,Vi as Text,Ur as TextInput,Wr as Textarea,so as Timeline,Ir as Title,Zo as Toast,xo as ToastStack,Pt as Tooltip,o as cx,zr as setThemeMode,yr as setThemeVars,Bs as useDisclosure};
