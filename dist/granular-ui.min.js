...
`;function Ot(){if(typeof document>"u"||document.getElementById(Ht))return;let e=document.createElement("style");e.id=Ht,e.textContent=ba,document.head.appendChild(e)}var xa=new Set(["--g-ui-bg","--g-ui-bg-subtle","--g-ui-bg-muted","--g-ui-bg-emphasized","--g-ui-bg-inverted","--g-ui-bg-panel","--g-ui-fg","--g-ui-fg-muted","--g-ui-fg-subtle","--g-ui-fg-inverted","--g-ui-border","--g-ui-border-subtle","--g-ui-border-emphasized","--g-ui-border-inverted","--g-ui-primary","--g-ui-primary-hover","--g-ui-primary-active","--g-ui-primary-subtle","--g-ui-primary-muted","--g-ui-primary-emphasized","--g-ui-success","--g-ui-success-hover","--g-ui-success-active","--g-ui-success-subtle","--g-ui-success-muted","--g-ui-danger","--g-ui-danger-hover","--g-ui-danger-active","--g-ui-danger-subtle","--g-ui-danger-muted","--g-ui-warning","--g-ui-warning-hover","--g-ui-warning-active","--g-ui-warning-subtle","--g-ui-warning-muted","--g-ui-info","--g-ui-info-hover","--g-ui-info-active","--g-ui-info-subtle","--g-ui-info-muted","--g-ui-shadow-xs","--g-ui-shadow-sm","--g-ui-shadow-md","--g-ui-shadow-lg","--g-ui-shadow-xl","--g-ui-shadow-2xl","--g-ui-radius","--g-ui-font","--g-ui-surface","--g-ui-text","--g-ui-muted","--g-ui-primary-strong","--g-ui-shadow"]);function wa(e={},i=document?.documentElement){if(i)for(let[t,r]of Object.entries(e)){let a=t.startsWith("--")?t:`--g-ui-${t}`;xa.has(a)&&i.style.setProperty(a,String(r))}}function ya(e="dark",i=document?.documentElement){i&&(i.classList.remove("g-ui-theme-dark","g-ui-theme-light"),i.classList.add(e==="light"?"g-ui-theme-light":"g-ui-theme-dark"))}function ka(e=document?.documentElement){return e.classList.contains("g-ui-theme-light")?"light":"dark"}import{Renderer as Wt,isSignal as qt,isState as Yt,isStatePath as Gt,isComputed as _t,resolve as He,computed as za,after as Gi,concat as Na,isWhen as Ca}from"@granularjs/core";function Oe(e){return qt(e)||Yt(e)||Gt(e)||_t(e)||Ca(e)}function s(...e){return Na(...e,{separator:" ",filterFalsy:!0})}function g(e,i){let t={},r=[],a=o=>!!o&&typeof o=="object"&&!Array.isArray(o)&&!Wt.isRenderable(o)&&!Wt.isDomNode(o)&&!qt(o)&&!Yt(o)&&!Gt(o)&&!_t(o);for(let o of e)a(o)?Object.assign(t,o):r.push(o);if(i&&typeof i=="object")for(let o of Object.keys(i))t[o]===void 0&&(t[o]=i[o]);return{props:za(t),rawProps:t,children:r}}function m(e){return He(e)}function ze(e){return!!He(e)}function z(e,i,t){let r=a=>{let o=He(a),n=o==null||o===""?t:o;return n==null||n===""?"":`${e}${n}`};return Oe(i)?Gi(i).compute(a=>r(a)):r(i)}function _(e,i){return Oe(i)?Gi(i).compute(t=>He(t)?e:""):He(i)?e:""}function he(e,i,t){let r=a=>i[a]||null;return Oe(e)?Gi(e).compute(a=>r(He(a??t))):r(He(e??t))}import{Button as Sa,Span as _i,when as Zi,after as Da}from"@granularjs/core";function Ui(...e){let{props:i,children:t}=g(e,{variant:"filled",size:"md",justify:"center"}),{variant:r,color:a,size:o,fullWidth:n,loading:u,leftSection:l,rightSection:p,className:d,disabled:y,justify:h,...c}=i,v=Da(y,u).compute(([w,V])=>w||V);return Sa({...c,disabled:v,className:s("g-ui-button",z("g-ui-button-variant-",r,"filled"),z("g-ui-button-color-",a,"primary"),z("g-ui-justify-",h,"center"),z("g-ui-button-size-",o,"md"),_("g-ui-button-full",n),_("g-ui-button-loading",u),d)},Zi(l,()=>_i({className:"g-ui-button-section-left"},l)),Zi(u,()=>_i("Loading..."),()=>t),Zi(p,()=>_i({className:"g-ui-button-section-right"},p)))}import{Span as Pa}from"@granularjs/core";function Xi(...e){let{props:i,children:t}=g(e,{size:"md"}),{size:r,weight:a,color:o,dimmed:n,align:u,ellipsis:l,decoration:p,className:d,style:y,...h}=i,c=he(a,{bold:"g-ui-text-weight-700",semibold:"g-ui-text-weight-600",medium:"g-ui-text-weight-500",700:"g-ui-text-weight-700",600:"g-ui-text-weight-600",500:"g-ui-text-weight-500",400:"g-ui-text-weight-400"}),v=he(o,{primary:"g-ui-text-primary",success:"g-ui-text-success",danger:"g-ui-text-danger",muted:"g-ui-text-dimmed"}),w=he(u,{center:"g-ui-text-align-center",right:"g-ui-text-align-right",left:"g-ui-text-align-left"}),V=he(p,{underline:"g-ui-text-decoration-underline","line-through":"g-ui-text-decoration-line-through",overline:"g-ui-text-decoration-overline",none:"g-ui-text-decoration-none"});return Pa({...h,style:y,className:s("g-ui-text",z("g-ui-text-size-",r,"md"),_("g-ui-text-dimmed",n),_("g-ui-text-ellipsis",l),c,v,w,V,d)},t)}import{H1 as Ma,H2 as Zt,H3 as Ta,H4 as Va,H5 as La,H6 as Ia}from"@granularjs/core";var $a={1:Ma,2:Zt,3:Ta,4:Va,5:La,6:Ia};function Aa(...e){let{props:i,children:t}=g(e,{order:2}),{order:r,className:a,style:o,...n}=i,u=m(r)||2;return($a[u]||Zt)({...n,className:s("g-ui-title",z("g-ui-title-order-",r,2),a)},t)}import{Div as Ba}from"@granularjs/core";function Fa(...e){let{props:i,children:t}=g(e,{size:"md"}),{size:r,fluid:a,className:o,style:n,...u}=i;return Ba({...u,style:n,className:s("g-ui-container",_("g-ui-container-fluid",a),z("g-ui-container-size-",r,"md"),o)},t)}import{Div as ja}from"@granularjs/core";function Ea(...e){let{props:i,children:t}=g(e,{gap:"md"}),{gap:r,align:a,justify:o,className:n,style:u,...l}=i,p=he(o,{between:"g-ui-justify-between",center:"g-ui-justify-center",end:"g-ui-justify-end",start:"g-ui-justify-start"});return ja({...l,style:u,className:s("g-ui-stack",z("g-ui-gap-",r,"md"),z("g-ui-align-",a),p,n)},t)}import{Div as Ra}from"@granularjs/core";function Ha(...e){let{props:i,children:t}=g(e,{gap:"md",align:"center"}),{gap:r,align:a,justify:o,position:n,noWrap:u,className:l,style:p,...d}=i,y=he(n,{apart:"g-ui-justify-between",center:"g-ui-justify-center",right:"g-ui-justify-end",left:"g-ui-justify-start"});return Ra({...d,style:p,className:s("g-ui-group",z("g-ui-gap-",r,"md"),z("g-ui-align-",a,"center"),z("g-ui-justify-",o,"none"),y,_("g-ui-no-wrap",u),l)},t)}import{Div as wi,list as Oa,when as Ki,after as Qi}from"@granularjs/core";function Wa(...e){let{props:i,children:t}=g(e,{padding:"md",radius:"md",shadow:"none"}),{title:r,content:a,actions:o,border:n,padding:u,radius:l,shadow:p,className:d,style:y,...h}=i,c=_("g-ui-card-bordered",n);return Qi(c).compute(v=>console.log(v)),wi({style:y},Ki(r,()=>wi({className:"g-ui-card-title"},r)),Ki(a,()=>wi({className:"g-ui-card-content"},a)),{className:s("g-ui-card",_("g-ui-card-bordered",n),z("g-ui-card-border-",n,"none"),z("g-ui-card-padding-",u,"md"),z("g-ui-card-radius-",l,"md"),z("g-ui-card-shadow-",p,"md"),d),...h},t,Ki(o,()=>wi({className:"g-ui-card-actions"},Oa(o,v=>Ui({className:"g-ui-card-action",onClick:w=>v.get().onClick?.(w),leftSection:v.leftSection,rightSection:v.rightSection,size:Qi(v.size).compute(w=>w||"sm"),variant:Qi(v.variant).compute(w=>w||"outline"),...v.get().props||{}},v.label)))))}import{Span as qa}from"@granularjs/core";function Ya(...e){let{props:i,children:t}=g(e,{variant:"filled",size:"md"}),{variant:r,size:a,className:o,dot:n,style:u,...l}=i,p=he(r,{dot:"g-ui-badge-dot"});return qa({...l,className:s("g-ui-badge",z("g-ui-badge-variant-",r,"filled"),z("g-ui-badge-size-",a,"md"),_("g-ui-badge-dot",n),p,o)},t)}import{Div as ri,Input as Ga,Textarea as _a,Label as Za,Span as Ua,when as ai,state as Xa,after as Ka,isState as Qa}from"@granularjs/core";function be(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{label:r,description:a,error:o,size:n,leftSection:u,rightSection:l,className:p,inputClassName:d,multiline:y,disabled:h,readOnly:c,value:v,...w}=i,{value:V,node:A,onChange:S,onInput:D,onFocus:N,onBlur:x,onKeyDown:k,onKeyUp:f,onClick:C}=t,I=Qa(V)&&!S&&!D,B=I?V:Xa(m(v)??"");Ka(v).change(Q=>{I||B.set(m(Q)??"")});let K=Q=>{let te=Q?.target?.value??"";te!==v.get()&&(B.set(te),S?.(Q),D?.(Q))},se=ze(y),ae=se?_a:Ga,H=s(d,se&&"g-ui-textarea"),G=ae({...w,node:A,value:B,onInput:K,onChange:K,onFocus:N,onBlur:x,onKeyDown:k,onKeyUp:f,onClick:C,disabled:h,readOnly:c,className:s("g-ui-input",H)});return ri({className:s("g-ui-text-input",p,_("g-ui-input-disabled",h),_("g-ui-input-read-only",c))},ai(r,()=>Za({className:"g-ui-text-input-label"},r)),ai(a,()=>Ua({className:"g-ui-text-input-description"},a)),ri({className:s("g-ui-input-wrapper",_("g-ui-input-multiline",y),z("g-ui-input-size-",n,"md"),_("g-ui-input-error",o))},ai(u,()=>ri({className:"g-ui-input-section"},u)),G,ai(l,()=>ri({className:"g-ui-input-section"},l))),ai(o,()=>ri({className:"g-ui-text-input-error-text"},o)))}function Ji(...e){let{props:i}=g(e,{size:"md"}),{size:t,leftSection:r,rightSection:a,className:o,...n}=i;return be({...n,size:t,className:o,leftSection:r,rightSection:a,multiline:!0})}import{Div as Ut,Span as Xt,after as We,state as Ja}from"@granularjs/core";function et(...e){let{props:i,rawProps:t}=g(e,{size:"md",step:1,allowDecimal:!0,allowNegative:!0,clampBehavior:"blur",hideControls:!1,decimalSeparator:".",thousandSeparator:"",format:null,prefix:"",suffix:""}),{value:r,min:a,max:o,step:n,size:u,allowDecimal:l,allowNegative:p,decimalSeparator:d,thousandSeparator:y,decimalScale:h,clampBehavior:c,hideControls:v,format:w,locale:V,currency:A,formatOptions:S,prefix:D,suffix:N,leftSection:x,rightSection:k,className:f,onChange:C,onInput:I,...B}=i,{onChange:K,onInput:se,onBlur:ae,onFocus:H,onKeyDown:G}=t,Q=$=>{K?.($.target?.value??""),se?.($.target?.value??"")},te=Q,X=Ja(""),T=$=>String($??"").replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),j=()=>{if(!!!m(l))return 0;let L=m(h);if(L!=null&&L!==""&&Number.isFinite(Number(L)))return Math.max(0,Number(L));let q=m(w);return q==="currency"||q==="percent"?2:0},P=$=>{let L=m(d)??".",q=m(y)??"",Z=String($??"");if(q&&(Z=Z.split(q).join("")),!Z||Z==="-"||Z===L||Z.endsWith(L))return null;let oe=Z.replace(L,"."),ie=Number(oe);return Number.isFinite(ie)?ie:null},Y=$=>{let L=m(y)??"";return L?$.replace(/\B(?=(\d{3})+(?!\d))/g,L):$},M=$=>{let L=m(d)??".",q=j(),Z=Number($);if(!Number.isFinite(Z))return"";let oe=Z<0?"-":"",ie=Math.abs(Z),[J,re=""]=String(ie).split("."),le=Y(J);if(q>0){let xe=re.slice(0,q).padEnd(q,"0");return`${oe}${le}${L}${xe}`}return`${oe}${le}`},E=($,L)=>{try{let q=m(V),Z=m(A)??"USD",oe=m(S)??{},ie=j(),J=L==="currency"?"currency":"decimal";return new Intl.NumberFormat(q,{style:J,currency:Z,...ie>0?{minimumFractionDigits:ie,maximumFractionDigits:ie}:{maximumFractionDigits:0},...oe}).format($)}catch{return M($)}},R=$=>{let L=$,q=m(a),Z=m(o);return q!=null&&Number.isFinite(Number(q))&&(L=Math.max(L,Number(q))),Z!=null&&Number.isFinite(Number(Z))&&(L=Math.min(L,Number(Z))),!m(p)&&L<0&&(L=0),L},ee=()=>{let $=m(N)??"",L=m(w);return!$&&L==="percent"?"%":$},pe=($,L,q)=>{let Z=m(D)??"",oe=ee(),ie=String($??"").replace(/\u00A0/g," "),J=String(Z??"").replace(/\u00A0/g," "),re=String(oe??"").replace(/\u00A0/g," "),le=J&&ie.startsWith(J),xe=re&&ie.endsWith(re);return`${L??""}${le?"":Z}${$}${xe?"":oe}`},ke=($,L)=>{let q=j(),Z=m(d)??".",ie=String($??"").replace(/\D/g,"")||"0",J=q>0?ie.padStart(q+1,"0"):ie,le=(q>0?J.slice(0,-q):J).replace(/^0+(?=\d)/,"")||"0",xe=q>0?J.slice(-q):"",Fe=q>0?`${le}${Z}${xe}`:le;return`${L??""}${Fe}`},Pe=$=>{let L=m(D)??"",q=ee(),Z=String($??""),oe=String(L??"").replace(/\u00A0/g," "),ie=String(q??"").replace(/\u00A0/g," ");return oe&&Z.replace(/\u00A0/g," ").startsWith(oe)&&(Z=Z.slice(L.length)),ie&&Z.replace(/\u00A0/g," ").endsWith(ie)&&(Z=Z.slice(0,-q.length)),Z},Be=$=>{let L=!!m(p),q=Pe($),Z=L&&q.includes("-")?"-":"",oe=q.replace(/\D/g,""),ie=ke(oe,Z);if(m(c)==="strict"){let J=P(ie);if(J!=null){let re=R(J);ie=`${re<0?"-":""}${M(Math.abs(re))}`}}return ie},Ve=$=>{if($==null||$==="")return ke("","");if(typeof $=="number"&&Number.isFinite($)){let re=m(c)==="strict"?R($):$;return`${re<0?"-":""}${M(Math.abs(re))}`}let L=Pe($),q=m(d)??".",oe=!!m(p)&&String(L).includes("-")?"-":"",ie=String(L??"").replace(new RegExp(`[^0-9${T(q)}]`,"g"),""),J=P(`${oe}${ie}`);if(J!=null){let re=m(c)==="strict"?R(J):J;return`${re<0?"-":""}${M(Math.abs(re))}`}return Be($)},Me,ti=$=>{let L=m($);if(L===void 0)return;let q=Ve(L);q!==X.get()&&(Me=q,X.set(q))};ti(r),We(r).change($=>{ti($)}),We(X).change($=>{if($===Me){Me=void 0;return}Me=void 0;let L=P($);if(L==null){Q?.({target:{value:$??""}});return}Q?.({target:{value:L}})});let Oi=We(k).compute($=>$!=null&&$!==!1),Wi=We(v,Oi).compute(([$,L])=>!m($)&&!L),xi=We(l).compute($=>m($)?"decimal":"numeric"),qi=We(w,D,N,l,p,d,y,h,c,a,o,V,A,S).compute(()=>({mode:"both",format:$=>{let L=Be($),q=m(w),oe=!!m(p)&&L.startsWith("-")?"-":"",ie=P(L),J=L.replace(oe,"");if(ie!=null){let re=Math.abs(ie);if(typeof q=="function")try{J=q(re)}catch{J=M(re)}else if(q==="currency")J=E(re,"currency");else if(q==="decimal"){let le=m(V),xe=m(S);J=le||xe?E(re,"decimal"):M(re)}else J=M(re)}return{value:L,raw:L,visual:pe(J,oe,q)}}})),b=$=>{let L=P(X.get()),q=Number(m(n)??1),oe=R((L??0)+q*$),ie=M(oe);X.set(ie)},O=$=>{if(!$||typeof $.setSelectionRange!="function")return;let L=()=>{try{let q=String($.value??"").length;$.setSelectionRange(q,q)}catch{}};typeof requestAnimationFrame=="function"?requestAnimationFrame(L):L()},ce=$=>{te?.($);let L=$?.target;L&&O(L)},U=$=>{if(ae?.($),m(c)!=="blur")return;let L=P(X.get());if(L==null)return;let q=R(L);X.set(M(q))},ge=$=>{H?.($),O($?.target)},ve=$=>{G?.($);let L=$?.target;if(!L)return;let q=m(D)??"",Z=ee();Z&&typeof L.selectionEnd=="number"&&(L.selectionEnd=Math.min(L.selectionEnd,String(L.value??"").length-Z.length)),q&&typeof L.selectionStart=="number"&&(L.selectionStart=Math.max(L.selectionStart,q.length))},ue=Ut({className:"g-ui-number-field-controls"},Xt({className:"g-ui-number-field-control",onClick:()=>b(1)},"+"),Xt({className:"g-ui-number-field-control",onClick:()=>b(-1)},"\u2212")),Te=Ut({className:"g-ui-number-field-controls-wrapper"},ue),Le=We(Wi,k).compute(([$,L])=>$?Te:L);return be({...B,size:u,className:s("g-ui-number-field",f),leftSection:x,rightSection:Le,type:"text",inputMode:xi,inputClassName:s("g-ui-input-number"),value:X,format:qi,onInput:ce,onBlur:U,onFocus:ge,onKeyDown:ve})}function eo(...e){return et(...e)}import{Div as Ni,Button as io,portal as to,when as it,after as ro}from"@granularjs/core";var yi='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/></svg>',ki='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M560-240 320-480l240-240 56 56-184 184 184 184-56 56Z"/></svg>',zi='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M379.33-244 154-469.33 201.67-517l177.66 177.67 378.34-378.34L805.33-670l-426 426Z"/></svg>',Kt='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M240-446.67v-66.66h480v66.66H240Z"/></svg>',je='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M312-265.33 265.33-312l168-168-168-167L312-693.67l168 168 167-168L693.67-647l-168 167 168 168L647-265.33l-167-168-168 168Z"/></svg>',Qt='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>',Jt='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>',er='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h357l-80 80H200v560h560v-278l80-80v358q0 33-23.5 56.5T760-120H200Zm280-360v-80h240v80H480Zm0 160v-80h320v80H480Zm0 160v-80h320v80H480ZM360-360v-80h80v80h-80Zm0 160v-80h80v80h-80Zm0 160v-80h80v80h-80Zm160-320h280l-36-37 37-37v74H520Zm-160 0h80v-80h-80v80ZM120-600v-160l160-160h160l-80 80H200v240h-80Zm80-240v-80 80Z"/></svg>',ir='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>',tr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80H200Zm0-80h560v-400H200v400Z"/></svg>',rr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z"/></svg>';function oi(...e){let{props:i,rawProps:t,children:r}=g(e,{size:"md",centered:!0,overlay:"normal"}),{opened:a,title:o,size:n,centered:u,overlay:l,position:p,className:d,style:y}=i,{onClose:h}=t,c=ro(p,u).compute(([v,w])=>`g-ui-modal-position-${v??(w===!1?"top-center":"center")}`);return it(a,()=>to(Ni({className:s("g-ui-modal-overlay",z("g-ui-modal-overlay-",l,"normal"),c),onClick:v=>{v.target===v.currentTarget&&h?.()}},Ni({className:s("g-ui-modal",z("g-ui-modal-size-",n,"md"),d)},Ni({className:"g-ui-modal-header"},it(o,()=>Ni({className:"g-ui-modal-title"},o)),it(h,()=>io({type:"button",className:"g-ui-button g-ui-button-variant-subtle g-ui-button-size-xs g-ui-modal-close",onClick:h,innerHTML:je}))),r))))}import{Div as Ci,Span as tt,after as ar,when as or}from"@granularjs/core";function ni(...e){let{props:i}=g(e,{variant:"spinner",size:"md"}),{variant:t,size:r,className:a}=i,o=ar(t).compute(u=>u==="dots"),n=ar(t).compute(u=>u==="bars");return or(o,()=>Ci({className:s("g-ui-loading g-ui-dots",z("g-ui-loading-size-",r,"md"),a)}),()=>or(n,()=>Ci({className:s("g-ui-loading g-ui-bars",z("g-ui-loading-size-",r,"md"),a)},tt(""),tt(""),tt("")),()=>Ci({className:s("g-ui-loading",z("g-ui-loading-size-",r,"md"),a)},Ci({className:"g-ui-spinner"}))))}import{Div as rt,Input as ao,Label as oo,Span as nr,when as at,state as no,after as so}from"@granularjs/core";function ot(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{checked:r,label:a,description:o,size:n,indeterminate:u,className:l,style:p,inputProps:d,...y}=i,{onChange:h}=t,c=no(ze(r));so(r).change(w=>{w!=null&&(c.set(!!w),h?.(w))});let v=oo({className:"g-ui-checkbox-control"},ao({type:"checkbox",indeterminate:u,checked:c,className:s("g-ui-checkbox-input",z("g-ui-checkbox-size-",n,"md"),d?.className),...y}),at(c,()=>rt({className:"g-ui-checkbox-checked",innerHTML:zi}),()=>{if(!c.get()&&u.get())return rt({className:"g-ui-checkbox-indeterminate",innerHTML:Kt})}),at(a,()=>nr({className:"g-ui-checkbox-label"},a)));return rt({className:s("g-ui-checkbox",z("g-ui-checkbox-size-",n,"md"),l)},v,at(o,()=>nr({className:"g-ui-checkbox-description"},o)))}import{Input as co,Label as po,Span as mo,when as fo,after as st,state as vo}from"@granularjs/core";import{Div as uo,context as go,after as sr}from"@granularjs/core";var nt=go({name:null,selected:null});function lo(...e){let{props:i,rawProps:t,children:r}=g(e),{className:a,name:o,selected:n,onChange:u,...l}=i,{onChange:p}=t,d=nt.scope({name:o?.get(),selected:n?.get()});return sr(d.selected).change(y=>{p?.(y)}),sr(n).change(y=>{y!==d.selected.get()&&(d.set().selected=y)}),d.serve(uo({...l,className:s("g-ui-switch-group",a)},r))}function ho(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{label:r,size:a,className:o,style:n,inputProps:u,checked:l,value:p,...d}=i,{onChange:y}=t,h=vo(l),c=nt.state(),v=st(c).compute(w=>({name:w.name,type:w.name?"radio":"checkbox"}));return st(c.selected).change(w=>{h.set(w===p.get())}),st(h).change(w=>{if(y?.(w),!w)return;let V=c.get().selected;c.set().selected=p.get()}),po({className:s("g-ui-switch",z("g-ui-switch-size-",a,"md"),o)},co({type:v.type,name:v.name,value:p,checked:h,className:s("g-ui-switch-input",z("g-ui-switch-size-",a,"md"),u?.className),...d}),fo(r,()=>mo({className:"g-ui-switch-label"},r)))}import{Div as Ee,Span as ut,when as Xe,state as ur,after as Si,Label as xo}from"@granularjs/core";import{Span as bo}from"@granularjs/core";function ye(...e){let{props:i,children:t}=g(e,{size:"md"});return bo({...i,className:s("g-ui-icon",z("g-ui-icon-size-",i.size,"md"),z("g-ui-icon-color-",i.color),i.className)},...t)}function wo(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"md"}),{data:r,value:a,size:o,leftSection:n,rightSection:u,placeholder:l,className:p,label:d,description:y,error:h,...c}=i,{onChange:v}=t,w=ur(!1),V=ur(m(a)??"");Si(a).change(N=>{let x=m(N);x!==void 0&&V.set(x??"")});let A=N=>{V.set(N),v?.(N),w.set(!1)},S=Si(V).compute(N=>N?"":"g-ui-select-placeholder"),D=Si(V).compute(N=>{let k=(m(r)??[]).find(f=>f.value===N);return N?k?.label??"":l??""});return Ee({...c,className:s("g-ui-select-root",p)},Xe(d,()=>xo({className:"g-ui-text-input-label"},d)),Xe(y,()=>ut({className:"g-ui-text-input-description"},y)),Ee({className:s("g-ui-input-wrapper",z("g-ui-input-size-",o,"md"))},Xe(n,()=>Ee({className:"g-ui-input-section"},n)),Ee({className:s("g-ui-select",S),onClick:()=>w.set(!w.get())},ut({className:"g-ui-select-value"},D)),Xe(u,()=>Ee({className:"g-ui-input-section"},u),()=>ut({className:"g-ui-select-caret"},ye({innerHTML:rr})))),Xe(h,()=>Ee({className:"g-ui-text-input-error-text"},h)),Xe(w,()=>Ee({className:"g-ui-select-dropdown"},(m(r)??[]).map(N=>Ee({className:s("g-ui-select-item",Si(V).compute(x=>x===N.value?"g-ui-select-item-active":"")),onClick:()=>A(N.value)},N.label)))))}import{Button as yo,Div as Ke,state as Ie,after as si,list as ko,when as zo}from"@granularjs/core";function No(...e){let{props:i,rawProps:t}=g(e,{tabs:[],orientation:"horizontal",variant:"default",sticky:!0,align:"left",size:"md"}),{value:r,tabs:a,orientation:o,variant:n,sticky:u,className:l,style:p,align:d,size:y}=i,{onChange:h}=t,c=Ie(m(r)??m(a)?.[0]?.value??""),v=Ie(),w=Ie(),V=Ie(0),A=Ie(0),S=Ie(0),D=Ie(0),N=Ie(!1),x=Ie(0),k=!1,f=null,C=!1,I=new Set;si(r).change(M=>{let E=m(M);E!=null&&c.set(E)});let B=M=>{c.set(M),h?.(M)},K=M=>{let E=[],R=M?.parentElement;for(;R;){let ee=getComputedStyle(R),pe=`${ee.overflow}${ee.overflowY}${ee.overflowX}`;/(auto|scroll)/.test(pe)&&E.push(R),R=R.parentElement}return E},se=M=>K(M)[0]??null,ae=M=>M?M.getBoundingClientRect().top:0,H=M=>M?M.scrollTop:window.scrollY||window.pageYOffset||0,G=(M,E)=>M>E?"down":M<E?"up":"none",Q=(M,E,R,ee)=>M==="down"&&E<R?!0:M==="up"&&E>=R?!1:ee,te=()=>{let M=v.get(),E=w.get();if(!M||!E)return;if(!ze(u)){N.set(!1),V.set(0);return}if(typeof window>"u")return;let R=M.getBoundingClientRect(),ee=E.getBoundingClientRect(),pe=se(M),ke=ae(pe),Pe=H(pe),Be=G(Pe,x.get());x.set(Pe);let Ve=Q(Be,R.top,ke,N.get());V.set(ee.height),A.set(R.left),S.set(R.width),D.set(ke),Ve!==N.get()&&N.set(Ve)},X=()=>{f==null&&(f=requestAnimationFrame(()=>{f=null,te()}))},T=M=>{!M||I.has(M)||(I.add(M),M.addEventListener("scroll",X,{passive:!0}))},j=()=>{if(k)return;let M=v.get(),E=w.get();!M||!E||typeof window>"u"||(k=!0,te(),T(window),window.addEventListener("resize",X),K(M).forEach(T))};si(w,v,u).change(j),!C&&typeof window<"u"&&(C=!0,setTimeout(()=>j(),0));let P=si(N,A,S,D).compute(M=>{let[E,R,ee,pe]=M;return E?{position:"fixed",top:`${pe}px`,left:`${R}px`,width:`${ee}px`,background:"var(--g-ui-surface)",zIndex:100}:{position:"static",top:"auto",left:"auto",width:"auto",zIndex:"auto",background:"transparent"}}),Y=si(N,V).compute(M=>{let[E,R]=M;return{height:E?`${R}px`:"0px"}});return Ke(Ke({className:s("g-ui-tabs",he(o,{vertical:"g-ui-tabs-vertical"}),z("g-ui-tabs-variant-",n,"default"),z("g-ui-tabs-align-",d,"left"),z("g-ui-tabs-size-",y,"md"),i.className??l)},Ke({node:v}),Ke({style:Y}),Ke({node:w,className:"g-ui-tabs-list",style:P},ko(a,M=>yo({className:si(c,M.value).compute(([E,R])=>s("g-ui-tabs-tab",R===E&&"g-ui-tabs-tab-active")),onClick:()=>B(M.get().value)},M.label))),Ke({className:"g-ui-tabs-panel"},zo(c,()=>a.get()?.find(M=>M.value===c.get())?.content??null))))}import{Table as Co,Thead as So,Tbody as Do,Tr as Po,Th as Mo,Td as To,list as lr,when as cr,after as gt}from"@granularjs/core";function Vo(...e){let{props:i}=g(e,{headers:[],rows:[]}),{headers:t,rows:r,striped:a,highlightOnHover:o,withBorder:n,withColumnBorders:u,withRowBorders:l,className:p,style:d,...y}=i,h=gt(t).compute(c=>c.length>0);return Co({...y,className:s("g-ui-table",_("g-ui-table-striped",a),_("g-ui-table-hover",o),_("g-ui-table-with-border",n),_("g-ui-table-column-borders",u),_("g-ui-table-row-borders",l),p)},cr(h,()=>So(gr(t,!0))),Do(lr(r,c=>gr(c,!1))))}var gr=(e,i)=>{let t=gt(e).compute(o=>Array.isArray(o)),r=o=>{let n=gt(o).compute(u=>Object.values(u));return a(n)},a=o=>lr(o,n=>i?Io(n):Lo(n));return Po(cr(t,()=>a(e),()=>r(e)))},Lo=e=>To(e),Io=e=>Mo(e);import{Div as lt}from"@granularjs/core";import{state as $o,when as Ao,after as Bo}from"@granularjs/core";function Fo(...e){let{props:i,rawProps:t,children:r}=g(e,{opened:!1}),{opened:a,className:o,...n}=i,{opened:u}=t,l=Oe(u),p=l?u:$o(ze(a));Bo(a).change(c=>{l||p.set(ze(c))});let d=()=>{l||p.set(!p.get())},y=r[0],h=r[1];return lt({...n,className:s("g-ui-accordion",o)},lt({className:"g-ui-accordion-header",onClick:d},y),Ao(p,()=>lt({className:"g-ui-accordion-content"},h)))}import{Span as pr}from"@granularjs/core";function jo(...e){let{props:i,children:t}=g(e),{label:r,className:a,style:o}=i;return pr({className:s("g-ui-tooltip",a)},t,pr({className:"g-ui-tooltip-content"},r))}import{Div as ui,when as Eo,after as Ro,state as gi,portal as Ho}from"@granularjs/core";var ct=gi({currentOpenState:null});function Oo(...e){let i=gi(),t=gi(),r=gi({}),{props:a,rawProps:o,children:n}=g(e,{position:"right"}),{opened:u,content:l,position:p,className:d,...y}=a,{onChange:h}=o,c=gi(m(u)??!1);Ro(u).change(N=>{let x=m(N);x!=null&&(c.set(!!x),x&&v())});let v=()=>{ct.get().currentOpenState!==c&&(ct.get().currentOpenState?.set(!1),ct.set().currentOpenState=c)};u.get()&&v();let w=N=>{let k=String(N??"right").toLowerCase().split("-").filter(Boolean);if(k.length===1){let I=k[0];return I==="top"||I==="bottom"?{placement:I,align:"center"}:I==="left"||I==="right"?{placement:"bottom",align:I}:I==="center"?{placement:"bottom",align:"center"}:{placement:"bottom",align:"right"}}let[f,C]=k;return f==="top"||f==="bottom"?{placement:f,align:C||"center"}:f==="left"||f==="right"?{placement:f,align:C||"center"}:{placement:"bottom",align:"right"}},V=()=>{let N=i.get(),x=t.get();if(!N||!x||typeof window>"u")return;let k=N.getBoundingClientRect(),f=x.getBoundingClientRect(),C=m(p)??"right",I=getComputedStyle(document.documentElement).getPropertyValue("--g-ui-space-20"),B=Number.parseFloat(I)||20,K=window.innerWidth||0,se=window.innerHeight||0,ae=Math.max(B,K-f.width-B),H=Math.max(B,se-f.height-B),{placement:G,align:Q}=w(C),te=8,X=k.bottom+te,T=k.left;G==="top"||G==="bottom"?(X=G==="top"?k.top-f.height-te:k.bottom+te,Q==="center"?T=k.left+k.width/2-f.width/2:Q==="right"?T=k.right-f.width:T=k.left):(G==="left"||G==="right")&&(T=G==="left"?k.left-f.width-te:k.right+te,Q==="center"?X=k.top+k.height/2-f.height/2:Q==="bottom"?X=k.bottom-f.height:X=k.top),T=Math.max(B,Math.min(T,ae)),X=Math.max(B,Math.min(X,H)),r.set({top:`${X}px`,left:`${T}px`})},A=N=>{c.set(N),h?.(N),N&&(v(),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>V()):setTimeout(()=>V(),0))},S=()=>A(!c.get()),D=()=>A(!1);return ui({...y,node:i,className:s("g-ui-menu",d)},ui({onClick:S},n),Eo(c,()=>Ho(ui(ui({className:"g-ui-menu-overlay",onClick:D}),ui({className:"g-ui-menu-dropdown",node:t,style:r},l)))))}import{Div as dr,portal as Wo,when as qo}from"@granularjs/core";function Yo(...e){let{props:i,children:t}=g(e,{position:"right",size:"md",overlay:"normal",shadowed:!0}),{opened:r,onClose:a,position:o,size:n,overlay:u,shadowed:l,className:p,style:d}=i;return qo(r,()=>Wo(dr({className:s("g-ui-drawer-overlay",z("g-ui-drawer-overlay-",u,"normal")),onClick:a},dr({className:s("g-ui-drawer",he(l,{true:"g-ui-drawer-shadowed"},!0),z("g-ui-drawer-",o,"right"),z("g-ui-drawer-size-",n,"md"),p),onClick:y=>y.stopPropagation()},t))))}import{Button as Go,Div as pt,Span as mr,when as Di,after as fr}from"@granularjs/core";function dt(...e){let{props:i,rawProps:t,children:r}=g(e,{color:"blue",withCloseButton:!0}),{title:a,color:o,icon:n,loading:u,withCloseButton:l,withBorder:p,className:d,style:y}=i,{onClose:h}=t,c=fr(n,u).compute(([w,V])=>!w&&!!V),v=fr(n,u).compute(([w,V])=>!!w||!!V);return pt({className:s("g-ui-notification",[p,"g-ui-notification-bordered"],[o,w=>`g-ui-notification-${w}`],[v,"g-ui-notification-with-icon"],d)},Di(n,()=>mr({className:"g-ui-notification-icon"},n)),Di(c,()=>ni({size:"sm",className:"g-ui-notification-loader"})),pt({className:"g-ui-notification-body"},Di(a,()=>pt({className:"g-ui-notification-title"},a)),r),Di(l,()=>Go({type:"button",className:"g-ui-notification-close",onClick:()=>h?.()},mr({innerHTML:je}))))}import{Div as _o,when as Zo}from"@granularjs/core";function Uo(...e){let{props:i}=g(e,{labelPosition:"center"}),{label:t,labelPosition:r,vertical:a,className:o,...n}=i;return _o({...n,className:s("g-ui-divider",_("label",t),z("g-ui-divider-label-",r,"center"),_("g-ui-divider-vertical",a),o)},Zo(t,()=>Xi({className:"g-ui-divider-label-text",size:"sm"},t)))}import{Div as Xo}from"@granularjs/core";function Ko(...e){let{props:i,children:t}=g(e,{padding:"md",radius:"md",shadow:"none"}),{padding:r,radius:a,shadow:o,className:n,...u}=i;return Xo({...u,className:s("g-ui-paper",[r,l=>`g-ui-card-padding-${l}`],[a,l=>`g-ui-card-radius-${l}`],[o,l=>`g-ui-card-shadow-${l}`],n)},t)}import{Button as Qo,Div as mt,Span as Jo,after as vr,when as ft}from"@granularjs/core";function en(...e){let{props:i,rawProps:t,children:r}=g(e,{color:"blue"}),{title:a,color:o,icon:n,withCloseButton:u,className:l,...p}=i,{onClose:d}=t,y=vr(a,u).compute(([c,v])=>c||v),h=vr(n).compute(c=>c!==void 0);return mt({...p,className:s("g-ui-alert",[o,c=>`g-ui-alert-${c}`],l)},mt({className:"g-ui-alert-header"},ft(n,()=>Jo({className:"g-ui-alert-icon"},n)),ft(a,()=>mt({className:"g-ui-alert-title"},a)),ft(u,()=>Qo({type:"button",className:"g-ui-alert-close",onClick:()=>d?.()},"\xD7"))),r)}import{Div as tn,Img as rn,when as an}from"@granularjs/core";function on(...e){let{props:i,children:t}=g(e,{size:"md",alt:""}),{src:r,size:a,alt:o,className:n,...u}=i;return tn({...u,className:s("g-ui-avatar",[a,l=>`g-ui-avatar-size-${l}`],n)},an(r,()=>rn({className:"g-ui-avatar-img",src:r,alt:o}),()=>t))}import{Span as nn}from"@granularjs/core";function sn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return nn({...a,className:s("g-ui-kbd",r)},t)}import{Code as un}from"@granularjs/core";function gn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return un({...a,className:s("g-ui-code",r)},t)}import{Blockquote as ln}from"@granularjs/core";function cn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return ln({...a,className:s("g-ui-blockquote",r)},t)}import{Div as pn}from"@granularjs/core";function dn(...e){let{props:i,children:t}=g(e,{cols:3,gap:"md"}),{cols:r,gap:a,className:o,...n}=i;return pn({...n,className:s("g-ui-grid",[a,u=>`g-ui-gap-${u}`],[r,u=>`g-ui-grid-cols-${u}`],o)},t)}import{Ul as mn,Ol as fn,Li as vt,Div as Pi,Span as ht,after as bt,when as qe,isSignal as vn,isState as hn,isStatePath as bn,isComputed as xn}from"@granularjs/core";function hr(...e){let{props:i,children:t}=g(e,{type:"none",size:"md"}),{type:r,size:a,withPadding:o,className:n,...u}=i,l=he(r,{ordered:"g-ui-list-ordered",unordered:"g-ui-list-unordered",none:"g-ui-list-none"}),p=bt(r).compute(w=>w==="ordered"),d=w=>w&&typeof w=="object"&&typeof w.tagName=="string"&&(w.tagName.toLowerCase()==="ul"||w.tagName.toLowerCase()==="ol"),y=w=>w&&typeof w=="object"&&typeof w.tagName=="string"&&w.tagName.toLowerCase()==="li",h=w=>{let V=A=>A?.nodeType==="granular-list-node"?A:A==null||A===!1?null:Array.isArray(A)?A.map(S=>V(S)):y(A)?A:d(A)?vt({className:"g-ui-list-nested-item"},A):vt(ht({className:"g-ui-list-item-shell"},A));return vn(w)||hn(w)||bn(w)||xn(w)?bt(w).compute(A=>V(A)):V(w)},c=qe(t,()=>t.map(w=>h(w))),v={...u,className:s("g-ui-list",z("g-ui-list-size-",a,"md"),_("g-ui-list-with-padding",o),l,n)};return qe(p,()=>fn(v,c),()=>mn(v,c))}function wn(...e){let{props:i,children:t}=g(e,{withBorder:!1}),{leftSection:r,rightSection:a,title:o,body:n,withBorder:u,className:l,verticalPadding:p,horizontalPadding:d,...y}=i,h=bt(o,n).compute(([c,v])=>!!c||!!v);return vt({...y,className:s("g-ui-list-item",_("g-ui-list-item-border",u),z("g-ui-list-item-vertical-padding-",p,"md"),z("g-ui-list-item-horizontal-padding-",d,"md"),l)},Pi({className:"g-ui-list-item-shell"},qe(r,()=>ht({className:"g-ui-list-item-section g-ui-list-item-section-left"},r)),qe(h,()=>Pi({className:"g-ui-list-item-content"},qe(o,()=>Pi({className:"g-ui-list-item-title"},o)),qe(n,()=>Pi({className:"g-ui-list-item-body"},n))),()=>t),qe(a,()=>ht({className:"g-ui-list-item-section g-ui-list-item-section-right"},a))))}hr.Item=wn;import{A as yn}from"@granularjs/core";function kn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return yn({...a,className:s("g-ui-anchor",r)},t)}import{Img as zn}from"@granularjs/core";function Nn(...e){let{props:i}=g(e),{className:t,...r}=i;return zn({...r,className:s("g-ui-image",t)})}import{Div as br}from"@granularjs/core";function Cn(...e){let{props:i}=g(e,{value:0,color:"primary",size:"md"}),{value:t,color:r,size:a,className:o,...n}=i;return br({...n,className:s("g-ui-progress",z("g-ui-progress-size-",a,"md"),[t,u=>{let l=Math.max(0,Math.min(100,Number(u)||0));return`g-ui-progress-${Math.round(l/5)*5}`}],[r,u=>u?`g-ui-progress-${u}`:""],o)},br({className:"g-ui-progress-bar"}))}import{Div as Re,after as Ye,state as Sn,when as xr,list as Dn}from"@granularjs/core";function Pn(...e){let{props:i,rawProps:t}=g(e,{size:"md",min:0,max:100,step:1}),{onChange:r}=t,{value:a,marks:o,size:n,min:u,max:l,step:p,disabled:d,className:y,...h}=i,c=Sn(m(a??u)),v=Ye(o).compute(x=>x&&x.length>0);Ye(a).change(x=>{x!=null&&c.set(m(x))});let w=()=>{let x=Number(m(u)),k=Number(m(l));return!Number.isFinite(x)||!Number.isFinite(k)?{minValue:0,maxValue:100}:{minValue:Math.min(x,k),maxValue:Math.max(x,k)}},V=()=>{let x=Number(m(p));return Number.isFinite(x)&&x>0?x:1},A=x=>{let{minValue:k,maxValue:f}=w(),C=V(),I=Math.max(k,Math.min(f,Number(x))),B=Math.round((I-k)/C)*C+k;B!==c.get()&&(c.set(B),r?.(B))},S=Ye(c).compute(x=>{let{minValue:k,maxValue:f}=w(),C=f-k;if(C<=0)return 0;let I=(Number(x??k)-k)/C*100;return Math.max(0,Math.min(100,I))}),D=(x,k)=>{let f=k?.();if(!f||f.width===0)return;let I=Math.min(Math.max(x.clientX-f.left,0),f.width)/f.width,{minValue:B,maxValue:K}=w();A(B+I*(K-B))},N=x=>{if(ze(d))return;x.preventDefault?.();let k=x.currentTarget,f=()=>k.getBoundingClientRect();k.setPointerCapture?.(x.pointerId),D(x,f);let C=B=>D(B,f),I=()=>{k.releasePointerCapture?.(x.pointerId),window.removeEventListener("pointermove",C),window.removeEventListener("pointerup",I)};window.addEventListener("pointermove",C),window.addEventListener("pointerup",I)};return Re({...h,className:s("g-ui-slider",z("g-ui-slider-size-",n,"md"),_("g-ui-slider-disabled",d),y)},Re({className:"g-ui-slider-track",onPointerDown:N},Re({className:"g-ui-slider-bar",style:Ye(S).compute(x=>({width:`${x}%`}))}),Re({className:"g-ui-slider-thumb",style:Ye(S).compute(x=>({left:`${x}%`}))})),xr(v,()=>Re({className:"g-ui-slider-marks-placeholder"})),xr(o,()=>Re({className:"g-ui-slider-marks"},Dn(o,x=>xt({mark:x,getBounds:w})))))}var xt=({mark:e,getBounds:i})=>{let{minValue:t,maxValue:r}=i(),a=r-t,o=Ye(e).compute(p=>p.value??p),n=Ye(e).compute(p=>p.label??String(p.value)??o),u=Number(o),l=0;return a>0&&(l=(u-t)/a*100),Re({className:"g-ui-slider-mark",style:{left:`${Math.max(0,Math.min(100,l))}%`}},Re({className:"g-ui-slider-mark-label"},n))};import{Div as Mn,after as Tn}from"@granularjs/core";function Vn(...e){let{props:i}=g(e,{height:"md",width:"full"}),{height:t,width:r,className:a,...o}=i,n=Tn(t,r).compute(([u,l])=>{let p={};return isNaN(u)||(p.height=`${u}px`),isNaN(l)||(p.width=`${l}px`),p});return Mn({...o,style:{width:n.width,height:n.height,...o.style||{}},className:s("g-ui-skeleton",[t,u=>`g-ui-skeleton-h-${u}`],[r,u=>`g-ui-skeleton-w-${u}`],a)})}import{Button as Ln,after as wr,state as In}from"@granularjs/core";function $n(...e){let{props:i,rawProps:t,children:r}=g(e,{size:"md",variant:"filled",color:"primary"}),{checked:a,size:o,variant:n,color:u,className:l,...p}=i,{onChange:d}=t,y=In(!!a);wr(a).change(c=>{c!=null&&y.set(!!c)});let h=c=>{y.set(c),d?.(c)};return Ln({...p,type:"button",className:s("g-ui-chip",z("g-ui-chip-size-",o,"md"),z("g-ui-chip-variant-",n,"filled"),z("g-ui-chip-color-",u,"primary"),wr(y).compute(c=>c?"g-ui-chip-active":""),l),onClick:()=>h(!y.get())},r)}import{Div as wt,after as yr,state as An,list as Bn}from"@granularjs/core";function Fn(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"sm"}),{value:r,data:a,size:o,scroll:n,className:u,...l}=i,{onChange:p}=t,d=An(m(r));yr(r).change(h=>{let c=m(h);c!=null&&d.set(c)});let y=h=>{d.set(h),p?.(h)};return wt({...l,className:s(n&&"g-ui-segmented-scroll")},wt({className:s("g-ui-segmented",z("g-ui-segmented-size-",o,"sm"),u)},Bn(a,(h=>wt({className:s("g-ui-segmented-item",yr(d).compute(c=>h.get().value===c?"g-ui-segmented-active":"")),onClick:()=>y(h.get().value)},h.label)))))}import{Button as yt,Div as jn,state as En,after as Mi}from"@granularjs/core";function Rn(...e){let{props:i,rawProps:t}=g(e,{total:1,size:"md"}),{page:r,total:a,size:o,className:n,...u}=i,{onChange:l}=t,p=En(m(r)??1);Mi(r).change(c=>{let v=m(c);v!=null&&p.set(v)});let d=c=>{let v=Number(m(a))||1,w=Math.max(1,Math.min(v,c));p.set(w),l?.(w)},y=[],h=Number(m(a))||1;for(let c=1;c<=h;c+=1)y.push(c);return jn({...u,className:s("g-ui-pagination",z("g-ui-pagination-size-",o,"md"),i.className??n)},yt({className:"g-ui-pagination-item",onClick:()=>d((p.get?.()??p)-1),disabled:Mi(p).compute(c=>c<=1)},"<"),y.map(c=>yt({className:Mi(p).compute(v=>s("g-ui-pagination-item",c===v&&"g-ui-pagination-item-active")),onClick:()=>d(c)},String(c))),yt({className:"g-ui-pagination-item",onClick:()=>d((p.get?.()??p)+1),disabled:Mi(p).compute(c=>c>=a)},">"))}import{Div as qn,Input as Yn,Label as Gn,Span as kr,when as zr,after as Nt,state as _n}from"@granularjs/core";import{Div as Hn,context as On,after as kt}from"@granularjs/core";var zt=On({name:"",selected:null});function Wn(...e){let{props:i,children:t,rawProps:r}=g(e),{className:a,name:o,selected:n,onChange:u,...l}=i,{onChange:p}=r,d=zt.scope({name:o?.get(),selected:n?.get()});return console.log("selected?.get()",n?.get()),kt(o).change(y=>{d.set().name=y}),kt(n).change(y=>{y!==d.selected.get()&&(d.set().selected=y)}),kt(d.selected).change(y=>{p?.(y)}),d.serve(Hn({...l,className:s("g-ui-stack g-ui-gap-sm",a)},t))}function Zn(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{label:r,name:a,value:o,checked:n,description:u,size:l,className:p,inputProps:d,...y}=i,{onChange:h}=t,c=_n(n?.get()??!1),v=zt.state(),w=Nt(v.name,a).compute(([A,S])=>A||S);Nt(n,v.selected).change(A=>{let[S,D]=A;v.get().name?c.set(D===o.get()):c.set(S)}),Nt(c).change(A=>{h?.(A),A&&v.get().name&&(v.set().selected=o.get())});let V=Gn({className:"g-ui-radio-control"},Yn({type:"radio",name:w,value:o,checked:c,className:s("g-ui-radio-input",z("g-ui-radio-size-",l,"md"),d?.className),...y}),zr(r,()=>kr({className:"g-ui-radio-label"},r)));return qn({className:s("g-ui-radio",z("g-ui-radio-size-",l,"md"),p)},V,zr(u,()=>kr({className:"g-ui-radio-description"},u)))}import{Nav as Un,Span as Xn}from"@granularjs/core";function Kn(...e){let{props:i,children:t}=g(e,{separator:"/"}),{separator:r,className:a,...o}=i,n=[];Array.isArray(t)?n.push(...t):n.push(t);let u=n.filter(Boolean),l=[];return u.forEach((p,d)=>{l.push(p),d<u.length-1&&l.push(Xn({className:"g-ui-breadcrumbs-separator"},r))}),Un({...o,className:s("g-ui-breadcrumbs",a)},l)}import{Div as Qn}from"@granularjs/core";function Jn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Qn({...a,className:s("g-ui-center",r)},t)}import{Div as es}from"@granularjs/core";function is(...e){let{props:i}=g(e,{size:"md"}),{size:t,className:r,...a}=i;return es({...a,className:s("g-ui-space",[t,o=>`g-ui-space-${o}`],r)})}import{Div as ts,when as rs}from"@granularjs/core";function as(...e){let{props:i,children:t}=g(e),{opened:r,className:a,...o}=i;return rs(r,()=>ts({...o,className:s("g-ui-collapse",a)},t))}import{Button as os}from"@granularjs/core";function Ge(...e){let{props:i,children:t}=g(e,{size:"md",variant:"filled"}),{size:r,variant:a,color:o,className:n,...u}=i;return os({...u,type:"button",className:s("g-ui-action-icon",z("g-ui-action-icon-size-",r,"md"),z("g-ui-action-icon-color-",o,"primary"),z("g-ui-action-icon-",a,"filled"),n)},t)}import{Div as Ct,when as ns,after as ss,state as us}from"@granularjs/core";function St(...e){let{props:i,rawProps:t,children:r}=g(e,{position:"left"}),{opened:a,position:o,content:n,className:u,...l}=i,{onChange:p}=t,d=us(m(a)??!1);ss(a).change(h=>{let c=m(h);c!=null&&d.set(!!c)});let y=h=>{d.set(h),p?.(h)};return Ct({...l,className:s("g-ui-popover",i.className??u)},Ct({onClick:()=>y(!d.get())},r),ns(d,()=>Ct({className:s("g-ui-popover-dropdown",o==="right"&&"g-ui-popover-right",o==="center"&&"g-ui-popover-center")},n)))}import{Div as Nr}from"@granularjs/core";function gs(...e){let{props:i,children:t}=g(e,{position:"left"}),{position:r,content:a,className:o,...n}=i;return Nr({...n,className:s("g-ui-hover-card",o)},t,Nr({className:s("g-ui-hover-card-dropdown",[r,u=>u==="right"?"g-ui-hover-card-right":""],[r,u=>u==="center"?"g-ui-hover-card-center":""])},a))}import{Div as ls}from"@granularjs/core";function cs(...e){let{props:i,children:t}=g(e,{position:"bottom-right"}),{position:r,className:a,...o}=i;return ls({...o,className:s("g-ui-affix",[r,n=>`g-ui-affix-${n}`],a)},t)}import{Fieldset as ps,Legend as ds,when as ms}from"@granularjs/core";function fs(...e){let{props:i,children:t}=g(e),{legend:r,className:a,...o}=i;return ps({...o,className:s("g-ui-fieldset",a)},ms(r,()=>ds({className:"g-ui-legend"},r)),t)}import{Div as vs}from"@granularjs/core";function hs(...e){let{props:i,children:t}=g(e,{position:"sticky"}),{position:r,className:a,...o}=i;return vs({...o,className:s("g-ui-appbar",z("g-ui-appbar-",r,"sticky"),a)},t)}import{Div as Dt,portal as bs,after as Ti,state as Cr,when as Sr}from"@granularjs/core";function xs(...e){let{props:i,children:t}=g(e,{position:"left",size:"md",blur:!0,fixed:!1,minWidth:"button"});return Sr(i.fixed,()=>ys(i,t),()=>ws(i,t))}var ws=(e,i)=>{let{open:t,onClose:r,position:a,size:o,blur:n,fixed:u,minWidth:l,className:p,...d}=e,y=Cr(!1),h=Cr(!1),c=220,v=A=>{if(A){y.set(!0),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>h.set(!0)):setTimeout(()=>h.set(!0),0);return}h.set(!1),setTimeout(()=>y.set(!1),c)};v(!!t.get()),Ti(t).change(A=>v(!!A));let w=Ti(h,n).compute(A=>{let[S,D]=A;return s("g-ui-sidebar-overlay",S&&"g-ui-sidebar-overlay-open",!D&&"g-ui-sidebar-overlay-noblur")}),V=Ti(o,a,h,p).compute(A=>{let[S,D,N,x]=A,k=D==="right"?"g-ui-sidebar-drawer-right g-ui-sidebar-position-right":"g-ui-sidebar-drawer-left";return s("g-ui-sidebar","g-ui-sidebar-drawer",`g-ui-sidebar-size-${S}`,k,N&&"g-ui-sidebar-drawer-open",m(x))});return Sr(y,()=>bs(Dt({className:w,onClick:r},Dt({className:V,onClick:A=>A.stopPropagation()},i))))},ys=(e,i)=>{let{open:t,position:r,size:a,minWidth:o,className:n,...u}=e,l=Ti(a,r,t,o,n).compute(p=>{let[d,y,h,c,v]=p,w=c||"button",V=null;return w==="button"?V="g-ui-sidebar-min-button":w==="xs"?V="g-ui-sidebar-min-xs":w==="sm"?V="g-ui-sidebar-min-sm":w==="md"&&(V="g-ui-sidebar-min-md"),s("g-ui-sidebar g-ui-sidebar-fixed",`g-ui-sidebar-size-${d||"md"}`,V,h&&"g-ui-sidebar-fixed-open",v)});return Dt({...u,className:l},i)};import{Div as Ne,when as Vi,list as Dr,after as ne,resolve as de,state as ks,Img as zs,Span as Ns}from"@granularjs/core";var Pr={xs:6,sm:8,md:10,lg:12,xl:14},Cs={xs:"2px",sm:"3px",md:"4px",lg:"6px",xl:"8px"},Ss={xs:"6px",sm:"8px",md:"10px",lg:"12px",xl:"14px"},Ds=14;function Ps(e){if(e==null||e==="")return"var(--g-ui-primary)";let i=String(e).trim();return i.startsWith("#")?i:`var(--g-ui-${i})`}function Ms(e){return(e??[]).map(t=>{if(t==null)return 1;let r=Number(t.weight);return Number.isFinite(r)&&r>=0?r:1})}function Li(e){let i=(e??[]).length;if(i<2)return{totalWeight:0,cumulativeWeights:[0]};let r=Ms(e).slice(0,i-1),a=r.reduce((n,u)=>n+u,0),o=[0];for(let n=0;n<r.length;n++)o.push(o[n]+r[n]);return{totalWeight:a,cumulativeWeights:o}}function Mr(e,i,t,r){if(r<1||t<=0)return 0;let a=Math.max(0,Math.min(100,e));for(let o=r-1;o>=0;o--){let n=i[o]/t*100;if(a>=n)return o}return 0}function Ts(e,i,t,r,a,o,n){let u=e,l=(n??[]).length;if(l===0)return{activeStep:0,progressPct:0};if(u==="step")return{activeStep:Math.max(0,Math.min(l-1,Math.floor(i??0))),progressPct:0};if(u==="percent"){let p=Math.max(0,Math.min(100,Number(t)||0)),d=Li(n);return{activeStep:Mr(p,d.cumulativeWeights,d.totalWeight,l),progressPct:p}}if(u==="time"){let p=Number(r)||0,d=a,y=o,h=0;if(Array.isArray(d)&&d.length>=l?h=d.slice(0,l).reduce((S,D)=>S+(Number(D)||0),0):typeof y=="number"&&y>0&&(h=y),h<=0)return{activeStep:0,progressPct:0};let c=h/l,v=0;if(Array.isArray(d)&&d.length>=l){let S=0;for(let D=0;D<l;D++){if(S+=Number(d[D])||0,p<S){v=D;break}v=D}}else v=Math.min(l-1,Math.floor(p/c));let w=Math.min(100,p/h*100),V=Li(n);return{activeStep:Mr(w,V.cumulativeWeights,V.totalWeight,l),progressPct:w}}return{activeStep:0,progressPct:0}}function Vs(e,i,t,r,a,o){if(a<2||r<0||r>=a-1)return 0;if(e==="step")return i>r?100:0;let{totalWeight:n,cumulativeWeights:u}=o??Li([]);if(n<=0)return 0;let l=u[r]/n*100,p=u[r+1]/n*100;if(t<=l)return 0;if(t>=p)return 100;let d=p-l;return d<=0?0:(t-l)/d*100}var Ls=0;function Is(e){let i=document.getElementById(e);if(!i)return[];let t=i.querySelectorAll(".g-ui-timeline-item");if(t.length<2)return[];let r=i.dataset.pinSize||"md",a=Pr[r]??Pr.md,o=[];for(let n=0;n<t.length-1;n++){let u=t[n].offsetTop+a,l=t[n+1].offsetTop-t[n].offsetTop;o.push({top:u,height:l})}return o}function $s(...e){let{props:i,rawProps:t}=g(e,{items:[],mode:"step",active:0,progress:0,elapsedMs:0,stepDurationsMs:null,totalDurationMs:null,clickable:!1,pinRadius:"md",reverseActive:!1,lineWidth:"md",pinSize:"md",activeColor:"primary",align:"left",pinMode:"default"}),{items:r,mode:a,active:o,progress:n,elapsedMs:u,stepDurationsMs:l,totalDurationMs:p,clickable:d,pinRadius:y,reverseActive:h,lineWidth:c,pinSize:v,activeColor:w,align:V,pinMode:A,className:S,...D}=i,{onChange:N}=t,x=ne(w).compute(H=>Ps(de(H))),k=`g-ui-timeline-${++Ls}`,f=ks([]),C=ne(a,o,n,u,l,p,r).compute(H=>{let[G,Q,te,X,T,j,P]=H;return Ts(G,Q,te,X,T,j,P)}),I=ne(f,h).compute(([H,G])=>{if(!de(G)||!H?.length)return null;let Q=H[0],te=0;for(let X of H)te+=X.height;return{top:Q.top,height:te}}),B=ne(C).compute(H=>H?.progressPct!=null?`${Math.max(0,Math.min(100,H.progressPct))}%`:"0%"),K=ne(a).compute(H=>{let G=de(H);return G==="time"||G==="percent"||G==="step"}),se=ne(a).compute(H=>de(H));function ae(){setTimeout(()=>{let H=Is(k);H.length&&f.set(H)},0)}return ne(r).change(()=>ae()),ne(v).change(()=>ae()),ae(),Ne({...D,id:k,"data-pin-size":ne(v).compute(H=>de(H)??"md"),"data-active-color":ne(w).compute(H=>{let G=de(H);if(G==null||typeof G!="string")return"primary";let Q=String(G).trim();return Q.startsWith("#")?"custom":Q||"primary"}),style:ne(w,c,v).compute(([H,G,Q])=>{let te={"--g-ui-timeline-line-width":Cs[de(G)]??"4px","--g-ui-timeline-track-offset":`calc(${Ds}px - var(--g-ui-timeline-line-width) / 2)`,"--g-ui-timeline-pin-half":Ss[de(Q)]??"10px"},X=de(H);return X&&String(X).trim().startsWith("#")&&(te["--g-ui-timeline-active-color"]=String(X).trim()),te}),className:s("g-ui-timeline",ne(a).compute(H=>H?`g-ui-timeline-mode-${de(H)}`:""),ne(K).compute(H=>H?"g-ui-timeline-has-track":""),ne(d).compute(H=>de(H)?"g-ui-timeline-clickable":""),ne(h).compute(H=>de(H)?"g-ui-timeline-reverse":""),ne(V).compute(H=>de(H)==="right"?"g-ui-timeline-align-right":""),z("g-ui-timeline-pin-radius-",y,"md"),z("g-ui-timeline-line-width-",c,"md"),z("g-ui-timeline-pin-size-",v,"md"),ne(A).compute(H=>H?`g-ui-timeline-pin-mode-${de(H)}`:""),S)},Vi(K,()=>ne(h).compute(H=>de(H)?Ne({className:"g-ui-timeline-track-segment g-ui-timeline-track-reverse",style:ne(I).compute(G=>G?{top:`${G.top}px`,height:`${G.height}px`}:{})},Ne({className:"g-ui-timeline-track-fill",style:ne(B).compute(G=>G?{height:G}:{height:"0%"})})):Dr(f,(G,Q)=>{let te=ne(G).compute(j=>j?{top:`${j.top}px`,height:`${j.height}px`}:{}),X=ne(C,Q,r,se).compute(([j,P,Y,M])=>{let E=Y??[],R=E.length,ee=Li(E);return Vs(M,j?.activeStep??0,j?.progressPct??0,de(P)??0,R,ee)}),T=ne(X).compute(j=>`${Math.max(0,Math.min(100,j))}%`);return Ne({className:"g-ui-timeline-track-segment",style:ne(te).compute(j=>j)},Ne({className:"g-ui-timeline-track-fill",style:ne(T).compute(j=>j?{height:j}:{height:"0%"})}))}))),Dr(r,(H,G)=>{let Q=ne(C,G,r,h).compute(([E,R,ee,pe])=>{let ke=E?.activeStep??0,Pe=de(R)??0,Be=(ee??[]).length,Ve=de(pe)?Be-1-Pe:Pe;return Ve<ke?"completed":Ve===ke?"active":"future"}),te=ne(Q).compute(E=>E?`g-ui-timeline-item-${E}`:""),X=de(d)&&typeof N=="function"?()=>{let E=de(G);typeof E=="number"&&N(E)}:void 0,T=ne(A).compute(E=>de(E)??"default"),j=ne(T,H).compute(([E,R])=>{let ee=E??"default";return ee==="icon"&&(R?.icon!=null||R?.pinIcon!=null)?Ns({className:"g-ui-timeline-pin-icon material-symbols-outlined"},R.icon??R.pinIcon??""):ee==="image"&&(R?.image!=null||R?.pinImage!=null||R?.src!=null)?zs({className:"g-ui-timeline-pin-image",src:R.image??R.pinImage??R.src,alt:R.pinImageAlt??""}):ee==="custom"&&R?.pinContent!=null?R.pinContent:null}),P=ne(T,H).compute(([E,R])=>{let ee=E??"default";return ee==="icon"?R?.icon!=null||R?.pinIcon!=null:ee==="image"?R?.image!=null||R?.pinImage!=null||R?.src!=null:ee==="custom"?R?.pinContent!=null:!1}),Y=Ne({className:"g-ui-timeline-dot"},Ne({className:"g-ui-timeline-dot-inner"}),Vi(P,()=>j)),M=Ne({className:"g-ui-timeline-content"},Vi(H.title,()=>Ne({className:"g-ui-timeline-title"},H.title)),Vi(H.description,()=>Ne({className:"g-ui-timeline-desc"},H.description)),H.content);return Ne({className:s("g-ui-timeline-item",te),style:ne(x).compute(E=>E?{"--g-ui-timeline-active-color":E}:void 0),onClick:X,role:X?"button":void 0,tabIndex:X?0:void 0},Ne({className:"g-ui-dot-wrapper"},Y),M)}))}import{Div as Ii,list as As}from"@granularjs/core";function Bs(...e){let{props:i}=g(e,{active:0,items:[]}),{active:t,items:r,className:a,...o}=i;return Ii({...o,className:s("g-ui-stepper",a)},As(r,(n,u)=>Ii({className:s("g-ui-stepper-item",[t,l=>(console.log("value",l,"idx",u),u.get()===l?"g-ui-stepper-active":"")])},Ii({className:"g-ui-stepper-index"},String(u+1)),Ii({className:"g-ui-stepper-label"},n.label))))}import{Span as Tr,after as Vr,state as Fs}from"@granularjs/core";function js(...e){let{props:i,rawProps:t}=g(e,{value:0,max:5,size:"md"}),{value:r,max:a,size:o,className:n,...u}=i,{onChange:l}=t,p=Fs(m(r));Vr(r).change(c=>{let v=m(c);v!=null&&p.set(v)});let d=c=>{p.set(c),l?.(c)},y=[],h=Number(m(a))||0;for(let c=1;c<=h;c+=1)y.push(c);return Tr({...u,className:s("g-ui-rating",z("g-ui-rating-size-",o,"md"),i.className??n)},y.map(c=>Tr({className:s("g-ui-rating-item",Vr(p).compute(v=>c<=v?"g-ui-rating-item-active":"")),onClick:()=>d(c)},"\u2605")))}import{Span as Es}from"@granularjs/core";function Rs(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Es({...a,className:s("g-ui-tag",r)},t)}import{Button as Lr,Div as Qe,state as Ir,after as $i}from"@granularjs/core";var Hs=["S","M","T","W","T","F","S"];function li(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{value:r,className:a,size:o,...n}=i,{onChange:u}=t,l=S=>{let D=m(S);if(D instanceof Date)return D;if(D==null)return null;let N=new Date(D);return Number.isNaN(N.getTime())?null:N},p=Ir(l(r)??new Date),d=Ir(new Date(p.get()));$i(r).change(S=>{let D=l(S);D!=null&&(p.set(D),d.set(new Date(D)))});let y=(S,D,N)=>{let x=new Date(S,D+1,0).getDate();return new Date(S,D,Math.min(N,x))},h=S=>{let D=d.get(),N=y(D.getFullYear(),D.getMonth(),S);p.set(N),d.set(N),u?.(N)},c=S=>{let D=d.get(),N=y(D.getFullYear(),D.getMonth()+S,D.getDate());d.set(N)},v=S=>{let D=d.get(),N=y(D.getFullYear()+S,D.getMonth(),D.getDate());d.set(N)},w=$i(d).compute(S=>S.toLocaleString("default",{month:"long"})),V=$i(d).compute(S=>String(S.getFullYear())),A=$i(d,p).compute(([S,D])=>{let N=S.getFullYear(),x=S.getMonth(),f=new Date(N,x,1).getDay(),C=new Date(N,x+1,0).getDate(),I=[];for(let B=0;B<f;B+=1)I.push({muted:!0,label:""});for(let B=1;B<=C;B+=1)I.push({label:B});return[...Hs.map(B=>Qe({className:"g-ui-calendar-cell g-ui-calendar-cell-muted"},B)),...I.map(B=>Qe({className:s("g-ui-calendar-cell",B.muted&&"g-ui-calendar-cell-muted",B.label&&D.getFullYear()===N&&D.getMonth()===x&&B.label===D.getDate()&&"g-ui-calendar-cell-active"),onClick:()=>B.label&&h(B.label)},B.label))]});return Qe({...n,className:s("g-ui-calendar",a,z("g-ui-calendar-size-",o,"md"))},Qe({className:"g-ui-calendar-header"},Ge({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>c(-1)},ye({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:ki})),Qe({className:"g-ui-calendar-title-group"},Lr({type:"button",className:"g-ui-calendar-title-button",onClick:()=>c(1)},w),Lr({type:"button",className:"g-ui-calendar-title-button",onClick:()=>v(1)},V)),Ge({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>c(1)},ye({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:yi}))),Qe({className:"g-ui-calendar-grid"},A))}import{Div as ci,Span as Je,Input as Os,when as Pt,after as De,state as Ai}from"@granularjs/core";function Ws(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"md",searchable:!0}),{value:r,data:a,size:o,className:n,placeholder:u,searchable:l,...p}=i,{onChange:d,onSearchChange:y}=t,h=Ai(m(r)??[]),c=Ai(""),v=Ai(!1),w=Ai(null),V=f=>(m(f)??[]).map(I=>typeof I=="string"?{value:I,label:I}:I&&typeof I=="object"?I:{value:String(I),label:String(I)});De(r).change(f=>{let C=m(f);C!=null&&h.set(C)});let A=null;De(v).change(f=>{if(A&&(A(),A=null),!f)return;let C=I=>{let B=w.get();B&&(B.contains(I.target)||v.set(!1))};document.addEventListener("mousedown",C),A=()=>document.removeEventListener("mousedown",C)}),De(c).change(f=>{y?.(f)});let S=f=>{let C=h.get()??[],I=C.includes(f)?C.filter(B=>B!==f):C.concat(f);h.set(I),d?.(I)},D=De(a).compute(f=>V(f)),N=De(D,c).compute(([f,C])=>{let I=String(m(C)??"").toLowerCase().trim();return I?f.filter(B=>String(B.label??"").toLowerCase().includes(I)):f}),x=De(h,c).compute(([f,C])=>{let I=m(f)??[],B=String(m(C)??"");return!I.length&&!B}),k=De(l).compute(f=>!!f);return ci({...p,node:w,className:s("g-ui-select-multi-root",n)},ci({className:s("g-ui-select-multi",z("g-ui-select-multi-size-",o,"md")),onClick:()=>v.set(!0)},De(D,h).compute(([f,C])=>(m(C)??[]).map(B=>{let se=(f??[]).find(ae=>ae.value===B)?.label??B;return Je({className:"g-ui-select-tag"},Je({className:"g-ui-select-tag-label",onClick:ae=>{ae?.stopPropagation?.()}},se),Je({className:"g-ui-select-tag-remove",innerHTML:je,onClick:ae=>{ae?.stopPropagation?.(),S(B)}}))})),Pt(x,()=>Je({className:"g-ui-select-multi-placeholder"},u??"Select...")),Pt(k,()=>Os({className:"g-ui-select-multi-input",value:c,onInput:f=>c.set(f.target?.value??""),onFocus:()=>v.set(!0)}))),Pt(v,()=>ci({className:"g-ui-select-dropdown"},De(N).compute(f=>f.length?f.map(C=>ci({className:s("g-ui-select-item",C.disabled&&"g-ui-select-item-disabled",De(h).compute(I=>(m(I)??[]).includes(C.value)?"g-ui-select-item-active":"")),onClick:()=>{C.disabled||S(C.value)}},Je({className:"g-ui-select-item-check",innerHTML:De(h).compute(I=>(m(I)??[]).includes(C.value)?zi:"")}),Je({className:"g-ui-select-item-label"},C.label))):ci({className:"g-ui-select-item"},"Nothing found")))))}import{Div as Gs,list as _s,portal as Zs}from"@granularjs/core";import{Div as Mt,Button as qs,when as $r,state as Ys}from"@granularjs/core";function Tt(...e){let{props:i,rawProps:t,children:r}=g(e),{title:a,className:o,...n}=i,{onClose:u}=t,l=Ys(!0),p=()=>{l.set(!1),u?.(),console.log("close")};return $r(l,()=>Mt({...n,className:s("g-ui-toast",o)},Mt({className:"g-ui-toast-row"},$r(a,()=>Mt({className:"g-ui-toast-title"},a)),qs({className:"g-ui-toast-close",onClick:p},ye({innerHTML:je}))),r))}function Us(...e){let{props:i,rawProps:t}=g(e,{items:[]}),{items:r,className:a,timeout:o,...n}=i,{onClose:u}=t;return Zs(Gs({...n,className:s("g-ui-toast-stack",a)},_s(r,l=>Tt({title:l.title,onClose:()=>u?.(l)},l.message))))}function Xs(...e){let{props:i}=g(e);return li(i)}import{Div as Ks,after as Qs}from"@granularjs/core";function Js(...e){let{props:i,rawProps:t}=g(e,{items:[],position:"top-right"}),{items:r,position:a,className:o,...n}=i,{onRemove:u}=t,l=new Map,p=(y,h)=>y?.id??y?.key??h,d=Qs(r).compute(y=>{let h=m(y)??[],c=new Set;h.forEach((v,w)=>{let V=p(v,w);if(c.add(V),v?.autoClose&&!l.has(V)){let A=setTimeout(()=>{l.delete(V),u?.(v)},v.autoClose);l.set(V,A)}});for(let[v,w]of l.entries())c.has(v)||(clearTimeout(w),l.delete(v));return h.map((v,w)=>dt({key:p(v,w),title:v.title,color:v.color,icon:v.icon,loading:v.loading,withCloseButton:v.withCloseButton,withBorder:v.withBorder,onClose:()=>{v.onClose?.(),u?.(v)}},v.message??v.body??v.content??v.text))});return Ks({...n,className:s("g-ui-notifications",z("g-ui-notifications-position-",a,"top-right"),o)},d)}import{Div as ei,after as pi,state as eu,when as iu}from"@granularjs/core";function tu(...e){let{props:i,rawProps:t}=g(e,{min:0,max:100,step:1,size:"md"}),{value:r,marks:a,min:o,max:n,step:u,size:l,disabled:p,className:d,...y}=i,{onChange:h}=t,c=eu(m(r??[o,n])),v=()=>{let x=Number(m(o)),k=Number(m(n));return!Number.isFinite(x)||!Number.isFinite(k)?{minValue:0,maxValue:100}:{minValue:Math.min(x,k),maxValue:Math.max(x,k)}},w=()=>{let x=Number(m(u));return Number.isFinite(x)&&x>0?x:1},V=x=>{let{minValue:k,maxValue:f}=v(),C=w(),I=[k,f];Array.isArray(x)&&(I=x);let B=Math.max(k,Math.min(f,Number(I[0]))),K=Math.max(k,Math.min(f,Number(I[1]))),se=Math.round(Math.min(B,K)/C)*C,ae=Math.round(Math.max(B,K)/C)*C;return[se,ae]};pi(r).change(x=>{x!=null&&c.set(V(x))});let A=x=>{let k=V(x);k?.[0]===c.get()?.[0]&&k?.[1]===c.get()?.[1]||(c.set(k),h?.(k))},S=pi(c).compute(x=>{let{minValue:k,maxValue:f}=v(),C=f-k,[I,B]=V(x);if(C<=0)return{lowPct:0,highPct:0};let K=(I-k)/C*100,se=(B-k)/C*100;return{lowPct:Math.max(0,Math.min(100,K)),highPct:Math.max(0,Math.min(100,se))}}),D=(x,k,f)=>{let C=k?.();if(!C||C.width===0)return;let B=Math.min(Math.max(x.clientX-C.left,0),C.width)/C.width,{minValue:K,maxValue:se}=v(),ae=K+B*(se-K),H=c;typeof c.get=="function"&&(H=c.get());let[G,Q]=V(H);A(f==="low"?[ae,Q]:[G,ae])},N=(x,k,f)=>{if(ze(p))return;x.preventDefault?.();let C=f||x.currentTarget,I=()=>C.getBoundingClientRect(),B=I(),K=S;typeof S.get=="function"&&(K=S.get());let{lowPct:se,highPct:ae}=K,H=(x.clientX-B.left)/B.width*100,G=k;if(!G){let X=Math.abs(H-se)<=Math.abs(H-ae);G="high",X&&(G="low")}C.setPointerCapture?.(x.pointerId),D(x,I,G);let Q=X=>D(X,I,G),te=()=>{C.releasePointerCapture?.(x.pointerId),window.removeEventListener("pointermove",Q),window.removeEventListener("pointerup",te)};window.addEventListener("pointermove",Q),window.addEventListener("pointerup",te)};return ei({...y,className:s("g-ui-range-slider",z("g-ui-slider-size-",l,"md"),_("g-ui-slider-disabled",p),i.className??d)},ei({className:"g-ui-slider-track",onPointerDown:x=>N(x)},ei({className:"g-ui-slider-bar",style:pi(S).compute(({lowPct:x,highPct:k})=>({left:`${x}%`,width:`${Math.max(0,k-x)}%`}))}),ei({className:"g-ui-slider-thumb",style:pi(S).compute(({lowPct:x})=>({left:`${x}%`})),onPointerDown:x=>{x.stopPropagation?.(),N(x,"low",x.currentTarget.parentElement)}}),ei({className:"g-ui-slider-thumb",style:pi(S).compute(({highPct:x})=>({left:`${x}%`})),onPointerDown:x=>{x.stopPropagation?.(),N(x,"high",x.currentTarget.parentElement)}})),iu(a,()=>ei({className:"g-ui-slider-marks"},a.map(x=>xt({mark:x,getBounds:v})))))}import{state as Vt,after as Ar}from"@granularjs/core";function Bi(...e){let{props:i,rawProps:t}=g(e,{size:"md",format:{pattern:"dddd-dd-dd"}}),{value:r,size:a,calendarSize:o,leftSection:n,rightSection:u,className:l,format:p,minDate:d,maxDate:y,...h}=i,{onChange:c}=t,v=k=>{let f=m(k);if(f instanceof Date)return f;if(f==null||f==="")return null;let C=new Date(f);return Number.isNaN(C.getTime())?null:C},w=(k,f)=>k&&f&&k.getFullYear()===f.getFullYear()&&k.getMonth()===f.getMonth()&&k.getDate()===f.getDate(),V=k=>{if(!k)return"";let f=String(k.getFullYear()).padStart(4,"0"),C=String(k.getMonth()+1).padStart(2,"0"),I=String(k.getDate()).padStart(2,"0");return`${f}-${C}-${I}`},A=k=>{let f=String(k??"").replace(/\D/g,"");if(f.length<8)return null;let C=Number(f.slice(0,4)),I=Number(f.slice(4,6)),B=Number(f.slice(6,8));if(!C||!I||!B)return null;let K=new Date(C,I-1,B);if(K.getFullYear()!==C||K.getMonth()!==I-1||K.getDate()!==B)return null;let se=v(d);if(se&&K<se)return null;let ae=v(y);return ae&&K>ae?null:K},S=Vt(v(r)),D=Vt(V(S.get())),N=Vt(!1);Ar(r).change(k=>{let f=v(k);if(!w(f,S.get())){if(f==null){S.set(null),D.set("");return}S.set(f),D.set(V(f))}}),Ar(D).change(k=>{let f=A(k);f&&(w(f,S.get())||(S.set(f),c?.(f)))});let x=k=>{k&&(w(k,S.get())||(S.set(k),D.set(V(k)),c?.(k),N.set(!1)))};return St({opened:N,onChange:k=>N.set(!!k),content:li({size:z("",o,"xs"),value:S,onChange:x}),className:"g-ui-date-input-popover"},be({...h,size:a,className:s("g-ui-dateinput",l),leftSection:n,rightSection:u,type:"text",inputMode:"numeric",format:p,value:D,onChange:k=>D.set(k)}))}import{Div as Lt,when as ru,after as au,state as ou}from"@granularjs/core";function nu(...e){let{props:i,rawProps:t,children:r}=g(e),{opened:a,content:o,className:n,...u}=i,{onChange:l}=t,p=ou(m(a)??!1);au(a).change(y=>{let h=m(y);h!=null&&p.set(!!h)});let d=y=>{p.set(y),l?.(y)};return Lt({...u,className:s("g-ui-popper",n)},Lt({onClick:()=>d(!p.get())},r),ru(p,()=>Lt({className:"g-ui-popper-dropdown"},o)))}import{Button as su,after as Br,when as uu,state as gu}from"@granularjs/core";function lu(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{size:r,className:a,rightSection:o,...n}=i,{onChange:u}=t,l=gu(!1),p=Br(l).compute(y=>y?"text":"password"),d=Br(o).compute(y=>y??su({className:"g-ui-password-toggle",onClick:()=>l.set(!l.get())},uu(l,()=>"Hide",()=>"Show")));return be({...n,size:r,className:a,onChange:u,rightSection:d,type:p})}import{Div as cu}from"@granularjs/core";function pu(...e){let{props:i}=g(e,{size:"md"}),{size:t,className:r,...a}=i;return be({...a,size:t,className:r,leftSection:cu({className:"g-ui-search-input-left-section",innerHTML:Qt}),type:"text",inputMode:"search"})}import{Button as du,after as mu,when as Fr}from"@granularjs/core";import{state as fu}from"@granularjs/core";function vu(...e){let{props:i,children:t}=g(e,{value:"",timeout:1500}),{value:r,timeout:a,className:o,...n}=i,u=fu(!1),l=mu(u).compute(d=>s("g-ui-copy-button",d&&"g-ui-copy-button-done",o));return du({...n,className:l,onClick:async()=>{try{await navigator.clipboard.writeText(String(r)),u.set(!0),setTimeout(()=>u.set(!1),a)}catch{}},type:"button"},Fr(t?.length,()=>t,()=>Fr(u,()=>"Copied",()=>"Copy")))}import{Div as jr,after as di,resolve as hu}from"@granularjs/core";function Er(e){let i=Number(e);return Number.isNaN(i)?0:Math.max(0,Math.min(100,i))}function bu(...e){let{props:i}=g(e,{size:"md",value:null,color:"primary"}),{size:t,value:r,color:a,className:o,...n}=i,u=di(r).compute(h=>h!=null&&h!==""),l=di(r).compute(h=>Er(h)),p=di(l,u).compute(([h,c])=>{if(!c)return{};let v=Number(h),w=Number.isNaN(v)?0:Math.max(0,Math.min(360,v*3.6));return{background:`conic-gradient(var(--g-ui-progress-ring-fill, var(--g-ui-primary)) 0deg ${w}deg, var(--g-ui-border-muted) ${w}deg 360deg)`}}),d=di(u).compute(h=>h?"":"g-ui-progress-ring-indeterminate"),y=di(u,r).compute(([h,c])=>h?Er(c):void 0);return jr({...n,className:s("g-ui-progress-ring",z("g-ui-progress-ring-",a,"primary"),[t,h=>`g-ui-progress-ring-size-${hu(h)??"md"}`],d,o),style:p,role:"progressbar","aria-valuemin":0,"aria-valuemax":100,"aria-valuenow":y},jr({className:"g-ui-progress-ring-hole"}))}import{Div as Fi,state as $t,after as _e,list as wu,when as yu}from"@granularjs/core";import{Div as xu}from"@granularjs/core";function It(...e){let{props:i,children:t}=g(e,{size:"md"}),{size:r,className:a,...o}=i;return xu({...o,className:s("g-ui-scroll-area",[r,n=>`g-ui-scroll-area-${n}`],a)},t)}function $e(e,i){if(i==null||i==="")return e;let t=String(i).trim().split("."),r=e;for(let a of t)r=r?.[a];return r}function ku(e,i,t){let r=t(i);return String(r??"").toLowerCase().includes(String(e??"").toLowerCase())}function At(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"md",valuePath:"value",labelPath:"label"}),{data:r,value:a,size:o,valuePath:n,labelPath:u,filter:l,placeholder:p,label:d,description:y,error:h,leftSection:c,rightSection:v,className:w,inputClassName:V,disabled:A,...S}=i,{onChange:D,renderItem:N}=t,x=$t(!1),k=$t(""),f=$t(m(a));_e(a).change(P=>{let Y=m(P);Y!==f.get()&&f.set(Y)});let C=_e(r).compute(P=>Array.isArray(P)?P:[]),I=_e(C,f,n).compute(([P,Y,M])=>{if(Y==null)return null;let E=R=>M==null||M===""?R:$e(R,M);return P.find(R=>E(R)===Y)??null}),B=_e(I,x,k,u).compute(([P,Y,M,E])=>{let R=ee=>E==null||E===""?String(ee??""):String($e(ee,E)??"");return Y?M??"":P?R(P):""}),K=_e(C,k,l,u).compute(([P,Y,M,E])=>{let R=pe=>E==null||E===""?String(pe??""):String($e(pe,E)??""),ee=m(M)??ku;return P.filter(pe=>ee(Y,pe,R))}),se=P=>{let Y=m(n),M=Y==null||Y===""?P:$e(P,Y);f.set(M),k.set(""),x.set(!1),D?.(M)},ae=()=>{if(m(A))return;x.set(!0);let P=I.get(),Y=m(u),M=E=>Y==null||Y===""?String(E??""):String($e(E,Y)??"");k.set(P?M(P):"")},H=()=>{x.set(!1);let P=I.get(),Y=m(u),M=E=>Y==null||Y===""?String(E??""):String($e(E,Y)??"");k.set(P?M(P):"")},{onChange:G,...Q}=S,te={...Q,size:o,label:d,description:y,error:h,leftSection:c,rightSection:v,placeholder:m(p)??void 0,disabled:A,value:B,onInput:P=>k.set(P?.target?.value??""),onFocus:ae,onClick:ae,onBlur:()=>setTimeout(()=>H(),150)},X=P=>{let Y=m(n);return Y==null||Y===""?P:$e(P,Y)},T=P=>_e(f,n).compute(([Y,M])=>(R=>M==null||M===""?R:$e(R,M))(P)===Y?"g-ui-autocomplete-item-active":""),j=P=>{if(N&&typeof N=="function"){let Y=N(P);if(Y!=null)return Fi({className:s("g-ui-autocomplete-item",T(P)),onClick:()=>se(P),role:"option"},Y)}return Fi({className:s("g-ui-autocomplete-item",T(P)),onClick:()=>se(P),role:"option"},_e(u).compute(Y=>Y==null||Y===""?String(P??""):String($e(P,Y)??"")))};return Fi({className:s("g-ui-autocomplete",w,_("g-ui-autocomplete-disabled",A))},be({...te,className:s("g-ui-autocomplete-input-wrapper",te.className),inputClassName:s("g-ui-autocomplete-input",V)}),yu(x,()=>Fi({className:"g-ui-autocomplete-dropdown",role:"listbox"},It({className:"g-ui-autocomplete-list",style:{maxHeight:"240px"}},wu(K,P=>j(P))))))}function zu(...e){return At(...e)}import{Div as Nu,Span as Cu,state as Rr,after as Su}from"@granularjs/core";function Hr(e){let i=m(e);if(i instanceof Date)return i;if(i==null||i==="")return null;let t=new Date(i);return Number.isNaN(t.getTime())?null:t}function Or(e){let i=m(e);if(i==null)return[null,null];let t=Array.isArray(i)?i:[i];return[Hr(t[0]),Hr(t[1])]}function Wr(e,i){return!e||!i?e===i:e.getFullYear()===i.getFullYear()&&e.getMonth()===i.getMonth()&&e.getDate()===i.getDate()}function Du(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{value:r,size:a,minDate:o,maxDate:n,className:u,placeholderMin:l,placeholderMax:p,...d}=i,{onChange:y}=t,[h,c]=Or(r),v=Rr(h),w=Rr(c);Su(r).change(D=>{let[N,x]=Or(D);Wr(N,v.get())&&Wr(x,w.get())||(v.set(N),w.set(x))});let V=()=>{let D=v.get(),N=w.get();y?.([D??null,N??null])},A=D=>{let N=w.get();D&&N&&D>N&&w.set(D),v.set(D),V()},S=D=>{let N=v.get();D&&N&&D<N&&v.set(D),w.set(D),V()};return Nu({...d,className:s("g-ui-range-picker",i.className??u)},Bi({...d,size:a,value:v,onChange:A,maxDate:w,placeholder:m(l)??void 0}),Cu({className:"g-ui-range-picker-separator"},"\u2013"),Bi({...d,size:a,value:w,onChange:S,minDate:v,placeholder:m(p)??void 0}))}import{Div as Pu}from"@granularjs/core";function Mu(...e){let{props:i,children:t}=g(e,{align:"center",direction:"row"}),{direction:r,wrap:a,align:o,justify:n,gap:u,className:l,...p}=i;return Pu({...p,className:s("g-ui-flex",[r,d=>d==="column"?"g-ui-flex-column":"g-ui-flex-row"],[a,"g-ui-flex-wrap"],[o,d=>d&&`g-ui-align-${d}`],[n,d=>d&&`g-ui-justify-${d}`],[u,d=>d&&`g-ui-gap-${d}`],l)},t)}import{A as Tu,Div as mi,Span as qr,when as fi,after as Yr,state as Vu}from"@granularjs/core";function Lu(...e){let{props:i,rawProps:t,children:r}=g(e,{variant:"subtle",childrenOffset:24}),{label:a,description:o,leftSection:n,rightSection:u,active:l,disabled:p,variant:d,childrenOffset:y,opened:h,defaultOpened:c,className:v,padding:w,...V}=i,{onClick:A,onChange:S}=t,D=r.length>0,N=Vu(m(h)??m(c)??!1);Yr(h).change(f=>{let C=m(f);C!=null&&N.set(!!C)});let x=Yr(n).compute(f=>Oe(f)?f.get():f),k=f=>{if(m(p)){f?.preventDefault?.();return}if(D){let C=!N.get();N.set(C),S?.(C)}A?.(f)};return mi({className:s("g-ui-navlink-root",v)},Tu({...V,className:s("g-ui-navlink",z("g-ui-navlink-variant-",d,"subtle"),_("g-ui-navlink-active",l),_("g-ui-navlink-disabled",p),z("g-ui-navlink-padding-",w,"md")),onClick:k},fi(x,()=>qr({className:"g-ui-navlink-section g-ui-navlink-left"},n)),mi({className:"g-ui-navlink-body"},fi(a,()=>mi({className:"g-ui-navlink-label"},a)),fi(o,()=>mi({className:"g-ui-navlink-description"},o))),fi(u,()=>qr({className:"g-ui-navlink-section g-ui-navlink-right"},u))),D&&fi(N,()=>mi({className:"g-ui-navlink-children"},r)))}import{Div as Gr,when as Iu}from"@granularjs/core";function $u(...e){let{props:i,children:t}=g(e,{show:!0,position:"top-right",color:"danger",size:"md"}),{show:r,position:a,color:o,size:n,className:u,...l}=i;return Gr({...l,className:s("g-ui-indicator",z("g-ui-indicator-position-",a,"top-right"),z("g-ui-indicator-color-",o,"danger"),z("g-ui-indicator-size-",n,"md"),u)},t,Iu(r,()=>Gr({className:"g-ui-indicator-badge"})))}import{Span as ji}from"@granularjs/core";function Au(...e){let{props:i}=g(e),{opened:t,className:r,...a}=i;return ji({...a,className:s("g-ui-burger",[t,"g-ui-burger-open"],r)},ji(""),ji(""),ji(""))}import{Div as Bu,when as Fu}from"@granularjs/core";function ju(...e){let{props:i}=g(e),{visible:t,...r}=i;return Fu(t,()=>Bu({...r,className:"g-ui-loading-overlay"},ni({})))}import{Div as Eu}from"@granularjs/core";function Ru(...e){let{props:i,children:t}=g(e,{gap:"md"}),{className:r,gap:a,...o}=i;return Eu({...o,className:s("g-ui-grid-system",[a,n=>`g-ui-gap-${n}`],r)},t)}import{Div as Hu}from"@granularjs/core";function Ou(...e){let{props:i,children:t}=g(e,{span:12}),{span:r,className:a,...o}=i;return Hu({...o,className:s([r,n=>`g-ui-col-span-${n}`],a)},t)}import{Div as _r,Input as Wu,after as Ae,state as Bt,when as Zr,list as qu}from"@granularjs/core";function Yu(...e){let{props:i,rawProps:t}=g(e,{length:4,size:"md",type:"alphanumeric",mask:!1,placeholder:"\u25CB",disabled:!1,error:!1,oneTimeCode:!1}),{length:r,value:a,size:o,type:n,mask:u,placeholder:l,disabled:p,error:d,oneTimeCode:y,className:h}=i,{onChange:c,onComplete:v}=t,w=Bt(m(r)??4),V=()=>w.get();Ae(r).change(T=>{let j=m(T)??4,P=w.get();if(j===P)return;w.set(j);let Y=S.get(),M=A.get();S.set(Array.from({length:j},(E,R)=>Y[R]??"")),A.set(Array.from({length:j},(E,R)=>M[R]??null))});let A=Bt(Array.from({length:V()},()=>null)),S=Bt(Array.from({length:V()},(T,j)=>{let P=m(a);return typeof P=="string"||Array.isArray(P)?P[j]??"":""}));Ae(a).change(T=>{if(T==null)return;let j=V();typeof T=="string"?S.set(Array.from({length:j},(P,Y)=>T[Y]??"")):Array.isArray(T)&&S.set(Array.from({length:j},(P,Y)=>T[Y]??""))});let D=()=>S.get().join(""),N=T=>{S.set(T);let j=T.join("");c?.(j),T.every(P=>P!=="")&&T.length===V()&&v?.(j)},x=T=>{let j=V(),P=A.get();T>=0&&T<j&&P[T]&&(P[T].focus(),P[T].select())},k=()=>{let T=m(n);return T==="number"?/^[0-9]$/:T instanceof RegExp?T:/^[a-zA-Z0-9]$/},f=(T,j)=>{let P=j.target.value,Y=k();if(P.length>1){C(T,P);return}if(P&&!Y.test(P)){j.target.value=S.get()[T]??"";return}let M=S.get().slice();M[T]=P,N(M),P&&T<V()-1&&x(T+1)},C=(T,j)=>{let P=k(),Y=j.split("").filter(ee=>P.test(ee)),M=S.get().slice(),E=V();Y.forEach((ee,pe)=>{let ke=T+pe;ke<E&&(M[ke]=ee)}),N(M);let R=M.findIndex((ee,pe)=>pe>=T&&ee==="");R>=0?x(R):x(Math.min(T+Y.length,E-1))},I=(T,j)=>{if(j.key==="Backspace"){let P=S.get().slice();P[T]===""&&T>0?(j.preventDefault(),P[T-1]="",N(P),x(T-1)):P[T]!==""&&(P[T]="",N(P))}else j.key==="ArrowLeft"&&T>0?(j.preventDefault(),x(T-1)):j.key==="ArrowRight"&&T<V()-1&&(j.preventDefault(),x(T+1))},B=(T,j)=>{j.target.select()},K=()=>{let T=S.get(),j=T.findIndex(P=>P==="");j>=0?x(j):x(T.length-1)},se=Ae(u).compute(T=>m(T)?"password":"text"),ae=Ae(n).compute(T=>m(T)==="number"?"numeric":"text"),H=Ae(y).compute(T=>m(T)?"one-time-code":"off"),G=Ae(p).compute(T=>!!m(T)),Q=Ae(d).compute(T=>!!m(T)),te=Ae(w).compute(T=>Array.from({length:T},(j,P)=>P)),X=T=>Wu({className:s("g-ui-pin-input-field",Zr(Q,()=>"g-ui-pin-input-error")),type:se,inputMode:ae,autocomplete:H,maxLength:2,placeholder:Zr(G,()=>"",()=>l),disabled:G,value:Ae(S,T).compute(([j,P])=>j[P]??""),node:A[T.get()],onInput:j=>f(T.get(),j),onChange:j=>f(T.get(),j),onKeyDown:j=>I(T.get(),j),onFocus:j=>B(T.get(),j)});return _r({className:s("g-ui-pin-input",z("g-ui-input-size-",o,"md"),h),onClick:K},_r({className:"g-ui-pin-input-wrapper"},qu(te,X)))}import{Div as Gu}from"@granularjs/core";function _u(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Gu({...a,className:s("g-ui-checkbox-group",r)},t)}import{Div as Zu}from"@granularjs/core";function Uu(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Zu({...a,className:s("g-ui-avatar-group",r)},t)}import{Div as Xu}from"@granularjs/core";function Ku(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Xu({...a,className:s("g-ui-badge-group",r)},t)}import{Div as Ei,Span as Qu,after as vi,context as Ur}from"@granularjs/core";var Ju=Ur([]),Xr=Ur({sort:null,onSort:null});function Ft(...e){let{props:i,rawProps:t,children:r}=g(e,{sizes:[],sort:null,stickyHeader:!1}),{className:a,sizes:o,sort:n,stickyHeader:u,...l}=i,{onSort:p}=t,d=Ju.scope(o.get());vi(o).change(h=>d.set(h));let y=Xr.scope({sort:n.get(),onSort:p||null});return vi(n).change(h=>y.set().sort=h),d.serve(y.serve(Ei({className:s("g-ui-grid-table",_("g-ui-grid-table-sticky",u),a),style:{gridTemplateColumns:vi(d).compute(h=>Array.isArray(h)?h.join(" "):"")},...l},r)))}Ft.GridRow=(...e)=>{let{props:i,children:t}=g(e,{}),{className:r,header:a,...o}=i;return Ei({className:s("g-ui-grid-table-row",_("g-ui-grid-table-row-header",a),r),...o},...t)};Ft.GridCell=function(...e){let{props:i,rawProps:t,children:r}=g(e,{}),{className:a,sort:o,...n}=i,u=t.sort;if(u){let l=Xr.state(),p=vi(l.sort).compute(y=>y?.key===u?y.direction:null),d=()=>{let y=l.get().sort,h;y?.key===u?h=y.direction==="asc"?{key:u,direction:"desc"}:null:h={key:u,direction:"asc"},l.set().sort=h;let{onSort:c}=l.get();c&&c(h)};return Ei({className:s("g-ui-grid-table-cell","g-ui-grid-table-cell-sortable",a),onClick:d,...n},r,Qu({className:"g-ui-grid-table-sort-icon"},vi(p).compute(y=>y==="asc"?" \u2191":y==="desc"?" \u2193":"")))}return Ei({className:s("g-ui-grid-table-cell",a),...n},r)};import{Button as eg,Div as ig,Span as Kr,when as Qr}from"@granularjs/core";function Jr(...e){let{props:i,children:t}=g(e,{grow:!0}),{grow:r,className:a,...o}=i;return ig({...o,className:s("g-ui-bottombar",_("g-ui-bottombar-grow",r),a)},t)}Jr.Action=function(...i){let{props:t,rawProps:r,children:a}=g(i,{variant:"subtle"}),{icon:o,label:n,active:u,disabled:l,variant:p,className:d,...y}=t,{onClick:h}=r;return eg({...y,className:s("g-ui-bottombar-action",z("g-ui-bottombar-action-variant-",p,"subtle"),_("g-ui-bottombar-action-active",u),_("g-ui-bottombar-action-disabled",l),d),onClick:h,disabled:l},Qr(o,()=>Kr({className:"g-ui-bottombar-action-icon"},o)),Qr(n,()=>Kr({className:"g-ui-bottombar-action-label"},n)),a)};import{Div as W,Button as Ze,state as me,after as Ce,when as fe,Input as Ri,Label as hi,Span as Ue}from"@granularjs/core";var tg=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],rg=[{value:"day",label:"Day"},{value:"week",label:"Week"},{value:"month",label:"Month"}];function Hi(e){if(e instanceof Date)return e;if(e==null)return null;let i=new Date(e);return Number.isNaN(i.getTime())?null:i}function ta(e){let i=Hi(e.start),t=Hi(e.end);return!i||!t?null:{...e,id:e.id??`${i.getTime()}-${e.title??"event"}`,title:e.title??"",start:i,end:t,allDay:!!e.allDay,description:e.description??"",location:e.location??"",attendees:Array.isArray(e.attendees)?e.attendees:[],color:e.color??null}}function ra(e,i,t){let r=Hi(i).getTime(),a=Hi(t).getTime();return e.map(ta).filter(Boolean).filter(o=>o.end.getTime()>r&&o.start.getTime()<a)}function ea(e,i){let t=new Date(i);t.setHours(0,0,0,0);let r=t.getTime();t.setHours(23,59,59,999);let a=t.getTime();return ra(e,r,a)}function jt(e,i){let t=new Date(e),a=(t.getDay()-i+7)%7;return t.setDate(t.getDate()-a),t.setHours(0,0,0,0),t}function ii(e,i="default"){return e.toLocaleTimeString(i,{hour:"numeric",minute:"2-digit",hour12:!0})}function bi(e,i="default"){return e.toLocaleDateString(i,{weekday:"short",month:"short",day:"numeric"})}function ag(e,i="default"){return e.toLocaleDateString(i,{month:"long",year:"numeric"})}function og(e,i="default"){let t=new Date(e);return t.setDate(t.getDate()+6),`${e.toLocaleDateString(i,{month:"short",day:"numeric"})} \u2013 ${t.toLocaleDateString(i,{month:"short",day:"numeric",year:"numeric"})}`}function ia(e,i,t,r){let a=new Date(e).setHours(t,0,0,0),o=new Date(e).setHours(r,0,0,0),n=(r-t)*60,u=Math.max(e.getTime(),a),p=(Math.min(i.getTime(),o)-u)/6e4,d=(u-a)/6e4/n*100,y=p/n*100;return{top:d,height:y}}function ng(...e){let{props:i,rawProps:t}=g(e,{defaultView:"month",firstDayOfWeek:0,locale:"default",hourSlotDuration:30,minTime:6,maxTime:22,eventCreationColorOptions:[]}),{events:r=[],defaultView:a,firstDayOfWeek:o,locale:n,hourSlotDuration:u,minTime:l,maxTime:p,eventCreationColorOptions:d,className:y,...h}=i,{onCreateEventRequest:c,onViewEventRequest:v,onUpdateEventRequest:w,onRemoveEventRequest:V,eventCreationEmailLookup:A,eventCreationLocationsCallback:S,eventCreationCalendarsCallback:D,onSlotClick:N,onDateRangeChange:x}=t,k=me(m(a)??"month"),f=me(new Date),C=me(null),I=me(null),B=me({title:"",start:null,end:null,allDay:!1,description:"",location:"",attendees:[],color:null}),K=Ce(r).compute(b=>Array.isArray(b)?b:[]),se=f.get(),ae=jt(se,m(o)??0),H=m(l)??6,G=m(p)??22,Q=m(u)??30,te=()=>{let b=new Date(f.get());k.get()==="month"?b.setMonth(b.getMonth()-1):k.get()==="week"?b.setDate(b.getDate()-7):b.setDate(b.getDate()-1),f.set(b),x?.({start:b,end:b,view:k.get()})},X=()=>{let b=new Date(f.get());k.get()==="month"?b.setMonth(b.getMonth()+1):k.get()==="week"?b.setDate(b.getDate()+7):b.setDate(b.getDate()+1),f.set(b),x?.({start:b,end:b,view:k.get()})},T=()=>{let b=new Date;f.set(b),x?.({start:b,end:b,view:k.get()})},j=(b,O,ce=!1)=>{let U=b?new Date(b):new Date(f.get()),ge=O?new Date(O):new Date(U.getTime()+3600*1e3);ce&&(U.setHours(0,0,0,0),ge.setHours(23,59,59,999)),B.set({title:"",start:U,end:ge,allDay:ce,description:"",location:"",attendees:[],color:null}),C.set("create")},P=b=>{I.set(ta(b)),C.set("view"),v?.(b)},Y=()=>{let b=I.get();b&&(B.set({title:b.title,start:new Date(b.start),end:new Date(b.end),allDay:b.allDay,description:b.description??"",location:b.location??"",attendees:[...b.attendees||[]],color:b.color??null}),C.set("edit"))},M=()=>{C.set(null),I.set(null)},E=(b,O,ce)=>{if(N){N({date:b,hour:O,allDay:ce});return}let U=new Date(b);if(ce){U.setHours(0,0,0,0);let ge=new Date(U);ge.setHours(23,59,59,999),j(U,ge,!0)}else{U.setHours(O,0,0,0);let ge=new Date(U.getTime()+Q*60*1e3);j(U,ge,!1)}},R=()=>{let b=B.get();!b.start||!b.end||c?.({title:b.title,start:b.start,end:b.end,allDay:b.allDay,description:b.description,location:b.location,attendees:b.attendees,color:b.color},()=>{M()})},ee=()=>{let b=I.get(),O=B.get();!b||!O.start||!O.end||w?.(b,{title:O.title,start:O.start,end:O.end,allDay:O.allDay,description:O.description,location:O.location,attendees:O.attendees,color:O.color},()=>M())},pe=()=>{let b=I.get();b&&V?.(b,()=>M())},ke=Ce(k,f).compute(([b,O])=>b==="month"?ag(O,m(n)):b==="week"?og(jt(O,m(o)??0),m(n)):bi(O,m(n))),Pe=W({className:"g-ui-event-calendar-header"},W({className:"g-ui-event-calendar-nav-group"},Ge({size:"sm",variant:"subtle",onClick:te,className:"g-ui-event-calendar-nav"},ye({size:"sm",innerHTML:ki})),Ge({size:"sm",variant:"subtle",onClick:X,className:"g-ui-event-calendar-nav"},ye({size:"sm",innerHTML:yi})),Ze({type:"button",variant:"subtle",size:"sm",className:"g-ui-event-calendar-today",onClick:T},ye({size:"sm",className:"g-ui-event-calendar-today-icon",innerHTML:tr}),"Today")),W({className:"g-ui-event-calendar-title"},ke),W({className:"g-ui-event-calendar-actions"},rg.map(b=>W({className:s("g-ui-event-calendar-view-option",Ce(k).compute(O=>O===b.value?"g-ui-event-calendar-view-option-active":"")),onClick:()=>{k.set(b.value),x?.({start:f.get(),end:f.get(),view:b.value})}},b.label)),Ze({type:"button",variant:"filled",size:"sm",className:"g-ui-event-calendar-create-btn",onClick:()=>j(f.get(),null,!1)},ye({size:"sm",innerHTML:Jt}),"Create"))),Be=Ce(f,K,o).compute(([b,O,ce])=>{let U=b.getFullYear(),ge=b.getMonth(),ue=(new Date(U,ge,1).getDay()-(ce??0)+7)%7,Te=new Date(U,ge+1,0).getDate(),Le=new Date(U,ge,0).getDate(),$=[],L=1,q=1,Z=Math.ceil((ue+Te)/7)*7,oe=[];for(let ie=0;ie<Z;ie+=1){let J,re,le;ie<ue?(J=Le-ue+ie+1,le=new Date(U,ge-1,J),re=!1):L<=Te?(J=L,le=new Date(U,ge,J),re=!0,L+=1):(J=q,le=new Date(U,ge+1,J),re=!1,q+=1);let xe=ea(O,le),Fe=le.getDate()===new Date().getDate()&&le.getMonth()===new Date().getMonth()&&le.getFullYear()===new Date().getFullYear();oe.push(W({key:le.getTime(),className:s("g-ui-event-calendar-month-cell",!re&&"g-ui-event-calendar-month-cell-outside",Fe&&"g-ui-event-calendar-month-cell-today")},W({className:"g-ui-event-calendar-month-cell-header",onClick:()=>E(le,0,!0)},Ue({className:"g-ui-event-calendar-month-cell-day"},le.getDate())),W({className:"g-ui-event-calendar-month-cell-events"},xe.slice(0,3).map(Se=>W({key:Se.id,className:"g-ui-event-calendar-month-event",style:Se.color?{borderLeftColor:Se.color,backgroundColor:`${Se.color}20`}:{},onClick:Yi=>{Yi.stopPropagation(),P(Se)}},Se.title||"(No title)")),fe(xe.length>3,()=>W({className:"g-ui-event-calendar-month-more",onClick:Se=>{Se.stopPropagation(),P(xe[3])}},`+${xe.length-3} more`)))))}return oe}),Ve=W({className:"g-ui-event-calendar-month"},W({className:"g-ui-event-calendar-weekdays"},tg.map(b=>W({key:b,className:"g-ui-event-calendar-weekday"},b))),W({className:"g-ui-event-calendar-month-grid"},Be)),Me=[];for(let b=H;b<G;b+=1)for(let O=0;O<60;O+=Q)Me.push(b+O/60);let ti=Ce(f,o).compute(([b,O])=>{let ce=jt(b,O??0),U=[];for(let ge=0;ge<7;ge+=1){let ve=new Date(ce);ve.setDate(ve.getDate()+ge),U.push(ve)}return U}),Oi=W({className:"g-ui-event-calendar-week"},Ce(ti).compute(b=>W({className:"g-ui-event-calendar-week-days"},W({className:"g-ui-event-calendar-week-time-col"},""),(b||[]).map(O=>W({key:O.getTime(),className:"g-ui-event-calendar-week-day-col"},W({className:"g-ui-event-calendar-week-day-header"},bi(O,m(n))))))),W({className:"g-ui-event-calendar-week-body"},W({className:"g-ui-event-calendar-week-time-col"},Me.map(b=>{let O=Math.floor(b),ce=(b-O)*60,U=`${O<=12?O:O-12}:${ce===0?"00":ce} ${O<12?"AM":"PM"}`;return W({key:b,className:"g-ui-event-calendar-week-slot-label"},U)})),Ce(ti,K).compute(([b,O])=>{if(!b||!b.length)return null;let ce=b[0],U=new Date(b[6]);U.setHours(23,59,59,999);let ge=ra(O,ce,U);return W({className:"g-ui-event-calendar-week-grid-cols"},b.map(ve=>W({key:ve.getTime(),className:"g-ui-event-calendar-week-day-col g-ui-event-calendar-week-day-col-body"},Me.map(ue=>W({key:ue,className:"g-ui-event-calendar-week-slot",onClick:()=>E(ve,ue,!1)})),ge.filter(ue=>!ue.allDay&&ue.start.getDate()===ve.getDate()&&ue.start.getMonth()===ve.getMonth()&&ue.start.getFullYear()===ve.getFullYear()).map(ue=>{let{top:Te,height:Le}=ia(ue.start,ue.end,H,G);return W({key:ue.id,className:"g-ui-event-calendar-week-event",style:{top:`${Te}%`,height:`${Le}%`,borderLeftColor:ue.color||"var(--g-ui-primary)"},onClick:$=>{$.stopPropagation(),P(ue)}},W({className:"g-ui-event-calendar-week-event-title"},ue.title||"(No title)"),fe(!ue.allDay,()=>Ue({className:"g-ui-event-calendar-week-event-time"},`${ii(ue.start,m(n))} \u2013 ${ii(ue.end,m(n))}`)))}))))}))),Wi=W({className:"g-ui-event-calendar-day"},W({className:"g-ui-event-calendar-day-body"},W({className:"g-ui-event-calendar-day-time-col"},Me.map(b=>{let O=Math.floor(b),ce=(b-O)*60,U=`${O<=12?O:O-12}:${ce===0?"00":ce} ${O<12?"AM":"PM"}`;return W({key:b,className:"g-ui-event-calendar-day-slot-label"},U)})),W({className:"g-ui-event-calendar-day-slots"},Me.map(b=>W({key:b,className:"g-ui-event-calendar-day-slot",onClick:()=>E(f.get(),b,!1)})),Ce(K,f).compute(([b,O])=>O?ea(b,O).filter(U=>!U.allDay).map(U=>{let{top:ge,height:ve}=ia(U.start,U.end,H,G);return W({key:U.id,className:"g-ui-event-calendar-day-event",style:{top:`${ge}%`,height:`${ve}%`,borderLeftColor:U.color||"var(--g-ui-primary)"},onClick:ue=>{ue.stopPropagation(),P(U)}},W({className:"g-ui-event-calendar-day-event-title"},U.title||"(No title)"),Ue({className:"g-ui-event-calendar-day-event-time"},`${ii(U.start,m(n))} \u2013 ${ii(U.end,m(n))}`))}):[])))),xi=b=>{let O=B.get(),ce=new Date,U=O.start||ce,ge=O.end||new Date(ce.getTime()+3600*1e3),ve=me(O.title),ue=me(U.toISOString().slice(0,10)),Te=me(!O.allDay&&U?U.toTimeString().slice(0,5):"09:00"),Le=me(ge.toISOString().slice(0,10)),$=me(!O.allDay&&ge?ge.toTimeString().slice(0,5):"10:00"),L=me(O.allDay),q=me(O.description),Z=me(O.location),oe=me(O.attendees||[]),ie=me(""),J=me([]),re=me([]),le=me(""),xe=Array.isArray(d)?d:[],Fe=me(O.color),Se=()=>{let F=new Date(ue.get()+"T"+(L.get()?"00:00:00":Te.get()+":00")),we=new Date(Le.get()+"T"+(L.get()?"23:59:59":$.get()+":00"));B.set({title:ve.get(),start:F,end:we,allDay:L.get(),description:q.get(),location:Z.get(),attendees:oe.get(),color:Fe.get()})},Yi=F=>{if(ie.set(F),!A||!F.trim()){J.set([]);return}Promise.resolve(A(F.trim())).then(we=>J.set(Array.isArray(we)?we:[])).catch(()=>J.set([]))},aa=F=>{let we=oe.get();we.some(Rt=>(Rt.email||Rt.id)===(F.email||F.id))||(oe.set([...we,{id:F.id,email:F.email??F.label,label:F.label}]),ie.set(""),J.set([]))},oa=F=>{let we=[...oe.get()];we.splice(F,1),oe.set(we)},Et=()=>{S&&Promise.resolve(S(le.get())).then(F=>re.set(Array.isArray(F)?F:[])).catch(()=>re.set([]))};return W({className:"g-ui-event-calendar-form"},W({className:"g-ui-event-calendar-form-row"},be({label:"Title",placeholder:"Event title",value:ve,onInput:F=>ve.set(F?.target?.value??"")})),W({className:"g-ui-event-calendar-form-row g-ui-event-calendar-form-row-inline"},ot({label:"All day",checked:L,onChange:F=>L.set(F)})),W({className:"g-ui-event-calendar-form-row g-ui-event-calendar-form-row-inline"},W({className:"g-ui-event-calendar-form-field"},hi({className:"g-ui-event-calendar-form-label"},"Start"),Ri({type:"date",className:"g-ui-input g-ui-input-size-md",value:ue,onInput:F=>ue.set(F?.target?.value??"")}),fe(!L,()=>Ri({type:"time",className:"g-ui-input g-ui-input-size-md",value:Te,onInput:F=>Te.set(F?.target?.value??"")}))),W({className:"g-ui-event-calendar-form-field"},hi({className:"g-ui-event-calendar-form-label"},"End"),Ri({type:"date",className:"g-ui-input g-ui-input-size-md",value:Le,onInput:F=>Le.set(F?.target?.value??"")}),fe(!L,()=>Ri({type:"time",className:"g-ui-input g-ui-input-size-md",value:$,onInput:F=>$.set(F?.target?.value??"")})))),fe(S,()=>W({className:"g-ui-event-calendar-form-row"},hi({className:"g-ui-event-calendar-form-label"},"Location"),be({placeholder:"Search or type location",value:le,onInput:F=>{le.set(F?.target?.value??""),Et()},onFocus:Et}),fe(Ce(re).compute(F=>F&&F.length>0),()=>W({className:"g-ui-event-calendar-form-suggestions"},re.get().map(F=>W({key:F.id??F.label,className:"g-ui-event-calendar-form-suggestion-item",onClick:()=>{Z.set(F.label??F.id),le.set(""),re.set([])}},F.label??F.id)))),fe(Ce(Z).compute(F=>!!F),()=>Ue({className:"g-ui-event-calendar-form-chip"},Z)))),fe(A,()=>W({className:"g-ui-event-calendar-form-row"},hi({className:"g-ui-event-calendar-form-label"},"Add guests"),be({placeholder:"Type email to search",value:ie,onInput:F=>Yi(F?.target?.value??"")}),W({className:"g-ui-event-calendar-form-chips"},oe.get().map((F,we)=>Ue({key:(F.email||F.id)+we,className:"g-ui-event-calendar-form-chip g-ui-event-calendar-form-chip-removable",onClick:()=>oa(we)},F.label||F.email||F.id," \xD7"))),fe(Ce(J).compute(F=>F&&F.length>0),()=>W({className:"g-ui-event-calendar-form-suggestions"},J.get().map(F=>W({key:F.id??F.email,className:"g-ui-event-calendar-form-suggestion-item",onClick:()=>aa(F)},F.label??F.email??F.id)))))),W({className:"g-ui-event-calendar-form-row"},Ji({label:"Description",placeholder:"Add description",value:q,onInput:F=>q.set(F?.target?.value??"")})),fe(xe.length>0,()=>W({className:"g-ui-event-calendar-form-row"},hi({className:"g-ui-event-calendar-form-label"},"Color"),W({className:"g-ui-event-calendar-form-colors"},xe.map(F=>W({key:F.value??F.id??F,className:s("g-ui-event-calendar-form-color-swatch",Ce(Fe).compute(we=>we===(F.value??F.id??F)?"g-ui-event-calendar-form-color-swatch-active":"")),style:{backgroundColor:F.color??F.value??F},onClick:()=>Fe.set(F.value??F.id??F)}))))),W({className:"g-ui-event-calendar-form-actions"},Ze({variant:"subtle",onClick:M},"Cancel"),Ze({variant:"filled",onClick:()=>{Se(),b?ee():R()}},b?"Save":"Create")))},qi=()=>{let b=I.get();return b?W({className:"g-ui-event-calendar-view-modal"},W({className:"g-ui-event-calendar-view-modal-title"},b.title||"(No title)"),W({className:"g-ui-event-calendar-view-modal-meta"},b.allDay?Ue({className:"g-ui-event-calendar-view-modal-date"},bi(b.start,m(n))+(b.start.getTime()!==b.end.getTime()?` \u2013 ${bi(b.end,m(n))}`:"")):Ue({className:"g-ui-event-calendar-view-modal-date"},`${bi(b.start,m(n))} \xB7 ${ii(b.start,m(n))} \u2013 ${ii(b.end,m(n))}`)),fe(b.location,()=>W({className:"g-ui-event-calendar-view-modal-field"},"Location: ",b.location)),fe(b.description,()=>W({className:"g-ui-event-calendar-view-modal-field"},b.description)),fe(b.attendees?.length,()=>W({className:"g-ui-event-calendar-view-modal-field"},"Guests: ",b.attendees.map(O=>O.label||O.email||O.id).join(", "))),W({className:"g-ui-event-calendar-view-modal-actions"},Ze({variant:"subtle",size:"sm",onClick:Y},ye({size:"sm",innerHTML:er})," Edit"),Ze({variant:"subtle",size:"sm",onClick:pe,className:"g-ui-event-calendar-view-modal-delete"},ye({size:"sm",innerHTML:ir})," Delete"),Ze({variant:"filled",size:"sm",onClick:M},"Close"))):null};return W({...h,className:s("g-ui-event-calendar",y)},Pe,fe(k,b=>b==="month",()=>Ve),fe(k,b=>b==="week",()=>Oi),fe(k,b=>b==="day",()=>Wi),fe(C,b=>b==="create",()=>oi({opened:!0,title:"New event",size:"lg",onClose:M},xi(!1))),fe(C,b=>b==="view",()=>oi({opened:!0,title:"Event",size:"md",onClose:M},qi())),fe(C,b=>b==="edit",()=>oi({opened:!0,title:"Edit event",size:"lg",onClose:M},xi(!0))))}import{state as sg}from"@granularjs/core";function ug(e=!1){let i=sg(!!e);return[i,{open:()=>i.set(!0),close:()=>i.set(!1),toggle:()=>i.set(!i.get())}]}Ot();export{Fo as Accordion,Ge as ActionIcon,cs as Affix,en as Alert,kn as Anchor,hs as AppBar,At as Autocomplete,on as Avatar,Uu as AvatarGroup,Ya as Badge,Ku as BadgeGroup,cn as Blockquote,Jr as BottomBar,Kn as Breadcrumbs,Au as Burger,Ui as Button,li as Calendar,Wa as Card,Jn as Center,ot as Checkbox,_u as CheckboxGroup,$n as Chip,gn as Code,Ou as Col,as as Collapse,Fa as Container,vu as CopyButton,Bi as DateInput,Xs as DatePicker,Uo as Divider,Yo as Drawer,ng as EventCalendar,fs as Fieldset,Mu as Flex,Ru as Grid,Ft as GridTable,Ha as Group,gs as HoverCard,ye as Icon,Nn as Image,$u as Indicator,sn as Kbd,hr as List,ni as Loading,ju as LoadingOverlay,Oo as Menu,oi as Modal,Ws as MultiSelect,Lu as NavLink,dt as Notification,Js as Notifications,et as NumberField,eo as NumberInput,Rn as Pagination,Ko as Paper,lu as PasswordInput,Yu as PinInput,St as Popover,nu as Popper,Cn as Progress,bu as ProgressRing,Zn as Radio,Wn as RadioGroup,Du as RangePicker,tu as RangeSlider,js as Rating,It as ScrollArea,pu as SearchInput,Fn as SegmentedControl,wo as Select,zu as SelectSearch,xs as Sidebar,dn as SimpleGrid,Vn as Skeleton,Pn as Slider,is as Space,Ea as Stack,Bs as Stepper,ho as Switch,lo as SwitchGroup,Vo as Table,No as Tabs,Rs as Tag,Xi as Text,be as TextInput,Ji as Textarea,$s as Timeline,Aa as Title,Tt as Toast,Us as ToastStack,jo as Tooltip,_ as classFlag,he as classMap,z as classVar,s as cx,ka as getThemeMode,ya as setThemeMode,wa as setThemeVars,g as splitPropsChildren,ug as useDisclosure};
