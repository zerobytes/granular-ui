var Ye="granular-ui-styles",Jr=new URL("./fonts/Poppins-400.ttf",import.meta.url).href,Qr=new URL("./fonts/Poppins-500.ttf",import.meta.url).href,it=new URL("./fonts/Poppins-600.ttf",import.meta.url).href,et=new URL("./fonts/Poppins-700.ttf",import.meta.url).href,rt=new URL("./fonts/Arimo-400.ttf",import.meta.url).href,tt=new URL("./fonts/Arimo-500.ttf",import.meta.url).href,at=new URL("./fonts/Arimo-600.ttf",import.meta.url).href,ot=new URL("./fonts/Arimo-700.ttf",import.meta.url).href,st=new URL("./fonts/Inter-400.woff2",import.meta.url).href,nt=new URL("./fonts/Inter-500.woff2",import.meta.url).href,ut=new URL("./fonts/Inter-600.woff2",import.meta.url).href,gt=new URL("./fonts/Inter-700.woff2",import.meta.url).href,lt=`
@font-face {
  font-family: 'Poppins';
  font-style: normal;
  font-weight: 400;
...
`;function Ge(){if(typeof document>"u"||document.getElementById(Ye))return;let i=document.createElement("style");i.id=Ye,i.textContent=lt,document.head.appendChild(i)}var ct=new Set(["--g-ui-bg","--g-ui-bg-subtle","--g-ui-bg-muted","--g-ui-bg-emphasized","--g-ui-bg-inverted","--g-ui-bg-panel","--g-ui-fg","--g-ui-fg-muted","--g-ui-fg-subtle","--g-ui-fg-inverted","--g-ui-border","--g-ui-border-subtle","--g-ui-border-emphasized","--g-ui-border-inverted","--g-ui-primary","--g-ui-primary-hover","--g-ui-primary-active","--g-ui-primary-subtle","--g-ui-primary-muted","--g-ui-primary-emphasized","--g-ui-success","--g-ui-success-hover","--g-ui-success-active","--g-ui-success-subtle","--g-ui-success-muted","--g-ui-danger","--g-ui-danger-hover","--g-ui-danger-active","--g-ui-danger-subtle","--g-ui-danger-muted","--g-ui-warning","--g-ui-warning-hover","--g-ui-warning-active","--g-ui-warning-subtle","--g-ui-warning-muted","--g-ui-info","--g-ui-info-hover","--g-ui-info-active","--g-ui-info-subtle","--g-ui-info-muted","--g-ui-shadow-xs","--g-ui-shadow-sm","--g-ui-shadow-md","--g-ui-shadow-lg","--g-ui-shadow-xl","--g-ui-shadow-2xl","--g-ui-radius","--g-ui-font","--g-ui-surface","--g-ui-text","--g-ui-muted","--g-ui-primary-strong","--g-ui-shadow"]);function pt(i={},e=document?.documentElement){if(e)for(let[a,r]of Object.entries(i)){let t=a.startsWith("--")?a:`--g-ui-${a}`;ct.has(t)&&e.style.setProperty(t,String(r))}}function dt(i="dark",e=document?.documentElement){e&&(e.classList.remove("g-ui-theme-dark","g-ui-theme-light"),e.classList.add(i==="light"?"g-ui-theme-light":"g-ui-theme-dark"))}import{Renderer as Xe,isSignal as Ue,isState as We,isStatePath as qe,isComputed as _e,resolve as ui,computed as mt,after as Zi,concat as ft}from"granular";function Ji(i){return Ue(i)||We(i)||qe(i)||_e(i)}function o(...i){return ft(...i,{separator:" ",filterFalsy:!0})}function Ke(i){if(!(i==null||i===""))return typeof i=="number"?`${i}px`:i}function n(i,e){let a={},r=[],t=s=>!!s&&typeof s=="object"&&!Array.isArray(s)&&!Xe.isRenderable(s)&&!Xe.isDomNode(s)&&!Ue(s)&&!We(s)&&!qe(s)&&!_e(s);for(let s of i)t(s)?Object.assign(a,s):r.push(s);if(e&&typeof e=="object")for(let s of Object.keys(e))a[s]===void 0&&(a[s]=e[s]);return{props:mt(a),rawProps:a,children:r}}function m(i){return ui(i)}function J(i){return!!ui(i)}function h(i,e,a){let r=t=>{let s=ui(t),u=s==null||s===""?a:s;return u==null||u===""?"":`${i}${u}`};return Ji(e)?Zi(e).compute(t=>r(t)):r(e)}function j(i,e){return Ji(e)?Zi(e).compute(a=>ui(a)?i:""):ui(e)?i:""}function W(i,e,a){let r=t=>e[t]||null;return Ji(i)?Zi(i).compute(t=>r(ui(t??a))):r(ui(i??a))}import{Button as ht,Span as Qi,when as ie}from"granular";function ee(...i){let{props:e,children:a}=n(i,{variant:"filled",size:"md"}),{variant:r,size:t,fullWidth:s,loading:u,leftSection:g,rightSection:d,className:f,disabled:l,...y}=e,p=J(u),c=J(l);return ht({...y,disabled:c||p,className:o("g-ui-button",h("g-ui-button-variant-",r,"filled"),h("g-ui-button-size-",t,"md"),j("g-ui-button-full",s),j("g-ui-button-loading",u),f)},ie(g,()=>Qi({className:"g-ui-button-section-left"},g)),ie(p,()=>Qi("Loading..."),()=>a),ie(d,()=>Qi({className:"g-ui-button-section-right"},d)))}import{Span as xt}from"granular";function re(...i){let{props:e,children:a}=n(i,{size:"md"}),{size:r,weight:t,color:s,dimmed:u,align:g,className:d,style:f,...l}=e,y=W(t,{bold:"g-ui-text-weight-700",semibold:"g-ui-text-weight-600",medium:"g-ui-text-weight-500",700:"g-ui-text-weight-700",600:"g-ui-text-weight-600",500:"g-ui-text-weight-500",400:"g-ui-text-weight-400"}),p=W(s,{primary:"g-ui-text-primary",success:"g-ui-text-success",danger:"g-ui-text-danger",muted:"g-ui-text-dimmed"}),c=W(g,{center:"g-ui-text-align-center",right:"g-ui-text-align-right",left:"g-ui-text-align-left"});return xt({...l,className:o("g-ui-text",h("g-ui-text-size-",r,"md"),j("g-ui-text-dimmed",u),y,p,c,d)},a)}import{H1 as bt,H2 as Ze,H3 as vt,H4 as wt,H5 as yt,H6 as zt}from"granular";var kt={1:bt,2:Ze,3:vt,4:wt,5:yt,6:zt};function Nt(...i){let{props:e,children:a}=n(i,{order:2}),{order:r,className:t,style:s,...u}=e,g=m(r)||2;return(kt[g]||Ze)({...u,className:o("g-ui-title",h("g-ui-title-order-",r,2),t)},a)}import{Div as Ct}from"granular";function St(...i){let{props:e,children:a}=n(i,{size:"md"}),{size:r,fluid:t,className:s,style:u,...g}=e;return Ct({...g,className:o("g-ui-container",j("g-ui-container-fluid",t),h("g-ui-container-size-",r,"md"),s)},a)}import{Div as Pt}from"granular";function Dt(...i){let{props:e,children:a}=n(i,{gap:"md"}),{gap:r,align:t,justify:s,className:u,style:g,...d}=e,f=W(s,{between:"g-ui-justify-between",center:"g-ui-justify-center",end:"g-ui-justify-end",start:"g-ui-justify-start"});return Pt({...d,className:o("g-ui-stack",h("g-ui-gap-",r,"md"),h("g-ui-align-",t),f,u)},a)}import{Div as Vt}from"granular";function Mt(...i){let{props:e,children:a}=n(i,{gap:"md",align:"center"}),{gap:r,align:t,position:s,wrap:u,className:g,style:d,...f}=e,l=W(s,{apart:"g-ui-justify-between",center:"g-ui-justify-center",right:"g-ui-justify-end",left:"g-ui-justify-start"});return Vt({...f,className:o("g-ui-group",h("g-ui-gap-",r,"md"),h("g-ui-align-",t,"center"),l,j("g-ui-wrap",u),g)},a)}import{Div as Ii,list as Lt,when as te}from"granular";function It(...i){let{props:e,children:a}=n(i,{padding:"md",radius:"md",shadow:"none"}),{title:r,content:t,actions:s,padding:u,radius:g,shadow:d,className:f,style:l,...y}=e;return Ii(te(r,()=>Ii({className:"g-ui-card-title"},r)),te(t,()=>Ii({className:"g-ui-card-content"},t)),te(s,()=>Ii({className:"g-ui-card-actions"},Lt(s,p=>ee({className:"g-ui-card-action",onClick:p.onClick,leftSection:p.leftSection,rightSection:p.rightSection,size:p.size||"sm",variant:p.variant||"outline",...p.props},p.label)))),{className:o("g-ui-card",h("g-ui-card-padding-",u,"md"),h("g-ui-card-radius-",g,"md"),h("g-ui-card-shadow-",d,"md"),f),...y},a)}import{Span as Bt}from"granular";function $t(...i){let{props:e,children:a}=n(i,{variant:"filled",size:"md"}),{variant:r,size:t,className:s,dot:u,style:g,...d}=e,f=W(r,{dot:"g-ui-badge-dot"});return Bt({...d,className:o("g-ui-badge",h("g-ui-badge-variant-",r,"filled"),h("g-ui-badge-size-",t,"md"),j("g-ui-badge-dot",u),f,s)},a)}import{Div as Je,Input as Tt,Label as Ft,Span as Bi,when as vi}from"granular";function At(...i){let{props:e,rawProps:a}=n(i,{size:"md"}),{label:r,description:t,error:s,size:u,leftSection:g,rightSection:d,className:f,style:l,inputProps:y,...p}=e,{onChange:c}=a,w=Tt({...p,className:o("g-ui-input",y?.className)});return Je({className:o("g-ui-text-input",f)},vi(r,()=>Ft({className:"g-ui-text-input-label"},r)),vi(t,()=>Bi({className:"g-ui-text-input-description"},t)),Je({className:o("g-ui-input-wrapper",h("g-ui-input-size-",u,"md"),j("g-ui-input-error",s))},vi(g,()=>Bi({className:"g-ui-input-section"},g)),w,vi(d,()=>Bi({className:"g-ui-input-section"},d))),vi(s,()=>Bi({className:"g-ui-text-input-error-text"},s)))}import{Div as ae,Textarea as jt,when as Qe}from"granular";function Rt(...i){let{props:e}=n(i,{size:"md"}),{size:a,leftSection:r,rightSection:t,className:s,...u}=e;return ae({className:o("g-ui-input-wrapper","g-ui-input-multiline",h("g-ui-input-size-",a,"md"),s)},Qe(r,()=>ae({className:"g-ui-input-section"},r)),jt({...u,className:o("g-ui-input g-ui-textarea")}),Qe(t,()=>ae({className:"g-ui-input-section"},t)))}import{Div as wi,Input as Et,Span as ir,when as $i,after as pi,state as Ot}from"granular";function oe(...i){let{props:e,rawProps:a}=n(i,{size:"md",step:1,allowDecimal:!0,allowNegative:!0,clampBehavior:"blur",hideControls:!1,decimalSeparator:".",thousandSeparator:"",format:null,prefix:"",suffix:""}),{value:r,min:t,max:s,step:u,size:g,allowDecimal:d,allowNegative:f,decimalSeparator:l,thousandSeparator:y,decimalScale:p,clampBehavior:c,hideControls:w,format:k,locale:B,currency:P,formatOptions:L,prefix:z,suffix:C,leftSection:x,rightSection:V,className:b,inputProps:v,onChange:M,onInput:$,onBlur:G,onFocus:Y,onKeyDown:X,..._}=e,{onChange:K,onInput:ri,onBlur:ci,onFocus:oi,onKeyDown:Ki}=a,N=Ot(""),T=D=>String(D??"").replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),F=()=>{if(!!!m(d))return 0;let S=m(p);if(S!=null&&S!==""&&Number.isFinite(Number(S)))return Math.max(0,Number(S));let I=m(k);return I==="currency"||I==="percent"?2:0},U=D=>{let S=m(l)??".",I=m(y)??"",A=String(D??"");if(I&&(A=A.split(I).join("")),!A||A==="-"||A===S||A.endsWith(S))return null;let H=A.replace(S,"."),E=Number(H);return Number.isFinite(E)?E:null},ei=D=>{let S=m(y)??"";return S?D.replace(/\B(?=(\d{3})+(?!\d))/g,S):D},q=D=>{let S=m(l)??".",I=F(),A=Number(D);if(!Number.isFinite(A))return"";let H=A<0?"-":"",E=Math.abs(A),[R,O=""]=String(E).split("."),Z=ei(R);if(I>0){let ni=O.slice(0,I).padEnd(I,"0");return`${H}${Z}${S}${ni}`}return`${H}${Z}`},ti=(D,S)=>{try{let I=m(B),A=m(P)??"USD",H=m(L)??{},E=F(),R=S==="currency"?"currency":"decimal";return new Intl.NumberFormat(I,{style:R,currency:A,...E>0?{minimumFractionDigits:E,maximumFractionDigits:E}:{maximumFractionDigits:0},...H}).format(D)}catch{return q(D)}},Q=D=>{let S=D,I=m(t),A=m(s);return I!=null&&Number.isFinite(Number(I))&&(S=Math.max(S,Number(I))),A!=null&&Number.isFinite(Number(A))&&(S=Math.min(S,Number(A))),!m(f)&&S<0&&(S=0),S},si=()=>{let D=m(C)??"",S=m(k);return!D&&S==="percent"?"%":D},Mi=(D,S,I)=>{let A=m(z)??"",H=si(),E=String(D??"").replace(/\u00A0/g," "),R=String(A??"").replace(/\u00A0/g," "),O=String(H??"").replace(/\u00A0/g," "),Z=R&&E.startsWith(R),ni=O&&E.endsWith(O);return`${S??""}${Z?"":A}${D}${ni?"":H}`},Te=(D,S)=>{let I=F(),A=m(l)??".",E=String(D??"").replace(/\D/g,"")||"0",R=I>0?E.padStart(I+1,"0"):E,Z=(I>0?R.slice(0,-I):R).replace(/^0+(?=\d)/,"")||"0",ni=I>0?R.slice(-I):"",He=I>0?`${Z}${A}${ni}`:Z;return`${S??""}${He}`},Fe=D=>{let S=m(z)??"",I=si(),A=String(D??""),H=String(S??"").replace(/\u00A0/g," "),E=String(I??"").replace(/\u00A0/g," ");return H&&A.replace(/\u00A0/g," ").startsWith(H)&&(A=A.slice(S.length)),E&&A.replace(/\u00A0/g," ").endsWith(E)&&(A=A.slice(0,-I.length)),A},Ae=D=>{let S=!!m(f),I=Fe(D),A=S&&I.includes("-")?"-":"",H=I.replace(/\D/g,""),E=Te(H,A);if(m(c)==="strict"){let R=U(E);if(R!=null){let O=Q(R);E=`${O<0?"-":""}${q(Math.abs(O))}`}}return E},Gr=D=>{if(D==null||D==="")return Te("","");if(typeof D=="number"&&Number.isFinite(D)){let O=m(c)==="strict"?Q(D):D;return`${O<0?"-":""}${q(Math.abs(O))}`}let S=Fe(D),I=m(l)??".",H=!!m(f)&&String(S).includes("-")?"-":"",E=String(S??"").replace(new RegExp(`[^0-9${T(I)}]`,"g"),""),R=U(`${H}${E}`);if(R!=null){let O=m(c)==="strict"?Q(R):R;return`${O<0?"-":""}${q(Math.abs(O))}`}return Ae(D)},Li,je=D=>{let S=m(D);if(S===void 0)return;let I=Gr(S);I!==N.get()&&(Li=I,N.set(I))};je(r),pi(r).change(je),pi(N).change(D=>{if(D===Li){Li=void 0;return}Li=void 0;let S=U(D);if(S==null){K?.(D??"");return}K?.(S)});let Re=pi(V).compute(D=>D!=null&&D!==!1),Xr=pi(w,Re).compute(([D,S])=>!m(D)&&!S),Ur=pi(d).compute(D=>m(D)?"decimal":"numeric"),Wr=pi(k,z,C,d,f,l,y,p,c,t,s,B,P,L).compute(()=>({mode:"both",format:D=>{let S=Ae(D),I=m(k),H=!!m(f)&&S.startsWith("-")?"-":"",E=U(S),R=S.replace(H,"");if(E!=null){let O=Math.abs(E);if(typeof I=="function")try{R=I(O)}catch{R=q(O)}else if(I==="currency")R=ti(O,"currency");else if(I==="decimal"){let Z=m(B),ni=m(L);R=Z||ni?ti(O,"decimal"):q(O)}else R=q(O)}return{value:S,raw:S,visual:Mi(R,H,I)}}})),Ee=D=>{let S=U(N.get()),I=Number(m(u)??1),H=Q((S??0)+I*D);N.set(q(H))},Oe=D=>{if(!D||typeof D.setSelectionRange!="function")return;let S=()=>{try{let I=String(D.value??"").length;D.setSelectionRange(I,I)}catch{}};typeof requestAnimationFrame=="function"?requestAnimationFrame(S):S()},qr=D=>{ri?.(D);let S=D?.target;S&&Oe(S)},_r=D=>{if(ci?.(D),m(c)!=="blur")return;let S=U(N.get());if(S==null)return;let I=Q(S);N.set(q(I))},Kr=D=>{oi?.(D),Oe(D?.target)},Zr=D=>{Ki?.(D);let S=D?.target;if(!S)return;let I=m(z)??"",A=si();A&&typeof S.selectionEnd=="number"&&(S.selectionEnd=Math.min(S.selectionEnd,String(S.value??"").length-A.length)),I&&typeof S.selectionStart=="number"&&(S.selectionStart=Math.max(S.selectionStart,I.length))};return wi({..._,className:o("g-ui-number-field",b)},wi({className:o("g-ui-input-wrapper",h("g-ui-input-size-",g,"md"))},$i(x,()=>wi({className:"g-ui-input-section"},x)),Et({type:"text",inputMode:$i(v?.inputMode,()=>v.get().inputMode,()=>Ur),...v,className:o("g-ui-input g-ui-input-number",v?.className),value:N,format:Wr,onInput:qr,onBlur:_r,onFocus:Kr,onKeyDown:Zr}),$i(Re,()=>wi({className:"g-ui-input-section"},V)),$i(Xr,()=>wi({className:"g-ui-number-field-controls"},ir({className:"g-ui-number-field-control",onClick:()=>Ee(1)},"+"),ir({className:"g-ui-number-field-control",onClick:()=>Ee(-1)},"\u2212")))))}function Ht(...i){return oe(...i)}import{Div as Fi,Button as Yt,portal as Gt,when as se,after as Xt}from"granular";var er='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/></svg>',rr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M560-240 320-480l240-240 56 56-184 184 184 184-56 56Z"/></svg>',Ti='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M379.33-244 154-469.33 201.67-517l177.66 177.67 378.34-378.34L805.33-670l-426 426Z"/></svg>',tr='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M240-446.67v-66.66h480v66.66H240Z"/></svg>',di='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M312-265.33 265.33-312l168-168-168-167L312-693.67l168 168 167-168L693.67-647l-168 167 168 168L647-265.33l-167-168-168 168Z"/></svg>';function Ut(...i){let{props:e,rawProps:a,children:r}=n(i,{size:"md",centered:!0,overlay:"normal"}),{opened:t,title:s,size:u,centered:g,overlay:d,position:f,className:l,style:y}=e,{onClose:p}=a,c=Xt(f,g).compute(([w,k])=>`g-ui-modal-position-${w??(k===!1?"top-center":"center")}`);return se(t,()=>Gt(Fi({className:o("g-ui-modal-overlay",h("g-ui-modal-overlay-",d,"normal"),c),onClick:w=>{w.target===w.currentTarget&&p?.()}},Fi({className:o("g-ui-modal",h("g-ui-modal-size-",u,"md"),l)},Fi({className:"g-ui-modal-header"},se(s,()=>Fi({className:"g-ui-modal-title"},s)),se(p,()=>Yt({type:"button",className:"g-ui-button g-ui-button-variant-subtle g-ui-button-size-xs g-ui-modal-close",onClick:p,innerHTML:di}))),r))))}import{Div as Ai,Span as ne,after as ar,when as or}from"granular";function yi(...i){let{props:e}=n(i,{variant:"spinner",size:"md"}),{variant:a,size:r,className:t}=e,s=ar(a).compute(g=>g==="dots"),u=ar(a).compute(g=>g==="bars");return or(s,()=>Ai({className:o("g-ui-loading g-ui-dots",h("g-ui-loading-size-",r,"md"),t)}),()=>or(u,()=>Ai({className:o("g-ui-loading g-ui-bars",h("g-ui-loading-size-",r,"md"),t)},ne(""),ne(""),ne("")),()=>Ai({className:o("g-ui-loading",h("g-ui-loading-size-",r,"md"),t)},Ai({className:"g-ui-spinner"}))))}import{Div as ue,Input as Wt,Label as qt,Span as sr,when as ge,state as _t,after as Kt}from"granular";function Zt(...i){let{props:e,rawProps:a}=n(i,{size:"md"}),{checked:r,label:t,description:s,size:u,indeterminate:g,className:d,style:f,inputProps:l,...y}=e,{onChange:p}=a,c=_t(J(r));Kt(r).change(k=>{k!=null&&(c.set(!!k),p?.(k))});let w=qt({className:"g-ui-checkbox-control"},Wt({type:"checkbox",indeterminate:g,checked:c,className:o("g-ui-checkbox-input",h("g-ui-checkbox-size-",u,"md"),l?.className),...y}),ge(c,()=>ue({className:"g-ui-checkbox-checked",innerHTML:Ti}),()=>{if(!c.get()&&g.get())return ue({className:"g-ui-checkbox-indeterminate",innerHTML:tr})}),ge(t,()=>sr({className:"g-ui-checkbox-label"},t)));return ue({className:o("g-ui-checkbox",h("g-ui-checkbox-size-",u,"md"),d)},w,ge(s,()=>sr({className:"g-ui-checkbox-description"},s)))}import{Input as Jt,Label as Qt,Span as ia,when as ea}from"granular";function ra(...i){let{props:e}=n(i,{size:"md"}),{label:a,size:r,className:t,style:s,inputProps:u,...g}=e;return Qt({className:o("g-ui-switch",h("g-ui-switch-size-",r,"md"),t)},Jt({type:"checkbox",className:o("g-ui-switch-input",h("g-ui-switch-size-",r,"md"),u?.className),...g}),ea(a,()=>ia({className:"g-ui-switch-label"},a)))}import{Div as gi,Span as nr,when as le,state as ur,after as ji}from"granular";function ta(...i){let{props:e,rawProps:a}=n(i,{data:[],size:"md"}),{data:r,value:t,size:s,leftSection:u,rightSection:g,placeholder:d,className:f,...l}=e,{onChange:y}=a,p=ur(!1),c=ur(m(t)??"");ji(t).change(P=>{let L=m(P);L!==void 0&&c.set(L??"")});let w=P=>{c.set(P),y?.(P),p.set(!1)},k=ji(c).compute(P=>P?"":"g-ui-select-placeholder"),B=ji(c).compute(P=>{let z=(m(r)??[]).find(C=>C.value===P);return P?z?.label??"":d??""});return gi({...l,className:o("g-ui-select-root",f)},gi({className:o("g-ui-input-wrapper",h("g-ui-input-size-",s,"md"))},le(u,()=>gi({className:"g-ui-input-section"},u)),gi({className:o("g-ui-select",k),onClick:()=>p.set(!p.get())},nr({className:"g-ui-select-value"},B)),le(g,()=>gi({className:"g-ui-input-section"},g),()=>nr({className:"g-ui-select-caret"},"\u25BE"))),le(p,()=>gi({className:"g-ui-select-dropdown"},(m(r)??[]).map(P=>gi({className:o("g-ui-select-item",ji(c).compute(L=>L===P.value?"g-ui-select-item-active":"")),onClick:()=>w(P.value)},P.label)))))}import{Button as aa,Div as ce,state as oa,after as gr,list as sa,when as na}from"granular";function ua(...i){let{props:e,rawProps:a}=n(i,{tabs:[],orientation:"horizontal",variant:"default"}),{value:r,tabs:t,orientation:s,variant:u,className:g,style:d}=e,{onChange:f}=a,l=oa(r?.get()??t.get()?.[0]?.value??"");gr(r).change(p=>{l.set(p)});let y=p=>{l.set(p),f?.(p)};return ce({className:o("g-ui-tabs",W(s,{vertical:"g-ui-tabs-vertical"}),h("g-ui-tabs-variant-",u,"default"),e.className??g)},ce({className:"g-ui-tabs-list"},sa(t,p=>aa({className:gr(l).compute(c=>o("g-ui-tabs-tab",p.value===c&&"g-ui-tabs-tab-active")),onClick:()=>y(p.value)},p.label))),ce({className:"g-ui-tabs-panel"},na(l,()=>(console.log("tabs",t.get()),t.get()?.find(p=>p.value===l.get())?.content??null))))}import{Table as ga,Thead as la,Tbody as ca,Tr as lr,Th as pa,Td as cr}from"granular";function da(...i){let{props:e}=n(i,{headers:[],rows:[]}),{headers:a,rows:r,striped:t,highlightOnHover:s,withBorder:u,withColumnBorders:g,className:d,style:f,...l}=e;return ga({...l,className:o("g-ui-table",j("g-ui-table-striped",t),j("g-ui-table-hover",s),j("g-ui-table-with-border",u),j("g-ui-table-column-borders",g),d)},a.length?la(lr(a.map(y=>pa(y)))):null,ca(r.map(y=>lr(Array.isArray(y)?y.map(p=>cr(p)):Object.values(y).map(p=>cr(p))))))}import{Div as pe}from"granular";import{state as ma,when as fa,after as ha}from"granular";function xa(...i){let{props:e,children:a}=n(i,{opened:!1}),{opened:r,className:t,...s}=e,u=ma(J(r));ha(r).change(l=>{u.set(J(l))});let g=()=>{u.set(!u.get())},d=a[0],f=a[1];return pe({...s,className:o("g-ui-accordion",t)},pe({className:"g-ui-accordion-header",onClick:g},d),fa(u,()=>pe({className:"g-ui-accordion-content"},f)))}import{Span as pr}from"granular";function ba(...i){let{props:e,children:a}=n(i),{label:r,className:t,style:s}=e;return pr({className:o("g-ui-tooltip",t)},a,pr({className:"g-ui-tooltip-content"},r))}import{Div as zi,when as va,after as wa,state as ki,portal as ya}from"granular";var de=ki({currentOpenState:null});function za(...i){let e=ki(),a=ki(),r=ki({}),{props:t,rawProps:s,children:u}=n(i,{position:"right"}),{opened:g,content:d,position:f,className:l,...y}=t,{onChange:p}=s,c=ki(m(g)??!1);wa(g).change(z=>{let C=m(z);C!=null&&(c.set(!!C),C&&w())});let w=()=>{de.get().currentOpenState!==c&&(de.get().currentOpenState?.set(!1),de.set().currentOpenState=c)};g.get()&&w();let k=()=>{let z=e.get(),C=a.get();if(!z||!C)return;let x=z.getBoundingClientRect(),V=C.getBoundingClientRect(),b=m(f)??"right",v=x.bottom+8,M=x.left;b==="center"&&(M=x.left+x.width/2-V.width/2),b==="right"&&(M=x.right-V.width),r.set({top:`${v}px`,left:`${M}px`})},B=z=>{c.set(z),p?.(z),z&&(w(),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>k()):setTimeout(()=>k(),0))},P=()=>B(!c.get()),L=()=>B(!1);return zi({...y,node:e,className:o("g-ui-menu",l)},zi({onClick:P},u),va(c,()=>ya(zi(zi({className:"g-ui-menu-overlay",onClick:L}),zi({className:"g-ui-menu-dropdown",node:a,style:r},d)))))}import{Div as dr,portal as ka,when as Na}from"granular";function Ca(...i){let{props:e,children:a}=n(i,{position:"right",size:"md",overlay:"normal",shadowed:!0}),{opened:r,onClose:t,position:s,size:u,overlay:g,shadowed:d,className:f,style:l}=e;return Na(r,()=>ka(dr({className:o("g-ui-drawer-overlay",h("g-ui-drawer-overlay-",g,"normal")),onClick:t},dr({className:o("g-ui-drawer",W(d,{true:"g-ui-drawer-shadowed"},!0),h("g-ui-drawer-",s,"right"),h("g-ui-drawer-size-",u,"md"),f),onClick:y=>y.stopPropagation()},a))))}import{Button as Sa,Div as me,Span as mr,when as Ri,after as fr}from"granular";function fe(...i){let{props:e,rawProps:a,children:r}=n(i,{color:"blue",withCloseButton:!0}),{title:t,color:s,icon:u,loading:g,withCloseButton:d,withBorder:f,className:l,style:y}=e,{onClose:p}=a,c=fr(u,g).compute(([k,B])=>!k&&!!B),w=fr(u,g).compute(([k,B])=>!!k||!!B);return me({className:o("g-ui-notification",[f,"g-ui-notification-bordered"],[s,k=>`g-ui-notification-${k}`],[w,"g-ui-notification-with-icon"],l)},Ri(u,()=>mr({className:"g-ui-notification-icon"},u)),Ri(c,()=>yi({size:"sm",className:"g-ui-notification-loader"})),me({className:"g-ui-notification-body"},Ri(t,()=>me({className:"g-ui-notification-title"},t)),r),Ri(d,()=>Sa({type:"button",className:"g-ui-notification-close",onClick:()=>p?.()},mr({innerHTML:di}))))}import{Div as Pa,when as Da}from"granular";function Va(...i){let{props:e}=n(i,{labelPosition:"center"}),{label:a,labelPosition:r,className:t,...s}=e;return Pa({...s,className:o("g-ui-divider",j("label",a),h("g-ui-divider-label-",r,"center"),t)},Da(a,()=>re({className:"g-ui-divider-label-text",size:"sm"},a)))}import{Div as Ma}from"granular";function La(...i){let{props:e,children:a}=n(i,{padding:"md",radius:"md",shadow:"none"}),{padding:r,radius:t,shadow:s,className:u,...g}=e;return Ma({...g,className:o("g-ui-paper",[r,d=>`g-ui-card-padding-${d}`],[t,d=>`g-ui-card-radius-${d}`],[s,d=>`g-ui-card-shadow-${d}`],u)},a)}import{Button as Ia,Div as he,Span as Ba,after as hr,when as xe}from"granular";function $a(...i){let{props:e,rawProps:a,children:r}=n(i,{color:"blue"}),{title:t,color:s,icon:u,withCloseButton:g,className:d,...f}=e,{onClose:l}=a,y=hr(t,g).compute(([c,w])=>c||w),p=hr(u).compute(c=>c!==void 0);return he({...f,className:o("g-ui-alert",[s,c=>`g-ui-alert-${c}`],d)},he({className:"g-ui-alert-header"},xe(u,()=>Ba({className:"g-ui-alert-icon"},u)),xe(t,()=>he({className:"g-ui-alert-title"},t)),xe(g,()=>Ia({type:"button",className:"g-ui-alert-close",onClick:()=>l?.()},"\xD7"))),r)}import{Div as Ta,Img as Fa,when as Aa}from"granular";function ja(...i){let{props:e,children:a}=n(i,{size:"md",alt:""}),{src:r,size:t,alt:s,className:u,...g}=e;return Ta({...g,className:o("g-ui-avatar",[t,d=>`g-ui-avatar-size-${d}`],u)},Aa(r,()=>Fa({className:"g-ui-avatar-img",src:r,alt:s}),()=>a))}import{Span as Ra}from"granular";function Ea(...i){let{props:e,children:a}=n(i),{className:r,...t}=e;return Ra({...t,className:o("g-ui-kbd",r)},a)}import{Code as Oa}from"granular";function Ha(...i){let{props:e,children:a}=n(i),{className:r,...t}=e;return Oa({...t,className:o("g-ui-code",r)},a)}import{Blockquote as Ya}from"granular";function Ga(...i){let{props:e,children:a}=n(i),{className:r,...t}=e;return Ya({...t,className:o("g-ui-blockquote",r)},a)}import{Div as Xa}from"granular";function Ua(...i){let{props:e,children:a}=n(i,{cols:3,gap:"md"}),{cols:r,gap:t,className:s,...u}=e;return Xa({...u,className:o("g-ui-grid",[t,g=>`g-ui-gap-${g}`],[r,g=>`g-ui-grid-cols-${g}`],s)},a)}import{Ul as Wa,Ol as qa,Li as be,Div as Ei,Span as ve,after as we,when as mi,isSignal as _a,isState as Ka,isStatePath as Za,isComputed as Ja}from"granular";function xr(...i){let{props:e,children:a}=n(i,{type:"none",size:"md"}),{type:r,size:t,withPadding:s,className:u,...g}=e,d=W(r,{ordered:"g-ui-list-ordered",unordered:"g-ui-list-unordered",none:"g-ui-list-none"}),f=we(r).compute(k=>k==="ordered"),l=k=>k&&typeof k=="object"&&typeof k.tagName=="string"&&(k.tagName.toLowerCase()==="ul"||k.tagName.toLowerCase()==="ol"),y=k=>k&&typeof k=="object"&&typeof k.tagName=="string"&&k.tagName.toLowerCase()==="li",p=k=>{let B=P=>P==null||P===!1?null:Array.isArray(P)?P.map(L=>B(L)):y(P)?P:l(P)?be({className:"g-ui-list-nested-item"},P):be(ve({className:"g-ui-list-item-shell"},P));return _a(k)||Ka(k)||Za(k)||Ja(k)?we(k).compute(P=>B(P)):B(k)},c=a.map(k=>p(k)),w={...g,className:o("g-ui-list",h("g-ui-list-size-",t,"md"),j("g-ui-list-with-padding",s),d,u)};return mi(f,()=>qa(w,c),()=>Wa(w,c))}function Qa(...i){let{props:e,children:a}=n(i,{withBorder:!1}),{leftSection:r,rightSection:t,title:s,body:u,withBorder:g,className:d,...f}=e,l=we(s,u).compute(([y,p])=>!!y||!!p);return be({...f,className:o("g-ui-list-item",j("g-ui-list-item-border",g),d)},Ei({className:"g-ui-list-item-shell"},mi(r,()=>ve({className:"g-ui-list-item-section g-ui-list-item-section-left"},r)),mi(l,()=>Ei({className:"g-ui-list-item-content"},mi(s,()=>Ei({className:"g-ui-list-item-title"},s)),mi(u,()=>Ei({className:"g-ui-list-item-body"},u))),()=>a),mi(t,()=>ve({className:"g-ui-list-item-section g-ui-list-item-section-right"},t))))}xr.Item=Qa;import{A as io}from"granular";function eo(...i){let{props:e,children:a}=n(i),{className:r,...t}=e;return io({...t,className:o("g-ui-anchor",r)},a)}import{Img as ro}from"granular";function to(...i){let{props:e}=n(i),{className:a,...r}=e;return ro({...r,className:o("g-ui-image",a)})}import{Span as ao}from"granular";function Oi(...i){let{props:e,children:a}=n(i,{size:"md"});return ao({...e,className:o("g-ui-icon",h("g-ui-icon-size-",e.size,"md"),h("g-ui-icon-color-",e.color),e.className)},...a)}import{Div as br}from"granular";function oo(...i){let{props:e}=n(i,{value:0,color:"primary",size:"md"}),{value:a,color:r,size:t,className:s,...u}=e;return br({...u,className:o("g-ui-progress",h("g-ui-progress-size-",t,"md"),[a,g=>{let d=Math.max(0,Math.min(100,Number(g)||0));return`g-ui-progress-${Math.round(d/5)*5}`}],[r,g=>g?`g-ui-progress-${g}`:""],s)},br({className:"g-ui-progress-bar"}))}import{Div as li,after as Hi,state as so,when as no}from"granular";function uo(...i){let{props:e,rawProps:a}=n(i,{size:"md",min:0,max:100,step:1}),{onChange:r}=a,{value:t,marks:s,size:u,min:g,max:d,step:f,disabled:l,className:y,...p}=e,c=so(m(t??g));Hi(t).change(C=>{C!=null&&c.set(m(C))});let w=()=>{let C=Number(m(g)),x=Number(m(d));return!Number.isFinite(C)||!Number.isFinite(x)?{minValue:0,maxValue:100}:{minValue:Math.min(C,x),maxValue:Math.max(C,x)}},k=()=>{let C=Number(m(f));return Number.isFinite(C)&&C>0?C:1},B=C=>{let{minValue:x,maxValue:V}=w(),b=k(),v=Math.max(x,Math.min(V,Number(C))),M=Math.round((v-x)/b)*b+x;M!==c.get()&&(c.set(M),r?.(M))},P=Hi(c).compute(C=>{let{minValue:x,maxValue:V}=w(),b=V-x;if(b<=0)return 0;let v=(Number(C??x)-x)/b*100;return Math.max(0,Math.min(100,v))}),L=(C,x)=>{let V=x?.();if(!V||V.width===0)return;let v=Math.min(Math.max(C.clientX-V.left,0),V.width)/V.width,{minValue:M,maxValue:$}=w();B(M+v*($-M))},z=C=>{if(J(l))return;C.preventDefault?.();let x=C.currentTarget,V=()=>x.getBoundingClientRect();x.setPointerCapture?.(C.pointerId),L(C,V);let b=M=>L(M,V),v=()=>{x.releasePointerCapture?.(C.pointerId),window.removeEventListener("pointermove",b),window.removeEventListener("pointerup",v)};window.addEventListener("pointermove",b),window.addEventListener("pointerup",v)};return li({...p,className:o("g-ui-slider",h("g-ui-slider-size-",u,"md"),j("g-ui-slider-disabled",l),y)},li({className:"g-ui-slider-track",onPointerDown:z},li({className:"g-ui-slider-bar",style:Hi(P).compute(C=>({width:`${C}%`}))}),li({className:"g-ui-slider-thumb",style:Hi(P).compute(C=>({left:`${C}%`}))})),no(s,()=>li({className:"g-ui-slider-marks"},s.map(C=>ye({mark:C,getBounds:w})))))}var ye=({mark:i,getBounds:e})=>{let{minValue:a,maxValue:r}=e(),t=r-a,s=i.value??i,u=i.label??String(i.value)??s,g=Number(s),d=0;return t>0&&(d=(g-a)/t*100),li({className:"g-ui-slider-mark",style:{left:`${Math.max(0,Math.min(100,d))}%`}},li({className:"g-ui-slider-mark-label"},u))};import{Div as go}from"granular";function lo(...i){let{props:e}=n(i,{height:"md",width:"full"}),{height:a,width:r,className:t,...s}=e;return go({...s,className:o("g-ui-skeleton",[a,u=>`g-ui-skeleton-h-${u}`],[r,u=>`g-ui-skeleton-w-${u}`],t)})}import{Button as co,after as vr,state as po}from"granular";function mo(...i){let{props:e,rawProps:a,children:r}=n(i,{size:"md",variant:"filled"}),{checked:t,size:s,variant:u,className:g,...d}=e,{onChange:f}=a,l=po(!!t);vr(t).change(p=>{p!=null&&l.set(!!p)});let y=p=>{l.set(p),f?.(p)};return co({...d,type:"button",className:o("g-ui-chip",h("g-ui-chip-size-",s,"md"),h("g-ui-chip-variant-",u,"filled"),vr(l).compute(p=>p?"g-ui-chip-active":""),g),onClick:()=>y(!l.get())},r)}import{Div as ze,after as wr,state as fo}from"granular";function ho(...i){let{props:e,rawProps:a}=n(i,{data:[],size:"sm"}),{value:r,data:t,size:s,scroll:u,className:g,...d}=e,{onChange:f}=a,l=fo(m(r));wr(r).change(p=>{let c=m(p);c!=null&&l.set(c)});let y=p=>{l.set(p),f?.(p)};return ze({...d,className:o(u&&"g-ui-segmented-scroll")},ze({className:o("g-ui-segmented",h("g-ui-segmented-size-",s,"sm"),e.className??g)},t.map(p=>ze({className:o("g-ui-segmented-item",wr(l).compute(c=>p.value===c?"g-ui-segmented-active":"")),onClick:()=>y(p.value)},p.label))))}import{Button as ke,Div as xo,state as bo,after as Yi}from"granular";function vo(...i){let{props:e,rawProps:a}=n(i,{total:1,size:"md"}),{page:r,total:t,size:s,className:u,...g}=e,{onChange:d}=a,f=bo(m(r??1));Yi(r).change(c=>{let w=m(c);w!=null&&f.set(w)});let l=c=>{let w=Number(m(t))||1,k=Math.max(1,Math.min(w,c));f.set(k),d?.(k)},y=[],p=Number(m(t))||1;for(let c=1;c<=p;c+=1)y.push(c);return xo({...g,className:o("g-ui-pagination",h("g-ui-pagination-size-",s,"md"),e.className??u)},ke({className:"g-ui-pagination-item",onClick:()=>l((f.get?.()??f)-1),disabled:Yi(f).compute(c=>c<=1)},"<"),y.map(c=>ke({className:Yi(f).compute(w=>o("g-ui-pagination-item",c===w&&"g-ui-pagination-item-active")),onClick:()=>l(c)},String(c))),ke({className:"g-ui-pagination-item",onClick:()=>l((f.get?.()??f)+1),disabled:Yi(f).compute(c=>c>=t)},">"))}import{Div as wo,Input as yo,Label as zo,Span as yr,when as zr}from"granular";function ko(...i){let{props:e}=n(i,{size:"md"}),{label:a,description:r,size:t,className:s,inputProps:u,...g}=e,d=zo({className:"g-ui-radio-control"},yo({type:"radio",className:o("g-ui-radio-input",h("g-ui-radio-size-",t,"md"),u?.className),...g}),zr(a,()=>yr({className:"g-ui-radio-label"},a)));return wo({className:o("g-ui-radio",h("g-ui-radio-size-",t,"md"),s)},d,zr(r,()=>yr({className:"g-ui-radio-description"},r)))}import{Div as No}from"granular";function Co(...i){let{props:e,children:a}=n(i),{className:r,...t}=e;return No({...t,className:o("g-ui-stack g-ui-gap-sm",r)},a)}import{Nav as So,Span as Po}from"granular";function Do(...i){let{props:e,children:a}=n(i,{separator:"/"}),{separator:r,className:t,...s}=e,u=[];Array.isArray(a)?u.push(...a):u.push(a);let g=u.filter(Boolean),d=[];return g.forEach((f,l)=>{d.push(f),l<g.length-1&&d.push(Po({className:"g-ui-breadcrumbs-separator"},r))}),So({...s,className:o("g-ui-breadcrumbs",t)},d)}import{Div as Vo}from"granular";function Mo(...i){let{props:e,children:a}=n(i),{className:r,...t}=e;return Vo({...t,className:o("g-ui-center",r)},a)}import{Div as Lo}from"granular";function Io(...i){let{props:e}=n(i,{size:"md"}),{size:a,className:r,...t}=e;return Lo({...t,className:o("g-ui-space",[a,s=>`g-ui-space-${s}`],r)})}import{Div as Bo,when as $o}from"granular";function To(...i){let{props:e,children:a}=n(i),{opened:r,className:t,...s}=e;return $o(r,()=>Bo({...s,className:o("g-ui-collapse",t)},a))}import{Button as Fo}from"granular";function Gi(...i){let{props:e,children:a}=n(i,{size:"md",variant:"filled"}),{size:r,variant:t,className:s,...u}=e;return Fo({...u,type:"button",className:o("g-ui-action-icon",h("g-ui-action-icon-size-",r,"md"),h("g-ui-action-icon-",t,"filled"),s)},a)}import{Div as Ne,when as Ao,after as jo,state as Ro}from"granular";function Ce(...i){let{props:e,rawProps:a,children:r}=n(i,{position:"left"}),{opened:t,position:s,content:u,className:g,...d}=e,{onChange:f}=a,l=Ro(m(t)??!1);jo(t).change(p=>{let c=m(p);c!=null&&l.set(!!c)});let y=p=>{l.set(p),f?.(p)};return Ne({...d,className:o("g-ui-popover",e.className??g)},Ne({onClick:()=>y(!l.get())},r),Ao(l,()=>Ne({className:o("g-ui-popover-dropdown",s==="right"&&"g-ui-popover-right",s==="center"&&"g-ui-popover-center")},u)))}import{Div as kr}from"granular";function Eo(...i){let{props:e,children:a}=n(i,{position:"left"}),{position:r,content:t,className:s,...u}=e;return kr({...u,className:o("g-ui-hover-card",s)},a,kr({className:o("g-ui-hover-card-dropdown",[r,g=>g==="right"?"g-ui-hover-card-right":""],[r,g=>g==="center"?"g-ui-hover-card-center":""])},t))}import{Div as Oo}from"granular";function Ho(...i){let{props:e,children:a}=n(i,{position:"bottom-right"}),{position:r,className:t,...s}=e;return Oo({...s,className:o("g-ui-affix",[r,u=>`g-ui-affix-${u}`],t)},a)}import{Fieldset as Yo,Legend as Go,when as Xo}from"granular";function Uo(...i){let{props:e,children:a}=n(i),{legend:r,className:t,...s}=e;return Yo({...s,className:o("g-ui-fieldset",t)},Xo(r,()=>Go({className:"g-ui-legend"},r)),a)}import{Div as Wo}from"granular";function qo(...i){let{props:e,children:a}=n(i,{position:"sticky"}),{position:r,className:t,...s}=e;return Wo({...s,className:o("g-ui-appbar",h("g-ui-appbar-",r,"sticky"),t)},a)}import{Div as Se,portal as _o,after as Xi,state as Nr,when as Cr}from"granular";function Ko(...i){let{props:e,children:a}=n(i,{position:"left",size:"md",blur:!0,fixed:!1,minWidth:"button"});return Cr(e.fixed,()=>Jo(e,a),()=>Zo(e,a))}var Zo=(i,e)=>{let{open:a,onClose:r,position:t,size:s,blur:u,fixed:g,minWidth:d,className:f,...l}=i,y=Nr(!1),p=Nr(!1),c=220,w=P=>{if(P){y.set(!0),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>p.set(!0)):setTimeout(()=>p.set(!0),0);return}p.set(!1),setTimeout(()=>y.set(!1),c)};w(!!a.get()),Xi(a).change(P=>w(!!P));let k=Xi(p,u).compute(P=>{let[L,z]=P;return o("g-ui-sidebar-overlay",L&&"g-ui-sidebar-overlay-open",!z&&"g-ui-sidebar-overlay-noblur")}),B=Xi(s,t,p,f).compute(P=>{let[L,z,C,x]=P,V=z==="right"?"g-ui-sidebar-drawer-right g-ui-sidebar-position-right":"g-ui-sidebar-drawer-left";return o("g-ui-sidebar","g-ui-sidebar-drawer",`g-ui-sidebar-size-${L}`,V,C&&"g-ui-sidebar-drawer-open",m(x))});return Cr(y,()=>_o(Se({className:k,onClick:r},Se({className:B,onClick:P=>P.stopPropagation()},e))))},Jo=(i,e)=>{let{open:a,position:r,size:t,minWidth:s,className:u,...g}=i,d=Xi(t,r,a,s,u).compute(f=>{let[l,y,p,c,w]=f,k=c||"button",B=null;return k==="button"?B="g-ui-sidebar-min-button":k==="xs"?B="g-ui-sidebar-min-xs":k==="sm"?B="g-ui-sidebar-min-sm":k==="md"&&(B="g-ui-sidebar-min-md"),o("g-ui-sidebar g-ui-sidebar-fixed",`g-ui-sidebar-size-${l||"md"}`,B,p&&"g-ui-sidebar-fixed-open",w)});return Se({...g,className:d},e)};import{Div as fi,when as Sr}from"granular";function Qo(...i){let{props:e}=n(i,{items:[]}),{items:a,className:r,...t}=e;return fi({...t,className:o("g-ui-timeline",r)},a.map(s=>fi({className:"g-ui-timeline-item"},fi({className:"g-ui-timeline-dot"}),fi({className:"g-ui-timeline-content"},Sr(s.title,()=>fi({className:"g-ui-timeline-title"},s.title)),Sr(s.description,()=>fi({className:"g-ui-timeline-desc"},s.description)),s.content))))}import{Div as Ui}from"granular";function is(...i){let{props:e}=n(i,{active:0,items:[]}),{active:a,items:r,className:t,...s}=e;return Ui({...s,className:o("g-ui-stepper",t)},r.map((u,g)=>Ui({className:o("g-ui-stepper-item",[a,d=>g===d?"g-ui-stepper-active":""])},Ui({className:"g-ui-stepper-index"},String(g+1)),Ui({className:"g-ui-stepper-label"},u.label))))}import{Span as Pr,after as Dr,state as es}from"granular";function rs(...i){let{props:e,rawProps:a}=n(i,{value:0,max:5,size:"md"}),{value:r,max:t,size:s,className:u,...g}=e,{onChange:d}=a,f=es(m(r));Dr(r).change(c=>{let w=m(c);w!=null&&f.set(w)});let l=c=>{f.set(c),d?.(c)},y=[],p=Number(m(t))||0;for(let c=1;c<=p;c+=1)y.push(c);return Pr({...g,className:o("g-ui-rating",h("g-ui-rating-size-",s,"md"),e.className??u)},y.map(c=>Pr({className:o("g-ui-rating-item",Dr(f).compute(w=>c<=w?"g-ui-rating-item-active":"")),onClick:()=>l(c)},"\u2605")))}import{Span as ts}from"granular";function as(...i){let{props:e,children:a}=n(i),{className:r,...t}=e;return ts({...t,className:o("g-ui-tag",r)},a)}import{Button as Vr,Div as hi,state as Mr,after as Wi}from"granular";var os=["S","M","T","W","T","F","S"];function Ni(...i){let{props:e,rawProps:a}=n(i,{size:"md"}),{value:r,className:t,size:s,...u}=e,{onChange:g}=a,d=L=>{let z=m(L);if(z instanceof Date)return z;if(z==null)return null;let C=new Date(z);return Number.isNaN(C.getTime())?null:C},f=Mr(d(r)??new Date),l=Mr(new Date(f.get()));Wi(r).change(L=>{let z=d(L);z!=null&&(f.set(z),l.set(new Date(z)))});let y=(L,z,C)=>{let x=new Date(L,z+1,0).getDate();return new Date(L,z,Math.min(C,x))},p=L=>{let z=l.get(),C=y(z.getFullYear(),z.getMonth(),L);f.set(C),l.set(C),g?.(C)},c=L=>{let z=l.get(),C=y(z.getFullYear(),z.getMonth()+L,z.getDate());l.set(C)},w=L=>{let z=l.get(),C=y(z.getFullYear()+L,z.getMonth(),z.getDate());l.set(C)},k=Wi(l).compute(L=>L.toLocaleString("default",{month:"long"})),B=Wi(l).compute(L=>String(L.getFullYear())),P=Wi(l,f).compute(([L,z])=>{let C=L.getFullYear(),x=L.getMonth(),b=new Date(C,x,1).getDay(),v=new Date(C,x+1,0).getDate(),M=[];for(let $=0;$<b;$+=1)M.push({muted:!0,label:""});for(let $=1;$<=v;$+=1)M.push({label:$});return[...os.map($=>hi({className:"g-ui-calendar-cell g-ui-calendar-cell-muted"},$)),...M.map($=>hi({className:o("g-ui-calendar-cell",$.muted&&"g-ui-calendar-cell-muted",$.label&&z.getFullYear()===C&&z.getMonth()===x&&$.label===z.getDate()&&"g-ui-calendar-cell-active"),onClick:()=>$.label&&p($.label)},$.label))]});return hi({...u,className:o("g-ui-calendar",t,h("g-ui-calendar-size-",s,"md"))},hi({className:"g-ui-calendar-header"},Gi({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>c(-1)},Oi({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:rr})),hi({className:"g-ui-calendar-title-group"},Vr({type:"button",className:"g-ui-calendar-title-button",onClick:()=>c(1)},k),Vr({type:"button",className:"g-ui-calendar-title-button",onClick:()=>w(1)},B)),Gi({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>c(1)},Oi({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:er}))),hi({className:"g-ui-calendar-grid"},P))}import{Div as Ci,Span as xi,Input as ss,when as Pe,after as ii,state as qi}from"granular";function ns(...i){let{props:e,rawProps:a}=n(i,{data:[],size:"md",searchable:!0}),{value:r,data:t,size:s,className:u,placeholder:g,searchable:d,...f}=e,{onChange:l,onSearchChange:y}=a,p=qi(m(r)??[]),c=qi(""),w=qi(!1),k=qi(null),B=b=>(m(b)??[]).map(M=>typeof M=="string"?{value:M,label:M}:M&&typeof M=="object"?M:{value:String(M),label:String(M)});ii(r).change(b=>{let v=m(b);v!=null&&p.set(v)});let P=null;ii(w).change(b=>{if(P&&(P(),P=null),!b)return;let v=M=>{let $=k.get();$&&($.contains(M.target)||w.set(!1))};document.addEventListener("mousedown",v),P=()=>document.removeEventListener("mousedown",v)}),ii(c).change(b=>{y?.(b)});let L=b=>{let v=p.get()??[],M=v.includes(b)?v.filter($=>$!==b):v.concat(b);p.set(M),l?.(M)},z=ii(t).compute(b=>B(b)),C=ii(z,c).compute(([b,v])=>{let M=String(m(v)??"").toLowerCase().trim();return M?b.filter($=>String($.label??"").toLowerCase().includes(M)):b}),x=ii(p,c).compute(([b,v])=>{let M=m(b)??[],$=String(m(v)??"");return!M.length&&!$}),V=ii(d).compute(b=>!!b);return Ci({...f,node:k,className:o("g-ui-select-multi-root",u)},Ci({className:o("g-ui-select-multi",h("g-ui-select-multi-size-",s,"md")),onClick:()=>w.set(!0)},ii(z,p).compute(([b,v])=>(m(v)??[]).map($=>{let Y=(b??[]).find(X=>X.value===$)?.label??$;return xi({className:"g-ui-select-tag"},xi({className:"g-ui-select-tag-label",onClick:X=>{X?.stopPropagation?.()}},Y),xi({className:"g-ui-select-tag-remove",innerHTML:di,onClick:X=>{X?.stopPropagation?.(),L($)}}))})),Pe(x,()=>xi({className:"g-ui-select-multi-placeholder"},g??"Select...")),Pe(V,()=>ss({className:"g-ui-select-multi-input",value:c,onInput:b=>c.set(b.target?.value??""),onFocus:()=>w.set(!0)}))),Pe(w,()=>Ci({className:"g-ui-select-dropdown"},ii(C).compute(b=>b.length?b.map(v=>Ci({className:o("g-ui-select-item",v.disabled&&"g-ui-select-item-disabled",ii(p).compute(M=>(m(M)??[]).includes(v.value)?"g-ui-select-item-active":"")),onClick:()=>{v.disabled||L(v.value)}},xi({className:"g-ui-select-item-check",innerHTML:ii(p).compute(M=>(m(M)??[]).includes(v.value)?Ti:"")}),xi({className:"g-ui-select-item-label"},v.label))):Ci({className:"g-ui-select-item"},"Nothing found")))))}import{Div as Si,when as Lr}from"granular";function us(...i){let{props:e}=n(i,{items:[]}),{items:a,className:r,onClose:t,timeout:s,...u}=e;return Si({...u,className:o("g-ui-toast-stack",r)},a.map(g=>Si({className:o("g-ui-toast",[s,"g-ui-toast-auto"])},Si({className:"g-ui-toast-row"},Lr(g.title,()=>Si({className:"g-ui-toast-title"},g.title)),Lr(t,()=>Si({className:"g-ui-toast-close",onClick:()=>t(g)},"\xD7"))),g.message)))}function gs(...i){let{props:e}=n(i);return Ni(e)}import{Div as ls,after as cs}from"granular";function ps(...i){let{props:e,rawProps:a}=n(i,{items:[],position:"top-right"}),{items:r,position:t,className:s,...u}=e,{onRemove:g}=a,d=new Map,f=(y,p)=>y?.id??y?.key??p,l=cs(r).compute(y=>{let p=m(y)??[],c=new Set;p.forEach((w,k)=>{let B=f(w,k);if(c.add(B),w?.autoClose&&!d.has(B)){let P=setTimeout(()=>{d.delete(B),g?.(w)},w.autoClose);d.set(B,P)}});for(let[w,k]of d.entries())c.has(w)||(clearTimeout(k),d.delete(w));return p.map((w,k)=>fe({key:f(w,k),title:w.title,color:w.color,icon:w.icon,loading:w.loading,withCloseButton:w.withCloseButton,withBorder:w.withBorder,onClose:()=>{w.onClose?.(),g?.(w)}},w.message??w.body??w.content??w.text))});return ls({...u,className:o("g-ui-notifications",h("g-ui-notifications-position-",t,"top-right"),s)},l)}import{Div as bi,after as Pi,state as ds,when as ms}from"granular";function fs(...i){let{props:e,rawProps:a}=n(i,{min:0,max:100,step:1,size:"md"}),{value:r,marks:t,min:s,max:u,step:g,size:d,disabled:f,className:l,...y}=e,{onChange:p}=a,c=ds(m(r??[s,u])),w=()=>{let x=Number(m(s)),V=Number(m(u));return!Number.isFinite(x)||!Number.isFinite(V)?{minValue:0,maxValue:100}:{minValue:Math.min(x,V),maxValue:Math.max(x,V)}},k=()=>{let x=Number(m(g));return Number.isFinite(x)&&x>0?x:1},B=x=>{let{minValue:V,maxValue:b}=w(),v=k(),M=[V,b];Array.isArray(x)&&(M=x);let $=Math.max(V,Math.min(b,Number(M[0]))),G=Math.max(V,Math.min(b,Number(M[1]))),Y=Math.round(Math.min($,G)/v)*v,X=Math.round(Math.max($,G)/v)*v;return[Y,X]};Pi(r).change(x=>{x!=null&&c.set(B(x))});let P=x=>{let V=B(x);V?.[0]===c.get()?.[0]&&V?.[1]===c.get()?.[1]||(c.set(V),p?.(V))},L=Pi(c).compute(x=>{let{minValue:V,maxValue:b}=w(),v=b-V,[M,$]=B(x);if(v<=0)return{lowPct:0,highPct:0};let G=(M-V)/v*100,Y=($-V)/v*100;return{lowPct:Math.max(0,Math.min(100,G)),highPct:Math.max(0,Math.min(100,Y))}}),z=(x,V,b)=>{let v=V?.();if(!v||v.width===0)return;let $=Math.min(Math.max(x.clientX-v.left,0),v.width)/v.width,{minValue:G,maxValue:Y}=w(),X=G+$*(Y-G),_=c;typeof c.get=="function"&&(_=c.get());let[K,ri]=B(_);P(b==="low"?[X,ri]:[K,X])},C=(x,V,b)=>{if(J(f))return;x.preventDefault?.();let v=b||x.currentTarget,M=()=>v.getBoundingClientRect(),$=M(),G=L;typeof L.get=="function"&&(G=L.get());let{lowPct:Y,highPct:X}=G,_=(x.clientX-$.left)/$.width*100,K=V;if(!K){let oi=Math.abs(_-Y)<=Math.abs(_-X);K="high",oi&&(K="low")}v.setPointerCapture?.(x.pointerId),z(x,M,K);let ri=oi=>z(oi,M,K),ci=()=>{v.releasePointerCapture?.(x.pointerId),window.removeEventListener("pointermove",ri),window.removeEventListener("pointerup",ci)};window.addEventListener("pointermove",ri),window.addEventListener("pointerup",ci)};return bi({...y,className:o("g-ui-range-slider",h("g-ui-slider-size-",d,"md"),j("g-ui-slider-disabled",f),e.className??l)},bi({className:"g-ui-slider-track",onPointerDown:x=>C(x)},bi({className:"g-ui-slider-bar",style:Pi(L).compute(({lowPct:x,highPct:V})=>({left:`${x}%`,width:`${Math.max(0,V-x)}%`}))}),bi({className:"g-ui-slider-thumb",style:Pi(L).compute(({lowPct:x})=>({left:`${x}%`})),onPointerDown:x=>{x.stopPropagation?.(),C(x,"low",x.currentTarget.parentElement)}}),bi({className:"g-ui-slider-thumb",style:Pi(L).compute(({highPct:x})=>({left:`${x}%`})),onPointerDown:x=>{x.stopPropagation?.(),C(x,"high",x.currentTarget.parentElement)}})),ms(t,()=>bi({className:"g-ui-slider-marks"},t.map(x=>ye({mark:x,getBounds:w})))))}import{Div as hs,Input as xs,Span as Ir,when as Br,state as De,after as $r}from"granular";function bs(...i){let{props:e,rawProps:a}=n(i,{size:"md",format:{pattern:"dddd-dd-dd"}}),{value:r,size:t,calendarSize:s,leftSection:u,rightSection:g,className:d,inputProps:f,format:l,minDate:y,maxDate:p,...c}=e,{onChange:w}=a,k=b=>{let v=m(b);if(v instanceof Date)return v;if(v==null||v==="")return null;let M=new Date(v);return Number.isNaN(M.getTime())?null:M},B=(b,v)=>b&&v&&b.getFullYear()===v.getFullYear()&&b.getMonth()===v.getMonth()&&b.getDate()===v.getDate(),P=b=>{if(!b)return"";let v=String(b.getFullYear()).padStart(4,"0"),M=String(b.getMonth()+1).padStart(2,"0"),$=String(b.getDate()).padStart(2,"0");return`${v}-${M}-${$}`},L=b=>{let v=String(b??"").replace(/\D/g,"");if(v.length<8)return null;let M=Number(v.slice(0,4)),$=Number(v.slice(4,6)),G=Number(v.slice(6,8));if(!M||!$||!G)return null;let Y=new Date(M,$-1,G);if(Y.getFullYear()!==M||Y.getMonth()!==$-1||Y.getDate()!==G)return null;let X=k(y);if(X&&Y<X)return null;let _=k(p);return _&&Y>_?null:Y},z=De(k(r)),C=De(P(z.get())),x=De(!1);$r(r).change(b=>{let v=k(b);if(v==null){z.set(null),C.set("");return}z.set(v),C.set(P(v))}),$r(C).change(b=>{let v=L(b);v&&(B(v,z.get())||(z.set(v),w?.(v)))});let V=b=>{b&&(B(b,z.get())||(z.set(b),C.set(P(b)),w?.(b),x.set(!1)))};return Ce({opened:x,onChange:b=>x.set(!!b),content:Ni({size:h("",s,"xs"),value:z,onChange:V}),className:"g-ui-date-input-popover"},hs({className:o("g-ui-dateinput","g-ui-input-wrapper",h("g-ui-input-size-",t,"md"),d)},Br(u,()=>Ir({className:"g-ui-input-section"},u)),xs({type:"text",inputMode:"numeric",format:l,value:C,...c,className:o("g-ui-input",f?.className),onInput:b=>{f?.onInput?.(b)}}),Br(g,()=>Ir({className:"g-ui-input-section"},g))))}import{Div as Ve,when as vs,after as ws,state as ys}from"granular";function zs(...i){let{props:e,rawProps:a,children:r}=n(i),{opened:t,content:s,className:u,...g}=e,{onChange:d}=a,f=ys(m(t)??!1);ws(t).change(y=>{let p=m(y);p!=null&&f.set(!!p)});let l=y=>{f.set(y),d?.(y)};return Ve({...g,className:o("g-ui-popper",u)},Ve({onClick:()=>l(!f.get())},r),vs(f,()=>Ve({className:"g-ui-popper-dropdown"},s)))}import{Div as ks,Input as Ns,Button as Cs,after as Ss,when as Ps}from"granular";import{state as Ds}from"granular";function Vs(...i){let{props:e}=n(i,{size:"md"}),{size:a,className:r,...t}=e,s=Ds(!1),u=Ss(s).compute(g=>g?"text":"password");return ks({className:o("g-ui-input-wrapper",h("g-ui-input-size-",a,"md"),r)},Ns({type:u,...t,className:"g-ui-input"}),Cs({className:"g-ui-password-toggle",onClick:()=>s.set(!s.get())},Ps(s,()=>"Hide",()=>"Show")))}import{Div as Tr,Input as Ms}from"granular";function Ls(...i){let{props:e}=n(i,{size:"md"}),{size:a,className:r,...t}=e;return Tr({className:o("g-ui-input-wrapper",h("g-ui-input-size-",a,"md"),r)},Tr({className:"g-ui-input-section"},"\u{1F50E}"),Ms({type:"text",inputMode:"search",...t,className:"g-ui-input"}))}import{Button as Is,after as Bs,when as Fr}from"granular";import{state as $s}from"granular";function Ts(...i){let{props:e,children:a}=n(i,{value:"",timeout:1500}),{value:r,timeout:t,className:s,...u}=e,g=$s(!1),d=Bs(g).compute(l=>o("g-ui-copy-button",l&&"g-ui-copy-button-done",s));return Is({...u,className:d,onClick:async()=>{try{await navigator.clipboard.writeText(String(r)),g.set(!0),setTimeout(()=>g.set(!1),t)}catch{}},type:"button"},Fr(a?.length,()=>a,()=>Fr(g,()=>"Copied",()=>"Copy")))}import{Div as Fs}from"granular";function As(...i){let{props:e}=n(i,{size:"md"}),{size:a,className:r,...t}=e;return Fs({...t,className:o("g-ui-progress-ring",[a,s=>`g-ui-progress-ring-size-${s}`],r)})}import{Div as Me,Button as js,when as Ar}from"granular";function Rs(...i){let{props:e,children:a}=n(i),{title:r,onClose:t,className:s,...u}=e;return Me({...u,className:o("g-ui-toast",s)},Me({className:"g-ui-toast-row"},Ar(r,()=>Me({className:"g-ui-toast-title"},r)),Ar(t,()=>js({className:"g-ui-toast-close",onClick:t},"\xD7"))),a)}import{Div as Le,Input as Es}from"granular";import{state as Os}from"granular";function Hs(...i){let{props:e,rawProps:a}=n(i,{data:[]}),{data:r,className:t,...s}=e,{onChange:u}=a,g=Os(""),d=r.filter(f=>String(f.label||"").toLowerCase().includes(String(g.get()).toLowerCase()));return Le({...s,className:o("g-ui-select-search",t)},Es({className:"g-ui-select-search-input",placeholder:"Search...",value:g}),Le({className:"g-ui-select-search-list"},d.map(f=>Le({className:"g-ui-select-search-item",onClick:()=>u?.(f.value)},f.label))))}import{Div as Ys}from"granular";function Gs(...i){let{props:e,children:a}=n(i),{className:r,...t}=e;return Ys({...t,className:o("g-ui-switch-group",r)},a)}import{Div as Ie,Input as jr,state as Xs,after as Be}from"granular";function Us(...i){let{props:e,rawProps:a}=n(i,{size:"md"}),{value:r,size:t,className:s,...u}=e,{onChange:g}=a,d=Xs(m(r)??["",""]);Be(r).change(l=>{let y=m(l);y!=null&&d.set(y)});let f=l=>{d.set(l),g?.(l)};return Ie({...u,className:o("g-ui-range-picker",e.className??s)},Ie({className:o("g-ui-input-wrapper",h("g-ui-input-size-",t,"md"))},jr({type:"text",inputMode:"numeric",className:"g-ui-input",value:Be(d).compute(l=>l?.[0]??""),onInput:l=>{let y=d.get()??["",""];f([l.target.value,y[1]])}})),Ie({className:o("g-ui-input-wrapper",h("g-ui-input-size-",t,"md"))},jr({type:"text",inputMode:"numeric",className:"g-ui-input",value:Be(d).compute(l=>l?.[1]??""),onInput:l=>{let y=d.get()??["",""];f([y[0],l.target.value])}})))}import{Div as Ws}from"granular";function qs(...i){let{props:e,children:a}=n(i,{direction:"row"}),{direction:r,wrap:t,align:s,justify:u,gap:g,className:d,...f}=e;return Ws({...f,className:o("g-ui-flex",[r,l=>l==="column"?"g-ui-flex-column":"g-ui-flex-row"],[t,"g-ui-flex-wrap"],[s,l=>l&&`g-ui-align-${l}`],[u,l=>l&&`g-ui-justify-${l}`],[g,l=>l&&`g-ui-gap-${l}`],d)},a)}import{A as _s,Div as Di,Span as Rr,when as Vi,after as Er,state as Ks}from"granular";function Zs(...i){let{props:e,rawProps:a,children:r}=n(i,{variant:"subtle",childrenOffset:24}),{label:t,description:s,leftSection:u,rightSection:g,active:d,disabled:f,variant:l,childrenOffset:y,opened:p,defaultOpened:c,className:w,...k}=e,{onClick:B,onChange:P}=a,L=r.length>0,z=Ks(m(p)??m(c)??!1);Er(p).change(V=>{let b=m(V);b!=null&&z.set(!!b)});let C=Er(y).compute(V=>({paddingLeft:Ke(m(V??24))??"24px"})),x=V=>{if(m(f)){V?.preventDefault?.();return}if(L){let b=!z.get();z.set(b),P?.(b)}B?.(V)};return Di({className:o("g-ui-navlink-root",w)},_s({...k,className:o("g-ui-navlink",h("g-ui-navlink-variant-",l,"subtle"),j("g-ui-navlink-active",d),j("g-ui-navlink-disabled",f)),onClick:x},Vi(u,()=>Rr({className:"g-ui-navlink-section g-ui-navlink-left"},u)),Di({className:"g-ui-navlink-body"},Vi(t,()=>Di({className:"g-ui-navlink-label"},t)),Vi(s,()=>Di({className:"g-ui-navlink-description"},s))),Vi(g,()=>Rr({className:"g-ui-navlink-section g-ui-navlink-right"},g))),L?Vi(z,()=>Di({className:"g-ui-navlink-children",style:C},r)):null)}import{Div as Or,when as Js}from"granular";function Qs(...i){let{props:e,children:a}=n(i,{show:!0,position:"top-right",color:"danger",size:"md"}),{show:r,position:t,color:s,size:u,className:g,...d}=e;return Or({...d,className:o("g-ui-indicator",h("g-ui-indicator-position-",t,"top-right"),h("g-ui-indicator-color-",s,"danger"),h("g-ui-indicator-size-",u,"md"),g)},a,Js(r,()=>Or({className:"g-ui-indicator-badge"})))}import{Span as _i}from"granular";function en(...i){let{props:e}=n(i),{opened:a,className:r,...t}=e;return _i({...t,className:o("g-ui-burger",[a,"g-ui-burger-open"],r)},_i(""),_i(""),_i(""))}import{Div as rn,when as tn}from"granular";function an(...i){let{props:e}=n(i),{visible:a,...r}=e;return tn(a,()=>rn({...r,className:"g-ui-loading-overlay"},yi({})))}import{Div as on}from"granular";function sn(...i){let{props:e,children:a}=n(i,{gap:"md"}),{className:r,gap:t,...s}=e;return on({...s,className:o("g-ui-grid-system",[t,u=>`g-ui-gap-${u}`],r)},a)}import{Div as nn}from"granular";function un(...i){let{props:e,children:a}=n(i,{span:12}),{span:r,className:t,...s}=e;return nn({...s,className:o([r,u=>`g-ui-col-span-${u}`],t)},a)}import{Div as gn}from"granular";function ln(...i){let{props:e,children:a}=n(i,{size:"md"}),{size:r,className:t,...s}=e;return gn({...s,className:o("g-ui-scroll-area",[r,u=>`g-ui-scroll-area-${u}`],t)},a)}import{Div as Hr,Input as cn,after as ai,state as $e,when as Yr}from"granular";function pn(...i){let{props:e,rawProps:a}=n(i,{length:4,size:"md",type:"alphanumeric",mask:!1,placeholder:"\u25CB",disabled:!1,error:!1,oneTimeCode:!1}),{length:r,value:t,size:s,type:u,mask:g,placeholder:d,disabled:f,error:l,oneTimeCode:y,className:p,...c}=e,{onChange:w,onComplete:k}=a,B=$e(m(r)??4),P=()=>B.get();ai(r).change(N=>{let T=m(N)??4,F=B.get();if(T===F)return;B.set(T);let U=z.get(),ei=L.get();z.set(Array.from({length:T},(q,ti)=>U[ti]??"")),L.set(Array.from({length:T},(q,ti)=>ei[ti]??null))});let L=$e(Array.from({length:P()},()=>null)),z=$e(Array.from({length:P()},(N,T)=>{let F=m(t);return typeof F=="string"||Array.isArray(F)?F[T]??"":""}));ai(t).change(N=>{if(N==null)return;let T=P();typeof N=="string"?z.set(Array.from({length:T},(F,U)=>N[U]??"")):Array.isArray(N)&&z.set(Array.from({length:T},(F,U)=>N[U]??""))});let C=()=>z.get().join(""),x=N=>{z.set(N);let T=N.join("");w?.(T),N.every(F=>F!=="")&&N.length===P()&&k?.(T)},V=N=>{let T=P(),F=L.get();N>=0&&N<T&&F[N]&&(F[N].focus(),F[N].select())},b=()=>{let N=m(u);return N==="number"?/^[0-9]$/:N instanceof RegExp?N:/^[a-zA-Z0-9]$/},v=(N,T)=>{let F=T.target.value,U=b();if(F.length>1){M(N,F);return}if(F&&!U.test(F)){T.target.value=z.get()[N]??"";return}let ei=z.get().slice();ei[N]=F,x(ei),F&&N<P()-1&&V(N+1)},M=(N,T)=>{let F=b(),U=T.split("").filter(Q=>F.test(Q)),ei=z.get().slice(),q=P();U.forEach((Q,si)=>{let Mi=N+si;Mi<q&&(ei[Mi]=Q)}),x(ei);let ti=ei.findIndex((Q,si)=>si>=N&&Q==="");ti>=0?V(ti):V(Math.min(N+U.length,q-1))},$=(N,T)=>{if(T.key==="Backspace"){let F=z.get().slice();F[N]===""&&N>0?(T.preventDefault(),F[N-1]="",x(F),V(N-1)):F[N]!==""&&(F[N]="",x(F))}else T.key==="ArrowLeft"&&N>0?(T.preventDefault(),V(N-1)):T.key==="ArrowRight"&&N<P()-1&&(T.preventDefault(),V(N+1))},G=(N,T)=>{T.target.select()},Y=()=>{let N=z.get(),T=N.findIndex(F=>F==="");T>=0?V(T):V(N.length-1)},X=ai(g).compute(N=>m(N)?"password":"text"),_=ai(u).compute(N=>m(N)==="number"?"numeric":"text"),K=ai(y).compute(N=>m(N)?"one-time-code":"off"),ri=ai(f).compute(N=>!!m(N)),ci=ai(l).compute(N=>!!m(N)),oi=ai(B).compute(N=>Array.from({length:N},(T,F)=>F)),Ki=N=>cn({className:o("g-ui-pin-input-field",Yr(ci,()=>"g-ui-pin-input-error")),type:X,inputMode:_,autocomplete:K,maxLength:2,placeholder:Yr(ri,()=>"",()=>d),disabled:ri,value:ai(z).compute(()=>z.get()[N]??""),node:L[N],onInput:T=>v(N,T),onKeyDown:T=>$(N,T),onFocus:T=>G(N,T)});return Hr({...c,className:o("g-ui-pin-input",h("g-ui-input-size-",s,"md"),p),onClick:Y},Hr({className:"g-ui-pin-input-wrapper"},oi.map(Ki)))}import{Div as dn}from"granular";function mn(...i){let{props:e,children:a}=n(i),{className:r,...t}=e;return dn({...t,className:o("g-ui-checkbox-group",r)},a)}import{Div as fn}from"granular";function hn(...i){let{props:e,children:a}=n(i),{className:r,...t}=e;return fn({...t,className:o("g-ui-avatar-group",r)},a)}import{Div as xn}from"granular";function bn(...i){let{props:e,children:a}=n(i),{className:r,...t}=e;return xn({...t,className:o("g-ui-badge-group",r)},a)}import{state as vn}from"granular";function wn(i=!1){let e=vn(!!i);return[e,{open:()=>e.set(!0),close:()=>e.set(!1),toggle:()=>e.set(!e.get())}]}Ge();export{xa as Accordion,Gi as ActionIcon,Ho as Affix,$a as Alert,eo as Anchor,qo as AppBar,ja as Avatar,hn as AvatarGroup,$t as Badge,bn as BadgeGroup,Ga as Blockquote,Do as Breadcrumbs,en as Burger,ee as Button,Ni as Calendar,It as Card,Mo as Center,Zt as Checkbox,mn as CheckboxGroup,mo as Chip,Ha as Code,un as Col,To as Collapse,St as Container,Ts as CopyButton,bs as DateInput,gs as DatePicker,Va as Divider,Ca as Drawer,Uo as Fieldset,qs as Flex,sn as Grid,Mt as Group,Eo as HoverCard,Oi as Icon,to as Image,Qs as Indicator,Ea as Kbd,xr as List,yi as Loading,an as LoadingOverlay,za as Menu,Ut as Modal,ns as MultiSelect,Zs as NavLink,fe as Notification,ps as Notifications,oe as NumberField,Ht as NumberInput,vo as Pagination,La as Paper,Vs as PasswordInput,pn as PinInput,Ce as Popover,zs as Popper,oo as Progress,As as ProgressRing,ko as Radio,Co as RadioGroup,Us as RangePicker,fs as RangeSlider,rs as Rating,ln as ScrollArea,Ls as SearchInput,ho as SegmentedControl,ta as Select,Hs as SelectSearch,Ko as Sidebar,Ua as SimpleGrid,lo as Skeleton,uo as Slider,Io as Space,Dt as Stack,is as Stepper,ra as Switch,Gs as SwitchGroup,da as Table,ua as Tabs,as as Tag,re as Text,At as TextInput,Rt as Textarea,Qo as Timeline,Nt as Title,Rs as Toast,us as ToastStack,ba as Tooltip,o as cx,dt as setThemeMode,pt as setThemeVars,wn as useDisclosure};
