var Mr="granular-ui-styles",Ut=new URL("./fonts/Poppins-400.ttf",import.meta.url).href,Xt=new URL("./fonts/Poppins-500.ttf",import.meta.url).href,_t=new URL("./fonts/Poppins-600.ttf",import.meta.url).href,Kt=new URL("./fonts/Poppins-700.ttf",import.meta.url).href,Qt=new URL("./fonts/Arimo-400.ttf",import.meta.url).href,Jt=new URL("./fonts/Arimo-500.ttf",import.meta.url).href,ea=new URL("./fonts/Arimo-600.ttf",import.meta.url).href,ia=new URL("./fonts/Arimo-700.ttf",import.meta.url).href,ra=new URL("./fonts/Inter-400.woff2",import.meta.url).href,ta=new URL("./fonts/Inter-500.woff2",import.meta.url).href,aa=new URL("./fonts/Inter-600.woff2",import.meta.url).href,oa=new URL("./fonts/Inter-700.woff2",import.meta.url).href,na=`
@font-face {
  font-family: 'Poppins';
  font-style: normal;
  font-weight: 400;
...
`;function Tr(){if(typeof document>"u"||document.getElementById(Mr))return;let e=document.createElement("style");e.id=Mr,e.textContent=na,document.head.appendChild(e)}var sa=new Set(["--g-ui-bg","--g-ui-bg-subtle","--g-ui-bg-muted","--g-ui-bg-emphasized","--g-ui-bg-inverted","--g-ui-bg-panel","--g-ui-fg","--g-ui-fg-muted","--g-ui-fg-subtle","--g-ui-fg-inverted","--g-ui-border","--g-ui-border-subtle","--g-ui-border-emphasized","--g-ui-border-inverted","--g-ui-primary","--g-ui-primary-hover","--g-ui-primary-active","--g-ui-primary-subtle","--g-ui-primary-muted","--g-ui-primary-emphasized","--g-ui-success","--g-ui-success-hover","--g-ui-success-active","--g-ui-success-subtle","--g-ui-success-muted","--g-ui-danger","--g-ui-danger-hover","--g-ui-danger-active","--g-ui-danger-subtle","--g-ui-danger-muted","--g-ui-warning","--g-ui-warning-hover","--g-ui-warning-active","--g-ui-warning-subtle","--g-ui-warning-muted","--g-ui-info","--g-ui-info-hover","--g-ui-info-active","--g-ui-info-subtle","--g-ui-info-muted","--g-ui-shadow-xs","--g-ui-shadow-sm","--g-ui-shadow-md","--g-ui-shadow-lg","--g-ui-shadow-xl","--g-ui-shadow-2xl","--g-ui-radius","--g-ui-font","--g-ui-surface","--g-ui-text","--g-ui-muted","--g-ui-primary-strong","--g-ui-shadow"]);function ua(e={},i=document?.documentElement){if(i)for(let[r,t]of Object.entries(e)){let a=r.startsWith("--")?r:`--g-ui-${r}`;sa.has(a)&&i.style.setProperty(a,String(t))}}function ga(e="dark",i=document?.documentElement){i&&(i.classList.remove("g-ui-theme-dark","g-ui-theme-light"),i.classList.add(e==="light"?"g-ui-theme-light":"g-ui-theme-dark"))}function la(e=document?.documentElement){return e.classList.contains("g-ui-theme-light")?"light":"dark"}import{Renderer as Vr,isSignal as Lr,isState as Ir,isStatePath as $r,isComputed as Ar,resolve as $e,computed as ca,after as Hi,concat as pa}from"@granularjs/core";function Oi(e){return Lr(e)||Ir(e)||$r(e)||Ar(e)}function o(...e){return pa(...e,{separator:" ",filterFalsy:!0})}function Br(e){if(!(e==null||e===""))return typeof e=="number"?`${e}px`:e}function s(e,i){let r={},t=[],a=n=>!!n&&typeof n=="object"&&!Array.isArray(n)&&!Vr.isRenderable(n)&&!Vr.isDomNode(n)&&!Lr(n)&&!Ir(n)&&!$r(n)&&!Ar(n);for(let n of e)a(n)?Object.assign(r,n):t.push(n);if(i&&typeof i=="object")for(let n of Object.keys(i))r[n]===void 0&&(r[n]=i[n]);return{props:ca(r),rawProps:r,children:t}}function l(e){return $e(e)}function xe(e){return!!$e(e)}function N(e,i,r){let t=a=>{let n=$e(a),u=n==null||n===""?r:n;return u==null||u===""?"":`${e}${u}`};return Oi(i)?Hi(i).compute(a=>t(a)):t(i)}function W(e,i){return Oi(i)?Hi(i).compute(r=>$e(r)?e:""):$e(i)?e:""}function me(e,i,r){let t=a=>i[a]||null;return Oi(e)?Hi(e).compute(a=>t($e(a??r))):t($e(e??r))}import{Button as da,Span as Yi,when as qi,after as ma}from"@granularjs/core";function Wi(...e){let{props:i,children:r}=s(e,{variant:"filled",size:"md",justify:"center"}),{variant:t,color:a,size:n,fullWidth:u,loading:g,leftSection:m,rightSection:b,className:w,disabled:k,justify:f,...c}=i,y=ma(k,g).compute(([z,B])=>z||B);return da({...c,disabled:y,className:o("g-ui-button",N("g-ui-button-variant-",t,"filled"),N("g-ui-button-color-",a,"primary"),N("g-ui-justify-",f,"center"),N("g-ui-button-size-",n,"md"),W("g-ui-button-full",u),W("g-ui-button-loading",g),w)},qi(m,()=>Yi({className:"g-ui-button-section-left"},m)),qi(g,()=>Yi("Loading..."),()=>r),qi(b,()=>Yi({className:"g-ui-button-section-right"},b)))}import{Span as fa}from"@granularjs/core";function Zi(...e){let{props:i,children:r}=s(e,{size:"md"}),{size:t,weight:a,color:n,dimmed:u,align:g,ellipsis:m,decoration:b,className:w,style:k,...f}=i,c=me(a,{bold:"g-ui-text-weight-700",semibold:"g-ui-text-weight-600",medium:"g-ui-text-weight-500",700:"g-ui-text-weight-700",600:"g-ui-text-weight-600",500:"g-ui-text-weight-500",400:"g-ui-text-weight-400"}),y=me(n,{primary:"g-ui-text-primary",success:"g-ui-text-success",danger:"g-ui-text-danger",muted:"g-ui-text-dimmed"}),z=me(g,{center:"g-ui-text-align-center",right:"g-ui-text-align-right",left:"g-ui-text-align-left"}),B=me(b,{underline:"g-ui-text-decoration-underline","line-through":"g-ui-text-decoration-line-through",overline:"g-ui-text-decoration-overline",none:"g-ui-text-decoration-none"});return fa({...f,style:k,className:o("g-ui-text",N("g-ui-text-size-",t,"md"),W("g-ui-text-dimmed",u),W("g-ui-text-ellipsis",m),c,y,z,B,w)},r)}import{H1 as va,H2 as Fr,H3 as ha,H4 as ba,H5 as xa,H6 as wa}from"@granularjs/core";var ya={1:va,2:Fr,3:ha,4:ba,5:xa,6:wa};function ka(...e){let{props:i,children:r}=s(e,{order:2}),{order:t,className:a,style:n,...u}=i,g=l(t)||2;return(ya[g]||Fr)({...u,className:o("g-ui-title",N("g-ui-title-order-",t,2),a)},r)}import{Div as za}from"@granularjs/core";function Na(...e){let{props:i,children:r}=s(e,{size:"md"}),{size:t,fluid:a,className:n,style:u,...g}=i;return za({...g,style:u,className:o("g-ui-container",W("g-ui-container-fluid",a),N("g-ui-container-size-",t,"md"),n)},r)}import{Div as Ca}from"@granularjs/core";function Sa(...e){let{props:i,children:r}=s(e,{gap:"md"}),{gap:t,align:a,justify:n,className:u,style:g,...m}=i,b=me(n,{between:"g-ui-justify-between",center:"g-ui-justify-center",end:"g-ui-justify-end",start:"g-ui-justify-start"});return Ca({...m,style:g,className:o("g-ui-stack",N("g-ui-gap-",t,"md"),N("g-ui-align-",a),b,u)},r)}import{Div as Da}from"@granularjs/core";function Pa(...e){let{props:i,children:r}=s(e,{gap:"md",align:"center"}),{gap:t,align:a,justify:n,position:u,noWrap:g,className:m,style:b,...w}=i,k=me(u,{apart:"g-ui-justify-between",center:"g-ui-justify-center",right:"g-ui-justify-end",left:"g-ui-justify-start"});return Da({...w,style:b,className:o("g-ui-group",N("g-ui-gap-",t,"md"),N("g-ui-align-",a,"center"),N("g-ui-justify-",n,"none"),k,W("g-ui-no-wrap",g),m)},r)}import{Div as vi,list as Ma,when as Gi,after as jr}from"@granularjs/core";function Ta(...e){let{props:i,children:r}=s(e,{padding:"md",radius:"md",shadow:"none",border:"default"}),{title:t,content:a,actions:n,border:u,padding:g,radius:m,shadow:b,className:w,style:k,...f}=i;return vi({style:k},Gi(t,()=>vi({className:"g-ui-card-title"},t)),Gi(a,()=>vi({className:"g-ui-card-content"},a)),{className:o("g-ui-card",N("g-ui-card-border-",u,"md"),N("g-ui-card-padding-",g,"md"),N("g-ui-card-radius-",m,"md"),N("g-ui-card-shadow-",b,"md"),w),...f},r,Gi(n,()=>vi({className:"g-ui-card-actions"},Ma(n,c=>Wi({className:"g-ui-card-action",onClick:y=>c.get().onClick?.(y),leftSection:c.leftSection,rightSection:c.rightSection,size:jr(c.size).compute(y=>y||"sm"),variant:jr(c.variant).compute(y=>y||"outline"),...c.get().props||{}},c.label)))))}import{Span as Va}from"@granularjs/core";function La(...e){let{props:i,children:r}=s(e,{variant:"filled",size:"md"}),{variant:t,size:a,className:n,dot:u,style:g,...m}=i,b=me(t,{dot:"g-ui-badge-dot"});return Va({...m,className:o("g-ui-badge",N("g-ui-badge-variant-",t,"filled"),N("g-ui-badge-size-",a,"md"),W("g-ui-badge-dot",u),b,n)},r)}import{Div as Ke,Input as Ia,Textarea as $a,Label as Aa,Span as Ba,when as Qe,state as Fa,after as ja,isState as Ea}from"@granularjs/core";function fe(...e){let{props:i,rawProps:r}=s(e,{size:"md"}),{label:t,description:a,error:n,size:u,leftSection:g,rightSection:m,className:b,inputClassName:w,multiline:k,value:f,...c}=i,{value:y,node:z,onChange:B,onInput:M,onFocus:S,onBlur:L,onKeyDown:I,onKeyUp:v,onClick:x}=r,d=Ea(y)&&!B&&!M,C=d?y:Fa(l(f)??"");ja(f).change(ne=>{d||C.set(l(ne)??"")});let T=ne=>{let J=ne?.target?.value??"";J!==f.get()&&(C.set(J),B?.(ne),M?.(ne))},$=xe(k),U=$?$a:Ia,oe=o(w,$&&"g-ui-textarea"),ee=U({...c,node:z,value:C,onInput:T,onChange:T,onFocus:S,onBlur:L,onKeyDown:I,onKeyUp:v,onClick:x,className:o("g-ui-input",oe)});return Ke({className:o("g-ui-text-input",b)},Qe(t,()=>Aa({className:"g-ui-text-input-label"},t)),Qe(a,()=>Ba({className:"g-ui-text-input-description"},a)),Ke({className:o("g-ui-input-wrapper",W("g-ui-input-multiline",k),N("g-ui-input-size-",u,"md"),W("g-ui-input-error",n))},Qe(g,()=>Ke({className:"g-ui-input-section"},g)),ee,Qe(m,()=>Ke({className:"g-ui-input-section"},m))),Qe(n,()=>Ke({className:"g-ui-text-input-error-text"},n)))}function Ui(...e){let{props:i}=s(e,{size:"md"}),{size:r,leftSection:t,rightSection:a,className:n,...u}=i;return fe({...u,size:r,className:n,leftSection:t,rightSection:a,multiline:!0})}import{Div as Er,Span as Rr,after as Ae,state as Ra}from"@granularjs/core";function Xi(...e){let{props:i,rawProps:r}=s(e,{size:"md",step:1,allowDecimal:!0,allowNegative:!0,clampBehavior:"blur",hideControls:!1,decimalSeparator:".",thousandSeparator:"",format:null,prefix:"",suffix:""}),{value:t,min:a,max:n,step:u,size:g,allowDecimal:m,allowNegative:b,decimalSeparator:w,thousandSeparator:k,decimalScale:f,clampBehavior:c,hideControls:y,format:z,locale:B,currency:M,formatOptions:S,prefix:L,suffix:I,leftSection:v,rightSection:x,className:d,onChange:C,onInput:T,...$}=i,{onChange:U,onInput:oe,onBlur:ee,onFocus:ne,onKeyDown:J}=r,se=V=>{U?.(V.target?.value??""),oe?.(V.target?.value??"")},ge=se,re=Ra(""),P=V=>String(V??"").replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),O=()=>{if(!!!l(m))return 0;let D=l(f);if(D!=null&&D!==""&&Number.isFinite(Number(D)))return Math.max(0,Number(D));let H=l(z);return H==="currency"||H==="percent"?2:0},h=V=>{let D=l(w)??".",H=l(k)??"",Y=String(V??"");if(H&&(Y=Y.split(H).join("")),!Y||Y==="-"||Y===D||Y.endsWith(D))return null;let Q=Y.replace(D,"."),X=Number(Q);return Number.isFinite(X)?X:null},F=V=>{let D=l(k)??"";return D?V.replace(/\B(?=(\d{3})+(?!\d))/g,D):V},E=V=>{let D=l(w)??".",H=O(),Y=Number(V);if(!Number.isFinite(Y))return"";let Q=Y<0?"-":"",X=Math.abs(Y),[Z,_=""]=String(X).split("."),ae=F(Z);if(H>0){let he=_.slice(0,H).padEnd(H,"0");return`${Q}${ae}${D}${he}`}return`${Q}${ae}`},G=(V,D)=>{try{let H=l(B),Y=l(M)??"USD",Q=l(S)??{},X=O(),Z=D==="currency"?"currency":"decimal";return new Intl.NumberFormat(H,{style:Z,currency:Y,...X>0?{minimumFractionDigits:X,maximumFractionDigits:X}:{maximumFractionDigits:0},...Q}).format(V)}catch{return E(V)}},K=V=>{let D=V,H=l(a),Y=l(n);return H!=null&&Number.isFinite(Number(H))&&(D=Math.max(D,Number(H))),Y!=null&&Number.isFinite(Number(Y))&&(D=Math.min(D,Number(Y))),!l(b)&&D<0&&(D=0),D},le=()=>{let V=l(I)??"",D=l(z);return!V&&D==="percent"?"%":V},ve=(V,D,H)=>{let Y=l(L)??"",Q=le(),X=String(V??"").replace(/\u00A0/g," "),Z=String(Y??"").replace(/\u00A0/g," "),_=String(Q??"").replace(/\u00A0/g," "),ae=Z&&X.startsWith(Z),he=_&&X.endsWith(_);return`${D??""}${ae?"":Y}${V}${he?"":Q}`},Se=(V,D)=>{let H=O(),Y=l(w)??".",X=String(V??"").replace(/\D/g,"")||"0",Z=H>0?X.padStart(H+1,"0"):X,ae=(H>0?Z.slice(0,-H):Z).replace(/^0+(?=\d)/,"")||"0",he=H>0?Z.slice(-H):"",Ve=H>0?`${ae}${Y}${he}`:ae;return`${D??""}${Ve}`},Ie=V=>{let D=l(L)??"",H=le(),Y=String(V??""),Q=String(D??"").replace(/\u00A0/g," "),X=String(H??"").replace(/\u00A0/g," ");return Q&&Y.replace(/\u00A0/g," ").startsWith(Q)&&(Y=Y.slice(D.length)),X&&Y.replace(/\u00A0/g," ").endsWith(X)&&(Y=Y.slice(0,-H.length)),Y},mi=V=>{let D=!!l(b),H=Ie(V),Y=D&&H.includes("-")?"-":"",Q=H.replace(/\D/g,""),X=Se(Q,Y);if(l(c)==="strict"){let Z=h(X);if(Z!=null){let _=K(Z);X=`${_<0?"-":""}${E(Math.abs(_))}`}}return X},Bi=V=>{if(V==null||V==="")return Se("","");if(typeof V=="number"&&Number.isFinite(V)){let _=l(c)==="strict"?K(V):V;return`${_<0?"-":""}${E(Math.abs(_))}`}let D=Ie(V),H=l(w)??".",Q=!!l(b)&&String(D).includes("-")?"-":"",X=String(D??"").replace(new RegExp(`[^0-9${P(H)}]`,"g"),""),Z=h(`${Q}${X}`);if(Z!=null){let _=l(c)==="strict"?K(Z):Z;return`${_<0?"-":""}${E(Math.abs(_))}`}return mi(V)},Ne,_e=V=>{let D=l(V);if(D===void 0)return;let H=Bi(D);H!==re.get()&&(Ne=H,re.set(H))};_e(t),Ae(t).change(V=>{_e(V)}),Ae(re).change(V=>{if(V===Ne){Ne=void 0;return}Ne=void 0;let D=h(V);if(D==null){se?.(V??"");return}se?.(D)});let Fi=Ae(x).compute(V=>V!=null&&V!==!1),ji=Ae(y,Fi).compute(([V,D])=>!l(V)&&!D),fi=Ae(m).compute(V=>l(V)?"decimal":"numeric"),Ei=Ae(z,L,I,m,b,w,k,f,c,a,n,B,M,S).compute(()=>({mode:"both",format:V=>{let D=mi(V),H=l(z),Q=!!l(b)&&D.startsWith("-")?"-":"",X=h(D),Z=D.replace(Q,"");if(X!=null){let _=Math.abs(X);if(typeof H=="function")try{Z=H(_)}catch{Z=E(_)}else if(H==="currency")Z=G(_,"currency");else if(H==="decimal"){let ae=l(B),he=l(S);Z=ae||he?G(_,"decimal"):E(_)}else Z=E(_)}return{value:D,raw:D,visual:ve(Z,Q,H)}}})),p=V=>{let D=h(re.get()),H=Number(l(u)??1),Q=K((D??0)+H*V);re.set(E(Q))},j=V=>{if(!V||typeof V.setSelectionRange!="function")return;let D=()=>{try{let H=String(V.value??"").length;V.setSelectionRange(H,H)}catch{}};typeof requestAnimationFrame=="function"?requestAnimationFrame(D):D()},ue=V=>{ge?.(V);let D=V?.target;D&&j(D)},q=V=>{if(ee?.(V),l(c)!=="blur")return;let D=h(re.get());if(D==null)return;let H=K(D);re.set(E(H))},te=V=>{ne?.(V),j(V?.target)},de=V=>{J?.(V);let D=V?.target;if(!D)return;let H=l(L)??"",Y=le();Y&&typeof D.selectionEnd=="number"&&(D.selectionEnd=Math.min(D.selectionEnd,String(D.value??"").length-Y.length)),H&&typeof D.selectionStart=="number"&&(D.selectionStart=Math.max(D.selectionStart,H.length))},ie=Er({className:"g-ui-number-field-controls"},Rr({className:"g-ui-number-field-control",onClick:()=>p(1)},"+"),Rr({className:"g-ui-number-field-control",onClick:()=>p(-1)},"\u2212")),Ce=Er({className:"g-ui-number-field-controls-wrapper"},ie),De=Ae(ji,x).compute(([V,D])=>V?Ce:D);return fe({...$,size:g,className:o("g-ui-number-field",d),leftSection:v,rightSection:De,type:"text",inputMode:fi,inputClassName:o("g-ui-input-number"),value:re,format:Ei,onInput:ue,onBlur:q,onFocus:te,onKeyDown:de})}function Ha(...e){return Xi(...e)}import{Div as wi,Button as Oa,portal as Ya,when as _i,after as qa}from"@granularjs/core";var hi='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/></svg>',bi='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M560-240 320-480l240-240 56 56-184 184 184 184-56 56Z"/></svg>',xi='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M379.33-244 154-469.33 201.67-517l177.66 177.67 378.34-378.34L805.33-670l-426 426Z"/></svg>',Hr='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M240-446.67v-66.66h480v66.66H240Z"/></svg>',Ye='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M312-265.33 265.33-312l168-168-168-167L312-693.67l168 168 167-168L693.67-647l-168 167 168 168L647-265.33l-167-168-168 168Z"/></svg>',Or='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>',Yr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>',qr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h357l-80 80H200v560h560v-278l80-80v358q0 33-23.5 56.5T760-120H200Zm280-360v-80h240v80H480Zm0 160v-80h320v80H480Zm0 160v-80h320v80H480ZM360-360v-80h80v80h-80Zm0 160v-80h80v80h-80Zm0 160v-80h80v80h-80Zm160-320h280l-36-37 37-37v74H520Zm-160 0h80v-80h-80v80ZM120-600v-160l160-160h160l-80 80H200v240h-80Zm80-240v-80 80Z"/></svg>',Wr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>',Zr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80H200Zm0-80h560v-400H200v400Z"/></svg>',Gr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z"/></svg>';function Je(...e){let{props:i,rawProps:r,children:t}=s(e,{size:"md",centered:!0,overlay:"normal"}),{opened:a,title:n,size:u,centered:g,overlay:m,position:b,className:w,style:k}=i,{onClose:f}=r,c=qa(b,g).compute(([y,z])=>`g-ui-modal-position-${y??(z===!1?"top-center":"center")}`);return _i(a,()=>Ya(wi({className:o("g-ui-modal-overlay",N("g-ui-modal-overlay-",m,"normal"),c),onClick:y=>{y.target===y.currentTarget&&f?.()}},wi({className:o("g-ui-modal",N("g-ui-modal-size-",u,"md"),w)},wi({className:"g-ui-modal-header"},_i(n,()=>wi({className:"g-ui-modal-title"},n)),_i(f,()=>Oa({type:"button",className:"g-ui-button g-ui-button-variant-subtle g-ui-button-size-xs g-ui-modal-close",onClick:f,innerHTML:Ye}))),t))))}import{Div as yi,Span as Ki,after as Ur,when as Xr}from"@granularjs/core";function ei(...e){let{props:i}=s(e,{variant:"spinner",size:"md"}),{variant:r,size:t,className:a}=i,n=Ur(r).compute(g=>g==="dots"),u=Ur(r).compute(g=>g==="bars");return Xr(n,()=>yi({className:o("g-ui-loading g-ui-dots",N("g-ui-loading-size-",t,"md"),a)}),()=>Xr(u,()=>yi({className:o("g-ui-loading g-ui-bars",N("g-ui-loading-size-",t,"md"),a)},Ki(""),Ki(""),Ki("")),()=>yi({className:o("g-ui-loading",N("g-ui-loading-size-",t,"md"),a)},yi({className:"g-ui-spinner"}))))}import{Div as Qi,Input as Wa,Label as Za,Span as _r,when as Ji,state as Ga,after as Ua}from"@granularjs/core";function er(...e){let{props:i,rawProps:r}=s(e,{size:"md"}),{checked:t,label:a,description:n,size:u,indeterminate:g,className:m,style:b,inputProps:w,...k}=i,{onChange:f}=r,c=Ga(xe(t));Ua(t).change(z=>{z!=null&&(c.set(!!z),f?.(z))});let y=Za({className:"g-ui-checkbox-control"},Wa({type:"checkbox",indeterminate:g,checked:c,className:o("g-ui-checkbox-input",N("g-ui-checkbox-size-",u,"md"),w?.className),...k}),Ji(c,()=>Qi({className:"g-ui-checkbox-checked",innerHTML:xi}),()=>{if(!c.get()&&g.get())return Qi({className:"g-ui-checkbox-indeterminate",innerHTML:Hr})}),Ji(a,()=>_r({className:"g-ui-checkbox-label"},a)));return Qi({className:o("g-ui-checkbox",N("g-ui-checkbox-size-",u,"md"),m)},y,Ji(n,()=>_r({className:"g-ui-checkbox-description"},n)))}import{Input as Xa,Label as _a,Span as Ka,when as Qa}from"@granularjs/core";function Ja(...e){let{props:i}=s(e,{size:"md"}),{label:r,size:t,className:a,style:n,inputProps:u,...g}=i;return _a({className:o("g-ui-switch",N("g-ui-switch-size-",t,"md"),a)},Xa({type:"checkbox",className:o("g-ui-switch-input",N("g-ui-switch-size-",t,"md"),u?.className),...g}),Qa(r,()=>Ka({className:"g-ui-switch-label"},r)))}import{Div as Be,Span as Kr,when as ir,state as Qr,after as ki}from"@granularjs/core";import{Span as eo}from"@granularjs/core";function we(...e){let{props:i,children:r}=s(e,{size:"md"});return eo({...i,className:o("g-ui-icon",N("g-ui-icon-size-",i.size,"md"),N("g-ui-icon-color-",i.color),i.className)},...r)}function io(...e){let{props:i,rawProps:r}=s(e,{data:[],size:"md"}),{data:t,value:a,size:n,leftSection:u,rightSection:g,placeholder:m,className:b,...w}=i,{onChange:k}=r,f=Qr(!1),c=Qr(l(a)??"");ki(a).change(M=>{let S=l(M);S!==void 0&&c.set(S??"")});let y=M=>{c.set(M),k?.(M),f.set(!1)},z=ki(c).compute(M=>M?"":"g-ui-select-placeholder"),B=ki(c).compute(M=>{let L=(l(t)??[]).find(I=>I.value===M);return M?L?.label??"":m??""});return Be({...w,className:o("g-ui-select-root",b)},Be({className:o("g-ui-input-wrapper",N("g-ui-input-size-",n,"md"))},ir(u,()=>Be({className:"g-ui-input-section"},u)),Be({className:o("g-ui-select",z),onClick:()=>f.set(!f.get())},Kr({className:"g-ui-select-value"},B)),ir(g,()=>Be({className:"g-ui-input-section"},g),()=>Kr({className:"g-ui-select-caret"},we({innerHTML:Gr})))),ir(f,()=>Be({className:"g-ui-select-dropdown"},(l(t)??[]).map(M=>Be({className:o("g-ui-select-item",ki(c).compute(S=>S===M.value?"g-ui-select-item-active":"")),onClick:()=>y(M.value)},M.label)))))}import{Button as ro,Div as qe,state as Pe,after as ii,list as to,when as ao}from"@granularjs/core";function oo(...e){let{props:i,rawProps:r}=s(e,{tabs:[],orientation:"horizontal",variant:"default",sticky:!0}),{value:t,tabs:a,orientation:n,variant:u,sticky:g,className:m,style:b}=i,{onChange:w}=r,k=Pe(l(t)??l(a)?.[0]?.value??""),f=Pe(),c=Pe(),y=Pe(0),z=Pe(0),B=Pe(0),M=Pe(0),S=Pe(!1),L=Pe(0),I=!1,v=null,x=!1,d=new Set;ii(t).change(h=>{let F=l(h);F!=null&&k.set(F)});let C=h=>{k.set(h),w?.(h)},T=h=>{let F=[],E=h?.parentElement;for(;E;){let G=getComputedStyle(E),K=`${G.overflow}${G.overflowY}${G.overflowX}`;/(auto|scroll)/.test(K)&&F.push(E),E=E.parentElement}return F},$=h=>T(h)[0]??null,U=h=>h?h.getBoundingClientRect().top:0,oe=h=>h?h.scrollTop:window.scrollY||window.pageYOffset||0,ee=(h,F)=>h>F?"down":h<F?"up":"none",ne=(h,F,E,G)=>h==="down"&&F<E?!0:h==="up"&&F>=E?!1:G,J=()=>{let h=f.get(),F=c.get();if(!h||!F)return;if(!xe(g)){S.set(!1),y.set(0);return}if(typeof window>"u")return;let E=h.getBoundingClientRect(),G=F.getBoundingClientRect(),K=$(h),le=U(K),ve=oe(K),Se=ee(ve,L.get());L.set(ve);let Ie=ne(Se,E.top,le,S.get());y.set(G.height),z.set(E.left),B.set(E.width),M.set(le),Ie!==S.get()&&S.set(Ie)},se=()=>{v==null&&(v=requestAnimationFrame(()=>{v=null,J()}))},ge=h=>{!h||d.has(h)||(d.add(h),h.addEventListener("scroll",se,{passive:!0}))},re=()=>{if(I)return;let h=f.get(),F=c.get();!h||!F||typeof window>"u"||(I=!0,J(),ge(window),window.addEventListener("resize",se),T(h).forEach(ge))};ii(c,f,g).change(re),!x&&typeof window<"u"&&(x=!0,setTimeout(()=>re(),0));let P=ii(S,z,B,M).compute(h=>{let[F,E,G,K]=h;return F?{position:"fixed",top:`${K}px`,left:`${E}px`,width:`${G}px`,background:"var(--g-ui-surface)",zIndex:100}:{position:"static",top:"auto",left:"auto",width:"auto",zIndex:"auto",background:"transparent"}}),O=ii(S,y).compute(h=>{let[F,E]=h;return{height:F?`${E}px`:"0px"}});return qe(qe({className:o("g-ui-tabs",me(n,{vertical:"g-ui-tabs-vertical"}),N("g-ui-tabs-variant-",u,"default"),i.className??m)},qe({node:f}),qe({style:O}),qe({node:c,className:"g-ui-tabs-list",style:P},to(a,h=>ro({className:ii(k,h.value).compute(([F,E])=>o("g-ui-tabs-tab",E===F&&"g-ui-tabs-tab-active")),onClick:()=>C(h.get().value)},h.label))),qe({className:"g-ui-tabs-panel"},ao(k,()=>a.get()?.find(h=>h.value===k.get())?.content??null))))}import{Table as no,Thead as so,Tbody as uo,Tr as Jr,Th as go,Td as et}from"@granularjs/core";function lo(...e){let{props:i}=s(e,{headers:[],rows:[]}),{headers:r,rows:t,striped:a,highlightOnHover:n,withBorder:u,withColumnBorders:g,className:m,style:b,...w}=i;return no({...w,className:o("g-ui-table",W("g-ui-table-striped",a),W("g-ui-table-hover",n),W("g-ui-table-with-border",u),W("g-ui-table-column-borders",g),m)},r.length?so(Jr(r.map(k=>go(k)))):null,uo(t.map(k=>Jr(Array.isArray(k)?k.map(f=>et(f)):Object.values(k).map(f=>et(f))))))}import{Div as rr}from"@granularjs/core";import{state as co,when as po,after as mo}from"@granularjs/core";function fo(...e){let{props:i,children:r}=s(e,{opened:!1}),{opened:t,className:a,...n}=i,u=co(xe(t));mo(t).change(w=>{u.set(xe(w))});let g=()=>{u.set(!u.get())},m=r[0],b=r[1];return rr({...n,className:o("g-ui-accordion",a)},rr({className:"g-ui-accordion-header",onClick:g},m),po(u,()=>rr({className:"g-ui-accordion-content"},b)))}import{Span as it}from"@granularjs/core";function vo(...e){let{props:i,children:r}=s(e),{label:t,className:a,style:n}=i;return it({className:o("g-ui-tooltip",a)},r,it({className:"g-ui-tooltip-content"},t))}import{Div as ri,when as ho,after as bo,state as ti,portal as xo}from"@granularjs/core";var tr=ti({currentOpenState:null});function wo(...e){let i=ti(),r=ti(),t=ti({}),{props:a,rawProps:n,children:u}=s(e,{position:"right"}),{opened:g,content:m,position:b,className:w,...k}=a,{onChange:f}=n,c=ti(l(g)??!1);bo(g).change(I=>{let v=l(I);v!=null&&(c.set(!!v),v&&y())});let y=()=>{tr.get().currentOpenState!==c&&(tr.get().currentOpenState?.set(!1),tr.set().currentOpenState=c)};g.get()&&y();let z=I=>{let x=String(I??"right").toLowerCase().split("-").filter(Boolean);if(x.length===1){let T=x[0];return T==="top"||T==="bottom"?{placement:T,align:"center"}:T==="left"||T==="right"?{placement:"bottom",align:T}:T==="center"?{placement:"bottom",align:"center"}:{placement:"bottom",align:"right"}}let[d,C]=x;return d==="top"||d==="bottom"?{placement:d,align:C||"center"}:d==="left"||d==="right"?{placement:d,align:C||"center"}:{placement:"bottom",align:"right"}},B=()=>{let I=i.get(),v=r.get();if(!I||!v||typeof window>"u")return;let x=I.getBoundingClientRect(),d=v.getBoundingClientRect(),C=l(b)??"right",T=getComputedStyle(document.documentElement).getPropertyValue("--g-ui-space-20"),$=Number.parseFloat(T)||20,U=window.innerWidth||0,oe=window.innerHeight||0,ee=Math.max($,U-d.width-$),ne=Math.max($,oe-d.height-$),{placement:J,align:se}=z(C),ge=8,re=x.bottom+ge,P=x.left;J==="top"||J==="bottom"?(re=J==="top"?x.top-d.height-ge:x.bottom+ge,se==="center"?P=x.left+x.width/2-d.width/2:se==="right"?P=x.right-d.width:P=x.left):(J==="left"||J==="right")&&(P=J==="left"?x.left-d.width-ge:x.right+ge,se==="center"?re=x.top+x.height/2-d.height/2:se==="bottom"?re=x.bottom-d.height:re=x.top),P=Math.max($,Math.min(P,ee)),re=Math.max($,Math.min(re,ne)),t.set({top:`${re}px`,left:`${P}px`})},M=I=>{c.set(I),f?.(I),I&&(y(),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>B()):setTimeout(()=>B(),0))},S=()=>M(!c.get()),L=()=>M(!1);return ri({...k,node:i,className:o("g-ui-menu",w)},ri({onClick:S},u),ho(c,()=>xo(ri(ri({className:"g-ui-menu-overlay",onClick:L}),ri({className:"g-ui-menu-dropdown",node:r,style:t},m)))))}import{Div as rt,portal as yo,when as ko}from"@granularjs/core";function zo(...e){let{props:i,children:r}=s(e,{position:"right",size:"md",overlay:"normal",shadowed:!0}),{opened:t,onClose:a,position:n,size:u,overlay:g,shadowed:m,className:b,style:w}=i;return ko(t,()=>yo(rt({className:o("g-ui-drawer-overlay",N("g-ui-drawer-overlay-",g,"normal")),onClick:a},rt({className:o("g-ui-drawer",me(m,{true:"g-ui-drawer-shadowed"},!0),N("g-ui-drawer-",n,"right"),N("g-ui-drawer-size-",u,"md"),b),onClick:k=>k.stopPropagation()},r))))}import{Button as No,Div as ar,Span as tt,when as zi,after as at}from"@granularjs/core";function or(...e){let{props:i,rawProps:r,children:t}=s(e,{color:"blue",withCloseButton:!0}),{title:a,color:n,icon:u,loading:g,withCloseButton:m,withBorder:b,className:w,style:k}=i,{onClose:f}=r,c=at(u,g).compute(([z,B])=>!z&&!!B),y=at(u,g).compute(([z,B])=>!!z||!!B);return ar({className:o("g-ui-notification",[b,"g-ui-notification-bordered"],[n,z=>`g-ui-notification-${z}`],[y,"g-ui-notification-with-icon"],w)},zi(u,()=>tt({className:"g-ui-notification-icon"},u)),zi(c,()=>ei({size:"sm",className:"g-ui-notification-loader"})),ar({className:"g-ui-notification-body"},zi(a,()=>ar({className:"g-ui-notification-title"},a)),t),zi(m,()=>No({type:"button",className:"g-ui-notification-close",onClick:()=>f?.()},tt({innerHTML:Ye}))))}import{Div as Co,when as So}from"@granularjs/core";function Do(...e){let{props:i}=s(e,{labelPosition:"center"}),{label:r,labelPosition:t,vertical:a,className:n,...u}=i;return Co({...u,className:o("g-ui-divider",W("label",r),N("g-ui-divider-label-",t,"center"),W("g-ui-divider-vertical",a),n)},So(r,()=>Zi({className:"g-ui-divider-label-text",size:"sm"},r)))}import{Div as Po}from"@granularjs/core";function Mo(...e){let{props:i,children:r}=s(e,{padding:"md",radius:"md",shadow:"none"}),{padding:t,radius:a,shadow:n,className:u,...g}=i;return Po({...g,className:o("g-ui-paper",[t,m=>`g-ui-card-padding-${m}`],[a,m=>`g-ui-card-radius-${m}`],[n,m=>`g-ui-card-shadow-${m}`],u)},r)}import{Button as To,Div as nr,Span as Vo,after as ot,when as sr}from"@granularjs/core";function Lo(...e){let{props:i,rawProps:r,children:t}=s(e,{color:"blue"}),{title:a,color:n,icon:u,withCloseButton:g,className:m,...b}=i,{onClose:w}=r,k=ot(a,g).compute(([c,y])=>c||y),f=ot(u).compute(c=>c!==void 0);return nr({...b,className:o("g-ui-alert",[n,c=>`g-ui-alert-${c}`],m)},nr({className:"g-ui-alert-header"},sr(u,()=>Vo({className:"g-ui-alert-icon"},u)),sr(a,()=>nr({className:"g-ui-alert-title"},a)),sr(g,()=>To({type:"button",className:"g-ui-alert-close",onClick:()=>w?.()},"\xD7"))),t)}import{Div as Io,Img as $o,when as Ao}from"@granularjs/core";function Bo(...e){let{props:i,children:r}=s(e,{size:"md",alt:""}),{src:t,size:a,alt:n,className:u,...g}=i;return Io({...g,className:o("g-ui-avatar",[a,m=>`g-ui-avatar-size-${m}`],u)},Ao(t,()=>$o({className:"g-ui-avatar-img",src:t,alt:n}),()=>r))}import{Span as Fo}from"@granularjs/core";function jo(...e){let{props:i,children:r}=s(e),{className:t,...a}=i;return Fo({...a,className:o("g-ui-kbd",t)},r)}import{Code as Eo}from"@granularjs/core";function Ro(...e){let{props:i,children:r}=s(e),{className:t,...a}=i;return Eo({...a,className:o("g-ui-code",t)},r)}import{Blockquote as Ho}from"@granularjs/core";function Oo(...e){let{props:i,children:r}=s(e),{className:t,...a}=i;return Ho({...a,className:o("g-ui-blockquote",t)},r)}import{Div as Yo}from"@granularjs/core";function qo(...e){let{props:i,children:r}=s(e,{cols:3,gap:"md"}),{cols:t,gap:a,className:n,...u}=i;return Yo({...u,className:o("g-ui-grid",[a,g=>`g-ui-gap-${g}`],[t,g=>`g-ui-grid-cols-${g}`],n)},r)}import{Ul as Wo,Ol as Zo,Li as ur,Div as Ni,Span as gr,after as lr,when as Fe,isSignal as Go,isState as Uo,isStatePath as Xo,isComputed as _o}from"@granularjs/core";function nt(...e){let{props:i,children:r}=s(e,{type:"none",size:"md"}),{type:t,size:a,withPadding:n,className:u,...g}=i,m=me(t,{ordered:"g-ui-list-ordered",unordered:"g-ui-list-unordered",none:"g-ui-list-none"}),b=lr(t).compute(z=>z==="ordered"),w=z=>z&&typeof z=="object"&&typeof z.tagName=="string"&&(z.tagName.toLowerCase()==="ul"||z.tagName.toLowerCase()==="ol"),k=z=>z&&typeof z=="object"&&typeof z.tagName=="string"&&z.tagName.toLowerCase()==="li",f=z=>{console.log("INFO ABOUT ITEM",z,typeof z,typeof z?.tagName,z?.tagName?.toLowerCase());let B=M=>M?.nodeType==="granular-list-node"?M:M==null||M===!1?null:Array.isArray(M)?M.map(S=>B(S)):k(M)?M:w(M)?ur({className:"g-ui-list-nested-item"},M):ur(gr({className:"g-ui-list-item-shell"},M));return Go(z)||Uo(z)||Xo(z)||_o(z)?lr(z).compute(M=>B(M)):B(z)},c=Fe(r,()=>r.map(z=>f(z))),y={...g,className:o("g-ui-list",N("g-ui-list-size-",a,"md"),W("g-ui-list-with-padding",n),m,u)};return Fe(b,()=>Zo(y,c),()=>Wo(y,c))}function Ko(...e){let{props:i,children:r}=s(e,{withBorder:!1}),{leftSection:t,rightSection:a,title:n,body:u,withBorder:g,className:m,...b}=i,w=lr(n,u).compute(([k,f])=>!!k||!!f);return ur({...b,className:o("g-ui-list-item",W("g-ui-list-item-border",g),m)},Ni({className:"g-ui-list-item-shell"},Fe(t,()=>gr({className:"g-ui-list-item-section g-ui-list-item-section-left"},t)),Fe(w,()=>Ni({className:"g-ui-list-item-content"},Fe(n,()=>Ni({className:"g-ui-list-item-title"},n)),Fe(u,()=>Ni({className:"g-ui-list-item-body"},u))),()=>r),Fe(a,()=>gr({className:"g-ui-list-item-section g-ui-list-item-section-right"},a))))}nt.Item=Ko;import{A as Qo}from"@granularjs/core";function Jo(...e){let{props:i,children:r}=s(e),{className:t,...a}=i;return Qo({...a,className:o("g-ui-anchor",t)},r)}import{Img as en}from"@granularjs/core";function rn(...e){let{props:i}=s(e),{className:r,...t}=i;return en({...t,className:o("g-ui-image",r)})}import{Div as st}from"@granularjs/core";function tn(...e){let{props:i}=s(e,{value:0,color:"primary",size:"md"}),{value:r,color:t,size:a,className:n,...u}=i;return st({...u,className:o("g-ui-progress",N("g-ui-progress-size-",a,"md"),[r,g=>{let m=Math.max(0,Math.min(100,Number(g)||0));return`g-ui-progress-${Math.round(m/5)*5}`}],[t,g=>g?`g-ui-progress-${g}`:""],n)},st({className:"g-ui-progress-bar"}))}import{Div as Le,after as je,state as an,when as ut,list as on}from"@granularjs/core";function nn(...e){let{props:i,rawProps:r}=s(e,{size:"md",min:0,max:100,step:1}),{onChange:t}=r,{value:a,marks:n,size:u,min:g,max:m,step:b,disabled:w,className:k,...f}=i,c=an(l(a??g)),y=je(n).compute(v=>v&&v.length>0);je(a).change(v=>{v!=null&&c.set(l(v))});let z=()=>{let v=Number(l(g)),x=Number(l(m));return!Number.isFinite(v)||!Number.isFinite(x)?{minValue:0,maxValue:100}:{minValue:Math.min(v,x),maxValue:Math.max(v,x)}},B=()=>{let v=Number(l(b));return Number.isFinite(v)&&v>0?v:1},M=v=>{let{minValue:x,maxValue:d}=z(),C=B(),T=Math.max(x,Math.min(d,Number(v))),$=Math.round((T-x)/C)*C+x;$!==c.get()&&(c.set($),t?.($))},S=je(c).compute(v=>{let{minValue:x,maxValue:d}=z(),C=d-x;if(C<=0)return 0;let T=(Number(v??x)-x)/C*100;return Math.max(0,Math.min(100,T))}),L=(v,x)=>{let d=x?.();if(!d||d.width===0)return;let T=Math.min(Math.max(v.clientX-d.left,0),d.width)/d.width,{minValue:$,maxValue:U}=z();M($+T*(U-$))},I=v=>{if(xe(w))return;v.preventDefault?.();let x=v.currentTarget,d=()=>x.getBoundingClientRect();x.setPointerCapture?.(v.pointerId),L(v,d);let C=$=>L($,d),T=()=>{x.releasePointerCapture?.(v.pointerId),window.removeEventListener("pointermove",C),window.removeEventListener("pointerup",T)};window.addEventListener("pointermove",C),window.addEventListener("pointerup",T)};return Le({...f,className:o("g-ui-slider",N("g-ui-slider-size-",u,"md"),W("g-ui-slider-disabled",w),k)},Le({className:"g-ui-slider-track",onPointerDown:I},Le({className:"g-ui-slider-bar",style:je(S).compute(v=>({width:`${v}%`}))}),Le({className:"g-ui-slider-thumb",style:je(S).compute(v=>({left:`${v}%`}))})),ut(y,()=>Le({className:"g-ui-slider-marks-placeholder"})),ut(n,()=>Le({className:"g-ui-slider-marks"},on(n,v=>cr({mark:v,getBounds:z})))))}var cr=({mark:e,getBounds:i})=>{let{minValue:r,maxValue:t}=i(),a=t-r,n=je(e).compute(b=>b.value??b),u=je(e).compute(b=>b.label??String(b.value)??n),g=Number(n),m=0;return a>0&&(m=(g-r)/a*100),Le({className:"g-ui-slider-mark",style:{left:`${Math.max(0,Math.min(100,m))}%`}},Le({className:"g-ui-slider-mark-label"},u))};import{Div as sn,after as un}from"@granularjs/core";function gn(...e){let{props:i}=s(e,{height:"md",width:"full"}),{height:r,width:t,className:a,...n}=i,u=un(r,t).compute(([g,m])=>{let b={};return isNaN(g)||(b.height=`${g}px`),isNaN(m)||(b.width=`${m}px`),b});return sn({...n,style:{width:u.width,height:u.height,...n.style||{}},className:o("g-ui-skeleton",[r,g=>`g-ui-skeleton-h-${g}`],[t,g=>`g-ui-skeleton-w-${g}`],a)})}import{Button as ln,after as gt,state as cn}from"@granularjs/core";function pn(...e){let{props:i,rawProps:r,children:t}=s(e,{size:"md",variant:"filled",color:"primary"}),{checked:a,size:n,variant:u,color:g,className:m,...b}=i,{onChange:w}=r,k=cn(!!a);gt(a).change(c=>{c!=null&&k.set(!!c)});let f=c=>{k.set(c),w?.(c)};return ln({...b,type:"button",className:o("g-ui-chip",N("g-ui-chip-size-",n,"md"),N("g-ui-chip-variant-",u,"filled"),N("g-ui-chip-color-",g,"primary"),gt(k).compute(c=>c?"g-ui-chip-active":""),m),onClick:()=>f(!k.get())},t)}import{Div as pr,after as lt,state as dn,list as mn}from"@granularjs/core";function fn(...e){let{props:i,rawProps:r}=s(e,{data:[],size:"sm"}),{value:t,data:a,size:n,scroll:u,className:g,...m}=i,{onChange:b}=r,w=dn(l(t));lt(t).change(f=>{let c=l(f);c!=null&&w.set(c)});let k=f=>{w.set(f),b?.(f)};return pr({...m,className:o(u&&"g-ui-segmented-scroll")},pr({className:o("g-ui-segmented",N("g-ui-segmented-size-",n,"sm"),g)},mn(a,(f=>pr({className:o("g-ui-segmented-item",lt(w).compute(c=>f.get().value===c?"g-ui-segmented-active":"")),onClick:()=>k(f.get().value)},f.label)))))}import{Button as dr,Div as vn,state as hn,after as Ci}from"@granularjs/core";function bn(...e){let{props:i,rawProps:r}=s(e,{total:1,size:"md"}),{page:t,total:a,size:n,className:u,...g}=i,{onChange:m}=r,b=hn(l(t)??1);Ci(t).change(c=>{let y=l(c);y!=null&&b.set(y)});let w=c=>{let y=Number(l(a))||1,z=Math.max(1,Math.min(y,c));b.set(z),m?.(z)},k=[],f=Number(l(a))||1;for(let c=1;c<=f;c+=1)k.push(c);return vn({...g,className:o("g-ui-pagination",N("g-ui-pagination-size-",n,"md"),i.className??u)},dr({className:"g-ui-pagination-item",onClick:()=>w((b.get?.()??b)-1),disabled:Ci(b).compute(c=>c<=1)},"<"),k.map(c=>dr({className:Ci(b).compute(y=>o("g-ui-pagination-item",c===y&&"g-ui-pagination-item-active")),onClick:()=>w(c)},String(c))),dr({className:"g-ui-pagination-item",onClick:()=>w((b.get?.()??b)+1),disabled:Ci(b).compute(c=>c>=a)},">"))}import{Div as xn,Input as wn,Label as yn,Span as ct,when as pt}from"@granularjs/core";function kn(...e){let{props:i}=s(e,{size:"md"}),{label:r,description:t,size:a,className:n,inputProps:u,...g}=i,m=yn({className:"g-ui-radio-control"},wn({type:"radio",className:o("g-ui-radio-input",N("g-ui-radio-size-",a,"md"),u?.className),...g}),pt(r,()=>ct({className:"g-ui-radio-label"},r)));return xn({className:o("g-ui-radio",N("g-ui-radio-size-",a,"md"),n)},m,pt(t,()=>ct({className:"g-ui-radio-description"},t)))}import{Div as zn}from"@granularjs/core";function Nn(...e){let{props:i,children:r}=s(e),{className:t,...a}=i;return zn({...a,className:o("g-ui-stack g-ui-gap-sm",t)},r)}import{Nav as Cn,Span as Sn}from"@granularjs/core";function Dn(...e){let{props:i,children:r}=s(e,{separator:"/"}),{separator:t,className:a,...n}=i,u=[];Array.isArray(r)?u.push(...r):u.push(r);let g=u.filter(Boolean),m=[];return g.forEach((b,w)=>{m.push(b),w<g.length-1&&m.push(Sn({className:"g-ui-breadcrumbs-separator"},t))}),Cn({...n,className:o("g-ui-breadcrumbs",a)},m)}import{Div as Pn}from"@granularjs/core";function Mn(...e){let{props:i,children:r}=s(e),{className:t,...a}=i;return Pn({...a,className:o("g-ui-center",t)},r)}import{Div as Tn}from"@granularjs/core";function Vn(...e){let{props:i}=s(e,{size:"md"}),{size:r,className:t,...a}=i;return Tn({...a,className:o("g-ui-space",[r,n=>`g-ui-space-${n}`],t)})}import{Div as Ln,when as In}from"@granularjs/core";function $n(...e){let{props:i,children:r}=s(e),{opened:t,className:a,...n}=i;return In(t,()=>Ln({...n,className:o("g-ui-collapse",a)},r))}import{Button as An}from"@granularjs/core";function Ee(...e){let{props:i,children:r}=s(e,{size:"md",variant:"filled"}),{size:t,variant:a,color:n,className:u,...g}=i;return An({...g,type:"button",className:o("g-ui-action-icon",N("g-ui-action-icon-size-",t,"md"),N("g-ui-action-icon-color-",n,"primary"),N("g-ui-action-icon-",a,"filled"),u)},r)}import{Div as mr,when as Bn,after as Fn,state as jn}from"@granularjs/core";function fr(...e){let{props:i,rawProps:r,children:t}=s(e,{position:"left"}),{opened:a,position:n,content:u,className:g,...m}=i,{onChange:b}=r,w=jn(l(a)??!1);Fn(a).change(f=>{let c=l(f);c!=null&&w.set(!!c)});let k=f=>{w.set(f),b?.(f)};return mr({...m,className:o("g-ui-popover",i.className??g)},mr({onClick:()=>k(!w.get())},t),Bn(w,()=>mr({className:o("g-ui-popover-dropdown",n==="right"&&"g-ui-popover-right",n==="center"&&"g-ui-popover-center")},u)))}import{Div as dt}from"@granularjs/core";function En(...e){let{props:i,children:r}=s(e,{position:"left"}),{position:t,content:a,className:n,...u}=i;return dt({...u,className:o("g-ui-hover-card",n)},r,dt({className:o("g-ui-hover-card-dropdown",[t,g=>g==="right"?"g-ui-hover-card-right":""],[t,g=>g==="center"?"g-ui-hover-card-center":""])},a))}import{Div as Rn}from"@granularjs/core";function Hn(...e){let{props:i,children:r}=s(e,{position:"bottom-right"}),{position:t,className:a,...n}=i;return Rn({...n,className:o("g-ui-affix",[t,u=>`g-ui-affix-${u}`],a)},r)}import{Fieldset as On,Legend as Yn,when as qn}from"@granularjs/core";function Wn(...e){let{props:i,children:r}=s(e),{legend:t,className:a,...n}=i;return On({...n,className:o("g-ui-fieldset",a)},qn(t,()=>Yn({className:"g-ui-legend"},t)),r)}import{Div as Zn}from"@granularjs/core";function Gn(...e){let{props:i,children:r}=s(e,{position:"sticky"}),{position:t,className:a,...n}=i;return Zn({...n,className:o("g-ui-appbar",N("g-ui-appbar-",t,"sticky"),a)},r)}import{Div as vr,portal as Un,after as Si,state as mt,when as ft}from"@granularjs/core";function Xn(...e){let{props:i,children:r}=s(e,{position:"left",size:"md",blur:!0,fixed:!1,minWidth:"button"});return ft(i.fixed,()=>Kn(i,r),()=>_n(i,r))}var _n=(e,i)=>{let{open:r,onClose:t,position:a,size:n,blur:u,fixed:g,minWidth:m,className:b,...w}=e,k=mt(!1),f=mt(!1),c=220,y=M=>{if(M){k.set(!0),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>f.set(!0)):setTimeout(()=>f.set(!0),0);return}f.set(!1),setTimeout(()=>k.set(!1),c)};y(!!r.get()),Si(r).change(M=>y(!!M));let z=Si(f,u).compute(M=>{let[S,L]=M;return o("g-ui-sidebar-overlay",S&&"g-ui-sidebar-overlay-open",!L&&"g-ui-sidebar-overlay-noblur")}),B=Si(n,a,f,b).compute(M=>{let[S,L,I,v]=M,x=L==="right"?"g-ui-sidebar-drawer-right g-ui-sidebar-position-right":"g-ui-sidebar-drawer-left";return o("g-ui-sidebar","g-ui-sidebar-drawer",`g-ui-sidebar-size-${S}`,x,I&&"g-ui-sidebar-drawer-open",l(v))});return ft(k,()=>Un(vr({className:z,onClick:t},vr({className:B,onClick:M=>M.stopPropagation()},i))))},Kn=(e,i)=>{let{open:r,position:t,size:a,minWidth:n,className:u,...g}=e,m=Si(a,t,r,n,u).compute(b=>{let[w,k,f,c,y]=b,z=c||"button",B=null;return z==="button"?B="g-ui-sidebar-min-button":z==="xs"?B="g-ui-sidebar-min-xs":z==="sm"?B="g-ui-sidebar-min-sm":z==="md"&&(B="g-ui-sidebar-min-md"),o("g-ui-sidebar g-ui-sidebar-fixed",`g-ui-sidebar-size-${w||"md"}`,B,f&&"g-ui-sidebar-fixed-open",y)});return vr({...g,className:m},i)};import{Div as We,when as vt}from"@granularjs/core";function Qn(...e){let{props:i}=s(e,{items:[]}),{items:r,className:t,...a}=i;return We({...a,className:o("g-ui-timeline",t)},r.map(n=>We({className:"g-ui-timeline-item"},We({className:"g-ui-timeline-dot"}),We({className:"g-ui-timeline-content"},vt(n.title,()=>We({className:"g-ui-timeline-title"},n.title)),vt(n.description,()=>We({className:"g-ui-timeline-desc"},n.description)),n.content))))}import{Div as Di}from"@granularjs/core";function Jn(...e){let{props:i}=s(e,{active:0,items:[]}),{active:r,items:t,className:a,...n}=i;return Di({...n,className:o("g-ui-stepper",a)},t.map((u,g)=>Di({className:o("g-ui-stepper-item",[r,m=>g===m?"g-ui-stepper-active":""])},Di({className:"g-ui-stepper-index"},String(g+1)),Di({className:"g-ui-stepper-label"},u.label))))}import{Span as ht,after as bt,state as es}from"@granularjs/core";function is(...e){let{props:i,rawProps:r}=s(e,{value:0,max:5,size:"md"}),{value:t,max:a,size:n,className:u,...g}=i,{onChange:m}=r,b=es(l(t));bt(t).change(c=>{let y=l(c);y!=null&&b.set(y)});let w=c=>{b.set(c),m?.(c)},k=[],f=Number(l(a))||0;for(let c=1;c<=f;c+=1)k.push(c);return ht({...g,className:o("g-ui-rating",N("g-ui-rating-size-",n,"md"),i.className??u)},k.map(c=>ht({className:o("g-ui-rating-item",bt(b).compute(y=>c<=y?"g-ui-rating-item-active":"")),onClick:()=>w(c)},"\u2605")))}import{Span as rs}from"@granularjs/core";function ts(...e){let{props:i,children:r}=s(e),{className:t,...a}=i;return rs({...a,className:o("g-ui-tag",t)},r)}import{Button as xt,Div as Ze,state as wt,after as Pi}from"@granularjs/core";var as=["S","M","T","W","T","F","S"];function ai(...e){let{props:i,rawProps:r}=s(e,{size:"md"}),{value:t,className:a,size:n,...u}=i,{onChange:g}=r,m=S=>{let L=l(S);if(L instanceof Date)return L;if(L==null)return null;let I=new Date(L);return Number.isNaN(I.getTime())?null:I},b=wt(m(t)??new Date),w=wt(new Date(b.get()));Pi(t).change(S=>{let L=m(S);L!=null&&(b.set(L),w.set(new Date(L)))});let k=(S,L,I)=>{let v=new Date(S,L+1,0).getDate();return new Date(S,L,Math.min(I,v))},f=S=>{let L=w.get(),I=k(L.getFullYear(),L.getMonth(),S);b.set(I),w.set(I),g?.(I)},c=S=>{let L=w.get(),I=k(L.getFullYear(),L.getMonth()+S,L.getDate());w.set(I)},y=S=>{let L=w.get(),I=k(L.getFullYear()+S,L.getMonth(),L.getDate());w.set(I)},z=Pi(w).compute(S=>S.toLocaleString("default",{month:"long"})),B=Pi(w).compute(S=>String(S.getFullYear())),M=Pi(w,b).compute(([S,L])=>{let I=S.getFullYear(),v=S.getMonth(),d=new Date(I,v,1).getDay(),C=new Date(I,v+1,0).getDate(),T=[];for(let $=0;$<d;$+=1)T.push({muted:!0,label:""});for(let $=1;$<=C;$+=1)T.push({label:$});return[...as.map($=>Ze({className:"g-ui-calendar-cell g-ui-calendar-cell-muted"},$)),...T.map($=>Ze({className:o("g-ui-calendar-cell",$.muted&&"g-ui-calendar-cell-muted",$.label&&L.getFullYear()===I&&L.getMonth()===v&&$.label===L.getDate()&&"g-ui-calendar-cell-active"),onClick:()=>$.label&&f($.label)},$.label))]});return Ze({...u,className:o("g-ui-calendar",a,N("g-ui-calendar-size-",n,"md"))},Ze({className:"g-ui-calendar-header"},Ee({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>c(-1)},we({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:bi})),Ze({className:"g-ui-calendar-title-group"},xt({type:"button",className:"g-ui-calendar-title-button",onClick:()=>c(1)},z),xt({type:"button",className:"g-ui-calendar-title-button",onClick:()=>y(1)},B)),Ee({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>c(1)},we({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:hi}))),Ze({className:"g-ui-calendar-grid"},M))}import{Div as oi,Span as Ge,Input as os,when as hr,after as ze,state as Mi}from"@granularjs/core";function ns(...e){let{props:i,rawProps:r}=s(e,{data:[],size:"md",searchable:!0}),{value:t,data:a,size:n,className:u,placeholder:g,searchable:m,...b}=i,{onChange:w,onSearchChange:k}=r,f=Mi(l(t)??[]),c=Mi(""),y=Mi(!1),z=Mi(null),B=d=>(l(d)??[]).map(T=>typeof T=="string"?{value:T,label:T}:T&&typeof T=="object"?T:{value:String(T),label:String(T)});ze(t).change(d=>{let C=l(d);C!=null&&f.set(C)});let M=null;ze(y).change(d=>{if(M&&(M(),M=null),!d)return;let C=T=>{let $=z.get();$&&($.contains(T.target)||y.set(!1))};document.addEventListener("mousedown",C),M=()=>document.removeEventListener("mousedown",C)}),ze(c).change(d=>{k?.(d)});let S=d=>{let C=f.get()??[],T=C.includes(d)?C.filter($=>$!==d):C.concat(d);f.set(T),w?.(T)},L=ze(a).compute(d=>B(d)),I=ze(L,c).compute(([d,C])=>{let T=String(l(C)??"").toLowerCase().trim();return T?d.filter($=>String($.label??"").toLowerCase().includes(T)):d}),v=ze(f,c).compute(([d,C])=>{let T=l(d)??[],$=String(l(C)??"");return!T.length&&!$}),x=ze(m).compute(d=>!!d);return oi({...b,node:z,className:o("g-ui-select-multi-root",u)},oi({className:o("g-ui-select-multi",N("g-ui-select-multi-size-",n,"md")),onClick:()=>y.set(!0)},ze(L,f).compute(([d,C])=>(l(C)??[]).map($=>{let oe=(d??[]).find(ee=>ee.value===$)?.label??$;return Ge({className:"g-ui-select-tag"},Ge({className:"g-ui-select-tag-label",onClick:ee=>{ee?.stopPropagation?.()}},oe),Ge({className:"g-ui-select-tag-remove",innerHTML:Ye,onClick:ee=>{ee?.stopPropagation?.(),S($)}}))})),hr(v,()=>Ge({className:"g-ui-select-multi-placeholder"},g??"Select...")),hr(x,()=>os({className:"g-ui-select-multi-input",value:c,onInput:d=>c.set(d.target?.value??""),onFocus:()=>y.set(!0)}))),hr(y,()=>oi({className:"g-ui-select-dropdown"},ze(I).compute(d=>d.length?d.map(C=>oi({className:o("g-ui-select-item",C.disabled&&"g-ui-select-item-disabled",ze(f).compute(T=>(l(T)??[]).includes(C.value)?"g-ui-select-item-active":"")),onClick:()=>{C.disabled||S(C.value)}},Ge({className:"g-ui-select-item-check",innerHTML:ze(f).compute(T=>(l(T)??[]).includes(C.value)?xi:"")}),Ge({className:"g-ui-select-item-label"},C.label))):oi({className:"g-ui-select-item"},"Nothing found")))))}import{Div as ni,when as yt}from"@granularjs/core";function ss(...e){let{props:i}=s(e,{items:[]}),{items:r,className:t,onClose:a,timeout:n,...u}=i;return ni({...u,className:o("g-ui-toast-stack",t)},r.map(g=>ni({className:o("g-ui-toast",[n,"g-ui-toast-auto"])},ni({className:"g-ui-toast-row"},yt(g.title,()=>ni({className:"g-ui-toast-title"},g.title)),yt(a,()=>ni({className:"g-ui-toast-close",onClick:()=>a(g)},"\xD7"))),g.message)))}function us(...e){let{props:i}=s(e);return ai(i)}import{Div as gs,after as ls}from"@granularjs/core";function cs(...e){let{props:i,rawProps:r}=s(e,{items:[],position:"top-right"}),{items:t,position:a,className:n,...u}=i,{onRemove:g}=r,m=new Map,b=(k,f)=>k?.id??k?.key??f,w=ls(t).compute(k=>{let f=l(k)??[],c=new Set;f.forEach((y,z)=>{let B=b(y,z);if(c.add(B),y?.autoClose&&!m.has(B)){let M=setTimeout(()=>{m.delete(B),g?.(y)},y.autoClose);m.set(B,M)}});for(let[y,z]of m.entries())c.has(y)||(clearTimeout(z),m.delete(y));return f.map((y,z)=>or({key:b(y,z),title:y.title,color:y.color,icon:y.icon,loading:y.loading,withCloseButton:y.withCloseButton,withBorder:y.withBorder,onClose:()=>{y.onClose?.(),g?.(y)}},y.message??y.body??y.content??y.text))});return gs({...u,className:o("g-ui-notifications",N("g-ui-notifications-position-",a,"top-right"),n)},w)}import{Div as Ue,after as si,state as ps,when as ds}from"@granularjs/core";function ms(...e){let{props:i,rawProps:r}=s(e,{min:0,max:100,step:1,size:"md"}),{value:t,marks:a,min:n,max:u,step:g,size:m,disabled:b,className:w,...k}=i,{onChange:f}=r,c=ps(l(t??[n,u])),y=()=>{let v=Number(l(n)),x=Number(l(u));return!Number.isFinite(v)||!Number.isFinite(x)?{minValue:0,maxValue:100}:{minValue:Math.min(v,x),maxValue:Math.max(v,x)}},z=()=>{let v=Number(l(g));return Number.isFinite(v)&&v>0?v:1},B=v=>{let{minValue:x,maxValue:d}=y(),C=z(),T=[x,d];Array.isArray(v)&&(T=v);let $=Math.max(x,Math.min(d,Number(T[0]))),U=Math.max(x,Math.min(d,Number(T[1]))),oe=Math.round(Math.min($,U)/C)*C,ee=Math.round(Math.max($,U)/C)*C;return[oe,ee]};si(t).change(v=>{v!=null&&c.set(B(v))});let M=v=>{let x=B(v);x?.[0]===c.get()?.[0]&&x?.[1]===c.get()?.[1]||(c.set(x),f?.(x))},S=si(c).compute(v=>{let{minValue:x,maxValue:d}=y(),C=d-x,[T,$]=B(v);if(C<=0)return{lowPct:0,highPct:0};let U=(T-x)/C*100,oe=($-x)/C*100;return{lowPct:Math.max(0,Math.min(100,U)),highPct:Math.max(0,Math.min(100,oe))}}),L=(v,x,d)=>{let C=x?.();if(!C||C.width===0)return;let $=Math.min(Math.max(v.clientX-C.left,0),C.width)/C.width,{minValue:U,maxValue:oe}=y(),ee=U+$*(oe-U),ne=c;typeof c.get=="function"&&(ne=c.get());let[J,se]=B(ne);M(d==="low"?[ee,se]:[J,ee])},I=(v,x,d)=>{if(xe(b))return;v.preventDefault?.();let C=d||v.currentTarget,T=()=>C.getBoundingClientRect(),$=T(),U=S;typeof S.get=="function"&&(U=S.get());let{lowPct:oe,highPct:ee}=U,ne=(v.clientX-$.left)/$.width*100,J=x;if(!J){let re=Math.abs(ne-oe)<=Math.abs(ne-ee);J="high",re&&(J="low")}C.setPointerCapture?.(v.pointerId),L(v,T,J);let se=re=>L(re,T,J),ge=()=>{C.releasePointerCapture?.(v.pointerId),window.removeEventListener("pointermove",se),window.removeEventListener("pointerup",ge)};window.addEventListener("pointermove",se),window.addEventListener("pointerup",ge)};return Ue({...k,className:o("g-ui-range-slider",N("g-ui-slider-size-",m,"md"),W("g-ui-slider-disabled",b),i.className??w)},Ue({className:"g-ui-slider-track",onPointerDown:v=>I(v)},Ue({className:"g-ui-slider-bar",style:si(S).compute(({lowPct:v,highPct:x})=>({left:`${v}%`,width:`${Math.max(0,x-v)}%`}))}),Ue({className:"g-ui-slider-thumb",style:si(S).compute(({lowPct:v})=>({left:`${v}%`})),onPointerDown:v=>{v.stopPropagation?.(),I(v,"low",v.currentTarget.parentElement)}}),Ue({className:"g-ui-slider-thumb",style:si(S).compute(({highPct:v})=>({left:`${v}%`})),onPointerDown:v=>{v.stopPropagation?.(),I(v,"high",v.currentTarget.parentElement)}})),ds(a,()=>Ue({className:"g-ui-slider-marks"},a.map(v=>cr({mark:v,getBounds:y})))))}import{state as br,after as kt}from"@granularjs/core";function Ti(...e){let{props:i,rawProps:r}=s(e,{size:"md",format:{pattern:"dddd-dd-dd"}}),{value:t,size:a,calendarSize:n,leftSection:u,rightSection:g,className:m,format:b,minDate:w,maxDate:k,...f}=i,{onChange:c}=r,y=x=>{let d=l(x);if(d instanceof Date)return d;if(d==null||d==="")return null;let C=new Date(d);return Number.isNaN(C.getTime())?null:C},z=(x,d)=>x&&d&&x.getFullYear()===d.getFullYear()&&x.getMonth()===d.getMonth()&&x.getDate()===d.getDate(),B=x=>{if(!x)return"";let d=String(x.getFullYear()).padStart(4,"0"),C=String(x.getMonth()+1).padStart(2,"0"),T=String(x.getDate()).padStart(2,"0");return`${d}-${C}-${T}`},M=x=>{let d=String(x??"").replace(/\D/g,"");if(d.length<8)return null;let C=Number(d.slice(0,4)),T=Number(d.slice(4,6)),$=Number(d.slice(6,8));if(!C||!T||!$)return null;let U=new Date(C,T-1,$);if(U.getFullYear()!==C||U.getMonth()!==T-1||U.getDate()!==$)return null;let oe=y(w);if(oe&&U<oe)return null;let ee=y(k);return ee&&U>ee?null:U},S=br(y(t)),L=br(B(S.get())),I=br(!1);kt(t).change(x=>{let d=y(x);if(!z(d,S.get())){if(d==null){S.set(null),L.set("");return}S.set(d),L.set(B(d))}}),kt(L).change(x=>{let d=M(x);d&&(z(d,S.get())||(S.set(d),c?.(d)))});let v=x=>{x&&(z(x,S.get())||(S.set(x),L.set(B(x)),c?.(x),I.set(!1)))};return fr({opened:I,onChange:x=>I.set(!!x),content:ai({size:N("",n,"xs"),value:S,onChange:v}),className:"g-ui-date-input-popover"},fe({...f,size:a,className:o("g-ui-dateinput",m),leftSection:u,rightSection:g,type:"text",inputMode:"numeric",format:b,value:L,onChange:x=>L.set(x)}))}import{Div as xr,when as fs,after as vs,state as hs}from"@granularjs/core";function bs(...e){let{props:i,rawProps:r,children:t}=s(e),{opened:a,content:n,className:u,...g}=i,{onChange:m}=r,b=hs(l(a)??!1);vs(a).change(k=>{let f=l(k);f!=null&&b.set(!!f)});let w=k=>{b.set(k),m?.(k)};return xr({...g,className:o("g-ui-popper",u)},xr({onClick:()=>w(!b.get())},t),fs(b,()=>xr({className:"g-ui-popper-dropdown"},n)))}import{Button as xs,after as zt,when as ws,state as ys}from"@granularjs/core";function ks(...e){let{props:i,rawProps:r}=s(e,{size:"md"}),{size:t,className:a,rightSection:n,...u}=i,{onChange:g}=r,m=ys(!1),b=zt(m).compute(k=>k?"text":"password"),w=zt(n).compute(k=>k??xs({className:"g-ui-password-toggle",onClick:()=>m.set(!m.get())},ws(m,()=>"Hide",()=>"Show")));return fe({...u,size:t,className:a,onChange:g,rightSection:w,type:b})}import{Div as zs}from"@granularjs/core";function Ns(...e){let{props:i}=s(e,{size:"md"}),{size:r,className:t,...a}=i;return fe({...a,size:r,className:t,leftSection:zs({className:"g-ui-search-input-left-section",innerHTML:Or}),type:"text",inputMode:"search"})}import{Button as Cs,after as Ss,when as Nt}from"@granularjs/core";import{state as Ds}from"@granularjs/core";function Ps(...e){let{props:i,children:r}=s(e,{value:"",timeout:1500}),{value:t,timeout:a,className:n,...u}=i,g=Ds(!1),m=Ss(g).compute(w=>o("g-ui-copy-button",w&&"g-ui-copy-button-done",n));return Cs({...u,className:m,onClick:async()=>{try{await navigator.clipboard.writeText(String(t)),g.set(!0),setTimeout(()=>g.set(!1),a)}catch{}},type:"button"},Nt(r?.length,()=>r,()=>Nt(g,()=>"Copied",()=>"Copy")))}import{Div as Ct,after as ui,resolve as Ms}from"@granularjs/core";function St(e){let i=Number(e);return Number.isNaN(i)?0:Math.max(0,Math.min(100,i))}function Ts(...e){let{props:i}=s(e,{size:"md",value:null,color:"primary"}),{size:r,value:t,color:a,className:n,...u}=i,g=ui(t).compute(f=>f!=null&&f!==""),m=ui(t).compute(f=>St(f)),b=ui(m,g).compute(([f,c])=>{if(!c)return{};let y=Number(f),z=Number.isNaN(y)?0:Math.max(0,Math.min(360,y*3.6));return{background:`conic-gradient(var(--g-ui-progress-ring-fill, var(--g-ui-primary)) 0deg ${z}deg, var(--g-ui-border-muted) ${z}deg 360deg)`}}),w=ui(g).compute(f=>f?"":"g-ui-progress-ring-indeterminate"),k=ui(g,t).compute(([f,c])=>f?St(c):void 0);return Ct({...u,className:o("g-ui-progress-ring",N("g-ui-progress-ring-",a,"primary"),[r,f=>`g-ui-progress-ring-size-${Ms(f)??"md"}`],w,n),style:b,role:"progressbar","aria-valuemin":0,"aria-valuemax":100,"aria-valuenow":k},Ct({className:"g-ui-progress-ring-hole"}))}import{Div as wr,Button as Vs,when as Dt}from"@granularjs/core";function Ls(...e){let{props:i,children:r}=s(e),{title:t,onClose:a,className:n,...u}=i;return wr({...u,className:o("g-ui-toast",n)},wr({className:"g-ui-toast-row"},Dt(t,()=>wr({className:"g-ui-toast-title"},t)),Dt(a,()=>Vs({className:"g-ui-toast-close",onClick:a},"\xD7"))),r)}import{Div as Vi,state as kr,after as Re,list as $s,when as As}from"@granularjs/core";import{Div as Is}from"@granularjs/core";function yr(...e){let{props:i,children:r}=s(e,{size:"md"}),{size:t,className:a,...n}=i;return Is({...n,className:o("g-ui-scroll-area",[t,u=>`g-ui-scroll-area-${u}`],a)},r)}function Me(e,i){if(i==null||i==="")return e;let r=String(i).trim().split("."),t=e;for(let a of r)t=t?.[a];return t}function Bs(e,i,r){let t=r(i);return String(t??"").toLowerCase().includes(String(e??"").toLowerCase())}function zr(...e){let{props:i,rawProps:r}=s(e,{data:[],size:"md",valuePath:"value",labelPath:"label"}),{data:t,value:a,size:n,valuePath:u,labelPath:g,filter:m,placeholder:b,label:w,description:k,error:f,leftSection:c,rightSection:y,className:z,inputClassName:B,disabled:M,...S}=i,{onChange:L,renderItem:I}=r,v=kr(!1),x=kr(""),d=kr(l(a));Re(a).change(h=>{let F=l(h);F!==d.get()&&d.set(F)});let C=Re(t).compute(h=>Array.isArray(h)?h:[]),T=Re(C,d,u).compute(([h,F,E])=>{if(F==null)return null;let G=K=>E==null||E===""?K:Me(K,E);return h.find(K=>G(K)===F)??null}),$=Re(T,v,x,g).compute(([h,F,E,G])=>{let K=le=>G==null||G===""?String(le??""):String(Me(le,G)??"");return F?E??"":h?K(h):""}),U=Re(C,x,m,g).compute(([h,F,E,G])=>{let K=ve=>G==null||G===""?String(ve??""):String(Me(ve,G)??""),le=l(E)??Bs;return h.filter(ve=>le(F,ve,K))}),oe=h=>{let F=l(u),E=F==null||F===""?h:Me(h,F);d.set(E),x.set(""),v.set(!1),L?.(E)},ee=()=>{if(l(M))return;v.set(!0);let h=T.get(),F=l(g),E=G=>F==null||F===""?String(G??""):String(Me(G,F)??"");x.set(h?E(h):"")},ne=()=>{v.set(!1);let h=T.get(),F=l(g),E=G=>F==null||F===""?String(G??""):String(Me(G,F)??"");x.set(h?E(h):"")},{onChange:J,...se}=S,ge={...se,size:n,label:w,description:k,error:f,leftSection:c,rightSection:y,placeholder:l(b)??void 0,disabled:M,value:$,onInput:h=>x.set(h?.target?.value??""),onFocus:ee,onClick:ee,onBlur:()=>setTimeout(()=>ne(),150)},re=h=>{let F=l(u);return F==null||F===""?h:Me(h,F)},P=h=>Re(d,u).compute(([F,E])=>(K=>E==null||E===""?K:Me(K,E))(h)===F?"g-ui-autocomplete-item-active":""),O=h=>{if(I&&typeof I=="function"){let F=I(h);if(F!=null)return Vi({className:o("g-ui-autocomplete-item",P(h)),onClick:()=>oe(h),role:"option"},F)}return Vi({className:o("g-ui-autocomplete-item",P(h)),onClick:()=>oe(h),role:"option"},Re(g).compute(F=>F==null||F===""?String(h??""):String(Me(h,F)??"")))};return Vi({className:o("g-ui-autocomplete",z,W("g-ui-autocomplete-disabled",M))},fe({...ge,className:o("g-ui-autocomplete-input-wrapper",ge.className),inputClassName:o("g-ui-autocomplete-input",B)}),As(v,()=>Vi({className:"g-ui-autocomplete-dropdown",role:"listbox"},yr({className:"g-ui-autocomplete-list",style:{maxHeight:"240px"}},$s(U,h=>O(h))))))}function Fs(...e){return zr(...e)}import{Div as js}from"@granularjs/core";function Es(...e){let{props:i,children:r}=s(e),{className:t,...a}=i;return js({...a,className:o("g-ui-switch-group",t)},r)}import{Div as Rs,Span as Hs,state as Pt,after as Os}from"@granularjs/core";function Mt(e){let i=l(e);if(i instanceof Date)return i;if(i==null||i==="")return null;let r=new Date(i);return Number.isNaN(r.getTime())?null:r}function Tt(e){let i=l(e);if(i==null)return[null,null];let r=Array.isArray(i)?i:[i];return[Mt(r[0]),Mt(r[1])]}function Vt(e,i){return!e||!i?e===i:e.getFullYear()===i.getFullYear()&&e.getMonth()===i.getMonth()&&e.getDate()===i.getDate()}function Ys(...e){let{props:i,rawProps:r}=s(e,{size:"md"}),{value:t,size:a,minDate:n,maxDate:u,className:g,placeholderMin:m,placeholderMax:b,...w}=i,{onChange:k}=r,[f,c]=Tt(t),y=Pt(f),z=Pt(c);Os(t).change(L=>{let[I,v]=Tt(L);Vt(I,y.get())&&Vt(v,z.get())||(y.set(I),z.set(v))});let B=()=>{let L=y.get(),I=z.get();k?.([L??null,I??null])},M=L=>{let I=z.get();L&&I&&L>I&&z.set(L),y.set(L),B()},S=L=>{let I=y.get();L&&I&&L<I&&y.set(L),z.set(L),B()};return Rs({...w,className:o("g-ui-range-picker",i.className??g)},Ti({...w,size:a,value:y,onChange:M,maxDate:z,placeholder:l(m)??void 0}),Hs({className:"g-ui-range-picker-separator"},"\u2013"),Ti({...w,size:a,value:z,onChange:S,minDate:y,placeholder:l(b)??void 0}))}import{Div as qs}from"@granularjs/core";function Ws(...e){let{props:i,children:r}=s(e,{align:"center",direction:"row"}),{direction:t,wrap:a,align:n,justify:u,gap:g,className:m,...b}=i;return qs({...b,className:o("g-ui-flex",[t,w=>w==="column"?"g-ui-flex-column":"g-ui-flex-row"],[a,"g-ui-flex-wrap"],[n,w=>w&&`g-ui-align-${w}`],[u,w=>w&&`g-ui-justify-${w}`],[g,w=>w&&`g-ui-gap-${w}`],m)},r)}import{A as Zs,Div as gi,Span as Lt,when as li,after as It,state as Gs}from"@granularjs/core";function Us(...e){let{props:i,rawProps:r,children:t}=s(e,{variant:"subtle",childrenOffset:24}),{label:a,description:n,leftSection:u,rightSection:g,active:m,disabled:b,variant:w,childrenOffset:k,opened:f,defaultOpened:c,className:y,padding:z,...B}=i,{onClick:M,onChange:S}=r,L=t.length>0,I=Gs(l(f)??l(c)??!1);It(f).change(d=>{let C=l(d);C!=null&&I.set(!!C)});let v=It(k).compute(d=>({paddingLeft:Br(l(d??24))??"24px"})),x=d=>{if(l(b)){d?.preventDefault?.();return}if(L){let C=!I.get();I.set(C),S?.(C)}M?.(d)};return gi({className:o("g-ui-navlink-root",y)},Zs({...B,className:o("g-ui-navlink",N("g-ui-navlink-variant-",w,"subtle"),W("g-ui-navlink-active",m),W("g-ui-navlink-disabled",b),N("g-ui-navlink-padding-",z,"md")),onClick:x},li(u,()=>Lt({className:"g-ui-navlink-section g-ui-navlink-left"},u)),gi({className:"g-ui-navlink-body"},li(a,()=>gi({className:"g-ui-navlink-label"},a)),li(n,()=>gi({className:"g-ui-navlink-description"},n))),li(g,()=>Lt({className:"g-ui-navlink-section g-ui-navlink-right"},g))),L?li(I,()=>gi({className:"g-ui-navlink-children",style:v},t)):null)}import{Div as $t,when as Xs}from"@granularjs/core";function _s(...e){let{props:i,children:r}=s(e,{show:!0,position:"top-right",color:"danger",size:"md"}),{show:t,position:a,color:n,size:u,className:g,...m}=i;return $t({...m,className:o("g-ui-indicator",N("g-ui-indicator-position-",a,"top-right"),N("g-ui-indicator-color-",n,"danger"),N("g-ui-indicator-size-",u,"md"),g)},r,Xs(t,()=>$t({className:"g-ui-indicator-badge"})))}import{Span as Li}from"@granularjs/core";function Ks(...e){let{props:i}=s(e),{opened:r,className:t,...a}=i;return Li({...a,className:o("g-ui-burger",[r,"g-ui-burger-open"],t)},Li(""),Li(""),Li(""))}import{Div as Qs,when as Js}from"@granularjs/core";function eu(...e){let{props:i}=s(e),{visible:r,...t}=i;return Js(r,()=>Qs({...t,className:"g-ui-loading-overlay"},ei({})))}import{Div as iu}from"@granularjs/core";function ru(...e){let{props:i,children:r}=s(e,{gap:"md"}),{className:t,gap:a,...n}=i;return iu({...n,className:o("g-ui-grid-system",[a,u=>`g-ui-gap-${u}`],t)},r)}import{Div as tu}from"@granularjs/core";function au(...e){let{props:i,children:r}=s(e,{span:12}),{span:t,className:a,...n}=i;return tu({...n,className:o([t,u=>`g-ui-col-span-${u}`],a)},r)}import{Div as At,Input as ou,after as Te,state as Nr,when as Bt,list as nu}from"@granularjs/core";function su(...e){let{props:i,rawProps:r}=s(e,{length:4,size:"md",type:"alphanumeric",mask:!1,placeholder:"\u25CB",disabled:!1,error:!1,oneTimeCode:!1}),{length:t,value:a,size:n,type:u,mask:g,placeholder:m,disabled:b,error:w,oneTimeCode:k,className:f}=i,{onChange:c,onComplete:y}=r,z=Nr(l(t)??4),B=()=>z.get();Te(t).change(P=>{let O=l(P)??4,h=z.get();if(O===h)return;z.set(O);let F=S.get(),E=M.get();S.set(Array.from({length:O},(G,K)=>F[K]??"")),M.set(Array.from({length:O},(G,K)=>E[K]??null))});let M=Nr(Array.from({length:B()},()=>null)),S=Nr(Array.from({length:B()},(P,O)=>{let h=l(a);return typeof h=="string"||Array.isArray(h)?h[O]??"":""}));Te(a).change(P=>{if(P==null)return;let O=B();typeof P=="string"?S.set(Array.from({length:O},(h,F)=>P[F]??"")):Array.isArray(P)&&S.set(Array.from({length:O},(h,F)=>P[F]??""))});let L=()=>S.get().join(""),I=P=>{S.set(P);let O=P.join("");c?.(O),P.every(h=>h!=="")&&P.length===B()&&y?.(O)},v=P=>{let O=B(),h=M.get();P>=0&&P<O&&h[P]&&(h[P].focus(),h[P].select())},x=()=>{let P=l(u);return P==="number"?/^[0-9]$/:P instanceof RegExp?P:/^[a-zA-Z0-9]$/},d=(P,O)=>{let h=O.target.value,F=x();if(h.length>1){C(P,h);return}if(h&&!F.test(h)){O.target.value=S.get()[P]??"";return}let E=S.get().slice();E[P]=h,I(E),h&&P<B()-1&&v(P+1)},C=(P,O)=>{let h=x(),F=O.split("").filter(le=>h.test(le)),E=S.get().slice(),G=B();F.forEach((le,ve)=>{let Se=P+ve;Se<G&&(E[Se]=le)}),I(E);let K=E.findIndex((le,ve)=>ve>=P&&le==="");K>=0?v(K):v(Math.min(P+F.length,G-1))},T=(P,O)=>{if(O.key==="Backspace"){let h=S.get().slice();h[P]===""&&P>0?(O.preventDefault(),h[P-1]="",I(h),v(P-1)):h[P]!==""&&(h[P]="",I(h))}else O.key==="ArrowLeft"&&P>0?(O.preventDefault(),v(P-1)):O.key==="ArrowRight"&&P<B()-1&&(O.preventDefault(),v(P+1))},$=(P,O)=>{O.target.select()},U=()=>{let P=S.get(),O=P.findIndex(h=>h==="");O>=0?v(O):v(P.length-1)},oe=Te(g).compute(P=>l(P)?"password":"text"),ee=Te(u).compute(P=>l(P)==="number"?"numeric":"text"),ne=Te(k).compute(P=>l(P)?"one-time-code":"off"),J=Te(b).compute(P=>!!l(P)),se=Te(w).compute(P=>!!l(P)),ge=Te(z).compute(P=>Array.from({length:P},(O,h)=>h)),re=P=>ou({className:o("g-ui-pin-input-field",Bt(se,()=>"g-ui-pin-input-error")),type:oe,inputMode:ee,autocomplete:ne,maxLength:2,placeholder:Bt(J,()=>"",()=>m),disabled:J,value:Te(S,P).compute(([O,h])=>O[h]??""),node:M[P.get()],onInput:O=>d(P.get(),O),onChange:O=>d(P.get(),O),onKeyDown:O=>T(P.get(),O),onFocus:O=>$(P.get(),O)});return At({className:o("g-ui-pin-input",N("g-ui-input-size-",n,"md"),f),onClick:U},At({className:"g-ui-pin-input-wrapper"},nu(ge,re)))}import{Div as uu}from"@granularjs/core";function gu(...e){let{props:i,children:r}=s(e),{className:t,...a}=i;return uu({...a,className:o("g-ui-checkbox-group",t)},r)}import{Div as lu}from"@granularjs/core";function cu(...e){let{props:i,children:r}=s(e),{className:t,...a}=i;return lu({...a,className:o("g-ui-avatar-group",t)},r)}import{Div as pu}from"@granularjs/core";function du(...e){let{props:i,children:r}=s(e),{className:t,...a}=i;return pu({...a,className:o("g-ui-badge-group",t)},r)}import{Div as Ii,Span as mu,after as ci,context as Ft}from"@granularjs/core";var fu=Ft([]),jt=Ft({sort:null,onSort:null});function Cr(...e){let{props:i,rawProps:r,children:t}=s(e,{sizes:[],sort:null,stickyHeader:!1}),{className:a,sizes:n,sort:u,stickyHeader:g,...m}=i,{onSort:b}=r,w=fu.scope(n.get());ci(n).change(f=>w.set(f));let k=jt.scope({sort:u.get(),onSort:b||null});return ci(u).change(f=>k.set().sort=f),w.serve(k.serve(Ii({className:o("g-ui-grid-table",W("g-ui-grid-table-sticky",g),a),style:{gridTemplateColumns:ci(w).compute(f=>Array.isArray(f)?f.join(" "):"")},...m},t)))}Cr.GridRow=(...e)=>{let{props:i,children:r}=s(e,{}),{className:t,header:a,...n}=i;return Ii({className:o("g-ui-grid-table-row",W("g-ui-grid-table-row-header",a),t),...n},...r)};Cr.GridCell=function(...e){let{props:i,rawProps:r,children:t}=s(e,{}),{className:a,sort:n,...u}=i,g=r.sort;if(g){let m=jt.state(),b=ci(m.sort).compute(k=>k?.key===g?k.direction:null),w=()=>{let k=m.get().sort,f;k?.key===g?f=k.direction==="asc"?{key:g,direction:"desc"}:null:f={key:g,direction:"asc"},m.set().sort=f;let{onSort:c}=m.get();c&&c(f)};return Ii({className:o("g-ui-grid-table-cell","g-ui-grid-table-cell-sortable",a),onClick:w,...u},t,mu({className:"g-ui-grid-table-sort-icon"},ci(b).compute(k=>k==="asc"?" \u2191":k==="desc"?" \u2193":"")))}return Ii({className:o("g-ui-grid-table-cell",a),...u},t)};import{Button as vu,Div as hu,Span as Et,when as Rt}from"@granularjs/core";function Ht(...e){let{props:i,children:r}=s(e,{grow:!0}),{grow:t,className:a,...n}=i;return hu({...n,className:o("g-ui-bottombar",W("g-ui-bottombar-grow",t),a)},r)}Ht.Action=function(...i){let{props:r,rawProps:t,children:a}=s(i,{variant:"subtle"}),{icon:n,label:u,active:g,disabled:m,variant:b,className:w,...k}=r,{onClick:f}=t;return vu({...k,className:o("g-ui-bottombar-action",N("g-ui-bottombar-action-variant-",b,"subtle"),W("g-ui-bottombar-action-active",g),W("g-ui-bottombar-action-disabled",m),w),onClick:f,disabled:m},Rt(n,()=>Et({className:"g-ui-bottombar-action-icon"},n)),Rt(u,()=>Et({className:"g-ui-bottombar-action-label"},u)),a)};import{Div as R,Button as He,state as ce,after as ye,when as pe,Input as $i,Label as pi,Span as Oe}from"@granularjs/core";var bu=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],xu=[{value:"day",label:"Day"},{value:"week",label:"Week"},{value:"month",label:"Month"}];function Ai(e){if(e instanceof Date)return e;if(e==null)return null;let i=new Date(e);return Number.isNaN(i.getTime())?null:i}function qt(e){let i=Ai(e.start),r=Ai(e.end);return!i||!r?null:{...e,id:e.id??`${i.getTime()}-${e.title??"event"}`,title:e.title??"",start:i,end:r,allDay:!!e.allDay,description:e.description??"",location:e.location??"",attendees:Array.isArray(e.attendees)?e.attendees:[],color:e.color??null}}function Wt(e,i,r){let t=Ai(i).getTime(),a=Ai(r).getTime();return e.map(qt).filter(Boolean).filter(n=>n.end.getTime()>t&&n.start.getTime()<a)}function Ot(e,i){let r=new Date(i);r.setHours(0,0,0,0);let t=r.getTime();r.setHours(23,59,59,999);let a=r.getTime();return Wt(e,t,a)}function Sr(e,i){let r=new Date(e),a=(r.getDay()-i+7)%7;return r.setDate(r.getDate()-a),r.setHours(0,0,0,0),r}function Xe(e,i="default"){return e.toLocaleTimeString(i,{hour:"numeric",minute:"2-digit",hour12:!0})}function di(e,i="default"){return e.toLocaleDateString(i,{weekday:"short",month:"short",day:"numeric"})}function wu(e,i="default"){return e.toLocaleDateString(i,{month:"long",year:"numeric"})}function yu(e,i="default"){let r=new Date(e);return r.setDate(r.getDate()+6),`${e.toLocaleDateString(i,{month:"short",day:"numeric"})} \u2013 ${r.toLocaleDateString(i,{month:"short",day:"numeric",year:"numeric"})}`}function Yt(e,i,r,t){let a=new Date(e).setHours(r,0,0,0),n=new Date(e).setHours(t,0,0,0),u=(t-r)*60,g=Math.max(e.getTime(),a),b=(Math.min(i.getTime(),n)-g)/6e4,w=(g-a)/6e4/u*100,k=b/u*100;return{top:w,height:k}}function ku(...e){let{props:i,rawProps:r}=s(e,{defaultView:"month",firstDayOfWeek:0,locale:"default",hourSlotDuration:30,minTime:6,maxTime:22,eventCreationColorOptions:[]}),{events:t=[],defaultView:a,firstDayOfWeek:n,locale:u,hourSlotDuration:g,minTime:m,maxTime:b,eventCreationColorOptions:w,className:k,...f}=i,{onCreateEventRequest:c,onViewEventRequest:y,onUpdateEventRequest:z,onRemoveEventRequest:B,eventCreationEmailLookup:M,eventCreationLocationsCallback:S,eventCreationCalendarsCallback:L,onSlotClick:I,onDateRangeChange:v}=r,x=ce(l(a)??"month"),d=ce(new Date),C=ce(null),T=ce(null),$=ce({title:"",start:null,end:null,allDay:!1,description:"",location:"",attendees:[],color:null}),U=ye(t).compute(p=>Array.isArray(p)?p:[]),oe=d.get(),ee=Sr(oe,l(n)??0),ne=l(m)??6,J=l(b)??22,se=l(g)??30,ge=()=>{let p=new Date(d.get());x.get()==="month"?p.setMonth(p.getMonth()-1):x.get()==="week"?p.setDate(p.getDate()-7):p.setDate(p.getDate()-1),d.set(p),v?.({start:p,end:p,view:x.get()})},re=()=>{let p=new Date(d.get());x.get()==="month"?p.setMonth(p.getMonth()+1):x.get()==="week"?p.setDate(p.getDate()+7):p.setDate(p.getDate()+1),d.set(p),v?.({start:p,end:p,view:x.get()})},P=()=>{let p=new Date;d.set(p),v?.({start:p,end:p,view:x.get()})},O=(p,j,ue=!1)=>{let q=p?new Date(p):new Date(d.get()),te=j?new Date(j):new Date(q.getTime()+3600*1e3);ue&&(q.setHours(0,0,0,0),te.setHours(23,59,59,999)),$.set({title:"",start:q,end:te,allDay:ue,description:"",location:"",attendees:[],color:null}),C.set("create")},h=p=>{T.set(qt(p)),C.set("view"),y?.(p)},F=()=>{let p=T.get();p&&($.set({title:p.title,start:new Date(p.start),end:new Date(p.end),allDay:p.allDay,description:p.description??"",location:p.location??"",attendees:[...p.attendees||[]],color:p.color??null}),C.set("edit"))},E=()=>{C.set(null),T.set(null)},G=(p,j,ue)=>{if(I){I({date:p,hour:j,allDay:ue});return}let q=new Date(p);if(ue){q.setHours(0,0,0,0);let te=new Date(q);te.setHours(23,59,59,999),O(q,te,!0)}else{q.setHours(j,0,0,0);let te=new Date(q.getTime()+se*60*1e3);O(q,te,!1)}},K=()=>{let p=$.get();!p.start||!p.end||c?.({title:p.title,start:p.start,end:p.end,allDay:p.allDay,description:p.description,location:p.location,attendees:p.attendees,color:p.color},()=>{E()})},le=()=>{let p=T.get(),j=$.get();!p||!j.start||!j.end||z?.(p,{title:j.title,start:j.start,end:j.end,allDay:j.allDay,description:j.description,location:j.location,attendees:j.attendees,color:j.color},()=>E())},ve=()=>{let p=T.get();p&&B?.(p,()=>E())},Se=ye(x,d).compute(([p,j])=>p==="month"?wu(j,l(u)):p==="week"?yu(Sr(j,l(n)??0),l(u)):di(j,l(u))),Ie=R({className:"g-ui-event-calendar-header"},R({className:"g-ui-event-calendar-nav-group"},Ee({size:"sm",variant:"subtle",onClick:ge,className:"g-ui-event-calendar-nav"},we({size:"sm",innerHTML:bi})),Ee({size:"sm",variant:"subtle",onClick:re,className:"g-ui-event-calendar-nav"},we({size:"sm",innerHTML:hi})),He({type:"button",variant:"subtle",size:"sm",className:"g-ui-event-calendar-today",onClick:P},we({size:"sm",className:"g-ui-event-calendar-today-icon",innerHTML:Zr}),"Today")),R({className:"g-ui-event-calendar-title"},Se),R({className:"g-ui-event-calendar-actions"},xu.map(p=>R({className:o("g-ui-event-calendar-view-option",ye(x).compute(j=>j===p.value?"g-ui-event-calendar-view-option-active":"")),onClick:()=>{x.set(p.value),v?.({start:d.get(),end:d.get(),view:p.value})}},p.label)),He({type:"button",variant:"filled",size:"sm",className:"g-ui-event-calendar-create-btn",onClick:()=>O(d.get(),null,!1)},we({size:"sm",innerHTML:Yr}),"Create"))),mi=ye(d,U,n).compute(([p,j,ue])=>{let q=p.getFullYear(),te=p.getMonth(),ie=(new Date(q,te,1).getDay()-(ue??0)+7)%7,Ce=new Date(q,te+1,0).getDate(),De=new Date(q,te,0).getDate(),V=[],D=1,H=1,Y=Math.ceil((ie+Ce)/7)*7,Q=[];for(let X=0;X<Y;X+=1){let Z,_,ae;X<ie?(Z=De-ie+X+1,ae=new Date(q,te-1,Z),_=!1):D<=Ce?(Z=D,ae=new Date(q,te,Z),_=!0,D+=1):(Z=H,ae=new Date(q,te+1,Z),_=!1,H+=1);let he=Ot(j,ae),Ve=ae.getDate()===new Date().getDate()&&ae.getMonth()===new Date().getMonth()&&ae.getFullYear()===new Date().getFullYear();Q.push(R({key:ae.getTime(),className:o("g-ui-event-calendar-month-cell",!_&&"g-ui-event-calendar-month-cell-outside",Ve&&"g-ui-event-calendar-month-cell-today")},R({className:"g-ui-event-calendar-month-cell-header",onClick:()=>G(ae,0,!0)},Oe({className:"g-ui-event-calendar-month-cell-day"},ae.getDate())),R({className:"g-ui-event-calendar-month-cell-events"},he.slice(0,3).map(ke=>R({key:ke.id,className:"g-ui-event-calendar-month-event",style:ke.color?{borderLeftColor:ke.color,backgroundColor:`${ke.color}20`}:{},onClick:Ri=>{Ri.stopPropagation(),h(ke)}},ke.title||"(No title)")),pe(he.length>3,()=>R({className:"g-ui-event-calendar-month-more",onClick:ke=>{ke.stopPropagation(),h(he[3])}},`+${he.length-3} more`)))))}return Q}),Bi=R({className:"g-ui-event-calendar-month"},R({className:"g-ui-event-calendar-weekdays"},bu.map(p=>R({key:p,className:"g-ui-event-calendar-weekday"},p))),R({className:"g-ui-event-calendar-month-grid"},mi)),Ne=[];for(let p=ne;p<J;p+=1)for(let j=0;j<60;j+=se)Ne.push(p+j/60);let _e=ye(d,n).compute(([p,j])=>{let ue=Sr(p,j??0),q=[];for(let te=0;te<7;te+=1){let de=new Date(ue);de.setDate(de.getDate()+te),q.push(de)}return q}),Fi=R({className:"g-ui-event-calendar-week"},ye(_e).compute(p=>R({className:"g-ui-event-calendar-week-days"},R({className:"g-ui-event-calendar-week-time-col"},""),(p||[]).map(j=>R({key:j.getTime(),className:"g-ui-event-calendar-week-day-col"},R({className:"g-ui-event-calendar-week-day-header"},di(j,l(u))))))),R({className:"g-ui-event-calendar-week-body"},R({className:"g-ui-event-calendar-week-time-col"},Ne.map(p=>{let j=Math.floor(p),ue=(p-j)*60,q=`${j<=12?j:j-12}:${ue===0?"00":ue} ${j<12?"AM":"PM"}`;return R({key:p,className:"g-ui-event-calendar-week-slot-label"},q)})),ye(_e,U).compute(([p,j])=>{if(!p||!p.length)return null;let ue=p[0],q=new Date(p[6]);q.setHours(23,59,59,999);let te=Wt(j,ue,q);return R({className:"g-ui-event-calendar-week-grid-cols"},p.map(de=>R({key:de.getTime(),className:"g-ui-event-calendar-week-day-col g-ui-event-calendar-week-day-col-body"},Ne.map(ie=>R({key:ie,className:"g-ui-event-calendar-week-slot",onClick:()=>G(de,ie,!1)})),te.filter(ie=>!ie.allDay&&ie.start.getDate()===de.getDate()&&ie.start.getMonth()===de.getMonth()&&ie.start.getFullYear()===de.getFullYear()).map(ie=>{let{top:Ce,height:De}=Yt(ie.start,ie.end,ne,J);return R({key:ie.id,className:"g-ui-event-calendar-week-event",style:{top:`${Ce}%`,height:`${De}%`,borderLeftColor:ie.color||"var(--g-ui-primary)"},onClick:V=>{V.stopPropagation(),h(ie)}},R({className:"g-ui-event-calendar-week-event-title"},ie.title||"(No title)"),pe(!ie.allDay,()=>Oe({className:"g-ui-event-calendar-week-event-time"},`${Xe(ie.start,l(u))} \u2013 ${Xe(ie.end,l(u))}`)))}))))}))),ji=R({className:"g-ui-event-calendar-day"},R({className:"g-ui-event-calendar-day-body"},R({className:"g-ui-event-calendar-day-time-col"},Ne.map(p=>{let j=Math.floor(p),ue=(p-j)*60,q=`${j<=12?j:j-12}:${ue===0?"00":ue} ${j<12?"AM":"PM"}`;return R({key:p,className:"g-ui-event-calendar-day-slot-label"},q)})),R({className:"g-ui-event-calendar-day-slots"},Ne.map(p=>R({key:p,className:"g-ui-event-calendar-day-slot",onClick:()=>G(d.get(),p,!1)})),ye(U,d).compute(([p,j])=>j?Ot(p,j).filter(q=>!q.allDay).map(q=>{let{top:te,height:de}=Yt(q.start,q.end,ne,J);return R({key:q.id,className:"g-ui-event-calendar-day-event",style:{top:`${te}%`,height:`${de}%`,borderLeftColor:q.color||"var(--g-ui-primary)"},onClick:ie=>{ie.stopPropagation(),h(q)}},R({className:"g-ui-event-calendar-day-event-title"},q.title||"(No title)"),Oe({className:"g-ui-event-calendar-day-event-time"},`${Xe(q.start,l(u))} \u2013 ${Xe(q.end,l(u))}`))}):[])))),fi=p=>{let j=$.get(),ue=new Date,q=j.start||ue,te=j.end||new Date(ue.getTime()+3600*1e3),de=ce(j.title),ie=ce(q.toISOString().slice(0,10)),Ce=ce(!j.allDay&&q?q.toTimeString().slice(0,5):"09:00"),De=ce(te.toISOString().slice(0,10)),V=ce(!j.allDay&&te?te.toTimeString().slice(0,5):"10:00"),D=ce(j.allDay),H=ce(j.description),Y=ce(j.location),Q=ce(j.attendees||[]),X=ce(""),Z=ce([]),_=ce([]),ae=ce(""),he=Array.isArray(w)?w:[],Ve=ce(j.color),ke=()=>{let A=new Date(ie.get()+"T"+(D.get()?"00:00:00":Ce.get()+":00")),be=new Date(De.get()+"T"+(D.get()?"23:59:59":V.get()+":00"));$.set({title:de.get(),start:A,end:be,allDay:D.get(),description:H.get(),location:Y.get(),attendees:Q.get(),color:Ve.get()})},Ri=A=>{if(X.set(A),!M||!A.trim()){Z.set([]);return}Promise.resolve(M(A.trim())).then(be=>Z.set(Array.isArray(be)?be:[])).catch(()=>Z.set([]))},Zt=A=>{let be=Q.get();be.some(Pr=>(Pr.email||Pr.id)===(A.email||A.id))||(Q.set([...be,{id:A.id,email:A.email??A.label,label:A.label}]),X.set(""),Z.set([]))},Gt=A=>{let be=[...Q.get()];be.splice(A,1),Q.set(be)},Dr=()=>{S&&Promise.resolve(S(ae.get())).then(A=>_.set(Array.isArray(A)?A:[])).catch(()=>_.set([]))};return R({className:"g-ui-event-calendar-form"},R({className:"g-ui-event-calendar-form-row"},fe({label:"Title",placeholder:"Event title",value:de,onInput:A=>de.set(A?.target?.value??"")})),R({className:"g-ui-event-calendar-form-row g-ui-event-calendar-form-row-inline"},er({label:"All day",checked:D,onChange:A=>D.set(A)})),R({className:"g-ui-event-calendar-form-row g-ui-event-calendar-form-row-inline"},R({className:"g-ui-event-calendar-form-field"},pi({className:"g-ui-event-calendar-form-label"},"Start"),$i({type:"date",className:"g-ui-input g-ui-input-size-md",value:ie,onInput:A=>ie.set(A?.target?.value??"")}),pe(!D,()=>$i({type:"time",className:"g-ui-input g-ui-input-size-md",value:Ce,onInput:A=>Ce.set(A?.target?.value??"")}))),R({className:"g-ui-event-calendar-form-field"},pi({className:"g-ui-event-calendar-form-label"},"End"),$i({type:"date",className:"g-ui-input g-ui-input-size-md",value:De,onInput:A=>De.set(A?.target?.value??"")}),pe(!D,()=>$i({type:"time",className:"g-ui-input g-ui-input-size-md",value:V,onInput:A=>V.set(A?.target?.value??"")})))),pe(S,()=>R({className:"g-ui-event-calendar-form-row"},pi({className:"g-ui-event-calendar-form-label"},"Location"),fe({placeholder:"Search or type location",value:ae,onInput:A=>{ae.set(A?.target?.value??""),Dr()},onFocus:Dr}),pe(ye(_).compute(A=>A&&A.length>0),()=>R({className:"g-ui-event-calendar-form-suggestions"},_.get().map(A=>R({key:A.id??A.label,className:"g-ui-event-calendar-form-suggestion-item",onClick:()=>{Y.set(A.label??A.id),ae.set(""),_.set([])}},A.label??A.id)))),pe(ye(Y).compute(A=>!!A),()=>Oe({className:"g-ui-event-calendar-form-chip"},Y)))),pe(M,()=>R({className:"g-ui-event-calendar-form-row"},pi({className:"g-ui-event-calendar-form-label"},"Add guests"),fe({placeholder:"Type email to search",value:X,onInput:A=>Ri(A?.target?.value??"")}),R({className:"g-ui-event-calendar-form-chips"},Q.get().map((A,be)=>Oe({key:(A.email||A.id)+be,className:"g-ui-event-calendar-form-chip g-ui-event-calendar-form-chip-removable",onClick:()=>Gt(be)},A.label||A.email||A.id," \xD7"))),pe(ye(Z).compute(A=>A&&A.length>0),()=>R({className:"g-ui-event-calendar-form-suggestions"},Z.get().map(A=>R({key:A.id??A.email,className:"g-ui-event-calendar-form-suggestion-item",onClick:()=>Zt(A)},A.label??A.email??A.id)))))),R({className:"g-ui-event-calendar-form-row"},Ui({label:"Description",placeholder:"Add description",value:H,onInput:A=>H.set(A?.target?.value??"")})),pe(he.length>0,()=>R({className:"g-ui-event-calendar-form-row"},pi({className:"g-ui-event-calendar-form-label"},"Color"),R({className:"g-ui-event-calendar-form-colors"},he.map(A=>R({key:A.value??A.id??A,className:o("g-ui-event-calendar-form-color-swatch",ye(Ve).compute(be=>be===(A.value??A.id??A)?"g-ui-event-calendar-form-color-swatch-active":"")),style:{backgroundColor:A.color??A.value??A},onClick:()=>Ve.set(A.value??A.id??A)}))))),R({className:"g-ui-event-calendar-form-actions"},He({variant:"subtle",onClick:E},"Cancel"),He({variant:"filled",onClick:()=>{ke(),p?le():K()}},p?"Save":"Create")))},Ei=()=>{let p=T.get();return p?R({className:"g-ui-event-calendar-view-modal"},R({className:"g-ui-event-calendar-view-modal-title"},p.title||"(No title)"),R({className:"g-ui-event-calendar-view-modal-meta"},p.allDay?Oe({className:"g-ui-event-calendar-view-modal-date"},di(p.start,l(u))+(p.start.getTime()!==p.end.getTime()?` \u2013 ${di(p.end,l(u))}`:"")):Oe({className:"g-ui-event-calendar-view-modal-date"},`${di(p.start,l(u))} \xB7 ${Xe(p.start,l(u))} \u2013 ${Xe(p.end,l(u))}`)),pe(p.location,()=>R({className:"g-ui-event-calendar-view-modal-field"},"Location: ",p.location)),pe(p.description,()=>R({className:"g-ui-event-calendar-view-modal-field"},p.description)),pe(p.attendees?.length,()=>R({className:"g-ui-event-calendar-view-modal-field"},"Guests: ",p.attendees.map(j=>j.label||j.email||j.id).join(", "))),R({className:"g-ui-event-calendar-view-modal-actions"},He({variant:"subtle",size:"sm",onClick:F},we({size:"sm",innerHTML:qr})," Edit"),He({variant:"subtle",size:"sm",onClick:ve,className:"g-ui-event-calendar-view-modal-delete"},we({size:"sm",innerHTML:Wr})," Delete"),He({variant:"filled",size:"sm",onClick:E},"Close"))):null};return R({...f,className:o("g-ui-event-calendar",k)},Ie,pe(x,p=>p==="month",()=>Bi),pe(x,p=>p==="week",()=>Fi),pe(x,p=>p==="day",()=>ji),pe(C,p=>p==="create",()=>Je({opened:!0,title:"New event",size:"lg",onClose:E},fi(!1))),pe(C,p=>p==="view",()=>Je({opened:!0,title:"Event",size:"md",onClose:E},Ei())),pe(C,p=>p==="edit",()=>Je({opened:!0,title:"Edit event",size:"lg",onClose:E},fi(!0))))}import{state as zu}from"@granularjs/core";function Nu(e=!1){let i=zu(!!e);return[i,{open:()=>i.set(!0),close:()=>i.set(!1),toggle:()=>i.set(!i.get())}]}Tr();export{fo as Accordion,Ee as ActionIcon,Hn as Affix,Lo as Alert,Jo as Anchor,Gn as AppBar,zr as Autocomplete,Bo as Avatar,cu as AvatarGroup,La as Badge,du as BadgeGroup,Oo as Blockquote,Ht as BottomBar,Dn as Breadcrumbs,Ks as Burger,Wi as Button,ai as Calendar,Ta as Card,Mn as Center,er as Checkbox,gu as CheckboxGroup,pn as Chip,Ro as Code,au as Col,$n as Collapse,Na as Container,Ps as CopyButton,Ti as DateInput,us as DatePicker,Do as Divider,zo as Drawer,ku as EventCalendar,Wn as Fieldset,Ws as Flex,ru as Grid,Cr as GridTable,Pa as Group,En as HoverCard,we as Icon,rn as Image,_s as Indicator,jo as Kbd,nt as List,ei as Loading,eu as LoadingOverlay,wo as Menu,Je as Modal,ns as MultiSelect,Us as NavLink,or as Notification,cs as Notifications,Xi as NumberField,Ha as NumberInput,bn as Pagination,Mo as Paper,ks as PasswordInput,su as PinInput,fr as Popover,bs as Popper,tn as Progress,Ts as ProgressRing,kn as Radio,Nn as RadioGroup,Ys as RangePicker,ms as RangeSlider,is as Rating,yr as ScrollArea,Ns as SearchInput,fn as SegmentedControl,io as Select,Fs as SelectSearch,Xn as Sidebar,qo as SimpleGrid,gn as Skeleton,nn as Slider,Vn as Space,Sa as Stack,Jn as Stepper,Ja as Switch,Es as SwitchGroup,lo as Table,oo as Tabs,ts as Tag,Zi as Text,fe as TextInput,Ui as Textarea,Qn as Timeline,ka as Title,Ls as Toast,ss as ToastStack,vo as Tooltip,W as classFlag,me as classMap,N as classVar,o as cx,la as getThemeMode,ga as setThemeMode,ua as setThemeVars,s as splitPropsChildren,Nu as useDisclosure};
