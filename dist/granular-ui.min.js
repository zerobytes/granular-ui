...
`;function Ht(){if(typeof document>"u"||document.getElementById(Rt))return;let e=document.createElement("style");e.id=Rt,e.textContent=xa,document.head.appendChild(e)}var wa=new Set(["--g-ui-bg","--g-ui-bg-subtle","--g-ui-bg-muted","--g-ui-bg-emphasized","--g-ui-bg-inverted","--g-ui-bg-panel","--g-ui-fg","--g-ui-fg-muted","--g-ui-fg-subtle","--g-ui-fg-inverted","--g-ui-border","--g-ui-border-subtle","--g-ui-border-emphasized","--g-ui-border-inverted","--g-ui-primary","--g-ui-primary-hover","--g-ui-primary-active","--g-ui-primary-subtle","--g-ui-primary-muted","--g-ui-primary-emphasized","--g-ui-success","--g-ui-success-hover","--g-ui-success-active","--g-ui-success-subtle","--g-ui-success-muted","--g-ui-danger","--g-ui-danger-hover","--g-ui-danger-active","--g-ui-danger-subtle","--g-ui-danger-muted","--g-ui-warning","--g-ui-warning-hover","--g-ui-warning-active","--g-ui-warning-subtle","--g-ui-warning-muted","--g-ui-info","--g-ui-info-hover","--g-ui-info-active","--g-ui-info-subtle","--g-ui-info-muted","--g-ui-shadow-xs","--g-ui-shadow-sm","--g-ui-shadow-md","--g-ui-shadow-lg","--g-ui-shadow-xl","--g-ui-shadow-2xl","--g-ui-radius","--g-ui-font","--g-ui-surface","--g-ui-text","--g-ui-muted","--g-ui-primary-strong","--g-ui-shadow"]);function ya(e={},i=document?.documentElement){if(i)for(let[t,r]of Object.entries(e)){let a=t.startsWith("--")?t:`--g-ui-${t}`;wa.has(a)&&i.style.setProperty(a,String(r))}}function ka(e="dark",i=document?.documentElement){i&&(i.classList.remove("g-ui-theme-dark","g-ui-theme-light"),i.classList.add(e==="light"?"g-ui-theme-light":"g-ui-theme-dark"))}function za(e=document?.documentElement){return e.classList.contains("g-ui-theme-light")?"light":"dark"}import{Renderer as Ot,isSignal as Wt,isState as qt,isStatePath as Yt,isComputed as Gt,resolve as He,computed as Na,after as Gi,concat as Ca}from"@granularjs/core";function ti(e){return Wt(e)||qt(e)||Yt(e)||Gt(e)}function s(...e){return Ca(...e,{separator:" ",filterFalsy:!0})}function _t(e){if(!(e==null||e===""))return typeof e=="number"?`${e}px`:e}function g(e,i){let t={},r=[],a=o=>!!o&&typeof o=="object"&&!Array.isArray(o)&&!Ot.isRenderable(o)&&!Ot.isDomNode(o)&&!Wt(o)&&!qt(o)&&!Yt(o)&&!Gt(o);for(let o of e)a(o)?Object.assign(t,o):r.push(o);if(i&&typeof i=="object")for(let o of Object.keys(i))t[o]===void 0&&(t[o]=i[o]);return{props:Na(t),rawProps:t,children:r}}function m(e){return He(e)}function ze(e){return!!He(e)}function z(e,i,t){let r=a=>{let o=He(a),n=o==null||o===""?t:o;return n==null||n===""?"":`${e}${n}`};return ti(i)?Gi(i).compute(a=>r(a)):r(i)}function U(e,i){return ti(i)?Gi(i).compute(t=>He(t)?e:""):He(i)?e:""}function he(e,i,t){let r=a=>i[a]||null;return ti(e)?Gi(e).compute(a=>r(He(a??t))):r(He(e??t))}import{Button as Sa,Span as _i,when as Zi,after as Da}from"@granularjs/core";function Ui(...e){let{props:i,children:t}=g(e,{variant:"filled",size:"md",justify:"center"}),{variant:r,color:a,size:o,fullWidth:n,loading:u,leftSection:l,rightSection:p,className:d,disabled:w,justify:f,...c}=i,h=Da(w,u).compute(([k,V])=>k||V);return Sa({...c,disabled:h,className:s("g-ui-button",z("g-ui-button-variant-",r,"filled"),z("g-ui-button-color-",a,"primary"),z("g-ui-justify-",f,"center"),z("g-ui-button-size-",o,"md"),U("g-ui-button-full",n),U("g-ui-button-loading",u),d)},Zi(l,()=>_i({className:"g-ui-button-section-left"},l)),Zi(u,()=>_i("Loading..."),()=>t),Zi(p,()=>_i({className:"g-ui-button-section-right"},p)))}import{Span as Pa}from"@granularjs/core";function Xi(...e){let{props:i,children:t}=g(e,{size:"md"}),{size:r,weight:a,color:o,dimmed:n,align:u,ellipsis:l,decoration:p,className:d,style:w,...f}=i,c=he(a,{bold:"g-ui-text-weight-700",semibold:"g-ui-text-weight-600",medium:"g-ui-text-weight-500",700:"g-ui-text-weight-700",600:"g-ui-text-weight-600",500:"g-ui-text-weight-500",400:"g-ui-text-weight-400"}),h=he(o,{primary:"g-ui-text-primary",success:"g-ui-text-success",danger:"g-ui-text-danger",muted:"g-ui-text-dimmed"}),k=he(u,{center:"g-ui-text-align-center",right:"g-ui-text-align-right",left:"g-ui-text-align-left"}),V=he(p,{underline:"g-ui-text-decoration-underline","line-through":"g-ui-text-decoration-line-through",overline:"g-ui-text-decoration-overline",none:"g-ui-text-decoration-none"});return Pa({...f,style:w,className:s("g-ui-text",z("g-ui-text-size-",r,"md"),U("g-ui-text-dimmed",n),U("g-ui-text-ellipsis",l),c,h,k,V,d)},t)}import{H1 as Ma,H2 as Zt,H3 as Ta,H4 as Va,H5 as La,H6 as Ia}from"@granularjs/core";var $a={1:Ma,2:Zt,3:Ta,4:Va,5:La,6:Ia};function Aa(...e){let{props:i,children:t}=g(e,{order:2}),{order:r,className:a,style:o,...n}=i,u=m(r)||2;return($a[u]||Zt)({...n,className:s("g-ui-title",z("g-ui-title-order-",r,2),a)},t)}import{Div as Ba}from"@granularjs/core";function Fa(...e){let{props:i,children:t}=g(e,{size:"md"}),{size:r,fluid:a,className:o,style:n,...u}=i;return Ba({...u,style:n,className:s("g-ui-container",U("g-ui-container-fluid",a),z("g-ui-container-size-",r,"md"),o)},t)}import{Div as ja}from"@granularjs/core";function Ea(...e){let{props:i,children:t}=g(e,{gap:"md"}),{gap:r,align:a,justify:o,className:n,style:u,...l}=i,p=he(o,{between:"g-ui-justify-between",center:"g-ui-justify-center",end:"g-ui-justify-end",start:"g-ui-justify-start"});return ja({...l,style:u,className:s("g-ui-stack",z("g-ui-gap-",r,"md"),z("g-ui-align-",a),p,n)},t)}import{Div as Ra}from"@granularjs/core";function Ha(...e){let{props:i,children:t}=g(e,{gap:"md",align:"center"}),{gap:r,align:a,justify:o,position:n,noWrap:u,className:l,style:p,...d}=i,w=he(n,{apart:"g-ui-justify-between",center:"g-ui-justify-center",right:"g-ui-justify-end",left:"g-ui-justify-start"});return Ra({...d,style:p,className:s("g-ui-group",z("g-ui-gap-",r,"md"),z("g-ui-align-",a,"center"),z("g-ui-justify-",o,"none"),w,U("g-ui-no-wrap",u),l)},t)}import{Div as wi,list as Oa,when as Ki,after as Ut}from"@granularjs/core";function Wa(...e){let{props:i,children:t}=g(e,{padding:"md",radius:"md",shadow:"none",border:"default"}),{title:r,content:a,actions:o,border:n,padding:u,radius:l,shadow:p,className:d,style:w,...f}=i;return wi({style:w},Ki(r,()=>wi({className:"g-ui-card-title"},r)),Ki(a,()=>wi({className:"g-ui-card-content"},a)),{className:s("g-ui-card",z("g-ui-card-border-",n,"md"),z("g-ui-card-padding-",u,"md"),z("g-ui-card-radius-",l,"md"),z("g-ui-card-shadow-",p,"md"),d),...f},t,Ki(o,()=>wi({className:"g-ui-card-actions"},Oa(o,c=>Ui({className:"g-ui-card-action",onClick:h=>c.get().onClick?.(h),leftSection:c.leftSection,rightSection:c.rightSection,size:Ut(c.size).compute(h=>h||"sm"),variant:Ut(c.variant).compute(h=>h||"outline"),...c.get().props||{}},c.label)))))}import{Span as qa}from"@granularjs/core";function Ya(...e){let{props:i,children:t}=g(e,{variant:"filled",size:"md"}),{variant:r,size:a,className:o,dot:n,style:u,...l}=i,p=he(r,{dot:"g-ui-badge-dot"});return qa({...l,className:s("g-ui-badge",z("g-ui-badge-variant-",r,"filled"),z("g-ui-badge-size-",a,"md"),U("g-ui-badge-dot",n),p,o)},t)}import{Div as ri,Input as Ga,Textarea as _a,Label as Za,Span as Ua,when as ai,state as Xa,after as Ka,isState as Qa}from"@granularjs/core";function be(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{label:r,description:a,error:o,size:n,leftSection:u,rightSection:l,className:p,inputClassName:d,multiline:w,value:f,...c}=i,{value:h,node:k,onChange:V,onInput:$,onFocus:S,onBlur:M,onKeyDown:C,onKeyUp:x,onClick:y}=t,v=Qa(h)&&!V&&!$,N=v?h:Xa(m(f)??"");Ka(f).change(E=>{v||N.set(m(E)??"")});let I=E=>{let G=E?.target?.value??"";G!==f.get()&&(N.set(G),V?.(E),$?.(E))},B=ze(w),Q=B?_a:Ga,se=s(d,B&&"g-ui-textarea"),re=Q({...c,node:k,value:N,onInput:I,onChange:I,onFocus:S,onBlur:M,onKeyDown:C,onKeyUp:x,onClick:y,className:s("g-ui-input",se)});return ri({className:s("g-ui-text-input",p)},ai(r,()=>Za({className:"g-ui-text-input-label"},r)),ai(a,()=>Ua({className:"g-ui-text-input-description"},a)),ri({className:s("g-ui-input-wrapper",U("g-ui-input-multiline",w),z("g-ui-input-size-",n,"md"),U("g-ui-input-error",o))},ai(u,()=>ri({className:"g-ui-input-section"},u)),re,ai(l,()=>ri({className:"g-ui-input-section"},l))),ai(o,()=>ri({className:"g-ui-text-input-error-text"},o)))}function Qi(...e){let{props:i}=g(e,{size:"md"}),{size:t,leftSection:r,rightSection:a,className:o,...n}=i;return be({...n,size:t,className:o,leftSection:r,rightSection:a,multiline:!0})}import{Div as Xt,Span as Kt,after as Oe,state as Ja}from"@granularjs/core";function Ji(...e){let{props:i,rawProps:t}=g(e,{size:"md",step:1,allowDecimal:!0,allowNegative:!0,clampBehavior:"blur",hideControls:!1,decimalSeparator:".",thousandSeparator:"",format:null,prefix:"",suffix:""}),{value:r,min:a,max:o,step:n,size:u,allowDecimal:l,allowNegative:p,decimalSeparator:d,thousandSeparator:w,decimalScale:f,clampBehavior:c,hideControls:h,format:k,locale:V,currency:$,formatOptions:S,prefix:M,suffix:C,leftSection:x,rightSection:y,className:v,onChange:N,onInput:I,...B}=i,{onChange:Q,onInput:se,onBlur:re,onFocus:E,onKeyDown:G}=t,ie=A=>{Q?.(A.target?.value??""),se?.(A.target?.value??"")},ae=ie,X=Ja(""),T=A=>String(A??"").replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),j=()=>{if(!!!m(l))return 0;let L=m(f);if(L!=null&&L!==""&&Number.isFinite(Number(L)))return Math.max(0,Number(L));let q=m(k);return q==="currency"||q==="percent"?2:0},D=A=>{let L=m(d)??".",q=m(w)??"",_=String(A??"");if(q&&(_=_.split(q).join("")),!_||_==="-"||_===L||_.endsWith(L))return null;let oe=_.replace(L,"."),ee=Number(oe);return Number.isFinite(ee)?ee:null},Y=A=>{let L=m(w)??"";return L?A.replace(/\B(?=(\d{3})+(?!\d))/g,L):A},P=A=>{let L=m(d)??".",q=j(),_=Number(A);if(!Number.isFinite(_))return"";let oe=_<0?"-":"",ee=Math.abs(_),[K,te=""]=String(ee).split("."),le=Y(K);if(q>0){let xe=te.slice(0,q).padEnd(q,"0");return`${oe}${le}${L}${xe}`}return`${oe}${le}`},R=(A,L)=>{try{let q=m(V),_=m($)??"USD",oe=m(S)??{},ee=j(),K=L==="currency"?"currency":"decimal";return new Intl.NumberFormat(q,{style:K,currency:_,...ee>0?{minimumFractionDigits:ee,maximumFractionDigits:ee}:{maximumFractionDigits:0},...oe}).format(A)}catch{return P(A)}},H=A=>{let L=A,q=m(a),_=m(o);return q!=null&&Number.isFinite(Number(q))&&(L=Math.max(L,Number(q))),_!=null&&Number.isFinite(Number(_))&&(L=Math.min(L,Number(_))),!m(p)&&L<0&&(L=0),L},J=()=>{let A=m(C)??"",L=m(k);return!A&&L==="percent"?"%":A},pe=(A,L,q)=>{let _=m(M)??"",oe=J(),ee=String(A??"").replace(/\u00A0/g," "),K=String(_??"").replace(/\u00A0/g," "),te=String(oe??"").replace(/\u00A0/g," "),le=K&&ee.startsWith(K),xe=te&&ee.endsWith(te);return`${L??""}${le?"":_}${A}${xe?"":oe}`},ke=(A,L)=>{let q=j(),_=m(d)??".",ee=String(A??"").replace(/\D/g,"")||"0",K=q>0?ee.padStart(q+1,"0"):ee,le=(q>0?K.slice(0,-q):K).replace(/^0+(?=\d)/,"")||"0",xe=q>0?K.slice(-q):"",Fe=q>0?`${le}${_}${xe}`:le;return`${L??""}${Fe}`},Pe=A=>{let L=m(M)??"",q=J(),_=String(A??""),oe=String(L??"").replace(/\u00A0/g," "),ee=String(q??"").replace(/\u00A0/g," ");return oe&&_.replace(/\u00A0/g," ").startsWith(oe)&&(_=_.slice(L.length)),ee&&_.replace(/\u00A0/g," ").endsWith(ee)&&(_=_.slice(0,-q.length)),_},Be=A=>{let L=!!m(p),q=Pe(A),_=L&&q.includes("-")?"-":"",oe=q.replace(/\D/g,""),ee=ke(oe,_);if(m(c)==="strict"){let K=D(ee);if(K!=null){let te=H(K);ee=`${te<0?"-":""}${P(Math.abs(te))}`}}return ee},Ve=A=>{if(A==null||A==="")return ke("","");if(typeof A=="number"&&Number.isFinite(A)){let te=m(c)==="strict"?H(A):A;return`${te<0?"-":""}${P(Math.abs(te))}`}let L=Pe(A),q=m(d)??".",oe=!!m(p)&&String(L).includes("-")?"-":"",ee=String(L??"").replace(new RegExp(`[^0-9${T(q)}]`,"g"),""),K=D(`${oe}${ee}`);if(K!=null){let te=m(c)==="strict"?H(K):K;return`${te<0?"-":""}${P(Math.abs(te))}`}return Be(A)},Me,ii=A=>{let L=m(A);if(L===void 0)return;let q=Ve(L);q!==X.get()&&(Me=q,X.set(q))};ii(r),Oe(r).change(A=>{ii(A)}),Oe(X).change(A=>{if(A===Me){Me=void 0;return}Me=void 0;let L=D(A);if(L==null){ie?.({target:{value:A??""}});return}ie?.({target:{value:L}})});let Oi=Oe(y).compute(A=>A!=null&&A!==!1),Wi=Oe(h,Oi).compute(([A,L])=>!m(A)&&!L),xi=Oe(l).compute(A=>m(A)?"decimal":"numeric"),qi=Oe(k,M,C,l,p,d,w,f,c,a,o,V,$,S).compute(()=>({mode:"both",format:A=>{let L=Be(A),q=m(k),oe=!!m(p)&&L.startsWith("-")?"-":"",ee=D(L),K=L.replace(oe,"");if(ee!=null){let te=Math.abs(ee);if(typeof q=="function")try{K=q(te)}catch{K=P(te)}else if(q==="currency")K=R(te,"currency");else if(q==="decimal"){let le=m(V),xe=m(S);K=le||xe?R(te,"decimal"):P(te)}else K=P(te)}return{value:L,raw:L,visual:pe(K,oe,q)}}})),b=A=>{let L=D(X.get()),q=Number(m(n)??1),oe=H((L??0)+q*A),ee=P(oe);X.set(ee)},O=A=>{if(!A||typeof A.setSelectionRange!="function")return;let L=()=>{try{let q=String(A.value??"").length;A.setSelectionRange(q,q)}catch{}};typeof requestAnimationFrame=="function"?requestAnimationFrame(L):L()},ce=A=>{ae?.(A);let L=A?.target;L&&O(L)},Z=A=>{if(re?.(A),m(c)!=="blur")return;let L=D(X.get());if(L==null)return;let q=H(L);X.set(P(q))},ge=A=>{E?.(A),O(A?.target)},ve=A=>{G?.(A);let L=A?.target;if(!L)return;let q=m(M)??"",_=J();_&&typeof L.selectionEnd=="number"&&(L.selectionEnd=Math.min(L.selectionEnd,String(L.value??"").length-_.length)),q&&typeof L.selectionStart=="number"&&(L.selectionStart=Math.max(L.selectionStart,q.length))},ue=Xt({className:"g-ui-number-field-controls"},Kt({className:"g-ui-number-field-control",onClick:()=>b(1)},"+"),Kt({className:"g-ui-number-field-control",onClick:()=>b(-1)},"\u2212")),Te=Xt({className:"g-ui-number-field-controls-wrapper"},ue),Le=Oe(Wi,y).compute(([A,L])=>A?Te:L);return be({...B,size:u,className:s("g-ui-number-field",v),leftSection:x,rightSection:Le,type:"text",inputMode:xi,inputClassName:s("g-ui-input-number"),value:X,format:qi,onInput:ce,onBlur:Z,onFocus:ge,onKeyDown:ve})}function eo(...e){return Ji(...e)}import{Div as Ni,Button as io,portal as to,when as et,after as ro}from"@granularjs/core";var yi='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/></svg>',ki='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M560-240 320-480l240-240 56 56-184 184 184 184-56 56Z"/></svg>',zi='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M379.33-244 154-469.33 201.67-517l177.66 177.67 378.34-378.34L805.33-670l-426 426Z"/></svg>',Qt='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M240-446.67v-66.66h480v66.66H240Z"/></svg>',je='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M312-265.33 265.33-312l168-168-168-167L312-693.67l168 168 167-168L693.67-647l-168 167 168 168L647-265.33l-167-168-168 168Z"/></svg>',Jt='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>',er='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>',ir='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h357l-80 80H200v560h560v-278l80-80v358q0 33-23.5 56.5T760-120H200Zm280-360v-80h240v80H480Zm0 160v-80h320v80H480Zm0 160v-80h320v80H480ZM360-360v-80h80v80h-80Zm0 160v-80h80v80h-80Zm0 160v-80h80v80h-80Zm160-320h280l-36-37 37-37v74H520Zm-160 0h80v-80h-80v80ZM120-600v-160l160-160h160l-80 80H200v240h-80Zm80-240v-80 80Z"/></svg>',tr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>',rr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80H200Zm0-80h560v-400H200v400Z"/></svg>',ar='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z"/></svg>';function oi(...e){let{props:i,rawProps:t,children:r}=g(e,{size:"md",centered:!0,overlay:"normal"}),{opened:a,title:o,size:n,centered:u,overlay:l,position:p,className:d,style:w}=i,{onClose:f}=t,c=ro(p,u).compute(([h,k])=>`g-ui-modal-position-${h??(k===!1?"top-center":"center")}`);return et(a,()=>to(Ni({className:s("g-ui-modal-overlay",z("g-ui-modal-overlay-",l,"normal"),c),onClick:h=>{h.target===h.currentTarget&&f?.()}},Ni({className:s("g-ui-modal",z("g-ui-modal-size-",n,"md"),d)},Ni({className:"g-ui-modal-header"},et(o,()=>Ni({className:"g-ui-modal-title"},o)),et(f,()=>io({type:"button",className:"g-ui-button g-ui-button-variant-subtle g-ui-button-size-xs g-ui-modal-close",onClick:f,innerHTML:je}))),r))))}import{Div as Ci,Span as it,after as or,when as nr}from"@granularjs/core";function ni(...e){let{props:i}=g(e,{variant:"spinner",size:"md"}),{variant:t,size:r,className:a}=i,o=or(t).compute(u=>u==="dots"),n=or(t).compute(u=>u==="bars");return nr(o,()=>Ci({className:s("g-ui-loading g-ui-dots",z("g-ui-loading-size-",r,"md"),a)}),()=>nr(n,()=>Ci({className:s("g-ui-loading g-ui-bars",z("g-ui-loading-size-",r,"md"),a)},it(""),it(""),it("")),()=>Ci({className:s("g-ui-loading",z("g-ui-loading-size-",r,"md"),a)},Ci({className:"g-ui-spinner"}))))}import{Div as tt,Input as ao,Label as oo,Span as sr,when as rt,state as no,after as so}from"@granularjs/core";function at(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{checked:r,label:a,description:o,size:n,indeterminate:u,className:l,style:p,inputProps:d,...w}=i,{onChange:f}=t,c=no(ze(r));so(r).change(k=>{k!=null&&(c.set(!!k),f?.(k))});let h=oo({className:"g-ui-checkbox-control"},ao({type:"checkbox",indeterminate:u,checked:c,className:s("g-ui-checkbox-input",z("g-ui-checkbox-size-",n,"md"),d?.className),...w}),rt(c,()=>tt({className:"g-ui-checkbox-checked",innerHTML:zi}),()=>{if(!c.get()&&u.get())return tt({className:"g-ui-checkbox-indeterminate",innerHTML:Qt})}),rt(a,()=>sr({className:"g-ui-checkbox-label"},a)));return tt({className:s("g-ui-checkbox",z("g-ui-checkbox-size-",n,"md"),l)},h,rt(o,()=>sr({className:"g-ui-checkbox-description"},o)))}import{Input as co,Label as po,Span as mo,when as fo,after as nt,state as vo}from"@granularjs/core";import{Div as uo,context as go,after as ur}from"@granularjs/core";var ot=go({name:null,selected:null});function lo(...e){let{props:i,rawProps:t,children:r}=g(e),{className:a,name:o,selected:n,onChange:u,...l}=i,{onChange:p}=t,d=ot.scope({name:o?.get(),selected:n?.get()});return ur(d.selected).change(w=>{p?.(w)}),ur(n).change(w=>{w!==d.selected.get()&&(d.set().selected=w)}),d.serve(uo({...l,className:s("g-ui-switch-group",a)},r))}function ho(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{label:r,size:a,className:o,style:n,inputProps:u,checked:l,value:p,...d}=i,{onChange:w}=t,f=vo(l),c=ot.state(),h=nt(c).compute(k=>({name:k.name,type:k.name?"radio":"checkbox"}));return nt(c.selected).change(k=>{f.set(k===p.get())}),nt(f).change(k=>{if(w?.(k),!k)return;let V=c.get().selected;c.set().selected=p.get()}),po({className:s("g-ui-switch",z("g-ui-switch-size-",a,"md"),o)},co({type:h.type,name:h.name,value:p,checked:f,className:s("g-ui-switch-input",z("g-ui-switch-size-",a,"md"),u?.className),...d}),fo(r,()=>mo({className:"g-ui-switch-label"},r)))}import{Div as Ee,Span as st,when as Ue,state as gr,after as Si,Label as xo}from"@granularjs/core";import{Span as bo}from"@granularjs/core";function ye(...e){let{props:i,children:t}=g(e,{size:"md"});return bo({...i,className:s("g-ui-icon",z("g-ui-icon-size-",i.size,"md"),z("g-ui-icon-color-",i.color),i.className)},...t)}function wo(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"md"}),{data:r,value:a,size:o,leftSection:n,rightSection:u,placeholder:l,className:p,label:d,description:w,error:f,...c}=i,{onChange:h}=t,k=gr(!1),V=gr(m(a)??"");Si(a).change(C=>{let x=m(C);x!==void 0&&V.set(x??"")});let $=C=>{V.set(C),h?.(C),k.set(!1)},S=Si(V).compute(C=>C?"":"g-ui-select-placeholder"),M=Si(V).compute(C=>{let y=(m(r)??[]).find(v=>v.value===C);return C?y?.label??"":l??""});return Ee({...c,className:s("g-ui-select-root",p)},Ue(d,()=>xo({className:"g-ui-text-input-label"},d)),Ue(w,()=>st({className:"g-ui-text-input-description"},w)),Ee({className:s("g-ui-input-wrapper",z("g-ui-input-size-",o,"md"))},Ue(n,()=>Ee({className:"g-ui-input-section"},n)),Ee({className:s("g-ui-select",S),onClick:()=>k.set(!k.get())},st({className:"g-ui-select-value"},M)),Ue(u,()=>Ee({className:"g-ui-input-section"},u),()=>st({className:"g-ui-select-caret"},ye({innerHTML:ar})))),Ue(f,()=>Ee({className:"g-ui-text-input-error-text"},f)),Ue(k,()=>Ee({className:"g-ui-select-dropdown"},(m(r)??[]).map(C=>Ee({className:s("g-ui-select-item",Si(V).compute(x=>x===C.value?"g-ui-select-item-active":"")),onClick:()=>$(C.value)},C.label)))))}import{Button as yo,Div as Xe,state as Ie,after as si,list as ko,when as zo}from"@granularjs/core";function No(...e){let{props:i,rawProps:t}=g(e,{tabs:[],orientation:"horizontal",variant:"default",sticky:!0,align:"left",size:"md"}),{value:r,tabs:a,orientation:o,variant:n,sticky:u,className:l,style:p,align:d,size:w}=i,{onChange:f}=t,c=Ie(m(r)??m(a)?.[0]?.value??""),h=Ie(),k=Ie(),V=Ie(0),$=Ie(0),S=Ie(0),M=Ie(0),C=Ie(!1),x=Ie(0),y=!1,v=null,N=!1,I=new Set;si(r).change(P=>{let R=m(P);R!=null&&c.set(R)});let B=P=>{c.set(P),f?.(P)},Q=P=>{let R=[],H=P?.parentElement;for(;H;){let J=getComputedStyle(H),pe=`${J.overflow}${J.overflowY}${J.overflowX}`;/(auto|scroll)/.test(pe)&&R.push(H),H=H.parentElement}return R},se=P=>Q(P)[0]??null,re=P=>P?P.getBoundingClientRect().top:0,E=P=>P?P.scrollTop:window.scrollY||window.pageYOffset||0,G=(P,R)=>P>R?"down":P<R?"up":"none",ie=(P,R,H,J)=>P==="down"&&R<H?!0:P==="up"&&R>=H?!1:J,ae=()=>{let P=h.get(),R=k.get();if(!P||!R)return;if(!ze(u)){C.set(!1),V.set(0);return}if(typeof window>"u")return;let H=P.getBoundingClientRect(),J=R.getBoundingClientRect(),pe=se(P),ke=re(pe),Pe=E(pe),Be=G(Pe,x.get());x.set(Pe);let Ve=ie(Be,H.top,ke,C.get());V.set(J.height),$.set(H.left),S.set(H.width),M.set(ke),Ve!==C.get()&&C.set(Ve)},X=()=>{v==null&&(v=requestAnimationFrame(()=>{v=null,ae()}))},T=P=>{!P||I.has(P)||(I.add(P),P.addEventListener("scroll",X,{passive:!0}))},j=()=>{if(y)return;let P=h.get(),R=k.get();!P||!R||typeof window>"u"||(y=!0,ae(),T(window),window.addEventListener("resize",X),Q(P).forEach(T))};si(k,h,u).change(j),!N&&typeof window<"u"&&(N=!0,setTimeout(()=>j(),0));let D=si(C,$,S,M).compute(P=>{let[R,H,J,pe]=P;return R?{position:"fixed",top:`${pe}px`,left:`${H}px`,width:`${J}px`,background:"var(--g-ui-surface)",zIndex:100}:{position:"static",top:"auto",left:"auto",width:"auto",zIndex:"auto",background:"transparent"}}),Y=si(C,V).compute(P=>{let[R,H]=P;return{height:R?`${H}px`:"0px"}});return Xe(Xe({className:s("g-ui-tabs",he(o,{vertical:"g-ui-tabs-vertical"}),z("g-ui-tabs-variant-",n,"default"),z("g-ui-tabs-align-",d,"left"),z("g-ui-tabs-size-",w,"md"),i.className??l)},Xe({node:h}),Xe({style:Y}),Xe({node:k,className:"g-ui-tabs-list",style:D},ko(a,P=>yo({className:si(c,P.value).compute(([R,H])=>s("g-ui-tabs-tab",H===R&&"g-ui-tabs-tab-active")),onClick:()=>B(P.get().value)},P.label))),Xe({className:"g-ui-tabs-panel"},zo(c,()=>a.get()?.find(P=>P.value===c.get())?.content??null))))}import{Table as Co,Thead as So,Tbody as Do,Tr as Po,Th as Mo,Td as To,list as cr,when as pr,after as ut}from"@granularjs/core";function Vo(...e){let{props:i}=g(e,{headers:[],rows:[]}),{headers:t,rows:r,striped:a,highlightOnHover:o,withBorder:n,withColumnBorders:u,withRowBorders:l,className:p,style:d,...w}=i,f=ut(t).compute(c=>c.length>0);return Co({...w,className:s("g-ui-table",U("g-ui-table-striped",a),U("g-ui-table-hover",o),U("g-ui-table-with-border",n),U("g-ui-table-column-borders",u),U("g-ui-table-row-borders",l),p)},pr(f,()=>So(lr(t,!0))),Do(cr(r,c=>lr(c,!1))))}var lr=(e,i)=>{let t=ut(e).compute(o=>Array.isArray(o)),r=o=>{let n=ut(o).compute(u=>Object.values(u));return a(n)},a=o=>cr(o,n=>i?Io(n):Lo(n));return Po(pr(t,()=>a(e),()=>r(e)))},Lo=e=>To(e),Io=e=>Mo(e);import{Div as gt}from"@granularjs/core";import{state as $o,when as Ao,after as Bo}from"@granularjs/core";function Fo(...e){let{props:i,rawProps:t,children:r}=g(e,{opened:!1}),{opened:a,className:o,...n}=i,{opened:u}=t,l=ti(u),p=l?u:$o(ze(a));Bo(a).change(c=>{l||p.set(ze(c))});let d=()=>{l||p.set(!p.get())},w=r[0],f=r[1];return gt({...n,className:s("g-ui-accordion",o)},gt({className:"g-ui-accordion-header",onClick:d},w),Ao(p,()=>gt({className:"g-ui-accordion-content"},f)))}import{Span as dr}from"@granularjs/core";function jo(...e){let{props:i,children:t}=g(e),{label:r,className:a,style:o}=i;return dr({className:s("g-ui-tooltip",a)},t,dr({className:"g-ui-tooltip-content"},r))}import{Div as ui,when as Eo,after as Ro,state as gi,portal as Ho}from"@granularjs/core";var lt=gi({currentOpenState:null});function Oo(...e){let i=gi(),t=gi(),r=gi({}),{props:a,rawProps:o,children:n}=g(e,{position:"right"}),{opened:u,content:l,position:p,className:d,...w}=a,{onChange:f}=o,c=gi(m(u)??!1);Ro(u).change(C=>{let x=m(C);x!=null&&(c.set(!!x),x&&h())});let h=()=>{lt.get().currentOpenState!==c&&(lt.get().currentOpenState?.set(!1),lt.set().currentOpenState=c)};u.get()&&h();let k=C=>{let y=String(C??"right").toLowerCase().split("-").filter(Boolean);if(y.length===1){let I=y[0];return I==="top"||I==="bottom"?{placement:I,align:"center"}:I==="left"||I==="right"?{placement:"bottom",align:I}:I==="center"?{placement:"bottom",align:"center"}:{placement:"bottom",align:"right"}}let[v,N]=y;return v==="top"||v==="bottom"?{placement:v,align:N||"center"}:v==="left"||v==="right"?{placement:v,align:N||"center"}:{placement:"bottom",align:"right"}},V=()=>{let C=i.get(),x=t.get();if(!C||!x||typeof window>"u")return;let y=C.getBoundingClientRect(),v=x.getBoundingClientRect(),N=m(p)??"right",I=getComputedStyle(document.documentElement).getPropertyValue("--g-ui-space-20"),B=Number.parseFloat(I)||20,Q=window.innerWidth||0,se=window.innerHeight||0,re=Math.max(B,Q-v.width-B),E=Math.max(B,se-v.height-B),{placement:G,align:ie}=k(N),ae=8,X=y.bottom+ae,T=y.left;G==="top"||G==="bottom"?(X=G==="top"?y.top-v.height-ae:y.bottom+ae,ie==="center"?T=y.left+y.width/2-v.width/2:ie==="right"?T=y.right-v.width:T=y.left):(G==="left"||G==="right")&&(T=G==="left"?y.left-v.width-ae:y.right+ae,ie==="center"?X=y.top+y.height/2-v.height/2:ie==="bottom"?X=y.bottom-v.height:X=y.top),T=Math.max(B,Math.min(T,re)),X=Math.max(B,Math.min(X,E)),r.set({top:`${X}px`,left:`${T}px`})},$=C=>{c.set(C),f?.(C),C&&(h(),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>V()):setTimeout(()=>V(),0))},S=()=>$(!c.get()),M=()=>$(!1);return ui({...w,node:i,className:s("g-ui-menu",d)},ui({onClick:S},n),Eo(c,()=>Ho(ui(ui({className:"g-ui-menu-overlay",onClick:M}),ui({className:"g-ui-menu-dropdown",node:t,style:r},l)))))}import{Div as mr,portal as Wo,when as qo}from"@granularjs/core";function Yo(...e){let{props:i,children:t}=g(e,{position:"right",size:"md",overlay:"normal",shadowed:!0}),{opened:r,onClose:a,position:o,size:n,overlay:u,shadowed:l,className:p,style:d}=i;return qo(r,()=>Wo(mr({className:s("g-ui-drawer-overlay",z("g-ui-drawer-overlay-",u,"normal")),onClick:a},mr({className:s("g-ui-drawer",he(l,{true:"g-ui-drawer-shadowed"},!0),z("g-ui-drawer-",o,"right"),z("g-ui-drawer-size-",n,"md"),p),onClick:w=>w.stopPropagation()},t))))}import{Button as Go,Div as ct,Span as fr,when as Di,after as vr}from"@granularjs/core";function pt(...e){let{props:i,rawProps:t,children:r}=g(e,{color:"blue",withCloseButton:!0}),{title:a,color:o,icon:n,loading:u,withCloseButton:l,withBorder:p,className:d,style:w}=i,{onClose:f}=t,c=vr(n,u).compute(([k,V])=>!k&&!!V),h=vr(n,u).compute(([k,V])=>!!k||!!V);return ct({className:s("g-ui-notification",[p,"g-ui-notification-bordered"],[o,k=>`g-ui-notification-${k}`],[h,"g-ui-notification-with-icon"],d)},Di(n,()=>fr({className:"g-ui-notification-icon"},n)),Di(c,()=>ni({size:"sm",className:"g-ui-notification-loader"})),ct({className:"g-ui-notification-body"},Di(a,()=>ct({className:"g-ui-notification-title"},a)),r),Di(l,()=>Go({type:"button",className:"g-ui-notification-close",onClick:()=>f?.()},fr({innerHTML:je}))))}import{Div as _o,when as Zo}from"@granularjs/core";function Uo(...e){let{props:i}=g(e,{labelPosition:"center"}),{label:t,labelPosition:r,vertical:a,className:o,...n}=i;return _o({...n,className:s("g-ui-divider",U("label",t),z("g-ui-divider-label-",r,"center"),U("g-ui-divider-vertical",a),o)},Zo(t,()=>Xi({className:"g-ui-divider-label-text",size:"sm"},t)))}import{Div as Xo}from"@granularjs/core";function Ko(...e){let{props:i,children:t}=g(e,{padding:"md",radius:"md",shadow:"none"}),{padding:r,radius:a,shadow:o,className:n,...u}=i;return Xo({...u,className:s("g-ui-paper",[r,l=>`g-ui-card-padding-${l}`],[a,l=>`g-ui-card-radius-${l}`],[o,l=>`g-ui-card-shadow-${l}`],n)},t)}import{Button as Qo,Div as dt,Span as Jo,after as hr,when as mt}from"@granularjs/core";function en(...e){let{props:i,rawProps:t,children:r}=g(e,{color:"blue"}),{title:a,color:o,icon:n,withCloseButton:u,className:l,...p}=i,{onClose:d}=t,w=hr(a,u).compute(([c,h])=>c||h),f=hr(n).compute(c=>c!==void 0);return dt({...p,className:s("g-ui-alert",[o,c=>`g-ui-alert-${c}`],l)},dt({className:"g-ui-alert-header"},mt(n,()=>Jo({className:"g-ui-alert-icon"},n)),mt(a,()=>dt({className:"g-ui-alert-title"},a)),mt(u,()=>Qo({type:"button",className:"g-ui-alert-close",onClick:()=>d?.()},"\xD7"))),r)}import{Div as tn,Img as rn,when as an}from"@granularjs/core";function on(...e){let{props:i,children:t}=g(e,{size:"md",alt:""}),{src:r,size:a,alt:o,className:n,...u}=i;return tn({...u,className:s("g-ui-avatar",[a,l=>`g-ui-avatar-size-${l}`],n)},an(r,()=>rn({className:"g-ui-avatar-img",src:r,alt:o}),()=>t))}import{Span as nn}from"@granularjs/core";function sn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return nn({...a,className:s("g-ui-kbd",r)},t)}import{Code as un}from"@granularjs/core";function gn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return un({...a,className:s("g-ui-code",r)},t)}import{Blockquote as ln}from"@granularjs/core";function cn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return ln({...a,className:s("g-ui-blockquote",r)},t)}import{Div as pn}from"@granularjs/core";function dn(...e){let{props:i,children:t}=g(e,{cols:3,gap:"md"}),{cols:r,gap:a,className:o,...n}=i;return pn({...n,className:s("g-ui-grid",[a,u=>`g-ui-gap-${u}`],[r,u=>`g-ui-grid-cols-${u}`],o)},t)}import{Ul as mn,Ol as fn,Li as ft,Div as Pi,Span as vt,after as ht,when as We,isSignal as vn,isState as hn,isStatePath as bn,isComputed as xn}from"@granularjs/core";function br(...e){let{props:i,children:t}=g(e,{type:"none",size:"md"}),{type:r,size:a,withPadding:o,className:n,...u}=i,l=he(r,{ordered:"g-ui-list-ordered",unordered:"g-ui-list-unordered",none:"g-ui-list-none"}),p=ht(r).compute(k=>k==="ordered"),d=k=>k&&typeof k=="object"&&typeof k.tagName=="string"&&(k.tagName.toLowerCase()==="ul"||k.tagName.toLowerCase()==="ol"),w=k=>k&&typeof k=="object"&&typeof k.tagName=="string"&&k.tagName.toLowerCase()==="li",f=k=>{let V=$=>$?.nodeType==="granular-list-node"?$:$==null||$===!1?null:Array.isArray($)?$.map(S=>V(S)):w($)?$:d($)?ft({className:"g-ui-list-nested-item"},$):ft(vt({className:"g-ui-list-item-shell"},$));return vn(k)||hn(k)||bn(k)||xn(k)?ht(k).compute($=>V($)):V(k)},c=We(t,()=>t.map(k=>f(k))),h={...u,className:s("g-ui-list",z("g-ui-list-size-",a,"md"),U("g-ui-list-with-padding",o),l,n)};return We(p,()=>fn(h,c),()=>mn(h,c))}function wn(...e){let{props:i,children:t}=g(e,{withBorder:!1}),{leftSection:r,rightSection:a,title:o,body:n,withBorder:u,className:l,verticalPadding:p,horizontalPadding:d,...w}=i,f=ht(o,n).compute(([c,h])=>!!c||!!h);return ft({...w,className:s("g-ui-list-item",U("g-ui-list-item-border",u),z("g-ui-list-item-vertical-padding-",p,"md"),z("g-ui-list-item-horizontal-padding-",d,"md"),l)},Pi({className:"g-ui-list-item-shell"},We(r,()=>vt({className:"g-ui-list-item-section g-ui-list-item-section-left"},r)),We(f,()=>Pi({className:"g-ui-list-item-content"},We(o,()=>Pi({className:"g-ui-list-item-title"},o)),We(n,()=>Pi({className:"g-ui-list-item-body"},n))),()=>t),We(a,()=>vt({className:"g-ui-list-item-section g-ui-list-item-section-right"},a))))}br.Item=wn;import{A as yn}from"@granularjs/core";function kn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return yn({...a,className:s("g-ui-anchor",r)},t)}import{Img as zn}from"@granularjs/core";function Nn(...e){let{props:i}=g(e),{className:t,...r}=i;return zn({...r,className:s("g-ui-image",t)})}import{Div as xr}from"@granularjs/core";function Cn(...e){let{props:i}=g(e,{value:0,color:"primary",size:"md"}),{value:t,color:r,size:a,className:o,...n}=i;return xr({...n,className:s("g-ui-progress",z("g-ui-progress-size-",a,"md"),[t,u=>{let l=Math.max(0,Math.min(100,Number(u)||0));return`g-ui-progress-${Math.round(l/5)*5}`}],[r,u=>u?`g-ui-progress-${u}`:""],o)},xr({className:"g-ui-progress-bar"}))}import{Div as Re,after as qe,state as Sn,when as wr,list as Dn}from"@granularjs/core";function Pn(...e){let{props:i,rawProps:t}=g(e,{size:"md",min:0,max:100,step:1}),{onChange:r}=t,{value:a,marks:o,size:n,min:u,max:l,step:p,disabled:d,className:w,...f}=i,c=Sn(m(a??u)),h=qe(o).compute(x=>x&&x.length>0);qe(a).change(x=>{x!=null&&c.set(m(x))});let k=()=>{let x=Number(m(u)),y=Number(m(l));return!Number.isFinite(x)||!Number.isFinite(y)?{minValue:0,maxValue:100}:{minValue:Math.min(x,y),maxValue:Math.max(x,y)}},V=()=>{let x=Number(m(p));return Number.isFinite(x)&&x>0?x:1},$=x=>{let{minValue:y,maxValue:v}=k(),N=V(),I=Math.max(y,Math.min(v,Number(x))),B=Math.round((I-y)/N)*N+y;B!==c.get()&&(c.set(B),r?.(B))},S=qe(c).compute(x=>{let{minValue:y,maxValue:v}=k(),N=v-y;if(N<=0)return 0;let I=(Number(x??y)-y)/N*100;return Math.max(0,Math.min(100,I))}),M=(x,y)=>{let v=y?.();if(!v||v.width===0)return;let I=Math.min(Math.max(x.clientX-v.left,0),v.width)/v.width,{minValue:B,maxValue:Q}=k();$(B+I*(Q-B))},C=x=>{if(ze(d))return;x.preventDefault?.();let y=x.currentTarget,v=()=>y.getBoundingClientRect();y.setPointerCapture?.(x.pointerId),M(x,v);let N=B=>M(B,v),I=()=>{y.releasePointerCapture?.(x.pointerId),window.removeEventListener("pointermove",N),window.removeEventListener("pointerup",I)};window.addEventListener("pointermove",N),window.addEventListener("pointerup",I)};return Re({...f,className:s("g-ui-slider",z("g-ui-slider-size-",n,"md"),U("g-ui-slider-disabled",d),w)},Re({className:"g-ui-slider-track",onPointerDown:C},Re({className:"g-ui-slider-bar",style:qe(S).compute(x=>({width:`${x}%`}))}),Re({className:"g-ui-slider-thumb",style:qe(S).compute(x=>({left:`${x}%`}))})),wr(h,()=>Re({className:"g-ui-slider-marks-placeholder"})),wr(o,()=>Re({className:"g-ui-slider-marks"},Dn(o,x=>bt({mark:x,getBounds:k})))))}var bt=({mark:e,getBounds:i})=>{let{minValue:t,maxValue:r}=i(),a=r-t,o=qe(e).compute(p=>p.value??p),n=qe(e).compute(p=>p.label??String(p.value)??o),u=Number(o),l=0;return a>0&&(l=(u-t)/a*100),Re({className:"g-ui-slider-mark",style:{left:`${Math.max(0,Math.min(100,l))}%`}},Re({className:"g-ui-slider-mark-label"},n))};import{Div as Mn,after as Tn}from"@granularjs/core";function Vn(...e){let{props:i}=g(e,{height:"md",width:"full"}),{height:t,width:r,className:a,...o}=i,n=Tn(t,r).compute(([u,l])=>{let p={};return isNaN(u)||(p.height=`${u}px`),isNaN(l)||(p.width=`${l}px`),p});return Mn({...o,style:{width:n.width,height:n.height,...o.style||{}},className:s("g-ui-skeleton",[t,u=>`g-ui-skeleton-h-${u}`],[r,u=>`g-ui-skeleton-w-${u}`],a)})}import{Button as Ln,after as yr,state as In}from"@granularjs/core";function $n(...e){let{props:i,rawProps:t,children:r}=g(e,{size:"md",variant:"filled",color:"primary"}),{checked:a,size:o,variant:n,color:u,className:l,...p}=i,{onChange:d}=t,w=In(!!a);yr(a).change(c=>{c!=null&&w.set(!!c)});let f=c=>{w.set(c),d?.(c)};return Ln({...p,type:"button",className:s("g-ui-chip",z("g-ui-chip-size-",o,"md"),z("g-ui-chip-variant-",n,"filled"),z("g-ui-chip-color-",u,"primary"),yr(w).compute(c=>c?"g-ui-chip-active":""),l),onClick:()=>f(!w.get())},r)}import{Div as xt,after as kr,state as An,list as Bn}from"@granularjs/core";function Fn(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"sm"}),{value:r,data:a,size:o,scroll:n,className:u,...l}=i,{onChange:p}=t,d=An(m(r));kr(r).change(f=>{let c=m(f);c!=null&&d.set(c)});let w=f=>{d.set(f),p?.(f)};return xt({...l,className:s(n&&"g-ui-segmented-scroll")},xt({className:s("g-ui-segmented",z("g-ui-segmented-size-",o,"sm"),u)},Bn(a,(f=>xt({className:s("g-ui-segmented-item",kr(d).compute(c=>f.get().value===c?"g-ui-segmented-active":"")),onClick:()=>w(f.get().value)},f.label)))))}import{Button as wt,Div as jn,state as En,after as Mi}from"@granularjs/core";function Rn(...e){let{props:i,rawProps:t}=g(e,{total:1,size:"md"}),{page:r,total:a,size:o,className:n,...u}=i,{onChange:l}=t,p=En(m(r)??1);Mi(r).change(c=>{let h=m(c);h!=null&&p.set(h)});let d=c=>{let h=Number(m(a))||1,k=Math.max(1,Math.min(h,c));p.set(k),l?.(k)},w=[],f=Number(m(a))||1;for(let c=1;c<=f;c+=1)w.push(c);return jn({...u,className:s("g-ui-pagination",z("g-ui-pagination-size-",o,"md"),i.className??n)},wt({className:"g-ui-pagination-item",onClick:()=>d((p.get?.()??p)-1),disabled:Mi(p).compute(c=>c<=1)},"<"),w.map(c=>wt({className:Mi(p).compute(h=>s("g-ui-pagination-item",c===h&&"g-ui-pagination-item-active")),onClick:()=>d(c)},String(c))),wt({className:"g-ui-pagination-item",onClick:()=>d((p.get?.()??p)+1),disabled:Mi(p).compute(c=>c>=a)},">"))}import{Div as qn,Input as Yn,Label as Gn,Span as zr,when as Nr,after as zt,state as _n}from"@granularjs/core";import{Div as Hn,context as On,after as yt}from"@granularjs/core";var kt=On({name:"",selected:null});function Wn(...e){let{props:i,children:t,rawProps:r}=g(e),{className:a,name:o,selected:n,onChange:u,...l}=i,{onChange:p}=r,d=kt.scope({name:o?.get(),selected:n?.get()});return console.log("selected?.get()",n?.get()),yt(o).change(w=>{d.set().name=w}),yt(n).change(w=>{w!==d.selected.get()&&(d.set().selected=w)}),yt(d.selected).change(w=>{p?.(w)}),d.serve(Hn({...l,className:s("g-ui-stack g-ui-gap-sm",a)},t))}function Zn(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{label:r,name:a,value:o,checked:n,description:u,size:l,className:p,inputProps:d,...w}=i,{onChange:f}=t,c=_n(n?.get()??!1),h=kt.state(),k=zt(h.name,a).compute(([$,S])=>$||S);zt(n,h.selected).change($=>{let[S,M]=$;h.get().name?c.set(M===o.get()):c.set(S)}),zt(c).change($=>{f?.($),$&&h.get().name&&(h.set().selected=o.get())});let V=Gn({className:"g-ui-radio-control"},Yn({type:"radio",name:k,value:o,checked:c,className:s("g-ui-radio-input",z("g-ui-radio-size-",l,"md"),d?.className),...w}),Nr(r,()=>zr({className:"g-ui-radio-label"},r)));return qn({className:s("g-ui-radio",z("g-ui-radio-size-",l,"md"),p)},V,Nr(u,()=>zr({className:"g-ui-radio-description"},u)))}import{Nav as Un,Span as Xn}from"@granularjs/core";function Kn(...e){let{props:i,children:t}=g(e,{separator:"/"}),{separator:r,className:a,...o}=i,n=[];Array.isArray(t)?n.push(...t):n.push(t);let u=n.filter(Boolean),l=[];return u.forEach((p,d)=>{l.push(p),d<u.length-1&&l.push(Xn({className:"g-ui-breadcrumbs-separator"},r))}),Un({...o,className:s("g-ui-breadcrumbs",a)},l)}import{Div as Qn}from"@granularjs/core";function Jn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Qn({...a,className:s("g-ui-center",r)},t)}import{Div as es}from"@granularjs/core";function is(...e){let{props:i}=g(e,{size:"md"}),{size:t,className:r,...a}=i;return es({...a,className:s("g-ui-space",[t,o=>`g-ui-space-${o}`],r)})}import{Div as ts,when as rs}from"@granularjs/core";function as(...e){let{props:i,children:t}=g(e),{opened:r,className:a,...o}=i;return rs(r,()=>ts({...o,className:s("g-ui-collapse",a)},t))}import{Button as os}from"@granularjs/core";function Ye(...e){let{props:i,children:t}=g(e,{size:"md",variant:"filled"}),{size:r,variant:a,color:o,className:n,...u}=i;return os({...u,type:"button",className:s("g-ui-action-icon",z("g-ui-action-icon-size-",r,"md"),z("g-ui-action-icon-color-",o,"primary"),z("g-ui-action-icon-",a,"filled"),n)},t)}import{Div as Nt,when as ns,after as ss,state as us}from"@granularjs/core";function Ct(...e){let{props:i,rawProps:t,children:r}=g(e,{position:"left"}),{opened:a,position:o,content:n,className:u,...l}=i,{onChange:p}=t,d=us(m(a)??!1);ss(a).change(f=>{let c=m(f);c!=null&&d.set(!!c)});let w=f=>{d.set(f),p?.(f)};return Nt({...l,className:s("g-ui-popover",i.className??u)},Nt({onClick:()=>w(!d.get())},r),ns(d,()=>Nt({className:s("g-ui-popover-dropdown",o==="right"&&"g-ui-popover-right",o==="center"&&"g-ui-popover-center")},n)))}import{Div as Cr}from"@granularjs/core";function gs(...e){let{props:i,children:t}=g(e,{position:"left"}),{position:r,content:a,className:o,...n}=i;return Cr({...n,className:s("g-ui-hover-card",o)},t,Cr({className:s("g-ui-hover-card-dropdown",[r,u=>u==="right"?"g-ui-hover-card-right":""],[r,u=>u==="center"?"g-ui-hover-card-center":""])},a))}import{Div as ls}from"@granularjs/core";function cs(...e){let{props:i,children:t}=g(e,{position:"bottom-right"}),{position:r,className:a,...o}=i;return ls({...o,className:s("g-ui-affix",[r,n=>`g-ui-affix-${n}`],a)},t)}import{Fieldset as ps,Legend as ds,when as ms}from"@granularjs/core";function fs(...e){let{props:i,children:t}=g(e),{legend:r,className:a,...o}=i;return ps({...o,className:s("g-ui-fieldset",a)},ms(r,()=>ds({className:"g-ui-legend"},r)),t)}import{Div as vs}from"@granularjs/core";function hs(...e){let{props:i,children:t}=g(e,{position:"sticky"}),{position:r,className:a,...o}=i;return vs({...o,className:s("g-ui-appbar",z("g-ui-appbar-",r,"sticky"),a)},t)}import{Div as St,portal as bs,after as Ti,state as Sr,when as Dr}from"@granularjs/core";function xs(...e){let{props:i,children:t}=g(e,{position:"left",size:"md",blur:!0,fixed:!1,minWidth:"button"});return Dr(i.fixed,()=>ys(i,t),()=>ws(i,t))}var ws=(e,i)=>{let{open:t,onClose:r,position:a,size:o,blur:n,fixed:u,minWidth:l,className:p,...d}=e,w=Sr(!1),f=Sr(!1),c=220,h=$=>{if($){w.set(!0),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>f.set(!0)):setTimeout(()=>f.set(!0),0);return}f.set(!1),setTimeout(()=>w.set(!1),c)};h(!!t.get()),Ti(t).change($=>h(!!$));let k=Ti(f,n).compute($=>{let[S,M]=$;return s("g-ui-sidebar-overlay",S&&"g-ui-sidebar-overlay-open",!M&&"g-ui-sidebar-overlay-noblur")}),V=Ti(o,a,f,p).compute($=>{let[S,M,C,x]=$,y=M==="right"?"g-ui-sidebar-drawer-right g-ui-sidebar-position-right":"g-ui-sidebar-drawer-left";return s("g-ui-sidebar","g-ui-sidebar-drawer",`g-ui-sidebar-size-${S}`,y,C&&"g-ui-sidebar-drawer-open",m(x))});return Dr(w,()=>bs(St({className:k,onClick:r},St({className:V,onClick:$=>$.stopPropagation()},i))))},ys=(e,i)=>{let{open:t,position:r,size:a,minWidth:o,className:n,...u}=e,l=Ti(a,r,t,o,n).compute(p=>{let[d,w,f,c,h]=p,k=c||"button",V=null;return k==="button"?V="g-ui-sidebar-min-button":k==="xs"?V="g-ui-sidebar-min-xs":k==="sm"?V="g-ui-sidebar-min-sm":k==="md"&&(V="g-ui-sidebar-min-md"),s("g-ui-sidebar g-ui-sidebar-fixed",`g-ui-sidebar-size-${d||"md"}`,V,f&&"g-ui-sidebar-fixed-open",h)});return St({...u,className:l},i)};import{Div as Ne,when as Vi,list as Pr,after as ne,resolve as de,state as ks,Img as zs,Span as Ns}from"@granularjs/core";var Mr={xs:6,sm:8,md:10,lg:12,xl:14},Cs={xs:"2px",sm:"3px",md:"4px",lg:"6px",xl:"8px"},Ss={xs:"6px",sm:"8px",md:"10px",lg:"12px",xl:"14px"},Ds=14;function Ps(e){if(e==null||e==="")return"var(--g-ui-primary)";let i=String(e).trim();return i.startsWith("#")?i:`var(--g-ui-${i})`}function Ms(e){return(e??[]).map(t=>{if(t==null)return 1;let r=Number(t.weight);return Number.isFinite(r)&&r>=0?r:1})}function Li(e){let i=(e??[]).length;if(i<2)return{totalWeight:0,cumulativeWeights:[0]};let r=Ms(e).slice(0,i-1),a=r.reduce((n,u)=>n+u,0),o=[0];for(let n=0;n<r.length;n++)o.push(o[n]+r[n]);return{totalWeight:a,cumulativeWeights:o}}function Tr(e,i,t,r){if(r<1||t<=0)return 0;let a=Math.max(0,Math.min(100,e));for(let o=r-1;o>=0;o--){let n=i[o]/t*100;if(a>=n)return o}return 0}function Ts(e,i,t,r,a,o,n){let u=e,l=(n??[]).length;if(l===0)return{activeStep:0,progressPct:0};if(u==="step")return{activeStep:Math.max(0,Math.min(l-1,Math.floor(i??0))),progressPct:0};if(u==="percent"){let p=Math.max(0,Math.min(100,Number(t)||0)),d=Li(n);return{activeStep:Tr(p,d.cumulativeWeights,d.totalWeight,l),progressPct:p}}if(u==="time"){let p=Number(r)||0,d=a,w=o,f=0;if(Array.isArray(d)&&d.length>=l?f=d.slice(0,l).reduce((S,M)=>S+(Number(M)||0),0):typeof w=="number"&&w>0&&(f=w),f<=0)return{activeStep:0,progressPct:0};let c=f/l,h=0;if(Array.isArray(d)&&d.length>=l){let S=0;for(let M=0;M<l;M++){if(S+=Number(d[M])||0,p<S){h=M;break}h=M}}else h=Math.min(l-1,Math.floor(p/c));let k=Math.min(100,p/f*100),V=Li(n);return{activeStep:Tr(k,V.cumulativeWeights,V.totalWeight,l),progressPct:k}}return{activeStep:0,progressPct:0}}function Vs(e,i,t,r,a,o){if(a<2||r<0||r>=a-1)return 0;if(e==="step")return i>r?100:0;let{totalWeight:n,cumulativeWeights:u}=o??Li([]);if(n<=0)return 0;let l=u[r]/n*100,p=u[r+1]/n*100;if(t<=l)return 0;if(t>=p)return 100;let d=p-l;return d<=0?0:(t-l)/d*100}var Ls=0;function Is(e){let i=document.getElementById(e);if(!i)return[];let t=i.querySelectorAll(".g-ui-timeline-item");if(t.length<2)return[];let r=i.dataset.pinSize||"md",a=Mr[r]??Mr.md,o=[];for(let n=0;n<t.length-1;n++){let u=t[n].offsetTop+a,l=t[n+1].offsetTop-t[n].offsetTop;o.push({top:u,height:l})}return o}function $s(...e){let{props:i,rawProps:t}=g(e,{items:[],mode:"step",active:0,progress:0,elapsedMs:0,stepDurationsMs:null,totalDurationMs:null,clickable:!1,pinRadius:"md",reverseActive:!1,lineWidth:"md",pinSize:"md",activeColor:"primary",align:"left",pinMode:"default"}),{items:r,mode:a,active:o,progress:n,elapsedMs:u,stepDurationsMs:l,totalDurationMs:p,clickable:d,pinRadius:w,reverseActive:f,lineWidth:c,pinSize:h,activeColor:k,align:V,pinMode:$,className:S,...M}=i,{onChange:C}=t,x=ne(k).compute(E=>Ps(de(E))),y=`g-ui-timeline-${++Ls}`,v=ks([]),N=ne(a,o,n,u,l,p,r).compute(E=>{let[G,ie,ae,X,T,j,D]=E;return Ts(G,ie,ae,X,T,j,D)}),I=ne(v,f).compute(([E,G])=>{if(!de(G)||!E?.length)return null;let ie=E[0],ae=0;for(let X of E)ae+=X.height;return{top:ie.top,height:ae}}),B=ne(N).compute(E=>E?.progressPct!=null?`${Math.max(0,Math.min(100,E.progressPct))}%`:"0%"),Q=ne(a).compute(E=>{let G=de(E);return G==="time"||G==="percent"||G==="step"}),se=ne(a).compute(E=>de(E));function re(){setTimeout(()=>{let E=Is(y);E.length&&v.set(E)},0)}return ne(r).change(()=>re()),ne(h).change(()=>re()),re(),Ne({...M,id:y,"data-pin-size":ne(h).compute(E=>de(E)??"md"),"data-active-color":ne(k).compute(E=>{let G=de(E);if(G==null||typeof G!="string")return"primary";let ie=String(G).trim();return ie.startsWith("#")?"custom":ie||"primary"}),style:ne(k,c,h).compute(([E,G,ie])=>{let ae={"--g-ui-timeline-line-width":Cs[de(G)]??"4px","--g-ui-timeline-track-offset":`calc(${Ds}px - var(--g-ui-timeline-line-width) / 2)`,"--g-ui-timeline-pin-half":Ss[de(ie)]??"10px"},X=de(E);return X&&String(X).trim().startsWith("#")&&(ae["--g-ui-timeline-active-color"]=String(X).trim()),ae}),className:s("g-ui-timeline",ne(a).compute(E=>E?`g-ui-timeline-mode-${de(E)}`:""),ne(Q).compute(E=>E?"g-ui-timeline-has-track":""),ne(d).compute(E=>de(E)?"g-ui-timeline-clickable":""),ne(f).compute(E=>de(E)?"g-ui-timeline-reverse":""),ne(V).compute(E=>de(E)==="right"?"g-ui-timeline-align-right":""),z("g-ui-timeline-pin-radius-",w,"md"),z("g-ui-timeline-line-width-",c,"md"),z("g-ui-timeline-pin-size-",h,"md"),ne($).compute(E=>E?`g-ui-timeline-pin-mode-${de(E)}`:""),S)},Vi(Q,()=>ne(f).compute(E=>de(E)?Ne({className:"g-ui-timeline-track-segment g-ui-timeline-track-reverse",style:ne(I).compute(G=>G?{top:`${G.top}px`,height:`${G.height}px`}:{})},Ne({className:"g-ui-timeline-track-fill",style:ne(B).compute(G=>G?{height:G}:{height:"0%"})})):Pr(v,(G,ie)=>{let ae=ne(G).compute(j=>j?{top:`${j.top}px`,height:`${j.height}px`}:{}),X=ne(N,ie,r,se).compute(([j,D,Y,P])=>{let R=Y??[],H=R.length,J=Li(R);return Vs(P,j?.activeStep??0,j?.progressPct??0,de(D)??0,H,J)}),T=ne(X).compute(j=>`${Math.max(0,Math.min(100,j))}%`);return Ne({className:"g-ui-timeline-track-segment",style:ne(ae).compute(j=>j)},Ne({className:"g-ui-timeline-track-fill",style:ne(T).compute(j=>j?{height:j}:{height:"0%"})}))}))),Pr(r,(E,G)=>{let ie=ne(N,G,r,f).compute(([R,H,J,pe])=>{let ke=R?.activeStep??0,Pe=de(H)??0,Be=(J??[]).length,Ve=de(pe)?Be-1-Pe:Pe;return Ve<ke?"completed":Ve===ke?"active":"future"}),ae=ne(ie).compute(R=>R?`g-ui-timeline-item-${R}`:""),X=de(d)&&typeof C=="function"?()=>{let R=de(G);typeof R=="number"&&C(R)}:void 0,T=ne($).compute(R=>de(R)??"default"),j=ne(T,E).compute(([R,H])=>{let J=R??"default";return J==="icon"&&(H?.icon!=null||H?.pinIcon!=null)?Ns({className:"g-ui-timeline-pin-icon material-symbols-outlined"},H.icon??H.pinIcon??""):J==="image"&&(H?.image!=null||H?.pinImage!=null||H?.src!=null)?zs({className:"g-ui-timeline-pin-image",src:H.image??H.pinImage??H.src,alt:H.pinImageAlt??""}):J==="custom"&&H?.pinContent!=null?H.pinContent:null}),D=ne(T,E).compute(([R,H])=>{let J=R??"default";return J==="icon"?H?.icon!=null||H?.pinIcon!=null:J==="image"?H?.image!=null||H?.pinImage!=null||H?.src!=null:J==="custom"?H?.pinContent!=null:!1}),Y=Ne({className:"g-ui-timeline-dot"},Ne({className:"g-ui-timeline-dot-inner"}),Vi(D,()=>j)),P=Ne({className:"g-ui-timeline-content"},Vi(E.title,()=>Ne({className:"g-ui-timeline-title"},E.title)),Vi(E.description,()=>Ne({className:"g-ui-timeline-desc"},E.description)),E.content);return Ne({className:s("g-ui-timeline-item",ae),style:ne(x).compute(R=>R?{"--g-ui-timeline-active-color":R}:void 0),onClick:X,role:X?"button":void 0,tabIndex:X?0:void 0},Ne({className:"g-ui-dot-wrapper"},Y),P)}))}import{Div as Ii,list as As}from"@granularjs/core";function Bs(...e){let{props:i}=g(e,{active:0,items:[]}),{active:t,items:r,className:a,...o}=i;return Ii({...o,className:s("g-ui-stepper",a)},As(r,(n,u)=>Ii({className:s("g-ui-stepper-item",[t,l=>(console.log("value",l,"idx",u),u.get()===l?"g-ui-stepper-active":"")])},Ii({className:"g-ui-stepper-index"},String(u+1)),Ii({className:"g-ui-stepper-label"},n.label))))}import{Span as Vr,after as Lr,state as Fs}from"@granularjs/core";function js(...e){let{props:i,rawProps:t}=g(e,{value:0,max:5,size:"md"}),{value:r,max:a,size:o,className:n,...u}=i,{onChange:l}=t,p=Fs(m(r));Lr(r).change(c=>{let h=m(c);h!=null&&p.set(h)});let d=c=>{p.set(c),l?.(c)},w=[],f=Number(m(a))||0;for(let c=1;c<=f;c+=1)w.push(c);return Vr({...u,className:s("g-ui-rating",z("g-ui-rating-size-",o,"md"),i.className??n)},w.map(c=>Vr({className:s("g-ui-rating-item",Lr(p).compute(h=>c<=h?"g-ui-rating-item-active":"")),onClick:()=>d(c)},"\u2605")))}import{Span as Es}from"@granularjs/core";function Rs(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Es({...a,className:s("g-ui-tag",r)},t)}import{Button as Ir,Div as Ke,state as $r,after as $i}from"@granularjs/core";var Hs=["S","M","T","W","T","F","S"];function li(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{value:r,className:a,size:o,...n}=i,{onChange:u}=t,l=S=>{let M=m(S);if(M instanceof Date)return M;if(M==null)return null;let C=new Date(M);return Number.isNaN(C.getTime())?null:C},p=$r(l(r)??new Date),d=$r(new Date(p.get()));$i(r).change(S=>{let M=l(S);M!=null&&(p.set(M),d.set(new Date(M)))});let w=(S,M,C)=>{let x=new Date(S,M+1,0).getDate();return new Date(S,M,Math.min(C,x))},f=S=>{let M=d.get(),C=w(M.getFullYear(),M.getMonth(),S);p.set(C),d.set(C),u?.(C)},c=S=>{let M=d.get(),C=w(M.getFullYear(),M.getMonth()+S,M.getDate());d.set(C)},h=S=>{let M=d.get(),C=w(M.getFullYear()+S,M.getMonth(),M.getDate());d.set(C)},k=$i(d).compute(S=>S.toLocaleString("default",{month:"long"})),V=$i(d).compute(S=>String(S.getFullYear())),$=$i(d,p).compute(([S,M])=>{let C=S.getFullYear(),x=S.getMonth(),v=new Date(C,x,1).getDay(),N=new Date(C,x+1,0).getDate(),I=[];for(let B=0;B<v;B+=1)I.push({muted:!0,label:""});for(let B=1;B<=N;B+=1)I.push({label:B});return[...Hs.map(B=>Ke({className:"g-ui-calendar-cell g-ui-calendar-cell-muted"},B)),...I.map(B=>Ke({className:s("g-ui-calendar-cell",B.muted&&"g-ui-calendar-cell-muted",B.label&&M.getFullYear()===C&&M.getMonth()===x&&B.label===M.getDate()&&"g-ui-calendar-cell-active"),onClick:()=>B.label&&f(B.label)},B.label))]});return Ke({...n,className:s("g-ui-calendar",a,z("g-ui-calendar-size-",o,"md"))},Ke({className:"g-ui-calendar-header"},Ye({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>c(-1)},ye({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:ki})),Ke({className:"g-ui-calendar-title-group"},Ir({type:"button",className:"g-ui-calendar-title-button",onClick:()=>c(1)},k),Ir({type:"button",className:"g-ui-calendar-title-button",onClick:()=>h(1)},V)),Ye({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>c(1)},ye({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:yi}))),Ke({className:"g-ui-calendar-grid"},$))}import{Div as ci,Span as Qe,Input as Os,when as Dt,after as De,state as Ai}from"@granularjs/core";function Ws(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"md",searchable:!0}),{value:r,data:a,size:o,className:n,placeholder:u,searchable:l,...p}=i,{onChange:d,onSearchChange:w}=t,f=Ai(m(r)??[]),c=Ai(""),h=Ai(!1),k=Ai(null),V=v=>(m(v)??[]).map(I=>typeof I=="string"?{value:I,label:I}:I&&typeof I=="object"?I:{value:String(I),label:String(I)});De(r).change(v=>{let N=m(v);N!=null&&f.set(N)});let $=null;De(h).change(v=>{if($&&($(),$=null),!v)return;let N=I=>{let B=k.get();B&&(B.contains(I.target)||h.set(!1))};document.addEventListener("mousedown",N),$=()=>document.removeEventListener("mousedown",N)}),De(c).change(v=>{w?.(v)});let S=v=>{let N=f.get()??[],I=N.includes(v)?N.filter(B=>B!==v):N.concat(v);f.set(I),d?.(I)},M=De(a).compute(v=>V(v)),C=De(M,c).compute(([v,N])=>{let I=String(m(N)??"").toLowerCase().trim();return I?v.filter(B=>String(B.label??"").toLowerCase().includes(I)):v}),x=De(f,c).compute(([v,N])=>{let I=m(v)??[],B=String(m(N)??"");return!I.length&&!B}),y=De(l).compute(v=>!!v);return ci({...p,node:k,className:s("g-ui-select-multi-root",n)},ci({className:s("g-ui-select-multi",z("g-ui-select-multi-size-",o,"md")),onClick:()=>h.set(!0)},De(M,f).compute(([v,N])=>(m(N)??[]).map(B=>{let se=(v??[]).find(re=>re.value===B)?.label??B;return Qe({className:"g-ui-select-tag"},Qe({className:"g-ui-select-tag-label",onClick:re=>{re?.stopPropagation?.()}},se),Qe({className:"g-ui-select-tag-remove",innerHTML:je,onClick:re=>{re?.stopPropagation?.(),S(B)}}))})),Dt(x,()=>Qe({className:"g-ui-select-multi-placeholder"},u??"Select...")),Dt(y,()=>Os({className:"g-ui-select-multi-input",value:c,onInput:v=>c.set(v.target?.value??""),onFocus:()=>h.set(!0)}))),Dt(h,()=>ci({className:"g-ui-select-dropdown"},De(C).compute(v=>v.length?v.map(N=>ci({className:s("g-ui-select-item",N.disabled&&"g-ui-select-item-disabled",De(f).compute(I=>(m(I)??[]).includes(N.value)?"g-ui-select-item-active":"")),onClick:()=>{N.disabled||S(N.value)}},Qe({className:"g-ui-select-item-check",innerHTML:De(f).compute(I=>(m(I)??[]).includes(N.value)?zi:"")}),Qe({className:"g-ui-select-item-label"},N.label))):ci({className:"g-ui-select-item"},"Nothing found")))))}import{Div as Gs,list as _s,portal as Zs}from"@granularjs/core";import{Div as Pt,Button as qs,when as Ar,state as Ys}from"@granularjs/core";function Mt(...e){let{props:i,rawProps:t,children:r}=g(e),{title:a,className:o,...n}=i,{onClose:u}=t,l=Ys(!0),p=()=>{l.set(!1),u?.(),console.log("close")};return Ar(l,()=>Pt({...n,className:s("g-ui-toast",o)},Pt({className:"g-ui-toast-row"},Ar(a,()=>Pt({className:"g-ui-toast-title"},a)),qs({className:"g-ui-toast-close",onClick:p},ye({innerHTML:je}))),r))}function Us(...e){let{props:i,rawProps:t}=g(e,{items:[]}),{items:r,className:a,timeout:o,...n}=i,{onClose:u}=t;return Zs(Gs({...n,className:s("g-ui-toast-stack",a)},_s(r,l=>Mt({title:l.title,onClose:()=>u?.(l)},l.message))))}function Xs(...e){let{props:i}=g(e);return li(i)}import{Div as Ks,after as Qs}from"@granularjs/core";function Js(...e){let{props:i,rawProps:t}=g(e,{items:[],position:"top-right"}),{items:r,position:a,className:o,...n}=i,{onRemove:u}=t,l=new Map,p=(w,f)=>w?.id??w?.key??f,d=Qs(r).compute(w=>{let f=m(w)??[],c=new Set;f.forEach((h,k)=>{let V=p(h,k);if(c.add(V),h?.autoClose&&!l.has(V)){let $=setTimeout(()=>{l.delete(V),u?.(h)},h.autoClose);l.set(V,$)}});for(let[h,k]of l.entries())c.has(h)||(clearTimeout(k),l.delete(h));return f.map((h,k)=>pt({key:p(h,k),title:h.title,color:h.color,icon:h.icon,loading:h.loading,withCloseButton:h.withCloseButton,withBorder:h.withBorder,onClose:()=>{h.onClose?.(),u?.(h)}},h.message??h.body??h.content??h.text))});return Ks({...n,className:s("g-ui-notifications",z("g-ui-notifications-position-",a,"top-right"),o)},d)}import{Div as Je,after as pi,state as eu,when as iu}from"@granularjs/core";function tu(...e){let{props:i,rawProps:t}=g(e,{min:0,max:100,step:1,size:"md"}),{value:r,marks:a,min:o,max:n,step:u,size:l,disabled:p,className:d,...w}=i,{onChange:f}=t,c=eu(m(r??[o,n])),h=()=>{let x=Number(m(o)),y=Number(m(n));return!Number.isFinite(x)||!Number.isFinite(y)?{minValue:0,maxValue:100}:{minValue:Math.min(x,y),maxValue:Math.max(x,y)}},k=()=>{let x=Number(m(u));return Number.isFinite(x)&&x>0?x:1},V=x=>{let{minValue:y,maxValue:v}=h(),N=k(),I=[y,v];Array.isArray(x)&&(I=x);let B=Math.max(y,Math.min(v,Number(I[0]))),Q=Math.max(y,Math.min(v,Number(I[1]))),se=Math.round(Math.min(B,Q)/N)*N,re=Math.round(Math.max(B,Q)/N)*N;return[se,re]};pi(r).change(x=>{x!=null&&c.set(V(x))});let $=x=>{let y=V(x);y?.[0]===c.get()?.[0]&&y?.[1]===c.get()?.[1]||(c.set(y),f?.(y))},S=pi(c).compute(x=>{let{minValue:y,maxValue:v}=h(),N=v-y,[I,B]=V(x);if(N<=0)return{lowPct:0,highPct:0};let Q=(I-y)/N*100,se=(B-y)/N*100;return{lowPct:Math.max(0,Math.min(100,Q)),highPct:Math.max(0,Math.min(100,se))}}),M=(x,y,v)=>{let N=y?.();if(!N||N.width===0)return;let B=Math.min(Math.max(x.clientX-N.left,0),N.width)/N.width,{minValue:Q,maxValue:se}=h(),re=Q+B*(se-Q),E=c;typeof c.get=="function"&&(E=c.get());let[G,ie]=V(E);$(v==="low"?[re,ie]:[G,re])},C=(x,y,v)=>{if(ze(p))return;x.preventDefault?.();let N=v||x.currentTarget,I=()=>N.getBoundingClientRect(),B=I(),Q=S;typeof S.get=="function"&&(Q=S.get());let{lowPct:se,highPct:re}=Q,E=(x.clientX-B.left)/B.width*100,G=y;if(!G){let X=Math.abs(E-se)<=Math.abs(E-re);G="high",X&&(G="low")}N.setPointerCapture?.(x.pointerId),M(x,I,G);let ie=X=>M(X,I,G),ae=()=>{N.releasePointerCapture?.(x.pointerId),window.removeEventListener("pointermove",ie),window.removeEventListener("pointerup",ae)};window.addEventListener("pointermove",ie),window.addEventListener("pointerup",ae)};return Je({...w,className:s("g-ui-range-slider",z("g-ui-slider-size-",l,"md"),U("g-ui-slider-disabled",p),i.className??d)},Je({className:"g-ui-slider-track",onPointerDown:x=>C(x)},Je({className:"g-ui-slider-bar",style:pi(S).compute(({lowPct:x,highPct:y})=>({left:`${x}%`,width:`${Math.max(0,y-x)}%`}))}),Je({className:"g-ui-slider-thumb",style:pi(S).compute(({lowPct:x})=>({left:`${x}%`})),onPointerDown:x=>{x.stopPropagation?.(),C(x,"low",x.currentTarget.parentElement)}}),Je({className:"g-ui-slider-thumb",style:pi(S).compute(({highPct:x})=>({left:`${x}%`})),onPointerDown:x=>{x.stopPropagation?.(),C(x,"high",x.currentTarget.parentElement)}})),iu(a,()=>Je({className:"g-ui-slider-marks"},a.map(x=>bt({mark:x,getBounds:h})))))}import{state as Tt,after as Br}from"@granularjs/core";function Bi(...e){let{props:i,rawProps:t}=g(e,{size:"md",format:{pattern:"dddd-dd-dd"}}),{value:r,size:a,calendarSize:o,leftSection:n,rightSection:u,className:l,format:p,minDate:d,maxDate:w,...f}=i,{onChange:c}=t,h=y=>{let v=m(y);if(v instanceof Date)return v;if(v==null||v==="")return null;let N=new Date(v);return Number.isNaN(N.getTime())?null:N},k=(y,v)=>y&&v&&y.getFullYear()===v.getFullYear()&&y.getMonth()===v.getMonth()&&y.getDate()===v.getDate(),V=y=>{if(!y)return"";let v=String(y.getFullYear()).padStart(4,"0"),N=String(y.getMonth()+1).padStart(2,"0"),I=String(y.getDate()).padStart(2,"0");return`${v}-${N}-${I}`},$=y=>{let v=String(y??"").replace(/\D/g,"");if(v.length<8)return null;let N=Number(v.slice(0,4)),I=Number(v.slice(4,6)),B=Number(v.slice(6,8));if(!N||!I||!B)return null;let Q=new Date(N,I-1,B);if(Q.getFullYear()!==N||Q.getMonth()!==I-1||Q.getDate()!==B)return null;let se=h(d);if(se&&Q<se)return null;let re=h(w);return re&&Q>re?null:Q},S=Tt(h(r)),M=Tt(V(S.get())),C=Tt(!1);Br(r).change(y=>{let v=h(y);if(!k(v,S.get())){if(v==null){S.set(null),M.set("");return}S.set(v),M.set(V(v))}}),Br(M).change(y=>{let v=$(y);v&&(k(v,S.get())||(S.set(v),c?.(v)))});let x=y=>{y&&(k(y,S.get())||(S.set(y),M.set(V(y)),c?.(y),C.set(!1)))};return Ct({opened:C,onChange:y=>C.set(!!y),content:li({size:z("",o,"xs"),value:S,onChange:x}),className:"g-ui-date-input-popover"},be({...f,size:a,className:s("g-ui-dateinput",l),leftSection:n,rightSection:u,type:"text",inputMode:"numeric",format:p,value:M,onChange:y=>M.set(y)}))}import{Div as Vt,when as ru,after as au,state as ou}from"@granularjs/core";function nu(...e){let{props:i,rawProps:t,children:r}=g(e),{opened:a,content:o,className:n,...u}=i,{onChange:l}=t,p=ou(m(a)??!1);au(a).change(w=>{let f=m(w);f!=null&&p.set(!!f)});let d=w=>{p.set(w),l?.(w)};return Vt({...u,className:s("g-ui-popper",n)},Vt({onClick:()=>d(!p.get())},r),ru(p,()=>Vt({className:"g-ui-popper-dropdown"},o)))}import{Button as su,after as Fr,when as uu,state as gu}from"@granularjs/core";function lu(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{size:r,className:a,rightSection:o,...n}=i,{onChange:u}=t,l=gu(!1),p=Fr(l).compute(w=>w?"text":"password"),d=Fr(o).compute(w=>w??su({className:"g-ui-password-toggle",onClick:()=>l.set(!l.get())},uu(l,()=>"Hide",()=>"Show")));return be({...n,size:r,className:a,onChange:u,rightSection:d,type:p})}import{Div as cu}from"@granularjs/core";function pu(...e){let{props:i}=g(e,{size:"md"}),{size:t,className:r,...a}=i;return be({...a,size:t,className:r,leftSection:cu({className:"g-ui-search-input-left-section",innerHTML:Jt}),type:"text",inputMode:"search"})}import{Button as du,after as mu,when as jr}from"@granularjs/core";import{state as fu}from"@granularjs/core";function vu(...e){let{props:i,children:t}=g(e,{value:"",timeout:1500}),{value:r,timeout:a,className:o,...n}=i,u=fu(!1),l=mu(u).compute(d=>s("g-ui-copy-button",d&&"g-ui-copy-button-done",o));return du({...n,className:l,onClick:async()=>{try{await navigator.clipboard.writeText(String(r)),u.set(!0),setTimeout(()=>u.set(!1),a)}catch{}},type:"button"},jr(t?.length,()=>t,()=>jr(u,()=>"Copied",()=>"Copy")))}import{Div as Er,after as di,resolve as hu}from"@granularjs/core";function Rr(e){let i=Number(e);return Number.isNaN(i)?0:Math.max(0,Math.min(100,i))}function bu(...e){let{props:i}=g(e,{size:"md",value:null,color:"primary"}),{size:t,value:r,color:a,className:o,...n}=i,u=di(r).compute(f=>f!=null&&f!==""),l=di(r).compute(f=>Rr(f)),p=di(l,u).compute(([f,c])=>{if(!c)return{};let h=Number(f),k=Number.isNaN(h)?0:Math.max(0,Math.min(360,h*3.6));return{background:`conic-gradient(var(--g-ui-progress-ring-fill, var(--g-ui-primary)) 0deg ${k}deg, var(--g-ui-border-muted) ${k}deg 360deg)`}}),d=di(u).compute(f=>f?"":"g-ui-progress-ring-indeterminate"),w=di(u,r).compute(([f,c])=>f?Rr(c):void 0);return Er({...n,className:s("g-ui-progress-ring",z("g-ui-progress-ring-",a,"primary"),[t,f=>`g-ui-progress-ring-size-${hu(f)??"md"}`],d,o),style:p,role:"progressbar","aria-valuemin":0,"aria-valuemax":100,"aria-valuenow":w},Er({className:"g-ui-progress-ring-hole"}))}import{Div as Fi,state as It,after as Ge,list as wu,when as yu}from"@granularjs/core";import{Div as xu}from"@granularjs/core";function Lt(...e){let{props:i,children:t}=g(e,{size:"md"}),{size:r,className:a,...o}=i;return xu({...o,className:s("g-ui-scroll-area",[r,n=>`g-ui-scroll-area-${n}`],a)},t)}function $e(e,i){if(i==null||i==="")return e;let t=String(i).trim().split("."),r=e;for(let a of t)r=r?.[a];return r}function ku(e,i,t){let r=t(i);return String(r??"").toLowerCase().includes(String(e??"").toLowerCase())}function $t(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"md",valuePath:"value",labelPath:"label"}),{data:r,value:a,size:o,valuePath:n,labelPath:u,filter:l,placeholder:p,label:d,description:w,error:f,leftSection:c,rightSection:h,className:k,inputClassName:V,disabled:$,...S}=i,{onChange:M,renderItem:C}=t,x=It(!1),y=It(""),v=It(m(a));Ge(a).change(D=>{let Y=m(D);Y!==v.get()&&v.set(Y)});let N=Ge(r).compute(D=>Array.isArray(D)?D:[]),I=Ge(N,v,n).compute(([D,Y,P])=>{if(Y==null)return null;let R=H=>P==null||P===""?H:$e(H,P);return D.find(H=>R(H)===Y)??null}),B=Ge(I,x,y,u).compute(([D,Y,P,R])=>{let H=J=>R==null||R===""?String(J??""):String($e(J,R)??"");return Y?P??"":D?H(D):""}),Q=Ge(N,y,l,u).compute(([D,Y,P,R])=>{let H=pe=>R==null||R===""?String(pe??""):String($e(pe,R)??""),J=m(P)??ku;return D.filter(pe=>J(Y,pe,H))}),se=D=>{let Y=m(n),P=Y==null||Y===""?D:$e(D,Y);v.set(P),y.set(""),x.set(!1),M?.(P)},re=()=>{if(m($))return;x.set(!0);let D=I.get(),Y=m(u),P=R=>Y==null||Y===""?String(R??""):String($e(R,Y)??"");y.set(D?P(D):"")},E=()=>{x.set(!1);let D=I.get(),Y=m(u),P=R=>Y==null||Y===""?String(R??""):String($e(R,Y)??"");y.set(D?P(D):"")},{onChange:G,...ie}=S,ae={...ie,size:o,label:d,description:w,error:f,leftSection:c,rightSection:h,placeholder:m(p)??void 0,disabled:$,value:B,onInput:D=>y.set(D?.target?.value??""),onFocus:re,onClick:re,onBlur:()=>setTimeout(()=>E(),150)},X=D=>{let Y=m(n);return Y==null||Y===""?D:$e(D,Y)},T=D=>Ge(v,n).compute(([Y,P])=>(H=>P==null||P===""?H:$e(H,P))(D)===Y?"g-ui-autocomplete-item-active":""),j=D=>{if(C&&typeof C=="function"){let Y=C(D);if(Y!=null)return Fi({className:s("g-ui-autocomplete-item",T(D)),onClick:()=>se(D),role:"option"},Y)}return Fi({className:s("g-ui-autocomplete-item",T(D)),onClick:()=>se(D),role:"option"},Ge(u).compute(Y=>Y==null||Y===""?String(D??""):String($e(D,Y)??"")))};return Fi({className:s("g-ui-autocomplete",k,U("g-ui-autocomplete-disabled",$))},be({...ae,className:s("g-ui-autocomplete-input-wrapper",ae.className),inputClassName:s("g-ui-autocomplete-input",V)}),yu(x,()=>Fi({className:"g-ui-autocomplete-dropdown",role:"listbox"},Lt({className:"g-ui-autocomplete-list",style:{maxHeight:"240px"}},wu(Q,D=>j(D))))))}function zu(...e){return $t(...e)}import{Div as Nu,Span as Cu,state as Hr,after as Su}from"@granularjs/core";function Or(e){let i=m(e);if(i instanceof Date)return i;if(i==null||i==="")return null;let t=new Date(i);return Number.isNaN(t.getTime())?null:t}function Wr(e){let i=m(e);if(i==null)return[null,null];let t=Array.isArray(i)?i:[i];return[Or(t[0]),Or(t[1])]}function qr(e,i){return!e||!i?e===i:e.getFullYear()===i.getFullYear()&&e.getMonth()===i.getMonth()&&e.getDate()===i.getDate()}function Du(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{value:r,size:a,minDate:o,maxDate:n,className:u,placeholderMin:l,placeholderMax:p,...d}=i,{onChange:w}=t,[f,c]=Wr(r),h=Hr(f),k=Hr(c);Su(r).change(M=>{let[C,x]=Wr(M);qr(C,h.get())&&qr(x,k.get())||(h.set(C),k.set(x))});let V=()=>{let M=h.get(),C=k.get();w?.([M??null,C??null])},$=M=>{let C=k.get();M&&C&&M>C&&k.set(M),h.set(M),V()},S=M=>{let C=h.get();M&&C&&M<C&&h.set(M),k.set(M),V()};return Nu({...d,className:s("g-ui-range-picker",i.className??u)},Bi({...d,size:a,value:h,onChange:$,maxDate:k,placeholder:m(l)??void 0}),Cu({className:"g-ui-range-picker-separator"},"\u2013"),Bi({...d,size:a,value:k,onChange:S,minDate:h,placeholder:m(p)??void 0}))}import{Div as Pu}from"@granularjs/core";function Mu(...e){let{props:i,children:t}=g(e,{align:"center",direction:"row"}),{direction:r,wrap:a,align:o,justify:n,gap:u,className:l,...p}=i;return Pu({...p,className:s("g-ui-flex",[r,d=>d==="column"?"g-ui-flex-column":"g-ui-flex-row"],[a,"g-ui-flex-wrap"],[o,d=>d&&`g-ui-align-${d}`],[n,d=>d&&`g-ui-justify-${d}`],[u,d=>d&&`g-ui-gap-${d}`],l)},t)}import{A as Tu,Div as mi,Span as Yr,when as fi,after as Gr,state as Vu}from"@granularjs/core";function Lu(...e){let{props:i,rawProps:t,children:r}=g(e,{variant:"subtle",childrenOffset:24}),{label:a,description:o,leftSection:n,rightSection:u,active:l,disabled:p,variant:d,childrenOffset:w,opened:f,defaultOpened:c,className:h,padding:k,...V}=i,{onClick:$,onChange:S}=t,M=r.length>0,C=Vu(m(f)??m(c)??!1);Gr(f).change(v=>{let N=m(v);N!=null&&C.set(!!N)});let x=Gr(w).compute(v=>({paddingLeft:_t(m(v??24))??"24px"})),y=v=>{if(m(p)){v?.preventDefault?.();return}if(M){let N=!C.get();C.set(N),S?.(N)}$?.(v)};return mi({className:s("g-ui-navlink-root",h)},Tu({...V,className:s("g-ui-navlink",z("g-ui-navlink-variant-",d,"subtle"),U("g-ui-navlink-active",l),U("g-ui-navlink-disabled",p),z("g-ui-navlink-padding-",k,"md")),onClick:y},fi(n,()=>Yr({className:"g-ui-navlink-section g-ui-navlink-left"},n)),mi({className:"g-ui-navlink-body"},fi(a,()=>mi({className:"g-ui-navlink-label"},a)),fi(o,()=>mi({className:"g-ui-navlink-description"},o))),fi(u,()=>Yr({className:"g-ui-navlink-section g-ui-navlink-right"},u))),M?fi(C,()=>mi({className:"g-ui-navlink-children",style:x},r)):null)}import{Div as _r,when as Iu}from"@granularjs/core";function $u(...e){let{props:i,children:t}=g(e,{show:!0,position:"top-right",color:"danger",size:"md"}),{show:r,position:a,color:o,size:n,className:u,...l}=i;return _r({...l,className:s("g-ui-indicator",z("g-ui-indicator-position-",a,"top-right"),z("g-ui-indicator-color-",o,"danger"),z("g-ui-indicator-size-",n,"md"),u)},t,Iu(r,()=>_r({className:"g-ui-indicator-badge"})))}import{Span as ji}from"@granularjs/core";function Au(...e){let{props:i}=g(e),{opened:t,className:r,...a}=i;return ji({...a,className:s("g-ui-burger",[t,"g-ui-burger-open"],r)},ji(""),ji(""),ji(""))}import{Div as Bu,when as Fu}from"@granularjs/core";function ju(...e){let{props:i}=g(e),{visible:t,...r}=i;return Fu(t,()=>Bu({...r,className:"g-ui-loading-overlay"},ni({})))}import{Div as Eu}from"@granularjs/core";function Ru(...e){let{props:i,children:t}=g(e,{gap:"md"}),{className:r,gap:a,...o}=i;return Eu({...o,className:s("g-ui-grid-system",[a,n=>`g-ui-gap-${n}`],r)},t)}import{Div as Hu}from"@granularjs/core";function Ou(...e){let{props:i,children:t}=g(e,{span:12}),{span:r,className:a,...o}=i;return Hu({...o,className:s([r,n=>`g-ui-col-span-${n}`],a)},t)}import{Div as Zr,Input as Wu,after as Ae,state as At,when as Ur,list as qu}from"@granularjs/core";function Yu(...e){let{props:i,rawProps:t}=g(e,{length:4,size:"md",type:"alphanumeric",mask:!1,placeholder:"\u25CB",disabled:!1,error:!1,oneTimeCode:!1}),{length:r,value:a,size:o,type:n,mask:u,placeholder:l,disabled:p,error:d,oneTimeCode:w,className:f}=i,{onChange:c,onComplete:h}=t,k=At(m(r)??4),V=()=>k.get();Ae(r).change(T=>{let j=m(T)??4,D=k.get();if(j===D)return;k.set(j);let Y=S.get(),P=$.get();S.set(Array.from({length:j},(R,H)=>Y[H]??"")),$.set(Array.from({length:j},(R,H)=>P[H]??null))});let $=At(Array.from({length:V()},()=>null)),S=At(Array.from({length:V()},(T,j)=>{let D=m(a);return typeof D=="string"||Array.isArray(D)?D[j]??"":""}));Ae(a).change(T=>{if(T==null)return;let j=V();typeof T=="string"?S.set(Array.from({length:j},(D,Y)=>T[Y]??"")):Array.isArray(T)&&S.set(Array.from({length:j},(D,Y)=>T[Y]??""))});let M=()=>S.get().join(""),C=T=>{S.set(T);let j=T.join("");c?.(j),T.every(D=>D!=="")&&T.length===V()&&h?.(j)},x=T=>{let j=V(),D=$.get();T>=0&&T<j&&D[T]&&(D[T].focus(),D[T].select())},y=()=>{let T=m(n);return T==="number"?/^[0-9]$/:T instanceof RegExp?T:/^[a-zA-Z0-9]$/},v=(T,j)=>{let D=j.target.value,Y=y();if(D.length>1){N(T,D);return}if(D&&!Y.test(D)){j.target.value=S.get()[T]??"";return}let P=S.get().slice();P[T]=D,C(P),D&&T<V()-1&&x(T+1)},N=(T,j)=>{let D=y(),Y=j.split("").filter(J=>D.test(J)),P=S.get().slice(),R=V();Y.forEach((J,pe)=>{let ke=T+pe;ke<R&&(P[ke]=J)}),C(P);let H=P.findIndex((J,pe)=>pe>=T&&J==="");H>=0?x(H):x(Math.min(T+Y.length,R-1))},I=(T,j)=>{if(j.key==="Backspace"){let D=S.get().slice();D[T]===""&&T>0?(j.preventDefault(),D[T-1]="",C(D),x(T-1)):D[T]!==""&&(D[T]="",C(D))}else j.key==="ArrowLeft"&&T>0?(j.preventDefault(),x(T-1)):j.key==="ArrowRight"&&T<V()-1&&(j.preventDefault(),x(T+1))},B=(T,j)=>{j.target.select()},Q=()=>{let T=S.get(),j=T.findIndex(D=>D==="");j>=0?x(j):x(T.length-1)},se=Ae(u).compute(T=>m(T)?"password":"text"),re=Ae(n).compute(T=>m(T)==="number"?"numeric":"text"),E=Ae(w).compute(T=>m(T)?"one-time-code":"off"),G=Ae(p).compute(T=>!!m(T)),ie=Ae(d).compute(T=>!!m(T)),ae=Ae(k).compute(T=>Array.from({length:T},(j,D)=>D)),X=T=>Wu({className:s("g-ui-pin-input-field",Ur(ie,()=>"g-ui-pin-input-error")),type:se,inputMode:re,autocomplete:E,maxLength:2,placeholder:Ur(G,()=>"",()=>l),disabled:G,value:Ae(S,T).compute(([j,D])=>j[D]??""),node:$[T.get()],onInput:j=>v(T.get(),j),onChange:j=>v(T.get(),j),onKeyDown:j=>I(T.get(),j),onFocus:j=>B(T.get(),j)});return Zr({className:s("g-ui-pin-input",z("g-ui-input-size-",o,"md"),f),onClick:Q},Zr({className:"g-ui-pin-input-wrapper"},qu(ae,X)))}import{Div as Gu}from"@granularjs/core";function _u(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Gu({...a,className:s("g-ui-checkbox-group",r)},t)}import{Div as Zu}from"@granularjs/core";function Uu(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Zu({...a,className:s("g-ui-avatar-group",r)},t)}import{Div as Xu}from"@granularjs/core";function Ku(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Xu({...a,className:s("g-ui-badge-group",r)},t)}import{Div as Ei,Span as Qu,after as vi,context as Xr}from"@granularjs/core";var Ju=Xr([]),Kr=Xr({sort:null,onSort:null});function Bt(...e){let{props:i,rawProps:t,children:r}=g(e,{sizes:[],sort:null,stickyHeader:!1}),{className:a,sizes:o,sort:n,stickyHeader:u,...l}=i,{onSort:p}=t,d=Ju.scope(o.get());vi(o).change(f=>d.set(f));let w=Kr.scope({sort:n.get(),onSort:p||null});return vi(n).change(f=>w.set().sort=f),d.serve(w.serve(Ei({className:s("g-ui-grid-table",U("g-ui-grid-table-sticky",u),a),style:{gridTemplateColumns:vi(d).compute(f=>Array.isArray(f)?f.join(" "):"")},...l},r)))}Bt.GridRow=(...e)=>{let{props:i,children:t}=g(e,{}),{className:r,header:a,...o}=i;return Ei({className:s("g-ui-grid-table-row",U("g-ui-grid-table-row-header",a),r),...o},...t)};Bt.GridCell=function(...e){let{props:i,rawProps:t,children:r}=g(e,{}),{className:a,sort:o,...n}=i,u=t.sort;if(u){let l=Kr.state(),p=vi(l.sort).compute(w=>w?.key===u?w.direction:null),d=()=>{let w=l.get().sort,f;w?.key===u?f=w.direction==="asc"?{key:u,direction:"desc"}:null:f={key:u,direction:"asc"},l.set().sort=f;let{onSort:c}=l.get();c&&c(f)};return Ei({className:s("g-ui-grid-table-cell","g-ui-grid-table-cell-sortable",a),onClick:d,...n},r,Qu({className:"g-ui-grid-table-sort-icon"},vi(p).compute(w=>w==="asc"?" \u2191":w==="desc"?" \u2193":"")))}return Ei({className:s("g-ui-grid-table-cell",a),...n},r)};import{Button as eg,Div as ig,Span as Qr,when as Jr}from"@granularjs/core";function ea(...e){let{props:i,children:t}=g(e,{grow:!0}),{grow:r,className:a,...o}=i;return ig({...o,className:s("g-ui-bottombar",U("g-ui-bottombar-grow",r),a)},t)}ea.Action=function(...i){let{props:t,rawProps:r,children:a}=g(i,{variant:"subtle"}),{icon:o,label:n,active:u,disabled:l,variant:p,className:d,...w}=t,{onClick:f}=r;return eg({...w,className:s("g-ui-bottombar-action",z("g-ui-bottombar-action-variant-",p,"subtle"),U("g-ui-bottombar-action-active",u),U("g-ui-bottombar-action-disabled",l),d),onClick:f,disabled:l},Jr(o,()=>Qr({className:"g-ui-bottombar-action-icon"},o)),Jr(n,()=>Qr({className:"g-ui-bottombar-action-label"},n)),a)};import{Div as W,Button as _e,state as me,after as Ce,when as fe,Input as Ri,Label as hi,Span as Ze}from"@granularjs/core";var tg=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],rg=[{value:"day",label:"Day"},{value:"week",label:"Week"},{value:"month",label:"Month"}];function Hi(e){if(e instanceof Date)return e;if(e==null)return null;let i=new Date(e);return Number.isNaN(i.getTime())?null:i}function ra(e){let i=Hi(e.start),t=Hi(e.end);return!i||!t?null:{...e,id:e.id??`${i.getTime()}-${e.title??"event"}`,title:e.title??"",start:i,end:t,allDay:!!e.allDay,description:e.description??"",location:e.location??"",attendees:Array.isArray(e.attendees)?e.attendees:[],color:e.color??null}}function aa(e,i,t){let r=Hi(i).getTime(),a=Hi(t).getTime();return e.map(ra).filter(Boolean).filter(o=>o.end.getTime()>r&&o.start.getTime()<a)}function ia(e,i){let t=new Date(i);t.setHours(0,0,0,0);let r=t.getTime();t.setHours(23,59,59,999);let a=t.getTime();return aa(e,r,a)}function Ft(e,i){let t=new Date(e),a=(t.getDay()-i+7)%7;return t.setDate(t.getDate()-a),t.setHours(0,0,0,0),t}function ei(e,i="default"){return e.toLocaleTimeString(i,{hour:"numeric",minute:"2-digit",hour12:!0})}function bi(e,i="default"){return e.toLocaleDateString(i,{weekday:"short",month:"short",day:"numeric"})}function ag(e,i="default"){return e.toLocaleDateString(i,{month:"long",year:"numeric"})}function og(e,i="default"){let t=new Date(e);return t.setDate(t.getDate()+6),`${e.toLocaleDateString(i,{month:"short",day:"numeric"})} \u2013 ${t.toLocaleDateString(i,{month:"short",day:"numeric",year:"numeric"})}`}function ta(e,i,t,r){let a=new Date(e).setHours(t,0,0,0),o=new Date(e).setHours(r,0,0,0),n=(r-t)*60,u=Math.max(e.getTime(),a),p=(Math.min(i.getTime(),o)-u)/6e4,d=(u-a)/6e4/n*100,w=p/n*100;return{top:d,height:w}}function ng(...e){let{props:i,rawProps:t}=g(e,{defaultView:"month",firstDayOfWeek:0,locale:"default",hourSlotDuration:30,minTime:6,maxTime:22,eventCreationColorOptions:[]}),{events:r=[],defaultView:a,firstDayOfWeek:o,locale:n,hourSlotDuration:u,minTime:l,maxTime:p,eventCreationColorOptions:d,className:w,...f}=i,{onCreateEventRequest:c,onViewEventRequest:h,onUpdateEventRequest:k,onRemoveEventRequest:V,eventCreationEmailLookup:$,eventCreationLocationsCallback:S,eventCreationCalendarsCallback:M,onSlotClick:C,onDateRangeChange:x}=t,y=me(m(a)??"month"),v=me(new Date),N=me(null),I=me(null),B=me({title:"",start:null,end:null,allDay:!1,description:"",location:"",attendees:[],color:null}),Q=Ce(r).compute(b=>Array.isArray(b)?b:[]),se=v.get(),re=Ft(se,m(o)??0),E=m(l)??6,G=m(p)??22,ie=m(u)??30,ae=()=>{let b=new Date(v.get());y.get()==="month"?b.setMonth(b.getMonth()-1):y.get()==="week"?b.setDate(b.getDate()-7):b.setDate(b.getDate()-1),v.set(b),x?.({start:b,end:b,view:y.get()})},X=()=>{let b=new Date(v.get());y.get()==="month"?b.setMonth(b.getMonth()+1):y.get()==="week"?b.setDate(b.getDate()+7):b.setDate(b.getDate()+1),v.set(b),x?.({start:b,end:b,view:y.get()})},T=()=>{let b=new Date;v.set(b),x?.({start:b,end:b,view:y.get()})},j=(b,O,ce=!1)=>{let Z=b?new Date(b):new Date(v.get()),ge=O?new Date(O):new Date(Z.getTime()+3600*1e3);ce&&(Z.setHours(0,0,0,0),ge.setHours(23,59,59,999)),B.set({title:"",start:Z,end:ge,allDay:ce,description:"",location:"",attendees:[],color:null}),N.set("create")},D=b=>{I.set(ra(b)),N.set("view"),h?.(b)},Y=()=>{let b=I.get();b&&(B.set({title:b.title,start:new Date(b.start),end:new Date(b.end),allDay:b.allDay,description:b.description??"",location:b.location??"",attendees:[...b.attendees||[]],color:b.color??null}),N.set("edit"))},P=()=>{N.set(null),I.set(null)},R=(b,O,ce)=>{if(C){C({date:b,hour:O,allDay:ce});return}let Z=new Date(b);if(ce){Z.setHours(0,0,0,0);let ge=new Date(Z);ge.setHours(23,59,59,999),j(Z,ge,!0)}else{Z.setHours(O,0,0,0);let ge=new Date(Z.getTime()+ie*60*1e3);j(Z,ge,!1)}},H=()=>{let b=B.get();!b.start||!b.end||c?.({title:b.title,start:b.start,end:b.end,allDay:b.allDay,description:b.description,location:b.location,attendees:b.attendees,color:b.color},()=>{P()})},J=()=>{let b=I.get(),O=B.get();!b||!O.start||!O.end||k?.(b,{title:O.title,start:O.start,end:O.end,allDay:O.allDay,description:O.description,location:O.location,attendees:O.attendees,color:O.color},()=>P())},pe=()=>{let b=I.get();b&&V?.(b,()=>P())},ke=Ce(y,v).compute(([b,O])=>b==="month"?ag(O,m(n)):b==="week"?og(Ft(O,m(o)??0),m(n)):bi(O,m(n))),Pe=W({className:"g-ui-event-calendar-header"},W({className:"g-ui-event-calendar-nav-group"},Ye({size:"sm",variant:"subtle",onClick:ae,className:"g-ui-event-calendar-nav"},ye({size:"sm",innerHTML:ki})),Ye({size:"sm",variant:"subtle",onClick:X,className:"g-ui-event-calendar-nav"},ye({size:"sm",innerHTML:yi})),_e({type:"button",variant:"subtle",size:"sm",className:"g-ui-event-calendar-today",onClick:T},ye({size:"sm",className:"g-ui-event-calendar-today-icon",innerHTML:rr}),"Today")),W({className:"g-ui-event-calendar-title"},ke),W({className:"g-ui-event-calendar-actions"},rg.map(b=>W({className:s("g-ui-event-calendar-view-option",Ce(y).compute(O=>O===b.value?"g-ui-event-calendar-view-option-active":"")),onClick:()=>{y.set(b.value),x?.({start:v.get(),end:v.get(),view:b.value})}},b.label)),_e({type:"button",variant:"filled",size:"sm",className:"g-ui-event-calendar-create-btn",onClick:()=>j(v.get(),null,!1)},ye({size:"sm",innerHTML:er}),"Create"))),Be=Ce(v,Q,o).compute(([b,O,ce])=>{let Z=b.getFullYear(),ge=b.getMonth(),ue=(new Date(Z,ge,1).getDay()-(ce??0)+7)%7,Te=new Date(Z,ge+1,0).getDate(),Le=new Date(Z,ge,0).getDate(),A=[],L=1,q=1,_=Math.ceil((ue+Te)/7)*7,oe=[];for(let ee=0;ee<_;ee+=1){let K,te,le;ee<ue?(K=Le-ue+ee+1,le=new Date(Z,ge-1,K),te=!1):L<=Te?(K=L,le=new Date(Z,ge,K),te=!0,L+=1):(K=q,le=new Date(Z,ge+1,K),te=!1,q+=1);let xe=ia(O,le),Fe=le.getDate()===new Date().getDate()&&le.getMonth()===new Date().getMonth()&&le.getFullYear()===new Date().getFullYear();oe.push(W({key:le.getTime(),className:s("g-ui-event-calendar-month-cell",!te&&"g-ui-event-calendar-month-cell-outside",Fe&&"g-ui-event-calendar-month-cell-today")},W({className:"g-ui-event-calendar-month-cell-header",onClick:()=>R(le,0,!0)},Ze({className:"g-ui-event-calendar-month-cell-day"},le.getDate())),W({className:"g-ui-event-calendar-month-cell-events"},xe.slice(0,3).map(Se=>W({key:Se.id,className:"g-ui-event-calendar-month-event",style:Se.color?{borderLeftColor:Se.color,backgroundColor:`${Se.color}20`}:{},onClick:Yi=>{Yi.stopPropagation(),D(Se)}},Se.title||"(No title)")),fe(xe.length>3,()=>W({className:"g-ui-event-calendar-month-more",onClick:Se=>{Se.stopPropagation(),D(xe[3])}},`+${xe.length-3} more`)))))}return oe}),Ve=W({className:"g-ui-event-calendar-month"},W({className:"g-ui-event-calendar-weekdays"},tg.map(b=>W({key:b,className:"g-ui-event-calendar-weekday"},b))),W({className:"g-ui-event-calendar-month-grid"},Be)),Me=[];for(let b=E;b<G;b+=1)for(let O=0;O<60;O+=ie)Me.push(b+O/60);let ii=Ce(v,o).compute(([b,O])=>{let ce=Ft(b,O??0),Z=[];for(let ge=0;ge<7;ge+=1){let ve=new Date(ce);ve.setDate(ve.getDate()+ge),Z.push(ve)}return Z}),Oi=W({className:"g-ui-event-calendar-week"},Ce(ii).compute(b=>W({className:"g-ui-event-calendar-week-days"},W({className:"g-ui-event-calendar-week-time-col"},""),(b||[]).map(O=>W({key:O.getTime(),className:"g-ui-event-calendar-week-day-col"},W({className:"g-ui-event-calendar-week-day-header"},bi(O,m(n))))))),W({className:"g-ui-event-calendar-week-body"},W({className:"g-ui-event-calendar-week-time-col"},Me.map(b=>{let O=Math.floor(b),ce=(b-O)*60,Z=`${O<=12?O:O-12}:${ce===0?"00":ce} ${O<12?"AM":"PM"}`;return W({key:b,className:"g-ui-event-calendar-week-slot-label"},Z)})),Ce(ii,Q).compute(([b,O])=>{if(!b||!b.length)return null;let ce=b[0],Z=new Date(b[6]);Z.setHours(23,59,59,999);let ge=aa(O,ce,Z);return W({className:"g-ui-event-calendar-week-grid-cols"},b.map(ve=>W({key:ve.getTime(),className:"g-ui-event-calendar-week-day-col g-ui-event-calendar-week-day-col-body"},Me.map(ue=>W({key:ue,className:"g-ui-event-calendar-week-slot",onClick:()=>R(ve,ue,!1)})),ge.filter(ue=>!ue.allDay&&ue.start.getDate()===ve.getDate()&&ue.start.getMonth()===ve.getMonth()&&ue.start.getFullYear()===ve.getFullYear()).map(ue=>{let{top:Te,height:Le}=ta(ue.start,ue.end,E,G);return W({key:ue.id,className:"g-ui-event-calendar-week-event",style:{top:`${Te}%`,height:`${Le}%`,borderLeftColor:ue.color||"var(--g-ui-primary)"},onClick:A=>{A.stopPropagation(),D(ue)}},W({className:"g-ui-event-calendar-week-event-title"},ue.title||"(No title)"),fe(!ue.allDay,()=>Ze({className:"g-ui-event-calendar-week-event-time"},`${ei(ue.start,m(n))} \u2013 ${ei(ue.end,m(n))}`)))}))))}))),Wi=W({className:"g-ui-event-calendar-day"},W({className:"g-ui-event-calendar-day-body"},W({className:"g-ui-event-calendar-day-time-col"},Me.map(b=>{let O=Math.floor(b),ce=(b-O)*60,Z=`${O<=12?O:O-12}:${ce===0?"00":ce} ${O<12?"AM":"PM"}`;return W({key:b,className:"g-ui-event-calendar-day-slot-label"},Z)})),W({className:"g-ui-event-calendar-day-slots"},Me.map(b=>W({key:b,className:"g-ui-event-calendar-day-slot",onClick:()=>R(v.get(),b,!1)})),Ce(Q,v).compute(([b,O])=>O?ia(b,O).filter(Z=>!Z.allDay).map(Z=>{let{top:ge,height:ve}=ta(Z.start,Z.end,E,G);return W({key:Z.id,className:"g-ui-event-calendar-day-event",style:{top:`${ge}%`,height:`${ve}%`,borderLeftColor:Z.color||"var(--g-ui-primary)"},onClick:ue=>{ue.stopPropagation(),D(Z)}},W({className:"g-ui-event-calendar-day-event-title"},Z.title||"(No title)"),Ze({className:"g-ui-event-calendar-day-event-time"},`${ei(Z.start,m(n))} \u2013 ${ei(Z.end,m(n))}`))}):[])))),xi=b=>{let O=B.get(),ce=new Date,Z=O.start||ce,ge=O.end||new Date(ce.getTime()+3600*1e3),ve=me(O.title),ue=me(Z.toISOString().slice(0,10)),Te=me(!O.allDay&&Z?Z.toTimeString().slice(0,5):"09:00"),Le=me(ge.toISOString().slice(0,10)),A=me(!O.allDay&&ge?ge.toTimeString().slice(0,5):"10:00"),L=me(O.allDay),q=me(O.description),_=me(O.location),oe=me(O.attendees||[]),ee=me(""),K=me([]),te=me([]),le=me(""),xe=Array.isArray(d)?d:[],Fe=me(O.color),Se=()=>{let F=new Date(ue.get()+"T"+(L.get()?"00:00:00":Te.get()+":00")),we=new Date(Le.get()+"T"+(L.get()?"23:59:59":A.get()+":00"));B.set({title:ve.get(),start:F,end:we,allDay:L.get(),description:q.get(),location:_.get(),attendees:oe.get(),color:Fe.get()})},Yi=F=>{if(ee.set(F),!$||!F.trim()){K.set([]);return}Promise.resolve($(F.trim())).then(we=>K.set(Array.isArray(we)?we:[])).catch(()=>K.set([]))},oa=F=>{let we=oe.get();we.some(Et=>(Et.email||Et.id)===(F.email||F.id))||(oe.set([...we,{id:F.id,email:F.email??F.label,label:F.label}]),ee.set(""),K.set([]))},na=F=>{let we=[...oe.get()];we.splice(F,1),oe.set(we)},jt=()=>{S&&Promise.resolve(S(le.get())).then(F=>te.set(Array.isArray(F)?F:[])).catch(()=>te.set([]))};return W({className:"g-ui-event-calendar-form"},W({className:"g-ui-event-calendar-form-row"},be({label:"Title",placeholder:"Event title",value:ve,onInput:F=>ve.set(F?.target?.value??"")})),W({className:"g-ui-event-calendar-form-row g-ui-event-calendar-form-row-inline"},at({label:"All day",checked:L,onChange:F=>L.set(F)})),W({className:"g-ui-event-calendar-form-row g-ui-event-calendar-form-row-inline"},W({className:"g-ui-event-calendar-form-field"},hi({className:"g-ui-event-calendar-form-label"},"Start"),Ri({type:"date",className:"g-ui-input g-ui-input-size-md",value:ue,onInput:F=>ue.set(F?.target?.value??"")}),fe(!L,()=>Ri({type:"time",className:"g-ui-input g-ui-input-size-md",value:Te,onInput:F=>Te.set(F?.target?.value??"")}))),W({className:"g-ui-event-calendar-form-field"},hi({className:"g-ui-event-calendar-form-label"},"End"),Ri({type:"date",className:"g-ui-input g-ui-input-size-md",value:Le,onInput:F=>Le.set(F?.target?.value??"")}),fe(!L,()=>Ri({type:"time",className:"g-ui-input g-ui-input-size-md",value:A,onInput:F=>A.set(F?.target?.value??"")})))),fe(S,()=>W({className:"g-ui-event-calendar-form-row"},hi({className:"g-ui-event-calendar-form-label"},"Location"),be({placeholder:"Search or type location",value:le,onInput:F=>{le.set(F?.target?.value??""),jt()},onFocus:jt}),fe(Ce(te).compute(F=>F&&F.length>0),()=>W({className:"g-ui-event-calendar-form-suggestions"},te.get().map(F=>W({key:F.id??F.label,className:"g-ui-event-calendar-form-suggestion-item",onClick:()=>{_.set(F.label??F.id),le.set(""),te.set([])}},F.label??F.id)))),fe(Ce(_).compute(F=>!!F),()=>Ze({className:"g-ui-event-calendar-form-chip"},_)))),fe($,()=>W({className:"g-ui-event-calendar-form-row"},hi({className:"g-ui-event-calendar-form-label"},"Add guests"),be({placeholder:"Type email to search",value:ee,onInput:F=>Yi(F?.target?.value??"")}),W({className:"g-ui-event-calendar-form-chips"},oe.get().map((F,we)=>Ze({key:(F.email||F.id)+we,className:"g-ui-event-calendar-form-chip g-ui-event-calendar-form-chip-removable",onClick:()=>na(we)},F.label||F.email||F.id," \xD7"))),fe(Ce(K).compute(F=>F&&F.length>0),()=>W({className:"g-ui-event-calendar-form-suggestions"},K.get().map(F=>W({key:F.id??F.email,className:"g-ui-event-calendar-form-suggestion-item",onClick:()=>oa(F)},F.label??F.email??F.id)))))),W({className:"g-ui-event-calendar-form-row"},Qi({label:"Description",placeholder:"Add description",value:q,onInput:F=>q.set(F?.target?.value??"")})),fe(xe.length>0,()=>W({className:"g-ui-event-calendar-form-row"},hi({className:"g-ui-event-calendar-form-label"},"Color"),W({className:"g-ui-event-calendar-form-colors"},xe.map(F=>W({key:F.value??F.id??F,className:s("g-ui-event-calendar-form-color-swatch",Ce(Fe).compute(we=>we===(F.value??F.id??F)?"g-ui-event-calendar-form-color-swatch-active":"")),style:{backgroundColor:F.color??F.value??F},onClick:()=>Fe.set(F.value??F.id??F)}))))),W({className:"g-ui-event-calendar-form-actions"},_e({variant:"subtle",onClick:P},"Cancel"),_e({variant:"filled",onClick:()=>{Se(),b?J():H()}},b?"Save":"Create")))},qi=()=>{let b=I.get();return b?W({className:"g-ui-event-calendar-view-modal"},W({className:"g-ui-event-calendar-view-modal-title"},b.title||"(No title)"),W({className:"g-ui-event-calendar-view-modal-meta"},b.allDay?Ze({className:"g-ui-event-calendar-view-modal-date"},bi(b.start,m(n))+(b.start.getTime()!==b.end.getTime()?` \u2013 ${bi(b.end,m(n))}`:"")):Ze({className:"g-ui-event-calendar-view-modal-date"},`${bi(b.start,m(n))} \xB7 ${ei(b.start,m(n))} \u2013 ${ei(b.end,m(n))}`)),fe(b.location,()=>W({className:"g-ui-event-calendar-view-modal-field"},"Location: ",b.location)),fe(b.description,()=>W({className:"g-ui-event-calendar-view-modal-field"},b.description)),fe(b.attendees?.length,()=>W({className:"g-ui-event-calendar-view-modal-field"},"Guests: ",b.attendees.map(O=>O.label||O.email||O.id).join(", "))),W({className:"g-ui-event-calendar-view-modal-actions"},_e({variant:"subtle",size:"sm",onClick:Y},ye({size:"sm",innerHTML:ir})," Edit"),_e({variant:"subtle",size:"sm",onClick:pe,className:"g-ui-event-calendar-view-modal-delete"},ye({size:"sm",innerHTML:tr})," Delete"),_e({variant:"filled",size:"sm",onClick:P},"Close"))):null};return W({...f,className:s("g-ui-event-calendar",w)},Pe,fe(y,b=>b==="month",()=>Ve),fe(y,b=>b==="week",()=>Oi),fe(y,b=>b==="day",()=>Wi),fe(N,b=>b==="create",()=>oi({opened:!0,title:"New event",size:"lg",onClose:P},xi(!1))),fe(N,b=>b==="view",()=>oi({opened:!0,title:"Event",size:"md",onClose:P},qi())),fe(N,b=>b==="edit",()=>oi({opened:!0,title:"Edit event",size:"lg",onClose:P},xi(!0))))}import{state as sg}from"@granularjs/core";function ug(e=!1){let i=sg(!!e);return[i,{open:()=>i.set(!0),close:()=>i.set(!1),toggle:()=>i.set(!i.get())}]}Ht();export{Fo as Accordion,Ye as ActionIcon,cs as Affix,en as Alert,kn as Anchor,hs as AppBar,$t as Autocomplete,on as Avatar,Uu as AvatarGroup,Ya as Badge,Ku as BadgeGroup,cn as Blockquote,ea as BottomBar,Kn as Breadcrumbs,Au as Burger,Ui as Button,li as Calendar,Wa as Card,Jn as Center,at as Checkbox,_u as CheckboxGroup,$n as Chip,gn as Code,Ou as Col,as as Collapse,Fa as Container,vu as CopyButton,Bi as DateInput,Xs as DatePicker,Uo as Divider,Yo as Drawer,ng as EventCalendar,fs as Fieldset,Mu as Flex,Ru as Grid,Bt as GridTable,Ha as Group,gs as HoverCard,ye as Icon,Nn as Image,$u as Indicator,sn as Kbd,br as List,ni as Loading,ju as LoadingOverlay,Oo as Menu,oi as Modal,Ws as MultiSelect,Lu as NavLink,pt as Notification,Js as Notifications,Ji as NumberField,eo as NumberInput,Rn as Pagination,Ko as Paper,lu as PasswordInput,Yu as PinInput,Ct as Popover,nu as Popper,Cn as Progress,bu as ProgressRing,Zn as Radio,Wn as RadioGroup,Du as RangePicker,tu as RangeSlider,js as Rating,Lt as ScrollArea,pu as SearchInput,Fn as SegmentedControl,wo as Select,zu as SelectSearch,xs as Sidebar,dn as SimpleGrid,Vn as Skeleton,Pn as Slider,is as Space,Ea as Stack,Bs as Stepper,ho as Switch,lo as SwitchGroup,Vo as Table,No as Tabs,Rs as Tag,Xi as Text,be as TextInput,Qi as Textarea,$s as Timeline,Aa as Title,Mt as Toast,Us as ToastStack,jo as Tooltip,U as classFlag,he as classMap,z as classVar,s as cx,za as getThemeMode,ka as setThemeMode,ya as setThemeVars,g as splitPropsChildren,ug as useDisclosure};
