var Ki="granular-ui-styles",Ue=new URL("./fonts/Poppins-400.ttf",import.meta.url).href,Xe=new URL("./fonts/Poppins-500.ttf",import.meta.url).href,qe=new URL("./fonts/Poppins-600.ttf",import.meta.url).href,We=new URL("./fonts/Poppins-700.ttf",import.meta.url).href,Ze=new URL("./fonts/Arimo-400.ttf",import.meta.url).href,Ke=new URL("./fonts/Arimo-500.ttf",import.meta.url).href,_e=new URL("./fonts/Arimo-600.ttf",import.meta.url).href,Je=new URL("./fonts/Arimo-700.ttf",import.meta.url).href,Qe=new URL("./fonts/Inter-400.woff2",import.meta.url).href,ir=new URL("./fonts/Inter-500.woff2",import.meta.url).href,er=new URL("./fonts/Inter-600.woff2",import.meta.url).href,rr=new URL("./fonts/Inter-700.woff2",import.meta.url).href,tr=`
@font-face {
  font-family: 'Poppins';
  font-style: normal;
  font-weight: 400;
...
`;function _i(){if(typeof document>"u"||document.getElementById(Ki))return;let e=document.createElement("style");e.id=Ki,e.textContent=tr,document.head.appendChild(e)}var ar=new Set(["--g-ui-bg","--g-ui-bg-subtle","--g-ui-bg-muted","--g-ui-bg-emphasized","--g-ui-bg-inverted","--g-ui-bg-panel","--g-ui-fg","--g-ui-fg-muted","--g-ui-fg-subtle","--g-ui-fg-inverted","--g-ui-border","--g-ui-border-subtle","--g-ui-border-emphasized","--g-ui-border-inverted","--g-ui-primary","--g-ui-primary-hover","--g-ui-primary-active","--g-ui-primary-subtle","--g-ui-primary-muted","--g-ui-primary-emphasized","--g-ui-success","--g-ui-success-hover","--g-ui-success-active","--g-ui-success-subtle","--g-ui-success-muted","--g-ui-danger","--g-ui-danger-hover","--g-ui-danger-active","--g-ui-danger-subtle","--g-ui-danger-muted","--g-ui-warning","--g-ui-warning-hover","--g-ui-warning-active","--g-ui-warning-subtle","--g-ui-warning-muted","--g-ui-info","--g-ui-info-hover","--g-ui-info-active","--g-ui-info-subtle","--g-ui-info-muted","--g-ui-shadow-xs","--g-ui-shadow-sm","--g-ui-shadow-md","--g-ui-shadow-lg","--g-ui-shadow-xl","--g-ui-shadow-2xl","--g-ui-radius","--g-ui-font","--g-ui-surface","--g-ui-text","--g-ui-muted","--g-ui-primary-strong","--g-ui-shadow"]);function or(e={},i=document?.documentElement){if(i)for(let[t,r]of Object.entries(e)){let a=t.startsWith("--")?t:`--g-ui-${t}`;ar.has(a)&&i.style.setProperty(a,String(r))}}function sr(e="dark",i=document?.documentElement){i&&(i.classList.remove("g-ui-theme-dark","g-ui-theme-light"),i.classList.add(e==="light"?"g-ui-theme-light":"g-ui-theme-dark"))}import{Renderer as Ji,isSignal as Qi,isState as ie,isStatePath as ee,isComputed as re,resolve as R,computed as nr,after as mi,concat as gr}from"granular";function fi(e){return Qi(e)||ie(e)||ee(e)||re(e)}function o(...e){return gr(...e,{separator:" ",filterFalsy:!0})}function n(e,i){let t={},r=[],a=s=>!!s&&typeof s=="object"&&!Array.isArray(s)&&!Ji.isRenderable(s)&&!Ji.isDomNode(s)&&!Qi(s)&&!ie(s)&&!ee(s)&&!re(s);for(let s of e)a(s)?Object.assign(t,s):r.push(s);if(i&&typeof i=="object")for(let s of Object.keys(i))t[s]===void 0&&(t[s]=i[s]);return{props:nr(t),rawProps:t,children:r}}function y(e){return R(e)}function B(e){return!!R(e)}function f(e,i,t){let r=a=>{let s=R(a),g=s==null||s===""?t:s;return g==null||g===""?"":`${e}${g}`};return fi(i)?mi(i).compute(a=>r(a)):r(i)}function I(e,i){return fi(i)?mi(i).compute(t=>R(t)?e:""):R(i)?e:""}function L(e,i,t){let r=a=>i[a]||null;return fi(e)?mi(e).compute(a=>r(R(a??t))):r(R(e??t))}import{Button as ur,Span as xi,when as hi}from"granular";function bi(...e){let{props:i,children:t}=n(e,{variant:"filled",size:"md"}),{variant:r,size:a,fullWidth:s,loading:g,leftSection:u,rightSection:l,className:d,disabled:p,...x}=i,c=B(g),m=B(p);return ur({...x,disabled:m||c,className:o("g-ui-button",f("g-ui-button-variant-",r,"filled"),f("g-ui-button-size-",a,"md"),I("g-ui-button-full",s),I("g-ui-button-loading",g),d)},hi(u,()=>xi({className:"g-ui-button-section-left"},u)),hi(c,()=>xi("Loading..."),()=>t),hi(l,()=>xi({className:"g-ui-button-section-right"},l)))}import{Span as pr}from"granular";function vi(...e){let{props:i,children:t}=n(e,{size:"md"}),{size:r,weight:a,color:s,dimmed:g,align:u,className:l,style:d,...p}=i,x=L(a,{bold:"g-ui-text-weight-700",semibold:"g-ui-text-weight-600",medium:"g-ui-text-weight-500",700:"g-ui-text-weight-700",600:"g-ui-text-weight-600",500:"g-ui-text-weight-500",400:"g-ui-text-weight-400"}),c=L(s,{primary:"g-ui-text-primary",success:"g-ui-text-success",danger:"g-ui-text-danger",muted:"g-ui-text-dimmed"}),m=L(u,{center:"g-ui-text-align-center",right:"g-ui-text-align-right",left:"g-ui-text-align-left"});return pr({...p,className:o("g-ui-text",f("g-ui-text-size-",r,"md"),I("g-ui-text-dimmed",g),x,c,m,l)},t)}import{H1 as cr,H2 as te,H3 as lr,H4 as dr,H5 as mr,H6 as fr}from"granular";var xr={1:cr,2:te,3:lr,4:dr,5:mr,6:fr};function hr(...e){let{props:i,children:t}=n(e,{order:2}),{order:r,className:a,style:s,...g}=i,u=y(r)||2;return(xr[u]||te)({...g,className:o("g-ui-title",f("g-ui-title-order-",r,2),a)},t)}import{Div as br}from"granular";function vr(...e){let{props:i,children:t}=n(e,{size:"md"}),{size:r,fluid:a,className:s,style:g,...u}=i;return br({...u,className:o("g-ui-container",I("g-ui-container-fluid",a),f("g-ui-container-size-",r,"md"),s)},t)}import{Div as wr}from"granular";function yr(...e){let{props:i,children:t}=n(e,{gap:"md"}),{gap:r,align:a,justify:s,className:g,style:u,...l}=i,d=L(s,{between:"g-ui-justify-between",center:"g-ui-justify-center",end:"g-ui-justify-end",start:"g-ui-justify-start"});return wr({...l,className:o("g-ui-stack",f("g-ui-gap-",r,"md"),f("g-ui-align-",a),d,g)},t)}import{Div as zr}from"granular";function kr(...e){let{props:i,children:t}=n(e,{gap:"md",align:"center"}),{gap:r,align:a,position:s,wrap:g,className:u,style:l,...d}=i,p=L(s,{apart:"g-ui-justify-between",center:"g-ui-justify-center",right:"g-ui-justify-end",left:"g-ui-justify-start"});return zr({...d,className:o("g-ui-group",f("g-ui-gap-",r,"md"),f("g-ui-align-",a,"center"),p,I("g-ui-wrap",g),u)},t)}import{Div as J,list as Nr,when as wi}from"granular";function Cr(...e){let{props:i,children:t}=n(e,{padding:"md",radius:"md",shadow:"none"}),{title:r,content:a,actions:s,padding:g,radius:u,shadow:l,className:d,style:p,...x}=i;return J(wi(r,()=>J({className:"g-ui-card-title"},r)),wi(a,()=>J({className:"g-ui-card-content"},a)),wi(s,()=>J({className:"g-ui-card-actions"},Nr(s,c=>bi({className:"g-ui-card-action",onClick:c.onClick,leftSection:c.leftSection,rightSection:c.rightSection,size:c.size||"sm",variant:c.variant||"outline",...c.props},c.label)))),{className:o("g-ui-card",f("g-ui-card-padding-",g,"md"),f("g-ui-card-radius-",u,"md"),f("g-ui-card-shadow-",l,"md"),d),...x},t)}import{Span as Pr}from"granular";function Sr(...e){let{props:i,children:t}=n(e,{variant:"filled",size:"md"}),{variant:r,size:a,className:s,dot:g,style:u,...l}=i,d=L(r,{dot:"g-ui-badge-dot"});return Pr({...l,className:o("g-ui-badge",f("g-ui-badge-variant-",r,"filled"),f("g-ui-badge-size-",a,"md"),I("g-ui-badge-dot",g),d,s)},t)}import{Div as ae,Input as Dr,Label as Vr,Span as Q,when as X}from"granular";function Mr(...e){let{props:i,rawProps:t}=n(e,{size:"md"}),{label:r,description:a,error:s,size:g,leftSection:u,rightSection:l,className:d,style:p,inputProps:x,...c}=i,{onChange:m}=t,b=Dr({...c,className:o("g-ui-input",x?.className),onInput:D=>{m?.(D?.target?.value,D),x?.onInput?.(D)}});return ae({className:o("g-ui-text-input",d)},X(r,()=>Vr({className:"g-ui-text-input-label"},r)),X(a,()=>Q({className:"g-ui-text-input-description"},a)),ae({className:o("g-ui-input-wrapper",f("g-ui-input-size-",g,"md"),I("g-ui-input-error",s))},X(u,()=>Q({className:"g-ui-input-section"},u)),b,X(l,()=>Q({className:"g-ui-input-section"},l))),X(s,()=>Q({className:"g-ui-text-input-error-text"},s)))}import{Div as yi,Textarea as Ir,when as oe}from"granular";function Lr(...e){let{props:i}=n(e,{size:"md"}),{size:t,leftSection:r,rightSection:a,className:s,...g}=i;return yi({className:o("g-ui-input-wrapper","g-ui-input-multiline",f("g-ui-input-size-",t,"md"),s)},oe(r,()=>yi({className:"g-ui-input-section"},r)),Ir({...g,className:o("g-ui-input g-ui-textarea")}),oe(a,()=>yi({className:"g-ui-input-section"},a)))}import{Div as zi,Input as Br,when as se}from"granular";function Tr(...e){let{props:i}=n(e,{size:"md"}),{size:t,leftSection:r,rightSection:a,className:s,...g}=i;return zi({className:o("g-ui-input-wrapper",f("g-ui-input-size-",t,"md"),s)},se(r,()=>zi({className:"g-ui-input-section"},r)),Br({type:"text",inputMode:"decimal",...g,className:"g-ui-input"}),se(a,()=>zi({className:"g-ui-input-section"},a)))}import{Div as ii,Button as $r,portal as Ar,when as ki}from"granular";function jr(...e){let{props:i,rawProps:t,children:r}=n(e,{size:"md",centered:!0,overlay:"normal"}),{opened:a,title:s,size:g,centered:u,overlay:l,className:d,style:p}=i,{onClose:x}=t;return ki(a,()=>Ar(ii({className:o("g-ui-modal-overlay",f("g-ui-modal-overlay-",l,"normal"),L(u,{true:"g-ui-modal-centered",false:"g-ui-modal-top"},!0)),onClick:c=>{c.target===c.currentTarget&&x?.()}},ii({className:o("g-ui-modal",f("g-ui-modal-size-",g,"md"),d)},ii({className:"g-ui-modal-header"},ki(s,()=>ii({className:"g-ui-modal-title"},s)),ki(x,()=>$r({className:"g-ui-button g-ui-button-variant-subtle g-ui-button-size-xs",onClick:x},"Close"))),r))))}import{Div as ei,Span as Ni}from"granular";function q(...e){let{props:i}=n(e,{variant:"spinner",size:"md"}),{variant:t,size:r,className:a,style:s}=i;return t==="dots"?ei({className:o("g-ui-loading g-ui-dots",f("g-ui-loading-size-",r,"md"),a)}):t==="bars"?ei({className:o("g-ui-loading g-ui-bars",f("g-ui-loading-size-",r,"md"),a)},Ni(""),Ni(""),Ni("")):ei({className:o("g-ui-loading",f("g-ui-loading-size-",r,"md"),a)},ei({className:"g-ui-spinner"}))}import{Div as Ci,Input as Fr,Label as Rr,Span as ce,when as Pi,state as Yr,after as Hr}from"granular";var ne='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/></svg>',ge='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M560-240 320-480l240-240 56 56-184 184 184 184-56 56Z"/></svg>',ue='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M379.33-244 154-469.33 201.67-517l177.66 177.67 378.34-378.34L805.33-670l-426 426Z"/></svg>',pe='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M240-446.67v-66.66h480v66.66H240Z"/></svg>';function Gr(...e){let{props:i,rawProps:t}=n(e,{size:"md"}),{checked:r,label:a,description:s,size:g,indeterminate:u,className:l,style:d,inputProps:p,...x}=i,{onChange:c}=t,m=Yr(B(r));Hr(r).change(D=>{D!=null&&(m.set(!!D),c?.(D))});let b=Rr({className:"g-ui-checkbox-control"},Fr({type:"checkbox",indeterminate:u,checked:m,className:o("g-ui-checkbox-input",f("g-ui-checkbox-size-",g,"md"),p?.className),...x}),Pi(m,()=>Ci({className:"g-ui-checkbox-checked",innerHTML:ue}),()=>{if(!m.get()&&u.get())return Ci({className:"g-ui-checkbox-indeterminate",innerHTML:pe})}),Pi(a,()=>ce({className:"g-ui-checkbox-label"},a)));return Ci({className:o("g-ui-checkbox",f("g-ui-checkbox-size-",g,"md"),l)},b,Pi(s,()=>ce({className:"g-ui-checkbox-description"},s)))}import{Input as Er,Label as Or,Span as Ur,when as Xr}from"granular";function qr(...e){let{props:i}=n(e,{size:"md"}),{label:t,size:r,className:a,style:s,inputProps:g,...u}=i;return Or({className:o("g-ui-switch",f("g-ui-switch-size-",r,"md"),a)},Er({type:"checkbox",className:o("g-ui-switch-input",f("g-ui-switch-size-",r,"md"),g?.className),...u}),Xr(t,()=>Ur({className:"g-ui-switch-label"},t)))}import{Div as Y,Span as le,when as Si,state as de,after as ri}from"granular";function Wr(...e){let{props:i,rawProps:t}=n(e,{data:[],size:"md"}),{data:r,value:a,size:s,leftSection:g,rightSection:u,placeholder:l,className:d,...p}=i,{onChange:x}=t,c=de(!1),m=de(y(a)??"");ri(a).change(N=>{let C=y(N);C!==void 0&&m.set(C??"")});let b=N=>{m.set(N),x?.(N),c.set(!1)},D=ri(m).compute(N=>N?"":"g-ui-select-placeholder"),S=ri(m).compute(N=>{let k=(y(r)??[]).find(v=>v.value===N);return N?k?.label??"":l??""});return Y({...p,className:o("g-ui-select-root",d)},Y({className:o("g-ui-input-wrapper",f("g-ui-input-size-",s,"md"))},Si(g,()=>Y({className:"g-ui-input-section"},g)),Y({className:o("g-ui-select",D),onClick:()=>c.set(!c.get())},le({className:"g-ui-select-value"},S)),Si(u,()=>Y({className:"g-ui-input-section"},u),()=>le({className:"g-ui-select-caret"},"\u25BE"))),Si(c,()=>Y({className:"g-ui-select-dropdown"},(y(r)??[]).map(N=>Y({className:o("g-ui-select-item",ri(m).compute(C=>C===N.value?"g-ui-select-item-active":"")),onClick:()=>b(N.value)},N.label)))))}import{Button as Zr,Div as Di,state as Kr,after as me,list as _r,when as Jr}from"granular";function Qr(...e){let{props:i,rawProps:t}=n(e,{tabs:[],orientation:"horizontal",variant:"default"}),{value:r,tabs:a,orientation:s,variant:g,className:u,style:l}=i,{onChange:d}=t,p=Kr(r?.get()??a.get()?.[0]?.value??"");me(r).change(c=>{p.set(c)});let x=c=>{p.set(c),d?.(c)};return Di({className:o("g-ui-tabs",L(s,{vertical:"g-ui-tabs-vertical"}),f("g-ui-tabs-variant-",g,"default"),i.className??u)},Di({className:"g-ui-tabs-list"},_r(a,c=>Zr({className:me(p).compute(m=>o("g-ui-tabs-tab",c.value===m&&"g-ui-tabs-tab-active")),onClick:()=>x(c.value)},c.label))),Di({className:"g-ui-tabs-panel"},Jr(p,()=>(console.log("tabs",a.get()),a.get()?.find(c=>c.value===p.get())?.content??null))))}import{Table as it,Thead as et,Tbody as rt,Tr as fe,Th as tt,Td as xe}from"granular";function at(...e){let{props:i}=n(e,{headers:[],rows:[]}),{headers:t,rows:r,striped:a,highlightOnHover:s,withBorder:g,withColumnBorders:u,className:l,style:d,...p}=i;return it({...p,className:o("g-ui-table",I("g-ui-table-striped",a),I("g-ui-table-hover",s),I("g-ui-table-with-border",g),I("g-ui-table-column-borders",u),l)},t.length?et(fe(t.map(x=>tt(x)))):null,rt(r.map(x=>fe(Array.isArray(x)?x.map(c=>xe(c)):Object.values(x).map(c=>xe(c))))))}import{Div as Vi}from"granular";import{state as ot,when as st,after as nt}from"granular";function gt(...e){let{props:i,children:t}=n(e,{opened:!1}),{opened:r,className:a,...s}=i,g=ot(B(r));nt(r).change(p=>{g.set(B(p))});let u=()=>{g.set(!g.get())},l=t[0],d=t[1];return Vi({...s,className:o("g-ui-accordion",a)},Vi({className:"g-ui-accordion-header",onClick:u},l),st(g,()=>Vi({className:"g-ui-accordion-content"},d)))}import{Span as he}from"granular";function ut(...e){let{props:i,children:t}=n(e),{label:r,className:a,style:s}=i;return he({className:o("g-ui-tooltip",a)},t,he({className:"g-ui-tooltip-content"},r))}import{Div as ti,when as pt,after as ct,state as lt}from"granular";function dt(...e){let{props:i,rawProps:t,children:r}=n(e,{items:[]}),{opened:a,items:s,className:g,style:u}=i,{onChange:l}=t,d=lt(y(a)??!1);ct(a).change(x=>{let c=y(x);c!=null&&d.set(!!c)});let p=x=>{d.set(x),l?.(x)};return ti({className:o("g-ui-menu",i.className??g)},ti({onClick:()=>p(!d.get())},r),pt(d,()=>ti({className:"g-ui-menu-dropdown"},y(s).map(x=>ti({className:"g-ui-menu-item",onClick:()=>{x.onClick?.(),p(!1)}},x.label)))))}import{Div as be,portal as mt,when as ft}from"granular";function xt(...e){let{props:i,children:t}=n(e,{position:"right",size:"md",overlay:"normal",shadowed:!0}),{opened:r,onClose:a,position:s,size:g,overlay:u,shadowed:l,className:d,style:p}=i;return ft(r,()=>mt(be({className:o("g-ui-drawer-overlay",f("g-ui-drawer-overlay-",u,"normal")),onClick:a},be({className:o("g-ui-drawer",L(l,{true:"g-ui-drawer-shadowed"},!0),f("g-ui-drawer-",s,"right"),f("g-ui-drawer-size-",g,"md"),d),onClick:x=>x.stopPropagation()},t))))}import{Button as ht,Div as Mi,Span as bt,when as ai,after as ve}from"granular";function vt(...e){let{props:i,rawProps:t,children:r}=n(e,{color:"blue",withCloseButton:!0}),{title:a,color:s,icon:g,loading:u,withCloseButton:l,className:d,style:p}=i,{onClose:x}=t,c=B(l),m=B(u),b=ve(g,m).compute(([S,N])=>!S&&!!N),D=ve(g,m).compute(([S,N])=>!!S||!!N);return Mi({className:o("g-ui-notification",[s,S=>`g-ui-notification-${S}`],[D,"g-ui-notification-with-icon"],d)},ai(g,()=>bt({className:"g-ui-notification-icon"},g)),ai(b,()=>q({size:"sm",className:"g-ui-notification-loader"})),Mi({className:"g-ui-notification-body"},ai(a,()=>Mi({className:"g-ui-notification-title"},a)),r),ai(c,()=>ht({type:"button",className:"g-ui-notification-close",onClick:()=>x?.()},"\xD7")))}import{Div as wt,when as yt}from"granular";function zt(...e){let{props:i}=n(e,{labelPosition:"center"}),{label:t,labelPosition:r,className:a,...s}=i;return wt({...s,className:o("g-ui-divider",I("label",t),f("g-ui-divider-label-",r,"center"),a)},yt(t,()=>vi({className:"g-ui-divider-label-text",size:"sm"},t)))}import{Div as kt}from"granular";function Nt(...e){let{props:i,children:t}=n(e,{padding:"md",radius:"md",shadow:"none"}),{padding:r,radius:a,shadow:s,className:g,...u}=i;return kt({...u,className:o("g-ui-paper",[r,l=>`g-ui-card-padding-${l}`],[a,l=>`g-ui-card-radius-${l}`],[s,l=>`g-ui-card-shadow-${l}`],g)},t)}import{Button as Ct,Div as Ii,Span as Pt,after as we,when as Li}from"granular";function St(...e){let{props:i,rawProps:t,children:r}=n(e,{color:"blue"}),{title:a,color:s,icon:g,withCloseButton:u,className:l,...d}=i,{onClose:p}=t,x=we(a,u).compute(([m,b])=>m||b),c=we(g).compute(m=>m!==void 0);return Ii({...d,className:o("g-ui-alert",[s,m=>`g-ui-alert-${m}`],l)},Ii({className:"g-ui-alert-header"},Li(g,()=>Pt({className:"g-ui-alert-icon"},g)),Li(a,()=>Ii({className:"g-ui-alert-title"},a)),Li(u,()=>Ct({type:"button",className:"g-ui-alert-close",onClick:()=>p?.()},"\xD7"))),r)}import{Div as Dt,Img as Vt,when as Mt}from"granular";function It(...e){let{props:i,children:t}=n(e,{size:"md",alt:""}),{src:r,size:a,alt:s,className:g,...u}=i;return Dt({...u,className:o("g-ui-avatar",[a,l=>`g-ui-avatar-size-${l}`],g)},Mt(r,()=>Vt({className:"g-ui-avatar-img",src:r,alt:s}),()=>(console.log("children",t),t)))}import{Span as Lt}from"granular";function Bt(...e){let{props:i,children:t}=n(e),{className:r,...a}=i;return Lt({...a,className:o("g-ui-kbd",r)},t)}import{Code as Tt}from"granular";function $t(...e){let{props:i,children:t}=n(e),{className:r,...a}=i;return Tt({...a,className:o("g-ui-code",r)},t)}import{Blockquote as At}from"granular";function jt(...e){let{props:i,children:t}=n(e),{className:r,...a}=i;return At({...a,className:o("g-ui-blockquote",r)},t)}import{Div as Ft}from"granular";function Rt(...e){let{props:i,children:t}=n(e,{cols:3,gap:"md"}),{cols:r,gap:a,className:s,...g}=i;return Ft({...g,className:o("g-ui-grid",[a,u=>`g-ui-gap-${u}`],[r,u=>`g-ui-grid-cols-${u}`],s)},t)}import{Ul as Yt,Ol as Ht,Li as Ti,Div as Bi,Span as ye,after as $i,when as G,isSignal as Gt,isState as Et,isStatePath as Ot,isComputed as Ut}from"granular";function ze(...e){let{props:i,children:t}=n(e,{type:"none",size:"md"}),{type:r,size:a,withPadding:s,className:g,...u}=i,l=L(r,{ordered:"g-ui-list-ordered",unordered:"g-ui-list-unordered",none:"g-ui-list-none"}),d=$i(r).compute(b=>b==="ordered"),p=b=>b&&typeof b=="object"&&typeof b.tagName=="string"&&(b.tagName.toLowerCase()==="ul"||b.tagName.toLowerCase()==="ol"),x=b=>{let D=S=>S==null||S===!1?null:Array.isArray(S)?S.map(N=>D(N)):p(S)?Ti({className:"g-ui-list-nested-item"},S):Ti(S);return Gt(b)||Et(b)||Ot(b)||Ut(b)?$i(b).compute(S=>D(S)):D(b)},c=t.map(b=>x(b)),m={...u,className:o("g-ui-list",f("g-ui-list-size-",a,"md"),I("g-ui-list-with-padding",s),l,g)};return G(d,()=>Ht(m,c),()=>Yt(m,c))}function Xt(...e){let{props:i,children:t}=n(e,{withBorder:!1}),{leftSection:r,rightSection:a,title:s,body:g,withBorder:u,className:l,...d}=i,p=$i(s,g).compute(([x,c])=>!!x||!!c);return Ti({...d,className:o("g-ui-list-item",I("g-ui-list-item-border",u),l)},G(r,()=>ye({className:"g-ui-list-item-section g-ui-list-item-section-left"},r)),G(p,()=>Bi({className:"g-ui-list-item-content"},G(s,()=>Bi({className:"g-ui-list-item-title"},s)),G(g,()=>Bi({className:"g-ui-list-item-body"},g))),()=>t),G(a,()=>ye({className:"g-ui-list-item-section g-ui-list-item-section-right"},a)))}ze.Item=Xt;import{A as qt}from"granular";function Wt(...e){let{props:i,children:t}=n(e),{className:r,...a}=i;return qt({...a,className:o("g-ui-anchor",r)},t)}import{Img as Zt}from"granular";function Kt(...e){let{props:i}=n(e),{className:t,...r}=i;return Zt({...r,className:o("g-ui-image",t)})}import{Span as _t}from"granular";function oi(...e){let{props:i,children:t}=n(e,{size:"md"});return _t({...i,className:o("g-ui-icon",f("g-ui-icon-size-",i.size,"md"),f("g-ui-icon-color-",i.color),i.className)},...t)}import{Div as ke}from"granular";function Jt(...e){let{props:i}=n(e,{value:0,color:"primary",size:"md"}),{value:t,color:r,size:a,className:s,...g}=i;return ke({...g,className:o("g-ui-progress",f("g-ui-progress-size-",a,"md"),[t,u=>{let l=Math.max(0,Math.min(100,Number(u)||0));return`g-ui-progress-${Math.round(l/5)*5}`}],[r,u=>u?`g-ui-progress-${u}`:""],s)},ke({className:"g-ui-progress-bar"}))}import{Div as H,after as si,state as Qt,when as ia}from"granular";function ea(...e){let{props:i,rawProps:t}=n(e,{size:"md",min:0,max:100,step:1}),{onChange:r}=t,{value:a,marks:s,size:g,min:u,max:l,step:d,disabled:p,className:x,...c}=i,m=Qt(y(a??u));si(a).change(v=>{v!=null&&m.set(y(v))});let b=()=>{let v=Number(y(u)),h=Number(y(l));return!Number.isFinite(v)||!Number.isFinite(h)?{minValue:0,maxValue:100}:{minValue:Math.min(v,h),maxValue:Math.max(v,h)}},D=()=>{let v=Number(y(d));return Number.isFinite(v)&&v>0?v:1},S=v=>{let{minValue:h,maxValue:P}=b(),z=D(),w=Math.max(h,Math.min(P,Number(v))),M=Math.round((w-h)/z)*z+h;M!==m.get()&&(m.set(M),r?.(M))},N=si(m).compute(v=>{let{minValue:h,maxValue:P}=b(),z=P-h;if(z<=0)return 0;let w=(Number(v??h)-h)/z*100;return Math.max(0,Math.min(100,w))}),C=(v,h)=>{let P=h?.();if(!P||P.width===0)return;let w=Math.min(Math.max(v.clientX-P.left,0),P.width)/P.width,{minValue:M,maxValue:V}=b();S(M+w*(V-M))},k=v=>{if(B(p))return;v.preventDefault?.();let h=v.currentTarget,P=()=>h.getBoundingClientRect();h.setPointerCapture?.(v.pointerId),C(v,P);let z=M=>C(M,P),w=()=>{h.releasePointerCapture?.(v.pointerId),window.removeEventListener("pointermove",z),window.removeEventListener("pointerup",w)};window.addEventListener("pointermove",z),window.addEventListener("pointerup",w)};return H({...c,className:o("g-ui-slider",f("g-ui-slider-size-",g,"md"),I("g-ui-slider-disabled",p),x)},H({className:"g-ui-slider-track",onPointerDown:k},H({className:"g-ui-slider-bar",style:si(N).compute(v=>({width:`${v}%`}))}),H({className:"g-ui-slider-thumb",style:si(N).compute(v=>({left:`${v}%`}))})),ia(s,()=>H({className:"g-ui-slider-marks"},s.map(v=>Ai({mark:v,getBounds:b})))))}var Ai=({mark:e,getBounds:i})=>{let{minValue:t,maxValue:r}=i(),a=r-t,s=e.value??e,g=e.label??String(e.value)??s,u=Number(s),l=0;return a>0&&(l=(u-t)/a*100),H({className:"g-ui-slider-mark",style:{left:`${Math.max(0,Math.min(100,l))}%`}},H({className:"g-ui-slider-mark-label"},g))};import{Div as ra}from"granular";function ta(...e){let{props:i}=n(e,{height:"md",width:"full"}),{height:t,width:r,className:a,...s}=i;return ra({...s,className:o("g-ui-skeleton",[t,g=>`g-ui-skeleton-h-${g}`],[r,g=>`g-ui-skeleton-w-${g}`],a)})}import{Button as aa,after as Ne,state as oa}from"granular";function sa(...e){let{props:i,rawProps:t,children:r}=n(e,{size:"md",variant:"filled"}),{checked:a,size:s,variant:g,className:u,...l}=i,{onChange:d}=t,p=oa(!!a);Ne(a).change(c=>{c!=null&&p.set(!!c)});let x=c=>{p.set(c),d?.(c)};return aa({...l,type:"button",className:o("g-ui-chip",f("g-ui-chip-size-",s,"md"),f("g-ui-chip-variant-",g,"filled"),Ne(p).compute(c=>c?"g-ui-chip-active":""),u),onClick:()=>x(!p.get())},r)}import{Div as ji,after as Ce,state as na}from"granular";function ga(...e){let{props:i,rawProps:t}=n(e,{data:[],size:"sm"}),{value:r,data:a,size:s,scroll:g,className:u,...l}=i,{onChange:d}=t,p=na(y(r));Ce(r).change(c=>{let m=y(c);m!=null&&p.set(m)});let x=c=>{p.set(c),d?.(c)};return ji({...l,className:o(g&&"g-ui-segmented-scroll")},ji({className:o("g-ui-segmented",f("g-ui-segmented-size-",s,"sm"),i.className??u)},a.map(c=>ji({className:o("g-ui-segmented-item",Ce(p).compute(m=>c.value===m?"g-ui-segmented-active":"")),onClick:()=>x(c.value)},c.label))))}import{Button as Fi,Div as ua,state as pa,after as ni}from"granular";function ca(...e){let{props:i,rawProps:t}=n(e,{total:1,size:"md"}),{page:r,total:a,size:s,className:g,...u}=i,{onChange:l}=t,d=pa(y(r??1));ni(r).change(m=>{let b=y(m);b!=null&&d.set(b)});let p=m=>{let b=Number(y(a))||1,D=Math.max(1,Math.min(b,m));d.set(D),l?.(D)},x=[],c=Number(y(a))||1;for(let m=1;m<=c;m+=1)x.push(m);return ua({...u,className:o("g-ui-pagination",f("g-ui-pagination-size-",s,"md"),i.className??g)},Fi({className:"g-ui-pagination-item",onClick:()=>p((d.get?.()??d)-1),disabled:ni(d).compute(m=>m<=1)},"<"),x.map(m=>Fi({className:ni(d).compute(b=>o("g-ui-pagination-item",m===b&&"g-ui-pagination-item-active")),onClick:()=>p(m)},String(m))),Fi({className:"g-ui-pagination-item",onClick:()=>p((d.get?.()??d)+1),disabled:ni(d).compute(m=>m>=a)},">"))}import{Div as la,Input as da,Label as ma,Span as Pe,when as Se}from"granular";function fa(...e){let{props:i}=n(e,{size:"md"}),{label:t,description:r,size:a,className:s,inputProps:g,...u}=i,l=ma({className:"g-ui-radio-control"},da({type:"radio",className:o("g-ui-radio-input",f("g-ui-radio-size-",a,"md"),g?.className),...u}),Se(t,()=>Pe({className:"g-ui-radio-label"},t)));return la({className:o("g-ui-radio",f("g-ui-radio-size-",a,"md"),s)},l,Se(r,()=>Pe({className:"g-ui-radio-description"},r)))}import{Div as xa}from"granular";function ha(...e){let{props:i,children:t}=n(e),{className:r,...a}=i;return xa({...a,className:o("g-ui-stack g-ui-gap-sm",r)},t)}import{Nav as ba,Span as va}from"granular";function wa(...e){let{props:i,children:t}=n(e,{separator:"/"}),{separator:r,className:a,...s}=i,g=[];Array.isArray(t)?g.push(...t):g.push(t);let u=g.filter(Boolean),l=[];return u.forEach((d,p)=>{l.push(d),p<u.length-1&&l.push(va({className:"g-ui-breadcrumbs-separator"},r))}),ba({...s,className:o("g-ui-breadcrumbs",a)},l)}import{Div as ya}from"granular";function za(...e){let{props:i,children:t}=n(e),{className:r,...a}=i;return ya({...a,className:o("g-ui-center",r)},t)}import{Div as ka}from"granular";function Na(...e){let{props:i}=n(e,{size:"md"}),{size:t,className:r,...a}=i;return ka({...a,className:o("g-ui-space",[t,s=>`g-ui-space-${s}`],r)})}import{Div as Ca,when as Pa}from"granular";function Sa(...e){let{props:i,children:t}=n(e),{opened:r,className:a,...s}=i;return Pa(r,()=>Ca({...s,className:o("g-ui-collapse",a)},t))}import{Button as Da}from"granular";function gi(...e){let{props:i,children:t}=n(e,{size:"md",variant:"filled"}),{size:r,variant:a,className:s,...g}=i;return Da({...g,type:"button",className:o("g-ui-action-icon",f("g-ui-action-icon-size-",r,"md"),f("g-ui-action-icon-",a,"filled"),s)},t)}import{Div as Ri,when as Va,after as Ma,state as Ia}from"granular";function Yi(...e){let{props:i,rawProps:t,children:r}=n(e,{position:"left"}),{opened:a,position:s,content:g,className:u,...l}=i,{onChange:d}=t,p=Ia(y(a)??!1);Ma(a).change(c=>{let m=y(c);m!=null&&p.set(!!m)});let x=c=>{p.set(c),d?.(c)};return Ri({...l,className:o("g-ui-popover",i.className??u)},Ri({onClick:()=>x(!p.get())},r),Va(p,()=>Ri({className:o("g-ui-popover-dropdown",s==="right"&&"g-ui-popover-right",s==="center"&&"g-ui-popover-center")},g)))}import{Div as De}from"granular";function La(...e){let{props:i,children:t}=n(e,{position:"left"}),{position:r,content:a,className:s,...g}=i;return De({...g,className:o("g-ui-hover-card",s)},t,De({className:o("g-ui-hover-card-dropdown",[r,u=>u==="right"?"g-ui-hover-card-right":""],[r,u=>u==="center"?"g-ui-hover-card-center":""])},a))}import{Div as Ba}from"granular";function Ta(...e){let{props:i,children:t}=n(e,{position:"bottom-right"}),{position:r,className:a,...s}=i;return Ba({...s,className:o("g-ui-affix",[r,g=>`g-ui-affix-${g}`],a)},t)}import{Fieldset as $a,Legend as Aa,when as ja}from"granular";function Fa(...e){let{props:i,children:t}=n(e),{legend:r,className:a,...s}=i;return $a({...s,className:o("g-ui-fieldset",a)},ja(r,()=>Aa({className:"g-ui-legend"},r)),t)}import{Div as Ra}from"granular";function Ya(...e){let{props:i,children:t}=n(e,{position:"sticky"}),{position:r,className:a,...s}=i;return Ra({...s,className:o("g-ui-appbar",f("g-ui-appbar-",r,"sticky"),a)},t)}import{Div as Hi,portal as Ha,after as ui,state as Ve,when as Me}from"granular";function Ga(...e){let{props:i,children:t}=n(e,{position:"left",size:"md",blur:!0,fixed:!1,minWidth:"button"});return Me(i.fixed,()=>Oa(i,t),()=>Ea(i,t))}var Ea=(e,i)=>{let{open:t,onClose:r,position:a,size:s,blur:g,fixed:u,minWidth:l,className:d,...p}=e,x=Ve(!1),c=Ve(!1),m=220,b=N=>{if(N){x.set(!0),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>c.set(!0)):setTimeout(()=>c.set(!0),0);return}c.set(!1),setTimeout(()=>x.set(!1),m)};b(!!t.get()),ui(t).change(N=>b(!!N));let D=ui(c,g).compute(N=>{let[C,k]=N;return o("g-ui-sidebar-overlay",C&&"g-ui-sidebar-overlay-open",!k&&"g-ui-sidebar-overlay-noblur")}),S=ui(s,a,c,d).compute(N=>{let[C,k,v,h]=N,P=k==="right"?"g-ui-sidebar-drawer-right g-ui-sidebar-position-right":"g-ui-sidebar-drawer-left";return o("g-ui-sidebar","g-ui-sidebar-drawer",`g-ui-sidebar-size-${C}`,P,v&&"g-ui-sidebar-drawer-open",y(h))});return Me(x,()=>Ha(Hi({className:D,onClick:r},Hi({className:S,onClick:N=>N.stopPropagation()},i))))},Oa=(e,i)=>{let{open:t,position:r,size:a,minWidth:s,className:g,...u}=e,l=ui(a,r,t,s,g).compute(d=>{let[p,x,c,m,b]=d,D=m||"button",S=null;return D==="button"?S="g-ui-sidebar-min-button":D==="xs"?S="g-ui-sidebar-min-xs":D==="sm"?S="g-ui-sidebar-min-sm":D==="md"&&(S="g-ui-sidebar-min-md"),o("g-ui-sidebar g-ui-sidebar-fixed",`g-ui-sidebar-size-${p||"md"}`,S,c&&"g-ui-sidebar-fixed-open",b)});return Hi({...u,className:l},i)};import{Div as E,when as Ie}from"granular";function Ua(...e){let{props:i}=n(e,{items:[]}),{items:t,className:r,...a}=i;return E({...a,className:o("g-ui-timeline",r)},t.map(s=>E({className:"g-ui-timeline-item"},E({className:"g-ui-timeline-dot"}),E({className:"g-ui-timeline-content"},Ie(s.title,()=>E({className:"g-ui-timeline-title"},s.title)),Ie(s.description,()=>E({className:"g-ui-timeline-desc"},s.description)),s.content))))}import{Div as pi}from"granular";function Xa(...e){let{props:i}=n(e,{active:0,items:[]}),{active:t,items:r,className:a,...s}=i;return pi({...s,className:o("g-ui-stepper",a)},r.map((g,u)=>pi({className:o("g-ui-stepper-item",[t,l=>u===l?"g-ui-stepper-active":""])},pi({className:"g-ui-stepper-index"},String(u+1)),pi({className:"g-ui-stepper-label"},g.label))))}import{Span as Le,after as Be,state as qa}from"granular";function Wa(...e){let{props:i,rawProps:t}=n(e,{value:0,max:5,size:"md"}),{value:r,max:a,size:s,className:g,...u}=i,{onChange:l}=t,d=qa(y(r));Be(r).change(m=>{let b=y(m);b!=null&&d.set(b)});let p=m=>{d.set(m),l?.(m)},x=[],c=Number(y(a))||0;for(let m=1;m<=c;m+=1)x.push(m);return Le({...u,className:o("g-ui-rating",f("g-ui-rating-size-",s,"md"),i.className??g)},x.map(m=>Le({className:o("g-ui-rating-item",Be(d).compute(b=>m<=b?"g-ui-rating-item-active":"")),onClick:()=>p(m)},"\u2605")))}import{Span as Za}from"granular";function Ka(...e){let{props:i,children:t}=n(e),{className:r,...a}=i;return Za({...a,className:o("g-ui-tag",r)},t)}import{Button as Te,Div as O,state as $e,after as ci}from"granular";var _a=["S","M","T","W","T","F","S"];function W(...e){let{props:i,rawProps:t}=n(e,{size:"md"}),{value:r,className:a,size:s,...g}=i,{onChange:u}=t,l=C=>{let k=y(C);if(k instanceof Date)return k;if(k==null)return null;let v=new Date(k);return Number.isNaN(v.getTime())?null:v},d=$e(l(r)??new Date),p=$e(new Date(d.get()));ci(r).change(C=>{let k=l(C);k!=null&&(d.set(k),p.set(new Date(k)))});let x=(C,k,v)=>{let h=new Date(C,k+1,0).getDate();return new Date(C,k,Math.min(v,h))},c=C=>{let k=p.get(),v=x(k.getFullYear(),k.getMonth(),C);d.set(v),p.set(v),u?.(v)},m=C=>{let k=p.get(),v=x(k.getFullYear(),k.getMonth()+C,k.getDate());p.set(v)},b=C=>{let k=p.get(),v=x(k.getFullYear()+C,k.getMonth(),k.getDate());p.set(v)},D=ci(p).compute(C=>C.toLocaleString("default",{month:"long"})),S=ci(p).compute(C=>String(C.getFullYear())),N=ci(p,d).compute(([C,k])=>{let v=C.getFullYear(),h=C.getMonth(),z=new Date(v,h,1).getDay(),w=new Date(v,h+1,0).getDate(),M=[];for(let V=0;V<z;V+=1)M.push({muted:!0,label:""});for(let V=1;V<=w;V+=1)M.push({label:V});return[..._a.map(V=>O({className:"g-ui-calendar-cell g-ui-calendar-cell-muted"},V)),...M.map(V=>O({className:o("g-ui-calendar-cell",V.muted&&"g-ui-calendar-cell-muted",V.label&&k.getFullYear()===v&&k.getMonth()===h&&V.label===k.getDate()&&"g-ui-calendar-cell-active"),onClick:()=>V.label&&c(V.label)},V.label))]});return O({...g,className:o("g-ui-calendar",a,f("g-ui-calendar-size-",s,"md"))},O({className:"g-ui-calendar-header"},gi({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>m(-1)},oi({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:ge})),O({className:"g-ui-calendar-title-group"},Te({type:"button",className:"g-ui-calendar-title-button",onClick:()=>m(1)},D),Te({type:"button",className:"g-ui-calendar-title-button",onClick:()=>b(1)},S)),gi({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>m(1)},oi({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:ne}))),O({className:"g-ui-calendar-grid"},N))}import{Div as Ja,Span as Qa,after as io,state as eo}from"granular";function ro(...e){let{props:i,rawProps:t}=n(e,{data:[],size:"md"}),{value:r,data:a,size:s,className:g,...u}=i,{onChange:l}=t,d=eo(y(r)??[]);io(r).change(c=>{let m=y(c);m!=null&&d.set(m)});let p=d.get()??[],x=c=>{let m=p.includes(c)?p.filter(b=>b!==c):p.concat(c);d.set(m),l?.(m)};return Ja({...u,className:o("g-ui-select-multi",f("g-ui-select-multi-size-",s,"md"),i.className??g)},a.map(c=>Qa({className:o("g-ui-select-tag",[p.includes(c.value),"g-ui-chip-active"]),onClick:()=>x(c.value)},c.label)))}import{Div as Z,when as Ae}from"granular";function to(...e){let{props:i}=n(e,{items:[]}),{items:t,className:r,onClose:a,timeout:s,...g}=i;return Z({...g,className:o("g-ui-toast-stack",r)},t.map(u=>Z({className:o("g-ui-toast",[s,"g-ui-toast-auto"])},Z({className:"g-ui-toast-row"},Ae(u.title,()=>Z({className:"g-ui-toast-title"},u.title)),Ae(a,()=>Z({className:"g-ui-toast-close",onClick:()=>a(u)},"\xD7"))),u.message)))}function ao(...e){let{props:i}=n(e);return W(i)}import{Div as Gi,when as oo}from"granular";function so(...e){let{props:i}=n(e,{items:[]}),{items:t,className:r,...a}=i;return Gi({...a,className:o("g-ui-notifications",r)},t.map(s=>Gi({className:o("g-ui-notification",s.color&&`g-ui-notification-${s.color}`)},oo(s.title,()=>Gi({className:"g-ui-notification-title"},s.title)),s.message)))}import{Div as U,after as K,state as no,when as go}from"granular";function uo(...e){let{props:i,rawProps:t}=n(e,{min:0,max:100,step:1,size:"md"}),{value:r,marks:a,min:s,max:g,step:u,size:l,disabled:d,className:p,...x}=i,{onChange:c}=t,m=no(y(r??[s,g])),b=()=>{let h=Number(y(s)),P=Number(y(g));return!Number.isFinite(h)||!Number.isFinite(P)?{minValue:0,maxValue:100}:{minValue:Math.min(h,P),maxValue:Math.max(h,P)}},D=()=>{let h=Number(y(u));return Number.isFinite(h)&&h>0?h:1},S=h=>{let{minValue:P,maxValue:z}=b(),w=D(),M=[P,z];Array.isArray(h)&&(M=h);let V=Math.max(P,Math.min(z,Number(M[0]))),T=Math.max(P,Math.min(z,Number(M[1]))),$=Math.round(Math.min(V,T)/w)*w,A=Math.round(Math.max(V,T)/w)*w;return[$,A]};K(r).change(h=>{h!=null&&m.set(S(h))});let N=h=>{let P=S(h);P?.[0]===m.get()?.[0]&&P?.[1]===m.get()?.[1]||(m.set(P),c?.(P))},C=K(m).compute(h=>{let{minValue:P,maxValue:z}=b(),w=z-P,[M,V]=S(h);if(w<=0)return{lowPct:0,highPct:0};let T=(M-P)/w*100,$=(V-P)/w*100;return{lowPct:Math.max(0,Math.min(100,T)),highPct:Math.max(0,Math.min(100,$))}}),k=(h,P,z)=>{let w=P?.();if(!w||w.width===0)return;let V=Math.min(Math.max(h.clientX-w.left,0),w.width)/w.width,{minValue:T,maxValue:$}=b(),A=T+V*($-T),j=m;typeof m.get=="function"&&(j=m.get());let[F,_]=S(j);N(z==="low"?[A,_]:[F,A])},v=(h,P,z)=>{if(B(d))return;h.preventDefault?.();let w=z||h.currentTarget,M=()=>w.getBoundingClientRect(),V=M(),T=C;typeof C.get=="function"&&(T=C.get());let{lowPct:$,highPct:A}=T,j=(h.clientX-V.left)/V.width*100,F=P;if(!F){let di=Math.abs(j-$)<=Math.abs(j-A);F="high",di&&(F="low")}w.setPointerCapture?.(h.pointerId),k(h,M,F);let _=di=>k(di,M,F),Zi=()=>{w.releasePointerCapture?.(h.pointerId),window.removeEventListener("pointermove",_),window.removeEventListener("pointerup",Zi)};window.addEventListener("pointermove",_),window.addEventListener("pointerup",Zi)};return U({...x,className:o("g-ui-range-slider",f("g-ui-slider-size-",l,"md"),I("g-ui-slider-disabled",d),i.className??p)},U({className:"g-ui-slider-track",onPointerDown:h=>v(h)},U({className:"g-ui-slider-bar",style:K(C).compute(({lowPct:h,highPct:P})=>({left:`${h}%`,width:`${Math.max(0,P-h)}%`}))}),U({className:"g-ui-slider-thumb",style:K(C).compute(({lowPct:h})=>({left:`${h}%`})),onPointerDown:h=>{h.stopPropagation?.(),v(h,"low",h.currentTarget.parentElement)}}),U({className:"g-ui-slider-thumb",style:K(C).compute(({highPct:h})=>({left:`${h}%`})),onPointerDown:h=>{h.stopPropagation?.(),v(h,"high",h.currentTarget.parentElement)}})),go(a,()=>U({className:"g-ui-slider-marks"},a.map(h=>Ai({mark:h,getBounds:b})))))}import{Div as po,Input as co,Span as je,when as Fe,state as Ei,after as Re}from"granular";function lo(...e){let{props:i,rawProps:t}=n(e,{size:"md",format:{pattern:"dddd-dd-dd"}}),{value:r,size:a,calendarSize:s,leftSection:g,rightSection:u,className:l,inputProps:d,format:p,minDate:x,maxDate:c,...m}=i,{onChange:b}=t,D=z=>{let w=y(z);if(w instanceof Date)return w;if(w==null||w==="")return null;let M=new Date(w);return Number.isNaN(M.getTime())?null:M},S=(z,w)=>z&&w&&z.getFullYear()===w.getFullYear()&&z.getMonth()===w.getMonth()&&z.getDate()===w.getDate(),N=z=>{if(!z)return"";let w=String(z.getFullYear()).padStart(4,"0"),M=String(z.getMonth()+1).padStart(2,"0"),V=String(z.getDate()).padStart(2,"0");return`${w}-${M}-${V}`},C=z=>{let w=String(z??"").replace(/\D/g,"");if(w.length<8)return null;let M=Number(w.slice(0,4)),V=Number(w.slice(4,6)),T=Number(w.slice(6,8));if(!M||!V||!T)return null;let $=new Date(M,V-1,T);if($.getFullYear()!==M||$.getMonth()!==V-1||$.getDate()!==T)return null;let A=D(x);if(A&&$<A)return null;let j=D(c);return j&&$>j?null:$},k=Ei(D(r)),v=Ei(N(k.get())),h=Ei(!1);Re(r).change(z=>{let w=D(z);if(w==null){k.set(null),v.set("");return}k.set(w),v.set(N(w))}),Re(v).change(z=>{let w=C(z);w&&(S(w,k.get())||(k.set(w),b?.(w)))});let P=z=>{z&&(S(z,k.get())||(k.set(z),v.set(N(z)),b?.(z),h.set(!1)))};return Yi({opened:h,onChange:z=>h.set(!!z),content:W({size:f("",s,"xs"),value:k,onChange:P}),className:"g-ui-date-input-popover"},po({className:o("g-ui-dateinput","g-ui-input-wrapper",f("g-ui-input-size-",a,"md"),l)},Fe(g,()=>je({className:"g-ui-input-section"},g)),co({type:"text",inputMode:"numeric",format:p,value:v,...m,className:o("g-ui-input",d?.className),onInput:z=>{d?.onInput?.(z)}}),Fe(u,()=>je({className:"g-ui-input-section"},u))))}import{Input as mo}from"granular";function fo(...e){let{props:i}=n(e),{className:t,...r}=i;return mo({type:"text",inputMode:"decimal",...r,className:o("g-ui-input g-ui-input-number",t)})}import{Div as Oi,when as xo,after as ho,state as bo}from"granular";function vo(...e){let{props:i,rawProps:t,children:r}=n(e),{opened:a,content:s,className:g,...u}=i,{onChange:l}=t,d=bo(y(a)??!1);ho(a).change(x=>{let c=y(x);c!=null&&d.set(!!c)});let p=x=>{d.set(x),l?.(x)};return Oi({...u,className:o("g-ui-popper",g)},Oi({onClick:()=>p(!d.get())},r),xo(d,()=>Oi({className:"g-ui-popper-dropdown"},s)))}import{Div as wo,Input as yo,Button as zo,after as ko,when as No}from"granular";import{state as Co}from"granular";function Po(...e){let{props:i}=n(e,{size:"md"}),{size:t,className:r,...a}=i,s=Co(!1),g=ko(s).compute(u=>u?"text":"password");return wo({className:o("g-ui-input-wrapper",f("g-ui-input-size-",t,"md"),r)},yo({type:g,...a,className:"g-ui-input"}),zo({className:"g-ui-password-toggle",onClick:()=>s.set(!s.get())},No(s,()=>"Hide",()=>"Show")))}import{Div as Ye,Input as So}from"granular";function Do(...e){let{props:i}=n(e,{size:"md"}),{size:t,className:r,...a}=i;return Ye({className:o("g-ui-input-wrapper",f("g-ui-input-size-",t,"md"),r)},Ye({className:"g-ui-input-section"},"\u{1F50E}"),So({type:"text",inputMode:"search",...a,className:"g-ui-input"}))}import{Button as Vo,after as Mo,when as He}from"granular";import{state as Io}from"granular";function Lo(...e){let{props:i,children:t}=n(e,{value:"",timeout:1500}),{value:r,timeout:a,className:s,...g}=i,u=Io(!1),l=Mo(u).compute(p=>o("g-ui-copy-button",p&&"g-ui-copy-button-done",s));return Vo({...g,className:l,onClick:async()=>{try{await navigator.clipboard.writeText(String(r)),u.set(!0),setTimeout(()=>u.set(!1),a)}catch{}},type:"button"},He(t?.length,()=>t,()=>He(u,()=>"Copied",()=>"Copy")))}import{Div as Bo}from"granular";function To(...e){let{props:i}=n(e,{size:"md"}),{size:t,className:r,...a}=i;return Bo({...a,className:o("g-ui-progress-ring",[t,s=>`g-ui-progress-ring-size-${s}`],r)})}import{Div as Ui,Button as $o,when as Ge}from"granular";function Ao(...e){let{props:i,children:t}=n(e),{title:r,onClose:a,className:s,...g}=i;return Ui({...g,className:o("g-ui-toast",s)},Ui({className:"g-ui-toast-row"},Ge(r,()=>Ui({className:"g-ui-toast-title"},r)),Ge(a,()=>$o({className:"g-ui-toast-close",onClick:a},"\xD7"))),t)}import{Div as Xi,Input as jo}from"granular";import{state as Fo}from"granular";function Ro(...e){let{props:i,rawProps:t}=n(e,{data:[]}),{data:r,className:a,...s}=i,{onChange:g}=t,u=Fo(""),l=r.filter(d=>String(d.label||"").toLowerCase().includes(String(u.get()).toLowerCase()));return Xi({...s,className:o("g-ui-select-search",a)},jo({className:"g-ui-select-search-input",placeholder:"Search...",value:u}),Xi({className:"g-ui-select-search-list"},l.map(d=>Xi({className:"g-ui-select-search-item",onClick:()=>g?.(d.value)},d.label))))}import{Div as Yo}from"granular";function Ho(...e){let{props:i,children:t}=n(e),{className:r,...a}=i;return Yo({...a,className:o("g-ui-switch-group",r)},t)}import{Div as qi,Input as Ee,state as Go,after as Wi}from"granular";function Eo(...e){let{props:i,rawProps:t}=n(e,{size:"md"}),{value:r,size:a,className:s,...g}=i,{onChange:u}=t,l=Go(y(r)??["",""]);Wi(r).change(p=>{let x=y(p);x!=null&&l.set(x)});let d=p=>{l.set(p),u?.(p)};return qi({...g,className:o("g-ui-range-picker",i.className??s)},qi({className:o("g-ui-input-wrapper",f("g-ui-input-size-",a,"md"))},Ee({type:"text",inputMode:"numeric",className:"g-ui-input",value:Wi(l).compute(p=>p?.[0]??""),onInput:p=>{let x=l.get()??["",""];d([p.target.value,x[1]])}})),qi({className:o("g-ui-input-wrapper",f("g-ui-input-size-",a,"md"))},Ee({type:"text",inputMode:"numeric",className:"g-ui-input",value:Wi(l).compute(p=>p?.[1]??""),onInput:p=>{let x=l.get()??["",""];d([x[0],p.target.value])}})))}import{Div as Oo}from"granular";function Uo(...e){let{props:i,children:t}=n(e,{direction:"row"}),{direction:r,wrap:a,align:s,justify:g,gap:u,className:l,...d}=i;return Oo({...d,className:o("g-ui-flex",[r,p=>p==="column"?"g-ui-flex-column":"g-ui-flex-row"],[a,"g-ui-flex-wrap"],[s,p=>p&&`g-ui-align-${p}`],[g,p=>p&&`g-ui-justify-${p}`],[u,p=>p&&`g-ui-gap-${p}`],l)},t)}import{A as Xo}from"granular";function qo(...e){let{props:i,children:t}=n(e),{active:r,className:a,...s}=i;return Xo({...s,className:o("g-ui-navlink",[r,"g-ui-navlink-active"],a)},t)}import{Div as Oe,when as Wo}from"granular";function Zo(...e){let{props:i,children:t}=n(e,{show:!0,position:"top-right",color:"danger",size:"md"}),{show:r,position:a,color:s,size:g,className:u,...l}=i;return Oe({...l,className:o("g-ui-indicator",f("g-ui-indicator-position-",a,"top-right"),f("g-ui-indicator-color-",s,"danger"),f("g-ui-indicator-size-",g,"md"),u)},t,Wo(r,()=>Oe({className:"g-ui-indicator-badge"})))}import{Span as li}from"granular";function Ko(...e){let{props:i}=n(e),{opened:t,className:r,...a}=i;return li({...a,className:o("g-ui-burger",[t,"g-ui-burger-open"],r)},li(""),li(""),li(""))}import{Div as _o,when as Jo}from"granular";function Qo(...e){let{props:i}=n(e),{visible:t,...r}=i;return Jo(t,()=>_o({...r,className:"g-ui-loading-overlay"},q({})))}import{Div as is}from"granular";function es(...e){let{props:i,children:t}=n(e,{gap:"md"}),{className:r,gap:a,...s}=i;return is({...s,className:o("g-ui-grid-system",[a,g=>`g-ui-gap-${g}`],r)},t)}import{Div as rs}from"granular";function ts(...e){let{props:i,children:t}=n(e,{span:12}),{span:r,className:a,...s}=i;return rs({...s,className:o([r,g=>`g-ui-col-span-${g}`],a)},t)}import{Div as as}from"granular";function os(...e){let{props:i,children:t}=n(e,{size:"md"}),{size:r,className:a,...s}=i;return as({...s,className:o("g-ui-scroll-area",[r,g=>`g-ui-scroll-area-${g}`],a)},t)}import{Div as ss,Input as ns,after as gs,state as us}from"granular";function ps(...e){let{props:i,rawProps:t}=n(e,{length:4}),{length:r,value:a,className:s,...g}=i,{onChange:u}=t,l=us(Array.from({length:r},()=>""));gs(a).change(p=>{p!=null&&l.set(p)});let d=p=>{l.set(p),u?.(p)};return ss({...g,className:o("g-ui-pin-inputs",s)},Array.from({length:r}).map((p,x)=>ns({className:"g-ui-pin-input",type:"text",inputMode:"numeric",maxLength:1,value:l.get()?.[x]||"",onInput:c=>{let b=(l.get()??[]).slice();b[x]=c.target.value,d(b)}})))}import{Div as cs}from"granular";function ls(...e){let{props:i,children:t}=n(e),{className:r,...a}=i;return cs({...a,className:o("g-ui-checkbox-group",r)},t)}import{Div as ds}from"granular";function ms(...e){let{props:i,children:t}=n(e),{className:r,...a}=i;return ds({...a,className:o("g-ui-avatar-group",r)},t)}import{Div as fs}from"granular";function xs(...e){let{props:i,children:t}=n(e),{className:r,...a}=i;return fs({...a,className:o("g-ui-badge-group",r)},t)}import{state as hs}from"granular";function bs(e=!1){let i=hs(!!e);return[i,{open:()=>i.set(!0),close:()=>i.set(!1),toggle:()=>i.set(!i.get())}]}_i();export{gt as Accordion,gi as ActionIcon,Ta as Affix,St as Alert,Wt as Anchor,Ya as AppBar,It as Avatar,ms as AvatarGroup,Sr as Badge,xs as BadgeGroup,jt as Blockquote,wa as Breadcrumbs,Ko as Burger,bi as Button,W as Calendar,Cr as Card,za as Center,Gr as Checkbox,ls as CheckboxGroup,sa as Chip,$t as Code,ts as Col,Sa as Collapse,vr as Container,Lo as CopyButton,lo as DateInput,ao as DatePicker,zt as Divider,xt as Drawer,Fa as Fieldset,Uo as Flex,es as Grid,kr as Group,La as HoverCard,oi as Icon,Kt as Image,Zo as Indicator,Bt as Kbd,ze as List,q as Loading,Qo as LoadingOverlay,dt as Menu,jr as Modal,ro as MultiSelect,qo as NavLink,vt as Notification,so as Notifications,fo as NumberField,Tr as NumberInput,ca as Pagination,Nt as Paper,Po as PasswordInput,ps as PinInput,Yi as Popover,vo as Popper,Jt as Progress,To as ProgressRing,fa as Radio,ha as RadioGroup,Eo as RangePicker,uo as RangeSlider,Wa as Rating,os as ScrollArea,Do as SearchInput,ga as SegmentedControl,Wr as Select,Ro as SelectSearch,Ga as Sidebar,Rt as SimpleGrid,ta as Skeleton,ea as Slider,Na as Space,yr as Stack,Xa as Stepper,qr as Switch,Ho as SwitchGroup,at as Table,Qr as Tabs,Ka as Tag,vi as Text,Mr as TextInput,Lr as Textarea,Ua as Timeline,hr as Title,Ao as Toast,to as ToastStack,ut as Tooltip,o as cx,sr as setThemeMode,or as setThemeVars,bs as useDisclosure};
