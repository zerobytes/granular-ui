var Ht="granular-ui-styles",ua=new URL("./fonts/Poppins-400.ttf",import.meta.url).href,ga=new URL("./fonts/Poppins-500.ttf",import.meta.url).href,la=new URL("./fonts/Poppins-600.ttf",import.meta.url).href,ca=new URL("./fonts/Poppins-700.ttf",import.meta.url).href,pa=new URL("./fonts/Arimo-400.ttf",import.meta.url).href,da=new URL("./fonts/Arimo-500.ttf",import.meta.url).href,ma=new URL("./fonts/Arimo-600.ttf",import.meta.url).href,fa=new URL("./fonts/Arimo-700.ttf",import.meta.url).href,ha=new URL("./fonts/Inter-400.woff2",import.meta.url).href,va=new URL("./fonts/Inter-500.woff2",import.meta.url).href,ba=new URL("./fonts/Inter-600.woff2",import.meta.url).href,xa=new URL("./fonts/Inter-700.woff2",import.meta.url).href,wa=`
@font-face {
  font-family: 'Poppins';
  font-style: normal;
  font-weight: 400;
...
`;function Ot(){if(typeof document>"u"||document.getElementById(Ht))return;let e=document.createElement("style");e.id=Ht,e.textContent=wa,document.head.appendChild(e)}var ya=new Set(["--g-ui-bg","--g-ui-bg-subtle","--g-ui-bg-muted","--g-ui-bg-emphasized","--g-ui-bg-inverted","--g-ui-bg-panel","--g-ui-fg","--g-ui-fg-muted","--g-ui-fg-subtle","--g-ui-fg-inverted","--g-ui-border","--g-ui-border-subtle","--g-ui-border-emphasized","--g-ui-border-inverted","--g-ui-primary","--g-ui-primary-hover","--g-ui-primary-active","--g-ui-primary-subtle","--g-ui-primary-muted","--g-ui-primary-emphasized","--g-ui-success","--g-ui-success-hover","--g-ui-success-active","--g-ui-success-subtle","--g-ui-success-muted","--g-ui-danger","--g-ui-danger-hover","--g-ui-danger-active","--g-ui-danger-subtle","--g-ui-danger-muted","--g-ui-warning","--g-ui-warning-hover","--g-ui-warning-active","--g-ui-warning-subtle","--g-ui-warning-muted","--g-ui-info","--g-ui-info-hover","--g-ui-info-active","--g-ui-info-subtle","--g-ui-info-muted","--g-ui-shadow-xs","--g-ui-shadow-sm","--g-ui-shadow-md","--g-ui-shadow-lg","--g-ui-shadow-xl","--g-ui-shadow-2xl","--g-ui-radius","--g-ui-font","--g-ui-surface","--g-ui-text","--g-ui-muted","--g-ui-primary-strong","--g-ui-shadow"]);function ka(e={},i=document?.documentElement){if(i)for(let[t,r]of Object.entries(e)){let a=t.startsWith("--")?t:`--g-ui-${t}`;ya.has(a)&&i.style.setProperty(a,String(r))}}function za(e="dark",i=document?.documentElement){i&&(i.classList.remove("g-ui-theme-dark","g-ui-theme-light"),i.classList.add(e==="light"?"g-ui-theme-light":"g-ui-theme-dark"))}function Na(e=document?.documentElement){return e.classList.contains("g-ui-theme-light")?"light":"dark"}import{Renderer as Wt,isSignal as qt,isState as Yt,isStatePath as Gt,isComputed as _t,resolve as He,computed as Ca,after as _i,concat as Sa,isWhen as Da}from"@granularjs/core";function Oe(e){return qt(e)||Yt(e)||Gt(e)||_t(e)||Da(e)}function s(...e){return Sa(...e,{separator:" ",filterFalsy:!0})}function g(e,i){let t={},r=[],a=o=>!!o&&typeof o=="object"&&!Array.isArray(o)&&!Wt.isRenderable(o)&&!Wt.isDomNode(o)&&!qt(o)&&!Yt(o)&&!Gt(o)&&!_t(o);for(let o of e)a(o)?Object.assign(t,o):r.push(o);if(i&&typeof i=="object")for(let o of Object.keys(i))t[o]===void 0&&(t[o]=i[o]);return{props:Ca(t),rawProps:t,children:r}}function h(e){return He(e)}function ze(e){return!!He(e)}function z(e,i,t){let r=a=>{let o=He(a),n=o==null||o===""?t:o;return n==null||n===""?"":`${e}${n}`};return Oe(i)?_i(i).compute(a=>r(a)):r(i)}function _(e,i){return Oe(i)?_i(i).compute(t=>He(t)?e:""):He(i)?e:""}function ve(e,i,t){let r=a=>i[a]||null;return Oe(e)?_i(e).compute(a=>r(He(a??t))):r(He(e??t))}import{Button as Pa,Span as Zi,when as Ui,after as Ma}from"@granularjs/core";function Xi(...e){let{props:i,children:t}=g(e,{variant:"filled",size:"md",justify:"center"}),{variant:r,color:a,size:o,fullWidth:n,loading:u,leftSection:l,rightSection:c,className:f,disabled:w,justify:y,...p}=i,x=Ma(w,u).compute(([v,P])=>v||P);return Pa({...p,disabled:x,className:s("g-ui-button",z("g-ui-button-variant-",r,"filled"),z("g-ui-button-color-",a,"primary"),z("g-ui-justify-",y,"center"),z("g-ui-button-size-",o,"md"),_("g-ui-button-full",n),_("g-ui-button-loading",u),f)},Ui(l,()=>Zi({className:"g-ui-button-section-left"},l)),Ui(u,()=>Zi("Loading..."),()=>t),Ui(c,()=>Zi({className:"g-ui-button-section-right"},c)))}import{Span as Ta}from"@granularjs/core";function Ki(...e){let{props:i,children:t}=g(e,{size:"md"}),{size:r,weight:a,color:o,dimmed:n,align:u,ellipsis:l,decoration:c,className:f,style:w,...y}=i,p=ve(a,{bold:"g-ui-text-weight-700",semibold:"g-ui-text-weight-600",medium:"g-ui-text-weight-500",700:"g-ui-text-weight-700",600:"g-ui-text-weight-600",500:"g-ui-text-weight-500",400:"g-ui-text-weight-400"}),x=ve(o,{primary:"g-ui-text-primary",success:"g-ui-text-success",danger:"g-ui-text-danger",muted:"g-ui-text-dimmed"}),v=ve(u,{center:"g-ui-text-align-center",right:"g-ui-text-align-right",left:"g-ui-text-align-left"}),P=ve(c,{underline:"g-ui-text-decoration-underline","line-through":"g-ui-text-decoration-line-through",overline:"g-ui-text-decoration-overline",none:"g-ui-text-decoration-none"});return Ta({...y,style:w,className:s("g-ui-text",z("g-ui-text-size-",r,"md"),_("g-ui-text-dimmed",n),_("g-ui-text-ellipsis",l),p,x,v,P,f)},t)}import{H1 as Va,H2 as Zt,H3 as La,H4 as Ia,H5 as $a,H6 as Aa}from"@granularjs/core";var Fa={1:Va,2:Zt,3:La,4:Ia,5:$a,6:Aa};function Ba(...e){let{props:i,children:t}=g(e,{order:2}),{order:r,className:a,style:o,...n}=i,u=h(r)||2;return(Fa[u]||Zt)({...n,className:s("g-ui-title",z("g-ui-title-order-",r,2),a)},t)}import{Div as ja}from"@granularjs/core";function Ea(...e){let{props:i,children:t}=g(e,{size:"md"}),{size:r,fluid:a,className:o,style:n,...u}=i;return ja({...u,style:n,className:s("g-ui-container",_("g-ui-container-fluid",a),z("g-ui-container-size-",r,"md"),o)},t)}import{Div as Ra}from"@granularjs/core";function Ha(...e){let{props:i,children:t}=g(e,{gap:"md"}),{gap:r,align:a,justify:o,className:n,style:u,...l}=i,c=ve(o,{between:"g-ui-justify-between",center:"g-ui-justify-center",end:"g-ui-justify-end",start:"g-ui-justify-start"});return Ra({...l,style:u,className:s("g-ui-stack",z("g-ui-gap-",r,"md"),z("g-ui-align-",a),c,n)},t)}import{Div as Oa}from"@granularjs/core";function Wa(...e){let{props:i,children:t}=g(e,{gap:"md",align:"center"}),{gap:r,align:a,justify:o,position:n,noWrap:u,className:l,style:c,...f}=i,w=ve(n,{apart:"g-ui-justify-between",center:"g-ui-justify-center",right:"g-ui-justify-end",left:"g-ui-justify-start"});return Oa({...f,style:c,className:s("g-ui-group",z("g-ui-gap-",r,"md"),z("g-ui-align-",a,"center"),z("g-ui-justify-",o,"none"),w,_("g-ui-no-wrap",u),l)},t)}import{Div as wi,list as qa,when as Qi,after as Ut}from"@granularjs/core";function Ya(...e){let{props:i,children:t}=g(e,{padding:"md",radius:"md",shadow:"none"}),{title:r,content:a,actions:o,border:n,padding:u,radius:l,shadow:c,className:f,style:w,...y}=i,p=_("g-ui-card-bordered",n);return wi({style:w},Qi(r,()=>wi({className:"g-ui-card-title"},r)),Qi(a,()=>wi({className:"g-ui-card-content"},a)),{className:s("g-ui-card",_("g-ui-card-bordered",n),z("g-ui-card-border-",n,"none"),z("g-ui-card-padding-",u,"md"),z("g-ui-card-radius-",l,"md"),z("g-ui-card-shadow-",c,"md"),f),...y},t,Qi(o,()=>wi({className:"g-ui-card-actions"},qa(o,x=>Xi({className:"g-ui-card-action",onClick:v=>x.get().onClick?.(v),leftSection:x.leftSection,rightSection:x.rightSection,size:Ut(x.size).compute(v=>v||"sm"),variant:Ut(x.variant).compute(v=>v||"outline"),...x.get().props||{}},x.label)))))}import{Span as Ga}from"@granularjs/core";function _a(...e){let{props:i,children:t}=g(e,{variant:"filled",size:"md"}),{variant:r,size:a,className:o,dot:n,style:u,...l}=i,c=ve(r,{dot:"g-ui-badge-dot"});return Ga({...l,className:s("g-ui-badge",z("g-ui-badge-variant-",r,"filled"),z("g-ui-badge-size-",a,"md"),_("g-ui-badge-dot",n),c,o)},t)}import{Div as oi,Input as Za,Textarea as Ua,Label as Xa,Span as Ka,when as ni,state as Qa,after as Ja,isState as eo}from"@granularjs/core";function be(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{label:r,description:a,error:o,size:n,leftSection:u,rightSection:l,className:c,inputClassName:f,multiline:w,disabled:y,readOnly:p,value:x,...v}=i,{value:P,node:L,onChange:S,onInput:k,onFocus:N,onBlur:C,onKeyDown:m,onKeyUp:d,onClick:I}=t,V=eo(P)&&!S&&!k,A=V?P:Qa(h(x)??"");Ja(x).change(U=>{V||A.set(h(U)??"")});let J=U=>{let ie=U?.target?.value??"";ie!==x.get()&&(A.set(ie),S?.(U),k?.(U))},oe=ze(w),re=oe?Ua:Za,R=s(f,oe&&"g-ui-textarea"),G=re({...v,node:L,value:A,onInput:J,onChange:J,onFocus:N,onBlur:C,onKeyDown:m,onKeyUp:d,onClick:I,disabled:y,readOnly:p,className:s("g-ui-input",R)});return oi({className:s("g-ui-text-input",c,_("g-ui-input-disabled",y),_("g-ui-input-read-only",p))},ni(r,()=>Xa({className:"g-ui-text-input-label"},r)),ni(a,()=>Ka({className:"g-ui-text-input-description"},a)),oi({className:s("g-ui-input-wrapper",_("g-ui-input-multiline",w),z("g-ui-input-size-",n,"md"),_("g-ui-input-error",o))},ni(u,()=>oi({className:"g-ui-input-section"},u)),G,ni(l,()=>oi({className:"g-ui-input-section"},l))),ni(o,()=>oi({className:"g-ui-text-input-error-text"},o)))}function Ji(...e){let{props:i}=g(e,{size:"md"}),{size:t,leftSection:r,rightSection:a,className:o,...n}=i;return be({...n,size:t,className:o,leftSection:r,rightSection:a,multiline:!0})}import{Div as Xt,Span as Kt,after as We,state as io}from"@granularjs/core";function et(...e){let{props:i,rawProps:t}=g(e,{size:"md",step:1,allowDecimal:!0,allowNegative:!0,clampBehavior:"blur",hideControls:!1,decimalSeparator:".",thousandSeparator:"",format:null,prefix:"",suffix:""}),{value:r,min:a,max:o,step:n,size:u,allowDecimal:l,allowNegative:c,decimalSeparator:f,thousandSeparator:w,decimalScale:y,clampBehavior:p,hideControls:x,format:v,locale:P,currency:L,formatOptions:S,prefix:k,suffix:N,leftSection:C,rightSection:m,className:d,onChange:I,onInput:V,...A}=i,{onChange:J,onInput:oe,onBlur:re,onFocus:R,onKeyDown:G}=t,U=F=>{J?.(F.target?.value??""),oe?.(F.target?.value??"")},ie=U,K=io(""),D=F=>String(F??"").replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),j=()=>{if(!!!h(l))return 0;let $=h(y);if($!=null&&$!==""&&Number.isFinite(Number($)))return Math.max(0,Number($));let q=h(v);return q==="currency"||q==="percent"?2:0},M=F=>{let $=h(f)??".",q=h(w)??"",Z=String(F??"");if(q&&(Z=Z.split(q).join("")),!Z||Z==="-"||Z===$||Z.endsWith($))return null;let ne=Z.replace($,"."),te=Number(ne);return Number.isFinite(te)?te:null},Y=F=>{let $=h(w)??"";return $?F.replace(/\B(?=(\d{3})+(?!\d))/g,$):F},T=F=>{let $=h(f)??".",q=j(),Z=Number(F);if(!Number.isFinite(Z))return"";let ne=Z<0?"-":"",te=Math.abs(Z),[Q,ae=""]=String(te).split("."),le=Y(Q);if(q>0){let xe=ae.slice(0,q).padEnd(q,"0");return`${ne}${le}${$}${xe}`}return`${ne}${le}`},E=(F,$)=>{try{let q=h(P),Z=h(L)??"USD",ne=h(S)??{},te=j(),Q=$==="currency"?"currency":"decimal";return new Intl.NumberFormat(q,{style:Q,currency:Z,...te>0?{minimumFractionDigits:te,maximumFractionDigits:te}:{maximumFractionDigits:0},...ne}).format(F)}catch{return T(F)}},H=F=>{let $=F,q=h(a),Z=h(o);return q!=null&&Number.isFinite(Number(q))&&($=Math.max($,Number(q))),Z!=null&&Number.isFinite(Number(Z))&&($=Math.min($,Number(Z))),!h(c)&&$<0&&($=0),$},ee=()=>{let F=h(N)??"",$=h(v);return!F&&$==="percent"?"%":F},pe=(F,$,q)=>{let Z=h(k)??"",ne=ee(),te=String(F??"").replace(/\u00A0/g," "),Q=String(Z??"").replace(/\u00A0/g," "),ae=String(ne??"").replace(/\u00A0/g," "),le=Q&&te.startsWith(Q),xe=ae&&te.endsWith(ae);return`${$??""}${le?"":Z}${F}${xe?"":ne}`},ke=(F,$)=>{let q=j(),Z=h(f)??".",te=String(F??"").replace(/\D/g,"")||"0",Q=q>0?te.padStart(q+1,"0"):te,le=(q>0?Q.slice(0,-q):Q).replace(/^0+(?=\d)/,"")||"0",xe=q>0?Q.slice(-q):"",Be=q>0?`${le}${Z}${xe}`:le;return`${$??""}${Be}`},Pe=F=>{let $=h(k)??"",q=ee(),Z=String(F??""),ne=String($??"").replace(/\u00A0/g," "),te=String(q??"").replace(/\u00A0/g," ");return ne&&Z.replace(/\u00A0/g," ").startsWith(ne)&&(Z=Z.slice($.length)),te&&Z.replace(/\u00A0/g," ").endsWith(te)&&(Z=Z.slice(0,-q.length)),Z},Fe=F=>{let $=!!h(c),q=Pe(F),Z=$&&q.includes("-")?"-":"",ne=q.replace(/\D/g,""),te=ke(ne,Z);if(h(p)==="strict"){let Q=M(te);if(Q!=null){let ae=H(Q);te=`${ae<0?"-":""}${T(Math.abs(ae))}`}}return te},Ve=F=>{if(F==null||F==="")return ke("","");if(typeof F=="number"&&Number.isFinite(F)){let ae=h(p)==="strict"?H(F):F;return`${ae<0?"-":""}${T(Math.abs(ae))}`}let $=Pe(F),q=h(f)??".",ne=!!h(c)&&String($).includes("-")?"-":"",te=String($??"").replace(new RegExp(`[^0-9${D(q)}]`,"g"),""),Q=M(`${ne}${te}`);if(Q!=null){let ae=h(p)==="strict"?H(Q):Q;return`${ae<0?"-":""}${T(Math.abs(ae))}`}return Fe(F)},Me,ai=F=>{let $=h(F);if($===void 0)return;let q=Ve($);q!==K.get()&&(Me=q,K.set(q))};ai(r),We(r).change(F=>{ai(F)}),We(K).change(F=>{if(F===Me){Me=void 0;return}Me=void 0;let $=M(F);if($==null){U?.({target:{value:F??""}});return}U?.({target:{value:$}})});let Wi=We(m).compute(F=>F!=null&&F!==!1),qi=We(x,Wi).compute(([F,$])=>!h(F)&&!$),xi=We(l).compute(F=>h(F)?"decimal":"numeric"),Yi=We(v,k,N,l,c,f,w,y,p,a,o,P,L,S).compute(()=>({mode:"both",format:F=>{let $=Fe(F),q=h(v),ne=!!h(c)&&$.startsWith("-")?"-":"",te=M($),Q=$.replace(ne,"");if(te!=null){let ae=Math.abs(te);if(typeof q=="function")try{Q=q(ae)}catch{Q=T(ae)}else if(q==="currency")Q=E(ae,"currency");else if(q==="decimal"){let le=h(P),xe=h(S);Q=le||xe?E(ae,"decimal"):T(ae)}else Q=T(ae)}return{value:$,raw:$,visual:pe(Q,ne,q)}}})),b=F=>{let $=M(K.get()),q=Number(h(n)??1),ne=H(($??0)+q*F),te=T(ne);K.set(te)},O=F=>{if(!F||typeof F.setSelectionRange!="function")return;let $=()=>{try{let q=String(F.value??"").length;F.setSelectionRange(q,q)}catch{}};typeof requestAnimationFrame=="function"?requestAnimationFrame($):$()},ce=F=>{ie?.(F);let $=F?.target;$&&O($)},X=F=>{if(re?.(F),h(p)!=="blur")return;let $=M(K.get());if($==null)return;let q=H($);K.set(T(q))},ge=F=>{R?.(F),O(F?.target)},he=F=>{G?.(F);let $=F?.target;if(!$)return;let q=h(k)??"",Z=ee();Z&&typeof $.selectionEnd=="number"&&($.selectionEnd=Math.min($.selectionEnd,String($.value??"").length-Z.length)),q&&typeof $.selectionStart=="number"&&($.selectionStart=Math.max($.selectionStart,q.length))},ue=Xt({className:"g-ui-number-field-controls"},Kt({className:"g-ui-number-field-control",onClick:()=>b(1)},"+"),Kt({className:"g-ui-number-field-control",onClick:()=>b(-1)},"\u2212")),Te=Xt({className:"g-ui-number-field-controls-wrapper"},ue),Le=We(qi,m).compute(([F,$])=>F?Te:$);return be({...A,size:u,className:s("g-ui-number-field",d),leftSection:C,rightSection:Le,type:"text",inputMode:xi,inputClassName:s("g-ui-input-number"),value:K,format:Yi,onInput:ce,onBlur:X,onFocus:ge,onKeyDown:he})}function to(...e){return et(...e)}import{Div as Ni,Button as ro,portal as ao,when as it,after as oo}from"@granularjs/core";var yi='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/></svg>',ki='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M560-240 320-480l240-240 56 56-184 184 184 184-56 56Z"/></svg>',zi='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M379.33-244 154-469.33 201.67-517l177.66 177.67 378.34-378.34L805.33-670l-426 426Z"/></svg>',Qt='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M240-446.67v-66.66h480v66.66H240Z"/></svg>',je='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M312-265.33 265.33-312l168-168-168-167L312-693.67l168 168 167-168L693.67-647l-168 167 168 168L647-265.33l-167-168-168 168Z"/></svg>',Jt='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>',er='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>',ir='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h357l-80 80H200v560h560v-278l80-80v358q0 33-23.5 56.5T760-120H200Zm280-360v-80h240v80H480Zm0 160v-80h320v80H480Zm0 160v-80h320v80H480ZM360-360v-80h80v80h-80Zm0 160v-80h80v80h-80Zm0 160v-80h80v80h-80Zm160-320h280l-36-37 37-37v74H520Zm-160 0h80v-80h-80v80ZM120-600v-160l160-160h160l-80 80H200v240h-80Zm80-240v-80 80Z"/></svg>',tr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>',rr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80H200Zm0-80h560v-400H200v400Z"/></svg>',ar='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z"/></svg>';function si(...e){let{props:i,rawProps:t,children:r}=g(e,{size:"md",centered:!0,overlay:"normal"}),{opened:a,title:o,size:n,centered:u,overlay:l,position:c,className:f,style:w}=i,{onClose:y}=t,p=oo(c,u).compute(([x,v])=>`g-ui-modal-position-${x??(v===!1?"top-center":"center")}`);return it(a,()=>ao(Ni({className:s("g-ui-modal-overlay",z("g-ui-modal-overlay-",l,"normal"),p),onClick:x=>{x.target===x.currentTarget&&y?.()}},Ni({className:s("g-ui-modal",z("g-ui-modal-size-",n,"md"),f)},Ni({className:"g-ui-modal-header"},it(o,()=>Ni({className:"g-ui-modal-title"},o)),it(y,()=>ro({type:"button",className:"g-ui-button g-ui-button-variant-subtle g-ui-button-size-xs g-ui-modal-close",onClick:y,innerHTML:je}))),r))))}import{Div as Ci,Span as tt,after as or,when as nr}from"@granularjs/core";function ui(...e){let{props:i}=g(e,{variant:"spinner",size:"md"}),{variant:t,size:r,className:a}=i,o=or(t).compute(u=>u==="dots"),n=or(t).compute(u=>u==="bars");return nr(o,()=>Ci({className:s("g-ui-loading g-ui-dots",z("g-ui-loading-size-",r,"md"),a)}),()=>nr(n,()=>Ci({className:s("g-ui-loading g-ui-bars",z("g-ui-loading-size-",r,"md"),a)},tt(""),tt(""),tt("")),()=>Ci({className:s("g-ui-loading",z("g-ui-loading-size-",r,"md"),a)},Ci({className:"g-ui-spinner"}))))}import{Div as rt,Input as no,Label as so,Span as sr,when as at,state as uo,after as go}from"@granularjs/core";function ot(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{checked:r,label:a,description:o,size:n,indeterminate:u,className:l,style:c,inputProps:f,...w}=i,{onChange:y}=t,p=uo(ze(r));go(r).change(v=>{v!=null&&(p.set(!!v),y?.(v))});let x=so({className:"g-ui-checkbox-control"},no({type:"checkbox",indeterminate:u,checked:p,className:s("g-ui-checkbox-input",z("g-ui-checkbox-size-",n,"md"),f?.className),...w}),at(p,()=>rt({className:"g-ui-checkbox-checked",innerHTML:zi}),()=>{if(!p.get()&&u.get())return rt({className:"g-ui-checkbox-indeterminate",innerHTML:Qt})}),at(a,()=>sr({className:"g-ui-checkbox-label"},a)));return rt({className:s("g-ui-checkbox",z("g-ui-checkbox-size-",n,"md"),l)},x,at(o,()=>sr({className:"g-ui-checkbox-description"},o)))}import{Input as mo,Label as fo,Span as ho,when as vo,after as Si,state as bo}from"@granularjs/core";import{Div as lo,context as co,after as ur}from"@granularjs/core";var nt=co({name:null,selected:null});function po(...e){let{props:i,rawProps:t,children:r}=g(e),{className:a,name:o,selected:n,onChange:u,...l}=i,{onChange:c}=t,f=nt.scope({name:o?.get(),selected:n?.get()});return ur(f.selected).change(w=>{c?.(w)}),ur(n).change(w=>{w!==f.selected.get()&&(f.set().selected=w)}),f.serve(lo({...l,className:s("g-ui-switch-group",a)},r))}function xo(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{label:r,size:a,className:o,style:n,inputProps:u,checked:l,value:c,name:f,type:w,onChange:y,onInput:p,...x}=i,{onChange:v}=t,P=bo(l?.get()??!1),L=nt.state(),S=Si(L,f,w).compute(([k,N,C])=>({name:N??k.name??"",type:C??(k.name?"radio":"checkbox")}));return Si(L.selected).change(k=>{P.set(k===c.get())}),Si(l).change(k=>{P.set(k)}),Si(P).change(k=>{if(v?.(k),!k){L.get().selected===c.get()&&(L.set().selected=null);return}L.set().selected=c.get()}),fo({className:s("g-ui-switch",z("g-ui-switch-size-",a,"md"),o)},mo({type:S.type,name:S.name,value:c,checked:P,className:s("g-ui-switch-input",z("g-ui-switch-size-",a,"md"),u?.className),...x}),vo(r,()=>ho({className:"g-ui-switch-label"},r)))}import{Div as Ee,Span as st,when as Ke,state as gr,after as Di,Label as yo}from"@granularjs/core";import{Span as wo}from"@granularjs/core";function ye(...e){let{props:i,children:t}=g(e,{size:"md"});return wo({...i,className:s("g-ui-icon",z("g-ui-icon-size-",i.size,"md"),z("g-ui-icon-color-",i.color),i.className)},...t)}function ko(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"md"}),{data:r,value:a,size:o,leftSection:n,rightSection:u,placeholder:l,className:c,label:f,description:w,error:y,...p}=i,{onChange:x}=t,v=gr(!1),P=gr(h(a)??"");Di(a).change(N=>{let C=h(N);C!==void 0&&P.set(C??"")});let L=N=>{P.set(N),x?.(N),v.set(!1)},S=Di(P).compute(N=>N?"":"g-ui-select-placeholder"),k=Di(P).compute(N=>{let m=(h(r)??[]).find(d=>d.value===N);return N?m?.label??"":l??""});return Ee({...p,className:s("g-ui-select-root",c)},Ke(f,()=>yo({className:"g-ui-text-input-label"},f)),Ke(w,()=>st({className:"g-ui-text-input-description"},w)),Ee({className:s("g-ui-input-wrapper",z("g-ui-input-size-",o,"md")),onClick:()=>v.set(!v.get())},Ke(n,()=>Ee({className:"g-ui-input-section"},n)),Ee({className:s("g-ui-select",S)},st({className:"g-ui-select-value"},k)),Ke(u,()=>Ee({className:"g-ui-input-section"},u),()=>st({className:"g-ui-select-caret"},ye({innerHTML:ar})))),Ke(y,()=>Ee({className:"g-ui-text-input-error-text"},y)),Ke(v,()=>Ee({className:"g-ui-select-dropdown"},(h(r)??[]).map(N=>Ee({className:s("g-ui-select-item",Di(P).compute(C=>C===N.value?"g-ui-select-item-active":"")),onClick:()=>L(N.value)},N.label)))))}import{Button as zo,Div as Qe,state as Ie,after as gi,list as No,when as Co}from"@granularjs/core";function So(...e){let{props:i,rawProps:t}=g(e,{tabs:[],orientation:"horizontal",variant:"default",sticky:!0,align:"left",size:"md"}),{value:r,tabs:a,orientation:o,variant:n,sticky:u,className:l,style:c,align:f,size:w}=i,{onChange:y}=t,p=Ie(h(r)??h(a)?.[0]?.value??""),x=Ie(),v=Ie(),P=Ie(0),L=Ie(0),S=Ie(0),k=Ie(0),N=Ie(!1),C=Ie(0),m=!1,d=null,I=!1,V=new Set;gi(r).change(T=>{let E=h(T);E!=null&&p.set(E)});let A=T=>{p.set(T),y?.(T)},J=T=>{let E=[],H=T?.parentElement;for(;H;){let ee=getComputedStyle(H),pe=`${ee.overflow}${ee.overflowY}${ee.overflowX}`;/(auto|scroll)/.test(pe)&&E.push(H),H=H.parentElement}return E},oe=T=>J(T)[0]??null,re=T=>T?T.getBoundingClientRect().top:0,R=T=>T?T.scrollTop:window.scrollY||window.pageYOffset||0,G=(T,E)=>T>E?"down":T<E?"up":"none",U=(T,E,H,ee)=>T==="down"&&E<H?!0:T==="up"&&E>=H?!1:ee,ie=()=>{let T=x.get(),E=v.get();if(!T||!E)return;if(!ze(u)){N.set(!1),P.set(0);return}if(typeof window>"u")return;let H=T.getBoundingClientRect(),ee=E.getBoundingClientRect(),pe=oe(T),ke=re(pe),Pe=R(pe),Fe=G(Pe,C.get());C.set(Pe);let Ve=U(Fe,H.top,ke,N.get());P.set(ee.height),L.set(H.left),S.set(H.width),k.set(ke),Ve!==N.get()&&N.set(Ve)},K=()=>{d==null&&(d=requestAnimationFrame(()=>{d=null,ie()}))},D=T=>{!T||V.has(T)||(V.add(T),T.addEventListener("scroll",K,{passive:!0}))},j=()=>{if(m)return;let T=x.get(),E=v.get();!T||!E||typeof window>"u"||(m=!0,ie(),D(window),window.addEventListener("resize",K),J(T).forEach(D))};gi(v,x,u).change(j),!I&&typeof window<"u"&&(I=!0,setTimeout(()=>j(),0));let M=gi(N,L,S,k).compute(T=>{let[E,H,ee,pe]=T;return E?{position:"fixed",top:`${pe}px`,left:`${H}px`,width:`${ee}px`,background:"var(--g-ui-surface)",zIndex:100}:{position:"static",top:"auto",left:"auto",width:"auto",zIndex:"auto",background:"transparent"}}),Y=gi(N,P).compute(T=>{let[E,H]=T;return{height:E?`${H}px`:"0px"}});return Qe(Qe({className:s("g-ui-tabs",ve(o,{vertical:"g-ui-tabs-vertical"}),z("g-ui-tabs-variant-",n,"default"),z("g-ui-tabs-align-",f,"left"),z("g-ui-tabs-size-",w,"md"),i.className??l)},Qe({node:x}),Qe({style:Y}),Qe({node:v,className:"g-ui-tabs-list",style:M},No(a,T=>zo({className:gi(p,T.value).compute(([E,H])=>s("g-ui-tabs-tab",H===E&&"g-ui-tabs-tab-active")),onClick:()=>A(T.get().value)},T.label))),Qe({className:"g-ui-tabs-panel"},Co(p,()=>a.get()?.find(T=>T.value===p.get())?.content??null))))}import{Table as Do,Thead as Po,Tbody as Mo,Tr as To,Th as Vo,Td as Lo,list as cr,when as pr,after as ut}from"@granularjs/core";function Io(...e){let{props:i}=g(e,{headers:[],rows:[]}),{headers:t,rows:r,striped:a,highlightOnHover:o,withBorder:n,withColumnBorders:u,withRowBorders:l,className:c,style:f,...w}=i,y=ut(t).compute(p=>p.length>0);return Do({...w,className:s("g-ui-table",_("g-ui-table-striped",a),_("g-ui-table-hover",o),_("g-ui-table-with-border",n),_("g-ui-table-column-borders",u),_("g-ui-table-row-borders",l),c)},pr(y,()=>Po(lr(t,!0))),Mo(cr(r,p=>lr(p,!1))))}var lr=(e,i)=>{let t=ut(e).compute(o=>Array.isArray(o)),r=o=>{let n=ut(o).compute(u=>Object.values(u));return a(n)},a=o=>cr(o,n=>i?Ao(n):$o(n));return To(pr(t,()=>a(e),()=>r(e)))},$o=e=>Lo(e),Ao=e=>Vo(e);import{Div as gt}from"@granularjs/core";import{state as Fo,when as Bo,after as jo}from"@granularjs/core";function Eo(...e){let{props:i,rawProps:t,children:r}=g(e,{opened:!1}),{opened:a,className:o,...n}=i,{opened:u}=t,l=Oe(u),c=l?u:Fo(ze(a));jo(a).change(p=>{l||c.set(ze(p))});let f=()=>{l||c.set(!c.get())},w=r[0],y=r[1];return gt({...n,className:s("g-ui-accordion",o)},gt({className:"g-ui-accordion-header",onClick:f},w),Bo(c,()=>gt({className:"g-ui-accordion-content"},y)))}import{Span as dr}from"@granularjs/core";function Ro(...e){let{props:i,children:t}=g(e),{label:r,className:a,style:o}=i;return dr({className:s("g-ui-tooltip",a)},t,dr({className:"g-ui-tooltip-content"},r))}import{Div as li,when as Ho,after as Oo,state as ci,portal as Wo}from"@granularjs/core";var lt=ci({currentOpenState:null});function qo(...e){let i=ci(),t=ci(),r=ci({}),{props:a,rawProps:o,children:n}=g(e,{position:"right"}),{opened:u,content:l,position:c,className:f,...w}=a,{onChange:y}=o,p=ci(h(u)??!1);Oo(u).change(N=>{let C=h(N);C!=null&&(p.set(!!C),C&&x())});let x=()=>{lt.get().currentOpenState!==p&&(lt.get().currentOpenState?.set(!1),lt.set().currentOpenState=p)};u.get()&&x();let v=N=>{let m=String(N??"right").toLowerCase().split("-").filter(Boolean);if(m.length===1){let V=m[0];return V==="top"||V==="bottom"?{placement:V,align:"center"}:V==="left"||V==="right"?{placement:"bottom",align:V}:V==="center"?{placement:"bottom",align:"center"}:{placement:"bottom",align:"right"}}let[d,I]=m;return d==="top"||d==="bottom"?{placement:d,align:I||"center"}:d==="left"||d==="right"?{placement:d,align:I||"center"}:{placement:"bottom",align:"right"}},P=()=>{let N=i.get(),C=t.get();if(!N||!C||typeof window>"u")return;let m=N.getBoundingClientRect(),d=C.getBoundingClientRect(),I=h(c)??"right",V=getComputedStyle(document.documentElement).getPropertyValue("--g-ui-space-20"),A=Number.parseFloat(V)||20,J=window.innerWidth||0,oe=window.innerHeight||0,re=Math.max(A,J-d.width-A),R=Math.max(A,oe-d.height-A),{placement:G,align:U}=v(I),ie=8,K=m.bottom+ie,D=m.left;G==="top"||G==="bottom"?(K=G==="top"?m.top-d.height-ie:m.bottom+ie,U==="center"?D=m.left+m.width/2-d.width/2:U==="right"?D=m.right-d.width:D=m.left):(G==="left"||G==="right")&&(D=G==="left"?m.left-d.width-ie:m.right+ie,U==="center"?K=m.top+m.height/2-d.height/2:U==="bottom"?K=m.bottom-d.height:K=m.top),D=Math.max(A,Math.min(D,re)),K=Math.max(A,Math.min(K,R)),r.set({top:`${K}px`,left:`${D}px`})},L=N=>{p.set(N),y?.(N),N&&(x(),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>P()):setTimeout(()=>P(),0))},S=()=>L(!p.get()),k=()=>L(!1);return li({...w,node:i,className:s("g-ui-menu",f)},li({onClick:S},n),Ho(p,()=>Wo(li(li({className:"g-ui-menu-overlay",onClick:k}),li({className:"g-ui-menu-dropdown",node:t,style:r},l)))))}import{Div as mr,portal as Yo,when as Go}from"@granularjs/core";function _o(...e){let{props:i,children:t}=g(e,{position:"right",size:"md",overlay:"normal",shadowed:!0}),{opened:r,onClose:a,position:o,size:n,overlay:u,shadowed:l,className:c,style:f}=i;return Go(r,()=>Yo(mr({className:s("g-ui-drawer-overlay",z("g-ui-drawer-overlay-",u,"normal")),onClick:a},mr({className:s("g-ui-drawer",ve(l,{true:"g-ui-drawer-shadowed"},!0),z("g-ui-drawer-",o,"right"),z("g-ui-drawer-size-",n,"md"),c),onClick:w=>w.stopPropagation()},t))))}import{Button as Zo,Div as ct,Span as fr,when as Pi,after as hr}from"@granularjs/core";function pt(...e){let{props:i,rawProps:t,children:r}=g(e,{color:"blue",withCloseButton:!0}),{title:a,color:o,icon:n,loading:u,withCloseButton:l,withBorder:c,className:f,style:w}=i,{onClose:y}=t,p=hr(n,u).compute(([v,P])=>!v&&!!P),x=hr(n,u).compute(([v,P])=>!!v||!!P);return ct({className:s("g-ui-notification",[c,"g-ui-notification-bordered"],[o,v=>`g-ui-notification-${v}`],[x,"g-ui-notification-with-icon"],f)},Pi(n,()=>fr({className:"g-ui-notification-icon"},n)),Pi(p,()=>ui({size:"sm",className:"g-ui-notification-loader"})),ct({className:"g-ui-notification-body"},Pi(a,()=>ct({className:"g-ui-notification-title"},a)),r),Pi(l,()=>Zo({type:"button",className:"g-ui-notification-close",onClick:()=>y?.()},fr({innerHTML:je}))))}import{Div as Uo,when as Xo}from"@granularjs/core";function Ko(...e){let{props:i}=g(e,{labelPosition:"center"}),{label:t,labelPosition:r,vertical:a,className:o,...n}=i;return Uo({...n,className:s("g-ui-divider",_("label",t),z("g-ui-divider-label-",r,"center"),_("g-ui-divider-vertical",a),o)},Xo(t,()=>Ki({className:"g-ui-divider-label-text",size:"sm"},t)))}import{Div as Qo}from"@granularjs/core";function Jo(...e){let{props:i,children:t}=g(e,{padding:"md",radius:"md",shadow:"none"}),{padding:r,radius:a,shadow:o,className:n,...u}=i;return Qo({...u,className:s("g-ui-paper",[r,l=>`g-ui-card-padding-${l}`],[a,l=>`g-ui-card-radius-${l}`],[o,l=>`g-ui-card-shadow-${l}`],n)},t)}import{Button as en,Div as dt,Span as tn,after as vr,when as mt}from"@granularjs/core";function rn(...e){let{props:i,rawProps:t,children:r}=g(e,{color:"blue"}),{title:a,color:o,icon:n,withCloseButton:u,className:l,...c}=i,{onClose:f}=t,w=vr(a,u).compute(([p,x])=>p||x),y=vr(n).compute(p=>p!==void 0);return dt({...c,className:s("g-ui-alert",[o,p=>`g-ui-alert-${p}`],l)},dt({className:"g-ui-alert-header"},mt(n,()=>tn({className:"g-ui-alert-icon"},n)),mt(a,()=>dt({className:"g-ui-alert-title"},a)),mt(u,()=>en({type:"button",className:"g-ui-alert-close",onClick:()=>f?.()},"\xD7"))),r)}import{Div as an,Img as on,when as nn}from"@granularjs/core";function sn(...e){let{props:i,children:t}=g(e,{size:"md",alt:""}),{src:r,size:a,alt:o,className:n,...u}=i;return an({...u,className:s("g-ui-avatar",[a,l=>`g-ui-avatar-size-${l}`],n)},nn(r,()=>on({className:"g-ui-avatar-img",src:r,alt:o}),()=>t))}import{Span as un}from"@granularjs/core";function gn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return un({...a,className:s("g-ui-kbd",r)},t)}import{Code as ln}from"@granularjs/core";function cn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return ln({...a,className:s("g-ui-code",r)},t)}import{Blockquote as pn}from"@granularjs/core";function dn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return pn({...a,className:s("g-ui-blockquote",r)},t)}import{Div as mn}from"@granularjs/core";function fn(...e){let{props:i,children:t}=g(e,{cols:3,gap:"md"}),{cols:r,gap:a,className:o,...n}=i;return mn({...n,className:s("g-ui-grid",[a,u=>`g-ui-gap-${u}`],[r,u=>`g-ui-grid-cols-${u}`],o)},t)}import{Ul as hn,Ol as vn,Li as ft,Div as Mi,Span as ht,after as vt,when as qe,isSignal as bn,isState as xn,isStatePath as wn,isComputed as yn}from"@granularjs/core";function br(...e){let{props:i,children:t}=g(e,{type:"none",size:"md"}),{type:r,size:a,withPadding:o,className:n,...u}=i,l=ve(r,{ordered:"g-ui-list-ordered",unordered:"g-ui-list-unordered",none:"g-ui-list-none"}),c=vt(r).compute(v=>v==="ordered"),f=v=>v&&typeof v=="object"&&typeof v.tagName=="string"&&(v.tagName.toLowerCase()==="ul"||v.tagName.toLowerCase()==="ol"),w=v=>v&&typeof v=="object"&&typeof v.tagName=="string"&&v.tagName.toLowerCase()==="li",y=v=>{let P=L=>L?.nodeType==="granular-list-node"?L:L==null||L===!1?null:Array.isArray(L)?L.map(S=>P(S)):w(L)?L:f(L)?ft({className:"g-ui-list-nested-item"},L):ft(ht({className:"g-ui-list-item-shell"},L));return bn(v)||xn(v)||wn(v)||yn(v)?vt(v).compute(L=>P(L)):P(v)},p=qe(t,()=>t.map(v=>y(v))),x={...u,className:s("g-ui-list",z("g-ui-list-size-",a,"md"),_("g-ui-list-with-padding",o),l,n)};return qe(c,()=>vn(x,p),()=>hn(x,p))}function kn(...e){let{props:i,children:t}=g(e,{withBorder:!1}),{leftSection:r,rightSection:a,title:o,body:n,withBorder:u,className:l,verticalPadding:c,horizontalPadding:f,...w}=i,y=vt(o,n).compute(([p,x])=>!!p||!!x);return ft({...w,className:s("g-ui-list-item",_("g-ui-list-item-border",u),z("g-ui-list-item-vertical-padding-",c,"md"),z("g-ui-list-item-horizontal-padding-",f,"md"),l)},Mi({className:"g-ui-list-item-shell"},qe(r,()=>ht({className:"g-ui-list-item-section g-ui-list-item-section-left"},r)),qe(y,()=>Mi({className:"g-ui-list-item-content"},qe(o,()=>Mi({className:"g-ui-list-item-title"},o)),qe(n,()=>Mi({className:"g-ui-list-item-body"},n))),()=>t),qe(a,()=>ht({className:"g-ui-list-item-section g-ui-list-item-section-right"},a))))}br.Item=kn;import{A as zn}from"@granularjs/core";function Nn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return zn({...a,className:s("g-ui-anchor",r)},t)}import{Img as Cn}from"@granularjs/core";function Sn(...e){let{props:i}=g(e),{className:t,...r}=i;return Cn({...r,className:s("g-ui-image",t)})}import{Div as xr}from"@granularjs/core";function Dn(...e){let{props:i}=g(e,{value:0,color:"primary",size:"md"}),{value:t,color:r,size:a,className:o,...n}=i;return xr({...n,className:s("g-ui-progress",z("g-ui-progress-size-",a,"md"),[t,u=>{let l=Math.max(0,Math.min(100,Number(u)||0));return`g-ui-progress-${Math.round(l/5)*5}`}],[r,u=>u?`g-ui-progress-${u}`:""],o)},xr({className:"g-ui-progress-bar"}))}import{Div as Re,after as Ye,state as Pn,when as wr,list as Mn}from"@granularjs/core";function Tn(...e){let{props:i,rawProps:t}=g(e,{size:"md",min:0,max:100,step:1}),{onChange:r}=t,{value:a,marks:o,size:n,min:u,max:l,step:c,disabled:f,className:w,...y}=i,p=Pn(h(a??u)),x=Ye(o).compute(C=>C&&C.length>0);Ye(a).change(C=>{C!=null&&p.set(h(C))});let v=()=>{let C=Number(h(u)),m=Number(h(l));return!Number.isFinite(C)||!Number.isFinite(m)?{minValue:0,maxValue:100}:{minValue:Math.min(C,m),maxValue:Math.max(C,m)}},P=()=>{let C=Number(h(c));return Number.isFinite(C)&&C>0?C:1},L=C=>{let{minValue:m,maxValue:d}=v(),I=P(),V=Math.max(m,Math.min(d,Number(C))),A=Math.round((V-m)/I)*I+m;A!==p.get()&&(p.set(A),r?.(A))},S=Ye(p).compute(C=>{let{minValue:m,maxValue:d}=v(),I=d-m;if(I<=0)return 0;let V=(Number(C??m)-m)/I*100;return Math.max(0,Math.min(100,V))}),k=(C,m)=>{let d=m?.();if(!d||d.width===0)return;let V=Math.min(Math.max(C.clientX-d.left,0),d.width)/d.width,{minValue:A,maxValue:J}=v();L(A+V*(J-A))},N=C=>{if(ze(f))return;C.preventDefault?.();let m=C.currentTarget,d=()=>m.getBoundingClientRect();m.setPointerCapture?.(C.pointerId),k(C,d);let I=A=>k(A,d),V=()=>{m.releasePointerCapture?.(C.pointerId),window.removeEventListener("pointermove",I),window.removeEventListener("pointerup",V)};window.addEventListener("pointermove",I),window.addEventListener("pointerup",V)};return Re({...y,className:s("g-ui-slider",z("g-ui-slider-size-",n,"md"),_("g-ui-slider-disabled",f),w)},Re({className:"g-ui-slider-track",onPointerDown:N},Re({className:"g-ui-slider-bar",style:Ye(S).compute(C=>({width:`${C}%`}))}),Re({className:"g-ui-slider-thumb",style:Ye(S).compute(C=>({left:`${C}%`}))})),wr(x,()=>Re({className:"g-ui-slider-marks-placeholder"})),wr(o,()=>Re({className:"g-ui-slider-marks"},Mn(o,C=>bt({mark:C,getBounds:v})))))}var bt=({mark:e,getBounds:i})=>{let{minValue:t,maxValue:r}=i(),a=r-t,o=Ye(e).compute(c=>c.value??c),n=Ye(e).compute(c=>c.label??String(c.value)??o),u=Number(o),l=0;return a>0&&(l=(u-t)/a*100),Re({className:"g-ui-slider-mark",style:{left:`${Math.max(0,Math.min(100,l))}%`}},Re({className:"g-ui-slider-mark-label"},n))};import{Div as Vn,after as Ln}from"@granularjs/core";function In(...e){let{props:i}=g(e,{height:"md",width:"full"}),{height:t,width:r,className:a,...o}=i,n=Ln(t,r).compute(([u,l])=>{let c={};return isNaN(u)||(c.height=`${u}px`),isNaN(l)||(c.width=`${l}px`),c});return Vn({...o,style:{width:n.width,height:n.height,...o.style||{}},className:s("g-ui-skeleton",[t,u=>`g-ui-skeleton-h-${u}`],[r,u=>`g-ui-skeleton-w-${u}`],a)})}import{Button as $n,after as yr,state as An}from"@granularjs/core";function Fn(...e){let{props:i,rawProps:t,children:r}=g(e,{size:"md",variant:"filled",color:"primary"}),{checked:a,size:o,variant:n,color:u,className:l,...c}=i,{onChange:f}=t,w=An(!!a);yr(a).change(p=>{p!=null&&w.set(!!p)});let y=p=>{w.set(p),f?.(p)};return $n({...c,type:"button",className:s("g-ui-chip",z("g-ui-chip-size-",o,"md"),z("g-ui-chip-variant-",n,"filled"),z("g-ui-chip-color-",u,"primary"),yr(w).compute(p=>p?"g-ui-chip-active":""),l),onClick:()=>y(!w.get())},r)}import{Div as xt,after as kr,state as Bn,list as jn}from"@granularjs/core";function En(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"sm"}),{value:r,data:a,size:o,scroll:n,className:u,...l}=i,{onChange:c}=t,f=Bn(h(r));kr(r).change(y=>{let p=h(y);p!=null&&f.set(p)});let w=y=>{f.set(y),c?.(y)};return xt({...l,className:s(n&&"g-ui-segmented-scroll")},xt({className:s("g-ui-segmented",z("g-ui-segmented-size-",o,"sm"),u)},jn(a,(y=>xt({className:s("g-ui-segmented-item",kr(f).compute(p=>y.get().value===p?"g-ui-segmented-active":"")),onClick:()=>w(y.get().value)},y.label)))))}import{Button as wt,Div as Rn,state as Hn,after as Ti}from"@granularjs/core";function On(...e){let{props:i,rawProps:t}=g(e,{total:1,size:"md"}),{page:r,total:a,size:o,className:n,...u}=i,{onChange:l}=t,c=Hn(h(r)??1);Ti(r).change(p=>{let x=h(p);x!=null&&c.set(x)});let f=p=>{let x=Number(h(a))||1,v=Math.max(1,Math.min(x,p));c.set(v),l?.(v)},w=[],y=Number(h(a))||1;for(let p=1;p<=y;p+=1)w.push(p);return Rn({...u,className:s("g-ui-pagination",z("g-ui-pagination-size-",o,"md"),i.className??n)},wt({className:"g-ui-pagination-item",onClick:()=>f((c.get?.()??c)-1),disabled:Ti(c).compute(p=>p<=1)},"<"),w.map(p=>wt({className:Ti(c).compute(x=>s("g-ui-pagination-item",p===x&&"g-ui-pagination-item-active")),onClick:()=>f(p)},String(p))),wt({className:"g-ui-pagination-item",onClick:()=>f((c.get?.()??c)+1),disabled:Ti(c).compute(p=>p>=a)},">"))}import{Div as Gn,Input as _n,Label as Zn,Span as zr,when as Nr,after as zt,state as Un}from"@granularjs/core";import{Div as Wn,context as qn,after as yt}from"@granularjs/core";var kt=qn({name:"",selected:null});function Yn(...e){let{props:i,children:t,rawProps:r}=g(e),{className:a,name:o,selected:n,onChange:u,...l}=i,{onChange:c}=r,f=kt.scope({name:o?.get(),selected:n?.get()});return yt(o).change(w=>{f.set().name=w}),yt(n).change(w=>{w!==f.selected.get()&&(f.set().selected=w)}),yt(f.selected).change(w=>{c?.(w)}),f.serve(Wn({...l,className:s("g-ui-stack g-ui-gap-sm",a)},t))}function Xn(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{label:r,name:a,value:o,checked:n,description:u,size:l,className:c,inputProps:f,...w}=i,{onChange:y}=t,p=Un(n?.get()??!1),x=kt.state(),v=zt(x.name,a).compute(([L,S])=>L||S);zt(n,x.selected).change(L=>{let[S,k]=L;x.get().name?p.set(k===o.get()):p.set(S)}),zt(p).change(L=>{y?.(L),L&&x.get().name&&(x.set().selected=o.get())});let P=Zn({className:"g-ui-radio-control"},_n({type:"radio",name:v,value:o,checked:p,className:s("g-ui-radio-input",z("g-ui-radio-size-",l,"md"),f?.className),...w}),Nr(r,()=>zr({className:"g-ui-radio-label"},r)));return Gn({className:s("g-ui-radio",z("g-ui-radio-size-",l,"md"),c)},P,Nr(u,()=>zr({className:"g-ui-radio-description"},u)))}import{Nav as Kn,Span as Qn}from"@granularjs/core";function Jn(...e){let{props:i,children:t}=g(e,{separator:"/"}),{separator:r,className:a,...o}=i,n=[];Array.isArray(t)?n.push(...t):n.push(t);let u=n.filter(Boolean),l=[];return u.forEach((c,f)=>{l.push(c),f<u.length-1&&l.push(Qn({className:"g-ui-breadcrumbs-separator"},r))}),Kn({...o,className:s("g-ui-breadcrumbs",a)},l)}import{Div as es}from"@granularjs/core";function is(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return es({...a,className:s("g-ui-center",r)},t)}import{Div as ts}from"@granularjs/core";function rs(...e){let{props:i}=g(e,{size:"md"}),{size:t,className:r,...a}=i;return ts({...a,className:s("g-ui-space",[t,o=>`g-ui-space-${o}`],r)})}import{Div as as,when as os}from"@granularjs/core";function ns(...e){let{props:i,children:t}=g(e),{opened:r,className:a,...o}=i;return os(r,()=>as({...o,className:s("g-ui-collapse",a)},t))}import{Button as ss}from"@granularjs/core";function Ge(...e){let{props:i,children:t}=g(e,{size:"md",variant:"filled"}),{size:r,variant:a,color:o,className:n,...u}=i;return ss({...u,type:"button",className:s("g-ui-action-icon",z("g-ui-action-icon-size-",r,"md"),z("g-ui-action-icon-color-",o,"primary"),z("g-ui-action-icon-",a,"filled"),n)},t)}import{Div as Nt,when as us,after as gs,state as ls}from"@granularjs/core";function Ct(...e){let{props:i,rawProps:t,children:r}=g(e,{position:"left"}),{opened:a,position:o,content:n,className:u,...l}=i,{onChange:c}=t,f=ls(h(a)??!1);gs(a).change(y=>{let p=h(y);p!=null&&f.set(!!p)});let w=y=>{f.set(y),c?.(y)};return Nt({...l,className:s("g-ui-popover",i.className??u)},Nt({onClick:()=>w(!f.get())},r),us(f,()=>Nt({className:s("g-ui-popover-dropdown",o==="right"&&"g-ui-popover-right",o==="center"&&"g-ui-popover-center")},n)))}import{Div as Cr}from"@granularjs/core";function cs(...e){let{props:i,children:t}=g(e,{position:"left"}),{position:r,content:a,className:o,...n}=i;return Cr({...n,className:s("g-ui-hover-card",o)},t,Cr({className:s("g-ui-hover-card-dropdown",[r,u=>u==="right"?"g-ui-hover-card-right":""],[r,u=>u==="center"?"g-ui-hover-card-center":""])},a))}import{Div as ps}from"@granularjs/core";function ds(...e){let{props:i,children:t}=g(e,{position:"bottom-right"}),{position:r,className:a,...o}=i;return ps({...o,className:s("g-ui-affix",[r,n=>`g-ui-affix-${n}`],a)},t)}import{Fieldset as ms,Legend as fs,when as hs}from"@granularjs/core";function vs(...e){let{props:i,children:t}=g(e),{legend:r,className:a,...o}=i;return ms({...o,className:s("g-ui-fieldset",a)},hs(r,()=>fs({className:"g-ui-legend"},r)),t)}import{Div as bs}from"@granularjs/core";function xs(...e){let{props:i,children:t}=g(e,{position:"sticky"}),{position:r,className:a,...o}=i;return bs({...o,className:s("g-ui-appbar",z("g-ui-appbar-",r,"sticky"),a)},t)}import{Div as St,portal as ws,after as Vi,state as Sr,when as Dr}from"@granularjs/core";function ys(...e){let{props:i,children:t}=g(e,{position:"left",size:"md",blur:!0,fixed:!1,minWidth:"button"});return Dr(i.fixed,()=>zs(i,t),()=>ks(i,t))}var ks=(e,i)=>{let{open:t,onClose:r,position:a,size:o,blur:n,fixed:u,minWidth:l,className:c,...f}=e,w=Sr(!1),y=Sr(!1),p=220,x=L=>{if(L){w.set(!0),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>y.set(!0)):setTimeout(()=>y.set(!0),0);return}y.set(!1),setTimeout(()=>w.set(!1),p)};x(!!t.get()),Vi(t).change(L=>x(!!L));let v=Vi(y,n).compute(L=>{let[S,k]=L;return s("g-ui-sidebar-overlay",S&&"g-ui-sidebar-overlay-open",!k&&"g-ui-sidebar-overlay-noblur")}),P=Vi(o,a,y,c).compute(L=>{let[S,k,N,C]=L,m=k==="right"?"g-ui-sidebar-drawer-right g-ui-sidebar-position-right":"g-ui-sidebar-drawer-left";return s("g-ui-sidebar","g-ui-sidebar-drawer",`g-ui-sidebar-size-${S}`,m,N&&"g-ui-sidebar-drawer-open",h(C))});return Dr(w,()=>ws(St({className:v,onClick:r},St({className:P,onClick:L=>L.stopPropagation()},i))))},zs=(e,i)=>{let{open:t,position:r,size:a,minWidth:o,className:n,...u}=e,l=Vi(a,r,t,o,n).compute(c=>{let[f,w,y,p,x]=c,v=p||"button",P=null;return v==="button"?P="g-ui-sidebar-min-button":v==="xs"?P="g-ui-sidebar-min-xs":v==="sm"?P="g-ui-sidebar-min-sm":v==="md"&&(P="g-ui-sidebar-min-md"),s("g-ui-sidebar g-ui-sidebar-fixed",`g-ui-sidebar-size-${f||"md"}`,P,y&&"g-ui-sidebar-fixed-open",x)});return St({...u,className:l},i)};import{Div as Ne,when as Li,list as Pr,after as se,resolve as de,state as Ns,Img as Cs,Span as Ss}from"@granularjs/core";var Mr={xs:6,sm:8,md:10,lg:12,xl:14},Ds={xs:"2px",sm:"3px",md:"4px",lg:"6px",xl:"8px"},Ps={xs:"6px",sm:"8px",md:"10px",lg:"12px",xl:"14px"},Ms=14;function Ts(e){if(e==null||e==="")return"var(--g-ui-primary)";let i=String(e).trim();return i.startsWith("#")?i:`var(--g-ui-${i})`}function Vs(e){return(e??[]).map(t=>{if(t==null)return 1;let r=Number(t.weight);return Number.isFinite(r)&&r>=0?r:1})}function Ii(e){let i=(e??[]).length;if(i<2)return{totalWeight:0,cumulativeWeights:[0]};let r=Vs(e).slice(0,i-1),a=r.reduce((n,u)=>n+u,0),o=[0];for(let n=0;n<r.length;n++)o.push(o[n]+r[n]);return{totalWeight:a,cumulativeWeights:o}}function Tr(e,i,t,r){if(r<1||t<=0)return 0;let a=Math.max(0,Math.min(100,e));for(let o=r-1;o>=0;o--){let n=i[o]/t*100;if(a>=n)return o}return 0}function Ls(e,i,t,r,a,o,n){let u=e,l=(n??[]).length;if(l===0)return{activeStep:0,progressPct:0};if(u==="step")return{activeStep:Math.max(0,Math.min(l-1,Math.floor(i??0))),progressPct:0};if(u==="percent"){let c=Math.max(0,Math.min(100,Number(t)||0)),f=Ii(n);return{activeStep:Tr(c,f.cumulativeWeights,f.totalWeight,l),progressPct:c}}if(u==="time"){let c=Number(r)||0,f=a,w=o,y=0;if(Array.isArray(f)&&f.length>=l?y=f.slice(0,l).reduce((S,k)=>S+(Number(k)||0),0):typeof w=="number"&&w>0&&(y=w),y<=0)return{activeStep:0,progressPct:0};let p=y/l,x=0;if(Array.isArray(f)&&f.length>=l){let S=0;for(let k=0;k<l;k++){if(S+=Number(f[k])||0,c<S){x=k;break}x=k}}else x=Math.min(l-1,Math.floor(c/p));let v=Math.min(100,c/y*100),P=Ii(n);return{activeStep:Tr(v,P.cumulativeWeights,P.totalWeight,l),progressPct:v}}return{activeStep:0,progressPct:0}}function Is(e,i,t,r,a,o){if(a<2||r<0||r>=a-1)return 0;if(e==="step")return i>r?100:0;let{totalWeight:n,cumulativeWeights:u}=o??Ii([]);if(n<=0)return 0;let l=u[r]/n*100,c=u[r+1]/n*100;if(t<=l)return 0;if(t>=c)return 100;let f=c-l;return f<=0?0:(t-l)/f*100}var $s=0;function As(e){let i=document.getElementById(e);if(!i)return[];let t=i.querySelectorAll(".g-ui-timeline-item");if(t.length<2)return[];let r=i.dataset.pinSize||"md",a=Mr[r]??Mr.md,o=[];for(let n=0;n<t.length-1;n++){let u=t[n].offsetTop+a,l=t[n+1].offsetTop-t[n].offsetTop;o.push({top:u,height:l})}return o}function Fs(...e){let{props:i,rawProps:t}=g(e,{items:[],mode:"step",active:0,progress:0,elapsedMs:0,stepDurationsMs:null,totalDurationMs:null,clickable:!1,pinRadius:"md",reverseActive:!1,lineWidth:"md",pinSize:"md",activeColor:"primary",align:"left",pinMode:"default"}),{items:r,mode:a,active:o,progress:n,elapsedMs:u,stepDurationsMs:l,totalDurationMs:c,clickable:f,pinRadius:w,reverseActive:y,lineWidth:p,pinSize:x,activeColor:v,align:P,pinMode:L,className:S,...k}=i,{onChange:N}=t,C=se(v).compute(R=>Ts(de(R))),m=`g-ui-timeline-${++$s}`,d=Ns([]),I=se(a,o,n,u,l,c,r).compute(R=>{let[G,U,ie,K,D,j,M]=R;return Ls(G,U,ie,K,D,j,M)}),V=se(d,y).compute(([R,G])=>{if(!de(G)||!R?.length)return null;let U=R[0],ie=0;for(let K of R)ie+=K.height;return{top:U.top,height:ie}}),A=se(I).compute(R=>R?.progressPct!=null?`${Math.max(0,Math.min(100,R.progressPct))}%`:"0%"),J=se(a).compute(R=>{let G=de(R);return G==="time"||G==="percent"||G==="step"}),oe=se(a).compute(R=>de(R));function re(){setTimeout(()=>{let R=As(m);R.length&&d.set(R)},0)}return se(r).change(()=>re()),se(x).change(()=>re()),re(),Ne({...k,id:m,"data-pin-size":se(x).compute(R=>de(R)??"md"),"data-active-color":se(v).compute(R=>{let G=de(R);if(G==null||typeof G!="string")return"primary";let U=String(G).trim();return U.startsWith("#")?"custom":U||"primary"}),style:se(v,p,x).compute(([R,G,U])=>{let ie={"--g-ui-timeline-line-width":Ds[de(G)]??"4px","--g-ui-timeline-track-offset":`calc(${Ms}px - var(--g-ui-timeline-line-width) / 2)`,"--g-ui-timeline-pin-half":Ps[de(U)]??"10px"},K=de(R);return K&&String(K).trim().startsWith("#")&&(ie["--g-ui-timeline-active-color"]=String(K).trim()),ie}),className:s("g-ui-timeline",se(a).compute(R=>R?`g-ui-timeline-mode-${de(R)}`:""),se(J).compute(R=>R?"g-ui-timeline-has-track":""),se(f).compute(R=>de(R)?"g-ui-timeline-clickable":""),se(y).compute(R=>de(R)?"g-ui-timeline-reverse":""),se(P).compute(R=>de(R)==="right"?"g-ui-timeline-align-right":""),z("g-ui-timeline-pin-radius-",w,"md"),z("g-ui-timeline-line-width-",p,"md"),z("g-ui-timeline-pin-size-",x,"md"),se(L).compute(R=>R?`g-ui-timeline-pin-mode-${de(R)}`:""),S)},Li(J,()=>se(y).compute(R=>de(R)?Ne({className:"g-ui-timeline-track-segment g-ui-timeline-track-reverse",style:se(V).compute(G=>G?{top:`${G.top}px`,height:`${G.height}px`}:{})},Ne({className:"g-ui-timeline-track-fill",style:se(A).compute(G=>G?{height:G}:{height:"0%"})})):Pr(d,(G,U)=>{let ie=se(G).compute(j=>j?{top:`${j.top}px`,height:`${j.height}px`}:{}),K=se(I,U,r,oe).compute(([j,M,Y,T])=>{let E=Y??[],H=E.length,ee=Ii(E);return Is(T,j?.activeStep??0,j?.progressPct??0,de(M)??0,H,ee)}),D=se(K).compute(j=>`${Math.max(0,Math.min(100,j))}%`);return Ne({className:"g-ui-timeline-track-segment",style:se(ie).compute(j=>j)},Ne({className:"g-ui-timeline-track-fill",style:se(D).compute(j=>j?{height:j}:{height:"0%"})}))}))),Pr(r,(R,G)=>{let U=se(I,G,r,y).compute(([E,H,ee,pe])=>{let ke=E?.activeStep??0,Pe=de(H)??0,Fe=(ee??[]).length,Ve=de(pe)?Fe-1-Pe:Pe;return Ve<ke?"completed":Ve===ke?"active":"future"}),ie=se(U).compute(E=>E?`g-ui-timeline-item-${E}`:""),K=de(f)&&typeof N=="function"?()=>{let E=de(G);typeof E=="number"&&N(E)}:void 0,D=se(L).compute(E=>de(E)??"default"),j=se(D,R).compute(([E,H])=>{let ee=E??"default";return ee==="icon"&&(H?.icon!=null||H?.pinIcon!=null)?Ss({className:"g-ui-timeline-pin-icon material-symbols-outlined"},H.icon??H.pinIcon??""):ee==="image"&&(H?.image!=null||H?.pinImage!=null||H?.src!=null)?Cs({className:"g-ui-timeline-pin-image",src:H.image??H.pinImage??H.src,alt:H.pinImageAlt??""}):ee==="custom"&&H?.pinContent!=null?H.pinContent:null}),M=se(D,R).compute(([E,H])=>{let ee=E??"default";return ee==="icon"?H?.icon!=null||H?.pinIcon!=null:ee==="image"?H?.image!=null||H?.pinImage!=null||H?.src!=null:ee==="custom"?H?.pinContent!=null:!1}),Y=Ne({className:"g-ui-timeline-dot"},Ne({className:"g-ui-timeline-dot-inner"}),Li(M,()=>j)),T=Ne({className:"g-ui-timeline-content"},Li(R.title,()=>Ne({className:"g-ui-timeline-title"},R.title)),Li(R.description,()=>Ne({className:"g-ui-timeline-desc"},R.description)),R.content);return Ne({className:s("g-ui-timeline-item",ie),style:se(C).compute(E=>E?{"--g-ui-timeline-active-color":E}:void 0),onClick:K,role:K?"button":void 0,tabIndex:K?0:void 0},Ne({className:"g-ui-dot-wrapper"},Y),T)}))}import{Div as $i,list as Bs}from"@granularjs/core";function js(...e){let{props:i}=g(e,{active:0,items:[]}),{active:t,items:r,className:a,...o}=i;return $i({...o,className:s("g-ui-stepper",a)},Bs(r,(n,u)=>$i({className:s("g-ui-stepper-item",[t,l=>u.get()===l?"g-ui-stepper-active":""])},$i({className:"g-ui-stepper-index"},String(u+1)),$i({className:"g-ui-stepper-label"},n.label))))}import{Span as Vr,after as Lr,state as Es}from"@granularjs/core";function Rs(...e){let{props:i,rawProps:t}=g(e,{value:0,max:5,size:"md"}),{value:r,max:a,size:o,className:n,...u}=i,{onChange:l}=t,c=Es(h(r));Lr(r).change(p=>{let x=h(p);x!=null&&c.set(x)});let f=p=>{c.set(p),l?.(p)},w=[],y=Number(h(a))||0;for(let p=1;p<=y;p+=1)w.push(p);return Vr({...u,className:s("g-ui-rating",z("g-ui-rating-size-",o,"md"),i.className??n)},w.map(p=>Vr({className:s("g-ui-rating-item",Lr(c).compute(x=>p<=x?"g-ui-rating-item-active":"")),onClick:()=>f(p)},"\u2605")))}import{Span as Hs}from"@granularjs/core";function Os(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Hs({...a,className:s("g-ui-tag",r)},t)}import{Button as Ir,Div as Je,state as $r,after as Ai}from"@granularjs/core";var Ws=["S","M","T","W","T","F","S"];function pi(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{value:r,className:a,size:o,...n}=i,{onChange:u}=t,l=S=>{let k=h(S);if(k instanceof Date)return k;if(k==null)return null;let N=new Date(k);return Number.isNaN(N.getTime())?null:N},c=$r(l(r)??new Date),f=$r(new Date(c.get()));Ai(r).change(S=>{let k=l(S);k!=null&&(c.set(k),f.set(new Date(k)))});let w=(S,k,N)=>{let C=new Date(S,k+1,0).getDate();return new Date(S,k,Math.min(N,C))},y=S=>{let k=f.get(),N=w(k.getFullYear(),k.getMonth(),S);c.set(N),f.set(N),u?.(N)},p=S=>{let k=f.get(),N=w(k.getFullYear(),k.getMonth()+S,k.getDate());f.set(N)},x=S=>{let k=f.get(),N=w(k.getFullYear()+S,k.getMonth(),k.getDate());f.set(N)},v=Ai(f).compute(S=>S.toLocaleString("default",{month:"long"})),P=Ai(f).compute(S=>String(S.getFullYear())),L=Ai(f,c).compute(([S,k])=>{let N=S.getFullYear(),C=S.getMonth(),d=new Date(N,C,1).getDay(),I=new Date(N,C+1,0).getDate(),V=[];for(let A=0;A<d;A+=1)V.push({muted:!0,label:""});for(let A=1;A<=I;A+=1)V.push({label:A});return[...Ws.map(A=>Je({className:"g-ui-calendar-cell g-ui-calendar-cell-muted"},A)),...V.map(A=>Je({className:s("g-ui-calendar-cell",A.muted&&"g-ui-calendar-cell-muted",A.label&&k.getFullYear()===N&&k.getMonth()===C&&A.label===k.getDate()&&"g-ui-calendar-cell-active"),onClick:()=>A.label&&y(A.label)},A.label))]});return Je({...n,className:s("g-ui-calendar",a,z("g-ui-calendar-size-",o,"md"))},Je({className:"g-ui-calendar-header"},Ge({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>p(-1)},ye({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:ki})),Je({className:"g-ui-calendar-title-group"},Ir({type:"button",className:"g-ui-calendar-title-button",onClick:()=>p(1)},v),Ir({type:"button",className:"g-ui-calendar-title-button",onClick:()=>x(1)},P)),Ge({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>p(1)},ye({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:yi}))),Je({className:"g-ui-calendar-grid"},L))}import{Div as di,Span as ei,Input as qs,when as Dt,after as De,state as Fi}from"@granularjs/core";function Ys(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"md",searchable:!0}),{value:r,data:a,size:o,className:n,placeholder:u,searchable:l,...c}=i,{onChange:f,onSearchChange:w}=t,y=Fi(h(r)??[]),p=Fi(""),x=Fi(!1),v=Fi(null),P=d=>(h(d)??[]).map(V=>typeof V=="string"?{value:V,label:V}:V&&typeof V=="object"?V:{value:String(V),label:String(V)});De(r).change(d=>{let I=h(d);I!=null&&y.set(I)});let L=null;De(x).change(d=>{if(L&&(L(),L=null),!d)return;let I=V=>{let A=v.get();A&&(A.contains(V.target)||x.set(!1))};document.addEventListener("mousedown",I),L=()=>document.removeEventListener("mousedown",I)}),De(p).change(d=>{w?.(d)});let S=d=>{let I=y.get()??[],V=I.includes(d)?I.filter(A=>A!==d):I.concat(d);y.set(V),f?.(V)},k=De(a).compute(d=>P(d)),N=De(k,p).compute(([d,I])=>{let V=String(h(I)??"").toLowerCase().trim();return V?d.filter(A=>String(A.label??"").toLowerCase().includes(V)):d}),C=De(y,p).compute(([d,I])=>{let V=h(d)??[],A=String(h(I)??"");return!V.length&&!A}),m=De(l).compute(d=>!!d);return di({...c,node:v,className:s("g-ui-select-multi-root",n)},di({className:s("g-ui-select-multi",z("g-ui-select-multi-size-",o,"md")),onClick:()=>x.set(!0)},De(k,y).compute(([d,I])=>(h(I)??[]).map(A=>{let oe=(d??[]).find(re=>re.value===A)?.label??A;return ei({className:"g-ui-select-tag"},ei({className:"g-ui-select-tag-label",onClick:re=>{re?.stopPropagation?.()}},oe),ei({className:"g-ui-select-tag-remove",innerHTML:je,onClick:re=>{re?.stopPropagation?.(),S(A)}}))})),Dt(C,()=>ei({className:"g-ui-select-multi-placeholder"},u??"Select...")),Dt(m,()=>qs({className:"g-ui-select-multi-input",value:p,onInput:d=>p.set(d.target?.value??""),onFocus:()=>x.set(!0)}))),Dt(x,()=>di({className:"g-ui-select-dropdown"},De(N).compute(d=>d.length?d.map(I=>di({className:s("g-ui-select-item",I.disabled&&"g-ui-select-item-disabled",De(y).compute(V=>(h(V)??[]).includes(I.value)?"g-ui-select-item-active":"")),onClick:()=>{I.disabled||S(I.value)}},ei({className:"g-ui-select-item-check",innerHTML:De(y).compute(V=>(h(V)??[]).includes(I.value)?zi:"")}),ei({className:"g-ui-select-item-label"},I.label))):di({className:"g-ui-select-item"},"Nothing found")))))}import{Div as Zs,list as Us,portal as Xs}from"@granularjs/core";import{Div as Pt,Button as Gs,when as Ar,state as _s}from"@granularjs/core";function Mt(...e){let{props:i,rawProps:t,children:r}=g(e),{title:a,className:o,...n}=i,{onClose:u}=t,l=_s(!0),c=()=>{l.set(!1),u?.()};return Ar(l,()=>Pt({...n,className:s("g-ui-toast",o)},Pt({className:"g-ui-toast-row"},Ar(a,()=>Pt({className:"g-ui-toast-title"},a)),Gs({className:"g-ui-toast-close",onClick:c},ye({innerHTML:je}))),r))}function Ks(...e){let{props:i,rawProps:t}=g(e,{items:[]}),{items:r,className:a,timeout:o,...n}=i,{onClose:u}=t;return Xs(Zs({...n,className:s("g-ui-toast-stack",a)},Us(r,l=>Mt({title:l.title,onClose:()=>u?.(l)},l.message))))}function Qs(...e){let{props:i}=g(e);return pi(i)}import{Div as Js,after as eu}from"@granularjs/core";function iu(...e){let{props:i,rawProps:t}=g(e,{items:[],position:"top-right"}),{items:r,position:a,className:o,...n}=i,{onRemove:u}=t,l=new Map,c=(w,y)=>w?.id??w?.key??y,f=eu(r).compute(w=>{let y=h(w)??[],p=new Set;y.forEach((x,v)=>{let P=c(x,v);if(p.add(P),x?.autoClose&&!l.has(P)){let L=setTimeout(()=>{l.delete(P),u?.(x)},x.autoClose);l.set(P,L)}});for(let[x,v]of l.entries())p.has(x)||(clearTimeout(v),l.delete(x));return y.map((x,v)=>pt({key:c(x,v),title:x.title,color:x.color,icon:x.icon,loading:x.loading,withCloseButton:x.withCloseButton,withBorder:x.withBorder,onClose:()=>{x.onClose?.(),u?.(x)}},x.message??x.body??x.content??x.text))});return Js({...n,className:s("g-ui-notifications",z("g-ui-notifications-position-",a,"top-right"),o)},f)}import{Div as _e,after as ii,state as tu,when as Fr,list as ru}from"@granularjs/core";function au(...e){let{props:i,rawProps:t}=g(e,{min:0,max:100,step:1,size:"md"}),{value:r,marks:a,min:o,max:n,step:u,size:l,disabled:c,className:f,...w}=i,{onChange:y}=t,p=tu(h(r??[o,n])),x=ii(a).compute(m=>m&&m.length>0),v=()=>{let m=Number(h(o)),d=Number(h(n));return!Number.isFinite(m)||!Number.isFinite(d)?{minValue:0,maxValue:100}:{minValue:Math.min(m,d),maxValue:Math.max(m,d)}},P=()=>{let m=Number(h(u));return Number.isFinite(m)&&m>0?m:1},L=m=>{let{minValue:d,maxValue:I}=v(),V=P(),A=[d,I];Array.isArray(m)&&(A=m);let J=Math.max(d,Math.min(I,Number(A[0]))),oe=Math.max(d,Math.min(I,Number(A[1]))),re=Math.round(Math.min(J,oe)/V)*V,R=Math.round(Math.max(J,oe)/V)*V;return[re,R]};ii(r).change(m=>{m!=null&&p.set(L(m))});let S=m=>{let d=L(m);d?.[0]===p.get()?.[0]&&d?.[1]===p.get()?.[1]||(p.set(d),y?.(d))},k=ii(p).compute(m=>{let{minValue:d,maxValue:I}=v(),V=I-d,[A,J]=L(m);if(V<=0)return{lowPct:0,highPct:0};let oe=(A-d)/V*100,re=(J-d)/V*100;return{lowPct:Math.max(0,Math.min(100,oe)),highPct:Math.max(0,Math.min(100,re))}}),N=(m,d,I)=>{let V=d?.();if(!V||V.width===0)return;let J=Math.min(Math.max(m.clientX-V.left,0),V.width)/V.width,{minValue:oe,maxValue:re}=v(),R=oe+J*(re-oe),G=p;typeof p.get=="function"&&(G=p.get());let[U,ie]=L(G);S(I==="low"?[R,ie]:[U,R])},C=(m,d,I)=>{if(ze(c))return;m.preventDefault?.();let V=I||m.currentTarget,A=()=>V.getBoundingClientRect(),J=A(),oe=k;typeof k.get=="function"&&(oe=k.get());let{lowPct:re,highPct:R}=oe,G=(m.clientX-J.left)/J.width*100,U=d;if(!U){let D=Math.abs(G-re)<=Math.abs(G-R);U="high",D&&(U="low")}V.setPointerCapture?.(m.pointerId),N(m,A,U);let ie=D=>N(D,A,U),K=()=>{V.releasePointerCapture?.(m.pointerId),window.removeEventListener("pointermove",ie),window.removeEventListener("pointerup",K)};window.addEventListener("pointermove",ie),window.addEventListener("pointerup",K)};return _e({...w,className:s("g-ui-range-slider",z("g-ui-slider-size-",l,"md"),_("g-ui-slider-disabled",c),i.className??f)},_e({className:"g-ui-slider-track",onPointerDown:m=>C(m)},_e({className:"g-ui-slider-bar",style:ii(k).compute(({lowPct:m,highPct:d})=>({left:`${m}%`,width:`${Math.max(0,d-m)}%`}))}),_e({className:"g-ui-slider-thumb",style:ii(k).compute(({lowPct:m})=>({left:`${m}%`})),onPointerDown:m=>{m.stopPropagation?.(),C(m,"low",m.currentTarget.parentElement)}}),_e({className:"g-ui-slider-thumb",style:ii(k).compute(({highPct:m})=>({left:`${m}%`})),onPointerDown:m=>{m.stopPropagation?.(),C(m,"high",m.currentTarget.parentElement)}})),Fr(x,()=>_e({className:"g-ui-slider-marks-placeholder"})),Fr(a,()=>_e({className:"g-ui-slider-marks"},ru(a,m=>bt({mark:m,getBounds:v})))))}import{state as Tt,after as Br}from"@granularjs/core";function Bi(...e){let{props:i,rawProps:t}=g(e,{size:"md",format:{pattern:"dddd-dd-dd"}}),{value:r,size:a,calendarSize:o,leftSection:n,rightSection:u,className:l,format:c,minDate:f,maxDate:w,...y}=i,{onChange:p}=t,x=m=>{let d=h(m);if(d instanceof Date)return d;if(d==null||d==="")return null;let I=new Date(d);return Number.isNaN(I.getTime())?null:I},v=(m,d)=>m&&d&&m.getFullYear()===d.getFullYear()&&m.getMonth()===d.getMonth()&&m.getDate()===d.getDate(),P=m=>{if(!m)return"";let d=String(m.getFullYear()).padStart(4,"0"),I=String(m.getMonth()+1).padStart(2,"0"),V=String(m.getDate()).padStart(2,"0");return`${d}-${I}-${V}`},L=m=>{let d=String(m??"").replace(/\D/g,"");if(d.length<8)return null;let I=Number(d.slice(0,4)),V=Number(d.slice(4,6)),A=Number(d.slice(6,8));if(!I||!V||!A)return null;let J=new Date(I,V-1,A);if(J.getFullYear()!==I||J.getMonth()!==V-1||J.getDate()!==A)return null;let oe=x(f);if(oe&&J<oe)return null;let re=x(w);return re&&J>re?null:J},S=Tt(x(r)),k=Tt(P(S.get())),N=Tt(!1);Br(r).change(m=>{let d=x(m);if(!v(d,S.get())){if(d==null){S.set(null),k.set("");return}S.set(d),k.set(P(d))}}),Br(k).change(m=>{let d=L(m);d&&(v(d,S.get())||(S.set(d),p?.(d)))});let C=m=>{m&&(v(m,S.get())||(S.set(m),k.set(P(m)),p?.(m),N.set(!1)))};return Ct({opened:N,onChange:m=>N.set(!!m),content:pi({size:z("",o,"xs"),value:S,onChange:C}),className:"g-ui-date-input-popover"},be({...y,size:a,className:s("g-ui-dateinput",l),leftSection:n,rightSection:u,type:"text",inputMode:"numeric",format:c,value:k,onChange:m=>k.set(m)}))}import{Div as Vt,when as ou,after as nu,state as su}from"@granularjs/core";function uu(...e){let{props:i,rawProps:t,children:r}=g(e),{opened:a,content:o,className:n,...u}=i,{onChange:l}=t,c=su(h(a)??!1);nu(a).change(w=>{let y=h(w);y!=null&&c.set(!!y)});let f=w=>{c.set(w),l?.(w)};return Vt({...u,className:s("g-ui-popper",n)},Vt({onClick:()=>f(!c.get())},r),ou(c,()=>Vt({className:"g-ui-popper-dropdown"},o)))}import{Button as gu,after as jr,when as lu,state as cu}from"@granularjs/core";function pu(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{size:r,className:a,rightSection:o,...n}=i,{onChange:u}=t,l=cu(!1),c=jr(l).compute(w=>w?"text":"password"),f=jr(o).compute(w=>w??gu({className:"g-ui-password-toggle",onClick:()=>l.set(!l.get())},lu(l,()=>"Hide",()=>"Show")));return be({...n,size:r,className:a,onChange:u,rightSection:f,type:c})}import{Div as du}from"@granularjs/core";function mu(...e){let{props:i}=g(e,{size:"md"}),{size:t,className:r,...a}=i;return be({...a,size:t,className:r,leftSection:du({className:"g-ui-search-input-left-section",innerHTML:Jt}),type:"text",inputMode:"search"})}import{Button as fu,after as hu,when as Er}from"@granularjs/core";import{state as vu}from"@granularjs/core";function bu(...e){let{props:i,children:t}=g(e,{value:"",timeout:1500}),{value:r,timeout:a,className:o,...n}=i,u=vu(!1),l=hu(u).compute(f=>s("g-ui-copy-button",f&&"g-ui-copy-button-done",o));return fu({...n,className:l,onClick:async()=>{try{await navigator.clipboard.writeText(String(r)),u.set(!0),setTimeout(()=>u.set(!1),a)}catch{}},type:"button"},Er(t?.length,()=>t,()=>Er(u,()=>"Copied",()=>"Copy")))}import{Div as Rr,after as ti,resolve as xu}from"@granularjs/core";function Hr(e){let i=Number(e);return Number.isNaN(i)?0:Math.max(0,Math.min(100,i))}function wu(...e){let{props:i}=g(e,{size:"md",value:null,color:"primary"}),{size:t,value:r,color:a,className:o,style:n,inset:u,...l}=i,c=ti(r).compute(v=>v!=null&&v!==""),f=ti(r).compute(v=>Hr(v)),w=ti(f,c,n,t).compute(([v,P,L,S])=>{let k={...L};if(isFinite(S)&&(k.width=S+"px",k.height=S+"px"),!P)return k;let N=Number(v),C=Number.isNaN(N)?0:Math.max(0,Math.min(360,N*3.6));return k.background=`conic-gradient(var(--g-ui-progress-ring-fill, var(--g-ui-primary)) 0deg ${C}deg, var(--g-ui-border-muted) ${C}deg 360deg)`,k}),y=ti(u).compute(v=>{let P={};return isFinite(v)&&(P.inset=v+"px"),P}),p=ti(c).compute(v=>v?"":"g-ui-progress-ring-indeterminate"),x=ti(c,r).compute(([v,P])=>v?Hr(P):void 0);return Rr({...l,className:s("g-ui-progress-ring",z("g-ui-progress-ring-",a,"primary"),[t,v=>`g-ui-progress-ring-size-${xu(v)??"md"}`],p,o),style:w,role:"progressbar","aria-valuemin":0,"aria-valuemax":100,"aria-valuenow":x},Rr({className:"g-ui-progress-ring-hole",style:y}))}import{Div as ji,state as It,after as Ze,list as ku,when as zu}from"@granularjs/core";import{Div as yu}from"@granularjs/core";function Lt(...e){let{props:i,children:t}=g(e,{size:"md"}),{size:r,className:a,...o}=i;return yu({...o,className:s("g-ui-scroll-area",[r,n=>`g-ui-scroll-area-${n}`],a)},t)}function $e(e,i){if(i==null||i==="")return e;let t=String(i).trim().split("."),r=e;for(let a of t)r=r?.[a];return r}function Nu(e,i,t){let r=t(i);return String(r??"").toLowerCase().includes(String(e??"").toLowerCase())}function $t(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"md",valuePath:"value",labelPath:"label"}),{data:r,value:a,size:o,valuePath:n,labelPath:u,filter:l,placeholder:c,label:f,description:w,error:y,leftSection:p,rightSection:x,className:v,inputClassName:P,disabled:L,...S}=i,{onChange:k,renderItem:N}=t,C=It(!1),m=It(""),d=It(h(a));Ze(a).change(M=>{let Y=h(M);Y!==d.get()&&d.set(Y)});let I=Ze(r).compute(M=>Array.isArray(M)?M:[]),V=Ze(I,d,n).compute(([M,Y,T])=>{if(Y==null)return null;let E=H=>T==null||T===""?H:$e(H,T);return M.find(H=>E(H)===Y)??null}),A=Ze(V,C,m,u).compute(([M,Y,T,E])=>{let H=ee=>E==null||E===""?String(ee??""):String($e(ee,E)??"");return Y?T??"":M?H(M):""}),J=Ze(I,m,l,u).compute(([M,Y,T,E])=>{let H=pe=>E==null||E===""?String(pe??""):String($e(pe,E)??""),ee=h(T)??Nu;return M.filter(pe=>ee(Y,pe,H))}),oe=M=>{let Y=h(n),T=Y==null||Y===""?M:$e(M,Y);d.set(T),m.set(""),C.set(!1),k?.(T)},re=()=>{if(h(L))return;C.set(!0);let M=V.get(),Y=h(u),T=E=>Y==null||Y===""?String(E??""):String($e(E,Y)??"");m.set(M?T(M):"")},R=()=>{C.set(!1);let M=V.get(),Y=h(u),T=E=>Y==null||Y===""?String(E??""):String($e(E,Y)??"");m.set(M?T(M):"")},{onChange:G,...U}=S,ie={...U,size:o,label:f,description:w,error:y,leftSection:p,rightSection:x,placeholder:h(c)??void 0,disabled:L,value:A,onInput:M=>m.set(M?.target?.value??""),onFocus:re,onClick:re,onBlur:()=>setTimeout(()=>R(),150)},K=M=>{let Y=h(n);return Y==null||Y===""?M:$e(M,Y)},D=M=>Ze(d,n).compute(([Y,T])=>(H=>T==null||T===""?H:$e(H,T))(M)===Y?"g-ui-autocomplete-item-active":""),j=M=>{if(N&&typeof N=="function"){let Y=N(M);if(Y!=null)return ji({className:s("g-ui-autocomplete-item",D(M)),onClick:()=>oe(M),role:"option"},Y)}return ji({className:s("g-ui-autocomplete-item",D(M)),onClick:()=>oe(M),role:"option"},Ze(u).compute(Y=>Y==null||Y===""?String(M??""):String($e(M,Y)??"")))};return ji({className:s("g-ui-autocomplete",v,_("g-ui-autocomplete-disabled",L))},be({...ie,className:s("g-ui-autocomplete-input-wrapper",ie.className),inputClassName:s("g-ui-autocomplete-input",P)}),zu(C,()=>ji({className:"g-ui-autocomplete-dropdown",role:"listbox"},Lt({className:"g-ui-autocomplete-list",style:{maxHeight:"240px"}},ku(J,M=>j(M))))))}function Cu(...e){return $t(...e)}import{Div as Su,Span as Du,state as Or,after as Pu}from"@granularjs/core";function Wr(e){let i=h(e);if(i instanceof Date)return i;if(i==null||i==="")return null;let t=new Date(i);return Number.isNaN(t.getTime())?null:t}function qr(e){let i=h(e);if(i==null)return[null,null];let t=Array.isArray(i)?i:[i];return[Wr(t[0]),Wr(t[1])]}function Yr(e,i){return!e||!i?e===i:e.getFullYear()===i.getFullYear()&&e.getMonth()===i.getMonth()&&e.getDate()===i.getDate()}function Mu(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{value:r,size:a,minDate:o,maxDate:n,className:u,placeholderMin:l,placeholderMax:c,...f}=i,{onChange:w}=t,[y,p]=qr(r),x=Or(y),v=Or(p);Pu(r).change(k=>{let[N,C]=qr(k);Yr(N,x.get())&&Yr(C,v.get())||(x.set(N),v.set(C))});let P=()=>{let k=x.get(),N=v.get();w?.([k??null,N??null])},L=k=>{let N=v.get();k&&N&&k>N&&v.set(k),x.set(k),P()},S=k=>{let N=x.get();k&&N&&k<N&&x.set(k),v.set(k),P()};return Su({...f,className:s("g-ui-range-picker",i.className??u)},Bi({...f,size:a,value:x,onChange:L,maxDate:v,placeholder:h(l)??void 0}),Du({className:"g-ui-range-picker-separator"},"\u2013"),Bi({...f,size:a,value:v,onChange:S,minDate:x,placeholder:h(c)??void 0}))}import{Div as Tu}from"@granularjs/core";function Vu(...e){let{props:i,children:t}=g(e,{align:"center",direction:"row"}),{direction:r,wrap:a,align:o,justify:n,gap:u,className:l,...c}=i;return Tu({...c,className:s("g-ui-flex",[r,f=>f==="column"?"g-ui-flex-column":"g-ui-flex-row"],[a,"g-ui-flex-wrap"],[o,f=>f&&`g-ui-align-${f}`],[n,f=>f&&`g-ui-justify-${f}`],[u,f=>f&&`g-ui-gap-${f}`],l)},t)}import{A as Lu,Div as mi,Span as Gr,when as fi,after as _r,state as Iu}from"@granularjs/core";function $u(...e){let{props:i,rawProps:t,children:r}=g(e,{variant:"subtle",childrenOffset:24}),{label:a,description:o,leftSection:n,rightSection:u,active:l,disabled:c,variant:f,childrenOffset:w,opened:y,defaultOpened:p,className:x,padding:v,...P}=i,{onClick:L,onChange:S}=t,k=r.length>0,N=Iu(h(y)??h(p)??!1);_r(y).change(d=>{let I=h(d);I!=null&&N.set(!!I)});let C=_r(n).compute(d=>Oe(d)?d?.get?d.get():null:d),m=d=>{if(h(c)){d?.preventDefault?.();return}if(k){let I=!N.get();N.set(I),S?.(I)}L?.(d)};return mi({className:s("g-ui-navlink-root",x)},Lu({...P,className:s("g-ui-navlink",z("g-ui-navlink-variant-",f,"subtle"),_("g-ui-navlink-active",l),_("g-ui-navlink-disabled",c),z("g-ui-navlink-padding-",v,"md")),onClick:m},fi(C,()=>Gr({className:"g-ui-navlink-section g-ui-navlink-left"},n)),mi({className:"g-ui-navlink-body"},fi(a,()=>mi({className:"g-ui-navlink-label"},a)),fi(o,()=>mi({className:"g-ui-navlink-description"},o))),fi(u,()=>Gr({className:"g-ui-navlink-section g-ui-navlink-right"},u))),k&&fi(N,()=>mi({className:"g-ui-navlink-children"},r)))}import{Div as Zr,when as Au}from"@granularjs/core";function Fu(...e){let{props:i,children:t}=g(e,{show:!0,position:"top-right",color:"danger",size:"md"}),{show:r,position:a,color:o,size:n,className:u,...l}=i;return Zr({...l,className:s("g-ui-indicator",z("g-ui-indicator-position-",a,"top-right"),z("g-ui-indicator-color-",o,"danger"),z("g-ui-indicator-size-",n,"md"),u)},t,Au(r,()=>Zr({className:"g-ui-indicator-badge"})))}import{Span as Ei}from"@granularjs/core";function Bu(...e){let{props:i}=g(e),{opened:t,className:r,...a}=i;return Ei({...a,className:s("g-ui-burger",[t,"g-ui-burger-open"],r)},Ei(""),Ei(""),Ei(""))}import{Div as ju,when as Eu}from"@granularjs/core";function At(...e){let{props:i}=g(e,{variant:"spinner",size:"md"}),{visible:t,variant:r,size:a,...o}=i;return Eu(t,()=>ju({...o,className:"g-ui-loading-overlay"},ui({variant:r,size:a})))}import{Div as Ru}from"@granularjs/core";function Hu(...e){let{props:i,children:t}=g(e,{gap:"md"}),{className:r,gap:a,...o}=i;return Ru({...o,className:s("g-ui-grid-system",[a,n=>`g-ui-gap-${n}`],r)},t)}import{Div as Ou}from"@granularjs/core";function Wu(...e){let{props:i,children:t}=g(e,{span:12}),{span:r,className:a,...o}=i;return Ou({...o,className:s([r,n=>`g-ui-col-span-${n}`],a)},t)}import{Div as Ur,Input as qu,after as Ae,state as Ft,when as Xr,list as Yu}from"@granularjs/core";function Gu(...e){let{props:i,rawProps:t}=g(e,{length:4,size:"md",type:"alphanumeric",mask:!1,placeholder:"\u25CB",disabled:!1,error:!1,oneTimeCode:!1}),{length:r,value:a,size:o,type:n,mask:u,placeholder:l,disabled:c,error:f,oneTimeCode:w,className:y}=i,{onChange:p,onComplete:x}=t,v=Ft(h(r)??4),P=()=>v.get();Ae(r).change(D=>{let j=h(D)??4,M=v.get();if(j===M)return;v.set(j);let Y=S.get(),T=L.get();S.set(Array.from({length:j},(E,H)=>Y[H]??"")),L.set(Array.from({length:j},(E,H)=>T[H]??null))});let L=Ft(Array.from({length:P()},()=>null)),S=Ft(Array.from({length:P()},(D,j)=>{let M=h(a);return typeof M=="string"||Array.isArray(M)?M[j]??"":""}));Ae(a).change(D=>{if(D==null)return;let j=P();typeof D=="string"?S.set(Array.from({length:j},(M,Y)=>D[Y]??"")):Array.isArray(D)&&S.set(Array.from({length:j},(M,Y)=>D[Y]??""))});let k=()=>S.get().join(""),N=D=>{S.set(D);let j=D.join("");p?.(j),D.every(M=>M!=="")&&D.length===P()&&x?.(j)},C=D=>{let j=P(),M=L.get();D>=0&&D<j&&M[D]&&(M[D].focus(),M[D].select())},m=()=>{let D=h(n);return D==="number"?/^[0-9]$/:D instanceof RegExp?D:/^[a-zA-Z0-9]$/},d=(D,j)=>{let M=j.target.value,Y=m();if(M.length>1){I(D,M);return}if(M&&!Y.test(M)){j.target.value=S.get()[D]??"";return}let T=S.get().slice();T[D]=M,N(T),M&&D<P()-1&&C(D+1)},I=(D,j)=>{let M=m(),Y=j.split("").filter(ee=>M.test(ee)),T=S.get().slice(),E=P();Y.forEach((ee,pe)=>{let ke=D+pe;ke<E&&(T[ke]=ee)}),N(T);let H=T.findIndex((ee,pe)=>pe>=D&&ee==="");H>=0?C(H):C(Math.min(D+Y.length,E-1))},V=(D,j)=>{if(j.key==="Backspace"){let M=S.get().slice();M[D]===""&&D>0?(j.preventDefault(),M[D-1]="",N(M),C(D-1)):M[D]!==""&&(M[D]="",N(M))}else j.key==="ArrowLeft"&&D>0?(j.preventDefault(),C(D-1)):j.key==="ArrowRight"&&D<P()-1&&(j.preventDefault(),C(D+1))},A=(D,j)=>{j.target.select()},J=()=>{let D=S.get(),j=D.findIndex(M=>M==="");j>=0?C(j):C(D.length-1)},oe=Ae(u).compute(D=>h(D)?"password":"text"),re=Ae(n).compute(D=>h(D)==="number"?"numeric":"text"),R=Ae(w).compute(D=>h(D)?"one-time-code":"off"),G=Ae(c).compute(D=>!!h(D)),U=Ae(f).compute(D=>!!h(D)),ie=Ae(v).compute(D=>Array.from({length:D},(j,M)=>M)),K=D=>qu({className:s("g-ui-pin-input-field",Xr(U,()=>"g-ui-pin-input-error")),type:oe,inputMode:re,autocomplete:R,maxLength:2,placeholder:Xr(G,()=>"",()=>l),disabled:G,value:Ae(S,D).compute(([j,M])=>j[M]??""),node:L[D.get()],onInput:j=>d(D.get(),j),onChange:j=>d(D.get(),j),onKeyDown:j=>V(D.get(),j),onFocus:j=>A(D.get(),j)});return Ur({className:s("g-ui-pin-input",z("g-ui-input-size-",o,"md"),y),onClick:J},Ur({className:"g-ui-pin-input-wrapper"},Yu(ie,K)))}import{Div as _u}from"@granularjs/core";function Zu(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return _u({...a,className:s("g-ui-checkbox-group",r)},t)}import{Div as Uu}from"@granularjs/core";function Xu(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Uu({...a,className:s("g-ui-avatar-group",r)},t)}import{Div as Ku}from"@granularjs/core";function Qu(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Ku({...a,className:s("g-ui-badge-group",r)},t)}import{Div as Ri,Span as Ju,after as hi,context as Kr}from"@granularjs/core";var eg=Kr([]),Qr=Kr({sort:null,onSort:null});function Bt(...e){let{props:i,rawProps:t,children:r}=g(e,{sizes:[],sort:null,stickyHeader:!1}),{className:a,sizes:o,sort:n,stickyHeader:u,...l}=i,{onSort:c}=t,f=eg.scope(o.get());hi(o).change(y=>f.set(y));let w=Qr.scope({sort:n.get(),onSort:c||null});return hi(n).change(y=>w.set().sort=y),f.serve(w.serve(Ri({className:s("g-ui-grid-table",_("g-ui-grid-table-sticky",u),a),style:{gridTemplateColumns:hi(f).compute(y=>Array.isArray(y)?y.join(" "):"")},...l},r)))}Bt.GridRow=(...e)=>{let{props:i,children:t}=g(e,{}),{className:r,header:a,...o}=i;return Ri({className:s("g-ui-grid-table-row",_("g-ui-grid-table-row-header",a),r),...o},...t)};Bt.GridCell=function(...e){let{props:i,rawProps:t,children:r}=g(e,{}),{className:a,sort:o,...n}=i,u=t.sort;if(u){let l=Qr.state(),c=hi(l.sort).compute(w=>w?.key===u?w.direction:null),f=()=>{let w=l.get().sort,y;w?.key===u?y=w.direction==="asc"?{key:u,direction:"desc"}:null:y={key:u,direction:"asc"},l.set().sort=y;let{onSort:p}=l.get();p&&p(y)};return Ri({className:s("g-ui-grid-table-cell","g-ui-grid-table-cell-sortable",a),onClick:f,...n},r,Ju({className:"g-ui-grid-table-sort-icon"},hi(c).compute(w=>w==="asc"?" \u2191":w==="desc"?" \u2193":"")))}return Ri({className:s("g-ui-grid-table-cell",a),...n},r)};import{Button as ig,Div as tg,Span as Jr,when as ea}from"@granularjs/core";function ia(...e){let{props:i,children:t}=g(e,{grow:!0}),{grow:r,className:a,...o}=i;return tg({...o,className:s("g-ui-bottombar",_("g-ui-bottombar-grow",r),a)},t)}ia.Action=function(...i){let{props:t,rawProps:r,children:a}=g(i,{variant:"subtle"}),{icon:o,label:n,active:u,disabled:l,variant:c,className:f,...w}=t,{onClick:y}=r;return ig({...w,className:s("g-ui-bottombar-action",z("g-ui-bottombar-action-variant-",c,"subtle"),_("g-ui-bottombar-action-active",u),_("g-ui-bottombar-action-disabled",l),f),onClick:y,disabled:l},ea(o,()=>Jr({className:"g-ui-bottombar-action-icon"},o)),ea(n,()=>Jr({className:"g-ui-bottombar-action-label"},n)),a)};import{Div as W,Button as Ue,state as me,after as Ce,when as fe,Input as Hi,Label as vi,Span as Xe}from"@granularjs/core";var rg=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],ag=[{value:"day",label:"Day"},{value:"week",label:"Week"},{value:"month",label:"Month"}];function Oi(e){if(e instanceof Date)return e;if(e==null)return null;let i=new Date(e);return Number.isNaN(i.getTime())?null:i}function aa(e){let i=Oi(e.start),t=Oi(e.end);return!i||!t?null:{...e,id:e.id??`${i.getTime()}-${e.title??"event"}`,title:e.title??"",start:i,end:t,allDay:!!e.allDay,description:e.description??"",location:e.location??"",attendees:Array.isArray(e.attendees)?e.attendees:[],color:e.color??null}}function oa(e,i,t){let r=Oi(i).getTime(),a=Oi(t).getTime();return e.map(aa).filter(Boolean).filter(o=>o.end.getTime()>r&&o.start.getTime()<a)}function ta(e,i){let t=new Date(i);t.setHours(0,0,0,0);let r=t.getTime();t.setHours(23,59,59,999);let a=t.getTime();return oa(e,r,a)}function jt(e,i){let t=new Date(e),a=(t.getDay()-i+7)%7;return t.setDate(t.getDate()-a),t.setHours(0,0,0,0),t}function ri(e,i="default"){return e.toLocaleTimeString(i,{hour:"numeric",minute:"2-digit",hour12:!0})}function bi(e,i="default"){return e.toLocaleDateString(i,{weekday:"short",month:"short",day:"numeric"})}function og(e,i="default"){return e.toLocaleDateString(i,{month:"long",year:"numeric"})}function ng(e,i="default"){let t=new Date(e);return t.setDate(t.getDate()+6),`${e.toLocaleDateString(i,{month:"short",day:"numeric"})} \u2013 ${t.toLocaleDateString(i,{month:"short",day:"numeric",year:"numeric"})}`}function ra(e,i,t,r){let a=new Date(e).setHours(t,0,0,0),o=new Date(e).setHours(r,0,0,0),n=(r-t)*60,u=Math.max(e.getTime(),a),c=(Math.min(i.getTime(),o)-u)/6e4,f=(u-a)/6e4/n*100,w=c/n*100;return{top:f,height:w}}function sg(...e){let{props:i,rawProps:t}=g(e,{defaultView:"month",firstDayOfWeek:0,locale:"default",hourSlotDuration:30,minTime:6,maxTime:22,eventCreationColorOptions:[]}),{events:r=[],defaultView:a,firstDayOfWeek:o,locale:n,hourSlotDuration:u,minTime:l,maxTime:c,eventCreationColorOptions:f,className:w,...y}=i,{onCreateEventRequest:p,onViewEventRequest:x,onUpdateEventRequest:v,onRemoveEventRequest:P,eventCreationEmailLookup:L,eventCreationLocationsCallback:S,eventCreationCalendarsCallback:k,onSlotClick:N,onDateRangeChange:C}=t,m=me(h(a)??"month"),d=me(new Date),I=me(null),V=me(null),A=me({title:"",start:null,end:null,allDay:!1,description:"",location:"",attendees:[],color:null}),J=Ce(r).compute(b=>Array.isArray(b)?b:[]),oe=d.get(),re=jt(oe,h(o)??0),R=h(l)??6,G=h(c)??22,U=h(u)??30,ie=()=>{let b=new Date(d.get());m.get()==="month"?b.setMonth(b.getMonth()-1):m.get()==="week"?b.setDate(b.getDate()-7):b.setDate(b.getDate()-1),d.set(b),C?.({start:b,end:b,view:m.get()})},K=()=>{let b=new Date(d.get());m.get()==="month"?b.setMonth(b.getMonth()+1):m.get()==="week"?b.setDate(b.getDate()+7):b.setDate(b.getDate()+1),d.set(b),C?.({start:b,end:b,view:m.get()})},D=()=>{let b=new Date;d.set(b),C?.({start:b,end:b,view:m.get()})},j=(b,O,ce=!1)=>{let X=b?new Date(b):new Date(d.get()),ge=O?new Date(O):new Date(X.getTime()+3600*1e3);ce&&(X.setHours(0,0,0,0),ge.setHours(23,59,59,999)),A.set({title:"",start:X,end:ge,allDay:ce,description:"",location:"",attendees:[],color:null}),I.set("create")},M=b=>{V.set(aa(b)),I.set("view"),x?.(b)},Y=()=>{let b=V.get();b&&(A.set({title:b.title,start:new Date(b.start),end:new Date(b.end),allDay:b.allDay,description:b.description??"",location:b.location??"",attendees:[...b.attendees||[]],color:b.color??null}),I.set("edit"))},T=()=>{I.set(null),V.set(null)},E=(b,O,ce)=>{if(N){N({date:b,hour:O,allDay:ce});return}let X=new Date(b);if(ce){X.setHours(0,0,0,0);let ge=new Date(X);ge.setHours(23,59,59,999),j(X,ge,!0)}else{X.setHours(O,0,0,0);let ge=new Date(X.getTime()+U*60*1e3);j(X,ge,!1)}},H=()=>{let b=A.get();!b.start||!b.end||p?.({title:b.title,start:b.start,end:b.end,allDay:b.allDay,description:b.description,location:b.location,attendees:b.attendees,color:b.color},()=>{T()})},ee=()=>{let b=V.get(),O=A.get();!b||!O.start||!O.end||v?.(b,{title:O.title,start:O.start,end:O.end,allDay:O.allDay,description:O.description,location:O.location,attendees:O.attendees,color:O.color},()=>T())},pe=()=>{let b=V.get();b&&P?.(b,()=>T())},ke=Ce(m,d).compute(([b,O])=>b==="month"?og(O,h(n)):b==="week"?ng(jt(O,h(o)??0),h(n)):bi(O,h(n))),Pe=W({className:"g-ui-event-calendar-header"},W({className:"g-ui-event-calendar-nav-group"},Ge({size:"sm",variant:"subtle",onClick:ie,className:"g-ui-event-calendar-nav"},ye({size:"sm",innerHTML:ki})),Ge({size:"sm",variant:"subtle",onClick:K,className:"g-ui-event-calendar-nav"},ye({size:"sm",innerHTML:yi})),Ue({type:"button",variant:"subtle",size:"sm",className:"g-ui-event-calendar-today",onClick:D},ye({size:"sm",className:"g-ui-event-calendar-today-icon",innerHTML:rr}),"Today")),W({className:"g-ui-event-calendar-title"},ke),W({className:"g-ui-event-calendar-actions"},ag.map(b=>W({className:s("g-ui-event-calendar-view-option",Ce(m).compute(O=>O===b.value?"g-ui-event-calendar-view-option-active":"")),onClick:()=>{m.set(b.value),C?.({start:d.get(),end:d.get(),view:b.value})}},b.label)),Ue({type:"button",variant:"filled",size:"sm",className:"g-ui-event-calendar-create-btn",onClick:()=>j(d.get(),null,!1)},ye({size:"sm",innerHTML:er}),"Create"))),Fe=Ce(d,J,o).compute(([b,O,ce])=>{let X=b.getFullYear(),ge=b.getMonth(),ue=(new Date(X,ge,1).getDay()-(ce??0)+7)%7,Te=new Date(X,ge+1,0).getDate(),Le=new Date(X,ge,0).getDate(),F=[],$=1,q=1,Z=Math.ceil((ue+Te)/7)*7,ne=[];for(let te=0;te<Z;te+=1){let Q,ae,le;te<ue?(Q=Le-ue+te+1,le=new Date(X,ge-1,Q),ae=!1):$<=Te?(Q=$,le=new Date(X,ge,Q),ae=!0,$+=1):(Q=q,le=new Date(X,ge+1,Q),ae=!1,q+=1);let xe=ta(O,le),Be=le.getDate()===new Date().getDate()&&le.getMonth()===new Date().getMonth()&&le.getFullYear()===new Date().getFullYear();ne.push(W({key:le.getTime(),className:s("g-ui-event-calendar-month-cell",!ae&&"g-ui-event-calendar-month-cell-outside",Be&&"g-ui-event-calendar-month-cell-today")},W({className:"g-ui-event-calendar-month-cell-header",onClick:()=>E(le,0,!0)},Xe({className:"g-ui-event-calendar-month-cell-day"},le.getDate())),W({className:"g-ui-event-calendar-month-cell-events"},xe.slice(0,3).map(Se=>W({key:Se.id,className:"g-ui-event-calendar-month-event",style:Se.color?{borderLeftColor:Se.color,backgroundColor:`${Se.color}20`}:{},onClick:Gi=>{Gi.stopPropagation(),M(Se)}},Se.title||"(No title)")),fe(xe.length>3,()=>W({className:"g-ui-event-calendar-month-more",onClick:Se=>{Se.stopPropagation(),M(xe[3])}},`+${xe.length-3} more`)))))}return ne}),Ve=W({className:"g-ui-event-calendar-month"},W({className:"g-ui-event-calendar-weekdays"},rg.map(b=>W({key:b,className:"g-ui-event-calendar-weekday"},b))),W({className:"g-ui-event-calendar-month-grid"},Fe)),Me=[];for(let b=R;b<G;b+=1)for(let O=0;O<60;O+=U)Me.push(b+O/60);let ai=Ce(d,o).compute(([b,O])=>{let ce=jt(b,O??0),X=[];for(let ge=0;ge<7;ge+=1){let he=new Date(ce);he.setDate(he.getDate()+ge),X.push(he)}return X}),Wi=W({className:"g-ui-event-calendar-week"},Ce(ai).compute(b=>W({className:"g-ui-event-calendar-week-days"},W({className:"g-ui-event-calendar-week-time-col"},""),(b||[]).map(O=>W({key:O.getTime(),className:"g-ui-event-calendar-week-day-col"},W({className:"g-ui-event-calendar-week-day-header"},bi(O,h(n))))))),W({className:"g-ui-event-calendar-week-body"},W({className:"g-ui-event-calendar-week-time-col"},Me.map(b=>{let O=Math.floor(b),ce=(b-O)*60,X=`${O<=12?O:O-12}:${ce===0?"00":ce} ${O<12?"AM":"PM"}`;return W({key:b,className:"g-ui-event-calendar-week-slot-label"},X)})),Ce(ai,J).compute(([b,O])=>{if(!b||!b.length)return null;let ce=b[0],X=new Date(b[6]);X.setHours(23,59,59,999);let ge=oa(O,ce,X);return W({className:"g-ui-event-calendar-week-grid-cols"},b.map(he=>W({key:he.getTime(),className:"g-ui-event-calendar-week-day-col g-ui-event-calendar-week-day-col-body"},Me.map(ue=>W({key:ue,className:"g-ui-event-calendar-week-slot",onClick:()=>E(he,ue,!1)})),ge.filter(ue=>!ue.allDay&&ue.start.getDate()===he.getDate()&&ue.start.getMonth()===he.getMonth()&&ue.start.getFullYear()===he.getFullYear()).map(ue=>{let{top:Te,height:Le}=ra(ue.start,ue.end,R,G);return W({key:ue.id,className:"g-ui-event-calendar-week-event",style:{top:`${Te}%`,height:`${Le}%`,borderLeftColor:ue.color||"var(--g-ui-primary)"},onClick:F=>{F.stopPropagation(),M(ue)}},W({className:"g-ui-event-calendar-week-event-title"},ue.title||"(No title)"),fe(!ue.allDay,()=>Xe({className:"g-ui-event-calendar-week-event-time"},`${ri(ue.start,h(n))} \u2013 ${ri(ue.end,h(n))}`)))}))))}))),qi=W({className:"g-ui-event-calendar-day"},W({className:"g-ui-event-calendar-day-body"},W({className:"g-ui-event-calendar-day-time-col"},Me.map(b=>{let O=Math.floor(b),ce=(b-O)*60,X=`${O<=12?O:O-12}:${ce===0?"00":ce} ${O<12?"AM":"PM"}`;return W({key:b,className:"g-ui-event-calendar-day-slot-label"},X)})),W({className:"g-ui-event-calendar-day-slots"},Me.map(b=>W({key:b,className:"g-ui-event-calendar-day-slot",onClick:()=>E(d.get(),b,!1)})),Ce(J,d).compute(([b,O])=>O?ta(b,O).filter(X=>!X.allDay).map(X=>{let{top:ge,height:he}=ra(X.start,X.end,R,G);return W({key:X.id,className:"g-ui-event-calendar-day-event",style:{top:`${ge}%`,height:`${he}%`,borderLeftColor:X.color||"var(--g-ui-primary)"},onClick:ue=>{ue.stopPropagation(),M(X)}},W({className:"g-ui-event-calendar-day-event-title"},X.title||"(No title)"),Xe({className:"g-ui-event-calendar-day-event-time"},`${ri(X.start,h(n))} \u2013 ${ri(X.end,h(n))}`))}):[])))),xi=b=>{let O=A.get(),ce=new Date,X=O.start||ce,ge=O.end||new Date(ce.getTime()+3600*1e3),he=me(O.title),ue=me(X.toISOString().slice(0,10)),Te=me(!O.allDay&&X?X.toTimeString().slice(0,5):"09:00"),Le=me(ge.toISOString().slice(0,10)),F=me(!O.allDay&&ge?ge.toTimeString().slice(0,5):"10:00"),$=me(O.allDay),q=me(O.description),Z=me(O.location),ne=me(O.attendees||[]),te=me(""),Q=me([]),ae=me([]),le=me(""),xe=Array.isArray(f)?f:[],Be=me(O.color),Se=()=>{let B=new Date(ue.get()+"T"+($.get()?"00:00:00":Te.get()+":00")),we=new Date(Le.get()+"T"+($.get()?"23:59:59":F.get()+":00"));A.set({title:he.get(),start:B,end:we,allDay:$.get(),description:q.get(),location:Z.get(),attendees:ne.get(),color:Be.get()})},Gi=B=>{if(te.set(B),!L||!B.trim()){Q.set([]);return}Promise.resolve(L(B.trim())).then(we=>Q.set(Array.isArray(we)?we:[])).catch(()=>Q.set([]))},na=B=>{let we=ne.get();we.some(Rt=>(Rt.email||Rt.id)===(B.email||B.id))||(ne.set([...we,{id:B.id,email:B.email??B.label,label:B.label}]),te.set(""),Q.set([]))},sa=B=>{let we=[...ne.get()];we.splice(B,1),ne.set(we)},Et=()=>{S&&Promise.resolve(S(le.get())).then(B=>ae.set(Array.isArray(B)?B:[])).catch(()=>ae.set([]))};return W({className:"g-ui-event-calendar-form"},W({className:"g-ui-event-calendar-form-row"},be({label:"Title",placeholder:"Event title",value:he,onInput:B=>he.set(B?.target?.value??"")})),W({className:"g-ui-event-calendar-form-row g-ui-event-calendar-form-row-inline"},ot({label:"All day",checked:$,onChange:B=>$.set(B)})),W({className:"g-ui-event-calendar-form-row g-ui-event-calendar-form-row-inline"},W({className:"g-ui-event-calendar-form-field"},vi({className:"g-ui-event-calendar-form-label"},"Start"),Hi({type:"date",className:"g-ui-input g-ui-input-size-md",value:ue,onInput:B=>ue.set(B?.target?.value??"")}),fe(!$,()=>Hi({type:"time",className:"g-ui-input g-ui-input-size-md",value:Te,onInput:B=>Te.set(B?.target?.value??"")}))),W({className:"g-ui-event-calendar-form-field"},vi({className:"g-ui-event-calendar-form-label"},"End"),Hi({type:"date",className:"g-ui-input g-ui-input-size-md",value:Le,onInput:B=>Le.set(B?.target?.value??"")}),fe(!$,()=>Hi({type:"time",className:"g-ui-input g-ui-input-size-md",value:F,onInput:B=>F.set(B?.target?.value??"")})))),fe(S,()=>W({className:"g-ui-event-calendar-form-row"},vi({className:"g-ui-event-calendar-form-label"},"Location"),be({placeholder:"Search or type location",value:le,onInput:B=>{le.set(B?.target?.value??""),Et()},onFocus:Et}),fe(Ce(ae).compute(B=>B&&B.length>0),()=>W({className:"g-ui-event-calendar-form-suggestions"},ae.get().map(B=>W({key:B.id??B.label,className:"g-ui-event-calendar-form-suggestion-item",onClick:()=>{Z.set(B.label??B.id),le.set(""),ae.set([])}},B.label??B.id)))),fe(Ce(Z).compute(B=>!!B),()=>Xe({className:"g-ui-event-calendar-form-chip"},Z)))),fe(L,()=>W({className:"g-ui-event-calendar-form-row"},vi({className:"g-ui-event-calendar-form-label"},"Add guests"),be({placeholder:"Type email to search",value:te,onInput:B=>Gi(B?.target?.value??"")}),W({className:"g-ui-event-calendar-form-chips"},ne.get().map((B,we)=>Xe({key:(B.email||B.id)+we,className:"g-ui-event-calendar-form-chip g-ui-event-calendar-form-chip-removable",onClick:()=>sa(we)},B.label||B.email||B.id," \xD7"))),fe(Ce(Q).compute(B=>B&&B.length>0),()=>W({className:"g-ui-event-calendar-form-suggestions"},Q.get().map(B=>W({key:B.id??B.email,className:"g-ui-event-calendar-form-suggestion-item",onClick:()=>na(B)},B.label??B.email??B.id)))))),W({className:"g-ui-event-calendar-form-row"},Ji({label:"Description",placeholder:"Add description",value:q,onInput:B=>q.set(B?.target?.value??"")})),fe(xe.length>0,()=>W({className:"g-ui-event-calendar-form-row"},vi({className:"g-ui-event-calendar-form-label"},"Color"),W({className:"g-ui-event-calendar-form-colors"},xe.map(B=>W({key:B.value??B.id??B,className:s("g-ui-event-calendar-form-color-swatch",Ce(Be).compute(we=>we===(B.value??B.id??B)?"g-ui-event-calendar-form-color-swatch-active":"")),style:{backgroundColor:B.color??B.value??B},onClick:()=>Be.set(B.value??B.id??B)}))))),W({className:"g-ui-event-calendar-form-actions"},Ue({variant:"subtle",onClick:T},"Cancel"),Ue({variant:"filled",onClick:()=>{Se(),b?ee():H()}},b?"Save":"Create")))},Yi=()=>{let b=V.get();return b?W({className:"g-ui-event-calendar-view-modal"},W({className:"g-ui-event-calendar-view-modal-title"},b.title||"(No title)"),W({className:"g-ui-event-calendar-view-modal-meta"},b.allDay?Xe({className:"g-ui-event-calendar-view-modal-date"},bi(b.start,h(n))+(b.start.getTime()!==b.end.getTime()?` \u2013 ${bi(b.end,h(n))}`:"")):Xe({className:"g-ui-event-calendar-view-modal-date"},`${bi(b.start,h(n))} \xB7 ${ri(b.start,h(n))} \u2013 ${ri(b.end,h(n))}`)),fe(b.location,()=>W({className:"g-ui-event-calendar-view-modal-field"},"Location: ",b.location)),fe(b.description,()=>W({className:"g-ui-event-calendar-view-modal-field"},b.description)),fe(b.attendees?.length,()=>W({className:"g-ui-event-calendar-view-modal-field"},"Guests: ",b.attendees.map(O=>O.label||O.email||O.id).join(", "))),W({className:"g-ui-event-calendar-view-modal-actions"},Ue({variant:"subtle",size:"sm",onClick:Y},ye({size:"sm",innerHTML:ir})," Edit"),Ue({variant:"subtle",size:"sm",onClick:pe,className:"g-ui-event-calendar-view-modal-delete"},ye({size:"sm",innerHTML:tr})," Delete"),Ue({variant:"filled",size:"sm",onClick:T},"Close"))):null};return W({...y,className:s("g-ui-event-calendar",w)},Pe,fe(m,b=>b==="month",()=>Ve),fe(m,b=>b==="week",()=>Wi),fe(m,b=>b==="day",()=>qi),fe(I,b=>b==="create",()=>si({opened:!0,title:"New event",size:"lg",onClose:T},xi(!1))),fe(I,b=>b==="view",()=>si({opened:!0,title:"Event",size:"md",onClose:T},Yi())),fe(I,b=>b==="edit",()=>si({opened:!0,title:"Edit event",size:"lg",onClose:T},xi(!0))))}import{Form as ug,context as gg,after as lg}from"@granularjs/core";var cg=gg({loading:!1});function pg(...e){let{props:i,children:t}=g(e,{}),{loading:r,loaderVariant:a,loaderSize:o,...n}=i,u=cg.scope({loading:r?.get()??!1});return lg(r).change(l=>{u.set({loading:l})}),u.serve(ug({loading:r,...n},At({visible:u.loading,variant:a,size:o}),t))}import{state as dg}from"@granularjs/core";function mg(e=!1){let i=dg(!!e);return[i,{open:()=>i.set(!0),close:()=>i.set(!1),toggle:()=>i.set(!i.get())}]}Ot();export{Eo as Accordion,Ge as ActionIcon,ds as Affix,rn as Alert,Nn as Anchor,xs as AppBar,$t as Autocomplete,sn as Avatar,Xu as AvatarGroup,_a as Badge,Qu as BadgeGroup,dn as Blockquote,ia as BottomBar,Jn as Breadcrumbs,Bu as Burger,Xi as Button,pi as Calendar,Ya as Card,is as Center,ot as Checkbox,Zu as CheckboxGroup,Fn as Chip,cn as Code,Wu as Col,ns as Collapse,Ea as Container,bu as CopyButton,Bi as DateInput,Qs as DatePicker,Ko as Divider,_o as Drawer,sg as EventCalendar,vs as Fieldset,Vu as Flex,pg as Form,Hu as Grid,Bt as GridTable,Wa as Group,cs as HoverCard,ye as Icon,Sn as Image,Fu as Indicator,gn as Kbd,br as List,ui as Loading,At as LoadingOverlay,qo as Menu,si as Modal,Ys as MultiSelect,$u as NavLink,pt as Notification,iu as Notifications,et as NumberField,to as NumberInput,On as Pagination,Jo as Paper,pu as PasswordInput,Gu as PinInput,Ct as Popover,uu as Popper,Dn as Progress,wu as ProgressRing,Xn as Radio,Yn as RadioGroup,Mu as RangePicker,au as RangeSlider,Rs as Rating,Lt as ScrollArea,mu as SearchInput,En as SegmentedControl,ko as Select,Cu as SelectSearch,ys as Sidebar,fn as SimpleGrid,In as Skeleton,Tn as Slider,rs as Space,Ha as Stack,js as Stepper,xo as Switch,po as SwitchGroup,Io as Table,So as Tabs,Os as Tag,Ki as Text,be as TextInput,Ji as Textarea,Fs as Timeline,Ba as Title,Mt as Toast,Ks as ToastStack,Ro as Tooltip,_ as classFlag,ve as classMap,z as classVar,s as cx,Na as getThemeMode,za as setThemeMode,ka as setThemeVars,g as splitPropsChildren,mg as useDisclosure};
