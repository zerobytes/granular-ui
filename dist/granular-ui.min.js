...
`;function Ot(){if(typeof document>"u"||document.getElementById(Ht))return;let e=document.createElement("style");e.id=Ht,e.textContent=xa,document.head.appendChild(e)}var wa=new Set(["--g-ui-bg","--g-ui-bg-subtle","--g-ui-bg-muted","--g-ui-bg-emphasized","--g-ui-bg-inverted","--g-ui-bg-panel","--g-ui-fg","--g-ui-fg-muted","--g-ui-fg-subtle","--g-ui-fg-inverted","--g-ui-border","--g-ui-border-subtle","--g-ui-border-emphasized","--g-ui-border-inverted","--g-ui-primary","--g-ui-primary-hover","--g-ui-primary-active","--g-ui-primary-subtle","--g-ui-primary-muted","--g-ui-primary-emphasized","--g-ui-success","--g-ui-success-hover","--g-ui-success-active","--g-ui-success-subtle","--g-ui-success-muted","--g-ui-danger","--g-ui-danger-hover","--g-ui-danger-active","--g-ui-danger-subtle","--g-ui-danger-muted","--g-ui-warning","--g-ui-warning-hover","--g-ui-warning-active","--g-ui-warning-subtle","--g-ui-warning-muted","--g-ui-info","--g-ui-info-hover","--g-ui-info-active","--g-ui-info-subtle","--g-ui-info-muted","--g-ui-shadow-xs","--g-ui-shadow-sm","--g-ui-shadow-md","--g-ui-shadow-lg","--g-ui-shadow-xl","--g-ui-shadow-2xl","--g-ui-radius","--g-ui-font","--g-ui-surface","--g-ui-text","--g-ui-muted","--g-ui-primary-strong","--g-ui-shadow"]);function ya(e={},i=document?.documentElement){if(i)for(let[t,r]of Object.entries(e)){let a=t.startsWith("--")?t:`--g-ui-${t}`;wa.has(a)&&i.style.setProperty(a,String(r))}}function ka(e="dark",i=document?.documentElement){i&&(i.classList.remove("g-ui-theme-dark","g-ui-theme-light"),i.classList.add(e==="light"?"g-ui-theme-light":"g-ui-theme-dark"))}function za(e=document?.documentElement){return e.classList.contains("g-ui-theme-light")?"light":"dark"}import{Renderer as Wt,isSignal as qt,isState as Yt,isStatePath as Gt,isComputed as _t,resolve as He,computed as Na,after as _i,concat as Ca,isWhen as Sa}from"@granularjs/core";function Oe(e){return qt(e)||Yt(e)||Gt(e)||_t(e)||Sa(e)}function s(...e){return Ca(...e,{separator:" ",filterFalsy:!0})}function g(e,i){let t={},r=[],a=o=>!!o&&typeof o=="object"&&!Array.isArray(o)&&!Wt.isRenderable(o)&&!Wt.isDomNode(o)&&!qt(o)&&!Yt(o)&&!Gt(o)&&!_t(o);for(let o of e)a(o)?Object.assign(t,o):r.push(o);if(i&&typeof i=="object")for(let o of Object.keys(i))t[o]===void 0&&(t[o]=i[o]);return{props:Na(t),rawProps:t,children:r}}function h(e){return He(e)}function ze(e){return!!He(e)}function k(e,i,t){let r=a=>{let o=He(a),n=o==null||o===""?t:o;return n==null||n===""?"":`${e}${n}`};return Oe(i)?_i(i).compute(a=>r(a)):r(i)}function _(e,i){return Oe(i)?_i(i).compute(t=>He(t)?e:""):He(i)?e:""}function ve(e,i,t){let r=a=>i[a]||null;return Oe(e)?_i(e).compute(a=>r(He(a??t))):r(He(e??t))}import{Button as Da,Span as Zi,when as Ui,after as Pa}from"@granularjs/core";function Xi(...e){let{props:i,children:t}=g(e,{variant:"filled",size:"md",justify:"center"}),{variant:r,color:a,size:o,fullWidth:n,loading:u,leftSection:l,rightSection:d,className:f,disabled:w,justify:y,...c}=i,b=Pa(w,u).compute(([v,N])=>v||N);return Da({...c,disabled:b,className:s("g-ui-button",k("g-ui-button-variant-",r,"filled"),k("g-ui-button-color-",a,"primary"),k("g-ui-justify-",y,"center"),k("g-ui-button-size-",o,"md"),_("g-ui-button-full",n),_("g-ui-button-loading",u),f)},Ui(l,()=>Zi({className:"g-ui-button-section-left"},l)),Ui(u,()=>Zi("Loading..."),()=>t),Ui(d,()=>Zi({className:"g-ui-button-section-right"},d)))}import{Span as Ma}from"@granularjs/core";function Ki(...e){let{props:i,children:t}=g(e,{size:"md"}),{size:r,weight:a,color:o,dimmed:n,align:u,ellipsis:l,decoration:d,className:f,style:w,...y}=i,c=ve(a,{bold:"g-ui-text-weight-700",semibold:"g-ui-text-weight-600",medium:"g-ui-text-weight-500",700:"g-ui-text-weight-700",600:"g-ui-text-weight-600",500:"g-ui-text-weight-500",400:"g-ui-text-weight-400"}),b=ve(o,{primary:"g-ui-text-primary",success:"g-ui-text-success",danger:"g-ui-text-danger",muted:"g-ui-text-dimmed"}),v=ve(u,{center:"g-ui-text-align-center",right:"g-ui-text-align-right",left:"g-ui-text-align-left"}),N=ve(d,{underline:"g-ui-text-decoration-underline","line-through":"g-ui-text-decoration-line-through",overline:"g-ui-text-decoration-overline",none:"g-ui-text-decoration-none"});return Ma({...y,style:w,className:s("g-ui-text",k("g-ui-text-size-",r,"md"),_("g-ui-text-dimmed",n),_("g-ui-text-ellipsis",l),c,b,v,N,f)},t)}import{H1 as Ta,H2 as Zt,H3 as Va,H4 as La,H5 as Ia,H6 as $a}from"@granularjs/core";var Aa={1:Ta,2:Zt,3:Va,4:La,5:Ia,6:$a};function Fa(...e){let{props:i,children:t}=g(e,{order:2}),{order:r,className:a,style:o,...n}=i,u=h(r)||2;return(Aa[u]||Zt)({...n,className:s("g-ui-title",k("g-ui-title-order-",r,2),a)},t)}import{Div as Ba}from"@granularjs/core";function ja(...e){let{props:i,children:t}=g(e,{size:"md"}),{size:r,fluid:a,className:o,style:n,...u}=i;return Ba({...u,style:n,className:s("g-ui-container",_("g-ui-container-fluid",a),k("g-ui-container-size-",r,"md"),o)},t)}import{Div as Ea}from"@granularjs/core";function Ra(...e){let{props:i,children:t}=g(e,{gap:"md"}),{gap:r,align:a,justify:o,className:n,style:u,...l}=i,d=ve(o,{between:"g-ui-justify-between",center:"g-ui-justify-center",end:"g-ui-justify-end",start:"g-ui-justify-start"});return Ea({...l,style:u,className:s("g-ui-stack",k("g-ui-gap-",r,"md"),k("g-ui-align-",a),d,n)},t)}import{Div as Ha}from"@granularjs/core";function Oa(...e){let{props:i,children:t}=g(e,{gap:"md",align:"center"}),{gap:r,align:a,justify:o,position:n,noWrap:u,className:l,style:d,...f}=i,w=ve(n,{apart:"g-ui-justify-between",center:"g-ui-justify-center",right:"g-ui-justify-end",left:"g-ui-justify-start"});return Ha({...f,style:d,className:s("g-ui-group",k("g-ui-gap-",r,"md"),k("g-ui-align-",a,"center"),k("g-ui-justify-",o,"none"),w,_("g-ui-no-wrap",u),l)},t)}import{Div as wi,list as Wa,when as Qi,after as Ji}from"@granularjs/core";function qa(...e){let{props:i,children:t}=g(e,{padding:"md",radius:"md",shadow:"none"}),{title:r,content:a,actions:o,border:n,padding:u,radius:l,shadow:d,className:f,style:w,...y}=i,c=_("g-ui-card-bordered",n);return Ji(c).compute(b=>console.log(b)),wi({style:w},Qi(r,()=>wi({className:"g-ui-card-title"},r)),Qi(a,()=>wi({className:"g-ui-card-content"},a)),{className:s("g-ui-card",_("g-ui-card-bordered",n),k("g-ui-card-border-",n,"none"),k("g-ui-card-padding-",u,"md"),k("g-ui-card-radius-",l,"md"),k("g-ui-card-shadow-",d,"md"),f),...y},t,Qi(o,()=>wi({className:"g-ui-card-actions"},Wa(o,b=>Xi({className:"g-ui-card-action",onClick:v=>b.get().onClick?.(v),leftSection:b.leftSection,rightSection:b.rightSection,size:Ji(b.size).compute(v=>v||"sm"),variant:Ji(b.variant).compute(v=>v||"outline"),...b.get().props||{}},b.label)))))}import{Span as Ya}from"@granularjs/core";function Ga(...e){let{props:i,children:t}=g(e,{variant:"filled",size:"md"}),{variant:r,size:a,className:o,dot:n,style:u,...l}=i,d=ve(r,{dot:"g-ui-badge-dot"});return Ya({...l,className:s("g-ui-badge",k("g-ui-badge-variant-",r,"filled"),k("g-ui-badge-size-",a,"md"),_("g-ui-badge-dot",n),d,o)},t)}import{Div as oi,Input as _a,Textarea as Za,Label as Ua,Span as Xa,when as ni,state as Ka,after as Qa,isState as Ja}from"@granularjs/core";function be(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{label:r,description:a,error:o,size:n,leftSection:u,rightSection:l,className:d,inputClassName:f,multiline:w,disabled:y,readOnly:c,value:b,...v}=i,{value:N,node:I,onChange:D,onInput:z,onFocus:C,onBlur:S,onKeyDown:m,onKeyUp:p,onClick:L}=t,V=Ja(N)&&!D&&!z,A=V?N:Ka(h(b)??"");Qa(b).change(U=>{V||A.set(h(U)??"")});let J=U=>{let ie=U?.target?.value??"";ie!==b.get()&&(A.set(ie),D?.(U),z?.(U))},oe=ze(w),re=oe?Za:_a,R=s(f,oe&&"g-ui-textarea"),G=re({...v,node:I,value:A,onInput:J,onChange:J,onFocus:C,onBlur:S,onKeyDown:m,onKeyUp:p,onClick:L,disabled:y,readOnly:c,className:s("g-ui-input",R)});return oi({className:s("g-ui-text-input",d,_("g-ui-input-disabled",y),_("g-ui-input-read-only",c))},ni(r,()=>Ua({className:"g-ui-text-input-label"},r)),ni(a,()=>Xa({className:"g-ui-text-input-description"},a)),oi({className:s("g-ui-input-wrapper",_("g-ui-input-multiline",w),k("g-ui-input-size-",n,"md"),_("g-ui-input-error",o))},ni(u,()=>oi({className:"g-ui-input-section"},u)),G,ni(l,()=>oi({className:"g-ui-input-section"},l))),ni(o,()=>oi({className:"g-ui-text-input-error-text"},o)))}function et(...e){let{props:i}=g(e,{size:"md"}),{size:t,leftSection:r,rightSection:a,className:o,...n}=i;return be({...n,size:t,className:o,leftSection:r,rightSection:a,multiline:!0})}import{Div as Ut,Span as Xt,after as We,state as eo}from"@granularjs/core";function it(...e){let{props:i,rawProps:t}=g(e,{size:"md",step:1,allowDecimal:!0,allowNegative:!0,clampBehavior:"blur",hideControls:!1,decimalSeparator:".",thousandSeparator:"",format:null,prefix:"",suffix:""}),{value:r,min:a,max:o,step:n,size:u,allowDecimal:l,allowNegative:d,decimalSeparator:f,thousandSeparator:w,decimalScale:y,clampBehavior:c,hideControls:b,format:v,locale:N,currency:I,formatOptions:D,prefix:z,suffix:C,leftSection:S,rightSection:m,className:p,onChange:L,onInput:V,...A}=i,{onChange:J,onInput:oe,onBlur:re,onFocus:R,onKeyDown:G}=t,U=F=>{J?.(F.target?.value??""),oe?.(F.target?.value??"")},ie=U,K=eo(""),P=F=>String(F??"").replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),j=()=>{if(!!!h(l))return 0;let $=h(y);if($!=null&&$!==""&&Number.isFinite(Number($)))return Math.max(0,Number($));let q=h(v);return q==="currency"||q==="percent"?2:0},M=F=>{let $=h(f)??".",q=h(w)??"",Z=String(F??"");if(q&&(Z=Z.split(q).join("")),!Z||Z==="-"||Z===$||Z.endsWith($))return null;let ne=Z.replace($,"."),te=Number(ne);return Number.isFinite(te)?te:null},Y=F=>{let $=h(w)??"";return $?F.replace(/\B(?=(\d{3})+(?!\d))/g,$):F},T=F=>{let $=h(f)??".",q=j(),Z=Number(F);if(!Number.isFinite(Z))return"";let ne=Z<0?"-":"",te=Math.abs(Z),[Q,ae=""]=String(te).split("."),le=Y(Q);if(q>0){let xe=ae.slice(0,q).padEnd(q,"0");return`${ne}${le}${$}${xe}`}return`${ne}${le}`},E=(F,$)=>{try{let q=h(N),Z=h(I)??"USD",ne=h(D)??{},te=j(),Q=$==="currency"?"currency":"decimal";return new Intl.NumberFormat(q,{style:Q,currency:Z,...te>0?{minimumFractionDigits:te,maximumFractionDigits:te}:{maximumFractionDigits:0},...ne}).format(F)}catch{return T(F)}},H=F=>{let $=F,q=h(a),Z=h(o);return q!=null&&Number.isFinite(Number(q))&&($=Math.max($,Number(q))),Z!=null&&Number.isFinite(Number(Z))&&($=Math.min($,Number(Z))),!h(d)&&$<0&&($=0),$},ee=()=>{let F=h(C)??"",$=h(v);return!F&&$==="percent"?"%":F},pe=(F,$,q)=>{let Z=h(z)??"",ne=ee(),te=String(F??"").replace(/\u00A0/g," "),Q=String(Z??"").replace(/\u00A0/g," "),ae=String(ne??"").replace(/\u00A0/g," "),le=Q&&te.startsWith(Q),xe=ae&&te.endsWith(ae);return`${$??""}${le?"":Z}${F}${xe?"":ne}`},ke=(F,$)=>{let q=j(),Z=h(f)??".",te=String(F??"").replace(/\D/g,"")||"0",Q=q>0?te.padStart(q+1,"0"):te,le=(q>0?Q.slice(0,-q):Q).replace(/^0+(?=\d)/,"")||"0",xe=q>0?Q.slice(-q):"",Be=q>0?`${le}${Z}${xe}`:le;return`${$??""}${Be}`},Pe=F=>{let $=h(z)??"",q=ee(),Z=String(F??""),ne=String($??"").replace(/\u00A0/g," "),te=String(q??"").replace(/\u00A0/g," ");return ne&&Z.replace(/\u00A0/g," ").startsWith(ne)&&(Z=Z.slice($.length)),te&&Z.replace(/\u00A0/g," ").endsWith(te)&&(Z=Z.slice(0,-q.length)),Z},Fe=F=>{let $=!!h(d),q=Pe(F),Z=$&&q.includes("-")?"-":"",ne=q.replace(/\D/g,""),te=ke(ne,Z);if(h(c)==="strict"){let Q=M(te);if(Q!=null){let ae=H(Q);te=`${ae<0?"-":""}${T(Math.abs(ae))}`}}return te},Ve=F=>{if(F==null||F==="")return ke("","");if(typeof F=="number"&&Number.isFinite(F)){let ae=h(c)==="strict"?H(F):F;return`${ae<0?"-":""}${T(Math.abs(ae))}`}let $=Pe(F),q=h(f)??".",ne=!!h(d)&&String($).includes("-")?"-":"",te=String($??"").replace(new RegExp(`[^0-9${P(q)}]`,"g"),""),Q=M(`${ne}${te}`);if(Q!=null){let ae=h(c)==="strict"?H(Q):Q;return`${ae<0?"-":""}${T(Math.abs(ae))}`}return Fe(F)},Me,ai=F=>{let $=h(F);if($===void 0)return;let q=Ve($);q!==K.get()&&(Me=q,K.set(q))};ai(r),We(r).change(F=>{ai(F)}),We(K).change(F=>{if(F===Me){Me=void 0;return}Me=void 0;let $=M(F);if($==null){U?.({target:{value:F??""}});return}U?.({target:{value:$}})});let Wi=We(m).compute(F=>F!=null&&F!==!1),qi=We(b,Wi).compute(([F,$])=>!h(F)&&!$),xi=We(l).compute(F=>h(F)?"decimal":"numeric"),Yi=We(v,z,C,l,d,f,w,y,c,a,o,N,I,D).compute(()=>({mode:"both",format:F=>{let $=Fe(F),q=h(v),ne=!!h(d)&&$.startsWith("-")?"-":"",te=M($),Q=$.replace(ne,"");if(te!=null){let ae=Math.abs(te);if(typeof q=="function")try{Q=q(ae)}catch{Q=T(ae)}else if(q==="currency")Q=E(ae,"currency");else if(q==="decimal"){let le=h(N),xe=h(D);Q=le||xe?E(ae,"decimal"):T(ae)}else Q=T(ae)}return{value:$,raw:$,visual:pe(Q,ne,q)}}})),x=F=>{let $=M(K.get()),q=Number(h(n)??1),ne=H(($??0)+q*F),te=T(ne);K.set(te)},O=F=>{if(!F||typeof F.setSelectionRange!="function")return;let $=()=>{try{let q=String(F.value??"").length;F.setSelectionRange(q,q)}catch{}};typeof requestAnimationFrame=="function"?requestAnimationFrame($):$()},ce=F=>{ie?.(F);let $=F?.target;$&&O($)},X=F=>{if(re?.(F),h(c)!=="blur")return;let $=M(K.get());if($==null)return;let q=H($);K.set(T(q))},ge=F=>{R?.(F),O(F?.target)},he=F=>{G?.(F);let $=F?.target;if(!$)return;let q=h(z)??"",Z=ee();Z&&typeof $.selectionEnd=="number"&&($.selectionEnd=Math.min($.selectionEnd,String($.value??"").length-Z.length)),q&&typeof $.selectionStart=="number"&&($.selectionStart=Math.max($.selectionStart,q.length))},ue=Ut({className:"g-ui-number-field-controls"},Xt({className:"g-ui-number-field-control",onClick:()=>x(1)},"+"),Xt({className:"g-ui-number-field-control",onClick:()=>x(-1)},"\u2212")),Te=Ut({className:"g-ui-number-field-controls-wrapper"},ue),Le=We(qi,m).compute(([F,$])=>F?Te:$);return be({...A,size:u,className:s("g-ui-number-field",p),leftSection:S,rightSection:Le,type:"text",inputMode:xi,inputClassName:s("g-ui-input-number"),value:K,format:Yi,onInput:ce,onBlur:X,onFocus:ge,onKeyDown:he})}function io(...e){return it(...e)}import{Div as Ni,Button as to,portal as ro,when as tt,after as ao}from"@granularjs/core";var yi='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/></svg>',ki='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M560-240 320-480l240-240 56 56-184 184 184 184-56 56Z"/></svg>',zi='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M379.33-244 154-469.33 201.67-517l177.66 177.67 378.34-378.34L805.33-670l-426 426Z"/></svg>',Kt='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M240-446.67v-66.66h480v66.66H240Z"/></svg>',je='<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M312-265.33 265.33-312l168-168-168-167L312-693.67l168 168 167-168L693.67-647l-168 167 168 168L647-265.33l-167-168-168 168Z"/></svg>',Qt='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>',Jt='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>',er='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h357l-80 80H200v560h560v-278l80-80v358q0 33-23.5 56.5T760-120H200Zm280-360v-80h240v80H480Zm0 160v-80h320v80H480Zm0 160v-80h320v80H480ZM360-360v-80h80v80h-80Zm0 160v-80h80v80h-80Zm0 160v-80h80v80h-80Zm160-320h280l-36-37 37-37v74H520Zm-160 0h80v-80h-80v80ZM120-600v-160l160-160h160l-80 80H200v240h-80Zm80-240v-80 80Z"/></svg>',ir='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>',tr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80H200Zm0-80h560v-400H200v400Z"/></svg>',rr='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z"/></svg>';function si(...e){let{props:i,rawProps:t,children:r}=g(e,{size:"md",centered:!0,overlay:"normal"}),{opened:a,title:o,size:n,centered:u,overlay:l,position:d,className:f,style:w}=i,{onClose:y}=t,c=ao(d,u).compute(([b,v])=>`g-ui-modal-position-${b??(v===!1?"top-center":"center")}`);return tt(a,()=>ro(Ni({className:s("g-ui-modal-overlay",k("g-ui-modal-overlay-",l,"normal"),c),onClick:b=>{b.target===b.currentTarget&&y?.()}},Ni({className:s("g-ui-modal",k("g-ui-modal-size-",n,"md"),f)},Ni({className:"g-ui-modal-header"},tt(o,()=>Ni({className:"g-ui-modal-title"},o)),tt(y,()=>to({type:"button",className:"g-ui-button g-ui-button-variant-subtle g-ui-button-size-xs g-ui-modal-close",onClick:y,innerHTML:je}))),r))))}import{Div as Ci,Span as rt,after as ar,when as or}from"@granularjs/core";function ui(...e){let{props:i}=g(e,{variant:"spinner",size:"md"}),{variant:t,size:r,className:a}=i,o=ar(t).compute(u=>u==="dots"),n=ar(t).compute(u=>u==="bars");return or(o,()=>Ci({className:s("g-ui-loading g-ui-dots",k("g-ui-loading-size-",r,"md"),a)}),()=>or(n,()=>Ci({className:s("g-ui-loading g-ui-bars",k("g-ui-loading-size-",r,"md"),a)},rt(""),rt(""),rt("")),()=>Ci({className:s("g-ui-loading",k("g-ui-loading-size-",r,"md"),a)},Ci({className:"g-ui-spinner"}))))}import{Div as at,Input as oo,Label as no,Span as nr,when as ot,state as so,after as uo}from"@granularjs/core";function nt(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{checked:r,label:a,description:o,size:n,indeterminate:u,className:l,style:d,inputProps:f,...w}=i,{onChange:y}=t,c=so(ze(r));uo(r).change(v=>{v!=null&&(c.set(!!v),y?.(v))});let b=no({className:"g-ui-checkbox-control"},oo({type:"checkbox",indeterminate:u,checked:c,className:s("g-ui-checkbox-input",k("g-ui-checkbox-size-",n,"md"),f?.className),...w}),ot(c,()=>at({className:"g-ui-checkbox-checked",innerHTML:zi}),()=>{if(!c.get()&&u.get())return at({className:"g-ui-checkbox-indeterminate",innerHTML:Kt})}),ot(a,()=>nr({className:"g-ui-checkbox-label"},a)));return at({className:s("g-ui-checkbox",k("g-ui-checkbox-size-",n,"md"),l)},b,ot(o,()=>nr({className:"g-ui-checkbox-description"},o)))}import{Input as po,Label as mo,Span as fo,when as ho,after as Si,state as vo}from"@granularjs/core";import{Div as go,context as lo,after as sr}from"@granularjs/core";var st=lo({name:null,selected:null});function co(...e){let{props:i,rawProps:t,children:r}=g(e),{className:a,name:o,selected:n,onChange:u,...l}=i,{onChange:d}=t,f=st.scope({name:o?.get(),selected:n?.get()});return sr(f.selected).change(w=>{d?.(w)}),sr(n).change(w=>{w!==f.selected.get()&&(f.set().selected=w)}),f.serve(go({...l,className:s("g-ui-switch-group",a)},r))}function bo(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{label:r,size:a,className:o,style:n,inputProps:u,checked:l,value:d,onChange:f,...w}=i,{onChange:y}=t,c=vo(l),b=st.state(),v=Si(b).compute(N=>({name:N.name,type:N.name?"radio":"checkbox"}));return Si(b.selected).change(N=>{c.set(N===d.get())}),y&&Si(l).change(N=>{N!==c.get()&&c.set(N)}),Si(c).change(N=>{if(N===l.get())return;y?.(N);let I=b.get().selected;b.set().selected=d.get()}),mo({className:s("g-ui-switch",k("g-ui-switch-size-",a,"md"),o)},po({type:v.type,name:v.name,value:d,checked:c,className:s("g-ui-switch-input",k("g-ui-switch-size-",a,"md"),u?.className),...w}),ho(r,()=>fo({className:"g-ui-switch-label"},r)))}import{Div as Ee,Span as ut,when as Ke,state as ur,after as Di,Label as wo}from"@granularjs/core";import{Span as xo}from"@granularjs/core";function ye(...e){let{props:i,children:t}=g(e,{size:"md"});return xo({...i,className:s("g-ui-icon",k("g-ui-icon-size-",i.size,"md"),k("g-ui-icon-color-",i.color),i.className)},...t)}function yo(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"md"}),{data:r,value:a,size:o,leftSection:n,rightSection:u,placeholder:l,className:d,label:f,description:w,error:y,...c}=i,{onChange:b}=t,v=ur(!1),N=ur(h(a)??"");Di(a).change(C=>{let S=h(C);S!==void 0&&N.set(S??"")});let I=C=>{N.set(C),b?.(C),v.set(!1)},D=Di(N).compute(C=>C?"":"g-ui-select-placeholder"),z=Di(N).compute(C=>{let m=(h(r)??[]).find(p=>p.value===C);return C?m?.label??"":l??""});return Ee({...c,className:s("g-ui-select-root",d)},Ke(f,()=>wo({className:"g-ui-text-input-label"},f)),Ke(w,()=>ut({className:"g-ui-text-input-description"},w)),Ee({className:s("g-ui-input-wrapper",k("g-ui-input-size-",o,"md")),onClick:()=>v.set(!v.get())},Ke(n,()=>Ee({className:"g-ui-input-section"},n)),Ee({className:s("g-ui-select",D)},ut({className:"g-ui-select-value"},z)),Ke(u,()=>Ee({className:"g-ui-input-section"},u),()=>ut({className:"g-ui-select-caret"},ye({innerHTML:rr})))),Ke(y,()=>Ee({className:"g-ui-text-input-error-text"},y)),Ke(v,()=>Ee({className:"g-ui-select-dropdown"},(h(r)??[]).map(C=>Ee({className:s("g-ui-select-item",Di(N).compute(S=>S===C.value?"g-ui-select-item-active":"")),onClick:()=>I(C.value)},C.label)))))}import{Button as ko,Div as Qe,state as Ie,after as gi,list as zo,when as No}from"@granularjs/core";function Co(...e){let{props:i,rawProps:t}=g(e,{tabs:[],orientation:"horizontal",variant:"default",sticky:!0,align:"left",size:"md"}),{value:r,tabs:a,orientation:o,variant:n,sticky:u,className:l,style:d,align:f,size:w}=i,{onChange:y}=t,c=Ie(h(r)??h(a)?.[0]?.value??""),b=Ie(),v=Ie(),N=Ie(0),I=Ie(0),D=Ie(0),z=Ie(0),C=Ie(!1),S=Ie(0),m=!1,p=null,L=!1,V=new Set;gi(r).change(T=>{let E=h(T);E!=null&&c.set(E)});let A=T=>{c.set(T),y?.(T)},J=T=>{let E=[],H=T?.parentElement;for(;H;){let ee=getComputedStyle(H),pe=`${ee.overflow}${ee.overflowY}${ee.overflowX}`;/(auto|scroll)/.test(pe)&&E.push(H),H=H.parentElement}return E},oe=T=>J(T)[0]??null,re=T=>T?T.getBoundingClientRect().top:0,R=T=>T?T.scrollTop:window.scrollY||window.pageYOffset||0,G=(T,E)=>T>E?"down":T<E?"up":"none",U=(T,E,H,ee)=>T==="down"&&E<H?!0:T==="up"&&E>=H?!1:ee,ie=()=>{let T=b.get(),E=v.get();if(!T||!E)return;if(!ze(u)){C.set(!1),N.set(0);return}if(typeof window>"u")return;let H=T.getBoundingClientRect(),ee=E.getBoundingClientRect(),pe=oe(T),ke=re(pe),Pe=R(pe),Fe=G(Pe,S.get());S.set(Pe);let Ve=U(Fe,H.top,ke,C.get());N.set(ee.height),I.set(H.left),D.set(H.width),z.set(ke),Ve!==C.get()&&C.set(Ve)},K=()=>{p==null&&(p=requestAnimationFrame(()=>{p=null,ie()}))},P=T=>{!T||V.has(T)||(V.add(T),T.addEventListener("scroll",K,{passive:!0}))},j=()=>{if(m)return;let T=b.get(),E=v.get();!T||!E||typeof window>"u"||(m=!0,ie(),P(window),window.addEventListener("resize",K),J(T).forEach(P))};gi(v,b,u).change(j),!L&&typeof window<"u"&&(L=!0,setTimeout(()=>j(),0));let M=gi(C,I,D,z).compute(T=>{let[E,H,ee,pe]=T;return E?{position:"fixed",top:`${pe}px`,left:`${H}px`,width:`${ee}px`,background:"var(--g-ui-surface)",zIndex:100}:{position:"static",top:"auto",left:"auto",width:"auto",zIndex:"auto",background:"transparent"}}),Y=gi(C,N).compute(T=>{let[E,H]=T;return{height:E?`${H}px`:"0px"}});return Qe(Qe({className:s("g-ui-tabs",ve(o,{vertical:"g-ui-tabs-vertical"}),k("g-ui-tabs-variant-",n,"default"),k("g-ui-tabs-align-",f,"left"),k("g-ui-tabs-size-",w,"md"),i.className??l)},Qe({node:b}),Qe({style:Y}),Qe({node:v,className:"g-ui-tabs-list",style:M},zo(a,T=>ko({className:gi(c,T.value).compute(([E,H])=>s("g-ui-tabs-tab",H===E&&"g-ui-tabs-tab-active")),onClick:()=>A(T.get().value)},T.label))),Qe({className:"g-ui-tabs-panel"},No(c,()=>a.get()?.find(T=>T.value===c.get())?.content??null))))}import{Table as So,Thead as Do,Tbody as Po,Tr as Mo,Th as To,Td as Vo,list as lr,when as cr,after as gt}from"@granularjs/core";function Lo(...e){let{props:i}=g(e,{headers:[],rows:[]}),{headers:t,rows:r,striped:a,highlightOnHover:o,withBorder:n,withColumnBorders:u,withRowBorders:l,className:d,style:f,...w}=i,y=gt(t).compute(c=>c.length>0);return So({...w,className:s("g-ui-table",_("g-ui-table-striped",a),_("g-ui-table-hover",o),_("g-ui-table-with-border",n),_("g-ui-table-column-borders",u),_("g-ui-table-row-borders",l),d)},cr(y,()=>Do(gr(t,!0))),Po(lr(r,c=>gr(c,!1))))}var gr=(e,i)=>{let t=gt(e).compute(o=>Array.isArray(o)),r=o=>{let n=gt(o).compute(u=>Object.values(u));return a(n)},a=o=>lr(o,n=>i?$o(n):Io(n));return Mo(cr(t,()=>a(e),()=>r(e)))},Io=e=>Vo(e),$o=e=>To(e);import{Div as lt}from"@granularjs/core";import{state as Ao,when as Fo,after as Bo}from"@granularjs/core";function jo(...e){let{props:i,rawProps:t,children:r}=g(e,{opened:!1}),{opened:a,className:o,...n}=i,{opened:u}=t,l=Oe(u),d=l?u:Ao(ze(a));Bo(a).change(c=>{l||d.set(ze(c))});let f=()=>{l||d.set(!d.get())},w=r[0],y=r[1];return lt({...n,className:s("g-ui-accordion",o)},lt({className:"g-ui-accordion-header",onClick:f},w),Fo(d,()=>lt({className:"g-ui-accordion-content"},y)))}import{Span as pr}from"@granularjs/core";function Eo(...e){let{props:i,children:t}=g(e),{label:r,className:a,style:o}=i;return pr({className:s("g-ui-tooltip",a)},t,pr({className:"g-ui-tooltip-content"},r))}import{Div as li,when as Ro,after as Ho,state as ci,portal as Oo}from"@granularjs/core";var ct=ci({currentOpenState:null});function Wo(...e){let i=ci(),t=ci(),r=ci({}),{props:a,rawProps:o,children:n}=g(e,{position:"right"}),{opened:u,content:l,position:d,className:f,...w}=a,{onChange:y}=o,c=ci(h(u)??!1);Ho(u).change(C=>{let S=h(C);S!=null&&(c.set(!!S),S&&b())});let b=()=>{ct.get().currentOpenState!==c&&(ct.get().currentOpenState?.set(!1),ct.set().currentOpenState=c)};u.get()&&b();let v=C=>{let m=String(C??"right").toLowerCase().split("-").filter(Boolean);if(m.length===1){let V=m[0];return V==="top"||V==="bottom"?{placement:V,align:"center"}:V==="left"||V==="right"?{placement:"bottom",align:V}:V==="center"?{placement:"bottom",align:"center"}:{placement:"bottom",align:"right"}}let[p,L]=m;return p==="top"||p==="bottom"?{placement:p,align:L||"center"}:p==="left"||p==="right"?{placement:p,align:L||"center"}:{placement:"bottom",align:"right"}},N=()=>{let C=i.get(),S=t.get();if(!C||!S||typeof window>"u")return;let m=C.getBoundingClientRect(),p=S.getBoundingClientRect(),L=h(d)??"right",V=getComputedStyle(document.documentElement).getPropertyValue("--g-ui-space-20"),A=Number.parseFloat(V)||20,J=window.innerWidth||0,oe=window.innerHeight||0,re=Math.max(A,J-p.width-A),R=Math.max(A,oe-p.height-A),{placement:G,align:U}=v(L),ie=8,K=m.bottom+ie,P=m.left;G==="top"||G==="bottom"?(K=G==="top"?m.top-p.height-ie:m.bottom+ie,U==="center"?P=m.left+m.width/2-p.width/2:U==="right"?P=m.right-p.width:P=m.left):(G==="left"||G==="right")&&(P=G==="left"?m.left-p.width-ie:m.right+ie,U==="center"?K=m.top+m.height/2-p.height/2:U==="bottom"?K=m.bottom-p.height:K=m.top),P=Math.max(A,Math.min(P,re)),K=Math.max(A,Math.min(K,R)),r.set({top:`${K}px`,left:`${P}px`})},I=C=>{c.set(C),y?.(C),C&&(b(),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>N()):setTimeout(()=>N(),0))},D=()=>I(!c.get()),z=()=>I(!1);return li({...w,node:i,className:s("g-ui-menu",f)},li({onClick:D},n),Ro(c,()=>Oo(li(li({className:"g-ui-menu-overlay",onClick:z}),li({className:"g-ui-menu-dropdown",node:t,style:r},l)))))}import{Div as dr,portal as qo,when as Yo}from"@granularjs/core";function Go(...e){let{props:i,children:t}=g(e,{position:"right",size:"md",overlay:"normal",shadowed:!0}),{opened:r,onClose:a,position:o,size:n,overlay:u,shadowed:l,className:d,style:f}=i;return Yo(r,()=>qo(dr({className:s("g-ui-drawer-overlay",k("g-ui-drawer-overlay-",u,"normal")),onClick:a},dr({className:s("g-ui-drawer",ve(l,{true:"g-ui-drawer-shadowed"},!0),k("g-ui-drawer-",o,"right"),k("g-ui-drawer-size-",n,"md"),d),onClick:w=>w.stopPropagation()},t))))}import{Button as _o,Div as pt,Span as mr,when as Pi,after as fr}from"@granularjs/core";function dt(...e){let{props:i,rawProps:t,children:r}=g(e,{color:"blue",withCloseButton:!0}),{title:a,color:o,icon:n,loading:u,withCloseButton:l,withBorder:d,className:f,style:w}=i,{onClose:y}=t,c=fr(n,u).compute(([v,N])=>!v&&!!N),b=fr(n,u).compute(([v,N])=>!!v||!!N);return pt({className:s("g-ui-notification",[d,"g-ui-notification-bordered"],[o,v=>`g-ui-notification-${v}`],[b,"g-ui-notification-with-icon"],f)},Pi(n,()=>mr({className:"g-ui-notification-icon"},n)),Pi(c,()=>ui({size:"sm",className:"g-ui-notification-loader"})),pt({className:"g-ui-notification-body"},Pi(a,()=>pt({className:"g-ui-notification-title"},a)),r),Pi(l,()=>_o({type:"button",className:"g-ui-notification-close",onClick:()=>y?.()},mr({innerHTML:je}))))}import{Div as Zo,when as Uo}from"@granularjs/core";function Xo(...e){let{props:i}=g(e,{labelPosition:"center"}),{label:t,labelPosition:r,vertical:a,className:o,...n}=i;return Zo({...n,className:s("g-ui-divider",_("label",t),k("g-ui-divider-label-",r,"center"),_("g-ui-divider-vertical",a),o)},Uo(t,()=>Ki({className:"g-ui-divider-label-text",size:"sm"},t)))}import{Div as Ko}from"@granularjs/core";function Qo(...e){let{props:i,children:t}=g(e,{padding:"md",radius:"md",shadow:"none"}),{padding:r,radius:a,shadow:o,className:n,...u}=i;return Ko({...u,className:s("g-ui-paper",[r,l=>`g-ui-card-padding-${l}`],[a,l=>`g-ui-card-radius-${l}`],[o,l=>`g-ui-card-shadow-${l}`],n)},t)}import{Button as Jo,Div as mt,Span as en,after as hr,when as ft}from"@granularjs/core";function tn(...e){let{props:i,rawProps:t,children:r}=g(e,{color:"blue"}),{title:a,color:o,icon:n,withCloseButton:u,className:l,...d}=i,{onClose:f}=t,w=hr(a,u).compute(([c,b])=>c||b),y=hr(n).compute(c=>c!==void 0);return mt({...d,className:s("g-ui-alert",[o,c=>`g-ui-alert-${c}`],l)},mt({className:"g-ui-alert-header"},ft(n,()=>en({className:"g-ui-alert-icon"},n)),ft(a,()=>mt({className:"g-ui-alert-title"},a)),ft(u,()=>Jo({type:"button",className:"g-ui-alert-close",onClick:()=>f?.()},"\xD7"))),r)}import{Div as rn,Img as an,when as on}from"@granularjs/core";function nn(...e){let{props:i,children:t}=g(e,{size:"md",alt:""}),{src:r,size:a,alt:o,className:n,...u}=i;return rn({...u,className:s("g-ui-avatar",[a,l=>`g-ui-avatar-size-${l}`],n)},on(r,()=>an({className:"g-ui-avatar-img",src:r,alt:o}),()=>t))}import{Span as sn}from"@granularjs/core";function un(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return sn({...a,className:s("g-ui-kbd",r)},t)}import{Code as gn}from"@granularjs/core";function ln(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return gn({...a,className:s("g-ui-code",r)},t)}import{Blockquote as cn}from"@granularjs/core";function pn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return cn({...a,className:s("g-ui-blockquote",r)},t)}import{Div as dn}from"@granularjs/core";function mn(...e){let{props:i,children:t}=g(e,{cols:3,gap:"md"}),{cols:r,gap:a,className:o,...n}=i;return dn({...n,className:s("g-ui-grid",[a,u=>`g-ui-gap-${u}`],[r,u=>`g-ui-grid-cols-${u}`],o)},t)}import{Ul as fn,Ol as hn,Li as ht,Div as Mi,Span as vt,after as bt,when as qe,isSignal as vn,isState as bn,isStatePath as xn,isComputed as wn}from"@granularjs/core";function vr(...e){let{props:i,children:t}=g(e,{type:"none",size:"md"}),{type:r,size:a,withPadding:o,className:n,...u}=i,l=ve(r,{ordered:"g-ui-list-ordered",unordered:"g-ui-list-unordered",none:"g-ui-list-none"}),d=bt(r).compute(v=>v==="ordered"),f=v=>v&&typeof v=="object"&&typeof v.tagName=="string"&&(v.tagName.toLowerCase()==="ul"||v.tagName.toLowerCase()==="ol"),w=v=>v&&typeof v=="object"&&typeof v.tagName=="string"&&v.tagName.toLowerCase()==="li",y=v=>{let N=I=>I?.nodeType==="granular-list-node"?I:I==null||I===!1?null:Array.isArray(I)?I.map(D=>N(D)):w(I)?I:f(I)?ht({className:"g-ui-list-nested-item"},I):ht(vt({className:"g-ui-list-item-shell"},I));return vn(v)||bn(v)||xn(v)||wn(v)?bt(v).compute(I=>N(I)):N(v)},c=qe(t,()=>t.map(v=>y(v))),b={...u,className:s("g-ui-list",k("g-ui-list-size-",a,"md"),_("g-ui-list-with-padding",o),l,n)};return qe(d,()=>hn(b,c),()=>fn(b,c))}function yn(...e){let{props:i,children:t}=g(e,{withBorder:!1}),{leftSection:r,rightSection:a,title:o,body:n,withBorder:u,className:l,verticalPadding:d,horizontalPadding:f,...w}=i,y=bt(o,n).compute(([c,b])=>!!c||!!b);return ht({...w,className:s("g-ui-list-item",_("g-ui-list-item-border",u),k("g-ui-list-item-vertical-padding-",d,"md"),k("g-ui-list-item-horizontal-padding-",f,"md"),l)},Mi({className:"g-ui-list-item-shell"},qe(r,()=>vt({className:"g-ui-list-item-section g-ui-list-item-section-left"},r)),qe(y,()=>Mi({className:"g-ui-list-item-content"},qe(o,()=>Mi({className:"g-ui-list-item-title"},o)),qe(n,()=>Mi({className:"g-ui-list-item-body"},n))),()=>t),qe(a,()=>vt({className:"g-ui-list-item-section g-ui-list-item-section-right"},a))))}vr.Item=yn;import{A as kn}from"@granularjs/core";function zn(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return kn({...a,className:s("g-ui-anchor",r)},t)}import{Img as Nn}from"@granularjs/core";function Cn(...e){let{props:i}=g(e),{className:t,...r}=i;return Nn({...r,className:s("g-ui-image",t)})}import{Div as br}from"@granularjs/core";function Sn(...e){let{props:i}=g(e,{value:0,color:"primary",size:"md"}),{value:t,color:r,size:a,className:o,...n}=i;return br({...n,className:s("g-ui-progress",k("g-ui-progress-size-",a,"md"),[t,u=>{let l=Math.max(0,Math.min(100,Number(u)||0));return`g-ui-progress-${Math.round(l/5)*5}`}],[r,u=>u?`g-ui-progress-${u}`:""],o)},br({className:"g-ui-progress-bar"}))}import{Div as Re,after as Ye,state as Dn,when as xr,list as Pn}from"@granularjs/core";function Mn(...e){let{props:i,rawProps:t}=g(e,{size:"md",min:0,max:100,step:1}),{onChange:r}=t,{value:a,marks:o,size:n,min:u,max:l,step:d,disabled:f,className:w,...y}=i,c=Dn(h(a??u)),b=Ye(o).compute(S=>S&&S.length>0);Ye(a).change(S=>{S!=null&&c.set(h(S))});let v=()=>{let S=Number(h(u)),m=Number(h(l));return!Number.isFinite(S)||!Number.isFinite(m)?{minValue:0,maxValue:100}:{minValue:Math.min(S,m),maxValue:Math.max(S,m)}},N=()=>{let S=Number(h(d));return Number.isFinite(S)&&S>0?S:1},I=S=>{let{minValue:m,maxValue:p}=v(),L=N(),V=Math.max(m,Math.min(p,Number(S))),A=Math.round((V-m)/L)*L+m;A!==c.get()&&(c.set(A),r?.(A))},D=Ye(c).compute(S=>{let{minValue:m,maxValue:p}=v(),L=p-m;if(L<=0)return 0;let V=(Number(S??m)-m)/L*100;return Math.max(0,Math.min(100,V))}),z=(S,m)=>{let p=m?.();if(!p||p.width===0)return;let V=Math.min(Math.max(S.clientX-p.left,0),p.width)/p.width,{minValue:A,maxValue:J}=v();I(A+V*(J-A))},C=S=>{if(ze(f))return;S.preventDefault?.();let m=S.currentTarget,p=()=>m.getBoundingClientRect();m.setPointerCapture?.(S.pointerId),z(S,p);let L=A=>z(A,p),V=()=>{m.releasePointerCapture?.(S.pointerId),window.removeEventListener("pointermove",L),window.removeEventListener("pointerup",V)};window.addEventListener("pointermove",L),window.addEventListener("pointerup",V)};return Re({...y,className:s("g-ui-slider",k("g-ui-slider-size-",n,"md"),_("g-ui-slider-disabled",f),w)},Re({className:"g-ui-slider-track",onPointerDown:C},Re({className:"g-ui-slider-bar",style:Ye(D).compute(S=>({width:`${S}%`}))}),Re({className:"g-ui-slider-thumb",style:Ye(D).compute(S=>({left:`${S}%`}))})),xr(b,()=>Re({className:"g-ui-slider-marks-placeholder"})),xr(o,()=>Re({className:"g-ui-slider-marks"},Pn(o,S=>xt({mark:S,getBounds:v})))))}var xt=({mark:e,getBounds:i})=>{console.log("here",e,i);let{minValue:t,maxValue:r}=i(),a=r-t,o=Ye(e).compute(d=>d.value??d),n=Ye(e).compute(d=>d.label??String(d.value)??o),u=Number(o),l=0;return a>0&&(l=(u-t)/a*100),Re({className:"g-ui-slider-mark",style:{left:`${Math.max(0,Math.min(100,l))}%`}},Re({className:"g-ui-slider-mark-label"},n))};import{Div as Tn,after as Vn}from"@granularjs/core";function Ln(...e){let{props:i}=g(e,{height:"md",width:"full"}),{height:t,width:r,className:a,...o}=i,n=Vn(t,r).compute(([u,l])=>{let d={};return isNaN(u)||(d.height=`${u}px`),isNaN(l)||(d.width=`${l}px`),d});return Tn({...o,style:{width:n.width,height:n.height,...o.style||{}},className:s("g-ui-skeleton",[t,u=>`g-ui-skeleton-h-${u}`],[r,u=>`g-ui-skeleton-w-${u}`],a)})}import{Button as In,after as wr,state as $n}from"@granularjs/core";function An(...e){let{props:i,rawProps:t,children:r}=g(e,{size:"md",variant:"filled",color:"primary"}),{checked:a,size:o,variant:n,color:u,className:l,...d}=i,{onChange:f}=t,w=$n(!!a);wr(a).change(c=>{c!=null&&w.set(!!c)});let y=c=>{w.set(c),f?.(c)};return In({...d,type:"button",className:s("g-ui-chip",k("g-ui-chip-size-",o,"md"),k("g-ui-chip-variant-",n,"filled"),k("g-ui-chip-color-",u,"primary"),wr(w).compute(c=>c?"g-ui-chip-active":""),l),onClick:()=>y(!w.get())},r)}import{Div as wt,after as yr,state as Fn,list as Bn}from"@granularjs/core";function jn(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"sm"}),{value:r,data:a,size:o,scroll:n,className:u,...l}=i,{onChange:d}=t,f=Fn(h(r));yr(r).change(y=>{let c=h(y);c!=null&&f.set(c)});let w=y=>{f.set(y),d?.(y)};return wt({...l,className:s(n&&"g-ui-segmented-scroll")},wt({className:s("g-ui-segmented",k("g-ui-segmented-size-",o,"sm"),u)},Bn(a,(y=>wt({className:s("g-ui-segmented-item",yr(f).compute(c=>y.get().value===c?"g-ui-segmented-active":"")),onClick:()=>w(y.get().value)},y.label)))))}import{Button as yt,Div as En,state as Rn,after as Ti}from"@granularjs/core";function Hn(...e){let{props:i,rawProps:t}=g(e,{total:1,size:"md"}),{page:r,total:a,size:o,className:n,...u}=i,{onChange:l}=t,d=Rn(h(r)??1);Ti(r).change(c=>{let b=h(c);b!=null&&d.set(b)});let f=c=>{let b=Number(h(a))||1,v=Math.max(1,Math.min(b,c));d.set(v),l?.(v)},w=[],y=Number(h(a))||1;for(let c=1;c<=y;c+=1)w.push(c);return En({...u,className:s("g-ui-pagination",k("g-ui-pagination-size-",o,"md"),i.className??n)},yt({className:"g-ui-pagination-item",onClick:()=>f((d.get?.()??d)-1),disabled:Ti(d).compute(c=>c<=1)},"<"),w.map(c=>yt({className:Ti(d).compute(b=>s("g-ui-pagination-item",c===b&&"g-ui-pagination-item-active")),onClick:()=>f(c)},String(c))),yt({className:"g-ui-pagination-item",onClick:()=>f((d.get?.()??d)+1),disabled:Ti(d).compute(c=>c>=a)},">"))}import{Div as Yn,Input as Gn,Label as _n,Span as kr,when as zr,after as Nt,state as Zn}from"@granularjs/core";import{Div as On,context as Wn,after as kt}from"@granularjs/core";var zt=Wn({name:"",selected:null});function qn(...e){let{props:i,children:t,rawProps:r}=g(e),{className:a,name:o,selected:n,onChange:u,...l}=i,{onChange:d}=r,f=zt.scope({name:o?.get(),selected:n?.get()});return console.log("selected?.get()",n?.get()),kt(o).change(w=>{f.set().name=w}),kt(n).change(w=>{w!==f.selected.get()&&(f.set().selected=w)}),kt(f.selected).change(w=>{d?.(w)}),f.serve(On({...l,className:s("g-ui-stack g-ui-gap-sm",a)},t))}function Un(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{label:r,name:a,value:o,checked:n,description:u,size:l,className:d,inputProps:f,...w}=i,{onChange:y}=t,c=Zn(n?.get()??!1),b=zt.state(),v=Nt(b.name,a).compute(([I,D])=>I||D);Nt(n,b.selected).change(I=>{let[D,z]=I;b.get().name?c.set(z===o.get()):c.set(D)}),Nt(c).change(I=>{y?.(I),I&&b.get().name&&(b.set().selected=o.get())});let N=_n({className:"g-ui-radio-control"},Gn({type:"radio",name:v,value:o,checked:c,className:s("g-ui-radio-input",k("g-ui-radio-size-",l,"md"),f?.className),...w}),zr(r,()=>kr({className:"g-ui-radio-label"},r)));return Yn({className:s("g-ui-radio",k("g-ui-radio-size-",l,"md"),d)},N,zr(u,()=>kr({className:"g-ui-radio-description"},u)))}import{Nav as Xn,Span as Kn}from"@granularjs/core";function Qn(...e){let{props:i,children:t}=g(e,{separator:"/"}),{separator:r,className:a,...o}=i,n=[];Array.isArray(t)?n.push(...t):n.push(t);let u=n.filter(Boolean),l=[];return u.forEach((d,f)=>{l.push(d),f<u.length-1&&l.push(Kn({className:"g-ui-breadcrumbs-separator"},r))}),Xn({...o,className:s("g-ui-breadcrumbs",a)},l)}import{Div as Jn}from"@granularjs/core";function es(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Jn({...a,className:s("g-ui-center",r)},t)}import{Div as is}from"@granularjs/core";function ts(...e){let{props:i}=g(e,{size:"md"}),{size:t,className:r,...a}=i;return is({...a,className:s("g-ui-space",[t,o=>`g-ui-space-${o}`],r)})}import{Div as rs,when as as}from"@granularjs/core";function os(...e){let{props:i,children:t}=g(e),{opened:r,className:a,...o}=i;return as(r,()=>rs({...o,className:s("g-ui-collapse",a)},t))}import{Button as ns}from"@granularjs/core";function Ge(...e){let{props:i,children:t}=g(e,{size:"md",variant:"filled"}),{size:r,variant:a,color:o,className:n,...u}=i;return ns({...u,type:"button",className:s("g-ui-action-icon",k("g-ui-action-icon-size-",r,"md"),k("g-ui-action-icon-color-",o,"primary"),k("g-ui-action-icon-",a,"filled"),n)},t)}import{Div as Ct,when as ss,after as us,state as gs}from"@granularjs/core";function St(...e){let{props:i,rawProps:t,children:r}=g(e,{position:"left"}),{opened:a,position:o,content:n,className:u,...l}=i,{onChange:d}=t,f=gs(h(a)??!1);us(a).change(y=>{let c=h(y);c!=null&&f.set(!!c)});let w=y=>{f.set(y),d?.(y)};return Ct({...l,className:s("g-ui-popover",i.className??u)},Ct({onClick:()=>w(!f.get())},r),ss(f,()=>Ct({className:s("g-ui-popover-dropdown",o==="right"&&"g-ui-popover-right",o==="center"&&"g-ui-popover-center")},n)))}import{Div as Nr}from"@granularjs/core";function ls(...e){let{props:i,children:t}=g(e,{position:"left"}),{position:r,content:a,className:o,...n}=i;return Nr({...n,className:s("g-ui-hover-card",o)},t,Nr({className:s("g-ui-hover-card-dropdown",[r,u=>u==="right"?"g-ui-hover-card-right":""],[r,u=>u==="center"?"g-ui-hover-card-center":""])},a))}import{Div as cs}from"@granularjs/core";function ps(...e){let{props:i,children:t}=g(e,{position:"bottom-right"}),{position:r,className:a,...o}=i;return cs({...o,className:s("g-ui-affix",[r,n=>`g-ui-affix-${n}`],a)},t)}import{Fieldset as ds,Legend as ms,when as fs}from"@granularjs/core";function hs(...e){let{props:i,children:t}=g(e),{legend:r,className:a,...o}=i;return ds({...o,className:s("g-ui-fieldset",a)},fs(r,()=>ms({className:"g-ui-legend"},r)),t)}import{Div as vs}from"@granularjs/core";function bs(...e){let{props:i,children:t}=g(e,{position:"sticky"}),{position:r,className:a,...o}=i;return vs({...o,className:s("g-ui-appbar",k("g-ui-appbar-",r,"sticky"),a)},t)}import{Div as Dt,portal as xs,after as Vi,state as Cr,when as Sr}from"@granularjs/core";function ws(...e){let{props:i,children:t}=g(e,{position:"left",size:"md",blur:!0,fixed:!1,minWidth:"button"});return Sr(i.fixed,()=>ks(i,t),()=>ys(i,t))}var ys=(e,i)=>{let{open:t,onClose:r,position:a,size:o,blur:n,fixed:u,minWidth:l,className:d,...f}=e,w=Cr(!1),y=Cr(!1),c=220,b=I=>{if(I){w.set(!0),typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>y.set(!0)):setTimeout(()=>y.set(!0),0);return}y.set(!1),setTimeout(()=>w.set(!1),c)};b(!!t.get()),Vi(t).change(I=>b(!!I));let v=Vi(y,n).compute(I=>{let[D,z]=I;return s("g-ui-sidebar-overlay",D&&"g-ui-sidebar-overlay-open",!z&&"g-ui-sidebar-overlay-noblur")}),N=Vi(o,a,y,d).compute(I=>{let[D,z,C,S]=I,m=z==="right"?"g-ui-sidebar-drawer-right g-ui-sidebar-position-right":"g-ui-sidebar-drawer-left";return s("g-ui-sidebar","g-ui-sidebar-drawer",`g-ui-sidebar-size-${D}`,m,C&&"g-ui-sidebar-drawer-open",h(S))});return Sr(w,()=>xs(Dt({className:v,onClick:r},Dt({className:N,onClick:I=>I.stopPropagation()},i))))},ks=(e,i)=>{let{open:t,position:r,size:a,minWidth:o,className:n,...u}=e,l=Vi(a,r,t,o,n).compute(d=>{let[f,w,y,c,b]=d,v=c||"button",N=null;return v==="button"?N="g-ui-sidebar-min-button":v==="xs"?N="g-ui-sidebar-min-xs":v==="sm"?N="g-ui-sidebar-min-sm":v==="md"&&(N="g-ui-sidebar-min-md"),s("g-ui-sidebar g-ui-sidebar-fixed",`g-ui-sidebar-size-${f||"md"}`,N,y&&"g-ui-sidebar-fixed-open",b)});return Dt({...u,className:l},i)};import{Div as Ne,when as Li,list as Dr,after as se,resolve as de,state as zs,Img as Ns,Span as Cs}from"@granularjs/core";var Pr={xs:6,sm:8,md:10,lg:12,xl:14},Ss={xs:"2px",sm:"3px",md:"4px",lg:"6px",xl:"8px"},Ds={xs:"6px",sm:"8px",md:"10px",lg:"12px",xl:"14px"},Ps=14;function Ms(e){if(e==null||e==="")return"var(--g-ui-primary)";let i=String(e).trim();return i.startsWith("#")?i:`var(--g-ui-${i})`}function Ts(e){return(e??[]).map(t=>{if(t==null)return 1;let r=Number(t.weight);return Number.isFinite(r)&&r>=0?r:1})}function Ii(e){let i=(e??[]).length;if(i<2)return{totalWeight:0,cumulativeWeights:[0]};let r=Ts(e).slice(0,i-1),a=r.reduce((n,u)=>n+u,0),o=[0];for(let n=0;n<r.length;n++)o.push(o[n]+r[n]);return{totalWeight:a,cumulativeWeights:o}}function Mr(e,i,t,r){if(r<1||t<=0)return 0;let a=Math.max(0,Math.min(100,e));for(let o=r-1;o>=0;o--){let n=i[o]/t*100;if(a>=n)return o}return 0}function Vs(e,i,t,r,a,o,n){let u=e,l=(n??[]).length;if(l===0)return{activeStep:0,progressPct:0};if(u==="step")return{activeStep:Math.max(0,Math.min(l-1,Math.floor(i??0))),progressPct:0};if(u==="percent"){let d=Math.max(0,Math.min(100,Number(t)||0)),f=Ii(n);return{activeStep:Mr(d,f.cumulativeWeights,f.totalWeight,l),progressPct:d}}if(u==="time"){let d=Number(r)||0,f=a,w=o,y=0;if(Array.isArray(f)&&f.length>=l?y=f.slice(0,l).reduce((D,z)=>D+(Number(z)||0),0):typeof w=="number"&&w>0&&(y=w),y<=0)return{activeStep:0,progressPct:0};let c=y/l,b=0;if(Array.isArray(f)&&f.length>=l){let D=0;for(let z=0;z<l;z++){if(D+=Number(f[z])||0,d<D){b=z;break}b=z}}else b=Math.min(l-1,Math.floor(d/c));let v=Math.min(100,d/y*100),N=Ii(n);return{activeStep:Mr(v,N.cumulativeWeights,N.totalWeight,l),progressPct:v}}return{activeStep:0,progressPct:0}}function Ls(e,i,t,r,a,o){if(a<2||r<0||r>=a-1)return 0;if(e==="step")return i>r?100:0;let{totalWeight:n,cumulativeWeights:u}=o??Ii([]);if(n<=0)return 0;let l=u[r]/n*100,d=u[r+1]/n*100;if(t<=l)return 0;if(t>=d)return 100;let f=d-l;return f<=0?0:(t-l)/f*100}var Is=0;function $s(e){let i=document.getElementById(e);if(!i)return[];let t=i.querySelectorAll(".g-ui-timeline-item");if(t.length<2)return[];let r=i.dataset.pinSize||"md",a=Pr[r]??Pr.md,o=[];for(let n=0;n<t.length-1;n++){let u=t[n].offsetTop+a,l=t[n+1].offsetTop-t[n].offsetTop;o.push({top:u,height:l})}return o}function As(...e){let{props:i,rawProps:t}=g(e,{items:[],mode:"step",active:0,progress:0,elapsedMs:0,stepDurationsMs:null,totalDurationMs:null,clickable:!1,pinRadius:"md",reverseActive:!1,lineWidth:"md",pinSize:"md",activeColor:"primary",align:"left",pinMode:"default"}),{items:r,mode:a,active:o,progress:n,elapsedMs:u,stepDurationsMs:l,totalDurationMs:d,clickable:f,pinRadius:w,reverseActive:y,lineWidth:c,pinSize:b,activeColor:v,align:N,pinMode:I,className:D,...z}=i,{onChange:C}=t,S=se(v).compute(R=>Ms(de(R))),m=`g-ui-timeline-${++Is}`,p=zs([]),L=se(a,o,n,u,l,d,r).compute(R=>{let[G,U,ie,K,P,j,M]=R;return Vs(G,U,ie,K,P,j,M)}),V=se(p,y).compute(([R,G])=>{if(!de(G)||!R?.length)return null;let U=R[0],ie=0;for(let K of R)ie+=K.height;return{top:U.top,height:ie}}),A=se(L).compute(R=>R?.progressPct!=null?`${Math.max(0,Math.min(100,R.progressPct))}%`:"0%"),J=se(a).compute(R=>{let G=de(R);return G==="time"||G==="percent"||G==="step"}),oe=se(a).compute(R=>de(R));function re(){setTimeout(()=>{let R=$s(m);R.length&&p.set(R)},0)}return se(r).change(()=>re()),se(b).change(()=>re()),re(),Ne({...z,id:m,"data-pin-size":se(b).compute(R=>de(R)??"md"),"data-active-color":se(v).compute(R=>{let G=de(R);if(G==null||typeof G!="string")return"primary";let U=String(G).trim();return U.startsWith("#")?"custom":U||"primary"}),style:se(v,c,b).compute(([R,G,U])=>{let ie={"--g-ui-timeline-line-width":Ss[de(G)]??"4px","--g-ui-timeline-track-offset":`calc(${Ps}px - var(--g-ui-timeline-line-width) / 2)`,"--g-ui-timeline-pin-half":Ds[de(U)]??"10px"},K=de(R);return K&&String(K).trim().startsWith("#")&&(ie["--g-ui-timeline-active-color"]=String(K).trim()),ie}),className:s("g-ui-timeline",se(a).compute(R=>R?`g-ui-timeline-mode-${de(R)}`:""),se(J).compute(R=>R?"g-ui-timeline-has-track":""),se(f).compute(R=>de(R)?"g-ui-timeline-clickable":""),se(y).compute(R=>de(R)?"g-ui-timeline-reverse":""),se(N).compute(R=>de(R)==="right"?"g-ui-timeline-align-right":""),k("g-ui-timeline-pin-radius-",w,"md"),k("g-ui-timeline-line-width-",c,"md"),k("g-ui-timeline-pin-size-",b,"md"),se(I).compute(R=>R?`g-ui-timeline-pin-mode-${de(R)}`:""),D)},Li(J,()=>se(y).compute(R=>de(R)?Ne({className:"g-ui-timeline-track-segment g-ui-timeline-track-reverse",style:se(V).compute(G=>G?{top:`${G.top}px`,height:`${G.height}px`}:{})},Ne({className:"g-ui-timeline-track-fill",style:se(A).compute(G=>G?{height:G}:{height:"0%"})})):Dr(p,(G,U)=>{let ie=se(G).compute(j=>j?{top:`${j.top}px`,height:`${j.height}px`}:{}),K=se(L,U,r,oe).compute(([j,M,Y,T])=>{let E=Y??[],H=E.length,ee=Ii(E);return Ls(T,j?.activeStep??0,j?.progressPct??0,de(M)??0,H,ee)}),P=se(K).compute(j=>`${Math.max(0,Math.min(100,j))}%`);return Ne({className:"g-ui-timeline-track-segment",style:se(ie).compute(j=>j)},Ne({className:"g-ui-timeline-track-fill",style:se(P).compute(j=>j?{height:j}:{height:"0%"})}))}))),Dr(r,(R,G)=>{let U=se(L,G,r,y).compute(([E,H,ee,pe])=>{let ke=E?.activeStep??0,Pe=de(H)??0,Fe=(ee??[]).length,Ve=de(pe)?Fe-1-Pe:Pe;return Ve<ke?"completed":Ve===ke?"active":"future"}),ie=se(U).compute(E=>E?`g-ui-timeline-item-${E}`:""),K=de(f)&&typeof C=="function"?()=>{let E=de(G);typeof E=="number"&&C(E)}:void 0,P=se(I).compute(E=>de(E)??"default"),j=se(P,R).compute(([E,H])=>{let ee=E??"default";return ee==="icon"&&(H?.icon!=null||H?.pinIcon!=null)?Cs({className:"g-ui-timeline-pin-icon material-symbols-outlined"},H.icon??H.pinIcon??""):ee==="image"&&(H?.image!=null||H?.pinImage!=null||H?.src!=null)?Ns({className:"g-ui-timeline-pin-image",src:H.image??H.pinImage??H.src,alt:H.pinImageAlt??""}):ee==="custom"&&H?.pinContent!=null?H.pinContent:null}),M=se(P,R).compute(([E,H])=>{let ee=E??"default";return ee==="icon"?H?.icon!=null||H?.pinIcon!=null:ee==="image"?H?.image!=null||H?.pinImage!=null||H?.src!=null:ee==="custom"?H?.pinContent!=null:!1}),Y=Ne({className:"g-ui-timeline-dot"},Ne({className:"g-ui-timeline-dot-inner"}),Li(M,()=>j)),T=Ne({className:"g-ui-timeline-content"},Li(R.title,()=>Ne({className:"g-ui-timeline-title"},R.title)),Li(R.description,()=>Ne({className:"g-ui-timeline-desc"},R.description)),R.content);return Ne({className:s("g-ui-timeline-item",ie),style:se(S).compute(E=>E?{"--g-ui-timeline-active-color":E}:void 0),onClick:K,role:K?"button":void 0,tabIndex:K?0:void 0},Ne({className:"g-ui-dot-wrapper"},Y),T)}))}import{Div as $i,list as Fs}from"@granularjs/core";function Bs(...e){let{props:i}=g(e,{active:0,items:[]}),{active:t,items:r,className:a,...o}=i;return $i({...o,className:s("g-ui-stepper",a)},Fs(r,(n,u)=>$i({className:s("g-ui-stepper-item",[t,l=>(console.log("value",l,"idx",u),u.get()===l?"g-ui-stepper-active":"")])},$i({className:"g-ui-stepper-index"},String(u+1)),$i({className:"g-ui-stepper-label"},n.label))))}import{Span as Tr,after as Vr,state as js}from"@granularjs/core";function Es(...e){let{props:i,rawProps:t}=g(e,{value:0,max:5,size:"md"}),{value:r,max:a,size:o,className:n,...u}=i,{onChange:l}=t,d=js(h(r));Vr(r).change(c=>{let b=h(c);b!=null&&d.set(b)});let f=c=>{d.set(c),l?.(c)},w=[],y=Number(h(a))||0;for(let c=1;c<=y;c+=1)w.push(c);return Tr({...u,className:s("g-ui-rating",k("g-ui-rating-size-",o,"md"),i.className??n)},w.map(c=>Tr({className:s("g-ui-rating-item",Vr(d).compute(b=>c<=b?"g-ui-rating-item-active":"")),onClick:()=>f(c)},"\u2605")))}import{Span as Rs}from"@granularjs/core";function Hs(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Rs({...a,className:s("g-ui-tag",r)},t)}import{Button as Lr,Div as Je,state as Ir,after as Ai}from"@granularjs/core";var Os=["S","M","T","W","T","F","S"];function pi(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{value:r,className:a,size:o,...n}=i,{onChange:u}=t,l=D=>{let z=h(D);if(z instanceof Date)return z;if(z==null)return null;let C=new Date(z);return Number.isNaN(C.getTime())?null:C},d=Ir(l(r)??new Date),f=Ir(new Date(d.get()));Ai(r).change(D=>{let z=l(D);z!=null&&(d.set(z),f.set(new Date(z)))});let w=(D,z,C)=>{let S=new Date(D,z+1,0).getDate();return new Date(D,z,Math.min(C,S))},y=D=>{let z=f.get(),C=w(z.getFullYear(),z.getMonth(),D);d.set(C),f.set(C),u?.(C)},c=D=>{let z=f.get(),C=w(z.getFullYear(),z.getMonth()+D,z.getDate());f.set(C)},b=D=>{let z=f.get(),C=w(z.getFullYear()+D,z.getMonth(),z.getDate());f.set(C)},v=Ai(f).compute(D=>D.toLocaleString("default",{month:"long"})),N=Ai(f).compute(D=>String(D.getFullYear())),I=Ai(f,d).compute(([D,z])=>{let C=D.getFullYear(),S=D.getMonth(),p=new Date(C,S,1).getDay(),L=new Date(C,S+1,0).getDate(),V=[];for(let A=0;A<p;A+=1)V.push({muted:!0,label:""});for(let A=1;A<=L;A+=1)V.push({label:A});return[...Os.map(A=>Je({className:"g-ui-calendar-cell g-ui-calendar-cell-muted"},A)),...V.map(A=>Je({className:s("g-ui-calendar-cell",A.muted&&"g-ui-calendar-cell-muted",A.label&&z.getFullYear()===C&&z.getMonth()===S&&A.label===z.getDate()&&"g-ui-calendar-cell-active"),onClick:()=>A.label&&y(A.label)},A.label))]});return Je({...n,className:s("g-ui-calendar",a,k("g-ui-calendar-size-",o,"md"))},Je({className:"g-ui-calendar-header"},Ge({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>c(-1)},ye({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:ki})),Je({className:"g-ui-calendar-title-group"},Lr({type:"button",className:"g-ui-calendar-title-button",onClick:()=>c(1)},v),Lr({type:"button",className:"g-ui-calendar-title-button",onClick:()=>b(1)},N)),Ge({size:"xs",variant:"subtle",className:"g-ui-calendar-nav",onClick:()=>c(1)},ye({size:"sm",className:"g-ui-calendar-nav-icon",innerHTML:yi}))),Je({className:"g-ui-calendar-grid"},I))}import{Div as di,Span as ei,Input as Ws,when as Pt,after as De,state as Fi}from"@granularjs/core";function qs(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"md",searchable:!0}),{value:r,data:a,size:o,className:n,placeholder:u,searchable:l,...d}=i,{onChange:f,onSearchChange:w}=t,y=Fi(h(r)??[]),c=Fi(""),b=Fi(!1),v=Fi(null),N=p=>(h(p)??[]).map(V=>typeof V=="string"?{value:V,label:V}:V&&typeof V=="object"?V:{value:String(V),label:String(V)});De(r).change(p=>{let L=h(p);L!=null&&y.set(L)});let I=null;De(b).change(p=>{if(I&&(I(),I=null),!p)return;let L=V=>{let A=v.get();A&&(A.contains(V.target)||b.set(!1))};document.addEventListener("mousedown",L),I=()=>document.removeEventListener("mousedown",L)}),De(c).change(p=>{w?.(p)});let D=p=>{let L=y.get()??[],V=L.includes(p)?L.filter(A=>A!==p):L.concat(p);y.set(V),f?.(V)},z=De(a).compute(p=>N(p)),C=De(z,c).compute(([p,L])=>{let V=String(h(L)??"").toLowerCase().trim();return V?p.filter(A=>String(A.label??"").toLowerCase().includes(V)):p}),S=De(y,c).compute(([p,L])=>{let V=h(p)??[],A=String(h(L)??"");return!V.length&&!A}),m=De(l).compute(p=>!!p);return di({...d,node:v,className:s("g-ui-select-multi-root",n)},di({className:s("g-ui-select-multi",k("g-ui-select-multi-size-",o,"md")),onClick:()=>b.set(!0)},De(z,y).compute(([p,L])=>(h(L)??[]).map(A=>{let oe=(p??[]).find(re=>re.value===A)?.label??A;return ei({className:"g-ui-select-tag"},ei({className:"g-ui-select-tag-label",onClick:re=>{re?.stopPropagation?.()}},oe),ei({className:"g-ui-select-tag-remove",innerHTML:je,onClick:re=>{re?.stopPropagation?.(),D(A)}}))})),Pt(S,()=>ei({className:"g-ui-select-multi-placeholder"},u??"Select...")),Pt(m,()=>Ws({className:"g-ui-select-multi-input",value:c,onInput:p=>c.set(p.target?.value??""),onFocus:()=>b.set(!0)}))),Pt(b,()=>di({className:"g-ui-select-dropdown"},De(C).compute(p=>p.length?p.map(L=>di({className:s("g-ui-select-item",L.disabled&&"g-ui-select-item-disabled",De(y).compute(V=>(h(V)??[]).includes(L.value)?"g-ui-select-item-active":"")),onClick:()=>{L.disabled||D(L.value)}},ei({className:"g-ui-select-item-check",innerHTML:De(y).compute(V=>(h(V)??[]).includes(L.value)?zi:"")}),ei({className:"g-ui-select-item-label"},L.label))):di({className:"g-ui-select-item"},"Nothing found")))))}import{Div as _s,list as Zs,portal as Us}from"@granularjs/core";import{Div as Mt,Button as Ys,when as $r,state as Gs}from"@granularjs/core";function Tt(...e){let{props:i,rawProps:t,children:r}=g(e),{title:a,className:o,...n}=i,{onClose:u}=t,l=Gs(!0),d=()=>{l.set(!1),u?.(),console.log("close")};return $r(l,()=>Mt({...n,className:s("g-ui-toast",o)},Mt({className:"g-ui-toast-row"},$r(a,()=>Mt({className:"g-ui-toast-title"},a)),Ys({className:"g-ui-toast-close",onClick:d},ye({innerHTML:je}))),r))}function Xs(...e){let{props:i,rawProps:t}=g(e,{items:[]}),{items:r,className:a,timeout:o,...n}=i,{onClose:u}=t;return Us(_s({...n,className:s("g-ui-toast-stack",a)},Zs(r,l=>Tt({title:l.title,onClose:()=>u?.(l)},l.message))))}function Ks(...e){let{props:i}=g(e);return pi(i)}import{Div as Qs,after as Js}from"@granularjs/core";function eu(...e){let{props:i,rawProps:t}=g(e,{items:[],position:"top-right"}),{items:r,position:a,className:o,...n}=i,{onRemove:u}=t,l=new Map,d=(w,y)=>w?.id??w?.key??y,f=Js(r).compute(w=>{let y=h(w)??[],c=new Set;y.forEach((b,v)=>{let N=d(b,v);if(c.add(N),b?.autoClose&&!l.has(N)){let I=setTimeout(()=>{l.delete(N),u?.(b)},b.autoClose);l.set(N,I)}});for(let[b,v]of l.entries())c.has(b)||(clearTimeout(v),l.delete(b));return y.map((b,v)=>dt({key:d(b,v),title:b.title,color:b.color,icon:b.icon,loading:b.loading,withCloseButton:b.withCloseButton,withBorder:b.withBorder,onClose:()=>{b.onClose?.(),u?.(b)}},b.message??b.body??b.content??b.text))});return Qs({...n,className:s("g-ui-notifications",k("g-ui-notifications-position-",a,"top-right"),o)},f)}import{Div as _e,after as ii,state as iu,when as Ar,list as tu}from"@granularjs/core";function ru(...e){let{props:i,rawProps:t}=g(e,{min:0,max:100,step:1,size:"md"}),{value:r,marks:a,min:o,max:n,step:u,size:l,disabled:d,className:f,...w}=i,{onChange:y}=t,c=iu(h(r??[o,n])),b=ii(a).compute(m=>m&&m.length>0),v=()=>{let m=Number(h(o)),p=Number(h(n));return!Number.isFinite(m)||!Number.isFinite(p)?{minValue:0,maxValue:100}:{minValue:Math.min(m,p),maxValue:Math.max(m,p)}},N=()=>{let m=Number(h(u));return Number.isFinite(m)&&m>0?m:1},I=m=>{let{minValue:p,maxValue:L}=v(),V=N(),A=[p,L];Array.isArray(m)&&(A=m);let J=Math.max(p,Math.min(L,Number(A[0]))),oe=Math.max(p,Math.min(L,Number(A[1]))),re=Math.round(Math.min(J,oe)/V)*V,R=Math.round(Math.max(J,oe)/V)*V;return[re,R]};ii(r).change(m=>{m!=null&&c.set(I(m))});let D=m=>{let p=I(m);p?.[0]===c.get()?.[0]&&p?.[1]===c.get()?.[1]||(c.set(p),y?.(p))},z=ii(c).compute(m=>{let{minValue:p,maxValue:L}=v(),V=L-p,[A,J]=I(m);if(V<=0)return{lowPct:0,highPct:0};let oe=(A-p)/V*100,re=(J-p)/V*100;return{lowPct:Math.max(0,Math.min(100,oe)),highPct:Math.max(0,Math.min(100,re))}}),C=(m,p,L)=>{let V=p?.();if(!V||V.width===0)return;let J=Math.min(Math.max(m.clientX-V.left,0),V.width)/V.width,{minValue:oe,maxValue:re}=v(),R=oe+J*(re-oe),G=c;typeof c.get=="function"&&(G=c.get());let[U,ie]=I(G);D(L==="low"?[R,ie]:[U,R])},S=(m,p,L)=>{if(ze(d))return;m.preventDefault?.();let V=L||m.currentTarget,A=()=>V.getBoundingClientRect(),J=A(),oe=z;typeof z.get=="function"&&(oe=z.get());let{lowPct:re,highPct:R}=oe,G=(m.clientX-J.left)/J.width*100,U=p;if(!U){let P=Math.abs(G-re)<=Math.abs(G-R);U="high",P&&(U="low")}V.setPointerCapture?.(m.pointerId),C(m,A,U);let ie=P=>C(P,A,U),K=()=>{V.releasePointerCapture?.(m.pointerId),window.removeEventListener("pointermove",ie),window.removeEventListener("pointerup",K)};window.addEventListener("pointermove",ie),window.addEventListener("pointerup",K)};return _e({...w,className:s("g-ui-range-slider",k("g-ui-slider-size-",l,"md"),_("g-ui-slider-disabled",d),i.className??f)},_e({className:"g-ui-slider-track",onPointerDown:m=>S(m)},_e({className:"g-ui-slider-bar",style:ii(z).compute(({lowPct:m,highPct:p})=>({left:`${m}%`,width:`${Math.max(0,p-m)}%`}))}),_e({className:"g-ui-slider-thumb",style:ii(z).compute(({lowPct:m})=>({left:`${m}%`})),onPointerDown:m=>{m.stopPropagation?.(),S(m,"low",m.currentTarget.parentElement)}}),_e({className:"g-ui-slider-thumb",style:ii(z).compute(({highPct:m})=>({left:`${m}%`})),onPointerDown:m=>{m.stopPropagation?.(),S(m,"high",m.currentTarget.parentElement)}})),Ar(b,()=>_e({className:"g-ui-slider-marks-placeholder"})),Ar(a,()=>_e({className:"g-ui-slider-marks"},tu(a,m=>xt({mark:m,getBounds:v})))))}import{state as Vt,after as Fr}from"@granularjs/core";function Bi(...e){let{props:i,rawProps:t}=g(e,{size:"md",format:{pattern:"dddd-dd-dd"}}),{value:r,size:a,calendarSize:o,leftSection:n,rightSection:u,className:l,format:d,minDate:f,maxDate:w,...y}=i,{onChange:c}=t,b=m=>{let p=h(m);if(p instanceof Date)return p;if(p==null||p==="")return null;let L=new Date(p);return Number.isNaN(L.getTime())?null:L},v=(m,p)=>m&&p&&m.getFullYear()===p.getFullYear()&&m.getMonth()===p.getMonth()&&m.getDate()===p.getDate(),N=m=>{if(!m)return"";let p=String(m.getFullYear()).padStart(4,"0"),L=String(m.getMonth()+1).padStart(2,"0"),V=String(m.getDate()).padStart(2,"0");return`${p}-${L}-${V}`},I=m=>{let p=String(m??"").replace(/\D/g,"");if(p.length<8)return null;let L=Number(p.slice(0,4)),V=Number(p.slice(4,6)),A=Number(p.slice(6,8));if(!L||!V||!A)return null;let J=new Date(L,V-1,A);if(J.getFullYear()!==L||J.getMonth()!==V-1||J.getDate()!==A)return null;let oe=b(f);if(oe&&J<oe)return null;let re=b(w);return re&&J>re?null:J},D=Vt(b(r)),z=Vt(N(D.get())),C=Vt(!1);Fr(r).change(m=>{let p=b(m);if(!v(p,D.get())){if(p==null){D.set(null),z.set("");return}D.set(p),z.set(N(p))}}),Fr(z).change(m=>{let p=I(m);p&&(v(p,D.get())||(D.set(p),c?.(p)))});let S=m=>{m&&(v(m,D.get())||(D.set(m),z.set(N(m)),c?.(m),C.set(!1)))};return St({opened:C,onChange:m=>C.set(!!m),content:pi({size:k("",o,"xs"),value:D,onChange:S}),className:"g-ui-date-input-popover"},be({...y,size:a,className:s("g-ui-dateinput",l),leftSection:n,rightSection:u,type:"text",inputMode:"numeric",format:d,value:z,onChange:m=>z.set(m)}))}import{Div as Lt,when as au,after as ou,state as nu}from"@granularjs/core";function su(...e){let{props:i,rawProps:t,children:r}=g(e),{opened:a,content:o,className:n,...u}=i,{onChange:l}=t,d=nu(h(a)??!1);ou(a).change(w=>{let y=h(w);y!=null&&d.set(!!y)});let f=w=>{d.set(w),l?.(w)};return Lt({...u,className:s("g-ui-popper",n)},Lt({onClick:()=>f(!d.get())},r),au(d,()=>Lt({className:"g-ui-popper-dropdown"},o)))}import{Button as uu,after as Br,when as gu,state as lu}from"@granularjs/core";function cu(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{size:r,className:a,rightSection:o,...n}=i,{onChange:u}=t,l=lu(!1),d=Br(l).compute(w=>w?"text":"password"),f=Br(o).compute(w=>w??uu({className:"g-ui-password-toggle",onClick:()=>l.set(!l.get())},gu(l,()=>"Hide",()=>"Show")));return be({...n,size:r,className:a,onChange:u,rightSection:f,type:d})}import{Div as pu}from"@granularjs/core";function du(...e){let{props:i}=g(e,{size:"md"}),{size:t,className:r,...a}=i;return be({...a,size:t,className:r,leftSection:pu({className:"g-ui-search-input-left-section",innerHTML:Qt}),type:"text",inputMode:"search"})}import{Button as mu,after as fu,when as jr}from"@granularjs/core";import{state as hu}from"@granularjs/core";function vu(...e){let{props:i,children:t}=g(e,{value:"",timeout:1500}),{value:r,timeout:a,className:o,...n}=i,u=hu(!1),l=fu(u).compute(f=>s("g-ui-copy-button",f&&"g-ui-copy-button-done",o));return mu({...n,className:l,onClick:async()=>{try{await navigator.clipboard.writeText(String(r)),u.set(!0),setTimeout(()=>u.set(!1),a)}catch{}},type:"button"},jr(t?.length,()=>t,()=>jr(u,()=>"Copied",()=>"Copy")))}import{Div as Er,after as ti,resolve as bu}from"@granularjs/core";function Rr(e){let i=Number(e);return Number.isNaN(i)?0:Math.max(0,Math.min(100,i))}function xu(...e){let{props:i}=g(e,{size:"md",value:null,color:"primary"}),{size:t,value:r,color:a,className:o,style:n,inset:u,...l}=i,d=ti(r).compute(v=>v!=null&&v!==""),f=ti(r).compute(v=>Rr(v)),w=ti(f,d,n,t).compute(([v,N,I,D])=>{let z={...I};if(isFinite(D)&&(z.width=D+"px",z.height=D+"px"),!N)return z;let C=Number(v),S=Number.isNaN(C)?0:Math.max(0,Math.min(360,C*3.6));return z.background=`conic-gradient(var(--g-ui-progress-ring-fill, var(--g-ui-primary)) 0deg ${S}deg, var(--g-ui-border-muted) ${S}deg 360deg)`,z}),y=ti(u).compute(v=>{let N={};return isFinite(v)&&(N.inset=v+"px"),N}),c=ti(d).compute(v=>v?"":"g-ui-progress-ring-indeterminate"),b=ti(d,r).compute(([v,N])=>v?Rr(N):void 0);return Er({...l,className:s("g-ui-progress-ring",k("g-ui-progress-ring-",a,"primary"),[t,v=>`g-ui-progress-ring-size-${bu(v)??"md"}`],c,o),style:w,role:"progressbar","aria-valuemin":0,"aria-valuemax":100,"aria-valuenow":b},Er({className:"g-ui-progress-ring-hole",style:y}))}import{Div as ji,state as $t,after as Ze,list as yu,when as ku}from"@granularjs/core";import{Div as wu}from"@granularjs/core";function It(...e){let{props:i,children:t}=g(e,{size:"md"}),{size:r,className:a,...o}=i;return wu({...o,className:s("g-ui-scroll-area",[r,n=>`g-ui-scroll-area-${n}`],a)},t)}function $e(e,i){if(i==null||i==="")return e;let t=String(i).trim().split("."),r=e;for(let a of t)r=r?.[a];return r}function zu(e,i,t){let r=t(i);return String(r??"").toLowerCase().includes(String(e??"").toLowerCase())}function At(...e){let{props:i,rawProps:t}=g(e,{data:[],size:"md",valuePath:"value",labelPath:"label"}),{data:r,value:a,size:o,valuePath:n,labelPath:u,filter:l,placeholder:d,label:f,description:w,error:y,leftSection:c,rightSection:b,className:v,inputClassName:N,disabled:I,...D}=i,{onChange:z,renderItem:C}=t,S=$t(!1),m=$t(""),p=$t(h(a));Ze(a).change(M=>{let Y=h(M);Y!==p.get()&&p.set(Y)});let L=Ze(r).compute(M=>Array.isArray(M)?M:[]),V=Ze(L,p,n).compute(([M,Y,T])=>{if(Y==null)return null;let E=H=>T==null||T===""?H:$e(H,T);return M.find(H=>E(H)===Y)??null}),A=Ze(V,S,m,u).compute(([M,Y,T,E])=>{let H=ee=>E==null||E===""?String(ee??""):String($e(ee,E)??"");return Y?T??"":M?H(M):""}),J=Ze(L,m,l,u).compute(([M,Y,T,E])=>{let H=pe=>E==null||E===""?String(pe??""):String($e(pe,E)??""),ee=h(T)??zu;return M.filter(pe=>ee(Y,pe,H))}),oe=M=>{let Y=h(n),T=Y==null||Y===""?M:$e(M,Y);p.set(T),m.set(""),S.set(!1),z?.(T)},re=()=>{if(h(I))return;S.set(!0);let M=V.get(),Y=h(u),T=E=>Y==null||Y===""?String(E??""):String($e(E,Y)??"");m.set(M?T(M):"")},R=()=>{S.set(!1);let M=V.get(),Y=h(u),T=E=>Y==null||Y===""?String(E??""):String($e(E,Y)??"");m.set(M?T(M):"")},{onChange:G,...U}=D,ie={...U,size:o,label:f,description:w,error:y,leftSection:c,rightSection:b,placeholder:h(d)??void 0,disabled:I,value:A,onInput:M=>m.set(M?.target?.value??""),onFocus:re,onClick:re,onBlur:()=>setTimeout(()=>R(),150)},K=M=>{let Y=h(n);return Y==null||Y===""?M:$e(M,Y)},P=M=>Ze(p,n).compute(([Y,T])=>(H=>T==null||T===""?H:$e(H,T))(M)===Y?"g-ui-autocomplete-item-active":""),j=M=>{if(C&&typeof C=="function"){let Y=C(M);if(Y!=null)return ji({className:s("g-ui-autocomplete-item",P(M)),onClick:()=>oe(M),role:"option"},Y)}return ji({className:s("g-ui-autocomplete-item",P(M)),onClick:()=>oe(M),role:"option"},Ze(u).compute(Y=>Y==null||Y===""?String(M??""):String($e(M,Y)??"")))};return ji({className:s("g-ui-autocomplete",v,_("g-ui-autocomplete-disabled",I))},be({...ie,className:s("g-ui-autocomplete-input-wrapper",ie.className),inputClassName:s("g-ui-autocomplete-input",N)}),ku(S,()=>ji({className:"g-ui-autocomplete-dropdown",role:"listbox"},It({className:"g-ui-autocomplete-list",style:{maxHeight:"240px"}},yu(J,M=>j(M))))))}function Nu(...e){return At(...e)}import{Div as Cu,Span as Su,state as Hr,after as Du}from"@granularjs/core";function Or(e){let i=h(e);if(i instanceof Date)return i;if(i==null||i==="")return null;let t=new Date(i);return Number.isNaN(t.getTime())?null:t}function Wr(e){let i=h(e);if(i==null)return[null,null];let t=Array.isArray(i)?i:[i];return[Or(t[0]),Or(t[1])]}function qr(e,i){return!e||!i?e===i:e.getFullYear()===i.getFullYear()&&e.getMonth()===i.getMonth()&&e.getDate()===i.getDate()}function Pu(...e){let{props:i,rawProps:t}=g(e,{size:"md"}),{value:r,size:a,minDate:o,maxDate:n,className:u,placeholderMin:l,placeholderMax:d,...f}=i,{onChange:w}=t,[y,c]=Wr(r),b=Hr(y),v=Hr(c);Du(r).change(z=>{let[C,S]=Wr(z);qr(C,b.get())&&qr(S,v.get())||(b.set(C),v.set(S))});let N=()=>{let z=b.get(),C=v.get();w?.([z??null,C??null])},I=z=>{let C=v.get();z&&C&&z>C&&v.set(z),b.set(z),N()},D=z=>{let C=b.get();z&&C&&z<C&&b.set(z),v.set(z),N()};return Cu({...f,className:s("g-ui-range-picker",i.className??u)},Bi({...f,size:a,value:b,onChange:I,maxDate:v,placeholder:h(l)??void 0}),Su({className:"g-ui-range-picker-separator"},"\u2013"),Bi({...f,size:a,value:v,onChange:D,minDate:b,placeholder:h(d)??void 0}))}import{Div as Mu}from"@granularjs/core";function Tu(...e){let{props:i,children:t}=g(e,{align:"center",direction:"row"}),{direction:r,wrap:a,align:o,justify:n,gap:u,className:l,...d}=i;return Mu({...d,className:s("g-ui-flex",[r,f=>f==="column"?"g-ui-flex-column":"g-ui-flex-row"],[a,"g-ui-flex-wrap"],[o,f=>f&&`g-ui-align-${f}`],[n,f=>f&&`g-ui-justify-${f}`],[u,f=>f&&`g-ui-gap-${f}`],l)},t)}import{A as Vu,Div as mi,Span as Yr,when as fi,after as Gr,state as Lu}from"@granularjs/core";function Iu(...e){let{props:i,rawProps:t,children:r}=g(e,{variant:"subtle",childrenOffset:24}),{label:a,description:o,leftSection:n,rightSection:u,active:l,disabled:d,variant:f,childrenOffset:w,opened:y,defaultOpened:c,className:b,padding:v,...N}=i,{onClick:I,onChange:D}=t,z=r.length>0,C=Lu(h(y)??h(c)??!1);Gr(y).change(p=>{let L=h(p);L!=null&&C.set(!!L)});let S=Gr(n).compute(p=>Oe(p)?p?.get?p.get():null:p),m=p=>{if(h(d)){p?.preventDefault?.();return}if(z){let L=!C.get();C.set(L),D?.(L)}I?.(p)};return mi({className:s("g-ui-navlink-root",b)},Vu({...N,className:s("g-ui-navlink",k("g-ui-navlink-variant-",f,"subtle"),_("g-ui-navlink-active",l),_("g-ui-navlink-disabled",d),k("g-ui-navlink-padding-",v,"md")),onClick:m},fi(S,()=>Yr({className:"g-ui-navlink-section g-ui-navlink-left"},n)),mi({className:"g-ui-navlink-body"},fi(a,()=>mi({className:"g-ui-navlink-label"},a)),fi(o,()=>mi({className:"g-ui-navlink-description"},o))),fi(u,()=>Yr({className:"g-ui-navlink-section g-ui-navlink-right"},u))),z&&fi(C,()=>mi({className:"g-ui-navlink-children"},r)))}import{Div as _r,when as $u}from"@granularjs/core";function Au(...e){let{props:i,children:t}=g(e,{show:!0,position:"top-right",color:"danger",size:"md"}),{show:r,position:a,color:o,size:n,className:u,...l}=i;return _r({...l,className:s("g-ui-indicator",k("g-ui-indicator-position-",a,"top-right"),k("g-ui-indicator-color-",o,"danger"),k("g-ui-indicator-size-",n,"md"),u)},t,$u(r,()=>_r({className:"g-ui-indicator-badge"})))}import{Span as Ei}from"@granularjs/core";function Fu(...e){let{props:i}=g(e),{opened:t,className:r,...a}=i;return Ei({...a,className:s("g-ui-burger",[t,"g-ui-burger-open"],r)},Ei(""),Ei(""),Ei(""))}import{Div as Bu,when as ju}from"@granularjs/core";function Eu(...e){let{props:i}=g(e),{visible:t,...r}=i;return ju(t,()=>Bu({...r,className:"g-ui-loading-overlay"},ui({})))}import{Div as Ru}from"@granularjs/core";function Hu(...e){let{props:i,children:t}=g(e,{gap:"md"}),{className:r,gap:a,...o}=i;return Ru({...o,className:s("g-ui-grid-system",[a,n=>`g-ui-gap-${n}`],r)},t)}import{Div as Ou}from"@granularjs/core";function Wu(...e){let{props:i,children:t}=g(e,{span:12}),{span:r,className:a,...o}=i;return Ou({...o,className:s([r,n=>`g-ui-col-span-${n}`],a)},t)}import{Div as Zr,Input as qu,after as Ae,state as Ft,when as Ur,list as Yu}from"@granularjs/core";function Gu(...e){let{props:i,rawProps:t}=g(e,{length:4,size:"md",type:"alphanumeric",mask:!1,placeholder:"\u25CB",disabled:!1,error:!1,oneTimeCode:!1}),{length:r,value:a,size:o,type:n,mask:u,placeholder:l,disabled:d,error:f,oneTimeCode:w,className:y}=i,{onChange:c,onComplete:b}=t,v=Ft(h(r)??4),N=()=>v.get();Ae(r).change(P=>{let j=h(P)??4,M=v.get();if(j===M)return;v.set(j);let Y=D.get(),T=I.get();D.set(Array.from({length:j},(E,H)=>Y[H]??"")),I.set(Array.from({length:j},(E,H)=>T[H]??null))});let I=Ft(Array.from({length:N()},()=>null)),D=Ft(Array.from({length:N()},(P,j)=>{let M=h(a);return typeof M=="string"||Array.isArray(M)?M[j]??"":""}));Ae(a).change(P=>{if(P==null)return;let j=N();typeof P=="string"?D.set(Array.from({length:j},(M,Y)=>P[Y]??"")):Array.isArray(P)&&D.set(Array.from({length:j},(M,Y)=>P[Y]??""))});let z=()=>D.get().join(""),C=P=>{D.set(P);let j=P.join("");c?.(j),P.every(M=>M!=="")&&P.length===N()&&b?.(j)},S=P=>{let j=N(),M=I.get();P>=0&&P<j&&M[P]&&(M[P].focus(),M[P].select())},m=()=>{let P=h(n);return P==="number"?/^[0-9]$/:P instanceof RegExp?P:/^[a-zA-Z0-9]$/},p=(P,j)=>{let M=j.target.value,Y=m();if(M.length>1){L(P,M);return}if(M&&!Y.test(M)){j.target.value=D.get()[P]??"";return}let T=D.get().slice();T[P]=M,C(T),M&&P<N()-1&&S(P+1)},L=(P,j)=>{let M=m(),Y=j.split("").filter(ee=>M.test(ee)),T=D.get().slice(),E=N();Y.forEach((ee,pe)=>{let ke=P+pe;ke<E&&(T[ke]=ee)}),C(T);let H=T.findIndex((ee,pe)=>pe>=P&&ee==="");H>=0?S(H):S(Math.min(P+Y.length,E-1))},V=(P,j)=>{if(j.key==="Backspace"){let M=D.get().slice();M[P]===""&&P>0?(j.preventDefault(),M[P-1]="",C(M),S(P-1)):M[P]!==""&&(M[P]="",C(M))}else j.key==="ArrowLeft"&&P>0?(j.preventDefault(),S(P-1)):j.key==="ArrowRight"&&P<N()-1&&(j.preventDefault(),S(P+1))},A=(P,j)=>{j.target.select()},J=()=>{let P=D.get(),j=P.findIndex(M=>M==="");j>=0?S(j):S(P.length-1)},oe=Ae(u).compute(P=>h(P)?"password":"text"),re=Ae(n).compute(P=>h(P)==="number"?"numeric":"text"),R=Ae(w).compute(P=>h(P)?"one-time-code":"off"),G=Ae(d).compute(P=>!!h(P)),U=Ae(f).compute(P=>!!h(P)),ie=Ae(v).compute(P=>Array.from({length:P},(j,M)=>M)),K=P=>qu({className:s("g-ui-pin-input-field",Ur(U,()=>"g-ui-pin-input-error")),type:oe,inputMode:re,autocomplete:R,maxLength:2,placeholder:Ur(G,()=>"",()=>l),disabled:G,value:Ae(D,P).compute(([j,M])=>j[M]??""),node:I[P.get()],onInput:j=>p(P.get(),j),onChange:j=>p(P.get(),j),onKeyDown:j=>V(P.get(),j),onFocus:j=>A(P.get(),j)});return Zr({className:s("g-ui-pin-input",k("g-ui-input-size-",o,"md"),y),onClick:J},Zr({className:"g-ui-pin-input-wrapper"},Yu(ie,K)))}import{Div as _u}from"@granularjs/core";function Zu(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return _u({...a,className:s("g-ui-checkbox-group",r)},t)}import{Div as Uu}from"@granularjs/core";function Xu(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Uu({...a,className:s("g-ui-avatar-group",r)},t)}import{Div as Ku}from"@granularjs/core";function Qu(...e){let{props:i,children:t}=g(e),{className:r,...a}=i;return Ku({...a,className:s("g-ui-badge-group",r)},t)}import{Div as Ri,Span as Ju,after as hi,context as Xr}from"@granularjs/core";var eg=Xr([]),Kr=Xr({sort:null,onSort:null});function Bt(...e){let{props:i,rawProps:t,children:r}=g(e,{sizes:[],sort:null,stickyHeader:!1}),{className:a,sizes:o,sort:n,stickyHeader:u,...l}=i,{onSort:d}=t,f=eg.scope(o.get());hi(o).change(y=>f.set(y));let w=Kr.scope({sort:n.get(),onSort:d||null});return hi(n).change(y=>w.set().sort=y),f.serve(w.serve(Ri({className:s("g-ui-grid-table",_("g-ui-grid-table-sticky",u),a),style:{gridTemplateColumns:hi(f).compute(y=>Array.isArray(y)?y.join(" "):"")},...l},r)))}Bt.GridRow=(...e)=>{let{props:i,children:t}=g(e,{}),{className:r,header:a,...o}=i;return Ri({className:s("g-ui-grid-table-row",_("g-ui-grid-table-row-header",a),r),...o},...t)};Bt.GridCell=function(...e){let{props:i,rawProps:t,children:r}=g(e,{}),{className:a,sort:o,...n}=i,u=t.sort;if(u){let l=Kr.state(),d=hi(l.sort).compute(w=>w?.key===u?w.direction:null),f=()=>{let w=l.get().sort,y;w?.key===u?y=w.direction==="asc"?{key:u,direction:"desc"}:null:y={key:u,direction:"asc"},l.set().sort=y;let{onSort:c}=l.get();c&&c(y)};return Ri({className:s("g-ui-grid-table-cell","g-ui-grid-table-cell-sortable",a),onClick:f,...n},r,Ju({className:"g-ui-grid-table-sort-icon"},hi(d).compute(w=>w==="asc"?" \u2191":w==="desc"?" \u2193":"")))}return Ri({className:s("g-ui-grid-table-cell",a),...n},r)};import{Button as ig,Div as tg,Span as Qr,when as Jr}from"@granularjs/core";function ea(...e){let{props:i,children:t}=g(e,{grow:!0}),{grow:r,className:a,...o}=i;return tg({...o,className:s("g-ui-bottombar",_("g-ui-bottombar-grow",r),a)},t)}ea.Action=function(...i){let{props:t,rawProps:r,children:a}=g(i,{variant:"subtle"}),{icon:o,label:n,active:u,disabled:l,variant:d,className:f,...w}=t,{onClick:y}=r;return ig({...w,className:s("g-ui-bottombar-action",k("g-ui-bottombar-action-variant-",d,"subtle"),_("g-ui-bottombar-action-active",u),_("g-ui-bottombar-action-disabled",l),f),onClick:y,disabled:l},Jr(o,()=>Qr({className:"g-ui-bottombar-action-icon"},o)),Jr(n,()=>Qr({className:"g-ui-bottombar-action-label"},n)),a)};import{Div as W,Button as Ue,state as me,after as Ce,when as fe,Input as Hi,Label as vi,Span as Xe}from"@granularjs/core";var rg=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],ag=[{value:"day",label:"Day"},{value:"week",label:"Week"},{value:"month",label:"Month"}];function Oi(e){if(e instanceof Date)return e;if(e==null)return null;let i=new Date(e);return Number.isNaN(i.getTime())?null:i}function ra(e){let i=Oi(e.start),t=Oi(e.end);return!i||!t?null:{...e,id:e.id??`${i.getTime()}-${e.title??"event"}`,title:e.title??"",start:i,end:t,allDay:!!e.allDay,description:e.description??"",location:e.location??"",attendees:Array.isArray(e.attendees)?e.attendees:[],color:e.color??null}}function aa(e,i,t){let r=Oi(i).getTime(),a=Oi(t).getTime();return e.map(ra).filter(Boolean).filter(o=>o.end.getTime()>r&&o.start.getTime()<a)}function ia(e,i){let t=new Date(i);t.setHours(0,0,0,0);let r=t.getTime();t.setHours(23,59,59,999);let a=t.getTime();return aa(e,r,a)}function jt(e,i){let t=new Date(e),a=(t.getDay()-i+7)%7;return t.setDate(t.getDate()-a),t.setHours(0,0,0,0),t}function ri(e,i="default"){return e.toLocaleTimeString(i,{hour:"numeric",minute:"2-digit",hour12:!0})}function bi(e,i="default"){return e.toLocaleDateString(i,{weekday:"short",month:"short",day:"numeric"})}function og(e,i="default"){return e.toLocaleDateString(i,{month:"long",year:"numeric"})}function ng(e,i="default"){let t=new Date(e);return t.setDate(t.getDate()+6),`${e.toLocaleDateString(i,{month:"short",day:"numeric"})} \u2013 ${t.toLocaleDateString(i,{month:"short",day:"numeric",year:"numeric"})}`}function ta(e,i,t,r){let a=new Date(e).setHours(t,0,0,0),o=new Date(e).setHours(r,0,0,0),n=(r-t)*60,u=Math.max(e.getTime(),a),d=(Math.min(i.getTime(),o)-u)/6e4,f=(u-a)/6e4/n*100,w=d/n*100;return{top:f,height:w}}function sg(...e){let{props:i,rawProps:t}=g(e,{defaultView:"month",firstDayOfWeek:0,locale:"default",hourSlotDuration:30,minTime:6,maxTime:22,eventCreationColorOptions:[]}),{events:r=[],defaultView:a,firstDayOfWeek:o,locale:n,hourSlotDuration:u,minTime:l,maxTime:d,eventCreationColorOptions:f,className:w,...y}=i,{onCreateEventRequest:c,onViewEventRequest:b,onUpdateEventRequest:v,onRemoveEventRequest:N,eventCreationEmailLookup:I,eventCreationLocationsCallback:D,eventCreationCalendarsCallback:z,onSlotClick:C,onDateRangeChange:S}=t,m=me(h(a)??"month"),p=me(new Date),L=me(null),V=me(null),A=me({title:"",start:null,end:null,allDay:!1,description:"",location:"",attendees:[],color:null}),J=Ce(r).compute(x=>Array.isArray(x)?x:[]),oe=p.get(),re=jt(oe,h(o)??0),R=h(l)??6,G=h(d)??22,U=h(u)??30,ie=()=>{let x=new Date(p.get());m.get()==="month"?x.setMonth(x.getMonth()-1):m.get()==="week"?x.setDate(x.getDate()-7):x.setDate(x.getDate()-1),p.set(x),S?.({start:x,end:x,view:m.get()})},K=()=>{let x=new Date(p.get());m.get()==="month"?x.setMonth(x.getMonth()+1):m.get()==="week"?x.setDate(x.getDate()+7):x.setDate(x.getDate()+1),p.set(x),S?.({start:x,end:x,view:m.get()})},P=()=>{let x=new Date;p.set(x),S?.({start:x,end:x,view:m.get()})},j=(x,O,ce=!1)=>{let X=x?new Date(x):new Date(p.get()),ge=O?new Date(O):new Date(X.getTime()+3600*1e3);ce&&(X.setHours(0,0,0,0),ge.setHours(23,59,59,999)),A.set({title:"",start:X,end:ge,allDay:ce,description:"",location:"",attendees:[],color:null}),L.set("create")},M=x=>{V.set(ra(x)),L.set("view"),b?.(x)},Y=()=>{let x=V.get();x&&(A.set({title:x.title,start:new Date(x.start),end:new Date(x.end),allDay:x.allDay,description:x.description??"",location:x.location??"",attendees:[...x.attendees||[]],color:x.color??null}),L.set("edit"))},T=()=>{L.set(null),V.set(null)},E=(x,O,ce)=>{if(C){C({date:x,hour:O,allDay:ce});return}let X=new Date(x);if(ce){X.setHours(0,0,0,0);let ge=new Date(X);ge.setHours(23,59,59,999),j(X,ge,!0)}else{X.setHours(O,0,0,0);let ge=new Date(X.getTime()+U*60*1e3);j(X,ge,!1)}},H=()=>{let x=A.get();!x.start||!x.end||c?.({title:x.title,start:x.start,end:x.end,allDay:x.allDay,description:x.description,location:x.location,attendees:x.attendees,color:x.color},()=>{T()})},ee=()=>{let x=V.get(),O=A.get();!x||!O.start||!O.end||v?.(x,{title:O.title,start:O.start,end:O.end,allDay:O.allDay,description:O.description,location:O.location,attendees:O.attendees,color:O.color},()=>T())},pe=()=>{let x=V.get();x&&N?.(x,()=>T())},ke=Ce(m,p).compute(([x,O])=>x==="month"?og(O,h(n)):x==="week"?ng(jt(O,h(o)??0),h(n)):bi(O,h(n))),Pe=W({className:"g-ui-event-calendar-header"},W({className:"g-ui-event-calendar-nav-group"},Ge({size:"sm",variant:"subtle",onClick:ie,className:"g-ui-event-calendar-nav"},ye({size:"sm",innerHTML:ki})),Ge({size:"sm",variant:"subtle",onClick:K,className:"g-ui-event-calendar-nav"},ye({size:"sm",innerHTML:yi})),Ue({type:"button",variant:"subtle",size:"sm",className:"g-ui-event-calendar-today",onClick:P},ye({size:"sm",className:"g-ui-event-calendar-today-icon",innerHTML:tr}),"Today")),W({className:"g-ui-event-calendar-title"},ke),W({className:"g-ui-event-calendar-actions"},ag.map(x=>W({className:s("g-ui-event-calendar-view-option",Ce(m).compute(O=>O===x.value?"g-ui-event-calendar-view-option-active":"")),onClick:()=>{m.set(x.value),S?.({start:p.get(),end:p.get(),view:x.value})}},x.label)),Ue({type:"button",variant:"filled",size:"sm",className:"g-ui-event-calendar-create-btn",onClick:()=>j(p.get(),null,!1)},ye({size:"sm",innerHTML:Jt}),"Create"))),Fe=Ce(p,J,o).compute(([x,O,ce])=>{let X=x.getFullYear(),ge=x.getMonth(),ue=(new Date(X,ge,1).getDay()-(ce??0)+7)%7,Te=new Date(X,ge+1,0).getDate(),Le=new Date(X,ge,0).getDate(),F=[],$=1,q=1,Z=Math.ceil((ue+Te)/7)*7,ne=[];for(let te=0;te<Z;te+=1){let Q,ae,le;te<ue?(Q=Le-ue+te+1,le=new Date(X,ge-1,Q),ae=!1):$<=Te?(Q=$,le=new Date(X,ge,Q),ae=!0,$+=1):(Q=q,le=new Date(X,ge+1,Q),ae=!1,q+=1);let xe=ia(O,le),Be=le.getDate()===new Date().getDate()&&le.getMonth()===new Date().getMonth()&&le.getFullYear()===new Date().getFullYear();ne.push(W({key:le.getTime(),className:s("g-ui-event-calendar-month-cell",!ae&&"g-ui-event-calendar-month-cell-outside",Be&&"g-ui-event-calendar-month-cell-today")},W({className:"g-ui-event-calendar-month-cell-header",onClick:()=>E(le,0,!0)},Xe({className:"g-ui-event-calendar-month-cell-day"},le.getDate())),W({className:"g-ui-event-calendar-month-cell-events"},xe.slice(0,3).map(Se=>W({key:Se.id,className:"g-ui-event-calendar-month-event",style:Se.color?{borderLeftColor:Se.color,backgroundColor:`${Se.color}20`}:{},onClick:Gi=>{Gi.stopPropagation(),M(Se)}},Se.title||"(No title)")),fe(xe.length>3,()=>W({className:"g-ui-event-calendar-month-more",onClick:Se=>{Se.stopPropagation(),M(xe[3])}},`+${xe.length-3} more`)))))}return ne}),Ve=W({className:"g-ui-event-calendar-month"},W({className:"g-ui-event-calendar-weekdays"},rg.map(x=>W({key:x,className:"g-ui-event-calendar-weekday"},x))),W({className:"g-ui-event-calendar-month-grid"},Fe)),Me=[];for(let x=R;x<G;x+=1)for(let O=0;O<60;O+=U)Me.push(x+O/60);let ai=Ce(p,o).compute(([x,O])=>{let ce=jt(x,O??0),X=[];for(let ge=0;ge<7;ge+=1){let he=new Date(ce);he.setDate(he.getDate()+ge),X.push(he)}return X}),Wi=W({className:"g-ui-event-calendar-week"},Ce(ai).compute(x=>W({className:"g-ui-event-calendar-week-days"},W({className:"g-ui-event-calendar-week-time-col"},""),(x||[]).map(O=>W({key:O.getTime(),className:"g-ui-event-calendar-week-day-col"},W({className:"g-ui-event-calendar-week-day-header"},bi(O,h(n))))))),W({className:"g-ui-event-calendar-week-body"},W({className:"g-ui-event-calendar-week-time-col"},Me.map(x=>{let O=Math.floor(x),ce=(x-O)*60,X=`${O<=12?O:O-12}:${ce===0?"00":ce} ${O<12?"AM":"PM"}`;return W({key:x,className:"g-ui-event-calendar-week-slot-label"},X)})),Ce(ai,J).compute(([x,O])=>{if(!x||!x.length)return null;let ce=x[0],X=new Date(x[6]);X.setHours(23,59,59,999);let ge=aa(O,ce,X);return W({className:"g-ui-event-calendar-week-grid-cols"},x.map(he=>W({key:he.getTime(),className:"g-ui-event-calendar-week-day-col g-ui-event-calendar-week-day-col-body"},Me.map(ue=>W({key:ue,className:"g-ui-event-calendar-week-slot",onClick:()=>E(he,ue,!1)})),ge.filter(ue=>!ue.allDay&&ue.start.getDate()===he.getDate()&&ue.start.getMonth()===he.getMonth()&&ue.start.getFullYear()===he.getFullYear()).map(ue=>{let{top:Te,height:Le}=ta(ue.start,ue.end,R,G);return W({key:ue.id,className:"g-ui-event-calendar-week-event",style:{top:`${Te}%`,height:`${Le}%`,borderLeftColor:ue.color||"var(--g-ui-primary)"},onClick:F=>{F.stopPropagation(),M(ue)}},W({className:"g-ui-event-calendar-week-event-title"},ue.title||"(No title)"),fe(!ue.allDay,()=>Xe({className:"g-ui-event-calendar-week-event-time"},`${ri(ue.start,h(n))} \u2013 ${ri(ue.end,h(n))}`)))}))))}))),qi=W({className:"g-ui-event-calendar-day"},W({className:"g-ui-event-calendar-day-body"},W({className:"g-ui-event-calendar-day-time-col"},Me.map(x=>{let O=Math.floor(x),ce=(x-O)*60,X=`${O<=12?O:O-12}:${ce===0?"00":ce} ${O<12?"AM":"PM"}`;return W({key:x,className:"g-ui-event-calendar-day-slot-label"},X)})),W({className:"g-ui-event-calendar-day-slots"},Me.map(x=>W({key:x,className:"g-ui-event-calendar-day-slot",onClick:()=>E(p.get(),x,!1)})),Ce(J,p).compute(([x,O])=>O?ia(x,O).filter(X=>!X.allDay).map(X=>{let{top:ge,height:he}=ta(X.start,X.end,R,G);return W({key:X.id,className:"g-ui-event-calendar-day-event",style:{top:`${ge}%`,height:`${he}%`,borderLeftColor:X.color||"var(--g-ui-primary)"},onClick:ue=>{ue.stopPropagation(),M(X)}},W({className:"g-ui-event-calendar-day-event-title"},X.title||"(No title)"),Xe({className:"g-ui-event-calendar-day-event-time"},`${ri(X.start,h(n))} \u2013 ${ri(X.end,h(n))}`))}):[])))),xi=x=>{let O=A.get(),ce=new Date,X=O.start||ce,ge=O.end||new Date(ce.getTime()+3600*1e3),he=me(O.title),ue=me(X.toISOString().slice(0,10)),Te=me(!O.allDay&&X?X.toTimeString().slice(0,5):"09:00"),Le=me(ge.toISOString().slice(0,10)),F=me(!O.allDay&&ge?ge.toTimeString().slice(0,5):"10:00"),$=me(O.allDay),q=me(O.description),Z=me(O.location),ne=me(O.attendees||[]),te=me(""),Q=me([]),ae=me([]),le=me(""),xe=Array.isArray(f)?f:[],Be=me(O.color),Se=()=>{let B=new Date(ue.get()+"T"+($.get()?"00:00:00":Te.get()+":00")),we=new Date(Le.get()+"T"+($.get()?"23:59:59":F.get()+":00"));A.set({title:he.get(),start:B,end:we,allDay:$.get(),description:q.get(),location:Z.get(),attendees:ne.get(),color:Be.get()})},Gi=B=>{if(te.set(B),!I||!B.trim()){Q.set([]);return}Promise.resolve(I(B.trim())).then(we=>Q.set(Array.isArray(we)?we:[])).catch(()=>Q.set([]))},oa=B=>{let we=ne.get();we.some(Rt=>(Rt.email||Rt.id)===(B.email||B.id))||(ne.set([...we,{id:B.id,email:B.email??B.label,label:B.label}]),te.set(""),Q.set([]))},na=B=>{let we=[...ne.get()];we.splice(B,1),ne.set(we)},Et=()=>{D&&Promise.resolve(D(le.get())).then(B=>ae.set(Array.isArray(B)?B:[])).catch(()=>ae.set([]))};return W({className:"g-ui-event-calendar-form"},W({className:"g-ui-event-calendar-form-row"},be({label:"Title",placeholder:"Event title",value:he,onInput:B=>he.set(B?.target?.value??"")})),W({className:"g-ui-event-calendar-form-row g-ui-event-calendar-form-row-inline"},nt({label:"All day",checked:$,onChange:B=>$.set(B)})),W({className:"g-ui-event-calendar-form-row g-ui-event-calendar-form-row-inline"},W({className:"g-ui-event-calendar-form-field"},vi({className:"g-ui-event-calendar-form-label"},"Start"),Hi({type:"date",className:"g-ui-input g-ui-input-size-md",value:ue,onInput:B=>ue.set(B?.target?.value??"")}),fe(!$,()=>Hi({type:"time",className:"g-ui-input g-ui-input-size-md",value:Te,onInput:B=>Te.set(B?.target?.value??"")}))),W({className:"g-ui-event-calendar-form-field"},vi({className:"g-ui-event-calendar-form-label"},"End"),Hi({type:"date",className:"g-ui-input g-ui-input-size-md",value:Le,onInput:B=>Le.set(B?.target?.value??"")}),fe(!$,()=>Hi({type:"time",className:"g-ui-input g-ui-input-size-md",value:F,onInput:B=>F.set(B?.target?.value??"")})))),fe(D,()=>W({className:"g-ui-event-calendar-form-row"},vi({className:"g-ui-event-calendar-form-label"},"Location"),be({placeholder:"Search or type location",value:le,onInput:B=>{le.set(B?.target?.value??""),Et()},onFocus:Et}),fe(Ce(ae).compute(B=>B&&B.length>0),()=>W({className:"g-ui-event-calendar-form-suggestions"},ae.get().map(B=>W({key:B.id??B.label,className:"g-ui-event-calendar-form-suggestion-item",onClick:()=>{Z.set(B.label??B.id),le.set(""),ae.set([])}},B.label??B.id)))),fe(Ce(Z).compute(B=>!!B),()=>Xe({className:"g-ui-event-calendar-form-chip"},Z)))),fe(I,()=>W({className:"g-ui-event-calendar-form-row"},vi({className:"g-ui-event-calendar-form-label"},"Add guests"),be({placeholder:"Type email to search",value:te,onInput:B=>Gi(B?.target?.value??"")}),W({className:"g-ui-event-calendar-form-chips"},ne.get().map((B,we)=>Xe({key:(B.email||B.id)+we,className:"g-ui-event-calendar-form-chip g-ui-event-calendar-form-chip-removable",onClick:()=>na(we)},B.label||B.email||B.id," \xD7"))),fe(Ce(Q).compute(B=>B&&B.length>0),()=>W({className:"g-ui-event-calendar-form-suggestions"},Q.get().map(B=>W({key:B.id??B.email,className:"g-ui-event-calendar-form-suggestion-item",onClick:()=>oa(B)},B.label??B.email??B.id)))))),W({className:"g-ui-event-calendar-form-row"},et({label:"Description",placeholder:"Add description",value:q,onInput:B=>q.set(B?.target?.value??"")})),fe(xe.length>0,()=>W({className:"g-ui-event-calendar-form-row"},vi({className:"g-ui-event-calendar-form-label"},"Color"),W({className:"g-ui-event-calendar-form-colors"},xe.map(B=>W({key:B.value??B.id??B,className:s("g-ui-event-calendar-form-color-swatch",Ce(Be).compute(we=>we===(B.value??B.id??B)?"g-ui-event-calendar-form-color-swatch-active":"")),style:{backgroundColor:B.color??B.value??B},onClick:()=>Be.set(B.value??B.id??B)}))))),W({className:"g-ui-event-calendar-form-actions"},Ue({variant:"subtle",onClick:T},"Cancel"),Ue({variant:"filled",onClick:()=>{Se(),x?ee():H()}},x?"Save":"Create")))},Yi=()=>{let x=V.get();return x?W({className:"g-ui-event-calendar-view-modal"},W({className:"g-ui-event-calendar-view-modal-title"},x.title||"(No title)"),W({className:"g-ui-event-calendar-view-modal-meta"},x.allDay?Xe({className:"g-ui-event-calendar-view-modal-date"},bi(x.start,h(n))+(x.start.getTime()!==x.end.getTime()?` \u2013 ${bi(x.end,h(n))}`:"")):Xe({className:"g-ui-event-calendar-view-modal-date"},`${bi(x.start,h(n))} \xB7 ${ri(x.start,h(n))} \u2013 ${ri(x.end,h(n))}`)),fe(x.location,()=>W({className:"g-ui-event-calendar-view-modal-field"},"Location: ",x.location)),fe(x.description,()=>W({className:"g-ui-event-calendar-view-modal-field"},x.description)),fe(x.attendees?.length,()=>W({className:"g-ui-event-calendar-view-modal-field"},"Guests: ",x.attendees.map(O=>O.label||O.email||O.id).join(", "))),W({className:"g-ui-event-calendar-view-modal-actions"},Ue({variant:"subtle",size:"sm",onClick:Y},ye({size:"sm",innerHTML:er})," Edit"),Ue({variant:"subtle",size:"sm",onClick:pe,className:"g-ui-event-calendar-view-modal-delete"},ye({size:"sm",innerHTML:ir})," Delete"),Ue({variant:"filled",size:"sm",onClick:T},"Close"))):null};return W({...y,className:s("g-ui-event-calendar",w)},Pe,fe(m,x=>x==="month",()=>Ve),fe(m,x=>x==="week",()=>Wi),fe(m,x=>x==="day",()=>qi),fe(L,x=>x==="create",()=>si({opened:!0,title:"New event",size:"lg",onClose:T},xi(!1))),fe(L,x=>x==="view",()=>si({opened:!0,title:"Event",size:"md",onClose:T},Yi())),fe(L,x=>x==="edit",()=>si({opened:!0,title:"Edit event",size:"lg",onClose:T},xi(!0))))}import{state as ug}from"@granularjs/core";function gg(e=!1){let i=ug(!!e);return[i,{open:()=>i.set(!0),close:()=>i.set(!1),toggle:()=>i.set(!i.get())}]}Ot();export{jo as Accordion,Ge as ActionIcon,ps as Affix,tn as Alert,zn as Anchor,bs as AppBar,At as Autocomplete,nn as Avatar,Xu as AvatarGroup,Ga as Badge,Qu as BadgeGroup,pn as Blockquote,ea as BottomBar,Qn as Breadcrumbs,Fu as Burger,Xi as Button,pi as Calendar,qa as Card,es as Center,nt as Checkbox,Zu as CheckboxGroup,An as Chip,ln as Code,Wu as Col,os as Collapse,ja as Container,vu as CopyButton,Bi as DateInput,Ks as DatePicker,Xo as Divider,Go as Drawer,sg as EventCalendar,hs as Fieldset,Tu as Flex,Hu as Grid,Bt as GridTable,Oa as Group,ls as HoverCard,ye as Icon,Cn as Image,Au as Indicator,un as Kbd,vr as List,ui as Loading,Eu as LoadingOverlay,Wo as Menu,si as Modal,qs as MultiSelect,Iu as NavLink,dt as Notification,eu as Notifications,it as NumberField,io as NumberInput,Hn as Pagination,Qo as Paper,cu as PasswordInput,Gu as PinInput,St as Popover,su as Popper,Sn as Progress,xu as ProgressRing,Un as Radio,qn as RadioGroup,Pu as RangePicker,ru as RangeSlider,Es as Rating,It as ScrollArea,du as SearchInput,jn as SegmentedControl,yo as Select,Nu as SelectSearch,ws as Sidebar,mn as SimpleGrid,Ln as Skeleton,Mn as Slider,ts as Space,Ra as Stack,Bs as Stepper,bo as Switch,co as SwitchGroup,Lo as Table,Co as Tabs,Hs as Tag,Ki as Text,be as TextInput,et as Textarea,As as Timeline,Fa as Title,Tt as Toast,Xs as ToastStack,Eo as Tooltip,_ as classFlag,ve as classMap,k as classVar,s as cx,za as getThemeMode,ka as setThemeMode,ya as setThemeVars,g as splitPropsChildren,gg as useDisclosure};
